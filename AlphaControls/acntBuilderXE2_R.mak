# ---------------------------------------------------------------------------
!if !$d(BCB)
BCB = "c:\Program files (x86)\Embarcadero\RAD Studio\9.0"
!endif
...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = acntBuilderXE2_R.bpl
OBJFILES = acntBuilderXE2_R.obj sVCLUtils.obj sAlphaGraph.obj \
...
MAINSOURCE = acntBuilderXE2_R.cpp
