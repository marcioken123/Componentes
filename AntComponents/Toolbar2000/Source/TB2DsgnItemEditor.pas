...

{
  ...
  $jrsoftware: tb2k/Source/TB2DsgnItemEditor.pas,v 1.60 2007/04/04 16:54:13 jr Exp $
}
...
type
  TTBItemEditForm = class(TDesignWindow)
    ...
    procedure FormShow(Sender: TObject); {vb+}
  private
...
const
  AboutText =
    '%s'#13#10 +
    'Copyright (C) 1998-2007 by Jordan Russell'#13#10 +
...
{vb+}
procedure TTBItemEditForm.FormShow(Sender: TObject);
const
  Win2KMajor = 5;
begin
  {$IFDEF JR_D7}
