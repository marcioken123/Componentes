...

{
  ...
  $jrsoftware: tb2k/Source/TB2Toolbar.pas,v 1.119 2006/05/12 17:24:19 jr Exp $
}
...
{ TTBChevronItem & TTBChevronItemViewer }
  ...
  protected
    ...
    property Toolbar: TTBCustomToolbar read FToolbar; {vb+}
  public
    constructor Create(AOwner: TComponent); override;
  end;
...
uses
  ...
  {TB2Consts, TB2Common, TB2Hook;} {vb-}
  TB2Consts, TB2Common, TB2Hook {$IFDEF JR_D9}, Types {$ENDIF}; {vb+}
...
begin
  if not(csDesigning in ComponentState) then begin
    ...
    if Assigned(FView.Selected) then begin
      {vb+}
      { Used in TTBXToolViewer when TBXToolPalette placed on floating toolbar }
