...
interface
uses ACBrBase, ACBrCHQClass, ACBrECF,  { Units da ACBr}
     SysUtils , Classes;

type
  TACBrCHQModelo = (chqNenhuma, chqImpressoraECF, chqImpressoraComum,
                    chqBematech, chqChronos, chqSchalter, chqPerto, chqSotomaq) ;
...
TACBrCHQ = class( TACBrComponent )
  ...
  public
    ...
    procedure ImprimirLinha( AString : String ) ;
...
procedure TACBrCHQ.ImprimirLinha( AString : String );
Var wAtivo : Boolean ;
begin
  wAtivo := Ativo ;
  try
