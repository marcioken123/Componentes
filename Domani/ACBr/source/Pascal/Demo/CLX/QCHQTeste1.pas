...
interface
uses ACBrCHQ, ACBrECF, ACBrBase, ACBrExtenso, QStdCtrls, QControls,
  QForms, QDialogs, QButtons, QGraphics, Classes, QExtCtrls ;
...
uses SysUtils, DateUtils, ACBrUtil, ACBrCHQPerto ;
...
begin
  ...
  Height := Image1.Height + 4 ;
  Width  := Image1.Width  + 4 ;
  pFrente.Align := alClient ;
  pVerso.Align  := alClient ;
