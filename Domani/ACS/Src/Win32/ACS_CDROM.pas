(*
  This file is a part of Audio Components Suite v 2.3 (Delphi Edition)
...
//    if Buisy then raise EACSException.Create('The component is buisy');
  ...
  begin
    if Self.Busy then raise EACSException.Create('The component is buisy');
    FStartTrack := Track;
  ...
  begin
    if Self.Busy then raise EACSException.Create('The component is busy');
    FEndTrack := Track;
