...
const
  ...
  cVersion = '3.00';
  cInsertDisk = 'Por farvor, insira o disco %s e clique em OK para continuar.';
  fSignature = 'EC2';
  fOldSignature = 'ECS';
  ...
  errCantreadFile = 'Não é possivel ler o arquivo';
  errCantwriteFile = 'Não é possivel sobrescrever o arquivo';
  errCantreadArchive = 'Não é possivel ler o backup';
  errCantwriteArchive = 'Não é possivel gravar o backup';
  errInvalidfiletype = 'Tipo invalido de arquivo';
  errCompression = 'Erro de compressão';
  errCantCreateFileID = 'Não é possivel gravar o arquivo temporário que contém inf. dos arquivos.';
...
procedure Register;
begin
  RegisterComponents('Domani', [TBackupFile]);
end;
