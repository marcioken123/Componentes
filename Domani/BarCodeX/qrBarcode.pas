...
uses
  Classes, SysUtils, Graphics, Barcode, QRCTRLS, Windows;
...
//  RegisterComponents('QMark',[TQRAsBarcode]);
  RegisterComponents('Barcode', [TQRBarcode, TQRAsBarcode]);
//  RegisterComponents('Barcode', []);
//QMARK - End of change
end;
...
Classes.RegisterClass(TAsBarcode);
