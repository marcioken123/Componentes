...
type
  ...
  TcxFilterValueItem = {$IFNDEF CLR}record{$ELSE}class{$ENDIF}
  ...
  public
    ...
    procedure Changed; virtual;
    procedure EndUpdate;
    function EqualItems(AFilterCriteria: TcxFilterCriteria): Boolean;
...
begin
  if VarIsNull(AValue) then
    Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterBlankCaption)
  else
...
begin
  Result := FilterVarToStr(AValue[0]) + ' ' +
    cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterAndCaption) + ' ' + FilterVarToStr(AValue[1]);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorEqual);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNotEqual);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLess);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLessEqual);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorGreater);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorGreaterEqual);
end;
...
begin
  ...
  case LikeOperatorByPattern(S, CriteriaItem.Criteria.PercentWildcard) of
    floBeginsWith:
      Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorBeginsWith);
    floEndsWith:
      Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorEndsWith);
    floContains:
      Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorContains);
  else
    Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLike);
  end;
end;
...
begin
  ...
  case LikeOperatorByPattern(S, CriteriaItem.Criteria.PercentWildcard) of
    floBeginsWith:
      Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorDoesNotBeginWith);
    floEndsWith:
      Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorDoesNotEndWith);
    floContains:
      Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorDoesNotContain);
  else
    Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNotLike);
  end;
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorBetween);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNotBetween);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorInList);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNotInList);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorIsNull);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorIsNotNull);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorYesterday);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorToday);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorTomorrow);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLast7Days);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLastWeek);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLast14Days);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLastTwoWeeks);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLast30Days);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLastMonth);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorLastYear);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorPast);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorThisWeek);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorThisMonth);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorThisYear);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNext7Days);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNextWeek);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNext14Days);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNextTwoWeeks);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNext30Days);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNextMonth);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorNextYear);
end;
...
begin
  Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOperatorFuture);
end;
...
begin
  ...
  if not AIsItemList and (TcxFilterCriteriaItem(Result).ItemLink = nil) then
    FreeAndNil(Result);
end;
...
begin
  if ((FOperator is TcxFilterNullOperator) or (FOperator is TcxFilterNotNullOperator)) and
    (FDisplayValue = '') then
    FDisplayValue := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterBlankCaption);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      New(PItem);
      {$ELSE}
      PItem := TcxFilterValueItem.Create;
      {$ENDIF}
...
begin
  if EqualItems(ASource) then Exit;
  BeginUpdate;
  try
    Clear;
...
function TcxFilterCriteria.EqualItems(AFilterCriteria: TcxFilterCriteria): Boolean;
var
...
begin
  ...
  try
    WriteData(AStream1, AFilterCriteria.Version);
    AFilterCriteria.WriteData(AStream2, Version);
...
function TcxFilterCriteria.DoFilterData(AData: TObject): Boolean;
  ...
  begin
    try
      ...
      if (fcoIgnoreNull in Options) and not AItem.Operator.IsNullOperator and AItem.ValueIsNull(V1) then
        Result := False
      else             
...
function TcxFilterCriteria.GetFilterExpression(AIsCaption: Boolean): string;
  ...
  begin
    case ABoolOperatorKind of
      fboAnd, fboNotAnd:
        begin
          if AIsCaption then
            Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterAndCaption)
          else
            Result := 'AND';
        end;
      fboOr, fboNotOr:
        begin
          if AIsCaption then
            Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterOrCaption)
          else
            Result := 'OR';
        end;
    end;
  ...
  begin
    if AIsCaption then
      Result := cxSFilterString({$IFNDEF CLR}@{$ENDIF}cxSFilterNotCaption)
    else
      Result := 'NOT';
  end;
...
begin
  Result := (Root.BoolOperatorKind <> fboAnd) or (Root.Count > 0);
end;
...
function TcxFilterCriteria.PrepareValue(AValue: Variant): Variant;
var
  I: Integer;
begin
    ...
    begin
      ...
      begin
        for I := VarArrayLowBound(AValue, 1) to VarArrayHighBound(AValue, 1) do
          AValue[I] := PrepareValue(AValue[I]);
        Result := AValue;
      end
      else
        Result := AValue;
