...
begin
  ...
  begin
    ...
    begin
      ...
      APainter.DrawCheckButton(ACanvas, ACheckRect, CheckState2ButtonState[ACheckState],
             AState = cbsChecked);
    end
    else
    begin
    ...
    begin
      ...
      begin
        ...
        if not Properties.IsEmbeddedEdit then
          Inc(ACheckBoxRect.Left, 2{ - TcxCustomCheckBoxViewInfo(AViewInfo).CheckBorderOffset});
      end
      else
        ...
        begin
          ...
          if not Properties.IsEmbeddedEdit then
            Dec(ACheckBoxRect.Right, 2{ - TcxCustomCheckBoxViewInfo(AViewInfo).CheckBorderOffset});
        end;
...
//  else
  ...
  ACheckBoxViewInfo.IsTextColorAssigned := Style.IsValueAssigned(svTextColor);
end;
...
begin
  if IsAccel(Key, Caption) and (ssAlt in Shift) and CanFocus then
    begin
      SetFocus;
      if Focused then
        Toggle;
