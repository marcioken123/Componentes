...
begin
  ...
  begin
    ...
    with TcxCheckListBoxItems(Collection).CheckListBox.Container do
      if Sorted then
        Sort;
    Changed(False);
  end;
...
procedure TcxCheckListBoxItems.Update(Item: TCollectionItem);
  ...
  begin
    AItemCount := CheckListBox.Items.Count;
    if AItemCount <> Count then
      if AItemCount < Count then
        for I := 1 to Count - AItemCount do
          CheckListBox.Items.Add('')
      else
        for I := 1 to AItemCount - Count do
          CheckListBox.Items.Delete(CheckListBox.Items.Count - 1);

    if Item = nil then
      for I := 0 to Count - 1 do
        CheckListBox.Items[I] := Items[I].Text;
  end;
...
begin
  ...
  begin
    AItemTextWidth := Canvas.TextWidth(Items[I].Text);
...
procedure TcxCustomCheckListBox.DrawItem(Control: TWinControl; Index: Integer;
  ...
  begin
    ...
    begin
      FInnerCheckListBox.Canvas.Brush.Color := ActiveStyle.Color;
