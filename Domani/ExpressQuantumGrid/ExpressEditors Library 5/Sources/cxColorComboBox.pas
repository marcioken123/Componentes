...
begin
  ...
  if (AReason in [crTab, crEnter, crClose]) and ModifiedAfterEnter then
  begin
    ASavedColor := ActiveProperties.GetColorByIndex(ILookupData.CurrentKey);
    FixMRUPosition(ASavedColor);
  end;
end;
