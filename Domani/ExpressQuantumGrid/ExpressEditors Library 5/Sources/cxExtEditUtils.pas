...
begin
  ...
  if AIsDTFlags then
  begin
    Result := Result or AlignmentsHorzArray[AHorzAlignments] or
  ...
  begin
    Result := Result or cxAlignmentsHorzArray[AHorzAlignments] or
      cxAlignmentsVertArray[AVertAlignments] or
