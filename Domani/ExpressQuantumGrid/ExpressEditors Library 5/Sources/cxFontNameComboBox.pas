...
begin
  ...
  begin
    ...
    Brush.Style := bsClear;
    CalculateFont(FRect);
    Windows.DrawText(Canvas.Handle, PChar(Caption),
      Length(Caption), FRect, GetTextFlag(DT_NOPREFIX));
  end;
end;
...
procedure TcxFontNameComboBoxListBox.DrawItem(Index: Integer; Rect: TRect;
  ...
  begin
    ...
    if ftiShowInList in Edit.ActiveProperties.ShowFontTypeIcon then
    begin
