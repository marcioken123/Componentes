...
{$ELSE}
    ...
    procedure MeasureItem(Control: TWinControl;
      ...
      {$IFDEF MSWINDOWS}{$IFNDEF DELPHI7}Index: Integer{$ELSE}item: QClxListBoxItemH{$ENDIF}{$ENDIF};
...
begin
  ...
  begin
    ...
    begin
      ImageRect := R;
      InflateRect(ImageRect, -2, 0);
      with ImageRect do
      begin
        if (Right - Left) > Images.Width then
        begin
          ...
          R.Left := R.Right;
        if (Bottom - Top) > Images.Height then
        begin
