...
uses
  cxClasses, cxEditConsts, dxThemeConsts, dxThemeManager, dxUxTheme;
...
var
  ATheme: TTheme;
begin
  if FLookAndFeel.NativeStyle and AreVisualStylesAvailable([totScrollBar]) then
  begin
    ATheme := OpenTheme(totScrollBar);
    DrawThemeBackground(ATheme, Canvas.Handle, SBP_SIZEBOX, SZB_RIGHTALIGN, @FSizeGripRect);
  end
  else
