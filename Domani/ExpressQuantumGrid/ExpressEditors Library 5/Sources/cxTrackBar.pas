...
procedure TcxCustomTrackBarViewInfo.Paint(ACanvas: TcxCanvas);
  ...
  begin
    if IsInplace then
    begin
      if Transparent or (Painter <> nil) then
...
begin
  ...
  if Painter <> nil then
    Painter.DrawTrackBar(ACanvas, FEdgeTrackRect, Enabled,
      TcxCustomTrackBarProperties(EditProperties).Orientation = tboHorizontal)
  else
