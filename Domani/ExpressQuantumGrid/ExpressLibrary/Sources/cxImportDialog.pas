...
type
  ...
  procedure ShowImportDialog(ADesigner: {$IFDEF DELPHI6}IDesigner{$ELSE}IFormDesigner{$ENDIF};
      ADestination: TObject; const AGroupConverterName: string; AShowOptionsButton: Boolean = True);

var
  cxImportDialogForm: TcxImportDialogForm;
...
procedure TcxImportDialogForm.Button2Click(Sender: TObject);
begin
  Close;
end;
