...
{$ELSE}
  DsgnIntf, Menus,
{$ENDIF}
  Classes, Forms, SysUtils, cxPC, cxPCConsts, cxPCPaintersFactory;

const
  cxPCVersion = '2.24';
  cxTabControlComponentEditorVerbA: array[0 .. 1] of string = (
    'ExpressPageControl Suite ' + cxPCVersion,
    'www.devexpress.com'
  );
...
type
  ...
  TcxPageControlComponentEditor = class(TComponentEditor)
  private
...
procedure TcxPageControlComponentEditor.ExecuteVerb(Index: Integer);
begin
  case Index of
    0: AddPage;
    1: NextPage(True);
...
function TcxPageControlComponentEditor.GetVerb(Index: Integer): string;
begin
  Result := cxPageControlComponentEditorVerbA[Index];
end;

function TcxPageControlComponentEditor.GetVerbCount: Integer;
begin
