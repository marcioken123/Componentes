object FilterByCodeDemoMainForm: TFilterByCodeDemoMainForm
  ...
  object lbDescrip: TLabel
    ...
    Caption = 
      ...
      'w and column headers dropdown. Click "About this demo" for more ' +
      'information.'
    Color = 12937777
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
  ...
  object cxGrid: TcxGrid
    ...
    object tvCustomers: TcxGridDBTableView
      DataController.DataSource = FilterByCodeDemoDataDM.dsCustomers
      ...
      Styles.StyleSheet = FilterByCodeDemoDataDM.GridTableViewStyleSheetDevExpress
      ...
      object tvCustomersPAYMENTTYPE: TcxGridDBColumn
        ...
        RepositoryItem = FilterByCodeDemoDataDM.edrepDXPaymentTypeImageCombo
        Width = 119
      end
      object tvCustomersPRODUCTID: TcxGridDBColumn
        Caption = 'Product'
        DataBinding.FieldName = 'PRODUCTID'
        RepositoryItem = FilterByCodeDemoDataDM.edrepDXLookupProducts
