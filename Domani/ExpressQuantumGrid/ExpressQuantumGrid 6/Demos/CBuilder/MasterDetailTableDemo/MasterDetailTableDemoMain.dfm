object MasterDetailTableDemoMainForm: TMasterDetailTableDemoMainForm
  ...
  Width = 876
  Height = 589
  Caption = 'ExpressQuantumGrid MasterDetailTableDemo'
  Color = clBtnFace
  ...
  object lbDescription: TLabel
    ...
    Caption = 
      ...
      'Options in order to show both tables in a single grid. Click "Ab' +
      'out this demo" for more information.'
    Color = 12937777
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -13
  ...
  object pnlDetail: TPanel
    ...
    object GridDetail: TcxGrid
      ...
      object tvFilmsPersonsStaff: TcxGridDBTableView
        DataController.DataSource = MasterDetailTableDemoDataDM.dsFilmsPersonsStaff
        ...
        Styles.StyleSheet = MasterDetailTableDemoDataDM.GridTableViewStyleSheetDevExpress
        object tvFilmsPersonsStaffPERSONLINEID: TcxGridDBColumn
          ...
          Properties.ListSource = MasterDetailTableDemoDataDM.dsPersonsLine
        end
        object tvFilmsPersonsStaffPERSONID: TcxGridDBColumn
          ...
          Properties.ListOptions.GridLines = glNone
          Properties.ListOptions.ShowHeader = False
          Properties.ListSource = MasterDetailTableDemoDataDM.dsPersons
        end
  ...
  object Grid: TcxGrid
    ...
    object tvFilms: TcxGridDBTableView
      ...
      DataController.DataSource = MasterDetailTableDemoDataDM.dsFilms
      DataController.KeyFieldNames = 'ID'
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      DataController.Summary.SummaryGroups = <>
