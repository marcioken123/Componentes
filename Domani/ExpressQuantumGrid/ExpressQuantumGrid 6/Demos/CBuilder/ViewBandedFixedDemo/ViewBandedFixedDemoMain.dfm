object ViewBandedFixedDemoMainForm: TViewBandedFixedDemoMainForm
  ...
  object lbDescription: TLabel
    ...
    Caption = 
      ...
      'the Options available. Click "About this demo" for more informat' +
      'ion. '
    Color = 12937777
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
  ...
  object cxGrid: TcxGrid
    ...
    object btvUsersSchedule: TcxGridDBBandedTableView
      DataController.DataSource = ViewBandedFixedDemoDataDM.dsSCHEDULER
      ...
      Bands = <
        item
          ...
          Styles.Content = ViewBandedFixedDemoDataDM.cxStyle1
          Width = 200
        end
        item
          Caption = 'Days'
      ...
      object btvUsersScheduleProjectName: TcxGridDBBandedColumn
        ...
        Properties.ListSource = ViewBandedFixedDemoDataDM.dsPROJECTS
        Visible = False
        GroupIndex = 0
