...
*)
  ...
  protected
    ...
    function FindItemByTag(AItemClass: TcxGridChartItemClass; ATag: TTag): TcxGridChartItem;
  ...
  public
    ...
    function FindDataGroupByTag(ATag: TTag): TcxGridChartDataGroup;
...
begin
  Result := Diagram.Values.Stacking <> vsNone;
end;
...
function TcxGridChartItem.GetTag: TTag;
begin
...
procedure TcxGridChartItem.SetTag(Value: TTag);
begin
  if Tag <> Value then
  begin
    inherited Tag := Value;
...
begin
  ...
  begin
    ...
    begin
      ...
      FNextID := TcxGridChartView(ASource).FNextID;
    end;
...
function TcxGridChartView.FindDataGroupByTag(ATag: TTag): TcxGridChartDataGroup;
begin
