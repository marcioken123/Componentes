...
{$ENDIF}
  ...
  cxLookAndFeelPainters, cxGeometry, cxControls, cxDataStorage;
    ...
    begin
      ...
      begin
        ...
        if AIsFooter then
          ...
          AValue := AValues^[J];
        AddVisualItemEx(GetFooterItemBounds(I, ALineIndex, R, AIsFooter), AItem.FormatValue(
          AValue, True), AParams, AColumn.FooterAlignmentHorz, cxBordersAll, GridLineColor);
        Dec(ACellCount);
        Inc(ALineIndex);
...
begin
  ...
  begin
    ...
    begin
      ...
      AddVisualItemEx(AItem.Bounds, AItem.Text, AItem.ViewParams,
        AItem.Alignment, GridLines - [bLeft, bRight], GridLineColor, False);
    end;
  end
  else
  begin
    AddVisualItemEx(R, ARow.DisplayText, AViewParams,
...
begin
  ...
  begin
    ...
    if AItem.IsBackground then
      FillRealArea(AItem.Bounds, AItem.Style, clBtnShadow)
    else
    begin
