         ...
         begin
            ...
            begin
               ...
               case StrToInt(ATipoOcorrencia) of
                  ...
                  04 : TipoOcorrencia := toRetornoAlteracaoDadosNovaEntrada;
                  05 : TipoOcorrencia := toRetornoAlteracaoDadosBaixa;
                  06 : TipoOcorrencia := toRetornoLiquidado;
                  08 : TipoOcorrencia := toRetornoLiquidadoEmCartorio;
               ...
               if Length(Trim(Copy(Retorno.Strings[NumeroRegistro],296,6))) = 6 then
                  begin
