...
//         Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.ContaBancaria.Banco.Codigo,3,false,'0'); // 140 a 142 - num.do banco encarregado da cobranca
         ...
         case Titulos[NumeroRegistro].EspecieDocumento of {//148 a 149 - Espécie do documento}
         ...
         //**************Aceite Documento **************************************
         case Titulos[NumeroRegistro].AceiteDocumento of // 150 - Identificação de título Aceito / Não aceito
