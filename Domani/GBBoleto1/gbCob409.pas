...
begin
  ...
  with ATitulo do
   begin
      ACodigoCedente := Formatar(Cedente.ContaBancaria.NumContrato,7,false,'0');
      ANossoNumero := Formatar(NossoNumero+Modulo11(NossoNumero,10,false,'0'),15,false,'0');
   end;
   ...
   if ((CodigoBanco = '409') and ((UpperCase(ATitulo.Carteira) = 'ESP') or (UpperCase(ATitulo.Carteira) = 'ESPECIAL') or (ATitulo.Carteira = '20'))) then
     begin
       with ATitulo do
       begin
          ACodigoCedente := Formatar(Cedente.ContaBancaria.NumContrato,7,false,'0');
          ANossoNumero := Formatar(NossoNumero,14,false,'0');
          ANossoNumero := ANossoNumero + Modulo11(ANossoNumero);
       end;
     end
   else
     begin
   ...
   {
   Result := '04' + FormatDateTime('yymmdd',ATitulo.DataVencimento);
   Result := Result + ATitulo.Cedente.ContaBancaria.CodigoAgencia+ATitulo.Cedente.ContaBancaria.DigitoAgencia;
   Result := Result + '5';
   Result := Result + Formatar(ATitulo.NossoNumero,11,false,'0');

   Modulo11(Formatar('60',10,false,'0'));
   Modulo11(Formatar(ATitulo.NossoNumero,10,false,'0'));
   Modulo11('1'+Formatar(ATitulo.NossoNumero,11,false,'0'));
   Result := Result + '1';
