...
begin
   ...
   ADigitoNossoNumero := Modulo11(ANossoNumero,9, false, '422');
...
begin
   ...
   begin
      ...
      ANossoNumero := ANossoNumero + Modulo11(ANossoNumero,9,false,'422');
   end;
...
begin
   ...
   begin                                                           
      ...
      ANossoNumero := Formatar(NossoNumero,9,false,' ') + '-' + DigitoNossoNumero;
...
begin
   ...
   begin
      ...
      Remessa.Add('0'+ // IDENT.DO REGISTRO
                  ...
                  Formatar(Titulos[NumeroRegistro].Cedente.ContaBancaria.DigitoAgencia,1,false,'0') +
                  Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,8,True,' ')+
                  Formatar(Titulos[NumeroRegistro].Cedente.DigitoCodigoCedente,1,True,' ')+ // IDENTIFICAÇÃO DA CONTA COBRANÇA/CARTEIRA FORNECIDO PELO BANCO
...
{              edAluguel: aTitulosEspecieDocumento := '01';
        ...
        case Titulos[NumeroRegistro].AceiteDocumento of
         ...
         Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.ContaBancaria.CodigoAgencia,4,false,'0'); // IDENTIFICAÇÃO DA CONTA COBRANÇA/CARTEIRA FORNECIDO PELO BANCO
         Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.ContaBancaria.DigitoAgencia,1,false,'0'); // IDENTIFICAÇÃO DA CONTA COBRANÇA/CARTEIRA FORNECIDO PELO BANCO
         Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,8,True,' '); // IDENTIFICAÇÃO DA CONTA COBRANÇA/CARTEIRA FORNECIDO PELO BANCO
         Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.DigitoCodigoCedente,1,True,' '); // IDENTIFICAÇÃO DA CONTA COBRANÇA/CARTEIRA FORNECIDO PELO BANCO
         ...
         Registro := Registro + Formatar(Titulos[NumeroRegistro].NossoNumero,8,False,'0') + Modulo11(Formatar(Titulos[NumeroRegistro].NossoNumero,8,False,'0'),9,false,'422'); // IDENT. DO TITULO NO BANCO COM DIG VERIFICADOR
...
//         Registro := Registro + Formatar(Titulos[NumeroRegistro].CodigoIof,1,false,'0'); // CODIGO IOF OPERAÇÕES
         ...
         if Titulos[NumeroRegistro].DataDesconto=0 then begin
            Registro := Registro + Formatar(' ',6,False,'0'); // DATA LIMITE P/ CONCESSÃO DESC.
         end else begin
