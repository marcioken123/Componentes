...
type
   ...
   private
      ...
      {Modificado por Sérgio Ávila - INICIO - bcc-sergio@ig.com.br}
      fConvenio: string; {Convênio da Empresa, 6 ou 7 dígitos, para carteiras 16, 17 e 18}
      {Modificado por Sérgio Ávila - FIM - bcc-sergio@ig.com.br}
      ...
      fDataMultaJuros, {Data a partir da qual deverão ser cobrados juros / multa}
      ...
      fTipoDataProtesto: String; {Tipo de Data em que o título deverá ser protestado em caso de falta de pagamento: dias uteis ou corridos}
      fDiasProtesto: String; {Numero de dias em que o título deverá ser protestado em caso de falta de pagamento: dias uteis ou corridos}
      fDiasMulta: String; {Numero de dias em que o título deverá ser multado em caso de falta de pagamento: dias uteis ou corridos}
...
//   AValorDocumento := FormatCurr('0000000000',ValorDocumento); {Formata o valor com 10 dígitos, incluindo as casas decimais, mas não mostra o ponto decimal}
...
begin
   ...
   if ValorMultaJuros <> 0 then
      AInstrucoes.Add('Após ' + FormatDateTime('dd/mm/yyyy',DataMultaJuros) + ' multa de ' + FormatCurr('R$ #,##0.00',ValorMultaJuros));
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            if ValorMultaJuros > 0 then
              begin
                Add('Após ' + DateToStr(DataMultaJuros) + ' multa de '+FormatCurr('#,##0.00',ValorMultaJuros));
              end;
