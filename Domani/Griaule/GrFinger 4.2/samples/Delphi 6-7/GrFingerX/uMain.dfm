object formMain: TformMain
  ...
  object GrFingerXCtrl1: TGrFingerXCtrl
    Left = 456
    Top = 104
    Width = 32
    Height = 32
    OnSensorPlug = GrFingerXCtrl1SensorPlug
    OnSensorUnplug = GrFingerXCtrl1SensorUnplug
    OnFingerUp = GrFingerXCtrl1FingerUp
    OnFingerDown = GrFingerXCtrl1FingerDown
    OnImageAcquired = GrFingerXCtrl1ImageAcquired
