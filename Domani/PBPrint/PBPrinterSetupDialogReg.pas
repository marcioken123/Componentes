...
{$ENDIF}
	...
	public
		{$IFDEF DEL345} constructor Create(AComponent: TComponent;
...
// -------------------- ComponentEditor -------------------
{$IFDEF DEL345} constructor TPBPrinterSetupEditor.Create(AComponent: TComponent;
...
{$IFDEF DEL345} procedure TPBPrinterSetupEditor.EditProperty(PropertyEditor : TPropertyEditor;
