...
$Id: SynHighlighterDOT.pas,v 1.1 2004/03/03 16:23:09 maelh Exp $
...
const
{$ENDIF}
  SYNS_FilterDOTGraphDrawingDescriptionlanguage = 'DOT Graph Drawing Description (*.dot)|*.dot';
  SYNS_LangDOTGraphDrawingDescriptionlanguage = 'DOT Graph Drawing Description language';
...
{function TSynDOTSyn.Func0: TtkTokenKind;
begin
  if KeyComp('->') then Result := tkDirections else
    if KeyComp('--') then Result := tkDirections else Result := tkIdentifier;
end;}
