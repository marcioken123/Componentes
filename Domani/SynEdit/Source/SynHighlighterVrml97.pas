...
$Id: SynHighlighterVrml97.pas,v 1.3 2004/03/06 10:53:13 maelh Exp $
...
begin
  for I := #0 to #255 do
    case I of
      ...
      '#' :fProcTable[I] := DiesisCommentProc; //nsl 2002-10--30
      ...
      //'<' :fProcTable[I] := InCommentProc;
      //'>' :fProcTable[I] := OutCommentProc;
