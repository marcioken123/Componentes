...
// (DO NOT EDIT: machine generated header) 'CoolTools.pas' rev: 4.00
...
#pragma option push -b-
enum TDisplayFrequency { df56Hertz, df60Hertz, df70Hertz, df72Hertz, df75Hertz, df85Hertz, df90Hertz, 
	df100Hertz, df120Hertz, dfError };
#pragma option pop
...
__published:
	...
	__property TDisplayFrequency DisplayFrequency = {read=GetDisplayFrequency, write=SetDisplayFrequency
		, default=4};
	__property TDisplayResolution DisplayResolution = {read=GetDisplayResolution, write=SetDisplayResolution
...
#pragma option push -b-
enum TLockerOption { loHideTaskBar, loHideStartBtn, loHideProgman, loPreventStartBtnExisting, loPreventAppClosing, 
	loPreventAppMinimizing, loPreventCursorLoosing, loPreventSystemKeysWork, loAlwaysOnTopPosition, loTaskBarAutoHide 
	};
#pragma option pop
...
private:
	...
	Windows::TRect FCaptureRect;
	Windows::TRect FDeviceRect;
...
public:
	__property Windows::TRect CaptureRect = {read=FCaptureRect, write=FCaptureRect};
	__property Windows::TRect DeviceRect = {read=FDeviceRect, write=FDeviceRect};
...
public:
	__property Windows::TPoint LoupePosition = {read=FLoupePosition, write=FLoupePosition};
...
private:
	...
	Windows::TPoint __fastcall GetLoupePosition();
	void __fastcall SetLoupePosition(const Windows::TPoint &Value);
...
public:
	__property Windows::TPoint LoupePosition = {read=GetLoupePosition, write=SetLoupePosition};
...
public:
	...
	/* TWinControl.CreateParented */ inline __fastcall TCoolLoupePolygones(HWND ParentWindow) : Controls::TCustomControl(
		ParentWindow) { }
	#pragma option pop
...
struct TWindowInfo
{
	...
	int wStyle;
	int wExStyle;
	Windows::TRect wWindowRect;
	Windows::TRect wClientRect;
	bool wEnabled;
	bool wVisible;
	bool wMaximized;
	bool wMinimized;
...
#pragma option push -b-
enum TAnimateEffect { aeStripesDown, aeStripesUp, aeStripesLeft, aeStripesRight, aeStripesTBCenter, 
	aeStripesLRCenter, aeStripesCenterTB, aeStripesCenterLR, aeStripesPartsHz, aeStripesPartsVt };
#pragma option pop
...
public:
	__fastcall TAnimateThread(unsigned Handle, Graphics::TBitmap* SourceBmp, Graphics::TBitmap* DestBmp
		, TAnimateEffect Effect, Graphics::TCanvas* Canvas, bool Exclusive);
...
__published:
	__property Coolctrls::TCCAboutBox* About = {read=FAboutBox, write=FAboutBox};
	__property TShadowOrientation ShadowOrientation = {read=FShadowOrientation, write=SetShadowOrientation
		, default=3};
...
typedef void __fastcall (__closure *TKeyEventEx)(System::TObject* Sender, Word &Key, Classes::TShiftState 
	Shift, bool &Handled);
...
public:
	#pragma option push -w-inl
	/* TComponent.Create */ inline __fastcall virtual TCoolClipboardComponent(Classes::TComponent* AOwner
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TCoolClipboardViewer(HWND ParentWindow) : Forms::TScrollBox(
		ParentWindow) { }
	#pragma option pop
...
public:
	...
	__property Classes::TNotifyEvent OnStartProcess = {read=FOnStartProcess, write=FOnStartProcess};
	__property Classes::TNotifyEvent OnEndProcess = {read=FOnEndProcess, write=FOnEndProcess};
	__fastcall TSearchFolderThread(AnsiString AFolderName, AnsiString AFileMask, AnsiString AStringToSearch
		, bool ACaseSensitive, TSearchScope ASearchScope, bool AFileNamesOnly);
