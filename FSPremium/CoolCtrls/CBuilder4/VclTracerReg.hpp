...
// (DO NOT EDIT: machine generated header) 'VclTracerReg.pas' rev: 4.00
...
protected:
	...
	/* TPropertyEditor.Create */ inline __fastcall TGlobalWinControlProperty(const Dsgnintf::_di_IFormDesigner 
