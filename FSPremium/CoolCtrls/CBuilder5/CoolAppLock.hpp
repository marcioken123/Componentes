...
// (DO NOT EDIT: machine generated header) 'CoolAppLock.pas' rev: 5.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TAppRunEvent)(System::TObject* Sender, AnsiString AppPath, bool 
	&AllowRun);
