...
// (DO NOT EDIT: machine generated header) 'CoolCtrls.pas' rev: 5.00
...
protected:
	...
	virtual void __fastcall DrawItem(int Index, const Windows::TRect &Recty, Windows::TOwnerDrawState State
		);
...
protected:
	...
	DYNAMIC void __fastcall AdjustBounds(void);
	DYNAMIC void __fastcall AdjustSize(void);
	virtual void __fastcall DoDrawText(Graphics::TCanvas* Canv, Windows::TRect &Recty, Word Flags);
