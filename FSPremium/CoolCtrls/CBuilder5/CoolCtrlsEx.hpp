...
// (DO NOT EDIT: machine generated header) 'CoolCtrlsEx.pas' rev: 5.00
...
protected:
	...
	void __fastcall MyAdvancedCustomDrawItem(Comctrls::TCustomListView* Sender, Comctrls::TListItem* Item
		, Comctrls::TCustomDrawState State, Comctrls::TCustomDrawStage Stage, bool &DefaultDraw);
