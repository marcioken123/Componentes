...
// (DO NOT EDIT: machine generated header) 'ColorListUnit.pas' rev: 6.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TColorListForm(Classes::TComponent* AOwner) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TColorListForm(Classes::TComponent* AOwner, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TColorListForm(HWND ParentWindow) : Forms::TForm(ParentWindow) { }
	#pragma option pop
