...
// (DO NOT EDIT: machine generated header) 'CoolLists.pas' rev: 6.00
...
public:
	Types::TPoint operator[](int Index) { return Items[Index]; }
...
protected:
	virtual void __fastcall DefineProperties(Classes::TFiler* Filer);
	int __fastcall GetCount(void);
	Types::TPoint __fastcall GetItem(int Index);
	void __fastcall SetItem(int Index, const Types::TPoint &Value);
	virtual void __fastcall Changed(void);
	
public:
	__fastcall TPointList(void);
	__fastcall virtual ~TPointList(void);
	virtual void __fastcall Add(const Types::TPoint &Value);
	virtual void __fastcall AddPoints(TPointList* Value);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	virtual void __fastcall Clear(void);
	virtual void __fastcall Delete(int Index);
	virtual void __fastcall Exchange(int Index1, int Index2);
	virtual int __fastcall IndexOf(const Types::TPoint &Value);
	virtual void __fastcall Insert(int Index, const Types::TPoint &Value);
	virtual void __fastcall Move(int CurIndex, int NewIndex);
	__property int Count = {read=GetCount, nodefault};
	__property Types::TPoint Items[int Index] = {read=GetItem, write=SetItem/*, default*/};
	__property Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
};
...
public:
	...
	virtual void __fastcall Add(const Types::TRect &Value);
	virtual void __fastcall AddRects(TRectList* Value);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	virtual void __fastcall Clear(void);
	virtual void __fastcall Delete(int Index);
	virtual void __fastcall Exchange(int Index1, int Index2);
	virtual int __fastcall IndexOf(const Types::TRect &Value);
	virtual void __fastcall Insert(int Index, const Types::TRect &Value);
	virtual void __fastcall Move(int CurIndex, int NewIndex);
	__property int Count = {read=GetCount, nodefault};
...
public:
	TPixelData operator[](int Index) { return Items[Index]; }
