...
// (DO NOT EDIT: machine generated header) 'CoolPolygons.pas' rev: 6.00
...
typedef void __fastcall (__closure *TPolygonEvent)(System::TObject* Sender, int Index, const Types::TPoint &Pt);
...
private:
	...
	bool __fastcall PointOnSide(Types::TPoint &PointActive, Types::TPoint &PointBefore, Types::TPoint &PointAfter);
	bool __fastcall PointOnHandle(Types::TPoint &PointActive, Types::TPoint &PointBefore, Types::TPoint &PointAfter);
...
public:
	...
	__fastcall virtual TSinglePolygon(Classes::TCollection* ACollection, Graphics::TColor AColor, Graphics::TColor ALineColor, Graphics::TColor AHandleColor, Coollists::TPointList* APoints, bool ATransparent)/* overload */;
	__fastcall virtual ~TSinglePolygon(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	bool __fastcall PointWithinPolygon(const Types::TPoint &PointActive);
...
public:
	TSinglePolygon* operator[](int Index) { return Items[Index]; }
...
public:
	...
	HIDESBASE TSinglePolygon* __fastcall Add(Graphics::TColor AColor, Graphics::TColor ALineColor, Graphics::TColor AHandleColor, Coollists::TPointList* APoints, bool ATransparent);
...
private:
	...
	#pragma pack(push, 1)
	Types::TPoint FActivePoint;
	#pragma pack(pop)
	
	#pragma pack(push, 1)
	Types::TPoint FPrevPoint;
	#pragma pack(pop)
	
	#pragma pack(push, 1)
	Types::TPoint FNextPoint;
	#pragma pack(pop)
	...
	void __fastcall PaintEditHandle(Graphics::TCanvas* Canv, const Types::TPoint &Pt);
...
public:
	...
	__property Graphics::TColor DefEditHandleColor = {read=FDefEditHandleColor, write=FDefEditHandleColor, default=255};
	__property Graphics::TColor DefNormalLineColor = {read=FDefNormalLineColor, write=FDefNormalLineColor, default=0};
	__property Graphics::TColor DefNormalHandleColor = {read=FDefNormalHandleColor, write=FDefNormalHandleColor, default=0};
...
__published:
	...
	__property DefColor  = {default=-2147483633};
	__property DefEditLineColor  = {default=255};
	__property DefEditHandleColor  = {default=255};
	__property DefNormalLineColor  = {default=0};
	__property DefNormalHandleColor  = {default=0};
	__property Editable  = {default=1};
	__property EditMode  = {default=7};
	__property HandleSize  = {default=3};
...
public:
	#pragma option push -w-inl
	/* TCustomPolygones.Create */ inline __fastcall virtual TCoolPolygones(Classes::TComponent* AOwner) : TCustomPolygones(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE void __fastcall ArrayFromList(Types::TPoint * AArray, const int AArray_Size, Coollists::TPointList* AList);
extern PACKAGE void __fastcall PolyRects(Graphics::TCanvas* Canvas, Coollists::TPointList* Points, int Offset);
