...
// (DO NOT EDIT: machine generated header) 'CoolScrollbar.pas' rev: 6.00
...
private:
	...
	#pragma pack(push, 1)
	Types::TRect FRulesRect;
	#pragma pack(pop)
	
	#pragma pack(push, 1)
	Types::TRect FUpBtnRect;
	#pragma pack(pop)
	
	#pragma pack(push, 1)
	Types::TRect FDnBtnRect;
	#pragma pack(pop)
...
protected:
	...
	DYNAMIC void __fastcall MouseUp(Controls::TMouseButton Btn, Classes::TShiftState Shift, int X, int Y);
	...
	bool __fastcall PointInsideRect(const Types::TRect &Rc, int X, int Y);
...
public:
	...
	/* TWinControl.CreateParented */ inline __fastcall TCoolScrollbar(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TDBCoolScrollbar(HWND ParentWindow) : TCoolScrollbar(ParentWindow) { }
	#pragma option pop
