...
// (DO NOT EDIT: machine generated header) 'CoolSplitter.pas' rev: 6.00
...
private:
	...
	Types::TRect __fastcall DrawBounds(Graphics::TCanvas* Canvas, const Types::TRect &Bounds, const Graphics::TColor AUpperLeftColor, const Graphics::TColor ALowerRightColor);
...
__published:
	...
	__property PositionAfterOpen PositionAfterOpen = {read=FPositionAfterOpen, write=FPositionAfterOpen, nodefault};
	...
	__property Graphics::TColor SpotHighlightColor = {read=FSpotHighlightColor, write=FSpotHighlightColor, default=-2147483628};
