...
// (DO NOT EDIT: machine generated header) 'MsgTracer.pas' rev: 6.00
...
__published:
	...
	void __fastcall MsgGridDrawCell(System::TObject* Sender, int Col, int Row, const Types::TRect &Recty, Grids::TGridDrawState State);
...
public:
	...
	/* TCustomForm.CreateNew */ inline __fastcall virtual TTracerForm(Classes::TComponent* AOwner, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	#pragma option pop
