...
// (DO NOT EDIT: machine generated header) 'CoolDBUtilsReg.pas' rev: 5.00
...
protected:
	#pragma option push -w-inl
	/* TPropertyEditor.Create */ inline __fastcall virtual TDBCUAboutProperty(const Dsgnintf::_di_IFormDesigner 
