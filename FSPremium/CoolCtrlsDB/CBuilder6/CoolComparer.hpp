...
// (DO NOT EDIT: machine generated header) 'CoolComparer.pas' rev: 6.00
...
#pragma option push -b-
enum TComparePosition { compByCons, compByVow, compByDig, compByPart, compByConsByPart, compByVowByPart, compByDigByPart };
#pragma option pop
...
public:
	...
	void __fastcall AssignData(Classes::TStrings* AFieldList, Classes::TStrings* ADataList, Classes::TStrings* APriorityList);
