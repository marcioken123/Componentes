...
// (DO NOT EDIT: machine generated header) 'CoolDBUtils.pas' rev: 6.00
...
typedef void __fastcall (__closure *TActionInProgress)(System::TObject* Sender, int TablesNum, AnsiString CurName, int CurNum);
...
__published:
	...
	__property TablesAction  = {default=0};
	__property Tables ;
...
public:
	#pragma option push -w-inl
	/* TCoolDBComponent.Create */ inline __fastcall virtual TCoolDBPack(Classes::TComponent* AOwner) : TCoolDBComponent(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
typedef void __fastcall (__closure *TTableSortEvent)(System::TObject* Sender, Dbtables::TTable* Table, int &SortFieldIdx, TSortType &SortType);
...
public:
	#pragma option push -w-inl
	/* TCoolDBComponent.Create */ inline __fastcall virtual TCoolDBStructureExporter(Classes::TComponent* AOwner) : TCoolDBComponent(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TCoolDBComponent.Create */ inline __fastcall virtual TCoolDBStructureRestorer(Classes::TComponent* AOwner) : TCoolDBComponent(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
#pragma option push -b-
enum TResultType { rtFieldsUniqueOne, rtFieldsUniqueTwo, rtFieldsAlike, rtFieldsDifferent, rtIndexesUniqueOne, rtIndexesUniqueTwo, rtIndexesAlike, rtIndexesDifferent, rtRIntsUniqueOne, rtRIntsUniqueTwo, rtRIntsAlike, rtRIntsDifferent };
#pragma option pop
...
private:
	TDBCUAboutBox* FAboutBox;
	Bde::SYSVersion __fastcall GetBDEVersionInfo();
	...
	Bde::SYSInfo __fastcall GetBDEInfo();
	...
	Bde::SYSConfig __fastcall GetBDEConfigInfo();
	bool __fastcall GetBDELocalShare(void);
	AnsiString __fastcall GetBDENetType();
	AnsiString __fastcall GetBDEUserName();
	AnsiString __fastcall GetBDEIniFile();
	AnsiString __fastcall GetBDELangDriver();
...
public:
	#pragma option push -w-inl
	/* TComponent.Create */ inline __fastcall virtual TCoolBDEInformant(Classes::TComponent* AOwner) : Classes::TComponent(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE void __fastcall CopyTable(Dbtables::TTable* &Table, AnsiString SrcTableName, AnsiString DestName);
...
extern PACKAGE void __fastcall ChangeField(Dbtables::TTable* Table, Db::TField* Field, Bde::pFLDDesc FieldsDesc);
...
extern PACKAGE bool __fastcall GetFieldDesc(Dbtables::TTable* Table, AnsiString FieldName, Bde::FLDDesc &FieldDesc);
...
extern PACKAGE void __fastcall ChangeIndex(Dbtables::TTable* Table, const Bde::IDXDesc &IndexDesc, int Index);
extern PACKAGE Classes::TStringList* __fastcall GetIndexes(Dbtables::TTable* Table);
extern PACKAGE bool __fastcall GetIndexDesc(Dbtables::TTable* Table, AnsiString IndexName, Bde::IDXDesc &IndexDesc);
...
extern PACKAGE bool __fastcall GetRIDesc(Dbtables::TTable* Table, AnsiString RiName, Bde::RINTDesc &RiDesc);
