...
// (DO NOT EDIT: machine generated header) 'CoolUtility.pas' rev: 6.00
...
enum TUVerifyProcess { TUVerifyHeader, TUVerifyIndex, TUVerifyData, TUVerifySXHeader, TUVerifySXIndex, TUVerifySXData, TUVerifySXIntegrity, TUVerifyTableName, TURebuild };
#pragma option pop
...
extern PACKAGE Word __stdcall (*TUVerifyTable)(Word hTUSession, char * pszTableName, char * pszDriverType, char * pszErrTableName, char * pszPassword, int iOptions, int &piErrorLevel);
extern PACKAGE Word __stdcall (*TURebuildTable)(Word hTUSession, char * pszTableName, char * pszDriverType, char * pszBackupTableName, char * pszKeyviolName, char * pszProblemTableName, Bde::pCRTblDesc pCrDesc);
extern PACKAGE Word __stdcall (*TUGetCRTblDescCount)(Word hTUSession, char * pszTableName, Word &iFldCount, Word &iIdxCount, Word &iSecRecCount, Word &iValChkCount, Word &iRintCount, Word &iOptParams, Word &iOptDataLen);
extern PACKAGE Word __stdcall (*TUFillCRTblDesc)(Word hTUSession, Bde::pCRTblDesc pCrDesc, char * pszTableName, char * pszPassword);
extern PACKAGE Word __stdcall (*TUFillCURProps)(Word hTUSession, char * pszTableName, Bde::CURProps &tblProps);
extern PACKAGE Word __stdcall (*TUGetExtTblProps)(Word hTUSession, char * pszTableName, double &pTS, bool &pbReadOnly);
