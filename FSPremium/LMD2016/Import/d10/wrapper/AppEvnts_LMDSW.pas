...
uses
  ...
  LMDSctSysWrappers, Windows, Messages, SysUtils, Classes, Forms, ActnList,
  AppEvnts, Windows_LMDSW, Messages_LMDSW, SysUtils_LMDSW, Classes_LMDSW,
  Forms_LMDSW, ActnList_LMDSW;
