...
uses
  ...
  LMDSctSysWrappers, Messages, Windows, SysUtils, CommCtrl, Classes, Controls,
  Forms, Menus, Graphics, StdCtrls, RichEdit, ToolWin, ImgList, ExtCtrls,
  ListActns, GraphUtil, ComCtrls, Messages_LMDSW, Windows_LMDSW,
