...
uses
  ...
  StdCtrls, ActnList, CheckLst, ComCtrls, Menus, ExtCtrls, ImgList, ActnMan,
  ActnCtrls, ActnMenus, Buttons, CustomizeDlg, Windows_LMDSW, Messages_LMDSW,
  SysUtils_LMDSW, Variants_LMDSW, Classes_LMDSW, Graphics_LMDSW,
  Controls_LMDSW, Forms_LMDSW, Dialogs_LMDSW, StdCtrls_LMDSW, ActnList_LMDSW,
  CheckLst_LMDSW, ComCtrls_LMDSW, Menus_LMDSW, ExtCtrls_LMDSW, ImgList_LMDSW,
  ActnMan_LMDSW, ActnCtrls_LMDSW, ActnMenus_LMDSW, Buttons_LMDSW;
