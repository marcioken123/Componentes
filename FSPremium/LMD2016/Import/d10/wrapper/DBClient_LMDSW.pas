...
uses
  ...
  SysUtils, Variants, Classes, DB, DBCommon, DBCommonTypes, DBClient,
...
begin
  ...
  AData.AddProperty('Ranged', TCustomClientDataSet_Ranged_si, Boolean_sw, True, False, 0, True, False);
...
begin
  ...
  AData.AddPropertyRedecl('Ranged', False);
end;
