...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'DB' unit.
  #
  # WARNING:
...
uses
  TypInfo, LMDTypes, LMDSctScripter, LMDSctWrappers, LMDSctSysWrappers, Windows,
  SysUtils, Classes, Variants, MaskUtils, DBCommonTypes, WideStrings, DB,
  Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW, Variants_LMDSW,
  MaskUtils_LMDSW, DBCommonTypes_LMDSW, WideStrings_LMDSW;
...
type
  ...
  TFlatList_sw = class(TWideStringList_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  ...
  TWideDataSet_sc = class of TWideDataSet;
  TWideDataSet_sw = class(TDataSet_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TWideDataSet): OleVariant;
    class function FromVar(const AValue: OleVariant): TWideDataSet;
    class function ClassToVar(AClass: TWideDataSet_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TWideDataSet_sc;
  end;

  TDateTimeAlias_sw = TDateTime_sw;
...
type
  ...
  TDataSource_sacc = class(TDataSource);
...
begin
  ...
  AData.AddProperty('Context', EUpdateError_Context_si, string_sw, True, False, 0, False);
  AData.AddProperty('ErrorCode', EUpdateError_ErrorCode_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('PreviousError', EUpdateError_PreviousError_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('OriginalException', EUpdateError_OriginalException_si, Exception_sw, True, False, 0, False);
...
class function TFieldType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
...
class function TDataSetState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDataSetState);
end;
...
class function TDataEvent_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDataEvent);
end;
...
class function TUpdateStatus_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TUpdateStatus);
end;
...
class function TUpdateAction_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TUpdateAction);
end;
...
class function TUpdateMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TUpdateMode);
end;
...
class function TUpdateKind_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TUpdateKind);
end;
...
begin
  ...
  AData.AddProperty('StreamedConnected', TCustomConnection_StreamedConnected_si, Boolean_sw, True, True, 0, True);
  AData.AddProcedure('Open', TCustomConnection_Open_si, 0, False);
  AData.AddProcedure('Close', TCustomConnection_Close_si, 0, False);
  AData.AddProperty('Connected', TCustomConnection_Connected_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DataSets', TCustomConnection_DataSets_si, TDataSet_sw, True, False, 1, False);
  AData.AddProperty('DataSetCount', TCustomConnection_DataSetCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('LoginPrompt', TCustomConnection_LoginPrompt_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AfterConnect', TCustomConnection_AfterConnect_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforeConnect', TCustomConnection_BeforeConnect_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterDisconnect', TCustomConnection_AfterDisconnect_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforeDisconnect', TCustomConnection_BeforeDisconnect_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnLogin', TCustomConnection_OnLogin_si, TLoginEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  if IsGet then
    ...
    TNamedItem(AObj).Name := WideString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Name', TNamedItem_Name_si, WideString_sw, True, True, 0, False);
end;
...
begin
  ...
  Result := TNamedItem_sw.ToVar(TDefCollection(AObj).Find(WideString(
    AArgs[0])));
end;
...
begin
  ...
  Result := TDefCollection(AObj).IndexOf(WideString(AArgs[0]));
end;
...
begin
  ...
  AData.AddProperty('OnUpdate', TDefCollection_OnUpdate_si, TNotifyEvent_sw, True, True, 0, True);
  ...
  AData.AddProperty('DataSet', TDefCollection_DataSet_si, TDataSet_sw, True, False, 0, False);
  AData.AddProperty('Updated', TDefCollection_Updated_si, Boolean_sw, True, True, 0, False);
...
class function TFieldAttribute_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFieldAttribute);
end;
...
begin
  ...
  Result := TField_sw.ToVar(TFieldDef(AObj).CreateField(TComponent_sw.FromVar(
    AArgs[0]), TObjectField_sw.FromVar(AArgs[1]), WideString(AArgs[2]), Boolean(
    AArgs[3])));
end;
...
begin
  ...
  AData.AddFunction('CreateField', TFieldDef_CreateField_si, TField_sw, 4, False);
  AData.AddFunction('HasChildDefs', TFieldDef_HasChildDefs_si, Boolean_sw, 0, False);
  AData.AddProperty('FieldClass', TFieldDef_FieldClass_si, TFieldClass_sw, True, False, 0, False);
  AData.AddProperty('FieldNo', TFieldDef_FieldNo_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('InternalCalcField', TFieldDef_InternalCalcField_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ParentDef', TFieldDef_ParentDef_si, TFieldDef_sw, True, False, 0, False);
  AData.AddProperty('Required', TFieldDef_Required_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Attributes', TFieldDef_Attributes_si, TFieldAttributes_sw, True, True, 0, False);
  AData.AddProperty('ChildDefs', TFieldDef_ChildDefs_si, TFieldDefs_sw, True, True, 0, False);
  AData.AddProperty('DataType', TFieldDef_DataType_si, TFieldType_sw, True, True, 0, False);
  AData.AddProperty('Precision', TFieldDef_Precision_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Size', TFieldDef_Size_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProcedure('Add', TFieldDefs_Add_si, 4, False);
  AData.AddProperty('HiddenFields', TFieldDefs_HiddenFields_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Items', TFieldDefs_Items_si, TFieldDef_sw, True, True, 1, False);
  AData.AddProperty('ParentDef', TFieldDefs_ParentDef_si, TFieldDef_sw, True, False, 0, False);
...
class function TIndexOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TIndexOption);
end;
...
function TIndexDef_Fields_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Fields: WideString read <getter> write <setter>;

  if IsGet then
    Result := TIndexDef(AObj).Fields
  else
    TIndexDef(AObj).Fields := WideString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('FieldExpression', TIndexDef_FieldExpression_si, string_sw, True, False, 0, False);
  AData.AddProperty('CaseInsFields', TIndexDef_CaseInsFields_si, string_sw, True, True, 0, False);
  AData.AddProperty('DescFields', TIndexDef_DescFields_si, string_sw, True, True, 0, False);
  AData.AddProperty('Expression', TIndexDef_Expression_si, string_sw, True, True, 0, False);
  AData.AddProperty('Fields', TIndexDef_Fields_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('Options', TIndexDef_Options_si, TIndexOptions_sw, True, True, 0, False);
  AData.AddProperty('Source', TIndexDef_Source_si, string_sw, True, True, 0, False);
  AData.AddProperty('GroupingLevel', TIndexDef_GroupingLevel_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Items', TIndexDefs_Items_si, TIndexDef_sw, True, True, 1, False);
...
begin
  ...
  AData.AddProperty('Updated', TFlatList_Updated_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Locked', TFlatList_Locked_si, Boolean_sw, True, True, 0, True);
  AData.AddProcedure('Update', TFlatList_Update_si, 0, False);
  AData.AddProperty('DataSet', TFlatList_DataSet_si, TDataSet_sw, True, False, 0, False);
...
begin
  ...
  Result := TFieldDef_sw.ToVar(TFieldDefList(AObj).FieldByName(WideString(
    AArgs[0])));
end;
...
function TFieldDefList_Find_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Find(const Name: WideString): TFieldDef;

  Result := TFieldDef_sw.ToVar(TFieldDefList(AObj).Find(WideString(AArgs[0])));
end;
...
begin
  ...
  AData.AddProperty('FieldDefs', TFieldDefList_FieldDefs_si, TFieldDef_sw, True, False, 1, False);
end;
...
function TFieldList_Find_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Find(const Name: WideString): TField;

  Result := TField_sw.ToVar(TFieldList(AObj).Find(WideString(AArgs[0])));
end;
...
begin
  ...
  AData.AddProperty('Fields', TFieldList_Fields_si, TField_sw, True, False, 1, False);
end;
...
begin
  ...
  AData.AddProperty('Current', TFieldsEnumerator_Current_si, TField_sw, True, False, 0, False);
...
class function TFieldKind_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFieldKind);
end;
...
begin
  ...
  TFields(AObj).CheckFieldName(WideString(AArgs[0]));
end;
...
begin
  ...
  TFields(AObj).CheckFieldNames(WideString(AArgs[0]));
end;
...
begin
  ...
  Result := TField_sw.ToVar(TFields(AObj).FindField(WideString(AArgs[0])));
end;
...
begin
  ...
  Result := TField_sw.ToVar(TFields(AObj).FieldByName(WideString(AArgs[0])));
end;
...
begin
  ...
  AData.AddProperty('SparseFields', TFields_SparseFields_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('OnChange', TFields_OnChange_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('ValidFieldKinds', TFields_ValidFieldKinds_si, TFieldKinds_sw, True, True, 0, True);
  ...
  AData.AddProperty('Count', TFields_Count_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('DataSet', TFields_DataSet_si, TDataSet_sw, True, False, 0, False);
  AData.AddProperty('Fields', TFields_Fields_si, TField_sw, True, True, 1, False);
...
class function TProviderFlag_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TProviderFlag);
end;
...
class function TAutoRefreshFlag_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TAutoRefreshFlag);
end;
...
begin
  ...
  if IsGet then
    ...
    TLookupListEntry_sw(AObj).FValue.Key := Variant(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    TLookupListEntry_sw(AObj).FValue.Value := Variant(AArgs[0]);
end;
...
begin
  ...
  AData.AddFunction('Copy', TLookupListEntry_Copy_si, TLookupListEntry_sw, 0);
  AData.AddField('Key', TLookupListEntry_Key_si, Variant_sw);
  AData.AddField('Value', TLookupListEntry_Value_si, Variant_sw);

  { Class members }

  AData.AddConstructor('Create', TLookupListEntry_Create_si, 0);
end;
...
begin
  ...
  TLookupList(AObj).Add(Variant(AArgs[0]), Variant(AArgs[1]));
end;
...
begin
  ...
  Result := TLookupList(AObj).ValueOfKey(Variant(AArgs[0]));
end;
...
function TField_AsWideString_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property AsWideString: WideString read <getter> write <se...

  if IsGet then
    Result := TField(AObj).AsWideString
  else
    TField(AObj).AsWideString := WideString(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    TField(AObj).AsVariant := Variant(AArgs[0]);
end;
...
function TField_DisplayName_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DisplayName: WideString read <getter>;
...
function TField_FullName_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property FullName: WideString read <getter>;
...
begin
  ...
  if IsGet then
    ...
    TField(AObj).NewValue := Variant(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    TField(AObj).Value := Variant(AArgs[0]);
end;
...
function TField_DisplayLabel_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DisplayLabel: WideString read <getter> write <se...

  if IsGet then
    Result := TField(AObj).DisplayLabel
  else
    TField(AObj).DisplayLabel := WideString(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    TField(AObj).FieldName := WideString(AArgs[0]);
end;
...
function TField_LookupKeyFields_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property LookupKeyFields: WideString read <getter> write ...

  if IsGet then
    Result := TField(AObj).LookupKeyFields
  else
    TField(AObj).LookupKeyFields := WideString(AArgs[0]);
end;

function TField_LookupResultField_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property LookupResultField: WideString read <getter> writ...

  if IsGet then
    Result := TField(AObj).LookupResultField
  else
    TField(AObj).LookupResultField := WideString(AArgs[0]);
end;

function TField_KeyFields_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property KeyFields: WideString read <getter> write <setter>;

  if IsGet then
    Result := TField(AObj).KeyFields
  else
    TField(AObj).KeyFields := WideString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('AsBoolean', TField_AsBoolean_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AsCurrency', TField_AsCurrency_si, Currency_sw, True, True, 0, False);
  AData.AddProperty('AsDateTime', TField_AsDateTime_si, TDateTime_sw, True, True, 0, False);
  AData.AddProperty('AsFloat', TField_AsFloat_si, Double_sw, True, True, 0, False);
  AData.AddProperty('AsInteger', TField_AsInteger_si, Longint_sw, True, True, 0, False);
  AData.AddProperty('AsString', TField_AsString_si, string_sw, True, True, 0, False);
  AData.AddProperty('AsWideString', TField_AsWideString_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('AsVariant', TField_AsVariant_si, Variant_sw, True, True, 0, False);
  AData.AddProperty('AttributeSet', TField_AttributeSet_si, string_sw, True, True, 0, False);
  AData.AddProperty('Calculated', TField_Calculated_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('CanModify', TField_CanModify_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('CurValue', TField_CurValue_si, Variant_sw, True, False, 0, False);
  AData.AddProperty('DataSet', TField_DataSet_si, TDataSet_sw, True, True, 0, False);
  AData.AddProperty('DataSize', TField_DataSize_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('DataType', TField_DataType_si, TFieldType_sw, True, False, 0, False);
  AData.AddProperty('DisplayName', TField_DisplayName_si, WideString_sw, True, False, 0, False);
  AData.AddProperty('DisplayText', TField_DisplayText_si, string_sw, True, False, 0, False);
  AData.AddProperty('EditMask', TField_EditMask_si, TEditMask_sw, True, True, 0, False);
  AData.AddProperty('EditMaskPtr', TField_EditMaskPtr_si, TEditMask_sw, True, False, 0, False);
  AData.AddProperty('FieldNo', TField_FieldNo_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('FullName', TField_FullName_si, WideString_sw, True, False, 0, False);
  AData.AddProperty('IsIndexField', TField_IsIndexField_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('IsNull', TField_IsNull_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Lookup', TField_Lookup_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('LookupList', TField_LookupList_si, TLookupList_sw, True, False, 0, False);
  AData.AddProperty('NewValue', TField_NewValue_si, Variant_sw, True, True, 0, False);
  AData.AddProperty('Offset', TField_Offset_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('OldValue', TField_OldValue_si, Variant_sw, True, False, 0, False);
  AData.AddProperty('ParentField', TField_ParentField_si, TObjectField_sw, True, True, 0, False);
  AData.AddProperty('Size', TField_Size_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Text', TField_Text_si, string_sw, True, True, 0, False);
  AData.AddProperty('ValidChars', TField_ValidChars_si, TFieldChars_sw, True, True, 0, False);
  AData.AddProperty('Value', TField_Value_si, Variant_sw, True, True, 0, False);
  AData.AddProperty('Alignment', TField_Alignment_si, TAlignment_sw, True, True, 0, False);
  AData.AddProperty('AutoGenerateValue', TField_AutoGenerateValue_si, TAutoRefreshFlag_sw, True, True, 0, False);
  AData.AddProperty('CustomConstraint', TField_CustomConstraint_si, string_sw, True, True, 0, False);
  AData.AddProperty('ConstraintErrorMessage', TField_ConstraintErrorMessage_si, string_sw, True, True, 0, False);
  AData.AddProperty('DefaultExpression', TField_DefaultExpression_si, string_sw, True, True, 0, False);
  AData.AddProperty('DisplayLabel', TField_DisplayLabel_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DisplayWidth', TField_DisplayWidth_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('FieldKind', TField_FieldKind_si, TFieldKind_sw, True, True, 0, False);
  AData.AddProperty('FieldName', TField_FieldName_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('HasConstraints', TField_HasConstraints_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Index', TField_Index_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ImportedConstraint', TField_ImportedConstraint_si, string_sw, True, True, 0, False);
  AData.AddProperty('LookupDataSet', TField_LookupDataSet_si, TDataSet_sw, True, True, 0, False);
  AData.AddProperty('LookupKeyFields', TField_LookupKeyFields_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('LookupResultField', TField_LookupResultField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('KeyFields', TField_KeyFields_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('LookupCache', TField_LookupCache_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Origin', TField_Origin_si, string_sw, True, True, 0, False);
  AData.AddProperty('ProviderFlags', TField_ProviderFlags_si, TProviderFlags_sw, True, True, 0, False);
  AData.AddProperty('ReadOnly', TField_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Required', TField_Required_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Visible', TField_Visible_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnChange', TField_OnChange_si, TFieldNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnGetText', TField_OnGetText_si, TFieldGetTextEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSetText', TField_OnSetText_si, TFieldSetTextEvent_sw, True, True, 0, False);
  AData.AddProperty('OnValidate', TField_OnValidate_si, TFieldNotifyEvent_sw, True, True, 0, False);
...
begin
  ...
  if IsGet then
    ...
    TStringField(AObj).Value := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Value', TStringField_Value_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('EditMask');
  AData.AddProperty('FixedChar', TStringField_FixedChar_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Size');
  AData.AddProperty('Transliterate', TStringField_Transliterate_si, Boolean_sw, True, True, 0, False);
end;
...
function TWideStringField_Value_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Value: WideString read <getter> write <setter>;

  if IsGet then
    Result := TWideStringField(AObj).Value
  else
    TWideStringField(AObj).Value := WideString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Value', TWideStringField_Value_si, WideString_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('DisplayFormat', TNumericField_DisplayFormat_si, string_sw, True, True, 0, False);
  AData.AddProperty('EditFormat', TNumericField_EditFormat_si, string_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Value', TIntegerField_Value_si, Longint_sw, True, True, 0, False);
  AData.AddProperty('MaxValue', TIntegerField_MaxValue_si, Longint_sw, True, True, 0, False);
  AData.AddProperty('MinValue', TIntegerField_MinValue_si, Longint_sw, True, True, 0, False);
end;
...
function TLargeintField_AsLargeInt_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property AsLargeInt: LargeInt read <getter> write <setter>;

  if IsGet then
    Result := LargeInt_sw.ToVar(TLargeintField(AObj).AsLargeInt)
  else
    TLargeintField(AObj).AsLargeInt := LargeInt_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('AsLargeInt', TLargeintField_AsLargeInt_si, LargeInt_sw, True, True, 0, False);
  AData.AddProperty('Value', TLargeintField_Value_si, Largeint_sw, True, True, 0, False);
  AData.AddProperty('MaxValue', TLargeintField_MaxValue_si, Largeint_sw, True, True, 0, False);
  AData.AddProperty('MinValue', TLargeintField_MinValue_si, Largeint_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Value', TFloatField_Value_si, Double_sw, True, True, 0, False);
  AData.AddProperty('currency', TFloatField_currency_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('MaxValue', TFloatField_MaxValue_si, Double_sw, True, True, 0, False);
  AData.AddProperty('MinValue', TFloatField_MinValue_si, Double_sw, True, True, 0, False);
  AData.AddProperty('Precision', TFloatField_Precision_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('currency');
end;
...
begin
  ...
  AData.AddProperty('Value', TBooleanField_Value_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DisplayValues', TBooleanField_DisplayValues_si, string_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Value', TDateTimeField_Value_si, TDateTime_sw, True, True, 0, False);
  AData.AddProperty('DisplayFormat', TDateTimeField_DisplayFormat_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('EditMask');
end;
...
begin
  ...
  AData.AddProperty('DisplayFormat', TSQLTimeStampField_DisplayFormat_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('EditMask');
end;
...
begin
  ...
  AData.AddProperty('Value', TBCDField_Value_si, Currency_sw, True, True, 0, False);
  AData.AddProperty('currency', TBCDField_currency_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('MaxValue', TBCDField_MaxValue_si, Currency_sw, True, True, 0, False);
  AData.AddProperty('MinValue', TBCDField_MinValue_si, Currency_sw, True, True, 0, False);
  AData.AddProperty('Precision', TBCDField_Precision_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Size');
end;
...
begin
  ...
  AData.AddProperty('currency', TFMTBCDField_currency_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('MaxValue', TFMTBCDField_MaxValue_si, string_sw, True, True, 0, False);
  AData.AddProperty('MinValue', TFMTBCDField_MinValue_si, string_sw, True, True, 0, False);
  AData.AddProperty('Precision', TFMTBCDField_Precision_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Size');
end;
...
function TBlobField_Value_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Value: string read <getter> write <setter>;

  if IsGet then
    Result := TBlobField(AObj).Value
  else
    TBlobField(AObj).Value := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('BlobSize', TBlobField_BlobSize_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Modified', TBlobField_Modified_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Value', TBlobField_Value_si, string_sw, True, True, 0, False);
  AData.AddProperty('Transliterate', TBlobField_Transliterate_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('BlobType', TBlobField_BlobType_si, TBlobType_sw, True, True, 0, False);
  AData.AddProperty('GraphicHeader', TBlobField_GraphicHeader_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Size');
end;
...
begin
  ...
  AData.AddPropertyRedecl('Transliterate');
end;
...
begin
  ...
  if IsGet then
    ...
    TWideMemoField(AObj).Value := WideString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Value', TWideMemoField_Value_si, WideString_sw, True, True, 0, False);
end;
...
begin
  ...
  if IsGet then
    ...
    TObjectField(AObj).FieldValues[Integer(AArgs[0])] := Variant(AArgs[1]);
end;
...
function TObjectField_ObjectType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property ObjectType: WideString read <getter> write <sett...

  if IsGet then
    Result := TObjectField(AObj).ObjectType
  else
    TObjectField(AObj).ObjectType := WideString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('FieldCount', TObjectField_FieldCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Fields', TObjectField_Fields_si, TFields_sw, True, False, 0, False);
  AData.AddProperty('FieldValues', TObjectField_FieldValues_si, Variant_sw, True, True, 1, False);
  AData.AddProperty('UnNamed', TObjectField_UnNamed_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('ObjectType', TObjectField_ObjectType_si, WideString_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('NestedDataSet', TDataSetField_NestedDataSet_si, TDataSet_sw, True, False, 0, False);
  AData.AddProperty('IncludeObjectField', TDataSetField_IncludeObjectField_si, Boolean_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('ReferenceTableName', TReferenceField_ReferenceTableName_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Size');
end;
...
function TAggregateField_DisplayName_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DisplayName: WideString read <getter> write <set...

  if IsGet then
    Result := TAggregateField(AObj).DisplayName
  else
    TAggregateField(AObj).DisplayName := WideString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('ResultType', TAggregateField_ResultType_si, TFieldType_sw, True, True, 0, False);
  AData.AddProperty('Active', TAggregateField_Active_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('currency', TAggregateField_currency_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DisplayName', TAggregateField_DisplayName_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DisplayFormat', TAggregateField_DisplayFormat_si, string_sw, True, True, 0, False);
  AData.AddProperty('Expression', TAggregateField_Expression_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('FieldKind');
  AData.AddProperty('GroupingLevel', TAggregateField_GroupingLevel_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('IndexName', TAggregateField_IndexName_si, string_sw, True, True, 0, False);
  AData.AddProperty('Precision', TAggregateField_Precision_si, Integer_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('VisualControl', TDataLink_VisualControl_si, Boolean_sw, True, True, 0, True);
  ...
  AData.AddProperty('Active', TDataLink_Active_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('ActiveRecord', TDataLink_ActiveRecord_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('BOF', TDataLink_BOF_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('BufferCount', TDataLink_BufferCount_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('DataSet', TDataLink_DataSet_si, TDataSet_sw, True, False, 0, False);
  AData.AddProperty('DataSource', TDataLink_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddProperty('DataSourceFixed', TDataLink_DataSourceFixed_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Editing', TDataLink_Editing_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Eof', TDataLink_Eof_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('ReadOnly', TDataLink_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('RecordCount', TDataLink_RecordCount_si, Integer_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('DetailDataSet', TDetailDataLink_DetailDataSet_si, TDataSet_sw, True, False, 0, False);
end;
...
function TMasterDataLink_Fields_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Fields: TList read <getter>;

  Result := TList_sw.ToVar(TMasterDataLink(AObj).Fields);
end;
...
begin
  ...
  AData.AddProperty('FieldNames', TMasterDataLink_FieldNames_si, string_sw, True, True, 0, False);
  AData.AddProperty('Fields', TMasterDataLink_Fields_si, TList_sw, True, False, 0, False);
  AData.AddProperty('OnMasterChange', TMasterDataLink_OnMasterChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnMasterDisable', TMasterDataLink_OnMasterDisable_si, TNotifyEvent_sw, True, True, 0, False);
...
function TDataSource_DataLinks_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property DataLinks: TList read <getter>;

  Result := TList_sw.ToVar(TDataSource_sacc(TDataSource(AObj)).DataLinks);
end;
...
begin
  ...
  AData.AddProperty('DataLinks', TDataSource_DataLinks_si, TList_sw, True, False, 0, True);
  ...
  AData.AddProperty('State', TDataSource_State_si, TDataSetState_sw, True, False, 0, False);
  AData.AddProperty('AutoEdit', TDataSource_AutoEdit_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DataSet', TDataSource_DataSet_si, TDataSet_sw, True, True, 0, False);
  AData.AddProperty('Enabled', TDataSource_Enabled_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnStateChange', TDataSource_OnStateChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnDataChange', TDataSource_OnDataChange_si, TDataChangeEvent_sw, True, True, 0, False);
  AData.AddProperty('OnUpdateData', TDataSource_OnUpdateData_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  TDataSetDesigner(AObj).DataEvent(TDataEvent_sw.FromVar(AArgs[0]), Longint(
    AArgs[1]));
end;
...
begin
  ...
  AData.AddProperty('DataSet', TDataSetDesigner_DataSet_si, TDataSet_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('CustomConstraint', TCheckConstraint_CustomConstraint_si, string_sw, True, True, 0, False);
  AData.AddProperty('ErrorMessage', TCheckConstraint_ErrorMessage_si, string_sw, True, True, 0, False);
  AData.AddProperty('FromDictionary', TCheckConstraint_FromDictionary_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ImportedConstraint', TCheckConstraint_ImportedConstraint_si, string_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Items', TCheckConstraints_Items_si, TCheckConstraint_sw, True, True, 1, False);
...
class function TParamType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TParamType);
end;
...
begin
  ...
  TParam(AObj).AssignFieldValue(TField_sw.FromVar(AArgs[0]), Variant(AArgs[1]));
end;
...
function TParam_AsBlob_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property AsBlob: TBlobData read <getter> write <setter>;

  if IsGet then
    Result := TBlobData_sw.ToVar(TParam(AObj).AsBlob)
  else
    TParam(AObj).AsBlob := TBlobData_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    TParam(AObj).AsWideString := WideString(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    TParam(AObj).Name := Widestring(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    TParam(AObj).Value := Variant(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('DataSet', TParam_DataSet_si, TDataSet_sw, True, False, 0, True);
  ...
  AData.AddProperty('AsBCD', TParam_AsBCD_si, Currency_sw, True, True, 0, False);
  AData.AddProperty('AsBlob', TParam_AsBlob_si, TBlobData_sw, True, True, 0, False);
  AData.AddProperty('AsBoolean', TParam_AsBoolean_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AsCurrency', TParam_AsCurrency_si, Currency_sw, True, True, 0, False);
  AData.AddProperty('AsDate', TParam_AsDate_si, TDateTime_sw, True, True, 0, False);
  AData.AddProperty('AsDateTime', TParam_AsDateTime_si, TDateTime_sw, True, True, 0, False);
  AData.AddProperty('AsFloat', TParam_AsFloat_si, Double_sw, True, True, 0, False);
  AData.AddProperty('AsInteger', TParam_AsInteger_si, LongInt_sw, True, True, 0, False);
  AData.AddProperty('AsSmallInt', TParam_AsSmallInt_si, LongInt_sw, True, True, 0, False);
  AData.AddProperty('AsMemo', TParam_AsMemo_si, string_sw, True, True, 0, False);
  AData.AddProperty('AsString', TParam_AsString_si, string_sw, True, True, 0, False);
  AData.AddProperty('AsWideString', TParam_AsWideString_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('AsTime', TParam_AsTime_si, TDateTime_sw, True, True, 0, False);
  AData.AddProperty('AsWord', TParam_AsWord_si, LongInt_sw, True, True, 0, False);
  AData.AddProperty('Bound', TParam_Bound_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('IsNull', TParam_IsNull_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('NativeStr', TParam_NativeStr_si, string_sw, True, True, 0, False);
  AData.AddProperty('Text', TParam_Text_si, string_sw, True, True, 0, False);
  AData.AddProperty('DataType', TParam_DataType_si, TFieldType_sw, True, True, 0, False);
  AData.AddProperty('Precision', TParam_Precision_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('NumericScale', TParam_NumericScale_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Name', TParam_Name_si, Widestring_sw, True, True, 0, False);
  AData.AddProperty('ParamType', TParam_ParamType_si, TParamType_sw, True, True, 0, False);
  AData.AddProperty('Size', TParam_Size_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Value', TParam_Value_si, Variant_sw, True, True, 0, False);
end;
...
begin
  ...
  TParams(AObj).GetParamList(TList_sw.FromVar(AArgs[0]), WideString(AArgs[1]));
end;
...
function TParams_ParseSQL_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function ParseSQL(SQL: WideString; DoCreate: Boolean): Wi...

  Result := TParams(AObj).ParseSQL(WideString(AArgs[0]), Boolean(AArgs[1]));
end;
...
begin
  ...
  Result := TParam_sw.ToVar(TParams(AObj).FindParam(WideString(AArgs[0])));
end;
...
begin
  ...
  if IsGet then
    ...
    TParams(AObj).ParamValues[string(AArgs[0])] := Variant(AArgs[1]);
end;
...
begin
  ...
  AData.AddFunction('ParseSQL', TParams_ParseSQL_si, WideString_sw, 2, False);
  ...
  AData.AddProperty('Items', TParams_Items_si, TParam_sw, True, True, 1, False);
  AData.AddProperty('ParamValues', TParams_ParamValues_si, Variant_sw, True, True, 1, False);
end;
...
class function TPSCommandType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPSCommandType);
end;
...
class function TBookmarkFlag_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBookmarkFlag);
end;
...
class function TGetMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TGetMode);
end;
...
class function TGetResult_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TGetResult);
end;
...
class function TDataAction_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDataAction);
end;
...
class function TBlobStreamMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBlobStreamMode);
end;
...
class function TLocateOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TLocateOption);
end;
...
class function TFilterOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFilterOption);
end;
...
begin
  ...
  if IsGet then
    ...
    TPacketAttribute_sw(AObj).FValue.Value := OleVariant(AArgs[0]);
end;
...
begin
  ...
  AData.AddFunction('Copy', TPacketAttribute_Copy_si, TPacketAttribute_sw, 0);
  ...
  AData.AddConstructor('Create', TPacketAttribute_Create_si, 0);
end;
...
class function TGroupPosInd_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TGroupPosInd);
end;
...
function TDataSet_NestedDataSets_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property NestedDataSets: TList read <getter>;

  Result := TList_sw.ToVar(TDataSet_sacc(TDataSet(AObj)).NestedDataSets);
end;
...
begin
  ...
  Result := TField_sw.ToVar(TDataSet(AObj).FieldByName(WideString(AArgs[0])));
end;
...
begin
  ...
  Result := TField_sw.ToVar(TDataSet(AObj).FindField(WideString(AArgs[0])));
end;
...
function TDataSet_GetDetailLinkFields_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure GetDetailLinkFields(MasterFields: TList; Detail...
...
function TDataSet_GetFieldList_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure GetFieldList(List: TList; const FieldNames: Wid...

  TDataSet(AObj).GetFieldList(TList_sw.FromVar(AArgs[0]), WideString(AArgs[1]));
end;
...
begin
  ...
  Result := TDataSet(AObj).Locate(string(AArgs[0]), Variant(AArgs[1]), 
    TLocateOptions_sw.FromVar(AArgs[2]));
end;
...
begin
  ...
  Result := TDataSet(AObj).Lookup(string(AArgs[0]), Variant(AArgs[1]), string(
    AArgs[2]));
end;
...
function TDataSet_Bookmark_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Bookmark: TBookmarkStr read <getter> write <sett...

  if IsGet then
    Result := TBookmarkStr_sw.ToVar(TDataSet(AObj).Bookmark)
  else
    TDataSet(AObj).Bookmark := TBookmarkStr_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    TDataSet(AObj).FieldValues[string(AArgs[0])] := Variant(AArgs[1]);
end;
...
begin
  ...
  AData.AddProperty('ActiveRecord', TDataSet_ActiveRecord_si, Integer_sw, True, False, 0, True);
  AData.AddProperty('CurrentRecord', TDataSet_CurrentRecord_si, Integer_sw, True, False, 0, True);
  AData.AddProperty('BlobFieldCount', TDataSet_BlobFieldCount_si, Integer_sw, True, False, 0, True);
  AData.AddProperty('BookmarkSize', TDataSet_BookmarkSize_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('BufferCount', TDataSet_BufferCount_si, Integer_sw, True, False, 0, True);
  AData.AddProperty('CalcFieldsSize', TDataSet_CalcFieldsSize_si, Integer_sw, True, False, 0, True);
  AData.AddProperty('Constraints', TDataSet_Constraints_si, TCheckConstraints_sw, True, True, 0, True);
  AData.AddProperty('FieldNoOfs', TDataSet_FieldNoOfs_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('InternalCalcFields', TDataSet_InternalCalcFields_si, Boolean_sw, True, False, 0, True);
  AData.AddProperty('NestedDataSets', TDataSet_NestedDataSets_si, TList_sw, True, False, 0, True);
  AData.AddProperty('NestedDataSetClass', TDataSet_NestedDataSetClass_si, TDataSetClass_sw, True, True, 0, True);
  ...
  AData.AddProperty('AggFields', TDataSet_AggFields_si, TFields_sw, True, False, 0, False);
  AData.AddProperty('Bof', TDataSet_Bof_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Bookmark', TDataSet_Bookmark_si, TBookmarkStr_sw, True, True, 0, False);
  AData.AddProperty('CanModify', TDataSet_CanModify_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('DataSetField', TDataSet_DataSetField_si, TDataSetField_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDataSet_DataSource_si, TDataSource_sw, True, False, 0, False);
  AData.AddProperty('DefaultFields', TDataSet_DefaultFields_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Designer', TDataSet_Designer_si, TDataSetDesigner_sw, True, False, 0, False);
  AData.AddProperty('Eof', TDataSet_Eof_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('BlockReadSize', TDataSet_BlockReadSize_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('FieldCount', TDataSet_FieldCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('FieldDefs', TDataSet_FieldDefs_si, TFieldDefs_sw, True, True, 0, False);
  AData.AddProperty('FieldDefList', TDataSet_FieldDefList_si, TFieldDefList_sw, True, False, 0, False);
  AData.AddProperty('Fields', TDataSet_Fields_si, TFields_sw, True, False, 0, False);
  AData.AddProperty('FieldList', TDataSet_FieldList_si, TFieldList_sw, True, False, 0, False);
  AData.AddProperty('FieldValues', TDataSet_FieldValues_si, Variant_sw, True, True, 1, False);
  AData.AddProperty('Found', TDataSet_Found_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('IsUniDirectional', TDataSet_IsUniDirectional_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Modified', TDataSet_Modified_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('ObjectView', TDataSet_ObjectView_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('RecordCount', TDataSet_RecordCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('RecNo', TDataSet_RecNo_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('RecordSize', TDataSet_RecordSize_si, Word_sw, True, False, 0, False);
  AData.AddProperty('SparseArrays', TDataSet_SparseArrays_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('State', TDataSet_State_si, TDataSetState_sw, True, False, 0, False);
  AData.AddProperty('Filter', TDataSet_Filter_si, string_sw, True, True, 0, False);
  AData.AddProperty('Filtered', TDataSet_Filtered_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('FilterOptions', TDataSet_FilterOptions_si, TFilterOptions_sw, True, True, 0, False);
  AData.AddProperty('Active', TDataSet_Active_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AutoCalcFields', TDataSet_AutoCalcFields_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('BeforeOpen', TDataSet_BeforeOpen_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterOpen', TDataSet_AfterOpen_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforeClose', TDataSet_BeforeClose_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterClose', TDataSet_AfterClose_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforeInsert', TDataSet_BeforeInsert_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterInsert', TDataSet_AfterInsert_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforeEdit', TDataSet_BeforeEdit_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterEdit', TDataSet_AfterEdit_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforePost', TDataSet_BeforePost_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterPost', TDataSet_AfterPost_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforeCancel', TDataSet_BeforeCancel_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterCancel', TDataSet_AfterCancel_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforeDelete', TDataSet_BeforeDelete_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterDelete', TDataSet_AfterDelete_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforeScroll', TDataSet_BeforeScroll_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterScroll', TDataSet_AfterScroll_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('BeforeRefresh', TDataSet_BeforeRefresh_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('AfterRefresh', TDataSet_AfterRefresh_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnCalcFields', TDataSet_OnCalcFields_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnDeleteError', TDataSet_OnDeleteError_si, TDataSetErrorEvent_sw, True, True, 0, False);
  AData.AddProperty('OnEditError', TDataSet_OnEditError_si, TDataSetErrorEvent_sw, True, True, 0, False);
  AData.AddProperty('OnFilterRecord', TDataSet_OnFilterRecord_si, TFilterRecordEvent_sw, True, True, 0, False);
  AData.AddProperty('OnNewRecord', TDataSet_OnNewRecord_si, TDataSetNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnPostError', TDataSet_OnPostError_si, TDataSetErrorEvent_sw, True, True, 0, False);
end;
...
class function TWideDataSet_sw.GetTypeName: WideString;
begin
  Result := 'TWideDataSet';
end;

class function TWideDataSet_sw.GetWrappedClass: TClass;
begin
  Result := TWideDataSet;
end;

class procedure TWideDataSet_sw.DoInit(AData: TLMDClassWrapperData);
begin
  // Do not call inherited.
end;

class function TWideDataSet_sw.ToVar(const AValue: TWideDataSet): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TWideDataSet_sw.FromVar(const AValue: OleVariant): TWideDataSet;
begin
  Result := TWideDataSet(ConvFromVar(AValue, TWideDataSet));
end;

class function TWideDataSet_sw.ClassToVar(AClass: TWideDataSet_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TWideDataSet_sw.ClassFromVar(
  const AClass: OleVariant): TWideDataSet_sc;
begin
  Result := TWideDataSet_sc(ConvClsFromVar(AClass, TWideDataSet));
end;
...
begin
  ...
  AData.AddFunction('Copy', TDateTimeRec_Copy_si, TDateTimeRec_sw, 0);
  ...
  AData.AddConstructor('Create', TDateTimeRec_Create_si, 0);
end;
...
class function TDBScreenCursor_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDBScreenCursor);
end;
...
function DB_TFieldType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFieldType = (ftString, ftSmallint, ftInteger, ftWor...
...
function DB_TDataSetState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDataSetState = (dsBrowse, dsEdit, dsInsert, dsSetKe...
...
function DB_TDataEvent_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDataEvent = (deRecordChange, deDataSetChange, deDat...
...
function DB_TUpdateStatus_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TUpdateStatus = (usModified, usInserted, usDeleted);
...
function DB_TUpdateAction_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TUpdateAction = (uaAbort, uaSkip, uaRetry, uaApplied);
...
function DB_TUpdateMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TUpdateMode = (upWhereChanged, upWhereKeyOnly);
...
function DB_TUpdateKind_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TUpdateKind = (ukInsert, ukDelete);
...
function DB_TFieldAttribute_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFieldAttribute = (faReadonly, faRequired, faLink, f...
...
function DB_TIndexOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TIndexOption = (ixUnique, ixDescending, ixCaseInsens...
...
function DB_TFlatList_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFlatList = class(TWideStringList);
...
function DB_TFieldKind_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFieldKind = (fkCalculated, fkLookup, fkInternalCalc...
...
function DB_TProviderFlag_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TProviderFlag = (pfInWhere, pfInKey, pfHidden);
...
function DB_TAutoRefreshFlag_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TAutoRefreshFlag = (arAutoInc, arDefault);
...
function DB_TBlobData_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBlobData = string;

  Result := TLMDUnitWrapper.TypeToVar(TBlobData_sw);
end;

function DB_TParamType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TParamType = (ptInput, ptOutput, ptInputOutput, ptRe...
...
function DB_TPSCommandType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPSCommandType = (ctQuery, ctTable, ctStoredProc, ct...
...
function DB_TBookmarkFlag_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBookmarkFlag = (bfBOF, bfEOF, bfInserted);
...
function DB_TGetResult_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TGetResult = (grBOF, grEOF, grError);
...
function DB_TDataAction_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDataAction = (daAbort, daRetry);
...
function DB_TBlobStreamMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBlobStreamMode = (bmWrite, bmReadWrite);
...
function DB_TLocateOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TLocateOption = (loPartialKey);
...
function DB_TFilterOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFilterOption = (foNoPartialCompare);
...
function DB_TGroupPosInd_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TGroupPosInd = (gbMiddle, gbLast);
...
function DB_TDataSet_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // type TDataSet = class(TComponent, IProviderSupport);

  Result := TLMDUnitWrapper.TypeToVar(TDataSet_sw);
end;

function DB_TWideDataSet_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TWideDataSet = class(TDataSet, IProviderSupport2);

  Result := TLMDUnitWrapper.TypeToVar(TWideDataSet_sw);
end;
...
function DB_TDBScreenCursor_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDBScreenCursor = (dcrHourGlass, dcrSQLWait, dcrOther);
...
var
  v_1: Integer;
begin
  // function ExtractFieldName(const Fields: WideString; var P...

  v_1 := Integer(AArgs[1]);
  Result := DB.ExtractFieldName(WideString(AArgs[0]), v_1);
...
function DB_DatabaseError_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure DatabaseError(const Message: WideString; Compon...

  DB.DatabaseError(WideString(AArgs[0]), TComponent_sw.FromVar(AArgs[1]));
end;
...
begin
  ...
  Result := TField_sw.ToVar(DB.GetFieldProperty(TDataSet_sw.FromVar(AArgs[0]), 
    TComponent_sw.FromVar(AArgs[1]), WideString(AArgs[2])));
end;
...
begin
  ...
  Result := TFieldType_sw.ToVar(DB.VarTypeToDataType(Integer(AArgs[0])));
end;
...
begin
  ...
  AData.AddType(TBlobData_sw, DB_TBlobData_si);
  ...
  AData.AddType(TWideDataSet_sw, DB_TWideDataSet_si);
  ...
  AData.AddFunction('ExtractFieldName', DB_ExtractFieldName_si, WideString_sw, 2, False);
  AData.AddProcedure('DatabaseError', DB_DatabaseError_si, 2, False);
...
initialization
  ...
  RegisterClassWrapper(TWideDataSet_sw);
