...
uses
  ...
  LMDSctSysWrappers, Messages, Windows, SysUtils, Classes, Contnrs, Controls,
  Forms, Menus, Graphics, StdCtrls, GraphUtil, ExtCtrls, Messages_LMDSW,
  Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW, Contnrs_LMDSW, Controls_LMDSW,
  Forms_LMDSW, Menus_LMDSW, Graphics_LMDSW, StdCtrls_LMDSW, GraphUtil_LMDSW;
