...
uses
  LMDTypes, LMDSctScripter, LMDSctWrappers, LMDSctSysWrappers, Types, Windows,
  Variants, SysUtils, Classes, TypInfo, DB, WideStrings, ADODB, Windows_LMDSW,
...
type
  ...
  TCustomADODataSet_sw = class(TWideDataSet_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
...
class function TConnectMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TConnectMode);
end;
...
class function TConnectOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TConnectOption);
end;
...
class function TCursorLocation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCursorLocation);
end;
...
class function TCursorType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCursorType);
end;
...
class function TEventStatus_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TEventStatus);
end;
...
class function TExecuteOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TExecuteOption);
end;
...
class function TIsolationLevel_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TIsolationLevel);
end;
...
class function TADOLockType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TADOLockType);
end;
...
class function TObjectState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TObjectState);
end;
...
class function TSchemaInfo_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TSchemaInfo);
end;
...
class function TXactAttribute_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TXactAttribute);
end;
...
class function TCommandType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCommandType);
end;
...
function TADOConnection_Open_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure Open(const UserID: WideString; const Password: ...
...
begin
  ...
  TADOConnection(AObj).OpenSchema(TSchemaInfo_sw.FromVar(AArgs[0]), OleVariant(
    AArgs[1]), OleVariant(AArgs[2]), TADODataSet_sw.FromVar(AArgs[3]));
end;
...
begin
  ...
  AData.AddProcedure('GetTableNames', TADOConnection_GetTableNames_si, 2, False);
  ...
  AData.AddProperty('CommandCount', TADOConnection_CommandCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Commands', TADOConnection_Commands_si, TADOCommand_sw, True, False, 1, False);
  AData.AddProperty('DataSets', TADOConnection_DataSets_si, TCustomADODataSet_sw, True, False, 1, False);
  AData.AddProperty('InTransaction', TADOConnection_InTransaction_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('State', TADOConnection_State_si, TObjectStates_sw, True, False, 0, False);
  AData.AddProperty('Version', TADOConnection_Version_si, WideString_sw, True, False, 0, False);
  AData.AddProperty('Attributes', TADOConnection_Attributes_si, TXactAttributes_sw, True, True, 0, False);
  AData.AddProperty('CommandTimeout', TADOConnection_CommandTimeout_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Connected');
  AData.AddProperty('ConnectionString', TADOConnection_ConnectionString_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('ConnectionTimeout', TADOConnection_ConnectionTimeout_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ConnectOptions', TADOConnection_ConnectOptions_si, TConnectOption_sw, True, True, 0, False);
  AData.AddProperty('CursorLocation', TADOConnection_CursorLocation_si, TCursorLocation_sw, True, True, 0, False);
  AData.AddProperty('DefaultDatabase', TADOConnection_DefaultDatabase_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('IsolationLevel', TADOConnection_IsolationLevel_si, TIsolationLevel_sw, True, True, 0, False);
  AData.AddProperty('KeepConnection', TADOConnection_KeepConnection_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('LoginPrompt');
  AData.AddProperty('Mode', TADOConnection_Mode_si, TConnectMode_sw, True, True, 0, False);
  AData.AddProperty('Provider', TADOConnection_Provider_si, WideString_sw, True, True, 0, False);
  ...
  AData.AddProperty('OnDisconnect', TADOConnection_OnDisconnect_si, TDisconnectEvent_sw, True, True, 0, False);
  AData.AddProperty('OnWillConnect', TADOConnection_OnWillConnect_si, TWillConnectEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnLogin');
end;
...
begin
  ...
  AData.AddProperty('AppServer', TRDSConnection_AppServer_si, OleVariant_sw, True, False, 0, False);
  AData.AddProperty('ComputerName', TRDSConnection_ComputerName_si, WideString_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Connected');
  AData.AddProperty('InternetTimeout', TRDSConnection_InternetTimeout_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ServerName', TRDSConnection_ServerName_si, WideString_sw, True, True, 0, False);
  AData.AddPropertyRedecl('AfterConnect');
  AData.AddPropertyRedecl('AfterDisconnect');
  AData.AddPropertyRedecl('BeforeConnect');
  AData.AddPropertyRedecl('BeforeDisconnect');
...
class function TParameterAttribute_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TParameterAttribute);
end;
...
class function TParameterDirection_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TParameterDirection);
end;
...
begin
  ...
  TParameter(AObj).AppendChunk(OleVariant(AArgs[0]));
end;
...
begin
  ...
  if IsGet then
    ...
    TParameter(AObj).Value := Variant(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Parameters', TParameter_Parameters_si, TParameters_sw, True, False, 0, False);
  AData.AddProperty('Name', TParameter_Name_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('Attributes', TParameter_Attributes_si, TParameterAttributes_sw, True, True, 0, False);
  AData.AddProperty('DataType', TParameter_DataType_si, TDataType_sw, True, True, 0, False);
  AData.AddProperty('Direction', TParameter_Direction_si, TParameterDirection_sw, True, True, 0, False);
  AData.AddProperty('NumericScale', TParameter_NumericScale_si, Byte_sw, True, True, 0, False);
  AData.AddProperty('Precision', TParameter_Precision_si, Byte_sw, True, True, 0, False);
  AData.AddProperty('Size', TParameter_Size_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Value', TParameter_Value_si, Variant_sw, True, True, 0, False);
end;
...
begin
  ...
  Result := TParameter_sw.ToVar(TParameters(AObj).CreateParameter(WideString(
    ...
    AArgs[2]), Integer(AArgs[3]), OleVariant(AArgs[4])));
end;
...
begin
  ...
  Result := TParameters(AObj).ParseSQL(WideString(AArgs[0]), Boolean(AArgs[1]));
end;
...
begin
  ...
  if IsGet then
    ...
    TParameters(AObj).ParamValues[WideString(AArgs[0])] := Variant(AArgs[1]);
end;
...
begin
  ...
  AData.AddProperty('Modified', TParameters_Modified_si, Boolean_sw, True, False, 0, True);
  ...
  AData.AddFunction('ParseSQL', TParameters_ParseSQL_si, WideString_sw, 2, False);
  AData.AddFunction('Refresh', TParameters_Refresh_si, Boolean_sw, 0, False);
  AData.AddProperty('ParamValues', TParameters_ParamValues_si, Variant_sw, True, True, 1, False);
  AData.AddProperty('Command', TParameters_Command_si, TADOCommand_sw, True, False, 0, False);
  AData.AddProperty('Items', TParameters_Items_si, TParameter_sw, True, True, 1, False);
end;
...
begin
  ...
  AData.AddProperty('CommandTextAlias', TADOCommand_CommandTextAlias_si, string_sw, True, True, 0, True);
  AData.AddProperty('ComponentRef', TADOCommand_ComponentRef_si, TComponent_sw, True, True, 0, True);
  AData.AddProcedure('Cancel', TADOCommand_Cancel_si, 0, False);
  AData.AddProperty('States', TADOCommand_States_si, TObjectStates_sw, True, False, 0, False);
  AData.AddProperty('CommandText', TADOCommand_CommandText_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('CommandTimeout', TADOCommand_CommandTimeout_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('CommandType', TADOCommand_CommandType_si, TCommandType_sw, True, True, 0, False);
  AData.AddProperty('Connection', TADOCommand_Connection_si, TADOConnection_sw, True, True, 0, False);
  AData.AddProperty('ConnectionString', TADOCommand_ConnectionString_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('ExecuteOptions', TADOCommand_ExecuteOptions_si, TExecuteOptions_sw, True, True, 0, False);
  AData.AddProperty('Prepared', TADOCommand_Prepared_si, WordBool_sw, True, True, 0, False);
  AData.AddProperty('Parameters', TADOCommand_Parameters_si, TParameters_sw, True, True, 0, False);
  AData.AddProperty('ParamCheck', TADOCommand_ParamCheck_si, Boolean_sw, True, True, 0, False);
end;
...
class function TCursorOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCursorOption);
end;
...
class function TEventReason_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TEventReason);
end;
...
class function TFilterGroup_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFilterGroup);
end;
...
class function TMarshalOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TMarshalOption);
end;
...
class function TRecordStatus_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TRecordStatus);
end;
...
class function TAffectRecords_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TAffectRecords);
end;
...
class function TPersistFormat_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPersistFormat);
end;
...
class function TSeekOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TSeekOption);
end;
...
function TCustomADODataSet_MasterFields_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property MasterFields: WideString read <getter>...

  if IsGet then
    Result := TCustomADODataSet_sacc(TCustomADODataSet(AObj)).MasterFields
  else
    TCustomADODataSet_sacc(TCustomADODataSet(AObj)).MasterFields := WideString(
      AArgs[0]);
end;
...
begin
  ...
  TCustomADODataSet(AObj).DeleteRecords(TAffectRecords_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  TCustomADODataSet(AObj).SaveToFile(WideString(AArgs[0]), TPersistFormat_sw.
    FromVar(AArgs[1]));
end;
...
begin
  ...
  Result := TCustomADODataSet(AObj).Seek(Variant(AArgs[0]), TSeekOption_sw.
    FromVar(AArgs[1]));
end;
...
function TCustomADODataSet_IndexName_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property IndexName: WideString read <getter> write <setter>;

  if IsGet then
    Result := TCustomADODataSet(AObj).IndexName
  else
    TCustomADODataSet(AObj).IndexName := WideString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('MasterDataLink', TCustomADODataSet_MasterDataLink_si, TMasterDataLink_sw, True, False, 0, True);
  AData.AddProperty('Command', TCustomADODataSet_Command_si, TADOCommand_sw, True, False, 0, True);
  AData.AddProperty('CommandText', TCustomADODataSet_CommandText_si, WideString_sw, True, True, 0, True);
  AData.AddProperty('CommandTimeout', TCustomADODataSet_CommandTimeout_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('CommandType', TCustomADODataSet_CommandType_si, TCommandType_sw, True, True, 0, True);
  AData.AddProperty('DataSource', TCustomADODataSet_DataSource_si, TDataSource_sw, True, True, 0, True);
  AData.AddProperty('IndexDefs', TCustomADODataSet_IndexDefs_si, TIndexDefs_sw, True, True, 0, True);
  AData.AddProperty('IndexFieldNames', TCustomADODataSet_IndexFieldNames_si, string_sw, True, True, 0, True);
  AData.AddProperty('MasterFields', TCustomADODataSet_MasterFields_si, WideString_sw, True, True, 0, True);
  AData.AddProperty('ParamCheck', TCustomADODataSet_ParamCheck_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Parameters', TCustomADODataSet_Parameters_si, TParameters_sw, True, True, 0, True);
  AData.AddProperty('Prepared', TCustomADODataSet_Prepared_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('StoreDefs', TCustomADODataSet_StoreDefs_si, Boolean_sw, True, True, 0, True);
  AData.AddProcedure('CancelBatch', TCustomADODataSet_CancelBatch_si, 1, False);
  AData.AddProcedure('CancelUpdates', TCustomADODataSet_CancelUpdates_si, 0, False);
  AData.AddProcedure('Clone', TCustomADODataSet_Clone_si, 2, False);
  AData.AddProcedure('DeleteRecords', TCustomADODataSet_DeleteRecords_si, 1, False);
  AData.AddProperty('EnableBCD', TCustomADODataSet_EnableBCD_si, Boolean_sw, True, True, 0, False);
  AData.AddProcedure('LoadFromFile', TCustomADODataSet_LoadFromFile_si, 1, False);
  AData.AddProcedure('Requery', TCustomADODataSet_Requery_si, 1, False);
  AData.AddProcedure('SaveToFile', TCustomADODataSet_SaveToFile_si, 2, False);
  AData.AddFunction('Seek', TCustomADODataSet_Seek_si, Boolean_sw, 2, False);
  AData.AddFunction('Supports', TCustomADODataSet_Supports_si, Boolean_sw, 1, False);
  AData.AddProcedure('UpdateBatch', TCustomADODataSet_UpdateBatch_si, 1, False);
  AData.AddProperty('DesignerData', TCustomADODataSet_DesignerData_si, string_sw, True, True, 0, False);
  AData.AddProperty('IndexName', TCustomADODataSet_IndexName_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('IndexFieldCount', TCustomADODataSet_IndexFieldCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('IndexFields', TCustomADODataSet_IndexFields_si, TField_sw, True, True, 1, False);
  AData.AddProperty('FilterGroup', TCustomADODataSet_FilterGroup_si, TFilterGroup_sw, True, True, 0, False);
  AData.AddProperty('RecordsetState', TCustomADODataSet_RecordsetState_si, TObjectStates_sw, True, False, 0, False);
  AData.AddProperty('RecordStatus', TCustomADODataSet_RecordStatus_si, TRecordStatusSet_sw, True, False, 0, False);
  AData.AddProperty('Sort', TCustomADODataSet_Sort_si, WideString_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Active');
  AData.AddPropertyRedecl('AutoCalcFields');
  AData.AddProperty('CacheSize', TCustomADODataSet_CacheSize_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Connection', TCustomADODataSet_Connection_si, TADOConnection_sw, True, True, 0, False);
  AData.AddProperty('ConnectionString', TCustomADODataSet_ConnectionString_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('CursorLocation', TCustomADODataSet_CursorLocation_si, TCursorLocation_sw, True, True, 0, False);
  AData.AddProperty('CursorType', TCustomADODataSet_CursorType_si, TCursorType_sw, True, True, 0, False);
  AData.AddProperty('ExecuteOptions', TCustomADODataSet_ExecuteOptions_si, TExecuteOptions_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Filter');
  AData.AddPropertyRedecl('Filtered');
  AData.AddProperty('LockType', TCustomADODataSet_LockType_si, TADOLockType_sw, True, True, 0, False);
  AData.AddProperty('MarshalOptions', TCustomADODataSet_MarshalOptions_si, TMarshalOption_sw, True, True, 0, False);
  AData.AddProperty('MaxRecords', TCustomADODataSet_MaxRecords_si, Integer_sw, True, True, 0, False);
  ...
  AData.AddProperty('OnWillChangeField', TCustomADODataSet_OnWillChangeField_si, TWillChangeFieldEvent_sw, True, True, 0, False);
  AData.AddProperty('OnWillChangeRecord', TCustomADODataSet_OnWillChangeRecord_si, TWillChangeRecordEvent_sw, True, True, 0, False);
  AData.AddProperty('OnWillChangeRecordset', TCustomADODataSet_OnWillChangeRecordset_si, TRecordsetReasonEvent_sw, True, True, 0, False);
  AData.AddProperty('OnWillMove', TCustomADODataSet_OnWillMove_si, TRecordsetReasonEvent_sw, True, True, 0, False);
  AData.AddProperty('OnEndOfRecordset', TCustomADODataSet_OnEndOfRecordset_si, TEndOfRecordsetEvent_sw, True, True, 0, False);
  AData.AddProperty('OnFetchProgress', TCustomADODataSet_OnFetchProgress_si, TFetchProgressEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('IndexDefs');
  AData.AddPropertyRedecl('CommandText');
  AData.AddPropertyRedecl('CommandTimeout');
  AData.AddPropertyRedecl('CommandType');
  AData.AddPropertyRedecl('DataSetField');
  AData.AddPropertyRedecl('DataSource');
  AData.AddPropertyRedecl('EnableBCD');
  AData.AddPropertyRedecl('FieldDefs');
  AData.AddPropertyRedecl('IndexName');
  AData.AddPropertyRedecl('IndexFieldNames');
  AData.AddPropertyRedecl('MasterFields');
  AData.AddPropertyRedecl('ParamCheck');
  AData.AddPropertyRedecl('Parameters');
  AData.AddPropertyRedecl('Prepared');
  AData.AddProperty('RDSConnection', TADODataSet_RDSConnection_si, TRDSConnection_sw, True, True, 0, False);
  AData.AddPropertyRedecl('StoreDefs');
  AData.AddPropertyRedecl('BeforeOpen');
  AData.AddPropertyRedecl('AfterOpen');
  AData.AddPropertyRedecl('BeforeClose');
  AData.AddPropertyRedecl('AfterClose');
...
begin
  ...
  AData.AddPropertyRedecl('IndexName');
  AData.AddPropertyRedecl('MasterFields');
  AData.AddProperty('MasterSource', TADOTable_MasterSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddProperty('ReadOnly', TADOTable_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('TableDirect', TADOTable_TableDirect_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('TableName', TADOTable_TableName_si, WideString_sw, True, True, 0, False);
end;
...
function TADOQuery_SQL_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property SQL: TWideStrings read <getter> write <setter>;

  if IsGet then
    Result := TWideStrings_sw.ToVar(TADOQuery(AObj).SQL)
  else
    TADOQuery(AObj).SQL := TWideStrings_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('RowsAffected', TADOQuery_RowsAffected_si, Integer_sw, True, False, 0, False);
  AData.AddPropertyRedecl('CommandTimeout');
  AData.AddPropertyRedecl('DataSource');
  AData.AddPropertyRedecl('EnableBCD');
  AData.AddPropertyRedecl('ParamCheck');
  AData.AddPropertyRedecl('Parameters');
  AData.AddPropertyRedecl('Prepared');
  AData.AddProperty('SQL', TADOQuery_SQL_si, TWideStrings_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('DataSource');
  AData.AddPropertyRedecl('EnableBCD');
  AData.AddProperty('ProcedureName', TADOStoredProc_ProcedureName_si, WideString_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Parameters');
  AData.AddPropertyRedecl('Prepared');
end;
...
function ADODB_TConnectMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TConnectMode = (cmRead, cmWrite, cmReadWrite, cmShar...
...
function ADODB_TConnectOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TConnectOption = (coAsyncConnect);
...
function ADODB_TCursorLocation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCursorLocation = (clUseClient);
...
function ADODB_TCursorType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCursorType = (ctOpenForwardOnly, ctKeyset, ctDynami...
...
function ADODB_TEventStatus_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TEventStatus = (esErrorsOccured, esCantDeny, esCance...
...
function ADODB_TExecuteOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TExecuteOption = (eoAsyncFetch, eoAsyncFetchNonBlock...
...
function ADODB_TIsolationLevel_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TIsolationLevel = (ilChaos, ilReadUncommitted, ilBro...
...
function ADODB_TADOLockType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TADOLockType = (ltReadOnly, ltPessimistic, ltOptimis...
...
function ADODB_TObjectState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TObjectState = (stOpen, stConnecting, stExecuting, s...
...
function ADODB_TSchemaInfo_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TSchemaInfo = (siCatalogs, siCharacterSets, siCollat...
...
function ADODB_TXactAttribute_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TXactAttribute = (xaAbortRetaining);
...
function ADODB_TCommandType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCommandType = (cmdText, cmdTable, cmdStoredProc, cm...
...
function ADODB_TADOConnection_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TADOConnection = class(TCustomConnection, IUnknown, ...
...
function ADODB_TParameterAttribute_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TParameterAttribute = (paNullable, paLong);
...
function ADODB_TParameterDirection_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TParameterDirection = (pdInput, pdOutput, pdInputOut...
...
function ADODB_TCursorOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCursorOption = (coMovePrevious, coAddNew, coDelete,...
...
function ADODB_TEventReason_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TEventReason = (erDelete, erUpdate, erUndoUpdate, er...
...
function ADODB_TFilterGroup_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFilterGroup = (fgNone, fgPendingRecords, fgAffected...
...
function ADODB_TMarshalOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMarshalOption = (moMarshalModifiedOnly);
...
function ADODB_TRecordStatus_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TRecordStatus = (rsNew, rsModified, rsDeleted, rsUnm...
...
function ADODB_TAffectRecords_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TAffectRecords = (arFiltered, arAll, arAllChapters);
...
function ADODB_TSeekOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TSeekOption = (soLastEQ, soAfterEQ, soAfter, soBefor...
...
function ADODB_TCustomADODataSet_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCustomADODataSet = class(TWideDataSet, IUnknown, Re...
...
begin
  ...
  AData.AddFunction('GetDataLinkFiles', ADODB_GetDataLinkFiles_si, Integer_sw, 2, False);
end;
