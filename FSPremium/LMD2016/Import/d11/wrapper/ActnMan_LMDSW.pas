...
uses
  ...
  LMDSctSysWrappers, Types, Windows, Messages, SysUtils, Forms, Classes, Menus,
...
begin
  ...
  Result := TActionClientItem_sw.ToVar(TCustomActionManager(AObj).AddCategory(
    string(AArgs[0]), TActionClient_sw.FromVar(AArgs[1]), Boolean(AArgs[2])));
end;
...
begin
  ...
  Result := TActionClientItem_sw.ToVar(TCustomActionManager(AObj).AddSeparator(
    TActionClientItem_sw.FromVar(AArgs[0]), Boolean(AArgs[1])));
end;
...
begin
  ...
  AData.AddProperty('Loading', TCustomActionManager_Loading_si, Boolean_sw, True, False, 0, True);
  AData.AddProperty('OnGetBarItemClass', TCustomActionManager_OnGetBarItemClass_si, TGetBarItemClassEvent_sw, True, True, 0, True);
  AData.AddProperty('OnGetBarsClass', TCustomActionManager_OnGetBarsClass_si, TGetBarsClassEvent_sw, True, True, 0, True);
  AData.AddProperty('OnGetClientsClass', TCustomActionManager_OnGetClientsClass_si, TGetClientsClassEvent_sw, True, True, 0, True);
  AData.AddProperty('OnGetClientItemClass', TCustomActionManager_OnGetClientItemClass_si, TGetClientItemClassEvent_sw, True, True, 0, True);
  AData.AddFunction('AddAction', TCustomActionManager_AddAction_si, TActionClientItem_sw, 3, False);
  AData.AddFunction('AddCategory', TCustomActionManager_AddCategory_si, TActionClientItem_sw, 3, False);
  AData.AddFunction('AddSeparator', TCustomActionManager_AddSeparator_si, TActionClientItem_sw, 2, False);
  ...
  AData.AddProperty('ActionBars', TCustomActionManager_ActionBars_si, TActionBars_sw, True, True, 0, False);
  AData.AddProperty('DefaultActionBars', TCustomActionManager_DefaultActionBars_si, TActionBars_sw, True, False, 0, False);
  AData.AddProperty('LinkedActionLists', TCustomActionManager_LinkedActionLists_si, TActionListCollection_sw, True, True, 0, False);
  AData.AddProperty('FileName', TCustomActionManager_FileName_si, TFileName_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Images');
  AData.AddProperty('PrioritySchedule', TCustomActionManager_PrioritySchedule_si, TStringList_sw, True, True, 0, False);
  AData.AddProperty('Style', TCustomActionManager_Style_si, TActionBarStyle_sw, True, True, 0, False);
  AData.AddProperty('OnStyleChanged', TCustomActionManager_OnStyleChanged_si, TStyleChanged_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('FileName');
  AData.AddPropertyRedecl('ActionBars');
  AData.AddPropertyRedecl('LinkedActionLists');
  AData.AddPropertyRedecl('Images');
  AData.AddPropertyRedecl('PrioritySchedule');
  ...
  AData.AddPropertyRedecl('OnGetBarItemClass');
  AData.AddPropertyRedecl('OnGetBarsClass');
  AData.AddPropertyRedecl('OnGetClientsClass');
  AData.AddPropertyRedecl('OnGetClientItemClass');
  AData.AddPropertyRedecl('OnUpdate');
  AData.AddPropertyRedecl('OnStateChange');
  AData.AddPropertyRedecl('OnStyleChanged');
end;
...
begin
  ...
  AData.AddProperty('ActionList', TActionListItem_ActionList_si, TCustomActionList_sw, True, True, 0, False);
  AData.AddProperty('Caption', TActionListItem_Caption_si, string_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('ActionManager', TActionListCollection_ActionManager_si, TCustomActionManager_sw, True, False, 0, False);
  AData.AddProperty('ListItems', TActionListCollection_ListItems_si, TActionListItem_sw, True, True, 1, False);
end;
...
begin
  ...
  AData.AddProperty('ActionClients', TActionClientsCollection_ActionClients_si, TActionClient_sw, True, True, 1, True);
  AData.AddProperty('ParentItem', TActionClientsCollection_ParentItem_si, TActionClient_sw, True, True, 0, True);
  AData.AddProcedure('IterateClients', TActionClientsCollection_IterateClients_si, 2, False);
  AData.AddProperty('ActionManager', TActionClientsCollection_ActionManager_si, TCustomActionManager_sw, True, False, 0, False);
  AData.AddProperty('AutoHotKeys', TActionClientsCollection_AutoHotKeys_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Customizable', TActionClientsCollection_Customizable_si, Boolean_sw, True, True, 0, False);
end;
...
class function TBackgroundLayout_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBackgroundLayout);
end;
...
class function TChangesAllowed_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TChangesAllowed);
end;
...
begin
  ...
  if IsGet then
    Result := TActionClient(AObj).Tag
  else
    TActionClient(AObj).Tag := Integer(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('ActionBar', TActionClient_ActionBar_si, TCustomActionBar_sw, True, True, 0, False);
  AData.AddProperty('ChildActionBar', TActionClient_ChildActionBar_si, TCustomActionBar_sw, True, True, 0, False);
  AData.AddProperty('HasItems', TActionClient_HasItems_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('OwningCollection', TActionClient_OwningCollection_si, TActionClientsCollection_sw, True, False, 0, False);
  AData.AddProperty('ChangesAllowed', TActionClient_ChangesAllowed_si, TChangesAllowedSet_sw, True, True, 0, False);
  AData.AddProperty('Color', TActionClient_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('ContextItems', TActionClient_ContextItems_si, TActionClients_sw, True, True, 0, False);
  AData.AddProperty('Background', TActionClient_Background_si, TPicture_sw, True, True, 0, False);
  AData.AddProperty('BackgroundLayout', TActionClient_BackgroundLayout_si, TBackgroundLayout_sw, True, True, 0, False);
  AData.AddProperty('Items', TActionClient_Items_si, TActionClients_sw, True, True, 0, False);
  AData.AddProperty('Tag', TActionClient_Tag_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Visible', TActionClient_Visible_si, Boolean_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('ActionBars', TActionBarItem_ActionBars_si, TActionBars_sw, True, False, 0, True);
  AData.AddPropertyRedecl('ActionBar');
  AData.AddProperty('AutoSize', TActionBarItem_AutoSize_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('GlyphLayout', TActionBarItem_GlyphLayout_si, TButtonLayout_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('ActionBars', TActionBars_ActionBars_si, TActionBarItem_sw, True, False, 1, False);
  AData.AddPropertyRedecl('Customizable');
  AData.AddProperty('HintShortCuts', TActionBars_HintShortCuts_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SessionCount', TActionBars_SessionCount_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ShowHints', TActionBars_ShowHints_si, Boolean_sw, True, True, 0, False);
...
class function TCaptionOptions_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCaptionOptions);
end;
...
begin
  ...
  AData.AddProperty('ActionClients', TActionClients_ActionClients_si, TActionClientItem_sw, True, True, 1, False);
  AData.AddProperty('ActionManager', TActionClients_ActionManager_si, TCustomActionManager_sw, True, False, 0, False);
  AData.AddPropertyRedecl('AutoHotKeys');
  AData.AddPropertyRedecl('Customizable');
  AData.AddProperty('HideUnused', TActionClients_HideUnused_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('CaptionOptions', TActionClients_CaptionOptions_si, TCaptionOptions_sw, True, True, 0, False);
  AData.AddProperty('SmallIcons', TActionClients_SmallIcons_si, Boolean_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('ActionClients', TActionClientItem_ActionClients_si, TActionClients_sw, True, False, 0, False);
  AData.AddProperty('ActionLink', TActionClientItem_ActionLink_si, TActionClientLink_sw, True, True, 0, False);
  AData.AddProperty('CheckUnused', TActionClientItem_CheckUnused_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Control', TActionClientItem_Control_si, TCustomActionControl_sw, True, True, 0, False);
  AData.AddProperty('ParentItem', TActionClientItem_ParentItem_si, TActionClient_sw, True, False, 0, False);
  AData.AddProperty('Separator', TActionClientItem_Separator_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('ShortCutText', TActionClientItem_ShortCutText_si, string_sw, True, False, 0, False);
  AData.AddProperty('Action', TActionClientItem_Action_si, TContainedAction_sw, True, True, 0, False);
  AData.AddProperty('Caption', TActionClientItem_Caption_si, string_sw, True, True, 0, False);
  AData.AddProperty('HelpContext', TActionClientItem_HelpContext_si, THelpContext_sw, True, True, 0, False);
  AData.AddProperty('ImageIndex', TActionClientItem_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('MergeIndex', TActionClientItem_MergeIndex_si, TMergeRange_sw, True, True, 0, False);
  AData.AddProperty('LastSession', TActionClientItem_LastSession_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ShowCaption', TActionClientItem_ShowCaption_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ShowGlyph', TActionClientItem_ShowGlyph_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ShowShortCut', TActionClientItem_ShowShortCut_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ShortCut', TActionClientItem_ShortCut_si, TShortCut_sw, True, True, 0, False);
  AData.AddProperty('UsageCount', TActionClientItem_UsageCount_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('ActionManager', TActionDragBaseClass_ActionManager_si, TCustomActionManager_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('ActionCount', TActionDragObject_ActionCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Actions', TActionDragObject_Actions_si, TContainedAction_sw, True, False, 1, False);
...
begin
  ...
  AData.AddProperty('Category', TCategoryDragObject_Category_si, string_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('ClientItem', TActionItemDragObject_ClientItem_si, TActionClientItem_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('BtnFrameColor', TCustomActionBarColorMap_BtnFrameColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('BtnSelectedColor', TCustomActionBarColorMap_BtnSelectedColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('BtnSelectedFont', TCustomActionBarColorMap_BtnSelectedFont_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('Color', TCustomActionBarColorMap_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('DesignFocus', TCustomActionBarColorMap_DesignFocus_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('DisabledColor', TCustomActionBarColorMap_DisabledColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('DisabledFontColor', TCustomActionBarColorMap_DisabledFontColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('DisabledFontShadow', TCustomActionBarColorMap_DisabledFontShadow_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('FontColor', TCustomActionBarColorMap_FontColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('FrameTopLeftInner', TCustomActionBarColorMap_FrameTopLeftInner_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('FrameTopLeftOuter', TCustomActionBarColorMap_FrameTopLeftOuter_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('FrameBottomRightInner', TCustomActionBarColorMap_FrameBottomRightInner_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('FrameBottomRightOuter', TCustomActionBarColorMap_FrameBottomRightOuter_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('HighlightColor', TCustomActionBarColorMap_HighlightColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('HotColor', TCustomActionBarColorMap_HotColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('HotFontColor', TCustomActionBarColorMap_HotFontColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('MenuColor', TCustomActionBarColorMap_MenuColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('SelectedColor', TCustomActionBarColorMap_SelectedColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('SelectedFontColor', TCustomActionBarColorMap_SelectedFontColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('ShadowColor', TCustomActionBarColorMap_ShadowColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('UnusedColor', TCustomActionBarColorMap_UnusedColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('OnColorChange', TCustomActionBarColorMap_OnColorChange_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
class function TBarOrientation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBarOrientation);
end;
...
class function TBarEdge_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBarEdge);
end;
...
begin
  ...
  AData.AddProperty('HRowCount', TCustomActionBar_HRowCount_si, Integer_sw, True, False, 0, True);
  AData.AddProperty('Items', TCustomActionBar_Items_si, TActionClients_sw, True, False, 0, True);
  AData.AddProperty('VRowCount', TCustomActionBar_VRowCount_si, Integer_sw, True, False, 0, True);
  AData.AddProperty('Widest', TCustomActionBar_Widest_si, Integer_sw, True, False, 0, True);
  ...
  AData.AddProperty('ActionManager', TCustomActionBar_ActionManager_si, TCustomActionManager_sw, True, True, 0, False);
  AData.AddProperty('ActionClient', TCustomActionBar_ActionClient_si, TActionClient_sw, True, True, 0, False);
  AData.AddProperty('AllowHiding', TCustomActionBar_AllowHiding_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AutoSizing', TCustomActionBar_AutoSizing_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Caption');
  AData.AddProperty('Canvas', TCustomActionBar_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Color');
  AData.AddProperty('ColorMap', TCustomActionBar_ColorMap_si, TCustomActionBarColorMap_sw, True, True, 0, False);
  AData.AddProperty('ContextBar', TCustomActionBar_ContextBar_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Designable', TCustomActionBar_Designable_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Font');
  AData.AddProperty('DesignMode', TCustomActionBar_DesignMode_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('HorzMargin', TCustomActionBar_HorzMargin_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('HorzSeparator', TCustomActionBar_HorzSeparator_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Orientation', TCustomActionBar_Orientation_si, TBarOrientation_sw, True, True, 0, False);
  AData.AddProperty('PersistentHotKeys', TCustomActionBar_PersistentHotKeys_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ActionControls', TCustomActionBar_ActionControls_si, TCustomActionControl_sw, True, False, 1, False);
  AData.AddProperty('Spacing', TCustomActionBar_Spacing_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('VertMargin', TCustomActionBar_VertMargin_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('VertSeparator', TCustomActionBar_VertSeparator_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnControlCreated', TCustomActionBar_OnControlCreated_si, TControlCreatedEvent_sw, True, True, 0, False);
  AData.AddProperty('OnGetControlClass', TCustomActionBar_OnGetControlClass_si, TGetControlClassEvent_sw, True, True, 0, False);
  AData.AddProperty('OnPaint', TCustomActionBar_OnPaint_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddFunction('Copy', TCMItemMsg_Copy_si, TCMItemMsg_sw, 0);
  ...
  AData.AddConstructor('Create', TCMItemMsg_Create_si, 0);
end;
...
begin
  ...
  AData.AddProperty('GlyphPos', TCustomActionControl_GlyphPos_si, TPoint_sw, True, True, 0, True);
  ...
  AData.AddProperty('ActionBar', TCustomActionControl_ActionBar_si, TCustomActionBar_sw, True, False, 0, False);
  AData.AddProperty('ActionClient', TCustomActionControl_ActionClient_si, TActionClientItem_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Caption');
  AData.AddProperty('DropPoint', TCustomActionControl_DropPoint_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('GlyphLayout', TCustomActionControl_GlyphLayout_si, TButtonLayout_sw, True, True, 0, False);
  AData.AddProperty('Margins', TCustomActionControl_Margins_si, TRect_sw, True, True, 0, False);
  AData.AddProperty('Selected', TCustomActionControl_Selected_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Separator', TCustomActionControl_Separator_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('ShowCaption', TCustomActionControl_ShowCaption_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('ShowShortCut', TCustomActionControl_ShowShortCut_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('SmallIcon', TCustomActionControl_SmallIcon_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Spacing', TCustomActionControl_Spacing_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('TextBounds', TCustomActionControl_TextBounds_si, TRect_sw, True, True, 0, False);
  AData.AddProperty('Transparent', TCustomActionControl_Transparent_si, Boolean_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Style', TActionBarStyleList_Style_si, TActionBarStyle_sw, True, False, 1, False);
end;
...
function ActnMan_TBackgroundLayout_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBackgroundLayout = (blStretch, blTile, blLeftBanner...
...
function ActnMan_TChangesAllowed_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TChangesAllowed = (caMove, caDelete);
...
function ActnMan_TCaptionOptions_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCaptionOptions = (coSelective, coAll);
...
function ActnMan_TBarOrientation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBarOrientation = (boRightToLeft, boTopToBottom, boB...
...
function ActnMan_TBarEdge_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBarEdge = (beRight, beEither);
