...
uses
  ...
  LMDSctSysWrappers, Types, Windows, Messages, Classes, Forms, Controls,
  Contnrs, Graphics, ActnList, ToolWin, ExtCtrls, ActnMan, ActnCtrls, Menus,
  StdCtrls, ShadowWnd, Buttons, StdActns, ActnMenus, Windows_LMDSW,
  Messages_LMDSW, Classes_LMDSW, Forms_LMDSW, Controls_LMDSW, Contnrs_LMDSW,
  Graphics_LMDSW, ActnList_LMDSW, ToolWin_LMDSW, ExtCtrls_LMDSW, ActnMan_LMDSW,
  ActnCtrls_LMDSW, Menus_LMDSW, StdCtrls_LMDSW, ShadowWnd_LMDSW, Buttons_LMDSW,
  StdActns_LMDSW;
...
begin
  ...
  AData.AddProperty('Bars', TMenuStack_Bars_si, TCustomActionMenuBar_sw, True, False, 1, True);
...
class function TAnimationStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TAnimationStyle);
end;
...
function TCustomActionMenuBar_PopupStack_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property PopupStack: TMenuStack read <getter>;

  Result := TMenuStack_sw.ToVar(TCustomActionMenuBar_sacc(TCustomActionMenuBar(
    AObj)).PopupStack);
end;
...
begin
  ...
  AData.AddProperty('AnimateDuration', TCustomActionMenuBar_AnimateDuration_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('DelayItem', TCustomActionMenuBar_DelayItem_si, TCustomActionControl_sw, True, True, 0, True);
  AData.AddProperty('Expandable', TCustomActionMenuBar_Expandable_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Expanded', TCustomActionMenuBar_Expanded_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('MouseControl', TCustomActionMenuBar_MouseControl_si, TControl_sw, True, True, 0, True);
  AData.AddProperty('ParentMenu', TCustomActionMenuBar_ParentMenu_si, TCustomActionMenuBar_sw, True, True, 0, True);
  AData.AddProperty('PopupStack', TCustomActionMenuBar_PopupStack_si, TMenuStack_sw, True, False, 0, True);
  AData.AddProperty('Selected', TCustomActionMenuBar_Selected_si, TActionClientItem_sw, True, False, 0, True);
  ...
  AData.AddProperty('AnimationStyle', TCustomActionMenuBar_AnimationStyle_si, TAnimationStyle_sw, True, True, 0, False);
  AData.AddProperty('AutoFocus', TCustomActionMenuBar_AutoFocus_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ExpandDelay', TCustomActionMenuBar_ExpandDelay_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('InMenuLoop', TCustomActionMenuBar_InMenuLoop_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ParentControl', TCustomActionMenuBar_ParentControl_si, TCustomActionControl_sw, True, True, 0, False);
  AData.AddProperty('RootMenu', TCustomActionMenuBar_RootMenu_si, TCustomActionMenuBar_sw, True, True, 0, False);
  AData.AddProperty('UseSystemFont', TCustomActionMenuBar_UseSystemFont_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnEnterMenuLoop', TCustomActionMenuBar_OnEnterMenuLoop_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnExitMenuLoop', TCustomActionMenuBar_OnExitMenuLoop_si, TExitMenuEvent_sw, True, True, 0, False);
  AData.AddProperty('OnGetPopupClass', TCustomActionMenuBar_OnGetPopupClass_si, TGetPopupClassEvent_sw, True, True, 0, False);
  AData.AddProperty('OnPopup', TCustomActionMenuBar_OnPopup_si, TMenuPopupEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Menu', TCustomMenuExpandBtn_Menu_si, TCustomActionMenuBar_sw, True, False, 0, True);
end;
...
begin
  ...
  AData.AddProperty('ExpandBtn', TCustomActionPopupMenu_ExpandBtn_si, TCustomMenuExpandBtn_sw, True, True, 0, False);
  AData.AddProperty('Shadow', TCustomActionPopupMenu_Shadow_si, Boolean_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('AddlItem', TCustomizeActionToolBar_AddlItem_si, TActionClientItem_sw, True, False, 0, True);
  AData.AddProperty('AdditionalItem', TCustomizeActionToolBar_AdditionalItem_si, TActionClientItem_sw, True, False, 0, False);
end;
...
class function TMDIButtonStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TMDIButtonStyle);
end;
...
begin
  ...
  AData.AddProperty('ButtonStyle', TCustomMDIMenuButton_ButtonStyle_si, TMDIButtonStyle_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Inactive', TCustomActionMainMenuBar_Inactive_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('PersistentHotKeys');
  AData.AddProperty('Shadows', TCustomActionMainMenuBar_Shadows_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('WindowMenu', TCustomActionMainMenuBar_WindowMenu_si, string_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('AnimateDuration');
  AData.AddPropertyRedecl('AnimationStyle');
  AData.AddPropertyRedecl('AutoFocus');
  ...
  AData.AddPropertyRedecl('ExpandDelay');
  ...
  AData.AddPropertyRedecl('PersistentHotKeys');
  AData.AddPropertyRedecl('Shadows');
  ...
  AData.AddPropertyRedecl('OnEnterMenuLoop');
  AData.AddPropertyRedecl('OnExit');
  AData.AddPropertyRedecl('OnExitMenuLoop');
  AData.AddPropertyRedecl('OnGetControlClass');
  AData.AddPropertyRedecl('OnGetPopupClass');
  ...
  AData.AddPropertyRedecl('OnPopup');
...
begin
  ...
  AData.AddProperty('Menu', TCustomMenuItem_Menu_si, TCustomActionMenuBar_sw, True, False, 0, True);
  AData.AddProperty('MouseSelected', TCustomMenuItem_MouseSelected_si, Boolean_sw, True, False, 0, True);
  AData.AddProperty('ShortCutBounds', TCustomMenuItem_ShortCutBounds_si, TRect_sw, True, True, 0, True);
  AData.AddProperty('Edges', TCustomMenuItem_Edges_si, TMenuEdges_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Menu', TCustomMenuButton_Menu_si, TCustomActionMenuBar_sw, True, False, 0, True);
end;
...
function ActnMenus_TAnimationStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TAnimationStyle = (asDefault, asUnFold, asSlide, asF...
...
function ActnMenus_TMDIButtonStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMDIButtonStyle = (mbRestore, mbClose);
