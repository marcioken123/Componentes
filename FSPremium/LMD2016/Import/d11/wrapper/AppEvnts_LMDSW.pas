...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'AppEvnts' unit.
  #
  # WARNING:
...
uses
  ...
  LMDSctSysWrappers, Types, Windows, Messages, SysUtils, Classes, Forms,
  ActnList, AppEvnts, Windows_LMDSW, Messages_LMDSW, SysUtils_LMDSW,
  Classes_LMDSW, Forms_LMDSW, ActnList_LMDSW;
...
begin
  ...
  AData.AddProperty('OnActionExecute', TCustomApplicationEvents_OnActionExecute_si, TActionEvent_sw, True, True, 0, True);
  AData.AddProperty('OnActionUpdate', TCustomApplicationEvents_OnActionUpdate_si, TActionEvent_sw, True, True, 0, True);
  AData.AddProperty('OnActivate', TCustomApplicationEvents_OnActivate_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDeactivate', TCustomApplicationEvents_OnDeactivate_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnException', TCustomApplicationEvents_OnException_si, TExceptionEvent_sw, True, True, 0, True);
  AData.AddProperty('OnIdle', TCustomApplicationEvents_OnIdle_si, TIdleEvent_sw, True, True, 0, True);
  AData.AddProperty('OnHelp', TCustomApplicationEvents_OnHelp_si, THelpEvent_sw, True, True, 0, True);
  AData.AddProperty('OnHint', TCustomApplicationEvents_OnHint_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnMessage', TCustomApplicationEvents_OnMessage_si, TMessageEvent_sw, True, True, 0, True);
  AData.AddProperty('OnMinimize', TCustomApplicationEvents_OnMinimize_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnRestore', TCustomApplicationEvents_OnRestore_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnShowHint', TCustomApplicationEvents_OnShowHint_si, TShowHintEvent_sw, True, True, 0, True);
  AData.AddProperty('OnSettingChange', TCustomApplicationEvents_OnSettingChange_si, TSettingChangeEvent_sw, True, True, 0, True);
  AData.AddProperty('OnModalBegin', TCustomApplicationEvents_OnModalBegin_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnModalEnd', TCustomApplicationEvents_OnModalEnd_si, TNotifyEvent_sw, True, True, 0, True);
...
begin
  ...
  AData.AddPropertyRedecl('OnActionExecute');
  AData.AddPropertyRedecl('OnActionUpdate');
  AData.AddPropertyRedecl('OnActivate');
  AData.AddPropertyRedecl('OnDeactivate');
  AData.AddPropertyRedecl('OnException');
  AData.AddPropertyRedecl('OnIdle');
  AData.AddPropertyRedecl('OnHelp');
  AData.AddPropertyRedecl('OnHint');
  AData.AddPropertyRedecl('OnMessage');
  AData.AddPropertyRedecl('OnMinimize');
  AData.AddPropertyRedecl('OnModalBegin');
  AData.AddPropertyRedecl('OnModalEnd');
  AData.AddPropertyRedecl('OnRestore');
  AData.AddPropertyRedecl('OnShowHint');
  AData.AddPropertyRedecl('OnShortCut');
  AData.AddPropertyRedecl('OnSettingChange');
end;
