...
uses
  ...
  ActnMan, ActnCtrls, ActnMenus, Buttons, CustomizeDlg, Windows_LMDSW,
  ...
  ImgList_LMDSW, ActnMan_LMDSW, ActnCtrls_LMDSW, ActnMenus_LMDSW,
  Buttons_LMDSW;
...
begin
  ...
  AData.AddProperty('ActionManager', TCustomizeFrm_ActionManager_si, TCustomActionManager_sw, True, True, 0, False);
  AData.AddProperty('ActiveActionList', TCustomizeFrm_ActiveActionList_si, TCustomActionList_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('CustomizeForm', TCustomizeDlg_CustomizeForm_si, TCustomizeFrm_sw, True, False, 0, False);
  AData.AddProperty('ActionManager', TCustomizeDlg_ActionManager_si, TCustomActionManager_sw, True, True, 0, False);
  AData.AddProperty('StayOnTop', TCustomizeDlg_StayOnTop_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnClose', TCustomizeDlg_OnClose_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnShow', TCustomizeDlg_OnShow_si, TNotifyEvent_sw, True, True, 0, False);
end;
