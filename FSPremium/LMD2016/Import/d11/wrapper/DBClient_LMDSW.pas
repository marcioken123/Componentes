...
type
  ...
  TCustomClientDataSet_sw = class(TWideDataSet_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
...
begin
  ...
  AData.AddProperty('Context', EReconcileError_Context_si, string_sw, True, False, 0, False);
end;
...
begin
  ...
  AData.AddProperty('OnGetUsername', TCustomRemoteServer_OnGetUsername_si, TGetUsernameEvent_sw, True, True, 0, True);
  ...
  AData.AddProperty('AppServer', TCustomRemoteServer_AppServer_si, Variant_sw, True, False, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Connection', TConnectionBroker_Connection_si, TCustomRemoteServer_sw, True, True, 0, False);
  ...
  AData.AddPropertyRedecl('OnGetUsername');
...
begin
  ...
  AData.AddProperty('DependentFields', TAggregate_DependentFields_si, TBits_sw, True, False, 0, True);
  AData.AddProperty('RecBufOfs', TAggregate_RecBufOfs_si, Integer_sw, True, True, 0, True);
  AData.AddFunction('Value', TAggregate_Value_si, Variant_sw, 0, False);
  AData.AddProperty('InUse', TAggregate_InUse_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DataSet', TAggregate_DataSet_si, TCustomClientDataSet_sw, True, False, 0, False);
  AData.AddProperty('DataSize', TAggregate_DataSize_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('DataType', TAggregate_DataType_si, TFieldType_sw, True, False, 0, False);
  AData.AddProperty('Active', TAggregate_Active_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AggregateName', TAggregate_AggregateName_si, string_sw, True, True, 0, False);
  AData.AddProperty('Expression', TAggregate_Expression_si, string_sw, True, True, 0, False);
  AData.AddProperty('GroupingLevel', TAggregate_GroupingLevel_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('IndexName', TAggregate_IndexName_si, string_sw, True, True, 0, False);
  AData.AddProperty('Visible', TAggregate_Visible_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnUpdate', TAggregate_OnUpdate_si, TAggUpdateEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Items', TAggregates_Items_si, TAggregate_sw, True, True, 1, False);
...
begin
  ...
  AData.AddFunction('Copy', TRecInfo_Copy_si, TRecInfo_sw, 0);
  ...
  AData.AddConstructor('Create', TRecInfo_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TKeyBuffer_Copy_si, TKeyBuffer_sw, 0);
  ...
  AData.AddConstructor('Create', TKeyBuffer_Create_si, 0);
end;
...
class function TDataPacketFormat_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDataPacketFormat);
end;
...
class function TReconcileAction_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TReconcileAction);
end;
...
begin
  ...
  AData.AddFunction('Copy', TReconcileInfo_Copy_si, TReconcileInfo_sw, 0);
  ...
  AData.AddConstructor('Create', TReconcileInfo_Create_si, 0);
end;
...
class function TDataSetOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDataSetOption);
end;
...
class function TFetchOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFetchOption);
end;
...
function TCustomClientDataSet_Ranged_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Ranged: Boolean read <getter>;

  Result := TCustomClientDataSet_sacc(TCustomClientDataSet(AObj)).Ranged;
end;
...
begin
  ...
  TCustomClientDataSet(AObj).AppendData(OleVariant(AArgs[0]), Boolean(
    AArgs[1]));
end;
...
begin
  ...
  Result := TCustomClientDataSet(AObj).DataRequest(OleVariant(AArgs[0]));
end;
...
begin
  ...
  Result := TCustomClientDataSet(AObj).Reconcile(OleVariant(AArgs[0]));
end;
...
begin
  ...
  TCustomClientDataSet(AObj).SaveToFile(string(AArgs[0]), TDataPacketFormat_sw.
    FromVar(AArgs[1]));
end;
...
begin
  ...
  if IsGet then
    ...
    TCustomClientDataSet(AObj).Data := OleVariant(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Aggregates', TCustomClientDataSet_Aggregates_si, TAggregates_sw, True, True, 0, True);
  AData.AddProperty('AggregatesActive', TCustomClientDataSet_AggregatesActive_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('CommandText', TCustomClientDataSet_CommandText_si, WideString_sw, True, True, 0, True);
  AData.AddProperty('DisableStringTrim', TCustomClientDataSet_DisableStringTrim_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('IndexDefs', TCustomClientDataSet_IndexDefs_si, TIndexDefs_sw, True, True, 0, True);
  AData.AddProperty('IndexName', TCustomClientDataSet_IndexName_si, Widestring_sw, True, True, 0, True);
  AData.AddProperty('IsClone', TCustomClientDataSet_IsClone_si, Boolean_sw, True, False, 0, True);
  AData.AddProperty('FetchOnDemand', TCustomClientDataSet_FetchOnDemand_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('MasterSource', TCustomClientDataSet_MasterSource_si, TDataSource_sw, True, True, 0, True);
  AData.AddProperty('Params', TCustomClientDataSet_Params_si, TParams_sw, True, True, 0, True);
  AData.AddProperty('ProviderEOF', TCustomClientDataSet_ProviderEOF_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ReadOnly', TCustomClientDataSet_ReadOnly_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('StoreDefs', TCustomClientDataSet_StoreDefs_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Ranged', TCustomClientDataSet_Ranged_si, Boolean_sw, True, False, 0, True);
  AData.AddProperty('OnReconcileError', TCustomClientDataSet_OnReconcileError_si, TReconcileErrorEvent_sw, True, True, 0, True);
  AData.AddProperty('BeforeApplyUpdates', TCustomClientDataSet_BeforeApplyUpdates_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddProperty('AfterApplyUpdates', TCustomClientDataSet_AfterApplyUpdates_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddProperty('BeforeGetRecords', TCustomClientDataSet_BeforeGetRecords_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddProperty('AfterGetRecords', TCustomClientDataSet_AfterGetRecords_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddProperty('BeforeRowRequest', TCustomClientDataSet_BeforeRowRequest_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddProperty('AfterRowRequest', TCustomClientDataSet_AfterRowRequest_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddProperty('BeforeExecute', TCustomClientDataSet_BeforeExecute_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddProperty('AfterExecute', TCustomClientDataSet_AfterExecute_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddProperty('BeforeGetParams', TCustomClientDataSet_BeforeGetParams_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddProperty('AfterGetParams', TCustomClientDataSet_AfterGetParams_si, TRemoteEvent_sw, True, True, 0, True);
  AData.AddPropertyRedecl('Active');
  AData.AddPropertyRedecl('DataSetField');
  AData.AddProperty('ProviderName', TCustomClientDataSet_ProviderName_si, string_sw, True, True, 0, False);
  AData.AddProperty('FileName', TCustomClientDataSet_FileName_si, string_sw, True, True, 0, False);
  AData.AddProperty('ConnectionBroker', TCustomClientDataSet_ConnectionBroker_si, TConnectionBroker_sw, True, True, 0, False);
  AData.AddProperty('IndexFieldNames', TCustomClientDataSet_IndexFieldNames_si, Widestring_sw, True, True, 0, False);
  AData.AddProperty('MasterFields', TCustomClientDataSet_MasterFields_si, Widestring_sw, True, True, 0, False);
  AData.AddProperty('PacketRecords', TCustomClientDataSet_PacketRecords_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('RemoteServer', TCustomClientDataSet_RemoteServer_si, TCustomRemoteServer_sw, True, True, 0, False);
  AData.AddProcedure('AddIndex', TCustomClientDataSet_AddIndex_si, 6, False);
  ...
  AData.AddProcedure('CloneCursor', TCustomClientDataSet_CloneCursor_si, 3, False);
  ...
  AData.AddProperty('HasAppServer', TCustomClientDataSet_HasAppServer_si, Boolean_sw, True, False, 0, False);
  AData.AddProcedure('LoadFromFile', TCustomClientDataSet_LoadFromFile_si, 1, False);
  ...
  AData.AddProcedure('SaveToFile', TCustomClientDataSet_SaveToFile_si, 2, False);
  AData.AddProcedure('SaveToStream', TCustomClientDataSet_SaveToStream_si, 2, False);
  AData.AddProcedure('SetKey', TCustomClientDataSet_SetKey_si, 0, False);
  AData.AddProcedure('SetOptionalParam', TCustomClientDataSet_SetOptionalParam_si, 3, False);
  ...
  AData.AddProperty('ActiveAggs', TCustomClientDataSet_ActiveAggs_si, TList_sw, True, False, 1, False);
  AData.AddProperty('ChangeCount', TCustomClientDataSet_ChangeCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('CloneSource', TCustomClientDataSet_CloneSource_si, TCustomClientDataSet_sw, True, False, 0, False);
  AData.AddProperty('Data', TCustomClientDataSet_Data_si, OleVariant_sw, True, True, 0, False);
  AData.AddProperty('XMLData', TCustomClientDataSet_XMLData_si, string_sw, True, True, 0, False);
  AData.AddProperty('DataSize', TCustomClientDataSet_DataSize_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Delta', TCustomClientDataSet_Delta_si, OleVariant_sw, True, False, 0, False);
  AData.AddProperty('GroupingLevel', TCustomClientDataSet_GroupingLevel_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('IndexFieldCount', TCustomClientDataSet_IndexFieldCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('IndexFields', TCustomClientDataSet_IndexFields_si, TField_sw, True, True, 1, False);
  AData.AddProperty('KeyExclusive', TCustomClientDataSet_KeyExclusive_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('KeyFieldCount', TCustomClientDataSet_KeyFieldCount_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('KeySize', TCustomClientDataSet_KeySize_si, Word_sw, True, False, 0, False);
  AData.AddProperty('LogChanges', TCustomClientDataSet_LogChanges_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SavePoint', TCustomClientDataSet_SavePoint_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('StatusFilter', TCustomClientDataSet_StatusFilter_si, TUpdateStatusSet_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Active');
  AData.AddPropertyRedecl('Aggregates');
  AData.AddPropertyRedecl('AggregatesActive');
  AData.AddPropertyRedecl('AutoCalcFields');
  AData.AddPropertyRedecl('CommandText');
  AData.AddPropertyRedecl('ConnectionBroker');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('DataSetField');
  AData.AddPropertyRedecl('DisableStringTrim');
  ...
  AData.AddPropertyRedecl('FetchOnDemand');
  AData.AddPropertyRedecl('MasterFields');
  AData.AddPropertyRedecl('MasterSource');
  AData.AddPropertyRedecl('ObjectView');
  AData.AddPropertyRedecl('PacketRecords');
  AData.AddPropertyRedecl('Params');
  AData.AddPropertyRedecl('ProviderName');
  AData.AddPropertyRedecl('ReadOnly');
  AData.AddPropertyRedecl('RemoteServer');
  ...
  AData.AddPropertyRedecl('OnReconcileError');
  ...
  AData.AddPropertyRedecl('Ranged');
end;
...
function DBClient_TDataPacketFormat_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDataPacketFormat = (dfXML, dfXMLUTF8);
...
function DBClient_TReconcileAction_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TReconcileAction = (raAbort, raMerge, raCorrect, raC...
...
function DBClient_TDataSetOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDataSetOption = (doDisableDeletes, doDisableEdits, ...
...
function DBClient_TFetchOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFetchOption = (foBlobs, foDetails);
...
function DBClient_TCustomClientDataSet_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCustomClientDataSet = class(TWideDataSet);
...
begin
  ...
  Result := DBClient.PackageParams(TParams_sw.FromVar(AArgs[0]), TParamTypes_sw.
    FromVar(AArgs[1]));
end;
...
begin
  ...
  DBClient.UnpackParams(OleVariant(AArgs[0]), TParams_sw.FromVar(AArgs[1]));
end;
...
begin
  ...
  AData.AddFunction('PackageParams', DBClient_PackageParams_si, OleVariant_sw, 2, False);
