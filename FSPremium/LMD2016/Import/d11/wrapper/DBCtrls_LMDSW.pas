...
begin
  ...
  AData.AddProperty('CanModify', TFieldDataLink_CanModify_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Control', TFieldDataLink_Control_si, TComponent_sw, True, True, 0, False);
  AData.AddProperty('Editing', TFieldDataLink_Editing_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Field', TFieldDataLink_Field_si, TField_sw, True, False, 0, False);
  AData.AddProperty('FieldName', TFieldDataLink_FieldName_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('OnDataChange', TFieldDataLink_OnDataChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnEditingChange', TFieldDataLink_OnEditingChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnUpdateData', TFieldDataLink_OnUpdateData_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnActiveChange', TFieldDataLink_OnActiveChange_si, TNotifyEvent_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Ctl3DButton', TPaintControl_Ctl3DButton_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Handle', TPaintControl_Handle_si, HWnd_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('Field', TDBEdit_Field_si, TField_sw, True, False, 0, False);
  ...
  AData.AddProperty('DataField', TDBEdit_DataField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDBEdit_DataSource_si, TDataSource_sw, True, True, 0, False);
  ...
  AData.AddProperty('ReadOnly', TDBEdit_ReadOnly_si, Boolean_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Field', TDBText_Field_si, TField_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  ...
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Constraints');
  AData.AddProperty('DataField', TDBText_DataField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDBText_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
...
begin
  ...
  AData.AddProperty('Field', TDBCheckBox_Field_si, TField_sw, True, False, 0, False);
  ...
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddProperty('DataField', TDBCheckBox_DataField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDBCheckBox_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('ReadOnly', TDBCheckBox_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddProperty('ValueChecked', TDBCheckBox_ValueChecked_si, string_sw, True, True, 0, False);
  AData.AddProperty('ValueUnchecked', TDBCheckBox_ValueUnchecked_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('WordWrap');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
...
begin
  ...
  AData.AddProperty('Field', TDBComboBox_Field_si, TField_sw, True, False, 0, False);
  ...
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddProperty('DataField', TDBComboBox_DataField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDBComboBox_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('ReadOnly', TDBComboBox_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
...
begin
  ...
  AData.AddProperty('Field', TDBListBox_Field_si, TField_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoComplete');
  AData.AddPropertyRedecl('BevelEdges');
  ...
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddProperty('DataField', TDBListBox_DataField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDBListBox_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('ReadOnly', TDBListBox_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('Style');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
...
begin
  ...
  AData.AddProperty('DataLink', TDBRadioGroup_DataLink_si, TFieldDataLink_sw, True, False, 0, True);
  AData.AddProperty('Field', TDBRadioGroup_Field_si, TField_sw, True, False, 0, False);
  AData.AddPropertyRedecl('ItemIndex');
  AData.AddProperty('Value', TDBRadioGroup_Value_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('Caption');
  ...
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddProperty('DataField', TDBRadioGroup_DataField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDBRadioGroup_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('ReadOnly', TDBRadioGroup_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddProperty('Values', TDBRadioGroup_Values_si, TStrings_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
  AData.AddProperty('OnChange', TDBRadioGroup_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
...
begin
  ...
  AData.AddProperty('Field', TDBMemo_Field_si, TField_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Alignment');
  AData.AddPropertyRedecl('Anchors');
  AData.AddProperty('AutoDisplay', TDBMemo_AutoDisplay_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  AData.AddPropertyRedecl('BevelOuter');
  AData.AddPropertyRedecl('BevelKind');
  ...
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddProperty('DataField', TDBMemo_DataField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDBMemo_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('ReadOnly', TDBMemo_ReadOnly_si, Boolean_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Field', TDBImage_Field_si, TField_sw, True, False, 0, False);
  AData.AddProperty('Picture', TDBImage_Picture_si, TPicture_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddProperty('AutoDisplay', TDBImage_AutoDisplay_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('BorderStyle', TDBImage_BorderStyle_si, TBorderStyle_sw, True, True, 0, False);
  AData.AddProperty('Center', TDBImage_Center_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddProperty('DataField', TDBImage_DataField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDBImage_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('ReadOnly', TDBImage_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('QuickDraw', TDBImage_QuickDraw_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('Stretch', TDBImage_Stretch_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnClick');
...
class function TNavGlyph_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TNavGlyph);
end;
...
class function TNavigateBtn_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TNavigateBtn);
end;
...
begin
  ...
  AData.AddProperty('DataSource', TDBNavigator_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddProperty('VisibleButtons', TDBNavigator_VisibleButtons_si, TNavButtonSet_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('DragCursor');
  ...
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddProperty('Flat', TDBNavigator_Flat_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddProperty('Hints', TDBNavigator_Hints_si, TStrings_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentCtl3D');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('ConfirmDelete', TDBNavigator_ConfirmDelete_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
  AData.AddProperty('BeforeAction', TDBNavigator_BeforeAction_si, ENavClick_sw, True, True, 0, False);
  AData.AddProperty('OnClick', TDBNavigator_OnClick_si, ENavClick_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
...
begin
  ...
  AData.AddProperty('Index', TNavButton_Index_si, TNavigateBtn_sw, True, True, 0, False);
end;
...
begin
  ...
  if IsGet then
    ...
    TDBLookupControl_sacc(TDBLookupControl(AObj)).KeyValue := Variant(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('DataField', TDBLookupControl_DataField_si, WideString_sw, True, True, 0, True);
  AData.AddProperty('DataLink', TDBLookupControl_DataLink_si, TDataSourceLink_sw, True, False, 0, True);
  AData.AddProperty('DataSource', TDBLookupControl_DataSource_si, TDataSource_sw, True, True, 0, True);
  AData.AddProperty('HasFocus', TDBLookupControl_HasFocus_si, Boolean_sw, True, False, 0, True);
  AData.AddProperty('KeyField', TDBLookupControl_KeyField_si, string_sw, True, True, 0, True);
  AData.AddProperty('KeyValue', TDBLookupControl_KeyValue_si, Variant_sw, True, True, 0, True);
  AData.AddProperty('ListActive', TDBLookupControl_ListActive_si, Boolean_sw, True, False, 0, True);
  AData.AddProperty('ListField', TDBLookupControl_ListField_si, string_sw, True, True, 0, True);
  AData.AddProperty('ListFieldIndex', TDBLookupControl_ListFieldIndex_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('ListFields', TDBLookupControl_ListFields_si, TList_sw, True, False, 0, True);
  AData.AddProperty('ListLink', TDBLookupControl_ListLink_si, TListSourceLink_sw, True, False, 0, True);
  AData.AddProperty('ListSource', TDBLookupControl_ListSource_si, TDataSource_sw, True, True, 0, True);
  AData.AddProperty('NullValueKey', TDBLookupControl_NullValueKey_si, TShortCut_sw, True, True, 0, True);
  AData.AddProperty('ReadOnly', TDBLookupControl_ReadOnly_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('SearchText', TDBLookupControl_SearchText_si, string_sw, True, True, 0, True);
  AData.AddProperty('Field', TDBLookupControl_Field_si, TField_sw, True, False, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('KeyValue');
  AData.AddProperty('SelectedItem', TDBLookupListBox_SelectedItem_si, string_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  ...
  AData.AddPropertyRedecl('BevelWidth');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddProperty('BorderStyle', TDBLookupListBox_BorderStyle_si, TBorderStyle_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddPropertyRedecl('DataField');
  ...
  AData.AddPropertyRedecl('ImeMode');
  AData.AddPropertyRedecl('ImeName');
  AData.AddPropertyRedecl('KeyField');
  AData.AddPropertyRedecl('ListField');
  AData.AddPropertyRedecl('ListFieldIndex');
  AData.AddPropertyRedecl('ListSource');
  AData.AddPropertyRedecl('NullValueKey');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentCtl3D');
  AData.AddPropertyRedecl('ParentFont');
  ...
  AData.AddProperty('RowCount', TDBLookupListBox_RowCount_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
...
class function TDropDownAlign_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDropDownAlign);
end;
...
begin
  ...
  AData.AddPropertyRedecl('KeyValue');
  AData.AddProperty('ListVisible', TDBLookupComboBox_ListVisible_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Text', TDBLookupComboBox_Text_si, string_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  ...
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddProperty('DropDownAlign', TDBLookupComboBox_DropDownAlign_si, TDropDownAlign_sw, True, True, 0, False);
  AData.AddProperty('DropDownRows', TDBLookupComboBox_DropDownRows_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('DropDownWidth', TDBLookupComboBox_DropDownWidth_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('ImeMode');
  AData.AddPropertyRedecl('ImeName');
  ...
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnClick');
  AData.AddProperty('OnCloseUp', TDBLookupComboBox_OnCloseUp_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddProperty('OnDropDown', TDBLookupComboBox_OnDropDown_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnEndDock');
  AData.AddPropertyRedecl('OnEndDrag');
  AData.AddPropertyRedecl('OnEnter');
  AData.AddPropertyRedecl('OnExit');
...
begin
  ...
  AData.AddProperty('Field', TDBRichEdit_Field_si, TField_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Alignment');
  AData.AddPropertyRedecl('Anchors');
  AData.AddProperty('AutoDisplay', TDBRichEdit_AutoDisplay_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  AData.AddPropertyRedecl('BevelOuter');
  AData.AddPropertyRedecl('BevelKind');
  ...
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddProperty('DataField', TDBRichEdit_DataField_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TDBRichEdit_DataSource_si, TDataSource_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  ...
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('ReadOnly', TDBRichEdit_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ScrollBars');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
...
function DBCtrls_TNavigateBtn_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TNavigateBtn = (nbPrior, nbNext, nbLast, nbInsert, n...
...
function DBCtrls_TDropDownAlign_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDropDownAlign = (daRight, daCenter);
