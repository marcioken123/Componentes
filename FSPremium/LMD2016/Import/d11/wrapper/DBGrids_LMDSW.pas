...
class function TColumnValue_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TColumnValue);
end;
...
begin
  ...
  AData.AddProperty('Column', TColumnTitle_Column_si, TColumn_sw, True, False, 0, False);
  AData.AddProperty('Alignment', TColumnTitle_Alignment_si, TAlignment_sw, True, True, 0, False);
  AData.AddProperty('Caption', TColumnTitle_Caption_si, string_sw, True, True, 0, False);
  AData.AddProperty('Color', TColumnTitle_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('Font', TColumnTitle_Font_si, TFont_sw, True, True, 0, False);
...
class function TColumnButtonStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TColumnButtonStyle);
end;
...
begin
  ...
  AData.AddProperty('IsStored', TColumn_IsStored_si, Boolean_sw, True, True, 0, True);
  ...
  AData.AddProperty('Grid', TColumn_Grid_si, TCustomDBGrid_sw, True, False, 0, False);
  AData.AddProperty('AssignedValues', TColumn_AssignedValues_si, TColumnValues_sw, True, False, 0, False);
  AData.AddProperty('Expandable', TColumn_Expandable_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Field', TColumn_Field_si, TField_sw, True, True, 0, False);
  AData.AddProperty('ParentColumn', TColumn_ParentColumn_si, TColumn_sw, True, False, 0, False);
  AData.AddProperty('Showing', TColumn_Showing_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Alignment', TColumn_Alignment_si, TAlignment_sw, True, True, 0, False);
  AData.AddProperty('ButtonStyle', TColumn_ButtonStyle_si, TColumnButtonStyle_sw, True, True, 0, False);
  AData.AddProperty('Color', TColumn_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('DropDownRows', TColumn_DropDownRows_si, Cardinal_sw, True, True, 0, False);
  AData.AddProperty('Expanded', TColumn_Expanded_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('FieldName', TColumn_FieldName_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('Font', TColumn_Font_si, TFont_sw, True, True, 0, False);
  AData.AddProperty('ImeMode', TColumn_ImeMode_si, TImeMode_sw, True, True, 0, False);
  AData.AddProperty('ImeName', TColumn_ImeName_si, TImeName_sw, True, True, 0, False);
  AData.AddProperty('PickList', TColumn_PickList_si, TStrings_sw, True, True, 0, False);
  AData.AddProperty('PopupMenu', TColumn_PopupMenu_si, TPopupMenu_sw, True, True, 0, False);
  AData.AddProperty('ReadOnly', TColumn_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Title', TColumn_Title_si, TColumnTitle_sw, True, True, 0, False);
  AData.AddProperty('Width', TColumn_Width_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Visible', TColumn_Visible_si, Boolean_sw, True, True, 0, False);
end;
...
class function TDBGridColumnsState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDBGridColumnsState);
end;
...
begin
  ...
  AData.AddProperty('State', TDBGridColumns_State_si, TDBGridColumnsState_sw, True, True, 0, False);
  AData.AddProperty('Grid', TDBGridColumns_Grid_si, TCustomDBGrid_sw, True, False, 0, False);
  AData.AddProperty('Items', TDBGridColumns_Items_si, TColumn_sw, True, True, 1, False);
...
begin
  ...
  AData.AddProperty('DefaultFields', TGridDataLink_DefaultFields_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('FieldCount', TGridDataLink_FieldCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Fields', TGridDataLink_Fields_si, TField_sw, True, False, 1, False);
  AData.AddProperty('SparseMap', TGridDataLink_SparseMap_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Grid', TGridDataLink_Grid_si, TCustomDBGrid_sw, True, False, 0, False);
...
function TBookmarkList_Find_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Integer;
begin
  // function Find(const Item: TBookmarkStr; var Index: Intege...

  v_1 := Integer(AArgs[1]);
  Result := TBookmarkList(AObj).Find(TBookmarkStr_sw.FromVar(AArgs[0]), v_1);
  AssignRefParam(AArgs[1], v_1);
end;

function TBookmarkList_IndexOf_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function IndexOf(const Item: TBookmarkStr): Integer;

  Result := TBookmarkList(AObj).IndexOf(TBookmarkStr_sw.FromVar(AArgs[0]));
end;
...
function TBookmarkList_Items_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Items[Index: Integer]: TBookmarkStr read <getter...

  Result := TBookmarkStr_sw.ToVar(TBookmarkList(AObj).Items[Integer(AArgs[0])]);
end;
...
begin
  ...
  AData.AddFunction('Find', TBookmarkList_Find_si, Boolean_sw, 2, False);
  AData.AddFunction('IndexOf', TBookmarkList_IndexOf_si, Integer_sw, 1, False);
  AData.AddFunction('Refresh', TBookmarkList_Refresh_si, Boolean_sw, 0, False);
  AData.AddProperty('Count', TBookmarkList_Count_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('CurrentRowSelected', TBookmarkList_CurrentRowSelected_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Items', TBookmarkList_Items_si, TBookmarkStr_sw, True, False, 1, False);
...
class function TDBGridOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDBGridOption);
end;
...
begin
  ...
  AData.AddProperty('Columns', TCustomDBGrid_Columns_si, TDBGridColumns_sw, True, True, 0, True);
  AData.AddProperty('DefaultDrawing', TCustomDBGrid_DefaultDrawing_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('DataLink', TCustomDBGrid_DataLink_si, TGridDataLink_sw, True, False, 0, True);
  AData.AddProperty('IndicatorOffset', TCustomDBGrid_IndicatorOffset_si, Byte_sw, True, False, 0, True);
  AData.AddProperty('LayoutLock', TCustomDBGrid_LayoutLock_si, Byte_sw, True, False, 0, True);
  AData.AddProperty('Options', TCustomDBGrid_Options_si, TDBGridOptions_sw, True, True, 0, True);
  AData.AddProperty('ReadOnly', TCustomDBGrid_ReadOnly_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('SelectedRows', TCustomDBGrid_SelectedRows_si, TBookmarkList_sw, True, False, 0, True);
  AData.AddProperty('TitleFont', TCustomDBGrid_TitleFont_si, TFont_sw, True, True, 0, True);
  AData.AddProperty('UpdateLock', TCustomDBGrid_UpdateLock_si, Byte_sw, True, False, 0, True);
  AData.AddProperty('OnColEnter', TCustomDBGrid_OnColEnter_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnColExit', TCustomDBGrid_OnColExit_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnEditButtonClick', TCustomDBGrid_OnEditButtonClick_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnColumnMoved', TCustomDBGrid_OnColumnMoved_si, TMovedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCellClick', TCustomDBGrid_OnCellClick_si, TDBGridClickEvent_sw, True, True, 0, True);
  AData.AddProperty('OnTitleClick', TCustomDBGrid_OnTitleClick_si, TDBGridClickEvent_sw, True, True, 0, True);
  AData.AddProcedure('ShowPopupEditor', TCustomDBGrid_ShowPopupEditor_si, 3, False);
  AData.AddFunction('ValidFieldIndex', TCustomDBGrid_ValidFieldIndex_si, Boolean_sw, 1, False);
  AData.AddPropertyRedecl('EditorMode');
  AData.AddProperty('FieldCount', TCustomDBGrid_FieldCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Fields', TCustomDBGrid_Fields_si, TField_sw, True, False, 1, False);
  AData.AddProperty('SelectedField', TCustomDBGrid_SelectedField_si, TField_sw, True, True, 0, False);
  AData.AddProperty('SelectedIndex', TCustomDBGrid_SelectedIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('DataSource', TCustomDBGrid_DataSource_si, TDataSource_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('SelectedRows');
  ...
  AData.AddPropertyRedecl('TitleFont');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnCellClick');
  AData.AddPropertyRedecl('OnColEnter');
  AData.AddPropertyRedecl('OnColExit');
  AData.AddPropertyRedecl('OnColumnMoved');
  AData.AddPropertyRedecl('OnDrawDataCell');
  AData.AddPropertyRedecl('OnDrawColumnCell');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddPropertyRedecl('OnEditButtonClick');
  ...
  AData.AddPropertyRedecl('OnTitleClick');
end;
...
function DBGrids_TColumnValue_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TColumnValue = (cvWidth, cvFont, cvAlignment, cvRead...
...
function DBGrids_TColumnButtonStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TColumnButtonStyle = (cbsEllipsis, cbsNone);
...
function DBGrids_TDBGridColumnsState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDBGridColumnsState = (csCustomized);
...
function DBGrids_TDBGridOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDBGridOption = (dgAlwaysShowEditor, dgTitles, dgInd...
