...
uses
  ...
  LMDSctSysWrappers, Types, Messages, Windows, SysUtils, Classes, Contnrs,
  Controls, Forms, Menus, Graphics, StdCtrls, GraphUtil, ExtCtrls,
  Messages_LMDSW, Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW, Contnrs_LMDSW,
  Controls_LMDSW, Forms_LMDSW, Menus_LMDSW, Graphics_LMDSW, StdCtrls_LMDSW,
  GraphUtil_LMDSW;
...
class function TShapeType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TShapeType);
end;
...
begin
  ...
  AData.AddProperty('Brush', TShape_Brush_si, TBrush_sw, True, True, 0, False);
  ...
  AData.AddProperty('Pen', TShape_Pen_si, TPen_sw, True, True, 0, False);
  AData.AddProperty('Shape', TShape_Shape_si, TShapeType_sw, True, True, 0, False);
...
begin
  ...
  AData.AddPropertyRedecl('OnMouseMove');
  AData.AddPropertyRedecl('OnMouseUp');
  AData.AddProperty('OnPaint', TPaintBox_OnPaint_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnStartDrag');
end;
...
begin
  ...
  AData.AddProperty('Canvas', TImage_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddProperty('Center', TImage_Center_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddProperty('IncrementalDisplay', TImage_IncrementalDisplay_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddProperty('Picture', TImage_Picture_si, TPicture_sw, True, True, 0, False);
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('Proportional', TImage_Proportional_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('Stretch', TImage_Stretch_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Transparent', TImage_Transparent_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDblClick');
...
class function TBevelStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBevelStyle);
end;
...
class function TBevelShape_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBevelShape);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddProperty('Shape', TBevel_Shape_si, TBevelShape_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('Style', TBevel_Style_si, TBevelStyle_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
end;
...
begin
  ...
  AData.AddProperty('Enabled', TTimer_Enabled_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Interval', TTimer_Interval_si, Cardinal_sw, True, True, 0, False);
  AData.AddProperty('OnTimer', TTimer_OnTimer_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Alignment', TCustomPanel_Alignment_si, TAlignment_sw, True, True, 0, True);
  AData.AddProperty('BevelInner', TCustomPanel_BevelInner_si, TPanelBevel_sw, True, True, 0, True);
  AData.AddProperty('BevelOuter', TCustomPanel_BevelOuter_si, TPanelBevel_sw, True, True, 0, True);
  AData.AddProperty('BevelWidth', TCustomPanel_BevelWidth_si, TBevelWidth_sw, True, True, 0, True);
  AData.AddProperty('BorderWidth', TCustomPanel_BorderWidth_si, TBorderWidth_sw, True, True, 0, True);
  AData.AddProperty('BorderStyle', TCustomPanel_BorderStyle_si, TBorderStyle_sw, True, True, 0, True);
  AData.AddProperty('FullRepaint', TCustomPanel_FullRepaint_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Locked', TCustomPanel_Locked_si, Boolean_sw, True, True, 0, True);
...
begin
  ...
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('FullRepaint');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('Locked');
  ...
  AData.AddPropertyRedecl('VerticalAlignment');
  AData.AddPropertyRedecl('Visible');
...
class function TFlowStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFlowStyle);
end;
...
begin
  ...
  AData.AddProperty('AutoWrap', TCustomFlowPanel_AutoWrap_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('FlowStyle', TCustomFlowPanel_FlowStyle_si, TFlowStyle_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddPropertyRedecl('AutoWrap');
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  AData.AddPropertyRedecl('BevelKind');
  AData.AddPropertyRedecl('BevelOuter');
  ...
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('FlowStyle');
  AData.AddPropertyRedecl('FullRepaint');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('Locked');
  AData.AddPropertyRedecl('Padding');
...
class function TSizeStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TSizeStyle);
end;
...
begin
  ...
  AData.AddProperty('Size', TCellItem_Size_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('AutoAdded', TCellItem_AutoAdded_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('SizeStyle', TCellItem_SizeStyle_si, TSizeStyle_sw, True, True, 0, False);
  AData.AddProperty('Value', TCellItem_Value_si, Double_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Items', TCellCollection_Items_si, TCellItem_sw, True, True, 1, False);
end;
...
begin
  ...
  TControlItem(AObj).SetLocation(Integer(AArgs[0]), Integer(AArgs[1]), Boolean(
    AArgs[2]));
end;
...
begin
  ...
  AData.AddProperty('GridPanel', TControlItem_GridPanel_si, TCustomGridPanel_sw, True, False, 0, True);
  AData.AddProperty('Pushed', TControlItem_Pushed_si, Boolean_sw, True, False, 0, True);
  AData.AddProcedure('SetLocation', TControlItem_SetLocation_si, 3, False);
  AData.AddProperty('Column', TControlItem_Column_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ColumnSpan', TControlItem_ColumnSpan_si, TCellSpan_sw, True, True, 0, False);
  AData.AddProperty('Control', TControlItem_Control_si, TControl_sw, True, True, 0, False);
  AData.AddProperty('Row', TControlItem_Row_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('RowSpan', TControlItem_RowSpan_si, TCellSpan_sw, True, True, 0, False);
end;
...
begin
  ...
  TControlCollection(AObj).AddControl(TControl_sw.FromVar(AArgs[0]), Integer(
...
begin
  ...
  AData.AddProcedure('AddControl', TControlCollection_AddControl_si, 3, False);
  ...
  AData.AddProperty('Controls', TControlCollection_Controls_si, TControl_sw, True, True, 2, False);
  AData.AddProperty('ControlItems', TControlCollection_ControlItems_si, TControlItem_sw, True, False, 2, False);
  AData.AddProperty('Items', TControlCollection_Items_si, TControlItem_sw, True, True, 1, False);
...
class function TExpandStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TExpandStyle);
end;
...
begin
  ...
  AData.AddProperty('ColumnSpanIndex', TCustomGridPanel_ColumnSpanIndex_si, Integer_sw, True, False, 2, False);
  AData.AddProperty('CellCount', TCustomGridPanel_CellCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('CellSize', TCustomGridPanel_CellSize_si, TPoint_sw, True, False, 2, False);
  AData.AddProperty('CellRect', TCustomGridPanel_CellRect_si, TRect_sw, True, False, 2, False);
  AData.AddProperty('ColumnCollection', TCustomGridPanel_ColumnCollection_si, TColumnCollection_sw, True, True, 0, False);
  AData.AddProperty('ControlCollection', TCustomGridPanel_ControlCollection_si, TControlCollection_sw, True, True, 0, False);
  AData.AddProperty('ExpandStyle', TCustomGridPanel_ExpandStyle_si, TExpandStyle_sw, True, True, 0, False);
  AData.AddProperty('RowCollection', TCustomGridPanel_RowCollection_si, TRowCollection_sw, True, True, 0, False);
  AData.AddProperty('RowSpanIndex', TCustomGridPanel_RowSpanIndex_si, Integer_sw, True, False, 2, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Caption');
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('ColumnCollection');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('ControlCollection');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddPropertyRedecl('UseDockManager');
  AData.AddPropertyRedecl('DockSite');
  AData.AddPropertyRedecl('DragCursor');
  ...
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('ExpandStyle');
  AData.AddPropertyRedecl('FullRepaint');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('Locked');
  AData.AddPropertyRedecl('Padding');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('RowCollection');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('VerticalAlignment');
...
begin
  ...
  AData.AddProperty('ActivePage', TNotebook_ActivePage_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Ctl3D');
  ...
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Constraints');
  AData.AddProperty('PageIndex', TNotebook_PageIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Pages', TNotebook_Pages_si, TStrings_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentCtl3D');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  ...
  AData.AddPropertyRedecl('OnMouseMove');
  AData.AddPropertyRedecl('OnMouseUp');
  AData.AddProperty('OnPageChanged', TNotebook_OnPageChanged_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnStartDrag');
end;
...
begin
  ...
  AData.AddProperty('SectionWidth', THeader_SectionWidth_si, Integer_sw, True, True, 1, False);
  AData.AddPropertyRedecl('Align');
  AData.AddProperty('AllowResize', THeader_AllowResize_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Anchors');
  AData.AddProperty('BorderStyle', THeader_BorderStyle_si, TBorderStyle_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('Sections', THeader_Sections_si, TStrings_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddProperty('OnSizing', THeader_OnSizing_si, TSectionEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSized', THeader_OnSized_si, TSectionEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Columns', TCustomRadioGroup_Columns_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('ItemIndex', TCustomRadioGroup_ItemIndex_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('Items', TCustomRadioGroup_Items_si, TStrings_sw, True, True, 0, True);
  AData.AddProperty('Buttons', TCustomRadioGroup_Buttons_si, TRadioButton_sw, True, False, 1, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('ItemIndex');
...
class function TResizeStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TResizeStyle);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Canvas');
  AData.AddPropertyRedecl('Align');
  AData.AddProperty('AutoSnap', TSplitter_AutoSnap_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Beveled', TSplitter_Beveled_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Cursor');
  AData.AddPropertyRedecl('Constraints');
  AData.AddProperty('MinSize', TSplitter_MinSize_si, NaturalNumber_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentColor');
  AData.AddProperty('ResizeStyle', TSplitter_ResizeStyle_si, TResizeStyle_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('Width');
  AData.AddProperty('OnCanResize', TSplitter_OnCanResize_si, TCanResizeEvent_sw, True, True, 0, False);
  AData.AddProperty('OnMoved', TSplitter_OnMoved_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnPaint', TSplitter_OnPaint_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
class function TBandPaintOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBandPaintOption);
end;
...
class function TBandDrawingStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBandDrawingStyle);
end;
...
class function TCornerEdge_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCornerEdge);
end;
...
begin
  ...
  AData.AddProperty('Picture', TCustomControlBar_Picture_si, TPicture_sw, True, True, 0, False);
  AData.AddProperty('AutoDock', TCustomControlBar_AutoDock_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('AutoDrag', TCustomControlBar_AutoDrag_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('CornerEdge', TCustomControlBar_CornerEdge_si, TCornerEdge_sw, True, True, 0, True);
  AData.AddProperty('DrawingStyle', TCustomControlBar_DrawingStyle_si, TBandDrawingStyle_sw, True, True, 0, True);
  AData.AddProperty('GradientDirection', TCustomControlBar_GradientDirection_si, TGradientDirection_sw, True, True, 0, True);
  AData.AddProperty('GradientStartColor', TCustomControlBar_GradientStartColor_si, TColor_sw, True, True, 0, True);
  AData.AddProperty('GradientEndColor', TCustomControlBar_GradientEndColor_si, TColor_sw, True, True, 0, True);
  AData.AddProperty('RowSize', TCustomControlBar_RowSize_si, TRowSize_sw, True, True, 0, True);
  AData.AddProperty('RowSnap', TCustomControlBar_RowSnap_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('OnBandDrag', TCustomControlBar_OnBandDrag_si, TBandDragEvent_sw, True, True, 0, True);
  AData.AddProperty('OnBandInfo', TCustomControlBar_OnBandInfo_si, TBandInfoEvent_sw, True, True, 0, True);
  AData.AddProperty('OnBandMove', TCustomControlBar_OnBandMove_si, TBandMoveEvent_sw, True, True, 0, True);
  AData.AddProperty('OnBandPaint', TCustomControlBar_OnBandPaint_si, TBandPaintEvent_sw, True, True, 0, True);
  AData.AddProperty('OnBeginBandMove', TCustomControlBar_OnBeginBandMove_si, TBeginBandMoveEvent_sw, True, True, 0, True);
  AData.AddProperty('OnEndBandMove', TCustomControlBar_OnEndBandMove_si, TEndBandMoveEvent_sw, True, True, 0, True);
  AData.AddProperty('OnPaint', TCustomControlBar_OnPaint_si, TNotifyEvent_sw, True, True, 0, True);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoDock');
  AData.AddPropertyRedecl('AutoDrag');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  AData.AddPropertyRedecl('BevelOuter');
  ...
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('CornerEdge');
  AData.AddPropertyRedecl('DockSite');
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  ...
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('GradientDirection');
  AData.AddPropertyRedecl('GradientEndColor');
  AData.AddPropertyRedecl('GradientStartColor');
  AData.AddPropertyRedecl('ParentBackground');
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentCtl3D');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('Picture');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('RowSize');
  AData.AddPropertyRedecl('RowSnap');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnAlignInsertBefore');
  AData.AddPropertyRedecl('OnAlignPosition');
  AData.AddPropertyRedecl('OnBandDrag');
  AData.AddPropertyRedecl('OnBandInfo');
  AData.AddPropertyRedecl('OnBandMove');
  AData.AddPropertyRedecl('OnBandPaint');
  AData.AddPropertyRedecl('OnBeginBandMove');
  AData.AddPropertyRedecl('OnEndBandMove');
  AData.AddPropertyRedecl('OnCanResize');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnConstrainedResize');
  AData.AddPropertyRedecl('OnContextPopup');
...
begin
  ...
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Font');
  AData.AddProperty('Height', TBoundLabel_Height_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Left', TBoundLabel_Left_si, Integer_sw, True, False, 0, False);
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('ShowAccelChar');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('Top', TBoundLabel_Top_si, Integer_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Transparent');
  AData.AddPropertyRedecl('Layout');
  AData.AddPropertyRedecl('WordWrap');
  AData.AddProperty('Width', TBoundLabel_Width_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDragDrop');
...
class function TLabelPosition_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TLabelPosition);
end;
...
begin
  ...
  AData.AddProperty('EditLabel', TCustomLabeledEdit_EditLabel_si, TBoundLabel_sw, True, False, 0, False);
  AData.AddProperty('LabelPosition', TCustomLabeledEdit_LabelPosition_si, TLabelPosition_sw, True, True, 0, False);
  AData.AddProperty('LabelSpacing', TCustomLabeledEdit_LabelSpacing_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoSelect');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  AData.AddPropertyRedecl('BevelKind');
  ...
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('BorderStyle');
  AData.AddPropertyRedecl('CharCase');
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('EditLabel');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('HideSelection');
  AData.AddPropertyRedecl('ImeMode');
  AData.AddPropertyRedecl('ImeName');
  AData.AddPropertyRedecl('LabelPosition');
  AData.AddPropertyRedecl('LabelSpacing');
  AData.AddPropertyRedecl('MaxLength');
  AData.AddPropertyRedecl('OEMConvert');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentCtl3D');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PasswordChar');
  AData.AddPropertyRedecl('PopupMenu');
...
class function TColorBoxStyles_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TColorBoxStyles);
end;
...
begin
  ...
  AData.AddProperty('Style', TCustomColorBox_Style_si, TColorBoxStyle_sw, True, True, 0, False);
  AData.AddProperty('Colors', TCustomColorBox_Colors_si, TColor_sw, True, False, 1, False);
  AData.AddProperty('ColorNames', TCustomColorBox_ColorNames_si, string_sw, True, False, 1, False);
  AData.AddProperty('Selected', TCustomColorBox_Selected_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('DefaultColorColor', TCustomColorBox_DefaultColorColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('NoneColorColor', TCustomColorBox_NoneColorColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('OnGetColors', TCustomColorBox_OnGetColors_si, TGetColorsEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('AutoDropDown');
  AData.AddPropertyRedecl('DefaultColorColor');
  AData.AddPropertyRedecl('NoneColorColor');
  AData.AddPropertyRedecl('Selected');
  ...
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnChange');
  AData.AddPropertyRedecl('OnCloseUp');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDragDrop');
  ...
  AData.AddPropertyRedecl('OnEnter');
  AData.AddPropertyRedecl('OnExit');
  AData.AddPropertyRedecl('OnGetColors');
  AData.AddPropertyRedecl('OnKeyDown');
  AData.AddPropertyRedecl('OnKeyPress');
  AData.AddPropertyRedecl('OnKeyUp');
  AData.AddPropertyRedecl('OnMouseEnter');
...
begin
  ...
  AData.AddProperty('Style', TCustomColorListBox_Style_si, TColorBoxStyle_sw, True, True, 0, False);
  AData.AddProperty('Colors', TCustomColorListBox_Colors_si, TColor_sw, True, False, 1, False);
  AData.AddProperty('ColorNames', TCustomColorListBox_ColorNames_si, string_sw, True, False, 1, False);
  AData.AddProperty('Selected', TCustomColorListBox_Selected_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('DefaultColorColor', TCustomColorListBox_DefaultColorColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('NoneColorColor', TCustomColorListBox_NoneColorColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('OnGetColors', TCustomColorListBox_OnGetColors_si, TLBGetColorsEvent_sw, True, True, 0, False);
end;
...
class function TBalloonFlags_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBalloonFlags);
end;
...
begin
  ...
  AData.AddProperty('Animate', TCustomTrayIcon_Animate_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AnimateInterval', TCustomTrayIcon_AnimateInterval_si, Cardinal_sw, True, True, 0, False);
  AData.AddProperty('Hint', TCustomTrayIcon_Hint_si, string_sw, True, True, 0, False);
  AData.AddProperty('BalloonHint', TCustomTrayIcon_BalloonHint_si, string_sw, True, True, 0, False);
  AData.AddProperty('BalloonTitle', TCustomTrayIcon_BalloonTitle_si, string_sw, True, True, 0, False);
  AData.AddProperty('BalloonTimeout', TCustomTrayIcon_BalloonTimeout_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('BalloonFlags', TCustomTrayIcon_BalloonFlags_si, TBalloonFlags_sw, True, True, 0, False);
  AData.AddProperty('Icon', TCustomTrayIcon_Icon_si, TIcon_sw, True, True, 0, False);
  AData.AddProperty('Icons', TCustomTrayIcon_Icons_si, TImageList_sw, True, True, 0, False);
  AData.AddProperty('IconIndex', TCustomTrayIcon_IconIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('PopupMenu', TCustomTrayIcon_PopupMenu_si, TPopupMenu_sw, True, True, 0, False);
  AData.AddProperty('Visible', TCustomTrayIcon_Visible_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnClick', TCustomTrayIcon_OnClick_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnDblClick', TCustomTrayIcon_OnDblClick_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnAnimate', TCustomTrayIcon_OnAnimate_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Animate');
  AData.AddPropertyRedecl('AnimateInterval');
  AData.AddPropertyRedecl('Hint');
  AData.AddPropertyRedecl('BalloonHint');
  AData.AddPropertyRedecl('BalloonTitle');
  AData.AddPropertyRedecl('BalloonTimeout');
  AData.AddPropertyRedecl('BalloonFlags');
  AData.AddPropertyRedecl('Icon');
  AData.AddPropertyRedecl('Icons');
  AData.AddPropertyRedecl('IconIndex');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnDblClick');
  ...
  AData.AddPropertyRedecl('OnMouseUp');
  AData.AddPropertyRedecl('OnMouseDown');
  AData.AddPropertyRedecl('OnAnimate');
end;
...
function ExtCtrls_TShapeType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TShapeType = (stSquare, stRoundRect, stRoundSquare, ...
...
function ExtCtrls_TBevelShape_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBevelShape = (bsFrame, bsTopLine, bsBottomLine, bsL...
...
function ExtCtrls_TFlowStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFlowStyle = (fsRightLeftTopBottom, fsLeftRightBotto...
...
function ExtCtrls_TSizeStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TSizeStyle = (ssPercent, ssAuto);
...
function ExtCtrls_TExpandStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TExpandStyle = (emAddColumns, emFixedSize);
...
function ExtCtrls_TResizeStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TResizeStyle = (rsLine, rsUpdate, rsPattern);
...
function ExtCtrls_TBandPaintOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBandPaintOption = (bpoFrame, bpoGradient, bpoRoundR...
...
function ExtCtrls_TBandDrawingStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBandDrawingStyle = (dsGradient);
...
function ExtCtrls_TCornerEdge_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCornerEdge = (ceSmall, ceMedium, ceLarge);
...
function ExtCtrls_TLabelPosition_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TLabelPosition = (lpBelow, lpLeft, lpRight);
...
function ExtCtrls_TColorBoxStyles_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TColorBoxStyles = (cbExtendedColors, cbSystemColors,...
...
function ExtCtrls_TBalloonFlags_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBalloonFlags = (bfInfo, bfWarning, bfError);
