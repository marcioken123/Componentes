...
uses
  ...
  StdCtrls, Graphics, ExtCtrls, Buttons, Dialogs, ExtDlgs, Messages_LMDSW,
  Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW, Controls_LMDSW, StdCtrls_LMDSW,
...
begin
  ...
  AData.AddProperty('ImageCtrl', TOpenPictureDialog_ImageCtrl_si, TImage_sw, True, False, 0, True);
  AData.AddProperty('PictureLabel', TOpenPictureDialog_PictureLabel_si, TLabel_sw, True, False, 0, True);
...
begin
  ...
  AData.AddProperty('Encodings', TOpenTextFileDialog_Encodings_si, TStrings_sw, True, True, 0, False);
  AData.AddProperty('EncodingIndex', TOpenTextFileDialog_EncodingIndex_si, Integer_sw, True, True, 0, False);
end;
