...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Forms' unit.
  #
  # WARNING:
...
uses
  ...
  LMDSctSysWrappers, Types, Messages, Windows, SysUtils, Classes, Graphics,
  Menus, Controls, Imm, ActnList, MultiMon, HelpIntfs, Forms, Messages_LMDSW,
  Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW, Graphics_LMDSW, Menus_LMDSW,
  Controls_LMDSW, Imm_LMDSW, ActnList_LMDSW, MultiMon_LMDSW, HelpIntfs_LMDSW;
...
type
  ...
  public
    function  GetHandler: TMethod; override;
    function Handler(Command: Word; Data: Longint;
...
class function TScrollBarKind_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TScrollBarKind);
end;
...
class function TScrollBarStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TScrollBarStyle);
end;
...
begin
  ...
  AData.AddProperty('Kind', TControlScrollBar_Kind_si, TScrollBarKind_sw, True, False, 0, False);
  AData.AddFunction('IsScrollBarVisible', TControlScrollBar_IsScrollBarVisible_si, Boolean_sw, 0, False);
  AData.AddProperty('ScrollPos', TControlScrollBar_ScrollPos_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('ButtonSize', TControlScrollBar_ButtonSize_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Color', TControlScrollBar_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('Increment', TControlScrollBar_Increment_si, TScrollBarInc_sw, True, True, 0, False);
  AData.AddProperty('Margin', TControlScrollBar_Margin_si, Word_sw, True, True, 0, False);
  AData.AddProperty('ParentColor', TControlScrollBar_ParentColor_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Position', TControlScrollBar_Position_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Range', TControlScrollBar_Range_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Smooth', TControlScrollBar_Smooth_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Size', TControlScrollBar_Size_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Style', TControlScrollBar_Style_si, TScrollBarStyle_sw, True, True, 0, False);
  AData.AddProperty('ThumbSize', TControlScrollBar_ThumbSize_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Tracking', TControlScrollBar_Tracking_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Visible', TControlScrollBar_Visible_si, Boolean_sw, True, True, 0, False);
end;
...
class function TWindowState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
...
begin
  ...
  AData.AddProperty('AutoScroll', TScrollingWinControl_AutoScroll_si, Boolean_sw, True, True, 0, True);
  ...
  AData.AddProperty('HorzScrollBar', TScrollingWinControl_HorzScrollBar_si, TControlScrollBar_sw, True, True, 0, False);
  AData.AddProperty('VertScrollBar', TScrollingWinControl_VertScrollBar_si, TControlScrollBar_sw, True, True, 0, False);
end;
...
class function TFormBorderStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
...
begin
  ...
  AData.AddPropertyRedecl('AutoScroll');
  ...
  AData.AddProperty('BorderStyle', TScrollBox_BorderStyle_si, TBorderStyle_sw, True, True, 0, False);
  ...
  AData.AddPropertyRedecl('Padding');
...
begin
  ...
  AData.AddFunction('Copy', TPopupWnd_Copy_si, TPopupWnd_sw, 0);
  AData.AddField('ID', TPopupWnd_ID_si, Integer_sw);
  AData.AddField('ControlWnd', TPopupWnd_ControlWnd_si, HWND_sw);

  { Class members }

  AData.AddConstructor('Create', TPopupWnd_Create_si, 0);
end;
...
class function TFormStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
...
class function TBorderIcon_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBorderIcon);
end;
...
class function TPosition_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPosition);
end;
...
class function TDefaultMonitor_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDefaultMonitor);
end;
...
class function TPrintScale_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPrintScale);
end;
...
class function TShowAction_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TShowAction);
end;
...
class function TTileMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTileMode);
end;
...
class function TCloseAction_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCloseAction);
end;
...
function THelpEvent_sh.Handler(Command: Word; Data: Longint;
  var CallHelp: Boolean): Boolean;
var
  args: array[0..2] of OleVariant;
  v_1: OleVariant;
begin
  // function (Command: Word; Data: Longint; var CallHelp: Boo...
...
class function TPopupMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPopupMode);
end;
...
begin
  ...
  Result := TCustomForm_sw.ToVar(TCustomForm_sc(AObj).CreateNew(TComponent_sw.
...
begin
  ...
  AData.AddProperty('ActiveMDIChild', TCustomForm_ActiveMDIChild_si, TForm_sw, True, False, 0, True);
  AData.AddProperty('AlphaBlend', TCustomForm_AlphaBlend_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('AlphaBlendValue', TCustomForm_AlphaBlendValue_si, Byte_sw, True, True, 0, True);
  AData.AddProperty('BorderIcons', TCustomForm_BorderIcons_si, TBorderIcons_sw, True, True, 0, True);
  AData.AddProperty('ClientHandle', TCustomForm_ClientHandle_si, HWND_sw, True, False, 0, True);
  AData.AddProperty('TransparentColor', TCustomForm_TransparentColor_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('TransparentColorValue', TCustomForm_TransparentColorValue_si, TColor_sw, True, True, 0, True);
  AData.AddProperty('DefaultMonitor', TCustomForm_DefaultMonitor_si, TDefaultMonitor_sw, True, True, 0, True);
  AData.AddProperty('FormStyle', TCustomForm_FormStyle_si, TFormStyle_sw, True, True, 0, True);
  AData.AddProperty('Icon', TCustomForm_Icon_si, TIcon_sw, True, True, 0, True);
  AData.AddProperty('MDIChildCount', TCustomForm_MDIChildCount_si, Integer_sw, True, False, 0, True);
  AData.AddProperty('MDIChildren', TCustomForm_MDIChildren_si, TForm_sw, True, False, 1, True);
  AData.AddProperty('OldCreateOrder', TCustomForm_OldCreateOrder_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ObjectMenuItem', TCustomForm_ObjectMenuItem_si, TMenuItem_sw, True, True, 0, True);
  AData.AddProperty('PixelsPerInch', TCustomForm_PixelsPerInch_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('PopupChildren', TCustomForm_PopupChildren_si, TList_sw, True, False, 0, True);
  AData.AddProperty('Position', TCustomForm_Position_si, TPosition_sw, True, True, 0, True);
  AData.AddProperty('PrintScale', TCustomForm_PrintScale_si, TPrintScale_sw, True, True, 0, True);
  AData.AddProperty('Scaled', TCustomForm_Scaled_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('TileMode', TCustomForm_TileMode_si, TTileMode_sw, True, True, 0, True);
  AData.AddProperty('WindowMenu', TCustomForm_WindowMenu_si, TMenuItem_sw, True, True, 0, True);
  AData.AddProperty('OnActivate', TCustomForm_OnActivate_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnClose', TCustomForm_OnClose_si, TCloseEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCloseQuery', TCustomForm_OnCloseQuery_si, TCloseQueryEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCreate', TCustomForm_OnCreate_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDestroy', TCustomForm_OnDestroy_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDeactivate', TCustomForm_OnDeactivate_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnHelp', TCustomForm_OnHelp_si, THelpEvent_sw, True, True, 0, True);
  AData.AddProperty('OnHide', TCustomForm_OnHide_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnPaint', TCustomForm_OnPaint_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnShow', TCustomForm_OnShow_si, TNotifyEvent_sw, True, True, 0, True);
  ...
  AData.AddProcedure('MakeFullyVisible', TCustomForm_MakeFullyVisible_si, 1, False);
  ...
  AData.AddProperty('Active', TCustomForm_Active_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('ActiveControl', TCustomForm_ActiveControl_si, TWinControl_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Action');
  AData.AddProperty('ActiveOleControl', TCustomForm_ActiveOleControl_si, TWinControl_sw, True, True, 0, False);
  AData.AddProperty('BorderStyle', TCustomForm_BorderStyle_si, TFormBorderStyle_sw, True, True, 0, False);
  AData.AddProperty('Canvas', TCustomForm_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Caption');
  AData.AddPropertyRedecl('Color');
  AData.AddProperty('DropTarget', TCustomForm_DropTarget_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Font');
  AData.AddProperty('HelpFile', TCustomForm_HelpFile_si, string_sw, True, True, 0, False);
  AData.AddProperty('KeyPreview', TCustomForm_KeyPreview_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Menu', TCustomForm_Menu_si, TMainMenu_sw, True, True, 0, False);
  AData.AddProperty('ModalResult', TCustomForm_ModalResult_si, TModalResult_sw, True, True, 0, False);
  AData.AddProperty('Monitor', TCustomForm_Monitor_si, TMonitor_sw, True, False, 0, False);
  AData.AddProperty('PopupMode', TCustomForm_PopupMode_si, TPopupMode_sw, True, True, 0, False);
  AData.AddProperty('PopupParent', TCustomForm_PopupParent_si, TCustomForm_sw, True, True, 0, False);
  AData.AddProperty('ScreenSnap', TCustomForm_ScreenSnap_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SnapBuffer', TCustomForm_SnapBuffer_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('WindowState', TCustomForm_WindowState_si, TWindowState_sw, True, True, 0, False);
  AData.AddProperty('Left', TCustomForm_Left_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Top', TCustomForm_Top_si, Integer_sw, True, True, 0, False);

  { Class members }

  AData.AddConstructor('CreateNew', TCustomForm_CreateNew_si, 2, False);
end;
...
class function TActiveFormBorderStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TActiveFormBorderStyle);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('ActiveControl');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoScroll');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddProperty('AxBorderStyle', TCustomActiveForm_AxBorderStyle_si, TActiveFormBorderStyle_sw, True, True, 0, False);
  ...
  AData.AddPropertyRedecl('HorzScrollBar');
  AData.AddPropertyRedecl('KeyPreview');
  AData.AddPropertyRedecl('Padding');
  AData.AddPropertyRedecl('OldCreateOrder');
  AData.AddPropertyRedecl('PixelsPerInch');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('PrintScale');
  AData.AddPropertyRedecl('Scaled');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('VertScrollBar');
  AData.AddPropertyRedecl('Width');
  AData.AddPropertyRedecl('OnActivate');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnCreate');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDestroy');
  AData.AddPropertyRedecl('OnDeactivate');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
...
begin
  ...
  AData.AddPropertyRedecl('ActiveMDIChild');
  AData.AddPropertyRedecl('ClientHandle');
  AData.AddPropertyRedecl('DockManager');
  AData.AddPropertyRedecl('MDIChildCount');
  AData.AddPropertyRedecl('MDIChildren');
  AData.AddPropertyRedecl('TileMode');
  AData.AddPropertyRedecl('Action');
  AData.AddPropertyRedecl('ActiveControl');
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('AlphaBlend');
  AData.AddPropertyRedecl('AlphaBlendValue');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoScroll');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('BorderIcons');
  AData.AddPropertyRedecl('BorderStyle');
  AData.AddPropertyRedecl('BorderWidth');
  AData.AddPropertyRedecl('Caption');
  AData.AddPropertyRedecl('ClientHeight');
  AData.AddPropertyRedecl('ClientWidth');
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('TransparentColor');
  AData.AddPropertyRedecl('TransparentColorValue');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddPropertyRedecl('UseDockManager');
  AData.AddPropertyRedecl('DefaultMonitor');
  AData.AddPropertyRedecl('DockSite');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('FormStyle');
  AData.AddPropertyRedecl('Height');
  AData.AddPropertyRedecl('HelpFile');
  AData.AddPropertyRedecl('HorzScrollBar');
  AData.AddPropertyRedecl('Icon');
  AData.AddPropertyRedecl('KeyPreview');
  AData.AddPropertyRedecl('Padding');
  AData.AddPropertyRedecl('Menu');
  AData.AddPropertyRedecl('OldCreateOrder');
  AData.AddPropertyRedecl('ObjectMenuItem');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('PixelsPerInch');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('PopupMode');
  AData.AddPropertyRedecl('PopupParent');
  AData.AddPropertyRedecl('Position');
  AData.AddPropertyRedecl('PrintScale');
  AData.AddPropertyRedecl('Scaled');
  AData.AddPropertyRedecl('ScreenSnap');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('SnapBuffer');
  AData.AddPropertyRedecl('VertScrollBar');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('Width');
  AData.AddPropertyRedecl('WindowState');
  AData.AddPropertyRedecl('WindowMenu');
  AData.AddPropertyRedecl('OnActivate');
  AData.AddPropertyRedecl('OnAlignInsertBefore');
  AData.AddPropertyRedecl('OnAlignPosition');
  AData.AddPropertyRedecl('OnCanResize');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnClose');
  AData.AddPropertyRedecl('OnCloseQuery');
  AData.AddPropertyRedecl('OnConstrainedResize');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnCreate');
  AData.AddPropertyRedecl('OnDblClick');
  ...
  AData.AddPropertyRedecl('OnEndDock');
  AData.AddPropertyRedecl('OnGetSiteInfo');
  AData.AddPropertyRedecl('OnHide');
  AData.AddPropertyRedecl('OnHelp');
  AData.AddPropertyRedecl('OnKeyDown');
  AData.AddPropertyRedecl('OnKeyPress');
  AData.AddPropertyRedecl('OnKeyUp');
  AData.AddPropertyRedecl('OnMouseActivate');
  ...
  AData.AddPropertyRedecl('OnPaint');
  AData.AddPropertyRedecl('OnResize');
  AData.AddPropertyRedecl('OnShortCut');
  AData.AddPropertyRedecl('OnShow');
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnUnDock');
end;
...
begin
  ...
  AData.AddProperty('MonitorNum', TMonitor_MonitorNum_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Left', TMonitor_Left_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Height', TMonitor_Height_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Top', TMonitor_Top_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Width', TMonitor_Width_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('BoundsRect', TMonitor_BoundsRect_si, TRect_sw, True, False, 0, False);
  AData.AddProperty('WorkareaRect', TMonitor_WorkareaRect_si, TRect_sw, True, False, 0, False);
  AData.AddProperty('Primary', TMonitor_Primary_si, Boolean_sw, True, False, 0, False);
end;
...
begin
  ...
  AData.AddFunction('Copy', TCursorRec_Copy_si, TCursorRec_sw, 0);
  AData.AddField('Index', TCursorRec_Index_si, Integer_sw);
  AData.AddField('Handle', TCursorRec_Handle_si, HCURSOR_sw);

  { Class members }

  AData.AddConstructor('Create', TCursorRec_Create_si, 0);
end;
...
class function TMonitorDefaultTo_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TMonitorDefaultTo);
end;
...
begin
  ...
  Result := TMonitor_sw.ToVar(TScreen(AObj).MonitorFromPoint(TPoint_sw.FromVar(
    AArgs[0]), TMonitorDefaultTo_sw.FromVar(AArgs[1])));
end;
...
begin
  ...
  Result := TMonitor_sw.ToVar(TScreen(AObj).MonitorFromRect(TRect_sw.FromVar(
    AArgs[0]), TMonitorDefaultTo_sw.FromVar(AArgs[1])));
end;
...
begin
  ...
  AData.AddFunction('MonitorFromPoint', TScreen_MonitorFromPoint_si, TMonitor_sw, 2, False);
  AData.AddFunction('MonitorFromRect', TScreen_MonitorFromRect_si, TMonitor_sw, 2, False);
  AData.AddFunction('MonitorFromWindow', TScreen_MonitorFromWindow_si, TMonitor_sw, 2, False);
  AData.AddProcedure('Realign', TScreen_Realign_si, 0, False);
  AData.AddProcedure('ResetFonts', TScreen_ResetFonts_si, 0, False);
  AData.AddProperty('ActiveControl', TScreen_ActiveControl_si, TWinControl_sw, True, False, 0, False);
  AData.AddProperty('ActiveCustomForm', TScreen_ActiveCustomForm_si, TCustomForm_sw, True, False, 0, False);
  AData.AddProperty('ActiveForm', TScreen_ActiveForm_si, TForm_sw, True, False, 0, False);
  AData.AddProperty('CustomFormCount', TScreen_CustomFormCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('CustomForms', TScreen_CustomForms_si, TCustomForm_sw, True, False, 1, False);
  AData.AddProperty('CursorCount', TScreen_CursorCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Cursor', TScreen_Cursor_si, TCursor_sw, True, True, 0, False);
  AData.AddProperty('Cursors', TScreen_Cursors_si, HCURSOR_sw, True, True, 1, False);
  AData.AddProperty('DataModules', TScreen_DataModules_si, TDataModule_sw, True, False, 1, False);
  AData.AddProperty('DataModuleCount', TScreen_DataModuleCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('FocusedForm', TScreen_FocusedForm_si, TCustomForm_sw, True, True, 0, False);
  AData.AddProperty('SaveFocusedList', TScreen_SaveFocusedList_si, TList_sw, True, False, 0, False);
  AData.AddProperty('MonitorCount', TScreen_MonitorCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Monitors', TScreen_Monitors_si, TMonitor_sw, True, False, 1, False);
  AData.AddProperty('DesktopRect', TScreen_DesktopRect_si, TRect_sw, True, False, 0, False);
  AData.AddProperty('DesktopHeight', TScreen_DesktopHeight_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('DesktopLeft', TScreen_DesktopLeft_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('DesktopTop', TScreen_DesktopTop_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('DesktopWidth', TScreen_DesktopWidth_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('WorkAreaRect', TScreen_WorkAreaRect_si, TRect_sw, True, False, 0, False);
  AData.AddProperty('WorkAreaHeight', TScreen_WorkAreaHeight_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('WorkAreaLeft', TScreen_WorkAreaLeft_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('WorkAreaTop', TScreen_WorkAreaTop_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('WorkAreaWidth', TScreen_WorkAreaWidth_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('HintFont', TScreen_HintFont_si, TFont_sw, True, True, 0, False);
  AData.AddProperty('IconFont', TScreen_IconFont_si, TFont_sw, True, True, 0, False);
  AData.AddProperty('MenuFont', TScreen_MenuFont_si, TFont_sw, True, True, 0, False);
  AData.AddProperty('Fonts', TScreen_Fonts_si, TStrings_sw, True, False, 0, False);
  AData.AddProperty('FormCount', TScreen_FormCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Forms', TScreen_Forms_si, TForm_sw, True, False, 1, False);
  AData.AddProperty('Imes', TScreen_Imes_si, TStrings_sw, True, False, 0, False);
  AData.AddProperty('DefaultIme', TScreen_DefaultIme_si, string_sw, True, False, 0, False);
  AData.AddProperty('DefaultKbLayout', TScreen_DefaultKbLayout_si, HKL_sw, True, False, 0, False);
  AData.AddProperty('Height', TScreen_Height_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('PixelsPerInch', TScreen_PixelsPerInch_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('PrimaryMonitor', TScreen_PrimaryMonitor_si, TMonitor_sw, True, False, 0, False);
  AData.AddProperty('Width', TScreen_Width_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('OnActiveControlChange', TScreen_OnActiveControlChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnActiveFormChange', TScreen_OnActiveFormChange_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
class function TTimerMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTimerMode);
end;
...
begin
  ...
  AData.AddFunction('Copy', THintInfo_Copy_si, THintInfo_sw, 0);
  ...
  AData.AddConstructor('Create', THintInfo_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TPopupForm_Copy_si, TPopupForm_sw, 0);
  ...
  AData.AddConstructor('Create', TPopupForm_Create_si, 0);
end;
...
begin
  ...
  v_1 := HintStr;
  v_2 := CanShow;
  v_3 := THintInfo_sw.ToVar(HintInfo);
  args[0] := MakeVarRef(v_1);
  args[1] := MakeVarRef(v_2);
  ...
  HintStr := string(v_1);
  CanShow := Boolean(v_2);
  HintInfo := THintInfo_sw.FromVar(v_3);
end;
...
function TApplication_HelpCommand_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function HelpCommand(Command: Integer; Data: Longint): Bo...

  Result := TApplication(AObj).HelpCommand(Integer(AArgs[0]), Longint(
    AArgs[1]));
end;
...
begin
  ...
  AData.AddProperty('Active', TApplication_Active_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('ActionUpdateDelay', TApplication_ActionUpdateDelay_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ActiveFormHandle', TApplication_ActiveFormHandle_si, HWND_sw, True, False, 0, False);
  AData.AddProperty('AllowTesting', TApplication_AllowTesting_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AutoDragDocking', TApplication_AutoDragDocking_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('CurrentHelpFile', TApplication_CurrentHelpFile_si, string_sw, True, False, 0, False);
  AData.AddProperty('DialogHandle', TApplication_DialogHandle_si, HWnd_sw, True, True, 0, False);
  AData.AddProperty('ExeName', TApplication_ExeName_si, string_sw, True, False, 0, False);
  AData.AddProperty('Handle', TApplication_Handle_si, HWnd_sw, True, True, 0, False);
  AData.AddProperty('HelpFile', TApplication_HelpFile_si, string_sw, True, True, 0, False);
  AData.AddProperty('Hint', TApplication_Hint_si, string_sw, True, True, 0, False);
  AData.AddProperty('HintColor', TApplication_HintColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('HintHidePause', TApplication_HintHidePause_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('HintPause', TApplication_HintPause_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('HintShortCuts', TApplication_HintShortCuts_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('HintShortPause', TApplication_HintShortPause_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Icon', TApplication_Icon_si, TIcon_sw, True, True, 0, False);
  AData.AddProperty('MainForm', TApplication_MainForm_si, TForm_sw, True, False, 0, False);
  AData.AddProperty('MainFormHandle', TApplication_MainFormHandle_si, HWND_sw, True, False, 0, False);
  AData.AddProperty('ModalLevel', TApplication_ModalLevel_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('ModalPopupMode', TApplication_ModalPopupMode_si, TPopupMode_sw, True, True, 0, False);
  AData.AddProperty('BiDiMode', TApplication_BiDiMode_si, TBiDiMode_sw, True, True, 0, False);
  AData.AddProperty('BiDiKeyboard', TApplication_BiDiKeyboard_si, string_sw, True, True, 0, False);
  AData.AddProperty('NonBiDiKeyboard', TApplication_NonBiDiKeyboard_si, string_sw, True, True, 0, False);
  AData.AddProperty('PopupControlWnd', TApplication_PopupControlWnd_si, HWND_sw, True, False, 0, False);
  AData.AddProperty('ShowHint', TApplication_ShowHint_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ShowMainForm', TApplication_ShowMainForm_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Terminated', TApplication_Terminated_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Title', TApplication_Title_si, string_sw, True, True, 0, False);
  AData.AddProperty('UpdateFormatSettings', TApplication_UpdateFormatSettings_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('UpdateMetricSettings', TApplication_UpdateMetricSettings_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnActionExecute', TApplication_OnActionExecute_si, TActionEvent_sw, True, True, 0, False);
  AData.AddProperty('OnActionUpdate', TApplication_OnActionUpdate_si, TActionEvent_sw, True, True, 0, False);
  AData.AddProperty('OnActivate', TApplication_OnActivate_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnDeactivate', TApplication_OnDeactivate_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnException', TApplication_OnException_si, TExceptionEvent_sw, True, True, 0, False);
  AData.AddProperty('OnGetActiveFormHandle', TApplication_OnGetActiveFormHandle_si, TGetHandleEvent_sw, True, True, 0, False);
  AData.AddProperty('OnGetMainFormHandle', TApplication_OnGetMainFormHandle_si, TGetHandleEvent_sw, True, True, 0, False);
  AData.AddProperty('OnIdle', TApplication_OnIdle_si, TIdleEvent_sw, True, True, 0, False);
  AData.AddProperty('OnHelp', TApplication_OnHelp_si, THelpEvent_sw, True, True, 0, False);
  AData.AddProperty('OnHint', TApplication_OnHint_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnMessage', TApplication_OnMessage_si, TMessageEvent_sw, True, True, 0, False);
  AData.AddProperty('OnMinimize', TApplication_OnMinimize_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnModalBegin', TApplication_OnModalBegin_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnModalEnd', TApplication_OnModalEnd_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnRestore', TApplication_OnRestore_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnShowHint', TApplication_OnShowHint_si, TShowHintEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSettingChange', TApplication_OnSettingChange_si, TSettingChangeEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('OnChange', TGlassFrame_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('Enabled', TGlassFrame_Enabled_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Left', TGlassFrame_Left_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Top', TGlassFrame_Top_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Right', TGlassFrame_Right_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Bottom', TGlassFrame_Bottom_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('SheetOfGlass', TGlassFrame_SheetOfGlass_si, Boolean_sw, True, True, 0, False);
...
function Forms_TScrollBarKind_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TScrollBarKind = (sbVertical);
...
function Forms_TScrollBarStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TScrollBarStyle = (ssFlat, ssHotTrack);
...
function Forms_TWindowState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TWindowState = (wsMinimized, wsMaximized);
...
function Forms_TFormBorderStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFormBorderStyle = (bsSingle, bsSizeable, bsDialog, ...
...
function Forms_TFormStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFormStyle = (fsMDIChild, fsMDIForm, fsStayOnTop);
...
function Forms_TBorderIcon_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBorderIcon = (biMinimize, biMaximize, biHelp);
...
function Forms_TPosition_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPosition = (poDefault, poDefaultPosOnly, poDefaultS...
...
function Forms_TDefaultMonitor_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDefaultMonitor = (dmPrimary, dmMainForm, dmActiveFo...
...
function Forms_TPrintScale_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPrintScale = (poProportional, poPrintToFit);
...
function Forms_TShowAction_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TShowAction = (saRestore, saMinimize, saMaximize);
...
function Forms_TCloseAction_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCloseAction = (caHide, caFree, caMinimize);
...
function Forms_TPopupMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPopupMode = (pmAuto, pmExplicit);
...
function Forms_TActiveFormBorderStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TActiveFormBorderStyle = (afbSingle, afbSunken, afbR...
...
function Forms_TMonitorDefaultTo_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMonitorDefaultTo = (mdNull, mdPrimary);
...
begin
  ...
  if IsGet then
    Result := TApplication_sw.ToVar(Forms.Application)
  else
    Forms.Application := TApplication_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TScreen_sw.ToVar(Forms.Screen)
  else
    Forms.Screen := TScreen_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := THintWindowClass_sw.ToVar(Forms.HintWindowClass)
  else
    Forms.HintWindowClass := THintWindowClass_sw.FromVar(AArgs[0]);
end;

function Forms_DeallocateHWnd_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure DeallocateHWnd(Wnd: HWND);

  Forms.DeallocateHWnd(HWND_sw.FromVar(AArgs[0]));
end;
...
function Forms_SetCustomFormGlassFrame_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure SetCustomFormGlassFrame(const CustomForm: TCust...

  Forms.SetCustomFormGlassFrame(TCustomForm_sw.FromVar(AArgs[0]), 
    TGlassFrame_sw.FromVar(AArgs[1]));
end;

function Forms_GetCustomFormGlassFrame_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function GetCustomFormGlassFrame(const CustomForm: TCusto...

  Result := TGlassFrame_sw.ToVar(Forms.GetCustomFormGlassFrame(TCustomForm_sw.
    FromVar(AArgs[0])));
end;

function Forms_SetApplicationMainFormOnTaskBar_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure SetApplicationMainFormOnTaskBar(const Applicati...

  Forms.SetApplicationMainFormOnTaskBar(TApplication_sw.FromVar(AArgs[0]), 
    Boolean(AArgs[1]));
end;

function Forms_GetApplicationMainFormOnTaskBar_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function GetApplicationMainFormOnTaskBar(const Applicatio...

  Result := Forms.GetApplicationMainFormOnTaskBar(TApplication_sw.FromVar(
    AArgs[0]));
end;
...
begin
  ...
  AData.AddProcedure('DeallocateHWnd', Forms_DeallocateHWnd_si, 1, False);
  AData.AddType(TGlassFrame_sw, Forms_TGlassFrame_si);
  AData.AddProcedure('SetCustomFormGlassFrame', Forms_SetCustomFormGlassFrame_si, 2, False);
  AData.AddFunction('GetCustomFormGlassFrame', Forms_GetCustomFormGlassFrame_si, TGlassFrame_sw, 1, False);
  AData.AddProcedure('SetApplicationMainFormOnTaskBar', Forms_SetApplicationMainFormOnTaskBar_si, 2, False);
  AData.AddFunction('GetApplicationMainFormOnTaskBar', Forms_GetApplicationMainFormOnTaskBar_si, Boolean_sw, 1, False);
end;
