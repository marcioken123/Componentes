...
uses
  ...
  LMDSctSysWrappers, Types, Windows, SysUtils, Classes, Graphics,
  Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW;
...
begin
  ...
  AData.AddFunction('Copy', TCursorOrIcon_Copy_si, TCursorOrIcon_sw, 0);
  ...
  AData.AddConstructor('Create', TCursorOrIcon_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TIconRec_Copy_si, TIconRec_sw, 0);
  ...
  AData.AddConstructor('Create', TIconRec_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TResData_Copy_si, TResData_sw, 0);
  AData.AddField('Handle', TResData_Handle_si, THandle_sw);

  { Class members }

  AData.AddConstructor('Create', TResData_Create_si, 0);
end;
...
class function TFontPitch_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFontPitch);
end;
...
class function TFontStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFontStyle);
end;
...
begin
  ...
  AData.AddFunction('Copy', TFontData_Copy_si, TFontData_sw, 0);
  ...
  AData.AddConstructor('Create', TFontData_Create_si, 0);
end;
...
class function TPenStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPenStyle);
end;
...
class function TPenMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPenMode);
end;
...
begin
  ...
  AData.AddFunction('Copy', TPenData_Copy_si, TPenData_sw, 0);
  ...
  AData.AddConstructor('Create', TPenData_Create_si, 0);
end;
...
class function TBrushStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBrushStyle);
end;
...
begin
  ...
  AData.AddFunction('Copy', TBrushData_Copy_si, TBrushData_sw, 0);
  ...
  AData.AddConstructor('Create', TBrushData_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TResource_Copy_si, TResource_sw, 0);
  ...
  AData.AddConstructor('Create', TResource_Create_si, 0);
end;
...
begin
  ...
  AData.AddProperty('OnChange', TGraphicsObject_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Handle', TFont_Handle_si, HFont_sw, True, True, 0, False);
  AData.AddProperty('PixelsPerInch', TFont_PixelsPerInch_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Charset', TFont_Charset_si, TFontCharset_sw, True, True, 0, False);
  AData.AddProperty('Color', TFont_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('Height', TFont_Height_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Name', TFont_Name_si, TFontName_sw, True, True, 0, False);
  AData.AddProperty('Orientation', TFont_Orientation_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Pitch', TFont_Pitch_si, TFontPitch_sw, True, True, 0, False);
  AData.AddProperty('Size', TFont_Size_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Style', TFont_Style_si, TFontStyles_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Handle', TPen_Handle_si, HPen_sw, True, True, 0, False);
  AData.AddProperty('Color', TPen_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('Mode', TPen_Mode_si, TPenMode_sw, True, True, 0, False);
  AData.AddProperty('Style', TPen_Style_si, TPenStyle_sw, True, True, 0, False);
  AData.AddProperty('Width', TPen_Width_si, Integer_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Bitmap', TBrush_Bitmap_si, TBitmap_sw, True, True, 0, False);
  AData.AddProperty('Handle', TBrush_Handle_si, HBrush_sw, True, True, 0, False);
  AData.AddProperty('Color', TBrush_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('Style', TBrush_Style_si, TBrushStyle_sw, True, True, 0, False);
...
class function TFillStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFillStyle);
end;
...
class function TFillMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFillMode);
end;
...
class function TCanvasStates_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCanvasStates);
end;
...
class function TCanvasOrientation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCanvasOrientation);
end;
...
class function TTextFormats_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTextFormats);
end;
...
function TCanvas_Ellipse_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure Ellipse(X1: Integer; Y1: Integer; X2: Integer; ...

  TCanvas(AObj).Ellipse(Integer(AArgs[0]), Integer(AArgs[1]), Integer(AArgs[2]),
    Integer(AArgs[3]));
end;
...
function TCanvas_Rectangle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure Rectangle(X1: Integer; Y1: Integer; X2: Integer...
...
begin
  ...
  AData.AddProcedure('Ellipse', TCanvas_Ellipse_si, 4, False);
  ...
  AData.AddProcedure('Rectangle', TCanvas_Rectangle_si, 4, False);
  ...
  AData.AddProperty('ClipRect', TCanvas_ClipRect_si, TRect_sw, True, False, 0, False);
  AData.AddProperty('Handle', TCanvas_Handle_si, HDC_sw, True, True, 0, False);
  AData.AddProperty('LockCount', TCanvas_LockCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('CanvasOrientation', TCanvas_CanvasOrientation_si, TCanvasOrientation_sw, True, False, 0, False);
  AData.AddProperty('PenPos', TCanvas_PenPos_si, TPoint_sw, True, True, 0, False);
  AData.AddProperty('Pixels', TCanvas_Pixels_si, TColor_sw, True, True, 2, False);
  AData.AddProperty('TextFlags', TCanvas_TextFlags_si, Longint_sw, True, True, 0, False);
  AData.AddProperty('OnChange', TCanvas_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnChanging', TCanvas_OnChanging_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('Brush', TCanvas_Brush_si, TBrush_sw, True, True, 0, False);
  AData.AddProperty('CopyMode', TCanvas_CopyMode_si, TCopyMode_sw, True, True, 0, False);
  AData.AddProperty('Font', TCanvas_Font_si, TFont_sw, True, True, 0, False);
  AData.AddProperty('Pen', TCanvas_Pen_si, TPen_sw, True, True, 0, False);
...
class function TProgressStage_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TProgressStage);
end;
...
begin
  ...
  AData.AddProperty('Empty', TGraphic_Empty_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Height', TGraphic_Height_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Modified', TGraphic_Modified_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Palette', TGraphic_Palette_si, HPALETTE_sw, True, True, 0, False);
  AData.AddProperty('PaletteModified', TGraphic_PaletteModified_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Transparent', TGraphic_Transparent_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Width', TGraphic_Width_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('OnChange', TGraphic_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Bitmap', TPicture_Bitmap_si, TBitmap_sw, True, True, 0, False);
  AData.AddProperty('Graphic', TPicture_Graphic_si, TGraphic_sw, True, True, 0, False);
  AData.AddProperty('Height', TPicture_Height_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Icon', TPicture_Icon_si, TIcon_sw, True, True, 0, False);
  AData.AddProperty('Metafile', TPicture_Metafile_si, TMetafile_sw, True, True, 0, False);
  AData.AddProperty('Width', TPicture_Width_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('OnChange', TPicture_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('RefCount', TSharedImage_RefCount_si, Integer_sw, True, False, 0, True);
end;
...
begin
  ...
  AData.AddProperty('CreatedBy', TMetafile_CreatedBy_si, string_sw, True, False, 0, False);
  AData.AddProperty('Description', TMetafile_Description_si, string_sw, True, False, 0, False);
  AData.AddProperty('Enhanced', TMetafile_Enhanced_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Handle', TMetafile_Handle_si, HENHMETAFILE_sw, True, True, 0, False);
  AData.AddProperty('MMWidth', TMetafile_MMWidth_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('MMHeight', TMetafile_MMHeight_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Inch', TMetafile_Inch_si, Word_sw, True, True, 0, False);
end;
...
class function TBitmapHandleType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBitmapHandleType);
end;
...
class function TPixelFormat_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPixelFormat);
end;
...
class function TTransparentMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTransparentMode);
end;
...
begin
  ...
  AData.AddProperty('Canvas', TBitmap_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddProperty('Handle', TBitmap_Handle_si, HBITMAP_sw, True, True, 0, False);
  AData.AddProperty('HandleType', TBitmap_HandleType_si, TBitmapHandleType_sw, True, True, 0, False);
  AData.AddProperty('IgnorePalette', TBitmap_IgnorePalette_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('MaskHandle', TBitmap_MaskHandle_si, HBITMAP_sw, True, True, 0, False);
  AData.AddProperty('Monochrome', TBitmap_Monochrome_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('PixelFormat', TBitmap_PixelFormat_si, TPixelFormat_sw, True, True, 0, False);
  AData.AddProperty('TransparentColor', TBitmap_TransparentColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('TransparentMode', TBitmap_TransparentMode_si, TTransparentMode_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Handle', TIcon_Handle_si, HICON_sw, True, True, 0, False);
end;
...
function Graphics_TFontPitch_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFontPitch = (fpVariable, fpFixed);
...
function Graphics_TFontStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFontStyle = (fsItalic, fsUnderline, fsStrikeOut);
...
function Graphics_TPenStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPenStyle = (psDash, psDot, psDashDot, psDashDotDot,...
...
function Graphics_TPenMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPenMode = (pmWhite, pmNop, pmNot, pmCopy, pmNotCopy...
...
function Graphics_TBrushStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBrushStyle = (bsClear, bsHorizontal, bsVertical, bs...
...
function Graphics_TCanvasStates_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCanvasStates = (csFontValid, csPenValid, csBrushVal...
...
function Graphics_TCanvasOrientation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCanvasOrientation = (coRightToLeft);
...
function Graphics_TTextFormats_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTextFormats = (tfCalcRect, tfCenter, tfEditControl,...
...
function Graphics_TProgressStage_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TProgressStage = (psRunning, psEnding);
...
function Graphics_TGraphic_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TGraphic = class(TInterfacedPersistent, IStreamPersi...
...
function Graphics_TPicture_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPicture = class(TInterfacedPersistent, IStreamPersi...
...
function Graphics_TPixelFormat_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPixelFormat = (pf1bit, pf4bit, pf8bit, pf15bit, pf1...
