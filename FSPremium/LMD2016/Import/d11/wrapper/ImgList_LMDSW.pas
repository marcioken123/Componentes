...
uses
  ...
  LMDSctSysWrappers, Types, Windows, Classes, Graphics, CommCtrl, ImgList,
...
begin
  ...
  AData.AddProperty('OnChange', TChangeLink_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('Sender', TChangeLink_Sender_si, TCustomImageList_sw, True, True, 0, False);
end;
...
class function TDrawingStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDrawingStyle);
end;
...
class function TImageType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TImageType);
end;
...
class function TResType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TResType);
end;
...
class function TLoadResource_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TLoadResource);
end;
...
begin
  ...
  TCustomImageList(AObj).Draw(TCanvas_sw.FromVar(AArgs[0]), Integer(AArgs[1]), 
...
begin
  ...
  AData.AddProcedure('Draw', TCustomImageList_Draw_si, 5, False);
  AData.AddProcedure('DrawOverlay', TCustomImageList_DrawOverlay_si, 6, False);
  ...
  AData.AddProperty('Count', TCustomImageList_Count_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('AllocBy', TCustomImageList_AllocBy_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('BlendColor', TCustomImageList_BlendColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('BkColor', TCustomImageList_BkColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('DrawingStyle', TCustomImageList_DrawingStyle_si, TDrawingStyle_sw, True, True, 0, False);
  AData.AddProperty('Height', TCustomImageList_Height_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ImageType', TCustomImageList_ImageType_si, TImageType_sw, True, True, 0, False);
  AData.AddProperty('Masked', TCustomImageList_Masked_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ShareImages', TCustomImageList_ShareImages_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Width', TCustomImageList_Width_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('OnChange', TCustomImageList_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
...
function ImgList_TDrawingStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDrawingStyle = (dsSelected, dsNormal, dsTransparent);
...
function ImgList_TLoadResource_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TLoadResource = (lrDefaultSize, lrFromFile, lrMap3DC...
