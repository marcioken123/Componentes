...
begin
  ...
  AData.AddProperty('Caption', TListControlItem_Caption_si, string_sw, True, True, 0, False);
  AData.AddProperty('ImageIndex', TListControlItem_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
end;
...
class function TListItemsSortType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TListItemsSortType);
end;
...
begin
  ...
  AData.AddProperty('Items', TListControlItems_Items_si, TListControlItem_sw, True, False, 1, False);
  AData.AddProperty('CaseSensitive', TListControlItems_CaseSensitive_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SortType', TListControlItems_SortType_si, TListItemsSortType_sw, True, True, 0, False);
  AData.AddProperty('OnCompare', TListControlItems_OnCompare_si, TListCompareEvent_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Images', TCustomListAction_Images_si, TCustomImageList_sw, True, True, 0, True);
  AData.AddProperty('Loading', TCustomListAction_Loading_si, Boolean_sw, True, False, 0, True);
  AData.AddProperty('OnGetItemCount', TCustomListAction_OnGetItemCount_si, TGetItemCountEvent_sw, True, True, 0, True);
  AData.AddProperty('OnItemSelected', TCustomListAction_OnItemSelected_si, TItemSelectedEvent_sw, True, True, 0, True);
  AData.AddProperty('Active', TCustomListAction_Active_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Count', TCustomListAction_Count_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('ItemIndex', TCustomListAction_ItemIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Strings', TCustomListAction_Strings_si, string_sw, True, True, 1, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('OnGetItemCount');
  AData.AddPropertyRedecl('OnItemSelected');
...
begin
  ...
  AData.AddPropertyRedecl('Images');
  AData.AddPropertyRedecl('ItemIndex');
  AData.AddProperty('Items', TCustomStaticListAction_Items_si, TStaticListItems_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShortCut');
  AData.AddPropertyRedecl('SecondaryShortCuts');
  AData.AddPropertyRedecl('Visible');
  AData.AddProperty('OnGetItem', TCustomStaticListAction_OnGetItem_si, TGetItemEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnItemSelected');
  AData.AddPropertyRedecl('OnHint');
...
begin
  ...
  AData.AddPropertyRedecl('SecondaryShortCuts');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnGetItem');
  AData.AddPropertyRedecl('OnItemSelected');
  AData.AddPropertyRedecl('OnHint');
  AData.AddPropertyRedecl('OnUpdate');
end;
...
function ListActns_TListItemsSortType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TListItemsSortType = (stData, stText, stBoth);
