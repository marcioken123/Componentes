...
uses
  ...
  LMDSctSysWrappers, Types, Windows, SysUtils, Classes, StdCtrls, Controls,
  Messages, Forms, Graphics, Menus, MaskUtils, Mask, Windows_LMDSW,
  SysUtils_LMDSW, Classes_LMDSW, StdCtrls_LMDSW, Controls_LMDSW,
  Messages_LMDSW, Forms_LMDSW, Graphics_LMDSW, Menus_LMDSW, MaskUtils_LMDSW;
...
begin
  ...
  AData.AddProperty('EditMask', TCustomMaskEdit_EditMask_si, TEditMask_sw, True, True, 0, True);
  AData.AddProperty('MaxLength', TCustomMaskEdit_MaxLength_si, Integer_sw, True, True, 0, True);
  ...
  AData.AddProperty('IsMasked', TCustomMaskEdit_IsMasked_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('EditText', TCustomMaskEdit_EditText_si, string_sw, True, True, 0, False);
  AData.AddProperty('Text', TCustomMaskEdit_Text_si, TMaskedText_sw, True, True, 0, False);
end;
