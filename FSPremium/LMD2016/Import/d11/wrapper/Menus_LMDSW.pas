...
uses
  ...
  LMDSctSysWrappers, Types, Windows, SysUtils, Classes, Contnrs, Messages,
  Graphics, ImgList, ActnList, Menus, Windows_LMDSW, SysUtils_LMDSW,
  Classes_LMDSW, Contnrs_LMDSW, Messages_LMDSW, Graphics_LMDSW, ImgList_LMDSW,
  ActnList_LMDSW;
...
class function TMenuBreak_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TMenuBreak);
end;
...
class function TMenuItemAutoFlag_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TMenuItemAutoFlag);
end;
...
begin
  ...
  AData.AddProperty('Current', TMenuItemEnumerator_Current_si, TMenuItem_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('ActionLink', TMenuItem_ActionLink_si, TMenuActionLink_sw, True, True, 0, True);
  ...
  AData.AddProperty('Command', TMenuItem_Command_si, Word_sw, True, False, 0, False);
  AData.AddProperty('Handle', TMenuItem_Handle_si, HMENU_sw, True, False, 0, False);
  AData.AddProperty('Count', TMenuItem_Count_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Items', TMenuItem_Items_si, TMenuItem_sw, True, False, 1, False);
  AData.AddProperty('MenuIndex', TMenuItem_MenuIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Parent', TMenuItem_Parent_si, TMenuItem_sw, True, False, 0, False);
  AData.AddProperty('Action', TMenuItem_Action_si, TBasicAction_sw, True, True, 0, False);
  AData.AddProperty('AutoCheck', TMenuItem_AutoCheck_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AutoHotkeys', TMenuItem_AutoHotkeys_si, TMenuItemAutoFlag_sw, True, True, 0, False);
  AData.AddProperty('AutoLineReduction', TMenuItem_AutoLineReduction_si, TMenuItemAutoFlag_sw, True, True, 0, False);
  AData.AddProperty('Bitmap', TMenuItem_Bitmap_si, TBitmap_sw, True, True, 0, False);
  AData.AddProperty('Break', TMenuItem_Break_si, TMenuBreak_sw, True, True, 0, False);
  AData.AddProperty('Caption', TMenuItem_Caption_si, string_sw, True, True, 0, False);
  AData.AddProperty('Checked', TMenuItem_Checked_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SubMenuImages', TMenuItem_SubMenuImages_si, TCustomImageList_sw, True, True, 0, False);
  AData.AddProperty('Default', TMenuItem_Default_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Enabled', TMenuItem_Enabled_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('GroupIndex', TMenuItem_GroupIndex_si, Byte_sw, True, True, 0, False);
  AData.AddProperty('HelpContext', TMenuItem_HelpContext_si, THelpContext_sw, True, True, 0, False);
  AData.AddProperty('Hint', TMenuItem_Hint_si, string_sw, True, True, 0, False);
  AData.AddProperty('ImageIndex', TMenuItem_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('RadioItem', TMenuItem_RadioItem_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ShortCut', TMenuItem_ShortCut_si, TShortCut_sw, True, True, 0, False);
  AData.AddProperty('Visible', TMenuItem_Visible_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnClick', TMenuItem_OnClick_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnDrawItem', TMenuItem_OnDrawItem_si, TMenuDrawItemEvent_sw, True, True, 0, False);
  AData.AddProperty('OnMeasureItem', TMenuItem_OnMeasureItem_si, TMenuMeasureItemEvent_sw, True, True, 0, False);
end;
...
class function TFindItemKind_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TFindItemKind);
end;
...
begin
  ...
  AData.AddProperty('OnChange', TMenu_OnChange_si, TMenuChangeEvent_sw, True, True, 0, True);
  ...
  AData.AddProperty('Images', TMenu_Images_si, TCustomImageList_sw, True, True, 0, False);
  ...
  AData.AddProperty('AutoHotkeys', TMenu_AutoHotkeys_si, TMenuAutoFlag_sw, True, True, 0, False);
  AData.AddProperty('AutoLineReduction', TMenu_AutoLineReduction_si, TMenuAutoFlag_sw, True, True, 0, False);
  AData.AddProperty('BiDiMode', TMenu_BiDiMode_si, TBiDiMode_sw, True, True, 0, False);
  AData.AddProperty('Handle', TMenu_Handle_si, HMENU_sw, True, False, 0, False);
  AData.AddProperty('OwnerDraw', TMenu_OwnerDraw_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ParentBiDiMode', TMenu_ParentBiDiMode_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('WindowHandle', TMenu_WindowHandle_si, HWND_sw, True, True, 0, False);
  AData.AddProperty('Items', TMenu_Items_si, TMenuItem_sw, True, False, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('AutoLineReduction');
  AData.AddProperty('AutoMerge', TMainMenu_AutoMerge_si, Boolean_sw, True, True, 0, False);
...
class function TPopupAlignment_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPopupAlignment);
end;
...
class function TTrackButton_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTrackButton);
end;
...
class function TMenuAnimations_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TMenuAnimations);
end;
...
begin
  ...
  AData.AddProperty('PopupComponent', TPopupMenu_PopupComponent_si, TComponent_sw, True, True, 0, False);
  AData.AddProperty('PopupPoint', TPopupMenu_PopupPoint_si, TPoint_sw, True, False, 0, False);
  AData.AddProperty('Alignment', TPopupMenu_Alignment_si, TPopupAlignment_sw, True, True, 0, False);
  AData.AddPropertyRedecl('AutoHotkeys');
  AData.AddPropertyRedecl('AutoLineReduction');
  AData.AddProperty('AutoPopup', TPopupMenu_AutoPopup_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddProperty('HelpContext', TPopupMenu_HelpContext_si, THelpContext_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Images');
  AData.AddProperty('MenuAnimation', TPopupMenu_MenuAnimation_si, TMenuAnimation_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OwnerDraw');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddProperty('TrackButton', TPopupMenu_TrackButton_si, TTrackButton_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnChange');
  AData.AddProperty('OnPopup', TPopupMenu_OnPopup_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Window', TPopupList_Window_si, HWND_sw, True, False, 0, False);
...
function Menus_TMenuBreak_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMenuBreak = (mbBreak, mbBarBreak);
...
function Menus_TMenuItemAutoFlag_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMenuItemAutoFlag = (maManual, maParent);
...
function Menus_TFindItemKind_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFindItemKind = (fkHandle, fkShortCut);
...
function Menus_TPopupAlignment_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPopupAlignment = (paRight, paCenter);
...
function Menus_TTrackButton_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTrackButton = (tbLeftButton);
...
function Menus_TMenuAnimations_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMenuAnimations = (maRightToLeft, maTopToBottom, maB...
