...
uses
  ...
  LMDSctSysWrappers, Types, Windows, SysUtils, Classes, Graphics, Forms,
  Printers, Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW, Graphics_LMDSW,
  Forms_LMDSW;
...
class function TPrinterState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPrinterState);
end;
...
class function TPrinterOrientation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPrinterOrientation);
end;
...
class function TPrinterCapability_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPrinterCapability);
end;
...
begin
  ...
  AData.AddProperty('Aborted', TPrinter_Aborted_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Canvas', TPrinter_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddProperty('Capabilities', TPrinter_Capabilities_si, TPrinterCapabilities_sw, True, False, 0, False);
  AData.AddProperty('Copies', TPrinter_Copies_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Fonts', TPrinter_Fonts_si, TStrings_sw, True, False, 0, False);
  AData.AddProperty('Handle', TPrinter_Handle_si, HDC_sw, True, False, 0, False);
  AData.AddProperty('Orientation', TPrinter_Orientation_si, TPrinterOrientation_sw, True, True, 0, False);
  AData.AddProperty('PageHeight', TPrinter_PageHeight_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('PageWidth', TPrinter_PageWidth_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('PageNumber', TPrinter_PageNumber_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('PrinterIndex', TPrinter_PrinterIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Printing', TPrinter_Printing_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Printers', TPrinter_Printers_si, TStrings_sw, True, False, 0, False);
  AData.AddProperty('Title', TPrinter_Title_si, string_sw, True, True, 0, False);
...
function Printers_TPrinterState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPrinterState = (psHandleIC, psHandleDC);
...
function Printers_TPrinterOrientation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPrinterOrientation = (poLandscape);
...
function Printers_TPrinterCapability_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPrinterCapability = (pcOrientation, pcCollation);
