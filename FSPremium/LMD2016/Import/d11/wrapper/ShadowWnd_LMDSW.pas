...
uses
  ...
  Graphics, ShadowWnd, Windows_LMDSW, Messages_LMDSW, Classes_LMDSW,
  Controls_LMDSW, Forms_LMDSW, Graphics_LMDSW;
...
class function TControlSide_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TControlSide);
end;
...
begin
  ...
  AData.AddProperty('Control', TShadowWindow_Control_si, TControl_sw, True, True, 0, False);
  AData.AddProperty('Side', TShadowWindow_Side_si, TControlSide_sw, True, True, 0, False);
