...
uses
  ...
  Forms, Menus, Graphics, CommCtrl, StdCtrls, Messages_LMDSW, Windows_LMDSW,
  SysUtils_LMDSW, Classes_LMDSW, Controls_LMDSW, Forms_LMDSW, Menus_LMDSW,
  Graphics_LMDSW, CommCtrl_LMDSW;
...
class function TTextLayout_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTextLayout);
end;
...
class function TEllipsisPosition_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TEllipsisPosition);
end;
...
begin
  ...
  AData.AddProperty('Alignment', TCustomLabel_Alignment_si, TAlignment_sw, True, True, 0, True);
  AData.AddProperty('AutoSize', TCustomLabel_AutoSize_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('EllipsisPosition', TCustomLabel_EllipsisPosition_si, TEllipsisPosition_sw, True, True, 0, True);
  AData.AddProperty('FocusControl', TCustomLabel_FocusControl_si, TWinControl_sw, True, True, 0, True);
  AData.AddProperty('ShowAccelChar', TCustomLabel_ShowAccelChar_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Transparent', TCustomLabel_Transparent_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Layout', TCustomLabel_Layout_si, TTextLayout_sw, True, True, 0, True);
  AData.AddProperty('WordWrap', TCustomLabel_WordWrap_si, Boolean_sw, True, True, 0, True);
  AData.AddPropertyRedecl('Caption');
...
begin
  ...
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('EllipsisPosition');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('FocusControl');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentFont');
...
class function TEditCharCase_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TEditCharCase);
end;
...
begin
  ...
  AData.AddProperty('AutoSelect', TCustomEdit_AutoSelect_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('AutoSize', TCustomEdit_AutoSize_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('BorderStyle', TCustomEdit_BorderStyle_si, TBorderStyle_sw, True, True, 0, True);
  AData.AddProperty('CharCase', TCustomEdit_CharCase_si, TEditCharCase_sw, True, True, 0, True);
  AData.AddProperty('HideSelection', TCustomEdit_HideSelection_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('MaxLength', TCustomEdit_MaxLength_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('OEMConvert', TCustomEdit_OEMConvert_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('PasswordChar', TCustomEdit_PasswordChar_si, Char_sw, True, True, 0, True);
  AData.AddProperty('OnChange', TCustomEdit_OnChange_si, TNotifyEvent_sw, True, True, 0, True);
  ...
  AData.AddProperty('CanUndo', TCustomEdit_CanUndo_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Modified', TCustomEdit_Modified_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ReadOnly', TCustomEdit_ReadOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SelLength', TCustomEdit_SelLength_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('SelStart', TCustomEdit_SelStart_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('SelText', TCustomEdit_SelText_si, string_sw, True, True, 0, False);
...
class function TScrollStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TScrollStyle);
end;
...
begin
  ...
  AData.AddProperty('Alignment', TCustomMemo_Alignment_si, TAlignment_sw, True, True, 0, True);
  AData.AddProperty('ScrollBars', TCustomMemo_ScrollBars_si, TScrollStyle_sw, True, True, 0, True);
  AData.AddProperty('WantReturns', TCustomMemo_WantReturns_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('WantTabs', TCustomMemo_WantTabs_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('WordWrap', TCustomMemo_WordWrap_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('CaretPos', TCustomMemo_CaretPos_si, TPoint_sw, True, True, 0, False);
  AData.AddProperty('Lines', TCustomMemo_Lines_si, TStrings_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('ComboBox', TCustomComboBoxStrings_ComboBox_si, TCustomCombo_sw, True, True, 0, True);
end;
...
begin
  ...
  AData.AddProperty('DropDownCount', TCustomCombo_DropDownCount_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('EditHandle', TCustomCombo_EditHandle_si, HWnd_sw, True, False, 0, True);
  AData.AddProperty('ItemCount', TCustomCombo_ItemCount_si, Integer_sw, True, False, 0, True);
  AData.AddProperty('ItemHeight', TCustomCombo_ItemHeight_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('ListHandle', TCustomCombo_ListHandle_si, HWnd_sw, True, False, 0, True);
  AData.AddProperty('MaxLength', TCustomCombo_MaxLength_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('OnChange', TCustomCombo_OnChange_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDropDown', TCustomCombo_OnDropDown_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnSelect', TCustomCombo_OnSelect_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCloseUp', TCustomCombo_OnCloseUp_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('Canvas', TCustomCombo_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddProperty('DroppedDown', TCustomCombo_DroppedDown_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Items', TCustomCombo_Items_si, TStrings_sw, True, True, 0, False);
  AData.AddProperty('SelLength', TCustomCombo_SelLength_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('SelStart', TCustomCombo_SelStart_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('TabStop');
end;
...
class function TComboBoxStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TComboBoxStyle);
end;
...
begin
  ...
  AData.AddProperty('Sorted', TCustomComboBox_Sorted_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Style', TCustomComboBox_Style_si, TComboBoxStyle_sw, True, True, 0, True);
  AData.AddProperty('OnMeasureItem', TCustomComboBox_OnMeasureItem_si, TMeasureItemEvent_sw, True, True, 0, True);
  AData.AddProperty('AutoCompleteDelay', TCustomComboBox_AutoCompleteDelay_si, Cardinal_sw, True, True, 0, False);
  AData.AddProperty('AutoComplete', TCustomComboBox_AutoComplete_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AutoCloseUp', TCustomComboBox_AutoCloseUp_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AutoDropDown', TCustomComboBox_AutoDropDown_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('CharCase', TCustomComboBox_CharCase_si, TEditCharCase_sw, True, True, 0, False);
  AData.AddProperty('SelText', TCustomComboBox_SelText_si, string_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('AutoCompleteDelay');
  AData.AddPropertyRedecl('AutoDropDown');
  AData.AddPropertyRedecl('AutoCloseUp');
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  AData.AddPropertyRedecl('BevelKind');
  AData.AddPropertyRedecl('BevelOuter');
...
begin
  ...
  AData.AddProperty('Checked', TButtonControl_Checked_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ClicksDisabled', TButtonControl_ClicksDisabled_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('WordWrap', TButtonControl_WordWrap_si, Boolean_sw, True, True, 0, True);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddProperty('Cancel', TButton_Cancel_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Caption');
  AData.AddPropertyRedecl('Constraints');
  AData.AddProperty('Default', TButton_Default_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddProperty('ModalResult', TButton_ModalResult_si, TModalResult_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
...
class function TCheckBoxState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCheckBoxState);
end;
...
begin
  ...
  AData.AddProperty('Alignment', TCustomCheckBox_Alignment_si, TLeftRight_sw, True, True, 0, True);
  AData.AddProperty('AllowGrayed', TCustomCheckBox_AllowGrayed_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('State', TCustomCheckBox_State_si, TCheckBoxState_sw, True, True, 0, True);
  AData.AddPropertyRedecl('TabStop');
end;
...
begin
  ...
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Alignment');
  AData.AddPropertyRedecl('AllowGrayed');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('Caption');
...
begin
  ...
  AData.AddPropertyRedecl('Action');
  AData.AddPropertyRedecl('Align');
  AData.AddProperty('Alignment', TRadioButton_Alignment_si, TLeftRight_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('Caption');
  AData.AddPropertyRedecl('Checked');
...
class function TListBoxStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TListBoxStyle);
end;
...
begin
  ...
  AData.AddProperty('BorderStyle', TCustomListBox_BorderStyle_si, TBorderStyle_sw, True, True, 0, True);
  AData.AddProperty('Columns', TCustomListBox_Columns_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('ExtendedSelect', TCustomListBox_ExtendedSelect_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('IntegralHeight', TCustomListBox_IntegralHeight_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ItemHeight', TCustomListBox_ItemHeight_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('Sorted', TCustomListBox_Sorted_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Style', TCustomListBox_Style_si, TListBoxStyle_sw, True, True, 0, True);
  AData.AddProperty('TabWidth', TCustomListBox_TabWidth_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('OnMeasureItem', TCustomListBox_OnMeasureItem_si, TMeasureItemEvent_sw, True, True, 0, True);
  AData.AddProperty('OnData', TCustomListBox_OnData_si, TLBGetDataEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDataObject', TCustomListBox_OnDataObject_si, TLBGetDataObjectEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDataFind', TCustomListBox_OnDataFind_si, TLBFindDataEvent_sw, True, True, 0, True);
  ...
  AData.AddProperty('AutoCompleteDelay', TCustomListBox_AutoCompleteDelay_si, Cardinal_sw, True, True, 0, False);
  AData.AddProperty('AutoComplete', TCustomListBox_AutoComplete_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Canvas', TCustomListBox_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddProperty('Count', TCustomListBox_Count_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Items', TCustomListBox_Items_si, TStrings_sw, True, True, 0, False);
  AData.AddProperty('Selected', TCustomListBox_Selected_si, Boolean_sw, True, True, 1, False);
  AData.AddProperty('ScrollWidth', TCustomListBox_ScrollWidth_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('TopIndex', TCustomListBox_TopIndex_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('TabStop');
end;
...
begin
  ...
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('ExtendedSelect');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('ImeMode');
  AData.AddPropertyRedecl('ImeName');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('ScrollWidth');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('Sorted');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
...
class function TScrollCode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TScrollCode);
end;
...
begin
  ...
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddProperty('Kind', TScrollBar_Kind_si, TScrollBarKind_sw, True, True, 0, False);
  AData.AddProperty('LargeChange', TScrollBar_LargeChange_si, TScrollBarInc_sw, True, True, 0, False);
  AData.AddProperty('Max', TScrollBar_Max_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Min', TScrollBar_Min_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('PageSize', TScrollBar_PageSize_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentCtl3D');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('Position', TScrollBar_Position_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('SmallChange', TScrollBar_SmallChange_si, TScrollBarInc_sw, True, True, 0, False);
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddProperty('OnChange', TScrollBar_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddPropertyRedecl('OnEndDock');
  AData.AddPropertyRedecl('OnEndDrag');
  ...
  AData.AddPropertyRedecl('OnMouseEnter');
  AData.AddPropertyRedecl('OnMouseLeave');
  AData.AddProperty('OnScroll', TScrollBar_OnScroll_si, TScrollEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnStartDrag');
end;
...
class function TStaticBorderStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TStaticBorderStyle);
end;
...
begin
  ...
  AData.AddProperty('Alignment', TCustomStaticText_Alignment_si, TAlignment_sw, True, True, 0, True);
  AData.AddProperty('AutoSize', TCustomStaticText_AutoSize_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('BorderStyle', TCustomStaticText_BorderStyle_si, TStaticBorderStyle_sw, True, True, 0, True);
  AData.AddProperty('FocusControl', TCustomStaticText_FocusControl_si, TWinControl_sw, True, True, 0, True);
  AData.AddProperty('ShowAccelChar', TCustomStaticText_ShowAccelChar_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Transparent', TCustomStaticText_Transparent_si, Boolean_sw, True, True, 0, True);
end;
...
function StdCtrls_TTextLayout_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTextLayout = (tlCenter, tlBottom);
...
function StdCtrls_TEllipsisPosition_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TEllipsisPosition = (epPathEllipsis, epEndEllipsis, ...
...
function StdCtrls_TEditCharCase_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TEditCharCase = (ecUpperCase, ecLowerCase);
...
function StdCtrls_TScrollStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TScrollStyle = (ssHorizontal, ssVertical, ssBoth);
...
function StdCtrls_TComboBoxStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TComboBoxStyle = (csSimple, csDropDownList, csOwnerD...
...
function StdCtrls_TCheckBoxState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCheckBoxState = (cbChecked, cbGrayed);
...
function StdCtrls_TListBoxStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TListBoxStyle = (lbOwnerDrawFixed, lbOwnerDrawVariab...
...
function StdCtrls_TScrollCode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TScrollCode = (scLineDown, scPageUp, scPageDown, scP...
...
function StdCtrls_TStaticBorderStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TStaticBorderStyle = (sbsSingle, sbsSunken);
