...
uses
  ...
  ToolWin, Windows_LMDSW, Messages_LMDSW, Classes_LMDSW, Controls_LMDSW,
  Forms_LMDSW;
...
class function TEdgeBorder_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TEdgeBorder);
end;
...
class function TEdgeStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TEdgeStyle);
end;
...
begin
  ...
  AData.AddProperty('EdgeBorders', TToolWindow_EdgeBorders_si, TEdgeBorders_sw, True, True, 0, False);
  AData.AddProperty('EdgeInner', TToolWindow_EdgeInner_si, TEdgeStyle_sw, True, True, 0, False);
  AData.AddProperty('EdgeOuter', TToolWindow_EdgeOuter_si, TEdgeStyle_sw, True, True, 0, False);
end;
...
class function TSizingOrientation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TSizingOrientation);
end;
...
function ToolWin_TEdgeBorder_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TEdgeBorder = (ebTop, ebRight, ebBottom);
...
function ToolWin_TEdgeStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TEdgeStyle = (esRaised, esLowered);
...
function ToolWin_TSizingOrientation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TSizingOrientation = (soHorizontal, soVertical);
