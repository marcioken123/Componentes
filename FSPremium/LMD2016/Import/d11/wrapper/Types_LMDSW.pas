...
uses
  ...
  LMDSctWrappers, LMDSctSysWrappers, Types;
...
begin
  ...
  AData.AddFunction('Copy', TPoint_Copy_si, TPoint_sw, 0);
  AData.AddField('X', TPoint_X_si, Longint_sw);
  AData.AddField('Y', TPoint_Y_si, Longint_sw);

  { Class members }

  AData.AddConstructor('Create', TPoint_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TRect_Copy_si, TRect_sw, 0);
  ...
  AData.AddConstructor('Create', TRect_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', tagSIZE_Copy_si, tagSIZE_sw, 0);
  AData.AddField('cx', tagSIZE_cx_si, Longint_sw);
  AData.AddField('cy', tagSIZE_cy_si, Longint_sw);

  { Class members }

  AData.AddConstructor('Create', tagSIZE_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TSmallPoint_Copy_si, TSmallPoint_sw, 0);
  AData.AddField('x', TSmallPoint_x_si, SmallInt_sw);
  AData.AddField('y', TSmallPoint_y_si, SmallInt_sw);

  { Class members }

  AData.AddConstructor('Create', TSmallPoint_Create_si, 0);
end;
