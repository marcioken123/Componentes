...
uses
  ...
  LMDSctSysWrappers, Types, Windows, SysUtils, Classes, Messages, Controls,
  Grids, StdCtrls, ValEdit, Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW,
...
class function TDisplayOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDisplayOption);
end;
...
class function TKeyOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TKeyOption);
end;
...
begin
  ...
  if IsGet then
    ...
    TValueListEditor(AObj).ItemProps[Variant(AArgs[0])] := TItemProp_sw.FromVar(
      AArgs[1]);
end;
...
begin
  ...
  AData.AddProperty('EditList', TValueListEditor_EditList_si, TInplaceEditList_sw, True, False, 0, True);
  ...
  AData.AddProperty('Cells', TValueListEditor_Cells_si, string_sw, True, True, 2, False);
  AData.AddPropertyRedecl('ColCount');
  AData.AddProperty('ItemProps', TValueListEditor_ItemProps_si, TItemProp_sw, True, True, 1, False);
  AData.AddProperty('Keys', TValueListEditor_Keys_si, string_sw, True, True, 1, False);
  AData.AddProperty('RowCount', TValueListEditor_RowCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Values', TValueListEditor_Values_si, string_sw, True, True, 1, False);
  ...
  AData.AddProperty('DisplayOptions', TValueListEditor_DisplayOptions_si, TDisplayOptions_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddProperty('DropDownRows', TValueListEditor_DropDownRows_si, Integer_sw, True, True, 0, False);
  ...
  AData.AddProperty('KeyOptions', TValueListEditor_KeyOptions_si, TKeyOptions_sw, True, True, 0, False);
  AData.AddProperty('Options', TValueListEditor_Options_si, TGridOptions_sw, True, True, 0, False);
  ...
  AData.AddProperty('Strings', TValueListEditor_Strings_si, TStrings_sw, True, True, 0, False);
  AData.AddPropertyRedecl('TabOrder');
  AData.AddProperty('TitleCaptions', TValueListEditor_TitleCaptions_si, TStrings_sw, True, True, 0, False);
  ...
  AData.AddProperty('OnEditButtonClick', TValueListEditor_OnEditButtonClick_si, TNotifyEvent_sw, True, True, 0, False);
  ...
  AData.AddProperty('OnGetPickList', TValueListEditor_OnGetPickList_si, TGetPickListEvent_sw, True, True, 0, False);
  ...
  AData.AddProperty('OnStringsChange', TValueListEditor_OnStringsChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnStringsChanging', TValueListEditor_OnStringsChanging_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnTopLeftChanged');
  AData.AddProperty('OnValidate', TValueListEditor_OnValidate_si, TOnValidateEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  if IsGet then
    ...
    TValueListStrings(AObj).ItemProps[Variant(AArgs[0])] := TItemProp_sw.
      FromVar(AArgs[1]);
end;
...
begin
  ...
  AData.AddFunction('KeyIsValid', TValueListStrings_KeyIsValid_si, Boolean_sw, 2, False);
  AData.AddProperty('ItemProps', TValueListStrings_ItemProps_si, TItemProp_sw, True, True, 1, False);
...
begin
  ...
  AData.AddProperty('EditMask', TItemProp_EditMask_si, string_sw, True, True, 0, False);
  AData.AddProperty('EditStyle', TItemProp_EditStyle_si, TEditStyle_sw, True, True, 0, False);
  AData.AddProperty('KeyDesc', TItemProp_KeyDesc_si, string_sw, True, True, 0, False);
  AData.AddProperty('PickList', TItemProp_PickList_si, TStrings_sw, True, True, 0, False);
  AData.AddProperty('MaxLength', TItemProp_MaxLength_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ReadOnly', TItemProp_ReadOnly_si, Boolean_sw, True, True, 0, False);
...
function ValEdit_TDisplayOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDisplayOption = (doAutoColResize, doKeyColFixed);
...
function ValEdit_TKeyOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TKeyOption = (keyAdd, keyDelete, keyUnique);
