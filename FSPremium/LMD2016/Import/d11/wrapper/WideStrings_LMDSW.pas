...
uses
  ...
  LMDSctSysWrappers, Types, Classes, SysUtils, WideStrings, Classes_LMDSW,
  SysUtils_LMDSW;
...
begin
  ...
  AData.AddProperty('Current', TWideStringsEnumerator_Current_si, WideString_sw, True, False, 0, False);
...
begin
  ...
  if IsGet then
    Result := TWideStrings(AObj).Delimiter
  else
...
begin
  ...
  if IsGet then
    Result := TWideStrings(AObj).QuoteChar
  else
...
begin
  ...
  if IsGet then
    Result := TWideStrings(AObj).NameValueSeparator
  else
...
begin
  ...
  AData.AddProperty('UpdateCount', TWideStrings_UpdateCount_si, Integer_sw, True, False, 0, True);
  ...
  AData.AddProperty('Capacity', TWideStrings_Capacity_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('CommaText', TWideStrings_CommaText_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('Count', TWideStrings_Count_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Delimiter', TWideStrings_Delimiter_si, WideChar_sw, True, True, 0, False);
  AData.AddProperty('DelimitedText', TWideStrings_DelimitedText_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('LineBreak', TWideStrings_LineBreak_si, WideString_sw, True, True, 0, False);
  AData.AddProperty('Names', TWideStrings_Names_si, WideString_sw, True, False, 1, False);
  AData.AddProperty('Objects', TWideStrings_Objects_si, TObject_sw, True, True, 1, False);
  AData.AddProperty('QuoteChar', TWideStrings_QuoteChar_si, WideChar_sw, True, True, 0, False);
  AData.AddProperty('Values', TWideStrings_Values_si, WideString_sw, True, True, 1, False);
  AData.AddProperty('ValueFromIndex', TWideStrings_ValueFromIndex_si, WideString_sw, True, True, 1, False);
  AData.AddProperty('NameValueSeparator', TWideStrings_NameValueSeparator_si, WideChar_sw, True, True, 0, False);
  AData.AddProperty('StrictDelimiter', TWideStrings_StrictDelimiter_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Strings', TWideStrings_Strings_si, WideString_sw, True, True, 1, False);
  AData.AddProperty('Text', TWideStrings_Text_si, WideString_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddFunction('Copy', TWideStringItem_Copy_si, TWideStringItem_sw, 0);
  ...
  AData.AddConstructor('Create', TWideStringItem_Create_si, 0);
end;
...
begin
  ...
  AData.AddProperty('Duplicates', TWideStringList_Duplicates_si, TDuplicates_sw, True, True, 0, False);
  AData.AddProperty('Sorted', TWideStringList_Sorted_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('CaseSensitive', TWideStringList_CaseSensitive_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnChange', TWideStringList_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnChanging', TWideStringList_OnChanging_si, TNotifyEvent_sw, True, True, 0, False);
end;
