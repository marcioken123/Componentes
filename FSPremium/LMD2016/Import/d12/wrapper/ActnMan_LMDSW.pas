...
uses
  ...
  LMDSctSysWrappers, Types, Windows, Messages, SysUtils, Classes, Forms, Menus,
  ActnList, Graphics, ToolWin, ImgList, Controls, Buttons, StdCtrls, ActnMan,
  Windows_LMDSW, Messages_LMDSW, SysUtils_LMDSW, Classes_LMDSW, Forms_LMDSW,
  Menus_LMDSW, ActnList_LMDSW, Graphics_LMDSW, ToolWin_LMDSW, ImgList_LMDSW,
  Controls_LMDSW, Buttons_LMDSW, StdCtrls_LMDSW;
...
begin
  ...
  AData.AddProperty('Tag', TActionClient_Tag_si, Integer_sw, True, True, 0, False, False);
end;
...
begin
  ...
  if IsGet then
    Result := TActionBarStyleList_sw.ToVar(ActnMan.ActionBarStyles)
  else
    ActnMan.ActionBarStyles := TActionBarStyleList_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    ActnMan.DefaultActnBarStyle := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddConstant('CM_ITEMDROPPOINT', ActnMan_CM_ITEMDROPPOINT_si, nil, VarType(ActnMan.CM_ITEMDROPPOINT));
