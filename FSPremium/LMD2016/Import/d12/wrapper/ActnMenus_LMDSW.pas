...
uses
  ...
  LMDSctSysWrappers, Types, Windows, Messages, Classes, Contnrs, Buttons,
  Graphics, Forms, Controls, ActnList, ToolWin, ExtCtrls, StdCtrls, Menus,
  StdActns, ActnMan, ActnCtrls, ShadowWnd, ActnMenus, Windows_LMDSW,
  Messages_LMDSW, Classes_LMDSW, Contnrs_LMDSW, Buttons_LMDSW, Graphics_LMDSW,
  Forms_LMDSW, Controls_LMDSW, ActnList_LMDSW, ToolWin_LMDSW, ExtCtrls_LMDSW,
