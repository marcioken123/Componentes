...
uses
  ...
  LMDSctSysWrappers, Types, Windows, Messages, SysUtils, Classes, Controls,
  Forms, ActnList, AppEvnts, Windows_LMDSW, Messages_LMDSW, SysUtils_LMDSW,
  Classes_LMDSW, Controls_LMDSW, Forms_LMDSW, ActnList_LMDSW;
