...
begin
  ...
  TList_sc(AObj).Error(string(AArgs[0]), Integer(AArgs[1]));
end;
...
begin
  ...
  TWriter(AObj).WriteString(UnicodeString(AArgs[0]));
end;
...
begin
  ...
  TWriter(AObj).WriteWideString(UnicodeString(AArgs[0]));
end;
...
begin
  ...
  AData.AddConstructor('Create', TParser_Create_si, 1, True);
end;
...
function TSynchronizeRecord_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: TSynchronizeRecord;
...
begin
  ...
  AData.AddFunction('Copy', TSynchronizeRecord_Copy_si, TSynchronizeRecord_sw, 0, False);

  { Class members }

  AData.AddConstructor('Create', TSynchronizeRecord_Create_si, 0, False);
end;
...
begin
  ...
  AData.AddProperty('ThreadID', TThread_ThreadID_si, THandle_sw, True, False, 0, False, False);
...
begin
  ...
  AData.AddProperty('DesignInfo', TComponent_DesignInfo_si, Longint_sw, True, True, 0, False, False);
  ...
  AData.AddProperty('Tag', TComponent_Tag_si, Longint_sw, True, True, 0, False, False);
...
function TBasicAction_Clients_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Clients: TList read <getter> write <se...

  if IsGet then
    Result := TList_sw.ToVar(TBasicAction_sacc(TBasicAction(AObj)).Clients)
  else
    TBasicAction_sacc(TBasicAction(AObj)).Clients := TList_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Clients', TBasicAction_Clients_si, TList_sw, True, True, 0, True, False);
...
begin
  ...
  if IsGet then
    ...
    Classes.CurrentGroup := Integer(AArgs[0]);
end;
...
begin
  ...
  Result := Classes.PointsEqual(TPoint_sw.FromVar(AArgs[0]), TPoint_sw.FromVar(
    AArgs[1]));
end;
...
begin
  ...
  case AArgsSize of
    2:
    begin
      Result := Classes.InvalidPoint(Integer(AArgs[0]), Integer(AArgs[1]));
    end;
    1:
    begin
      Result := Classes.InvalidPoint(TPoint_sw.FromVar(AArgs[0]));
    end;
  else
...
begin
  ...
  case AArgsSize of
    4:
    begin
      Result := TRect_sw.ToVar(Classes.Rect(Integer(AArgs[0]), Integer(
        AArgs[1]), Integer(AArgs[2]), Integer(AArgs[3])));
    end;
    2:
    begin
      Result := TRect_sw.ToVar(Classes.Rect(TPoint_sw.FromVar(AArgs[0]), 
...
begin
  ...
  Classes.RegisterClass(TPersistentClass_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Classes.RegisterClassAlias(TPersistentClass_sw.FromVar(AArgs[0]), string(
    AArgs[1]));
end;
...
begin
  ...
  Classes.UnRegisterClass(TPersistentClass_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Classes.UnRegisterModuleClasses(HMODULE_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Result := TPersistentClass_sw.ToVar(Classes.FindClass(string(AArgs[0])));
end;
...
begin
  ...
  Result := TPersistentClass_sw.ToVar(Classes.GetClass(string(AArgs[0])));
end;
...
begin
  ...
  Classes.StartClassGroup(TPersistentClass_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Classes.GroupDescendentsWith(TPersistentClass_sw.FromVar(AArgs[0]), 
...
begin
  ...
  Result := TPersistentClass_sw.ToVar(Classes.ActivateClassGroup(
    TPersistentClass_sw.FromVar(AArgs[0])));
end;
...
begin
  ...
  Result := TPersistentClass_sw.ToVar(Classes.ClassGroupOf(TPersistentClass_sw.
    FromVar(AArgs[0])));
end;
...
begin
  ...
  Result := TComponent_sw.ToVar(Classes.FindGlobalComponent(string(AArgs[0])));
end;
...
begin
  ...
  Result := Classes.IsUniqueGlobalComponentName(string(AArgs[0]));
end;
...
begin
  ...
  Result := Classes.InitInheritedComponent(TComponent_sw.FromVar(AArgs[0]), 
...
begin
  ...
  Result := Classes.InitComponentRes(string(AArgs[0]), TComponent_sw.FromVar(
    AArgs[1]));
end;
...
begin
  ...
  Result := TComponent_sw.ToVar(Classes.ReadComponentRes(string(AArgs[0]), 
    TComponent_sw.FromVar(AArgs[1])));
end;
...
begin
  ...
  Result := TComponent_sw.ToVar(Classes.ReadComponentResEx(THandle_sw.FromVar(
...
function Classes_ReadComponentResFile_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function ReadComponentResFile(const FileName: string; Ins...

  Result := TComponent_sw.ToVar(Classes.ReadComponentResFile(string(AArgs[0]), 
    TComponent_sw.FromVar(AArgs[1])));
end;
...
function Classes_WriteComponentResFile_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure WriteComponentResFile(const FileName: string; I...

  Classes.WriteComponentResFile(string(AArgs[0]), TComponent_sw.FromVar(
    AArgs[1]));
end;
...
function Classes_GetFixupReferenceNames_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure GetFixupReferenceNames(Root: TComponent; Names:...

  Classes.GetFixupReferenceNames(TComponent_sw.FromVar(AArgs[0]), TStrings_sw.
    FromVar(AArgs[1]));
end;
...
function Classes_GetFixupInstanceNames_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure GetFixupInstanceNames(Root: TComponent; const R...

  Classes.GetFixupInstanceNames(TComponent_sw.FromVar(AArgs[0]), string(
...
function Classes_RedirectFixupReferences_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure RedirectFixupReferences(Root: TComponent; const...

  Classes.RedirectFixupReferences(TComponent_sw.FromVar(AArgs[0]), string(
...
function Classes_RemoveFixupReferences_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure RemoveFixupReferences(Root: TComponent; const R...

  Classes.RemoveFixupReferences(TComponent_sw.FromVar(AArgs[0]), string(
    AArgs[1]));
end;
...
begin
  ...
  Classes.RemoveFixups(TPersistent_sw.FromVar(AArgs[0]));
end;

function Classes_FindNestedComponent_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function FindNestedComponent(Root: TComponent; const Name...

  Result := TComponent_sw.ToVar(Classes.FindNestedComponent(TComponent_sw.
...
function Classes_CollectionsEqual_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function CollectionsEqual(C1: TCollection; C2: TCollectio...

  Result := Classes.CollectionsEqual(TCollection_sw.FromVar(AArgs[0]), 
...
begin
  ...
  Result := TPersistent_sw.ToVar(Classes.GetUltimateOwner(TPersistent_sw.
    FromVar(AArgs[0])));
end;
...
begin
  ...
  case AArgsSize of
    2:
    begin
      Classes.ObjectBinaryToText(TStream_sw.FromVar(AArgs[0]), TStream_sw.
        FromVar(AArgs[1]));
    end;
    3:
    begin
...
begin
  ...
  case AArgsSize of
    2:
    begin
      Classes.ObjectTextToBinary(TStream_sw.FromVar(AArgs[0]), TStream_sw.
        FromVar(AArgs[1]));
    end;
    3:
    begin
...
begin
  ...
  case AArgsSize of
    2:
    begin
      Classes.ObjectResourceToText(TStream_sw.FromVar(AArgs[0]), TStream_sw.
        FromVar(AArgs[1]));
    end;
    3:
    begin
...
begin
  ...
  case AArgsSize of
    2:
    begin
      Classes.ObjectTextToResource(TStream_sw.FromVar(AArgs[0]), TStream_sw.
        FromVar(AArgs[1]));
    end;
    3:
    begin
...
function Classes_TestStreamFormat_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function TestStreamFormat(Stream: TStream): TStreamOrigin...

  Result := TStreamOriginalFormat_sw.ToVar(Classes.TestStreamFormat(TStream_sw.
    FromVar(AArgs[0])));
end;
...
var
  v_1: string;
begin
  // function GetResourceName(ObjStream: TStream; var AName: s...

  v_1 := string(AArgs[1]);
  Result := Classes.GetResourceName(TStream_sw.FromVar(AArgs[0]), v_1);
  AssignRefParam(AArgs[1], v_1);
end;
...
function Classes_WriteObjectResourceHeader_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure WriteObjectResourceHeader(ObjStream: TStream; O...

  Classes.WriteObjectResourceHeader(TStream_sw.FromVar(AArgs[0]), TStream_sw.
    FromVar(AArgs[1]));
end;
...
begin
  ...
  Result := Classes.CountGenerations(TClass_sw.FromVar(AArgs[0]), TClass_sw.
    FromVar(AArgs[1]));
end;
...
begin
  ...
  case AArgsSize of
    ...
    1:
    begin
      Result := Classes.CheckSynchronize(Integer(AArgs[0]));
    end;
  else
...
begin
  ...
  if IsGet then
    Result := TNotifyEvent_sw.ToVar(Classes.WakeMainThread)
  else
    Classes.WakeMainThread := TNotifyEvent_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := THandle_sw.ToVar(Classes.SyncEvent)
  else
    Classes.SyncEvent := THandle_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  Result := HWND_sw.ToVar(Classes.AllocateHWnd(TWndMethod_sw.FromVar(
    AArgs[0])));
end;
...
begin
  ...
  Classes.DeallocateHWnd(HWND_sw.FromVar(AArgs[0]));
end;

function Classes_AncestorIsValid_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function AncestorIsValid(Ancestor: TPersistent; Root: TCo...

  Result := Classes.AncestorIsValid(TPersistent_sw.FromVar(AArgs[0]), 
...
begin
  AData.AddConstant('MaxListSize', Classes_MaxListSize_si, nil, VarType(Classes.MaxListSize));
  ...
  AData.AddProcedure('ObjectTextToResource', Classes_ObjectTextToResource_si, 2, True);
  ...
  AData.AddProcedure('WriteObjectResourceHeader', Classes_WriteObjectResourceHeader_si, 2, False);
