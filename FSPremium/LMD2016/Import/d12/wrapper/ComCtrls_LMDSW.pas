...
begin
  ...
  AData.AddProperty('Min', TCustomUpDown_Min_si, SmallInt_sw, True, True, 0, True, False);
  AData.AddProperty('Max', TCustomUpDown_Max_si, SmallInt_sw, True, True, 0, True, False);
  ...
  AData.AddProperty('Position', TCustomUpDown_Position_si, SmallInt_sw, True, True, 0, True, False);
...
function TListGroup_TopDescription_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property TopDescription: string read <getter> write <sett...

  if IsGet then
    Result := TListGroup(AObj).TopDescription
  else
    TListGroup(AObj).TopDescription := string(AArgs[0]);
end;

function TListGroup_BottomDescription_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property BottomDescription: string read <getter> write <s...

  if IsGet then
    Result := TListGroup(AObj).BottomDescription
  else
    TListGroup(AObj).BottomDescription := string(AArgs[0]);
end;
...
function TListGroup_ExtendedImage_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property ExtendedImage: TImageIndex read <getter> write <...

  if IsGet then
    Result := TImageIndex_sw.ToVar(TListGroup(AObj).ExtendedImage)
  else
    TListGroup(AObj).ExtendedImage := TImageIndex_sw.FromVar(AArgs[0]);
end;

function TListGroup_SubsetTitle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property SubsetTitle: string read <getter> write <setter>;

  if IsGet then
    Result := TListGroup(AObj).SubsetTitle
  else
    TListGroup(AObj).SubsetTitle := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('TopDescription', TListGroup_TopDescription_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('BottomDescription', TListGroup_BottomDescription_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('TitleImage', TListGroup_TitleImage_si, TImageIndex_sw, True, True, 0, False, False);
  AData.AddProperty('ExtendedImage', TListGroup_ExtendedImage_si, TImageIndex_sw, True, True, 0, False, False);
  AData.AddProperty('SubsetTitle', TListGroup_SubsetTitle_si, string_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddConstant('CN_DROPDOWNCLOSED', ComCtrls_CN_DROPDOWNCLOSED_si, nil, VarType(ComCtrls.CN_DROPDOWNCLOSED));
  ...
  AData.AddConstant('CN_BANDCHANGE', ComCtrls_CN_BANDCHANGE_si, nil, VarType(ComCtrls.CN_BANDCHANGE));
  ...
  AData.AddConstant('ComCtlVersionIE3', ComCtrls_ComCtlVersionIE3_si, nil, VarType(ComCtrls.ComCtlVersionIE3));
  AData.AddConstant('ComCtlVersionIE4', ComCtrls_ComCtlVersionIE4_si, nil, VarType(ComCtrls.ComCtlVersionIE4));
  AData.AddConstant('ComCtlVersionIE401', ComCtrls_ComCtlVersionIE401_si, nil, VarType(ComCtrls.ComCtlVersionIE401));
  AData.AddConstant('ComCtlVersionIE5', ComCtrls_ComCtlVersionIE5_si, nil, VarType(ComCtrls.ComCtlVersionIE5));
  AData.AddConstant('ComCtlVersionIE501', ComCtrls_ComCtlVersionIE501_si, nil, VarType(ComCtrls.ComCtlVersionIE501));
  AData.AddConstant('ComCtlVersionIE6', ComCtrls_ComCtlVersionIE6_si, nil, VarType(ComCtrls.ComCtlVersionIE6));
