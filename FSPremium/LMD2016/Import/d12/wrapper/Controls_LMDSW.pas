...
function Controls_GetAlignControlList_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function GetAlignControlList(AControl: TWinControl): TList;

  Result := TList_sw.ToVar(Controls.GetAlignControlList(TWinControl_sw.FromVar(
    AArgs[0])));
end;
...
begin
  ...
  AData.AddConstant('CM_CONTROLLISTCHANGING', Controls_CM_CONTROLLISTCHANGING_si, nil, VarType(Controls.CM_CONTROLLISTCHANGING));
  ...
  AData.AddFunction('GetAlignControlList', Controls_GetAlignControlList_si, TList_sw, 1, False);
end;
