...
type
  ...
  TParamDataSetObject_sw = class;
  TParamParamsObject_sw = class;
  ...
  TParamDataSetObject_sc = class of TParamDataSetObject;
  TParamDataSetObject_sw = class(TParamObject_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TParamDataSetObject): OleVariant;
    class function FromVar(const AValue: OleVariant): TParamDataSetObject;
    class function ClassToVar(AClass: TParamDataSetObject_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TParamDataSetObject_sc;
  end;

  TParamParamsObject_sc = class of TParamParamsObject;
  TParamParamsObject_sw = class(TParamObject_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TParamParamsObject): OleVariant;
    class function FromVar(const AValue: OleVariant): TParamParamsObject;
    class function ClassToVar(AClass: TParamParamsObject_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TParamParamsObject_sc;
  end;
...
class procedure TFieldType_sw.GetEnumerators(out AEnums: PLMDEnumerator;
  out ACount: Integer);
const
  ENUMS: array[0..48] of TLMDEnumerator = (
...
function TDefCollection_GetItemNames_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function GetItemNames(...); overload;
...
function TFields_GetFieldNames_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function GetFieldNames(...); overload;
...
function TField_AsWideString_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property AsWideString: UnicodeString read <getter> write ...

  if IsGet then
    Result := TField(AObj).AsWideString
  else
    TField(AObj).AsWideString := UnicodeString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('AsWideString', TField_AsWideString_si, UnicodeString_sw, True, True, 0, False, False);
...
function TWideStringField_Value_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Value: UnicodeString read <getter> write <setter>;

  if IsGet then
    Result := TWideStringField(AObj).Value
  else
    TWideStringField(AObj).Value := UnicodeString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Value', TWideStringField_Value_si, UnicodeString_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddProperty('AsLargeInt', TLargeintField_AsLargeInt_si, LargeInt_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    ...
    TWideMemoField(AObj).Value := UnicodeString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Value', TWideMemoField_Value_si, UnicodeString_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddProperty('Fields', TMasterDataLink_Fields_si, TList_sw, True, False, 0, False, False);
...
begin
  ...
  AData.AddProperty('DataLinks', TDataSource_DataLinks_si, TList_sw, True, False, 0, True, False);
...
begin
  ...
  if IsGet then
    ...
    TParam(AObj).AsWideString := UnicodeString(AArgs[0]);
end;
...
begin
  ...
  AData.AddProcedure('SetStream', TParam_SetStream_si, 2, False);
  ...
  AData.AddProperty('AsWideString', TParam_AsWideString_si, UnicodeString_sw, True, True, 0, False, False);
...
function TParamObject_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create(AInstanceOwner: Boolean; AInstanceOwne...

  Result := TParamObject_sw.ToVar(TParamObject_sc(AObj).Create(Boolean(
    AArgs[0]), Boolean(AArgs[1])));
end;

function TParamObject_GetImplementation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function GetImplementation: TObject;

  Result := TObject_sw.ToVar(TParamObject(AObj).GetImplementation());
end;

function TParamObject_IsInstanceOwner_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property IsInstanceOwner: Boolean read <getter>;

  Result := TParamObject(AObj).IsInstanceOwner;
end;
...
begin
  ...
  AData.AddFunction('GetImplementation', TParamObject_GetImplementation_si, TObject_sw, 0, False);
  AData.AddProperty('IsInstanceOwner', TParamObject_IsInstanceOwner_si, Boolean_sw, True, False, 0, False, False);

  { Class members }

  AData.AddConstructor('Create', TParamObject_Create_si, 2, False);
end;
...
{ TParamDataSetObject_sw }

function TParamDataSetObject_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create(DataSet: TDataSet; AInstanceOwner: Boo...

  Result := TParamDataSetObject_sw.ToVar(TParamDataSetObject_sc(AObj).Create(
    TDataSet_sw.FromVar(AArgs[0]), Boolean(AArgs[1]), Boolean(AArgs[2])));
end;

function TParamDataSetObject_DataSet_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DataSet: TDataSet read <getter>;

  Result := TDataSet_sw.ToVar(TParamDataSetObject(AObj).DataSet);
end;

class function TParamDataSetObject_sw.GetTypeName: WideString;
begin
  Result := 'TParamDataSetObject';
end;

class function TParamDataSetObject_sw.GetWrappedClass: TClass;
begin
  Result := TParamDataSetObject;
end;

class procedure TParamDataSetObject_sw.DoInit(AData: TLMDClassWrapperData);
begin
  { Instance members }

  AData.AddProperty('DataSet', TParamDataSetObject_DataSet_si, TDataSet_sw, True, False, 0, False, False);

  { Class members }

  AData.AddConstructor('Create', TParamDataSetObject_Create_si, 3, False);
end;

class function TParamDataSetObject_sw.ToVar(
  const AValue: TParamDataSetObject): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TParamDataSetObject_sw.FromVar(
  const AValue: OleVariant): TParamDataSetObject;
begin
  Result := TParamDataSetObject(ConvFromVar(AValue, TParamDataSetObject));
end;

class function TParamDataSetObject_sw.ClassToVar(
  AClass: TParamDataSetObject_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TParamDataSetObject_sw.ClassFromVar(
  const AClass: OleVariant): TParamDataSetObject_sc;
begin
  Result := TParamDataSetObject_sc(ConvClsFromVar(AClass, TParamDataSetObject));
end;

{ TParamParamsObject_sw }

function TParamParamsObject_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create(Params: TParams; AInstanceOwner: Boole...

  Result := TParamParamsObject_sw.ToVar(TParamParamsObject_sc(AObj).Create(
    TParams_sw.FromVar(AArgs[0]), Boolean(AArgs[1]), Boolean(AArgs[2])));
end;

function TParamParamsObject_Params_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Params: TParams read <getter>;

  Result := TParams_sw.ToVar(TParamParamsObject(AObj).Params);
end;

class function TParamParamsObject_sw.GetTypeName: WideString;
begin
  Result := 'TParamParamsObject';
end;

class function TParamParamsObject_sw.GetWrappedClass: TClass;
begin
  Result := TParamParamsObject;
end;

class procedure TParamParamsObject_sw.DoInit(AData: TLMDClassWrapperData);
begin
  { Instance members }

  AData.AddProperty('Params', TParamParamsObject_Params_si, TParams_sw, True, False, 0, False, False);

  { Class members }

  AData.AddConstructor('Create', TParamParamsObject_Create_si, 3, False);
end;

class function TParamParamsObject_sw.ToVar(
  const AValue: TParamParamsObject): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TParamParamsObject_sw.FromVar(
  const AValue: OleVariant): TParamParamsObject;
begin
  Result := TParamParamsObject(ConvFromVar(AValue, TParamParamsObject));
end;

class function TParamParamsObject_sw.ClassToVar(
  AClass: TParamParamsObject_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TParamParamsObject_sw.ClassFromVar(
  const AClass: OleVariant): TParamParamsObject_sc;
begin
  Result := TParamParamsObject_sc(ConvClsFromVar(AClass, TParamParamsObject));
end;

{ TParamStreamObject_sw }

function TParamStreamObject_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create(Stream: TStream; AKnownSize: Integer; ...

  Result := TParamStreamObject_sw.ToVar(TParamStreamObject_sc(AObj).Create(
    TStream_sw.FromVar(AArgs[0]), Integer(AArgs[1]), Boolean(AArgs[2]), Boolean(
    AArgs[3])));
end;

function TParamStreamObject_Stream_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Stream: TStream read <getter>;

  Result := TStream_sw.ToVar(TParamStreamObject(AObj).Stream);
end;
...
begin
  ...
  AData.AddProperty('Stream', TParamStreamObject_Stream_si, TStream_sw, True, False, 0, False, False);

  { Class members }

  AData.AddConstructor('Create', TParamStreamObject_Create_si, 4, False);
end;
...
begin
  ...
  AData.AddProperty('NestedDataSets', TDataSet_NestedDataSets_si, TList_sw, True, False, 0, True, False);
...
function DB_TParamDataSetObject_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TParamDataSetObject = class(TParamObject);

  Result := TLMDUnitWrapper.TypeToVar(TParamDataSetObject_sw);
end;

function DB_TParamParamsObject_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TParamParamsObject = class(TParamObject);

  Result := TLMDUnitWrapper.TypeToVar(TParamParamsObject_sw);
end;
...
function DB_TWideDataSet_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TWideDataSet = class(TDataSet);
...
begin
  ...
  v_1 := Integer(AArgs[1]);
  Result := DB.ExtractFieldName(string(AArgs[0]), v_1);
...
begin
  ...
  case AArgsSize of
    1:
    begin
      DB.DatabaseError(string(AArgs[0]));
    end;
    2:
    begin
...
begin
  ...
  AData.AddType(TParamDataSetObject_sw, DB_TParamDataSetObject_si);
  AData.AddType(TParamParamsObject_sw, DB_TParamParamsObject_si);
  ...
  AData.AddConstant('dsMaxStringSize', DB_dsMaxStringSize_si, nil, VarType(DB.dsMaxStringSize));
...
initialization
  ...
  RegisterClassWrapper(TParamDataSetObject_sw);
  RegisterClassWrapper(TParamParamsObject_sw);
