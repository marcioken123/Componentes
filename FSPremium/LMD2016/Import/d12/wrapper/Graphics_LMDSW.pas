...
begin
  ...
  case AArgsSize of
    3:
    begin
      TCanvas(AObj).Draw(Integer(AArgs[0]), Integer(AArgs[1]), TGraphic_sw.
        FromVar(AArgs[2]));
    end;
    4:
    begin
      TCanvas(AObj).Draw(Integer(AArgs[0]), Integer(AArgs[1]), TGraphic_sw.
        FromVar(AArgs[2]), Byte(AArgs[3]));
    end;
  else
...
begin
  ...
  case AArgsSize of
    ...
    3:
    begin
      TCanvas(AObj).RoundRect(TRect_sw.FromVar(AArgs[0]), Integer(AArgs[1]), 
        Integer(AArgs[2]));
    end;
  else
...
begin
  ...
  case AArgsSize of
    ...
    begin
      v_1 := TRect_sw.FromVar(AArgs[0]);
      v_2 := string(AArgs[1]);
      TCanvas(AObj).TextRect(v_1, v_2, TTextFormat_sw.FromVar(AArgs[2]));
      AssignRefParam(AArgs[0], TRect_sw.ToVar(v_1));
      AssignRefParam(AArgs[1], v_2);
    end;
    4:
    begin
      TCanvas(AObj).TextRect(TRect_sw.FromVar(AArgs[0]), Integer(AArgs[1]), 
        Integer(AArgs[2]), string(AArgs[3]));
    end;
  else
...
begin
  ...
  AData.AddProcedure('Draw', TCanvas_Draw_si, 3, True);
  ...
  AData.AddProcedure('RoundRect', TCanvas_RoundRect_si, 3, True);
  ...
  AData.AddProcedure('TextRect', TCanvas_TextRect_si, 2, True);
