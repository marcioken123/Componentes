...
uses
  ...
  LMDSctSysWrappers, Types, Messages, Windows, SysUtils, Classes, Controls,
  Forms, Menus, Graphics, CommCtrl, ImgList, StdCtrls, Messages_LMDSW,
  Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW, Controls_LMDSW, Forms_LMDSW,
  Menus_LMDSW, Graphics_LMDSW, CommCtrl_LMDSW, ImgList_LMDSW;
