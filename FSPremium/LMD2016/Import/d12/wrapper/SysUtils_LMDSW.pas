...
uses
  ...
  LMDSctWrappers, LMDSctSysWrappers, Types, Windows, SysConst, Windows_LMDSW,
  SysConst_LMDSW;
...
begin
  ...
  if IsGet then
    Result := Ord(SysUtils.ThousandSeparator)
  else
...
begin
  ...
  if IsGet then
    Result := Ord(SysUtils.DecimalSeparator)
  else
...
begin
  ...
  if IsGet then
    Result := Ord(SysUtils.DateSeparator)
  else
...
begin
  ...
  if IsGet then
    Result := Ord(SysUtils.TimeSeparator)
  else
...
begin
  ...
  if IsGet then
    Result := Ord(SysUtils.ListSeparator)
  else
...
begin
  ...
  Result := Ord(SysUtils.GetLocaleChar(Integer(AArgs[0]), Integer(AArgs[1]), 
    Char(Integer(AArgs[2]))));
end;
