...
uses
  ...
  LMDSctSysWrappers, Types, SysUtils, Types_LMDSW, SysUtils_LMDSW;
...
begin
  ...
  case AArgsSize of
    2:
    begin
      Result := Variants.VarIsError(Variant(FindVarData(AArgs[0])^), v_1);
      AssignRefParam(AArgs[1], HRESULT_sw.ToVar(v_1));
    end;
    1:
    begin
      Result := Variants.VarIsError(Variant(FindVarData(AArgs[0])^));
    end;
  else
...
begin
  ...
  Result := Variants.VarAsError(HRESULT_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  case AArgsSize of
    ...
    2:
    begin
      Variants.VarCastError(TVarType_sw.FromVar(AArgs[0]), TVarType_sw.FromVar(
        AArgs[1]));
    end;
  else
...
begin
  ...
  Variants.VarOverflowError(TVarType_sw.FromVar(AArgs[0]), TVarType_sw.FromVar(
    AArgs[1]));
end;
...
begin
  ...
  Variants.VarRangeCheckError(TVarType_sw.FromVar(AArgs[0]), TVarType_sw.
    FromVar(AArgs[1]));
end;
...
begin
  ...
  case AArgsSize of
    1:
    begin
      Variants.VarResultCheck(HRESULT_sw.FromVar(AArgs[0]));
    end;
    3:
    begin
      Variants.VarResultCheck(HRESULT_sw.FromVar(AArgs[0]), TVarType_sw.FromVar(
        AArgs[1]), TVarType_sw.FromVar(AArgs[2]));
    end;
  else
...
begin
  ...
  Variants.HandleConversionException(TVarType_sw.FromVar(AArgs[0]), TVarType_sw.
    FromVar(AArgs[1]));
end;
...
begin
  ...
  Result := Variants.VarTypeAsText(TVarType_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  if IsGet then
    Result := TNullCompareRule_sw.ToVar(Variants.NullEqualityRule)
  else
    Variants.NullEqualityRule := TNullCompareRule_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TNullCompareRule_sw.ToVar(Variants.NullMagnitudeRule)
  else
    Variants.NullMagnitudeRule := TNullCompareRule_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := Variants.NullStrictConvert
  else
    Variants.NullStrictConvert := Boolean(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := Variants.NullAsStringValue
  else
    Variants.NullAsStringValue := string(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := Variants.PackVarCreation
  else
    Variants.PackVarCreation := Boolean(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TBooleanToStringRule_sw.ToVar(Variants.BooleanToStringRule)
  else
    Variants.BooleanToStringRule := TBooleanToStringRule_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := Variants.OleVariantInt64AsDouble
  else
    Variants.OleVariantInt64AsDouble := Boolean(AArgs[0]);
end;
