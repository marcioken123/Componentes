...
uses
  ...
  LMDSctSysWrappers, Messages, Windows, SysUtils, CommCtrl, Classes, Forms,
  Controls, Menus, Graphics, StdCtrls, RichEdit, ToolWin, ImgList, ExtCtrls,
  ListActns, GraphUtil, ComCtrls, Messages_LMDSW, Windows_LMDSW,
  SysUtils_LMDSW, CommCtrl_LMDSW, Classes_LMDSW, Forms_LMDSW, Controls_LMDSW,
