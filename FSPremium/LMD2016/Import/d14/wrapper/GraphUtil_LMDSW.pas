...
uses
  ...
  LMDSctSysWrappers, Classes, GraphUtil, Classes_LMDSW;
...
begin
  AData.AddConstant('WebNamedColorsCount', GraphUtil_WebNamedColorsCount_si, nil, VarType(GraphUtil.WebNamedColorsCount));
