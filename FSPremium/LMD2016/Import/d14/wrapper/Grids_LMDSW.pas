...
uses
  ...
  Messages, Windows, SysUtils, Classes, Variants, Types, Graphics, Menus,
  Controls, Forms, StdCtrls, Mask, Grids, Messages_LMDSW, Windows_LMDSW,
  SysUtils_LMDSW, Classes_LMDSW, Variants_LMDSW, Types_LMDSW, Graphics_LMDSW,
  Menus_LMDSW, Controls_LMDSW, Forms_LMDSW, StdCtrls_LMDSW, Mask_LMDSW;
