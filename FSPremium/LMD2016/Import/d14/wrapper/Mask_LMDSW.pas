...
uses
  ...
  LMDSctSysWrappers, Windows, Messages, SysUtils, Classes, MaskUtils, Controls,
  StdCtrls, Forms, Graphics, Menus, Mask, Windows_LMDSW, Messages_LMDSW,
  SysUtils_LMDSW, Classes_LMDSW, MaskUtils_LMDSW, Controls_LMDSW,
  StdCtrls_LMDSW, Forms_LMDSW, Graphics_LMDSW, Menus_LMDSW;
