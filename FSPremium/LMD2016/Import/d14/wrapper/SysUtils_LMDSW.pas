...
begin
  ...
  if IsGet then
    Result := TStringBuilder(AObj).Chars[Integer(AArgs[0])]
  else
...
begin
  ...
  AData.AddClassFunction('GetEncoding', TEncoding_GetEncoding_si, TEncoding_sw, 1, False);
...
begin
  ...
  if IsGet then
    Result := SysUtils.EmptyAnsiStr
  else
    SysUtils.EmptyAnsiStr := AnsiString(AArgs[0]);
end;
...
begin
  ...
  SysUtils.AppendStr(v_1, AnsiString(AArgs[1]));
...
begin
  ...
  case AArgsSize of
    ...
    2:
    begin
      Result := SysUtils.UpperCase(string(AArgs[0]), TLocaleOptions_sw.FromVar(
        AArgs[1]));
    end;
  else
...
begin
  ...
  case AArgsSize of
    ...
    2:
    begin
      Result := SysUtils.LowerCase(string(AArgs[0]), TLocaleOptions_sw.FromVar(
        AArgs[1]));
    end;
  else
...
begin
  ...
  Result := SysUtils.UIntToStr(UInt64_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  case AArgsSize of
    ...
    3:
    begin
      Result := SysUtils.FileCreate(string(AArgs[0]), LongWord(AArgs[1]), 
        Integer(AArgs[2]));
    end;
  else
...
begin
  ...
  case AArgsSize of
    ...
    2:
    begin
      Result := SysUtils.FileAge(string(AArgs[0]), v_1);
...
begin
  ...
  Result := SysUtils.IsAssembly(string(AArgs[0]));
end;
...
begin
  ...
  Result := SysUtils.ChangeFilePath(string(AArgs[0]), string(AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.SysErrorMessage(Cardinal(AArgs[0]));
end;
...
begin
  ...
  Result := TMbcsByteType_sw.ToVar(SysUtils.ByteType(UnicodeString(AArgs[0]), 
    Integer(AArgs[1])));
end;
...
begin
  ...
  Result := SysUtils.ByteToCharLen(UnicodeString(AArgs[0]), Integer(AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.ElementToCharLen(UnicodeString(AArgs[0]), Integer(
    AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.CharToByteLen(UnicodeString(AArgs[0]), Integer(AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.CharToElementLen(UnicodeString(AArgs[0]), Integer(
    AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.ByteToCharIndex(UnicodeString(AArgs[0]), Integer(
    AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.ElementToCharIndex(UnicodeString(AArgs[0]), Integer(
    AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.CharToByteIndex(UnicodeString(AArgs[0]), Integer(
    AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.CharToElementIndex(UnicodeString(AArgs[0]), Integer(
    AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.CharLength(UnicodeString(AArgs[0]), Integer(AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.NextCharIndex(UnicodeString(AArgs[0]), Integer(AArgs[1]));
end;
...
begin
  ...
  Result := SysUtils.IsLeadChar(WideChar(Integer(AArgs[0])));
end;
...
begin
  ...
  Result := SysUtils.CharInSet(WideChar(Integer(AArgs[0])), TSysCharSet_sw.
    FromVar(AArgs[1]));
end;
...
begin
  ...
  case AArgsSize of
    2:
    begin
      Result := SysUtils.FindDelimiter(string(AArgs[0]), string(AArgs[1]));
    end;
    3:
    begin
      Result := SysUtils.FindDelimiter(string(AArgs[0]), string(AArgs[1]), 
...
begin
  ...
  case AArgsSize of
    ...
    1:
    begin
      SysUtils.RaiseLastOSError(Integer(AArgs[0]));
    end;
  else
...
begin
  ...
  Result := SysUtils.ByteLength(string(AArgs[0]));
end;
...
begin
  ...
  Result := SysUtils.GetDefaultFallbackLanguages();
end;
...
begin
  ...
  SysUtils.SetDefaultFallbackLanguages(string(AArgs[0]));
end;
...
begin
  ...
  Result := SysUtils.PreferredUILanguages();
end;
...
begin
  ...
  Result := SysUtils.LocaleFileExists(string(AArgs[0]));
end;
...
begin
  ...
  Result := SysUtils.GetLocaleFile(string(AArgs[0]));
end;
...
begin
  ...
  Result := SysUtils.LocaleDirectoryExists(string(AArgs[0]));
end;
...
begin
  ...
  Result := SysUtils.GetLocaleDirectory(string(AArgs[0]));
end;
...
begin
  ...
  AData.AddConstant('faNormal', SysUtils_faNormal_si, nil, VarType(SysUtils.faNormal));
  AData.AddConstant('faTemporary', SysUtils_faTemporary_si, nil, VarType(SysUtils.faTemporary));
  ...
  AData.AddConstant('SecsPerHour', SysUtils_SecsPerHour_si, nil, VarType(SysUtils.SecsPerHour));
  ...
  AData.AddFunction('AnsiCompareFileName', SysUtils_AnsiCompareFileName_si, nil, 2, False);
  ...
  AData.AddConstant('pfConsumerMask', SysUtils_pfConsumerMask_si, nil, VarType(SysUtils.pfConsumerMask));
  AData.AddConstant('pfConsumerCompat', SysUtils_pfConsumerCompat_si, nil, VarType(SysUtils.pfConsumerCompat));
  AData.AddConstant('pfConsumerDelphi', SysUtils_pfConsumerDelphi_si, nil, VarType(SysUtils.pfConsumerDelphi));
  AData.AddConstant('pfConsumerBCB', SysUtils_pfConsumerBCB_si, nil, VarType(SysUtils.pfConsumerBCB));
