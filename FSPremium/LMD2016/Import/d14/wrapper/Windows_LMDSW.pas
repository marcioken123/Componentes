...
begin
  ...
  if IsGet then
    Result := UINT_sw.ToVar(tagNMHDR_sw(AObj).FValue.idFrom)
  else
    tagNMHDR_sw(AObj).FValue.idFrom := UINT_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('idFrom', tagNMHDR_idFrom_si, UINT_sw);
