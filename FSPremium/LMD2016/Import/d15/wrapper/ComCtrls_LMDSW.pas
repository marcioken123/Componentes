...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'ComCtrls' unit.
  #
  # WARNING:
...
uses
  ...
  LMDSctSysWrappers, Types, Messages, Windows, SysUtils, CommCtrl, Classes,
  Controls, Forms, Menus, Graphics, StdCtrls, RichEdit, ToolWin, ImgList,
  ExtCtrls, ListActns, GraphUtil, ComCtrls, Messages_LMDSW, Windows_LMDSW,
  SysUtils_LMDSW, CommCtrl_LMDSW, Classes_LMDSW, Controls_LMDSW, Forms_LMDSW,
  Menus_LMDSW, Graphics_LMDSW, StdCtrls_LMDSW, RichEdit_LMDSW, ToolWin_LMDSW,
  ImgList_LMDSW, ExtCtrls_LMDSW, ListActns_LMDSW, GraphUtil_LMDSW;
...
class function THitTest_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(THitTest);
end;
...
class function TTabPosition_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTabPosition);
end;
...
class function TTabStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTabStyle);
end;
...
begin
  ...
  AData.AddProperty('DisplayRect', TCustomTabControl_DisplayRect_si, TRect_sw, True, False, 0, True);
  AData.AddProperty('HotTrack', TCustomTabControl_HotTrack_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Images', TCustomTabControl_Images_si, TCustomImageList_sw, True, True, 0, True);
  AData.AddProperty('MultiLine', TCustomTabControl_MultiLine_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('MultiSelect', TCustomTabControl_MultiSelect_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('OwnerDraw', TCustomTabControl_OwnerDraw_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('RaggedRight', TCustomTabControl_RaggedRight_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ScrollOpposite', TCustomTabControl_ScrollOpposite_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Style', TCustomTabControl_Style_si, TTabStyle_sw, True, True, 0, True);
  AData.AddProperty('TabHeight', TCustomTabControl_TabHeight_si, Smallint_sw, True, True, 0, True);
  AData.AddProperty('TabIndex', TCustomTabControl_TabIndex_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('TabPosition', TCustomTabControl_TabPosition_si, TTabPosition_sw, True, True, 0, True);
  AData.AddProperty('Tabs', TCustomTabControl_Tabs_si, TStrings_sw, True, True, 0, True);
  AData.AddProperty('TabWidth', TCustomTabControl_TabWidth_si, Smallint_sw, True, True, 0, True);
  AData.AddProperty('OnChange', TCustomTabControl_OnChange_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnChanging', TCustomTabControl_OnChanging_si, TTabChangingEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDrawTab', TCustomTabControl_OnDrawTab_si, TDrawTabEvent_sw, True, True, 0, True);
  AData.AddProperty('OnGetImageIndex', TCustomTabControl_OnGetImageIndex_si, TTabGetImageEvent_sw, True, True, 0, True);
  ...
  AData.AddProperty('Canvas', TCustomTabControl_Canvas_si, TCanvas_sw, True, False, 0, False);
...
begin
  ...
  AData.AddPropertyRedecl('DisplayRect');
  ...
  AData.AddPropertyRedecl('DockSite');
  AData.AddPropertyRedecl('DoubleBuffered');
  ...
  AData.AddPropertyRedecl('HotTrack');
  AData.AddPropertyRedecl('Images');
  AData.AddPropertyRedecl('MultiLine');
  AData.AddPropertyRedecl('MultiSelect');
  AData.AddPropertyRedecl('OwnerDraw');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('RaggedRight');
  AData.AddPropertyRedecl('ScrollOpposite');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('Style');
  AData.AddPropertyRedecl('TabHeight');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabPosition');
  AData.AddPropertyRedecl('Tabs');
  AData.AddPropertyRedecl('TabIndex');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('TabWidth');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnChange');
  AData.AddPropertyRedecl('OnChanging');
  ...
  AData.AddPropertyRedecl('OnDrawTab');
  ...
  AData.AddPropertyRedecl('OnGetImageIndex');
...
begin
  ...
  AData.AddProperty('PageControl', TTabSheet_PageControl_si, TPageControl_sw, True, True, 0, False);
  AData.AddProperty('TabIndex', TTabSheet_TabIndex_si, Integer_sw, True, False, 0, False);
  AData.AddPropertyRedecl('BorderWidth');
  AData.AddPropertyRedecl('Caption');
  AData.AddPropertyRedecl('DoubleBuffered');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('Height');
  AData.AddProperty('Highlighted', TTabSheet_Highlighted_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ImageIndex', TTabSheet_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Left');
  AData.AddPropertyRedecl('Constraints');
  AData.AddProperty('PageIndex', TTabSheet_PageIndex_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('TabVisible', TTabSheet_TabVisible_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Top');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('Width');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddPropertyRedecl('OnEndDrag');
  AData.AddPropertyRedecl('OnEnter');
  AData.AddPropertyRedecl('OnExit');
  AData.AddProperty('OnHide', TTabSheet_OnHide_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnMouseActivate');
  AData.AddPropertyRedecl('OnMouseDown');
  AData.AddPropertyRedecl('OnMouseEnter');
  AData.AddPropertyRedecl('OnMouseLeave');
  ...
  AData.AddPropertyRedecl('OnMouseUp');
  AData.AddPropertyRedecl('OnResize');
  AData.AddProperty('OnShow', TTabSheet_OnShow_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnStartDrag');
end;
...
begin
  ...
  AData.AddProcedure('SelectNextPage', TPageControl_SelectNextPage_si, 2, False);
  AData.AddProperty('ActivePageIndex', TPageControl_ActivePageIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('PageCount', TPageControl_PageCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Pages', TPageControl_Pages_si, TTabSheet_sw, True, False, 1, False);
  AData.AddProperty('ActivePage', TPageControl_ActivePage_si, TTabSheet_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('Constraints');
...
class function TStatusPanelStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TStatusPanelStyle);
end;
...
class function TStatusPanelBevel_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TStatusPanelBevel);
end;
...
begin
  ...
  AData.AddProperty('Alignment', TStatusPanel_Alignment_si, TAlignment_sw, True, True, 0, False);
  AData.AddProperty('Bevel', TStatusPanel_Bevel_si, TStatusPanelBevel_sw, True, True, 0, False);
  AData.AddProperty('BiDiMode', TStatusPanel_BiDiMode_si, TBiDiMode_sw, True, True, 0, False);
  AData.AddProperty('ParentBiDiMode', TStatusPanel_ParentBiDiMode_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Style', TStatusPanel_Style_si, TStatusPanelStyle_sw, True, True, 0, False);
  AData.AddProperty('Text', TStatusPanel_Text_si, string_sw, True, True, 0, False);
  AData.AddProperty('Width', TStatusPanel_Width_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Items', TStatusPanels_Items_si, TStatusPanel_sw, True, True, 1, False);
...
begin
  ...
  AData.AddProperty('Canvas', TCustomStatusBar_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddProperty('AutoHint', TCustomStatusBar_AutoHint_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Panels', TCustomStatusBar_Panels_si, TStatusPanels_sw, True, True, 0, False);
  AData.AddProperty('SimplePanel', TCustomStatusBar_SimplePanel_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SimpleText', TCustomStatusBar_SimpleText_si, string_sw, True, True, 0, False);
  AData.AddProperty('SizeGrip', TCustomStatusBar_SizeGrip_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('UseSystemFont', TCustomStatusBar_UseSystemFont_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnCreatePanelClass', TCustomStatusBar_OnCreatePanelClass_si, TSBCreatePanelClassEvent_sw, True, True, 0, False);
  AData.AddProperty('OnHint', TCustomStatusBar_OnHint_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnDrawPanel', TCustomStatusBar_OnDrawPanel_si, TCustomDrawPanelEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('AutoHint');
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('BorderWidth');
  ...
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Panels');
  AData.AddPropertyRedecl('ParentBiDiMode');
  ...
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('SimplePanel');
  AData.AddPropertyRedecl('SimpleText');
  AData.AddPropertyRedecl('SizeGrip');
  AData.AddPropertyRedecl('UseSystemFont');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnCreatePanelClass');
  ...
  AData.AddPropertyRedecl('OnMouseMove');
  AData.AddPropertyRedecl('OnMouseUp');
  AData.AddProperty('OnDrawPanel', TStatusBar_OnDrawPanel_si, TDrawPanelEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnResize');
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnStartDrag');
end;
...
class function TCustomDrawTarget_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCustomDrawTarget);
end;
...
class function TCustomDrawStage_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCustomDrawStage);
end;
...
class function THeaderSectionStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(THeaderSectionStyle);
end;
...
begin
  ...
  AData.AddProperty('Left', THeaderSection_Left_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Right', THeaderSection_Right_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Alignment', THeaderSection_Alignment_si, TAlignment_sw, True, True, 0, False);
  AData.AddProperty('AllowClick', THeaderSection_AllowClick_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AutoSize', THeaderSection_AutoSize_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('BiDiMode', THeaderSection_BiDiMode_si, TBiDiMode_sw, True, True, 0, False);
  AData.AddProperty('CheckBox', THeaderSection_CheckBox_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Checked', THeaderSection_Checked_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('FixedWidth', THeaderSection_FixedWidth_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ImageIndex', THeaderSection_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('MaxWidth', THeaderSection_MaxWidth_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('MinWidth', THeaderSection_MinWidth_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ParentBiDiMode', THeaderSection_ParentBiDiMode_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Style', THeaderSection_Style_si, THeaderSectionStyle_sw, True, True, 0, False);
  AData.AddProperty('Text', THeaderSection_Text_si, string_sw, True, True, 0, False);
  AData.AddProperty('Width', THeaderSection_Width_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Items', THeaderSections_Items_si, THeaderSection_sw, True, True, 1, False);
...
class function TSectionTrackState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TSectionTrackState);
end;
...
class function THeaderStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(THeaderStyle);
end;
...
begin
  ...
  AData.AddProperty('Canvas', TCustomHeaderControl_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('BorderWidth');
  ...
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddProperty('DragReorder', TCustomHeaderControl_DragReorder_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('FullDrag', TCustomHeaderControl_FullDrag_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('HotTrack', TCustomHeaderControl_HotTrack_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddProperty('Images', TCustomHeaderControl_Images_si, TCustomImageList_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Constraints');
  AData.AddProperty('Sections', TCustomHeaderControl_Sections_si, THeaderSections_sw, True, True, 0, False);
  AData.AddProperty('Style', TCustomHeaderControl_Style_si, THeaderStyle_sw, True, True, 0, False);
  AData.AddProperty('OnCreateSectionClass', TCustomHeaderControl_OnCreateSectionClass_si, TCustomHCCreateSectionClassEvent_sw, True, True, 0, False);
  AData.AddProperty('OnDrawSection', TCustomHeaderControl_OnDrawSection_si, TCustomDrawSectionEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSectionClick', TCustomHeaderControl_OnSectionClick_si, TCustomSectionNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSectionCheck', TCustomHeaderControl_OnSectionCheck_si, TCustomSectionNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSectionDrag', TCustomHeaderControl_OnSectionDrag_si, TSectionDragEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSectionEndDrag', TCustomHeaderControl_OnSectionEndDrag_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSectionResize', TCustomHeaderControl_OnSectionResize_si, TCustomSectionNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSectionTrack', TCustomHeaderControl_OnSectionTrack_si, TCustomSectionTrackEvent_sw, True, True, 0, False);
  AData.AddProperty('CheckBoxes', TCustomHeaderControl_CheckBoxes_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('NoSizing', TCustomHeaderControl_NoSizing_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OverFlow', TCustomHeaderControl_OverFlow_si, Boolean_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('DragReorder');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('FullDrag');
  AData.AddPropertyRedecl('HotTrack');
  AData.AddPropertyRedecl('Images');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Sections');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('Style');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  ...
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnCreateSectionClass');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddPropertyRedecl('OnEndDock');
  AData.AddPropertyRedecl('OnEndDrag');
  ...
  AData.AddPropertyRedecl('OnMouseUp');
  AData.AddPropertyRedecl('OnResize');
  AData.AddProperty('OnDrawSection', THeaderControl_OnDrawSection_si, TDrawSectionEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSectionClick', THeaderControl_OnSectionClick_si, TSectionNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSectionResize', THeaderControl_OnSectionResize_si, TSectionNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnSectionTrack', THeaderControl_OnSectionTrack_si, TSectionTrackEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnSectionDrag');
  AData.AddPropertyRedecl('OnSectionEndDrag');
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnStartDrag');
end;
...
class function TNodeState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TNodeState);
end;
...
class function TNodeAttachMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TNodeAttachMode);
end;
...
class function TAddMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TAddMode);
end;
...
begin
  ...
  AData.AddFunction('Copy', TNodeInfo_Copy_si, TNodeInfo_sw, 0);
  ...
  AData.AddConstructor('Create', TNodeInfo_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TNodeDataInfo_Copy_si, TNodeDataInfo_sw, 0);
  ...
  AData.AddConstructor('Create', TNodeDataInfo_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TNodeDataInfo2_Copy_si, TNodeDataInfo2_sw, 0);
  ...
  AData.AddConstructor('Create', TNodeDataInfo2_Create_si, 0);
end;
...
class function TNodeDataType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TNodeDataType);
end;
...
class function TTVItemStateEx_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTVItemStateEx);
end;
...
begin
  ...
  AData.AddFunction('AlphaSort', TTreeNode_AlphaSort_si, Boolean_sw, 1, False);
  ...
  AData.AddProperty('AbsoluteIndex', TTreeNode_AbsoluteIndex_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Count', TTreeNode_Count_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Cut', TTreeNode_Cut_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Deleting', TTreeNode_Deleting_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Focused', TTreeNode_Focused_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DropTarget', TTreeNode_DropTarget_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Selected', TTreeNode_Selected_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Expanded', TTreeNode_Expanded_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ExpandedImageIndex', TTreeNode_ExpandedImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('Handle', TTreeNode_Handle_si, HWND_sw, True, False, 0, False);
  AData.AddProperty('HasChildren', TTreeNode_HasChildren_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ImageIndex', TTreeNode_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('Index', TTreeNode_Index_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('IsVisible', TTreeNode_IsVisible_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('Item', TTreeNode_Item_si, TTreeNode_sw, True, True, 1, False);
  AData.AddProperty('Level', TTreeNode_Level_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('OverlayIndex', TTreeNode_OverlayIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Owner', TTreeNode_Owner_si, TTreeNodes_sw, True, False, 0, False);
  AData.AddProperty('Parent', TTreeNode_Parent_si, TTreeNode_sw, True, False, 0, False);
  AData.AddProperty('SelectedIndex', TTreeNode_SelectedIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Enabled', TTreeNode_Enabled_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('StateIndex', TTreeNode_StateIndex_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Text', TTreeNode_Text_si, string_sw, True, True, 0, False);
  AData.AddProperty('TreeView', TTreeNode_TreeView_si, TCustomTreeView_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('Current', TTreeNodesEnumerator_Current_si, TTreeNode_sw, True, False, 0, False);
...
begin
  ...
  AData.AddFunction('Copy', TNodeCache_Copy_si, TNodeCache_sw, 0);
  ...
  AData.AddConstructor('Create', TNodeCache_Create_si, 0);
end;
...
begin
  ...
  AData.AddProperty('Reading', TTreeNodes_Reading_si, Boolean_sw, True, False, 0, True);
  ...
  AData.AddFunction('AlphaSort', TTreeNodes_AlphaSort_si, Boolean_sw, 1, False);
  ...
  AData.AddProperty('Count', TTreeNodes_Count_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Handle', TTreeNodes_Handle_si, HWND_sw, True, False, 0, False);
  AData.AddProperty('Item', TTreeNodes_Item_si, TTreeNode_sw, True, False, 1, False);
  AData.AddProperty('Owner', TTreeNodes_Owner_si, TCustomTreeView_sw, True, False, 0, False);
...
class function TSortType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TSortType);
end;
...
class function TMultiSelectStyles_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TMultiSelectStyles);
end;
...
begin
  ...
  AData.AddProperty('AutoExpand', TCustomTreeView_AutoExpand_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('BorderStyle', TCustomTreeView_BorderStyle_si, TBorderStyle_sw, True, True, 0, True);
  AData.AddProperty('ChangeDelay', TCustomTreeView_ChangeDelay_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('CreateWndRestores', TCustomTreeView_CreateWndRestores_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('HideSelection', TCustomTreeView_HideSelection_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('HotTrack', TCustomTreeView_HotTrack_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Images', TCustomTreeView_Images_si, TCustomImageList_sw, True, True, 0, True);
  AData.AddProperty('Indent', TCustomTreeView_Indent_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('Items', TCustomTreeView_Items_si, TTreeNodes_sw, True, True, 0, True);
  AData.AddProperty('MultiSelect', TCustomTreeView_MultiSelect_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('MultiSelectStyle', TCustomTreeView_MultiSelectStyle_si, TMultiSelectStyle_sw, True, True, 0, True);
  AData.AddProperty('ReadOnly', TCustomTreeView_ReadOnly_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('RightClickSelect', TCustomTreeView_RightClickSelect_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('RowSelect', TCustomTreeView_RowSelect_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ShowButtons', TCustomTreeView_ShowButtons_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ShowLines', TCustomTreeView_ShowLines_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ShowRoot', TCustomTreeView_ShowRoot_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('SortType', TCustomTreeView_SortType_si, TSortType_sw, True, True, 0, True);
  AData.AddProperty('StateImages', TCustomTreeView_StateImages_si, TCustomImageList_sw, True, True, 0, True);
  AData.AddProperty('ToolTips', TCustomTreeView_ToolTips_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('OnAddition', TCustomTreeView_OnAddition_si, TTVExpandedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnAdvancedCustomDraw', TCustomTreeView_OnAdvancedCustomDraw_si, TTVAdvancedCustomDrawEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCancelEdit', TCustomTreeView_OnCancelEdit_si, TTVChangedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnChange', TCustomTreeView_OnChange_si, TTVChangedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnChanging', TCustomTreeView_OnChanging_si, TTVChangingEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCollapsed', TCustomTreeView_OnCollapsed_si, TTVExpandedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCollapsing', TCustomTreeView_OnCollapsing_si, TTVCollapsingEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCompare', TCustomTreeView_OnCompare_si, TTVCompareEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCustomDraw', TCustomTreeView_OnCustomDraw_si, TTVCustomDrawEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDeletion', TCustomTreeView_OnDeletion_si, TTVExpandedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnEditing', TCustomTreeView_OnEditing_si, TTVEditingEvent_sw, True, True, 0, True);
  AData.AddProperty('OnEdited', TCustomTreeView_OnEdited_si, TTVEditedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnExpanding', TCustomTreeView_OnExpanding_si, TTVExpandingEvent_sw, True, True, 0, True);
  AData.AddProperty('OnExpanded', TCustomTreeView_OnExpanded_si, TTVExpandedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnGetImageIndex', TCustomTreeView_OnGetImageIndex_si, TTVExpandedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnGetSelectedIndex', TCustomTreeView_OnGetSelectedIndex_si, TTVExpandedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCreateNodeClass', TCustomTreeView_OnCreateNodeClass_si, TTVCreateNodeClassEvent_sw, True, True, 0, True);
  AData.AddFunction('AlphaSort', TCustomTreeView_AlphaSort_si, Boolean_sw, 1, False);
  ...
  AData.AddProcedure('LoadFromFile', TCustomTreeView_LoadFromFile_si, 1, False);
  AData.AddProcedure('LoadFromStream', TCustomTreeView_LoadFromStream_si, 1, False);
  AData.AddProcedure('SaveToFile', TCustomTreeView_SaveToFile_si, 1, False);
  AData.AddProcedure('SaveToStream', TCustomTreeView_SaveToStream_si, 1, False);
  AData.AddProcedure('Deselect', TCustomTreeView_Deselect_si, 1, False);
  AData.AddProcedure('Subselect', TCustomTreeView_Subselect_si, 2, False);
  AData.AddProcedure('ClearSelection', TCustomTreeView_ClearSelection_si, 1, False);
  ...
  AData.AddProperty('Canvas', TCustomTreeView_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddProperty('DropTarget', TCustomTreeView_DropTarget_si, TTreeNode_sw, True, True, 0, False);
  AData.AddProperty('Selected', TCustomTreeView_Selected_si, TTreeNode_sw, True, True, 0, False);
  AData.AddProperty('TopItem', TCustomTreeView_TopItem_si, TTreeNode_sw, True, True, 0, False);
  AData.AddProperty('SelectionCount', TCustomTreeView_SelectionCount_si, Cardinal_sw, True, False, 0, False);
  AData.AddProperty('Selections', TCustomTreeView_Selections_si, TTreeNode_sw, True, False, 1, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoExpand');
  ...
  AData.AddPropertyRedecl('BorderWidth');
  AData.AddPropertyRedecl('ChangeDelay');
  AData.AddPropertyRedecl('Color');
  ...
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('HideSelection');
  AData.AddPropertyRedecl('HotTrack');
  AData.AddPropertyRedecl('Images');
  AData.AddPropertyRedecl('Indent');
  AData.AddPropertyRedecl('MultiSelect');
  AData.AddPropertyRedecl('MultiSelectStyle');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentColor');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('ReadOnly');
  AData.AddPropertyRedecl('RightClickSelect');
  AData.AddPropertyRedecl('RowSelect');
  AData.AddPropertyRedecl('ShowButtons');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('ShowLines');
  AData.AddPropertyRedecl('ShowRoot');
  AData.AddPropertyRedecl('SortType');
  AData.AddPropertyRedecl('StateImages');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('ToolTips');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnAddition');
  AData.AddPropertyRedecl('OnAdvancedCustomDraw');
  AData.AddPropertyRedecl('OnAdvancedCustomDrawItem');
  AData.AddPropertyRedecl('OnChange');
  AData.AddPropertyRedecl('OnChanging');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnCollapsed');
  AData.AddPropertyRedecl('OnCollapsing');
  AData.AddPropertyRedecl('OnCompare');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnCreateNodeClass');
  AData.AddPropertyRedecl('OnCustomDraw');
  AData.AddPropertyRedecl('OnCustomDrawItem');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDeletion');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddPropertyRedecl('OnEdited');
  AData.AddPropertyRedecl('OnEditing');
  AData.AddPropertyRedecl('OnEndDock');
  AData.AddPropertyRedecl('OnEndDrag');
  AData.AddPropertyRedecl('OnEnter');
  AData.AddPropertyRedecl('OnExit');
  AData.AddPropertyRedecl('OnExpanding');
  AData.AddPropertyRedecl('OnExpanded');
  AData.AddPropertyRedecl('OnGetImageIndex');
  AData.AddPropertyRedecl('OnGetSelectedIndex');
...
class function TTrackBarOrientation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTrackBarOrientation);
end;
...
class function TTickMark_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTickMark);
end;
...
class function TTickStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTickStyle);
end;
...
class function TPositionToolTip_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPositionToolTip);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Constraints');
  AData.AddProperty('LineSize', TTrackBar_LineSize_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Max', TTrackBar_Max_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Min', TTrackBar_Min_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Orientation', TTrackBar_Orientation_si, TTrackBarOrientation_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentCtl3D');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddProperty('PageSize', TTrackBar_PageSize_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('Frequency', TTrackBar_Frequency_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Position', TTrackBar_Position_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('PositionToolTip', TTrackBar_PositionToolTip_si, TPositionToolTip_sw, True, True, 0, False);
  AData.AddProperty('SliderVisible', TTrackBar_SliderVisible_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SelEnd', TTrackBar_SelEnd_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('SelStart', TTrackBar_SelStart_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('ShowSelRange', TTrackBar_ShowSelRange_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddProperty('ThumbLength', TTrackBar_ThumbLength_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('TickMarks', TTrackBar_TickMarks_si, TTickMark_sw, True, True, 0, False);
  AData.AddProperty('TickStyle', TTrackBar_TickStyle_si, TTickStyle_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddProperty('OnChange', TTrackBar_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddPropertyRedecl('OnEndDock');
  AData.AddPropertyRedecl('OnEndDrag');
...
class function TProgressBarOrientation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TProgressBarOrientation);
end;
...
class function TProgressBarStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TProgressBarStyle);
end;
...
class function TProgressBarState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TProgressBarState);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Constraints');
  AData.AddProperty('Min', TProgressBar_Min_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Max', TProgressBar_Max_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Orientation', TProgressBar_Orientation_si, TProgressBarOrientation_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('Position', TProgressBar_Position_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Smooth', TProgressBar_Smooth_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Style', TProgressBar_Style_si, TProgressBarStyle_sw, True, True, 0, False);
  AData.AddProperty('MarqueeInterval', TProgressBar_MarqueeInterval_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('BarColor', TProgressBar_BarColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('BackgroundColor', TProgressBar_BackgroundColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('SmoothReverse', TProgressBar_SmoothReverse_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Step', TProgressBar_Step_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('State', TProgressBar_State_si, TProgressBarState_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
...
class function TAttributeType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TAttributeType);
end;
...
class function TConsistentAttribute_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TConsistentAttribute);
end;
...
begin
  ...
  AData.AddProperty('Charset', TTextAttributes_Charset_si, TFontCharset_sw, True, True, 0, False);
  AData.AddProperty('Color', TTextAttributes_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('ConsistentAttributes', TTextAttributes_ConsistentAttributes_si, TConsistentAttributes_sw, True, False, 0, False);
  AData.AddProperty('Name', TTextAttributes_Name_si, TFontName_sw, True, True, 0, False);
  AData.AddProperty('Pitch', TTextAttributes_Pitch_si, TFontPitch_sw, True, True, 0, False);
  AData.AddProperty('Protected', TTextAttributes_Protected_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Size', TTextAttributes_Size_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Style', TTextAttributes_Style_si, TFontStyles_sw, True, True, 0, False);
  AData.AddProperty('Height', TTextAttributes_Height_si, Integer_sw, True, True, 0, False);
...
class function TNumberingStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TNumberingStyle);
end;
...
begin
  ...
  AData.AddProperty('Alignment', TParaAttributes_Alignment_si, TAlignment_sw, True, True, 0, False);
  AData.AddProperty('FirstIndent', TParaAttributes_FirstIndent_si, Longint_sw, True, True, 0, False);
  AData.AddProperty('LeftIndent', TParaAttributes_LeftIndent_si, Longint_sw, True, True, 0, False);
  AData.AddProperty('Numbering', TParaAttributes_Numbering_si, TNumberingStyle_sw, True, True, 0, False);
  AData.AddProperty('RightIndent', TParaAttributes_RightIndent_si, Longint_sw, True, True, 0, False);
  AData.AddProperty('Tab', TParaAttributes_Tab_si, Longint_sw, True, True, 1, False);
  AData.AddProperty('TabCount', TParaAttributes_TabCount_si, Integer_sw, True, True, 0, False);
...
class function TSearchType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TSearchType);
end;
...
begin
  ...
  AData.AddFunction('Copy', TConversionFormat_Copy_si, TConversionFormat_sw, 0);
  ...
  AData.AddConstructor('Create', TConversionFormat_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TRichEditStreamInfo_Copy_si, TRichEditStreamInfo_sw, 0);
  ...
  AData.AddConstructor('Create', TRichEditStreamInfo_Create_si, 0);
end;
...
begin
  ...
  AData.AddProperty('HideSelection', TCustomRichEdit_HideSelection_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('HideScrollBars', TCustomRichEdit_HideScrollBars_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Lines', TCustomRichEdit_Lines_si, TStrings_sw, True, True, 0, True);
  AData.AddProperty('OnSaveClipboard', TCustomRichEdit_OnSaveClipboard_si, TRichEditSaveClipboard_sw, True, True, 0, True);
  AData.AddProperty('OnSelectionChange', TCustomRichEdit_OnSelectionChange_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnProtectChange', TCustomRichEdit_OnProtectChange_si, TRichEditProtectChange_sw, True, True, 0, True);
  AData.AddProperty('OnResizeRequest', TCustomRichEdit_OnResizeRequest_si, TRichEditResizeEvent_sw, True, True, 0, True);
  AData.AddProperty('PlainText', TCustomRichEdit_PlainText_si, Boolean_sw, True, True, 0, True);
  ...
  AData.AddProperty('DefaultConverter', TCustomRichEdit_DefaultConverter_si, TConversionClass_sw, True, True, 0, False);
  AData.AddProperty('DefAttributes', TCustomRichEdit_DefAttributes_si, TTextAttributes_sw, True, True, 0, False);
  AData.AddProperty('SelAttributes', TCustomRichEdit_SelAttributes_si, TTextAttributes_sw, True, True, 0, False);
  AData.AddProperty('PageRect', TCustomRichEdit_PageRect_si, TRect_sw, True, True, 0, False);
  AData.AddProperty('Paragraph', TCustomRichEdit_Paragraph_si, TParaAttributes_sw, True, False, 0, False);
...
begin
  ...
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Alignment');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  AData.AddPropertyRedecl('BevelOuter');
  ...
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('HideSelection');
  AData.AddPropertyRedecl('HideScrollBars');
  AData.AddPropertyRedecl('ImeMode');
  AData.AddPropertyRedecl('ImeName');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Lines');
  AData.AddPropertyRedecl('MaxLength');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentCtl3D');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PlainText');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('ReadOnly');
  ...
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('WantTabs');
  AData.AddPropertyRedecl('WantReturns');
  AData.AddPropertyRedecl('WordWrap');
  AData.AddPropertyRedecl('OnChange');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDblClick');
  ...
  AData.AddPropertyRedecl('OnMouseMove');
  AData.AddPropertyRedecl('OnMouseUp');
  AData.AddPropertyRedecl('OnMouseWheel');
  AData.AddPropertyRedecl('OnMouseWheelDown');
  AData.AddPropertyRedecl('OnMouseWheelUp');
  AData.AddPropertyRedecl('OnProtectChange');
  AData.AddPropertyRedecl('OnResizeRequest');
  AData.AddPropertyRedecl('OnSaveClipboard');
  AData.AddPropertyRedecl('OnSelectionChange');
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnStartDrag');
end;
...
class function TUDAlignButton_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TUDAlignButton);
end;
...
class function TUDOrientation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TUDOrientation);
end;
...
class function TUDBtnType_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TUDBtnType);
end;
...
class function TUpDownDirection_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TUpDownDirection);
end;
...
function TCustomUpDown_Min_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Min: SmallInt read <getter> write <set...

  if IsGet then
    Result := TCustomUpDown_sacc(TCustomUpDown(AObj)).Min
  else
    TCustomUpDown_sacc(TCustomUpDown(AObj)).Min := SmallInt(AArgs[0]);
end;

function TCustomUpDown_Max_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Max: SmallInt read <getter> write <set...

  if IsGet then
    Result := TCustomUpDown_sacc(TCustomUpDown(AObj)).Max
  else
    TCustomUpDown_sacc(TCustomUpDown(AObj)).Max := SmallInt(AArgs[0]);
end;
...
function TCustomUpDown_Position_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Position: SmallInt read <getter> write...

  if IsGet then
    Result := TCustomUpDown_sacc(TCustomUpDown(AObj)).Position
  else
    TCustomUpDown_sacc(TCustomUpDown(AObj)).Position := SmallInt(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('AlignButton', TCustomUpDown_AlignButton_si, TUDAlignButton_sw, True, True, 0, True);
  AData.AddProperty('ArrowKeys', TCustomUpDown_ArrowKeys_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Associate', TCustomUpDown_Associate_si, TWinControl_sw, True, True, 0, True);
  AData.AddProperty('Min', TCustomUpDown_Min_si, SmallInt_sw, True, True, 0, True);
  AData.AddProperty('Max', TCustomUpDown_Max_si, SmallInt_sw, True, True, 0, True);
  AData.AddProperty('Increment', TCustomUpDown_Increment_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('Orientation', TCustomUpDown_Orientation_si, TUDOrientation_sw, True, True, 0, True);
  AData.AddProperty('Position', TCustomUpDown_Position_si, SmallInt_sw, True, True, 0, True);
  AData.AddProperty('Thousands', TCustomUpDown_Thousands_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Wrap', TCustomUpDown_Wrap_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('OnChanging', TCustomUpDown_OnChanging_si, TUDChangingEvent_sw, True, True, 0, True);
  AData.AddProperty('OnChangingEx', TCustomUpDown_OnChangingEx_si, TUDChangingEventEx_sw, True, True, 0, True);
  AData.AddProperty('OnClick', TCustomUpDown_OnClick_si, TUDClickEvent_sw, True, True, 0, True);
end;
...
begin
  ...
  AData.AddPropertyRedecl('AlignButton');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('Associate');
  AData.AddPropertyRedecl('ArrowKeys');
  AData.AddPropertyRedecl('DoubleBuffered');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Hint');
  AData.AddPropertyRedecl('Min');
  AData.AddPropertyRedecl('Max');
  AData.AddPropertyRedecl('Increment');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Orientation');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('Position');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Thousands');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('Wrap');
  AData.AddPropertyRedecl('OnChanging');
  AData.AddPropertyRedecl('OnChangingEx');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnEnter');
  AData.AddPropertyRedecl('OnExit');
...
class function THKModifier_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(THKModifier);
end;
...
class function THKInvalidKey_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(THKInvalidKey);
end;
...
begin
  ...
  AData.AddProperty('AutoSize', TCustomHotKey_AutoSize_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('InvalidKeys', TCustomHotKey_InvalidKeys_si, THKInvalidKeys_sw, True, True, 0, True);
  AData.AddProperty('Modifiers', TCustomHotKey_Modifiers_si, THKModifiers_sw, True, True, 0, True);
  AData.AddProperty('HotKey', TCustomHotKey_HotKey_si, TShortCut_sw, True, True, 0, True);
  AData.AddProperty('OnChange', TCustomHotKey_OnChange_si, TNotifyEvent_sw, True, True, 0, True);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('DoubleBuffered');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Hint');
  AData.AddPropertyRedecl('HotKey');
  AData.AddPropertyRedecl('InvalidKeys');
  AData.AddPropertyRedecl('Modifiers');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
...
class function TListGroupState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TListGroupState);
end;
...
begin
  ...
  AData.AddProperty('Header', TListGroup_Header_si, string_sw, True, True, 0, False);
  AData.AddProperty('Footer', TListGroup_Footer_si, string_sw, True, True, 0, False);
  AData.AddProperty('GroupID', TListGroup_GroupID_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('State', TListGroup_State_si, TListGroupStateSet_sw, True, True, 0, False);
  AData.AddProperty('HeaderAlign', TListGroup_HeaderAlign_si, TAlignment_sw, True, True, 0, False);
  AData.AddProperty('FooterAlign', TListGroup_FooterAlign_si, TAlignment_sw, True, True, 0, False);
  AData.AddProperty('Subtitle', TListGroup_Subtitle_si, string_sw, True, True, 0, False);
  AData.AddProperty('TitleImage', TListGroup_TitleImage_si, TImageIndex_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Items', TListGroups_Items_si, TListGroup_sw, True, True, 1, False);
  AData.AddProperty('NextGroupID', TListGroups_NextGroupID_si, Integer_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('WidthType', TListColumn_WidthType_si, TWidth_sw, True, False, 0, False);
  AData.AddProperty('Alignment', TListColumn_Alignment_si, TAlignment_sw, True, True, 0, False);
  AData.AddProperty('AutoSize', TListColumn_AutoSize_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Caption', TListColumn_Caption_si, string_sw, True, True, 0, False);
  AData.AddProperty('ImageIndex', TListColumn_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('MaxWidth', TListColumn_MaxWidth_si, TWidth_sw, True, True, 0, False);
  AData.AddProperty('MinWidth', TListColumn_MinWidth_si, TWidth_sw, True, True, 0, False);
  AData.AddProperty('Tag', TListColumn_Tag_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Width', TListColumn_Width_si, TWidth_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Items', TListColumns_Items_si, TListColumn_sw, True, True, 1, False);
...
class function TDisplayCode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDisplayCode);
end;
...
begin
  ...
  AData.AddProperty('Caption', TListItem_Caption_si, string_sw, True, True, 0, False);
  AData.AddProperty('Checked', TListItem_Checked_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Cut', TListItem_Cut_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Deleting', TListItem_Deleting_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('DropTarget', TListItem_DropTarget_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Focused', TListItem_Focused_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('GroupID', TListItem_GroupID_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Handle', TListItem_Handle_si, HWND_sw, True, False, 0, False);
  AData.AddProperty('ImageIndex', TListItem_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('Indent', TListItem_Indent_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Index', TListItem_Index_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Left', TListItem_Left_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ListView', TListItem_ListView_si, TCustomListView_sw, True, False, 0, False);
  AData.AddProperty('Owner', TListItem_Owner_si, TListItems_sw, True, False, 0, False);
  AData.AddProperty('OverlayIndex', TListItem_OverlayIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('Position', TListItem_Position_si, TPoint_sw, True, True, 0, False);
  AData.AddProperty('Selected', TListItem_Selected_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('StateIndex', TListItem_StateIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('SubItems', TListItem_SubItems_si, TStrings_sw, True, True, 0, False);
  AData.AddProperty('SubItemImages', TListItem_SubItemImages_si, Integer_sw, True, True, 1, False);
  AData.AddProperty('Top', TListItem_Top_si, Integer_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Current', TListItemsEnumerator_Current_si, TListItem_sw, True, False, 0, False);
...
begin
  ...
  Result := TListItem_sw.ToVar(TListItems(AObj).AddItem(TListItem_sw.FromVar(
    AArgs[0]), Integer(AArgs[1])));
end;
...
begin
  ...
  AData.AddFunction('AddItem', TListItems_AddItem_si, TListItem_sw, 2, False);
  ...
  AData.AddProperty('Count', TListItems_Count_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Handle', TListItems_Handle_si, HWND_sw, True, False, 0, False);
  AData.AddProperty('Item', TListItems_Item_si, TListItem_sw, True, True, 1, False);
  AData.AddProperty('Owner', TListItems_Owner_si, TCustomListView_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('Rect', TWorkArea_Rect_si, TRect_sw, True, True, 0, False);
  AData.AddProperty('Color', TWorkArea_Color_si, TColor_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Items', TWorkAreas_Items_si, TWorkArea_sw, True, True, 1, False);
end;
...
class function TIconArrangement_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TIconArrangement);
end;
...
begin
  ...
  AData.AddProperty('Arrangement', TIconOptions_Arrangement_si, TIconArrangement_sw, True, True, 0, False);
  AData.AddProperty('AutoArrange', TIconOptions_AutoArrange_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('WrapText', TIconOptions_WrapText_si, Boolean_sw, True, True, 0, False);
...
class function TListArrangement_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TListArrangement);
end;
...
class function TViewStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TViewStyle);
end;
...
class function TItemState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TItemState);
end;
...
class function TItemChange_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TItemChange);
end;
...
class function TItemFind_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TItemFind);
end;
...
class function TSearchDirection_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TSearchDirection);
end;
...
class function TListHotTrackStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TListHotTrackStyle);
end;
...
class function TItemRequests_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TItemRequests);
end;
...
begin
  ...
  AData.AddProperty('BorderStyle', TCustomListView_BorderStyle_si, TBorderStyle_sw, True, True, 0, True);
  AData.AddProperty('Groups', TCustomListView_Groups_si, TListGroups_sw, True, True, 0, True);
  AData.AddProperty('Columns', TCustomListView_Columns_si, TListColumns_sw, True, True, 0, True);
  AData.AddProperty('ColumnClick', TCustomListView_ColumnClick_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ReadOnly', TCustomListView_ReadOnly_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('HideSelection', TCustomListView_HideSelection_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('IconOptions', TCustomListView_IconOptions_si, TIconOptions_sw, True, True, 0, True);
  AData.AddProperty('AllocBy', TCustomListView_AllocBy_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('GroupView', TCustomListView_GroupView_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('HoverTime', TCustomListView_HoverTime_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('LargeImages', TCustomListView_LargeImages_si, TCustomImageList_sw, True, True, 0, True);
  AData.AddProperty('GroupHeaderImages', TCustomListView_GroupHeaderImages_si, TCustomImageList_sw, True, True, 0, True);
  AData.AddProperty('MultiSelect', TCustomListView_MultiSelect_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('OwnerData', TCustomListView_OwnerData_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('OwnerDraw', TCustomListView_OwnerDraw_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('OnAdvancedCustomDraw', TCustomListView_OnAdvancedCustomDraw_si, TLVAdvancedCustomDrawEvent_sw, True, True, 0, True);
  AData.AddProperty('OnChange', TCustomListView_OnChange_si, TLVChangeEvent_sw, True, True, 0, True);
  AData.AddProperty('OnChanging', TCustomListView_OnChanging_si, TLVChangingEvent_sw, True, True, 0, True);
  AData.AddProperty('OnColumnClick', TCustomListView_OnColumnClick_si, TLVColumnClickEvent_sw, True, True, 0, True);
  AData.AddProperty('OnColumnDragged', TCustomListView_OnColumnDragged_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnColumnRightClick', TCustomListView_OnColumnRightClick_si, TLVColumnRClickEvent_sw, True, True, 0, True);
  AData.AddProperty('OnCustomDraw', TCustomListView_OnCustomDraw_si, TLVCustomDrawEvent_sw, True, True, 0, True);
  AData.AddProperty('OnData', TCustomListView_OnData_si, TLVOwnerDataEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDataHint', TCustomListView_OnDataHint_si, TLVOwnerDataHintEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDataStateChange', TCustomListView_OnDataStateChange_si, TLVOwnerDataStateChangeEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDeletion', TCustomListView_OnDeletion_si, TLVDeletedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnEdited', TCustomListView_OnEdited_si, TLVEditedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnEditing', TCustomListView_OnEditing_si, TLVEditingEvent_sw, True, True, 0, True);
  AData.AddProperty('OnInfoTip', TCustomListView_OnInfoTip_si, TLVInfoTipEvent_sw, True, True, 0, True);
  AData.AddProperty('OnInsert', TCustomListView_OnInsert_si, TLVDeletedEvent_sw, True, True, 0, True);
  AData.AddProperty('OnGetImageIndex', TCustomListView_OnGetImageIndex_si, TLVNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnGetSubItemImage', TCustomListView_OnGetSubItemImage_si, TLVSubItemImageEvent_sw, True, True, 0, True);
  AData.AddProperty('OnSelectItem', TCustomListView_OnSelectItem_si, TLVSelectItemEvent_sw, True, True, 0, True);
  AData.AddProperty('OnItemChecked', TCustomListView_OnItemChecked_si, TLVCheckedItemEvent_sw, True, True, 0, True);
  AData.AddProperty('ShowColumnHeaders', TCustomListView_ShowColumnHeaders_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ShowWorkAreas', TCustomListView_ShowWorkAreas_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('SmallImages', TCustomListView_SmallImages_si, TCustomImageList_sw, True, True, 0, True);
  AData.AddProperty('SortType', TCustomListView_SortType_si, TSortType_sw, True, True, 0, True);
  AData.AddProperty('StateImages', TCustomListView_StateImages_si, TCustomImageList_sw, True, True, 0, True);
  AData.AddProperty('ViewStyle', TCustomListView_ViewStyle_si, TViewStyle_sw, True, True, 0, True);
  AData.AddProperty('OnCreateItemClass', TCustomListView_OnCreateItemClass_si, TLVCreateItemClassEvent_sw, True, True, 0, True);
  ...
  AData.AddProperty('Canvas', TCustomListView_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddProperty('Checkboxes', TCustomListView_Checkboxes_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Column', TCustomListView_Column_si, TListColumn_sw, True, False, 1, False);
  AData.AddProperty('DropTarget', TCustomListView_DropTarget_si, TListItem_sw, True, True, 0, False);
  AData.AddProperty('FlatScrollBars', TCustomListView_FlatScrollBars_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('FullDrag', TCustomListView_FullDrag_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('GridLines', TCustomListView_GridLines_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('HotTrack', TCustomListView_HotTrack_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('HotTrackStyles', TCustomListView_HotTrackStyles_si, TListHotTrackStyles_sw, True, True, 0, False);
  AData.AddProperty('ItemFocused', TCustomListView_ItemFocused_si, TListItem_sw, True, True, 0, False);
  AData.AddProperty('Items', TCustomListView_Items_si, TListItems_sw, True, True, 0, False);
  AData.AddProperty('RowSelect', TCustomListView_RowSelect_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SelCount', TCustomListView_SelCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Selected', TCustomListView_Selected_si, TListItem_sw, True, True, 0, False);
  ...
  AData.AddProperty('TopItem', TCustomListView_TopItem_si, TListItem_sw, True, False, 0, False);
  AData.AddProperty('ViewOrigin', TCustomListView_ViewOrigin_si, TPoint_sw, True, False, 0, False);
  AData.AddProperty('VisibleRowCount', TCustomListView_VisibleRowCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('BoundingRect', TCustomListView_BoundingRect_si, TRect_sw, True, False, 0, False);
  AData.AddProperty('WorkAreas', TCustomListView_WorkAreas_si, TWorkAreas_sw, True, False, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Action');
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('AllocBy');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  AData.AddPropertyRedecl('BevelOuter');
  ...
  AData.AddPropertyRedecl('BorderStyle');
  AData.AddPropertyRedecl('BorderWidth');
  AData.AddPropertyRedecl('Checkboxes');
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Columns');
  AData.AddPropertyRedecl('ColumnClick');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddPropertyRedecl('DoubleBuffered');
  AData.AddPropertyRedecl('DragCursor');
  ...
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('FlatScrollBars');
  AData.AddPropertyRedecl('FullDrag');
  AData.AddPropertyRedecl('GridLines');
  AData.AddPropertyRedecl('Groups');
  AData.AddPropertyRedecl('HideSelection');
  AData.AddPropertyRedecl('HotTrack');
  AData.AddPropertyRedecl('HotTrackStyles');
  AData.AddPropertyRedecl('HoverTime');
  AData.AddPropertyRedecl('IconOptions');
  AData.AddPropertyRedecl('Items');
  AData.AddPropertyRedecl('LargeImages');
  AData.AddPropertyRedecl('MultiSelect');
  AData.AddPropertyRedecl('OwnerData');
  AData.AddPropertyRedecl('OwnerDraw');
  AData.AddPropertyRedecl('GroupHeaderImages');
  AData.AddPropertyRedecl('GroupView');
  AData.AddPropertyRedecl('ReadOnly');
  AData.AddPropertyRedecl('RowSelect');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentColor');
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('ShowColumnHeaders');
  AData.AddPropertyRedecl('ShowWorkAreas');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('SmallImages');
  AData.AddPropertyRedecl('SortType');
  AData.AddPropertyRedecl('StateImages');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('ViewStyle');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnAdvancedCustomDraw');
  AData.AddPropertyRedecl('OnAdvancedCustomDrawItem');
  AData.AddPropertyRedecl('OnAdvancedCustomDrawSubItem');
  AData.AddPropertyRedecl('OnChange');
  AData.AddPropertyRedecl('OnChanging');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnColumnClick');
  AData.AddPropertyRedecl('OnColumnDragged');
  AData.AddPropertyRedecl('OnColumnRightClick');
  AData.AddPropertyRedecl('OnCompare');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnCustomDraw');
  AData.AddPropertyRedecl('OnCustomDrawItem');
  AData.AddPropertyRedecl('OnCustomDrawSubItem');
  AData.AddPropertyRedecl('OnCreateItemClass');
  AData.AddPropertyRedecl('OnData');
  AData.AddPropertyRedecl('OnDataFind');
  AData.AddPropertyRedecl('OnDataHint');
  AData.AddPropertyRedecl('OnDataStateChange');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDeletion');
  ...
  AData.AddPropertyRedecl('OnExit');
  AData.AddPropertyRedecl('OnGetImageIndex');
  AData.AddPropertyRedecl('OnGetSubItemImage');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddPropertyRedecl('OnInfoTip');
  AData.AddPropertyRedecl('OnInsert');
  AData.AddPropertyRedecl('OnKeyDown');
  AData.AddPropertyRedecl('OnKeyPress');
  AData.AddPropertyRedecl('OnKeyUp');
  AData.AddPropertyRedecl('OnMouseActivate');
  ...
  AData.AddPropertyRedecl('OnMouseUp');
  AData.AddPropertyRedecl('OnResize');
  AData.AddPropertyRedecl('OnSelectItem');
  AData.AddPropertyRedecl('OnItemChecked');
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnStartDrag');
end;
...
class function TCommonAVI_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCommonAVI);
end;
...
begin
  ...
  AData.AddFunction('Copy', TAnimateParams_Copy_si, TAnimateParams_sw, 0);
  ...
  AData.AddConstructor('Create', TAnimateParams_Create_si, 0);
end;
...
begin
  ...
  AData.AddProperty('FrameCount', TAnimate_FrameCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('FrameHeight', TAnimate_FrameHeight_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('FrameWidth', TAnimate_FrameWidth_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Open', TAnimate_Open_si, Boolean_sw, True, True, 0, False);
  ...
  AData.AddProperty('ResHandle', TAnimate_ResHandle_si, THandle_sw, True, True, 0, False);
  AData.AddProperty('ResId', TAnimate_ResId_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ResName', TAnimate_ResName_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddProperty('Active', TAnimate_Active_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddPropertyRedecl('BorderWidth');
  AData.AddProperty('Center', TAnimate_Center_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Color');
  AData.AddProperty('CommonAVI', TAnimate_CommonAVI_si, TCommonAVI_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('DoubleBuffered');
  AData.AddProperty('FileName', TAnimate_FileName_si, string_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddProperty('Repetitions', TAnimate_Repetitions_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('StartFrame', TAnimate_StartFrame_si, Smallint_sw, True, True, 0, False);
  AData.AddProperty('StopFrame', TAnimate_StopFrame_si, Smallint_sw, True, True, 0, False);
  AData.AddProperty('Timers', TAnimate_Timers_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Transparent', TAnimate_Transparent_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
  AData.AddProperty('OnOpen', TAnimate_OnOpen_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnClose', TAnimate_OnClose_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnStart', TAnimate_OnStart_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnStop', TAnimate_OnStop_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
class function TToolButtonStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TToolButtonStyle);
end;
...
class function TToolButtonState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TToolButtonState);
end;
...
begin
  ...
  AData.AddProperty('Index', TToolButton_Index_si, Integer_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Action');
  AData.AddProperty('AllowAllUp', TToolButton_AllowAllUp_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AutoSize', TToolButton_AutoSize_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Caption');
  AData.AddProperty('Down', TToolButton_Down_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddProperty('DropdownMenu', TToolButton_DropdownMenu_si, TPopupMenu_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Enabled');
  AData.AddProperty('EnableDropdown', TToolButton_EnableDropdown_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Grouped', TToolButton_Grouped_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Height');
  AData.AddProperty('ImageIndex', TToolButton_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('Indeterminate', TToolButton_Indeterminate_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Marked', TToolButton_Marked_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('MenuItem', TToolButton_MenuItem_si, TMenuItem_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('Wrap', TToolButton_Wrap_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('Style', TToolButton_Style_si, TToolButtonStyle_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('Width');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
...
class function TTBDrawingStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TTBDrawingStyle);
end;
...
begin
  ...
  AData.AddProperty('Current', TToolBarEnumerator_Current_si, TToolButton_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('ButtonCount', TToolBar_ButtonCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Buttons', TToolBar_Buttons_si, TToolButton_sw, True, False, 1, False);
  AData.AddProperty('Canvas', TToolBar_Canvas_si, TCanvas_sw, True, False, 0, False);
  AData.AddProperty('CustomizeKeyName', TToolBar_CustomizeKeyName_si, string_sw, True, True, 0, False);
  AData.AddProperty('CustomizeValueName', TToolBar_CustomizeValueName_si, string_sw, True, True, 0, False);
  AData.AddProperty('RowCount', TToolBar_RowCount_si, Integer_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddPropertyRedecl('BorderWidth');
  AData.AddProperty('ButtonHeight', TToolBar_ButtonHeight_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ButtonWidth', TToolBar_ButtonWidth_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Caption');
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  AData.AddProperty('Customizable', TToolBar_Customizable_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DisabledImages', TToolBar_DisabledImages_si, TCustomImageList_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DoubleBuffered');
  AData.AddPropertyRedecl('DockSite');
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddProperty('DrawingStyle', TToolBar_DrawingStyle_si, TTBDrawingStyle_sw, True, True, 0, False);
  AData.AddPropertyRedecl('EdgeBorders');
  AData.AddPropertyRedecl('EdgeInner');
  AData.AddPropertyRedecl('EdgeOuter');
  AData.AddPropertyRedecl('Enabled');
  AData.AddProperty('Flat', TToolBar_Flat_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Font');
  AData.AddProperty('GradientEndColor', TToolBar_GradientEndColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('GradientStartColor', TToolBar_GradientStartColor_si, TColor_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Height');
  AData.AddProperty('HideClippedButtons', TToolBar_HideClippedButtons_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('HotImages', TToolBar_HotImages_si, TCustomImageList_sw, True, True, 0, False);
  AData.AddProperty('HotTrackColor', TToolBar_HotTrackColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('Images', TToolBar_Images_si, TCustomImageList_sw, True, True, 0, False);
  AData.AddProperty('Indent', TToolBar_Indent_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('List', TToolBar_List_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Menu', TToolBar_Menu_si, TMainMenu_sw, True, True, 0, False);
  AData.AddProperty('GradientDirection', TToolBar_GradientDirection_si, TGradientDirection_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('ShowCaptions', TToolBar_ShowCaptions_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('AllowTextButtons', TToolBar_AllowTextButtons_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddProperty('Transparent', TToolBar_Transparent_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
  AData.AddProperty('Wrapable', TToolBar_Wrapable_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('OnAdvancedCustomDraw', TToolBar_OnAdvancedCustomDraw_si, TTBAdvancedCustomDrawEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddProperty('OnCustomDraw', TToolBar_OnCustomDraw_si, TTBCustomDrawEvent_sw, True, True, 0, False);
  AData.AddProperty('OnCustomizeAdded', TToolBar_OnCustomizeAdded_si, TTBButtonEvent_sw, True, True, 0, False);
  AData.AddProperty('OnCustomizeCanInsert', TToolBar_OnCustomizeCanInsert_si, TTBCustomizeQueryEvent_sw, True, True, 0, False);
  AData.AddProperty('OnCustomizeCanDelete', TToolBar_OnCustomizeCanDelete_si, TTBCustomizeQueryEvent_sw, True, True, 0, False);
  AData.AddProperty('OnCustomized', TToolBar_OnCustomized_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnCustomizeDelete', TToolBar_OnCustomizeDelete_si, TTBButtonEvent_sw, True, True, 0, False);
  AData.AddProperty('OnCustomizing', TToolBar_OnCustomizing_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnCustomizeNewButton', TToolBar_OnCustomizeNewButton_si, TTBNewButtonEvent_sw, True, True, 0, False);
  AData.AddProperty('OnCustomizeReset', TToolBar_OnCustomizeReset_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDockDrop');
  AData.AddPropertyRedecl('OnDockOver');
  AData.AddPropertyRedecl('OnDragDrop');
...
begin
  ...
  AData.AddProperty('Height', TCoolBand_Height_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Bitmap', TCoolBand_Bitmap_si, TBitmap_sw, True, True, 0, False);
  AData.AddProperty('BorderStyle', TCoolBand_BorderStyle_si, TBorderStyle_sw, True, True, 0, False);
  AData.AddProperty('Break', TCoolBand_Break_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Color', TCoolBand_Color_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('Control', TCoolBand_Control_si, TWinControl_sw, True, True, 0, False);
  AData.AddProperty('FixedBackground', TCoolBand_FixedBackground_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('FixedSize', TCoolBand_FixedSize_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('HorizontalOnly', TCoolBand_HorizontalOnly_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ImageIndex', TCoolBand_ImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('MinHeight', TCoolBand_MinHeight_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('MinWidth', TCoolBand_MinWidth_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ParentColor', TCoolBand_ParentColor_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('ParentBitmap', TCoolBand_ParentBitmap_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Text', TCoolBand_Text_si, string_sw, True, True, 0, False);
  AData.AddProperty('Visible', TCoolBand_Visible_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Width', TCoolBand_Width_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('CoolBar', TCoolBands_CoolBar_si, TCoolBar_sw, True, False, 0, False);
  AData.AddProperty('Items', TCoolBands_Items_si, TCoolBand_sw, True, True, 1, False);
...
class function TCoolBandMaximize_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCoolBandMaximize);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('AutoSize');
  AData.AddProperty('BandBorderStyle', TCoolBar_BandBorderStyle_si, TBorderStyle_sw, True, True, 0, False);
  AData.AddProperty('BandMaximize', TCoolBar_BandMaximize_si, TCoolBandMaximize_sw, True, True, 0, False);
  AData.AddProperty('Bands', TCoolBar_Bands_si, TCoolBands_sw, True, True, 0, False);
  AData.AddPropertyRedecl('BorderWidth');
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Ctl3D');
  ...
  AData.AddPropertyRedecl('EdgeOuter');
  AData.AddPropertyRedecl('Enabled');
  AData.AddProperty('FixedSize', TCoolBar_FixedSize_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('FixedOrder', TCoolBar_FixedOrder_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Font');
  AData.AddProperty('Images', TCoolBar_Images_si, TCustomImageList_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddProperty('Bitmap', TCoolBar_Bitmap_si, TBitmap_sw, True, True, 0, False);
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddProperty('ShowText', TCoolBar_ShowText_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Vertical', TCoolBar_Vertical_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Visible');
  AData.AddProperty('OnChange', TCoolBar_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDockDrop');
...
begin
  ...
  AData.AddProperty('BackColor', TMonthCalColors_BackColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('TextColor', TMonthCalColors_TextColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('TitleBackColor', TMonthCalColors_TitleBackColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('TitleTextColor', TMonthCalColors_TitleTextColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('MonthBackColor', TMonthCalColors_MonthBackColor_si, TColor_sw, True, True, 0, False);
  AData.AddProperty('TrailingTextColor', TMonthCalColors_TrailingTextColor_si, TColor_sw, True, True, 0, False);
...
class function TCalDayOfWeek_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TCalDayOfWeek);
end;
...
begin
  ...
  AData.AddProperty('CalExceptionClass', TCommonCalendar_CalExceptionClass_si, ECommonCalExceptClass_sw, True, True, 0, True);
  AData.AddProperty('CalColors', TCommonCalendar_CalColors_si, TMonthCalColors_sw, True, True, 0, True);
  AData.AddProperty('CalendarHandle', TCommonCalendar_CalendarHandle_si, HWND_sw, True, False, 0, True);
  AData.AddProperty('Date', TCommonCalendar_Date_si, TDate_sw, True, True, 0, True);
  AData.AddProperty('DateTime', TCommonCalendar_DateTime_si, TDateTime_sw, True, True, 0, True);
  AData.AddProperty('EndDate', TCommonCalendar_EndDate_si, TDate_sw, True, True, 0, True);
  AData.AddProperty('FirstDayOfWeek', TCommonCalendar_FirstDayOfWeek_si, TCalDayOfWeek_sw, True, True, 0, True);
  AData.AddProperty('MaxDate', TCommonCalendar_MaxDate_si, TDate_sw, True, True, 0, True);
  AData.AddProperty('MaxSelectRange', TCommonCalendar_MaxSelectRange_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('MinDate', TCommonCalendar_MinDate_si, TDate_sw, True, True, 0, True);
  AData.AddProperty('MonthDelta', TCommonCalendar_MonthDelta_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('MultiSelect', TCommonCalendar_MultiSelect_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ShowToday', TCommonCalendar_ShowToday_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ShowTodayCircle', TCommonCalendar_ShowTodayCircle_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('WeekNumbers', TCommonCalendar_WeekNumbers_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('OnGetMonthInfo', TCommonCalendar_OnGetMonthInfo_si, TOnGetMonthInfoEvent_sw, True, True, 0, True);
end;
...
begin
  ...
  AData.AddPropertyRedecl('BorderWidth');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('CalColors');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('MultiSelect');
  AData.AddPropertyRedecl('Date');
  AData.AddPropertyRedecl('DoubleBuffered');
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('EndDate');
  AData.AddPropertyRedecl('FirstDayOfWeek');
  AData.AddPropertyRedecl('Font');
  AData.AddPropertyRedecl('ImeMode');
  AData.AddPropertyRedecl('ImeName');
  AData.AddPropertyRedecl('MaxDate');
  AData.AddPropertyRedecl('MaxSelectRange');
  AData.AddPropertyRedecl('MinDate');
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentFont');
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('ShowToday');
  AData.AddPropertyRedecl('ShowTodayCircle');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('WeekNumbers');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDragDrop');
  ...
  AData.AddPropertyRedecl('OnEnter');
  AData.AddPropertyRedecl('OnExit');
  AData.AddPropertyRedecl('OnGetMonthInfo');
  AData.AddPropertyRedecl('OnKeyDown');
  AData.AddPropertyRedecl('OnKeyPress');
  AData.AddPropertyRedecl('OnKeyUp');
  AData.AddPropertyRedecl('OnMouseEnter');
...
class function TDateTimeKind_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDateTimeKind);
end;
...
class function TDTDateMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDTDateMode);
end;
...
class function TDTDateFormat_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDTDateFormat);
end;
...
class function TDTCalAlignment_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDTCalAlignment);
end;
...
begin
  ...
  AData.AddPropertyRedecl('DateTime');
  AData.AddProperty('DroppedDown', TDateTimePicker_DroppedDown_si, Boolean_sw, True, False, 0, False);
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BevelEdges');
  AData.AddPropertyRedecl('BevelInner');
  ...
  AData.AddPropertyRedecl('BevelWidth');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddProperty('CalAlignment', TDateTimePicker_CalAlignment_si, TDTCalAlignment_sw, True, True, 0, False);
  AData.AddPropertyRedecl('CalColors');
  AData.AddPropertyRedecl('Constraints');
  AData.AddPropertyRedecl('Date');
  AData.AddProperty('Format', TDateTimePicker_Format_si, string_sw, True, True, 0, False);
  AData.AddProperty('Time', TDateTimePicker_Time_si, TTime_sw, True, True, 0, False);
  AData.AddProperty('ShowCheckbox', TDateTimePicker_ShowCheckbox_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Checked', TDateTimePicker_Checked_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Color');
  AData.AddProperty('DateFormat', TDateTimePicker_DateFormat_si, TDTDateFormat_sw, True, True, 0, False);
  AData.AddProperty('DateMode', TDateTimePicker_DateMode_si, TDTDateMode_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DoubleBuffered');
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  ...
  AData.AddPropertyRedecl('ImeMode');
  AData.AddPropertyRedecl('ImeName');
  AData.AddProperty('Kind', TDateTimePicker_Kind_si, TDateTimeKind_sw, True, True, 0, False);
  AData.AddPropertyRedecl('MaxDate');
  AData.AddPropertyRedecl('MinDate');
  AData.AddProperty('ParseInput', TDateTimePicker_ParseInput_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ParentBiDiMode');
  AData.AddPropertyRedecl('ParentColor');
  AData.AddPropertyRedecl('ParentDoubleBuffered');
  AData.AddPropertyRedecl('ParentFont');
  ...
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnClick');
  AData.AddProperty('OnCloseUp', TDateTimePicker_OnCloseUp_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnChange', TDateTimePicker_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddProperty('OnDropDown', TDateTimePicker_OnDropDown_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddPropertyRedecl('OnEndDock');
  ...
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnStartDrag');
  AData.AddProperty('OnUserInput', TDateTimePicker_OnUserInput_si, TDTParseInputEvent_sw, True, True, 0, False);
end;
...
class function TPageScrollerOrientation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPageScrollerOrientation);
end;
...
class function TPageScrollerButton_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPageScrollerButton);
end;
...
class function TPageScrollerButtonState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TPageScrollerButtonState);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('Anchors');
  AData.AddProperty('AutoScroll', TPageScroller_AutoScroll_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('BorderWidth');
  AData.AddProperty('ButtonSize', TPageScroller_ButtonSize_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Color');
  AData.AddPropertyRedecl('Constraints');
  AData.AddProperty('Control', TPageScroller_Control_si, TWinControl_sw, True, True, 0, False);
  AData.AddPropertyRedecl('DockSite');
  AData.AddPropertyRedecl('DoubleBuffered');
  AData.AddPropertyRedecl('DragCursor');
  AData.AddPropertyRedecl('DragKind');
  AData.AddPropertyRedecl('DragMode');
  AData.AddProperty('DragScroll', TPageScroller_DragScroll_si, Boolean_sw, True, True, 0, False);
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('Font');
  AData.AddProperty('Margin', TPageScroller_Margin_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Orientation', TPageScroller_Orientation_si, TPageScrollerOrientation_sw, True, True, 0, False);
  ...
  AData.AddPropertyRedecl('ParentShowHint');
  AData.AddPropertyRedecl('PopupMenu');
  AData.AddProperty('Position', TPageScroller_Position_si, Integer_sw, True, True, 0, False);
  AData.AddPropertyRedecl('ShowHint');
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Visible');
...
begin
  ...
  AData.AddProperty('Indent', TComboExItem_Indent_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('OverlayImageIndex', TComboExItem_OverlayImageIndex_si, TImageIndex_sw, True, True, 0, False);
  AData.AddProperty('SelectedImageIndex', TComboExItem_SelectedImageIndex_si, TImageIndex_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('ComboItems', TComboExItems_ComboItems_si, TComboExItem_sw, True, False, 1, False);
end;
...
begin
  ...
  AData.AddProperty('SortType', TComboBoxExStrings_SortType_si, TListItemsSortType_sw, True, True, 0, False);
  AData.AddProperty('ItemsEx', TComboBoxExStrings_ItemsEx_si, TComboExItems_sw, True, True, 0, False);
...
class function TComboBoxExStyle_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TComboBoxExStyle);
end;
...
class function TComboBoxExStyleEx_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TComboBoxExStyleEx);
end;
...
class function TAutoCompleteOption_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TAutoCompleteOption);
end;
...
begin
  ...
  AData.AddProperty('AutoCompleteOptions', TCustomComboBoxEx_AutoCompleteOptions_si, TAutoCompleteOptions_sw, True, True, 0, False);
  AData.AddProperty('DropDownCount', TCustomComboBoxEx_DropDownCount_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Images', TCustomComboBoxEx_Images_si, TCustomImageList_sw, True, True, 0, False);
  AData.AddProperty('ItemsEx', TCustomComboBoxEx_ItemsEx_si, TComboExItems_sw, True, True, 0, False);
  AData.AddProperty('SelText', TCustomComboBoxEx_SelText_si, string_sw, True, True, 0, False);
  AData.AddProperty('Style', TCustomComboBoxEx_Style_si, TComboBoxExStyle_sw, True, True, 0, False);
  AData.AddProperty('StyleEx', TCustomComboBoxEx_StyleEx_si, TComboBoxExStyles_sw, True, True, 0, False);
  AData.AddProperty('OnBeginEdit', TCustomComboBoxEx_OnBeginEdit_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('OnEndEdit', TCustomComboBoxEx_OnEndEdit_si, TNotifyEvent_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Align');
  AData.AddPropertyRedecl('AutoCompleteOptions');
  AData.AddPropertyRedecl('ItemsEx');
  AData.AddPropertyRedecl('Style');
  AData.AddPropertyRedecl('StyleEx');
  AData.AddPropertyRedecl('Action');
  AData.AddPropertyRedecl('Anchors');
  AData.AddPropertyRedecl('BiDiMode');
  AData.AddPropertyRedecl('Color');
  ...
  AData.AddPropertyRedecl('TabOrder');
  AData.AddPropertyRedecl('TabStop');
  AData.AddPropertyRedecl('Text');
  AData.AddPropertyRedecl('Visible');
  AData.AddPropertyRedecl('OnBeginEdit');
  AData.AddPropertyRedecl('OnChange');
  AData.AddPropertyRedecl('OnClick');
  AData.AddPropertyRedecl('OnContextPopup');
  AData.AddPropertyRedecl('OnDblClick');
  AData.AddPropertyRedecl('OnDragDrop');
  AData.AddPropertyRedecl('OnDragOver');
  AData.AddPropertyRedecl('OnDropDown');
  AData.AddPropertyRedecl('OnEndEdit');
  AData.AddPropertyRedecl('OnEndDock');
  AData.AddPropertyRedecl('OnEndDrag');
  AData.AddPropertyRedecl('OnEnter');
  AData.AddPropertyRedecl('OnExit');
  ...
  AData.AddPropertyRedecl('OnKeyUp');
  AData.AddPropertyRedecl('OnMouseMove');
  AData.AddPropertyRedecl('OnSelect');
  AData.AddPropertyRedecl('OnStartDock');
  AData.AddPropertyRedecl('OnStartDrag');
  AData.AddPropertyRedecl('Images');
  AData.AddPropertyRedecl('DropDownCount');
end;
...
function ComCtrls_THitTest_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type THitTest = (htBelow, htNowhere, htOnItem, htOnButton...
...
function ComCtrls_TTabPosition_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTabPosition = (tpBottom, tpLeft, tpRight);
...
function ComCtrls_TTabStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTabStyle = (tsButtons, tsFlatButtons);
...
function ComCtrls_TStatusPanelStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TStatusPanelStyle = (psOwnerDraw);
...
function ComCtrls_TStatusPanelBevel_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TStatusPanelBevel = (pbLowered, pbRaised);
...
function ComCtrls_TCustomDrawTarget_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCustomDrawTarget = (dtItem, dtSubItem);
...
function ComCtrls_TCustomDrawStage_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCustomDrawStage = (cdPostPaint, cdPreErase, cdPostE...
...
function ComCtrls_THeaderSectionStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type THeaderSectionStyle = (hsOwnerDraw);
...
function ComCtrls_TSectionTrackState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TSectionTrackState = (tsTrackMove, tsTrackEnd);
...
function ComCtrls_TNodeState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TNodeState = (nsDropHilited, nsFocused, nsSelected, ...
...
function ComCtrls_TNodeAttachMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TNodeAttachMode = (naAddFirst, naAddChild, naAddChil...
...
function ComCtrls_TNodeDataType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TNodeDataType = (ndtDefault2, ndt32bit, ndt64bit, nd...
...
function ComCtrls_TSortType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TSortType = (stData, stText, stBoth);
...
function ComCtrls_TMultiSelectStyles_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMultiSelectStyles = (msShiftSelect, msVisibleOnly, ...
...
function ComCtrls_TTrackBarOrientation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTrackBarOrientation = (trVertical);
...
function ComCtrls_TTickMark_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTickMark = (tmTopLeft, tmBoth);
...
function ComCtrls_TTickStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTickStyle = (tsAuto, tsManual);
...
function ComCtrls_TPositionToolTip_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPositionToolTip = (ptTop, ptLeft, ptBottom, ptRight);
...
function ComCtrls_TProgressBarOrientation_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TProgressBarOrientation = (pbVertical);
...
function ComCtrls_TProgressBarStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TProgressBarStyle = (pbstMarquee);
...
function ComCtrls_TProgressBarState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TProgressBarState = (pbsError, pbsPaused);
...
function ComCtrls_TAttributeType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TAttributeType = (atDefaultText);
...
function ComCtrls_TConsistentAttribute_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TConsistentAttribute = (caColor, caFace, caItalic, c...
...
function ComCtrls_TUDOrientation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TUDOrientation = (udVertical);
...
function ComCtrls_TUpDownDirection_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TUpDownDirection = (updUp, updDown);
...
function ComCtrls_THKModifier_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type THKModifier = (hkCtrl, hkAlt, hkExt);
...
function ComCtrls_THKInvalidKey_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type THKInvalidKey = (hcShift, hcCtrl, hcAlt, hcShiftCtrl...
...
function ComCtrls_TListGroupState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TListGroupState = (lgsHidden, lgsCollapsed, lgsNoHea...
...
function ComCtrls_TDisplayCode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDisplayCode = (drIcon, drLabel, drSelectBounds);
...
function ComCtrls_TListArrangement_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TListArrangement = (arAlignLeft, arAlignRight, arAli...
...
function ComCtrls_TViewStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TViewStyle = (vsSmallIcon, vsList, vsReport);
...
function ComCtrls_TItemState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TItemState = (isCut, isDropHilited, isFocused, isSel...
...
function ComCtrls_TItemChange_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TItemChange = (ctImage, ctState);
...
function ComCtrls_TItemFind_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TItemFind = (ifPartialString, ifExactString, ifNeare...
...
function ComCtrls_TSearchDirection_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TSearchDirection = (sdRight, sdAbove, sdBelow, sdAll);
...
function ComCtrls_TListHotTrackStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TListHotTrackStyle = (htUnderlineCold, htUnderlineHot);
...
function ComCtrls_TItemRequests_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TItemRequests = (irImage, irParam, irState, irIndent);
...
function ComCtrls_TCommonAVI_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCommonAVI = (aviFindFolder, aviFindFile, aviFindCom...
...
function ComCtrls_TToolButtonStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TToolButtonStyle = (tbsCheck, tbsDropDown, tbsSepara...
...
function ComCtrls_TToolButtonState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TToolButtonState = (tbsPressed, tbsEnabled, tbsHidde...
...
function ComCtrls_TTBDrawingStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTBDrawingStyle = (dsGradient);
...
function ComCtrls_TCoolBandMaximize_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCoolBandMaximize = (bmClick, bmDblClick);
...
function ComCtrls_TCalDayOfWeek_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCalDayOfWeek = (dowTuesday, dowWednesday, dowThursd...
...
function ComCtrls_TPageScrollerOrientation_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPageScrollerOrientation = (soVertical);
...
function ComCtrls_TPageScrollerButton_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPageScrollerButton = (sbLast);
...
function ComCtrls_TPageScrollerButtonState_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPageScrollerButtonState = (bsInvisible, bsGrayed, b...
...
function ComCtrls_TComboBoxExStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TComboBoxExStyle = (csExSimple, csExDropDownList);
...
function ComCtrls_TComboBoxExStyleEx_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TComboBoxExStyleEx = (csExNoEditImage, csExNoEditIma...
...
function ComCtrls_TAutoCompleteOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TAutoCompleteOption = (acoAutoAppend, acoSearch, aco...
...
begin
  ...
  Result := ComCtrls.InitCommonControl(Integer(AArgs[0]));
end;
...
begin
  ...
  ComCtrls.CheckCommonControl(Integer(AArgs[0]));
end;
...
begin
  ...
  Result := ComCtrls.GetComCtlVersion();
end;
...
begin
  ...
  ComCtrls.CheckToolMenuDropdown(TToolButton_sw.FromVar(AArgs[0]));
end;
