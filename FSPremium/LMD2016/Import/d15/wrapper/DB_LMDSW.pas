...
begin
  ...
  AData.AddProperty('Name', TNamedItem_Name_si, string_sw, True, True, 0, False);
end;
...
begin
  ...
  Result := TField_sw.ToVar(TFieldDef(AObj).CreateField(TComponent_sw.FromVar(
    AArgs[0]), TObjectField_sw.FromVar(AArgs[1]), string(AArgs[2]), Boolean(
    AArgs[3])));
end;
...
begin
  ...
  AData.AddProperty('Fields', TIndexDef_Fields_si, string_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('AsExtended', TField_AsExtended_si, Extended_sw, True, True, 0, False);
  ...
  AData.AddProperty('AsAnsiString', TField_AsAnsiString_si, AnsiString_sw, True, True, 0, False);
  ...
  AData.AddProperty('DisplayName', TField_DisplayName_si, string_sw, True, False, 0, False);
  ...
  AData.AddProperty('FullName', TField_FullName_si, string_sw, True, False, 0, False);
  ...
  AData.AddProperty('DisplayLabel', TField_DisplayLabel_si, string_sw, True, True, 0, False);
  ...
  AData.AddProperty('FieldName', TField_FieldName_si, string_sw, True, True, 0, False);
  ...
  AData.AddProperty('LookupKeyFields', TField_LookupKeyFields_si, string_sw, True, True, 0, False);
  AData.AddProperty('LookupResultField', TField_LookupResultField_si, string_sw, True, True, 0, False);
  AData.AddProperty('KeyFields', TField_KeyFields_si, string_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Value', TStringField_Value_si, AnsiString_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Value', TLongWordField_Value_si, LongWord_sw, True, True, 0, False);
  AData.AddProperty('MaxValue', TLongWordField_MaxValue_si, LongWord_sw, True, True, 0, False);
  AData.AddProperty('MinValue', TLongWordField_MinValue_si, LongWord_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Value', TExtendedField_Value_si, Extended_sw, True, True, 0, False);
  AData.AddProperty('currency', TExtendedField_currency_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('MaxValue', TExtendedField_MaxValue_si, Extended_sw, True, True, 0, False);
  AData.AddProperty('MinValue', TExtendedField_MinValue_si, Extended_sw, True, True, 0, False);
  AData.AddProperty('Precision', TExtendedField_Precision_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Value', TMemoField_Value_si, AnsiString_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('ObjectType', TObjectField_ObjectType_si, string_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('DisplayName', TAggregateField_DisplayName_si, string_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('AsShortInt', TParam_AsShortInt_si, LongInt_sw, True, True, 0, False);
  AData.AddProperty('AsByte', TParam_AsByte_si, LongInt_sw, True, True, 0, False);
  AData.AddProperty('AsLongWord', TParam_AsLongWord_si, LongWord_sw, True, True, 0, False);
  AData.AddProperty('AsLargeInt', TParam_AsLargeInt_si, LargeInt_sw, True, True, 0, False);
  ...
  AData.AddProperty('AsAnsiString', TParam_AsAnsiString_si, AnsiString_sw, True, True, 0, False);
  ...
  AData.AddProperty('AsDataSet', TParam_AsDataSet_si, TDataSet_sw, True, True, 0, False);
  AData.AddProperty('AsParams', TParam_AsParams_si, TParams_sw, True, True, 0, False);
  AData.AddProperty('AsStream', TParam_AsStream_si, TStream_sw, True, True, 0, False);
  ...
  AData.AddProperty('Name', TParam_Name_si, string_sw, True, True, 0, False);
...
function TParams_GetParamList_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure GetParamList(List: TList; const ParamNames: str...
...
function TDataSet_GetFieldList_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure GetFieldList(List: TList; const FieldNames: str...
...
function DB_TParamObject_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TParamObject = class(TInterfacedObject, IParamImplem...
...
begin
  ...
  DB.DatabaseError(string(AArgs[0]), TComponent_sw.FromVar(AArgs[1]));
end;
...
begin
  ...
  Result := TField_sw.ToVar(DB.GetFieldProperty(TDataSet_sw.FromVar(AArgs[0]), 
    TComponent_sw.FromVar(AArgs[1]), string(AArgs[2])));
end;
...
begin
  ...
  if IsGet then
    Result := TFieldDefsClass_sw.ToVar(DB.DefaultFieldDefsClass)
  else
    DB.DefaultFieldDefsClass := TFieldDefsClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TFieldDefClass_sw.ToVar(DB.DefaultFieldDefClass)
  else
    DB.DefaultFieldDefClass := TFieldDefClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TLookupListClass_sw.ToVar(DB.DefaultLookupListClass)
  else
    DB.DefaultLookupListClass := TLookupListClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TIndexDefClass_sw.ToVar(DB.DefaultIndexDefClass)
  else
    DB.DefaultIndexDefClass := TIndexDefClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TCheckConstraintClass_sw.ToVar(DB.DefaultCheckConstraintClass)
  else
    DB.DefaultCheckConstraintClass := TCheckConstraintClass_sw.FromVar(
      AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TParamClass_sw.ToVar(DB.DefaultParamClass)
  else
    DB.DefaultParamClass := TParamClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TParamsClass_sw.ToVar(DB.DefaultParamsClass)
  else
    DB.DefaultParamsClass := TParamsClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TFieldsClass_sw.ToVar(DB.DefaultFieldsClass)
  else
    DB.DefaultFieldsClass := TFieldsClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TFieldListClass_sw.ToVar(DB.DefaultFieldListClass)
  else
    DB.DefaultFieldListClass := TFieldListClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TIndexDefsClass_sw.ToVar(DB.DefaultIndexDefsClass)
  else
    DB.DefaultIndexDefsClass := TIndexDefsClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TFieldDefListClass_sw.ToVar(DB.DefaultFieldDefListClass)
  else
    DB.DefaultFieldDefListClass := TFieldDefListClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TCheckConstraintsClass_sw.ToVar(DB.DefaultCheckConstraintsClass)
  else
    DB.DefaultCheckConstraintsClass := TCheckConstraintsClass_sw.FromVar(
      AArgs[0]);
end;
