...
begin
  ...
  AData.AddPropertyRedecl('Font');
  AData.AddProperty('GlassFrame', TCustomForm_GlassFrame_si, TGlassFrame_sw, True, True, 0, False);
...
begin
  ...
  AData.AddPropertyRedecl('GlassFrame');
  AData.AddPropertyRedecl('Height');
...
begin
  ...
  AData.AddProperty('MessageFont', TScreen_MessageFont_si, TFont_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('DefaultFont', TApplication_DefaultFont_si, TFont_sw, True, True, 0, False);
  AData.AddProperty('DialogHandle', TApplication_DialogHandle_si, HWnd_sw, True, True, 0, False);
  AData.AddProperty('EnumAllWindowsOnActivateHint', TApplication_EnumAllWindowsOnActivateHint_si, Boolean_sw, True, True, 0, False);
  ...
  AData.AddProperty('MainFormOnTaskBar', TApplication_MainFormOnTaskBar_si, Boolean_sw, True, True, 0, False);
