...
uses
  ...
  Windows, Messages, SysUtils, Classes, Variants, Controls, Grids, StdCtrls,
  ValEdit, Windows_LMDSW, Messages_LMDSW, SysUtils_LMDSW, Classes_LMDSW,
  Variants_LMDSW, Controls_LMDSW, Grids_LMDSW, StdCtrls_LMDSW;
