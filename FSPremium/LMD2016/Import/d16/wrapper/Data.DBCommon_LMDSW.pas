...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Data.DBCommon' unit.
  #
  # WARNING:
...
uses
  ...
  LMDSctSysWrappers, System.Variants, System.SysUtils, System.Classes, Data.DB,
  Data.DBCommon, System.Variants_LMDSW, System.SysUtils_LMDSW,
  System.Classes_LMDSW, Data.DB_LMDSW;
...
begin
  ...
  Result := Data.DBCommon.GetFieldInfo(Widestring(AArgs[0]), v_1);
...
begin
  ...
  Result := TIndexDef_sw.ToVar(Data.DBCommon.GetIndexForOrderBy(WideString(
    AArgs[0]), TDataSet_sw.FromVar(AArgs[1])));
end;
...
begin
  ...
  Result := Data.DBCommon.GetTableNameFromSQL(WideString(AArgs[0]));
end;
...
begin
  ...
  Result := Data.DBCommon.GetTableNameFromQuery(Widestring(AArgs[0]));
end;
...
begin
  ...
  case AArgsSize of
    3:
    begin
      Result := Data.DBCommon.AddParamSQLForDetail(TParams_sw.FromVar(AArgs[0]),
...
begin
  ...
  Result := Data.DBCommon.IsMultiTableQuery(WideString(AArgs[0]));
end;
...
begin
  ...
  Result := Data.DBCommon.SQLRequiresParams(WideString(AArgs[0]));
end;
...
begin
  ...
  Result := Data.DBCommon.GetTableNameFromSQLEx(WideString(AArgs[0]), 
...
begin
  ...
  Result := RawByteString_sw.ToVar(Data.DBCommon.MetaDataFromUnicode(string(
    AArgs[0])));
end;
...
begin
  ...
  Result := Data.DBCommon.MetaDataToUnicode(RawByteString_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  AData.AddConstant('CANEXPRSIZE', DBCommon_CANEXPRSIZE_si, nil, VarType(Data.DBCommon.CANEXPRSIZE));
  AData.AddConstant('CANHDRSIZE', DBCommon_CANHDRSIZE_si, nil, VarType(Data.DBCommon.CANHDRSIZE));
  AData.AddConstant('CANEXPRVERSION', DBCommon_CANEXPRVERSION_si, nil, VarType(Data.DBCommon.CANEXPRVERSION));
