...
uses
  ...
  System.MaskUtils, System.WideStrings, Data.DBCommonTypes, Data.DB,
  System.SysUtils_LMDSW, System.Classes_LMDSW, System.Variants_LMDSW,
  System.MaskUtils_LMDSW, System.WideStrings_LMDSW, Data.DBCommonTypes_LMDSW;
...
function TField_AssignValue_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure AssignValue(const Value: TVarRec);

  TField(AObj).AssignValue(TVarRec_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  AData.AddProcedure('AssignValue', TField_AssignValue_si, 1, False);
