...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Data.Win.ADODB' unit.
  #
  # WARNING:
...
uses
  System.Types, LMDTypes, LMDSctScripter, LMDSctWrappers, LMDSctSysWrappers,
  Winapi.Windows, System.Variants, System.SysUtils, System.Classes,
  System.TypInfo, Data.DB, System.WideStrings, Data.Win.ADODB,
  Winapi.Windows_LMDSW, System.Variants_LMDSW, System.SysUtils_LMDSW,
  System.Classes_LMDSW, System.TypInfo_LMDSW, Data.DB_LMDSW,
  System.WideStrings_LMDSW;
...
begin
  // procedure/function GetProcedureNames(...); overload;
...
function TADOConnection_GetTableNames_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function GetTableNames(...); overload;
...
function TParameters_ParseSQL_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function ParseSQL(const SQL: WideString; DoCreate: Boolea...
...
begin
  ...
  AData.AddProperty('MasterFields', TCustomADODataSet_MasterFields_si, WideString_sw, True, True, 0, True, False);
  ...
  AData.AddProperty('IndexName', TCustomADODataSet_IndexName_si, WideString_sw, True, True, 0, False, False);
...
begin
  ...
  Data.Win.ADODB.CreateUDLFile(WideString(AArgs[0]), WideString(AArgs[1]), 
    WideString(AArgs[2]));
end;
...
begin
  ...
  Result := Data.Win.ADODB.DataLinkDir();
end;

function ADODB_GetProviderNames_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function GetProviderNames(...); overload;

  Data.Win.ADODB.GetProviderNames(TStrings_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Result := Data.Win.ADODB.PromptDataSource(THandle_sw.FromVar(AArgs[0]), 
    WideString(AArgs[1]));
end;
...
begin
  ...
  Result := Data.Win.ADODB.PromptDataLinkFile(THandle_sw.FromVar(AArgs[0]), 
    WideString(AArgs[1]));
end;
...
function ADODB_GetDataLinkFiles_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function GetDataLinkFiles(...); overload;

  case AArgsSize of
    1:
    begin
      Result := Data.Win.ADODB.GetDataLinkFiles(TStrings_sw.FromVar(AArgs[0]));
    end;
    2:
    begin
      Result := Data.Win.ADODB.GetDataLinkFiles(TStrings_sw.FromVar(AArgs[0]), 
...
begin
  ...
  AData.AddFunction('GetDataLinkFiles', ADODB_GetDataLinkFiles_si, nil, 1, True);
end;
