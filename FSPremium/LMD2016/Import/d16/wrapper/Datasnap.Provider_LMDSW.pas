...
uses
  ...
  LMDSctSysWrappers, System.SysUtils, System.Variants, System.Classes,
  Datasnap.DBClient, Data.DB, System.WideStrings, Datasnap.Provider,
  System.SysUtils_LMDSW, System.Variants_LMDSW, System.Classes_LMDSW,
  Datasnap.DBClient_LMDSW, Data.DB_LMDSW, System.WideStrings_LMDSW;
  ...
  case AArgsSize of
    ...
    begin
      ...
      Result := TCustomProvider(AObj).GetRecords(Integer(AArgs[0]), v_2, 
        Integer(AArgs[2]), WideString(AArgs[3]), v_3, v_4);
...
begin
  ...
  AData.AddProperty('DetailList', TUpdateTree_DetailList_si, TList_sw, True, False, 0, True, False);
  ...
  AData.AddProperty('Name', TUpdateTree_Name_si, WideString_sw, True, True, 0, False, False);
...
begin
  ...
  Result := Datasnap.Provider.VarArrayFromWideStrings(TWideStrings_sw.FromVar(
    AArgs[0]));
end;
