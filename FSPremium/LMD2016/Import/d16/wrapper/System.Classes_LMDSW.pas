...
uses
  System.Types, System.Classes, LMDTypes, LMDSctScripter, LMDSctWrappers,
  LMDSctSysWrappers, Winapi.Windows, Winapi.Messages, System.SysUtils,
  System.Variants, System.TypInfo, Winapi.Windows_LMDSW, Winapi.Messages_LMDSW,
  System.SysUtils_LMDSW, System.Variants_LMDSW, System.TypInfo_LMDSW;
...
type
  ...
  ELoginCredendialError_sw = class;
  ...
  ELoginCredendialError_sc = class of ELoginCredendialError;
  ELoginCredendialError_sw = class(Exception_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: ELoginCredendialError): OleVariant;
    class function FromVar(const AValue: OleVariant): ELoginCredendialError;
    class function ClassToVar(AClass: ELoginCredendialError_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): ELoginCredendialError_sc;
  end;
...
function TLinkObservers_EditLinkUpdate_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure EditLinkUpdate(AObservers: TObservers);
...
function TLinkObservers_EditLinkReset_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure EditLinkReset(AObservers: TObservers);
...
function TLinkObservers_EditLinkIsModified_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditLinkIsModified(AObservers: TObservers)...
...
function TLinkObservers_EditLinkIsValidChar_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditLinkIsValidChar(AObservers: TObservers...
...
function TLinkObservers_EditLinkIsEditing_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditLinkIsEditing(AObservers: TObservers):...
...
function TLinkObservers_EditLinkEdit_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditLinkEdit(AObservers: TObservers): Bool...
...
function TLinkObservers_EditLinkSetIsReadOnly_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure EditLinkSetIsReadOnly(AObservers: TObserv...
...
function TLinkObservers_EditLinkIsReadOnly_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditLinkIsReadOnly(AObservers: TObservers)...
...
function TLinkObservers_EditGridLinkUpdate_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure EditGridLinkUpdate(AObservers: TObservers);
...
function TLinkObservers_EditGridLinkReset_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure EditGridLinkReset(AObservers: TObservers);
...
function TLinkObservers_EditGridLinkModified_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure EditGridLinkModified(AObservers: TObserve...
...
function TLinkObservers_EditGridLinkIsModified_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditGridLinkIsModified(AObservers: TObserv...
...
function TLinkObservers_EditGridLinkIsValidChar_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditGridLinkIsValidChar(AObservers: TObser...
...
function TLinkObservers_EditGridLinkIsEditing_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditGridLinkIsEditing(AObservers: TObserve...
...
function TLinkObservers_EditGridLinkEdit_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditGridLinkEdit(AObservers: TObservers): ...
...
function TLinkObservers_EditGridLinkIsReadOnly_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditGridLinkIsReadOnly(AObservers: TObserv...
...
function TLinkObservers_EditGridLinkSetIsReadOnly_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure EditGridLinkSetIsReadOnly(AObservers: TOb...
...
function TLinkObservers_PositionLinkPosChanged_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure PositionLinkPosChanged(AObservers: TObser...
...
function TLinkObservers_ListSelectionChanged_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure ListSelectionChanged(AObservers: TObserve...
...
begin
  ...
  AData.AddFunction('ReadInt16', TBinaryReader_ReadInt16_si, ShortInt_sw, 0, False);
  ...
  AData.AddFunction('ReadSByte', TBinaryReader_ReadSByte_si, SmallInt_sw, 0, False);
...
{ ELoginCredendialError_sw }

class function ELoginCredendialError_sw.GetTypeName: WideString;
begin
  Result := 'ELoginCredendialError';
end;

class function ELoginCredendialError_sw.GetWrappedClass: TClass;
begin
  Result := ELoginCredendialError;
end;

class procedure ELoginCredendialError_sw.DoInit(AData: TLMDClassWrapperData);
begin
  // Do not call inherited.
end;

class function ELoginCredendialError_sw.ToVar(
  const AValue: ELoginCredendialError): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function ELoginCredendialError_sw.FromVar(
  const AValue: OleVariant): ELoginCredendialError;
begin
  Result := ELoginCredendialError(ConvFromVar(AValue, ELoginCredendialError));
end;

class function ELoginCredendialError_sw.ClassToVar(
  AClass: ELoginCredendialError_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function ELoginCredendialError_sw.ClassFromVar(
  const AClass: OleVariant): ELoginCredendialError_sc;
begin
  Result := ELoginCredendialError_sc(ConvClsFromVar(AClass, 
...
function Classes_ELoginCredendialError_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type ELoginCredendialError = class(Exception);

  Result := TLMDUnitWrapper.TypeToVar(ELoginCredendialError_sw);
end;
...
begin
  ...
  AData.AddType(ELoginCredendialError_sw, Classes_ELoginCredendialError_si);
...
initialization
  ...
  RegisterClassWrapper(ELoginCredendialError_sw);
