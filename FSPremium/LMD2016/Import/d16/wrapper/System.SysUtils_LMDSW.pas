...
uses
  ...
  Winapi.Windows, System.SysConst, Winapi.Windows_LMDSW, System.SysConst_LMDSW;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.CurrencyString
  else
    System.SysUtils.CurrencyString := string(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.CurrencyFormat
  else
    System.SysUtils.CurrencyFormat := Byte(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.CurrencyDecimals
  else
    System.SysUtils.CurrencyDecimals := Byte(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := Ord(System.SysUtils.DateSeparator)
  else
    System.SysUtils.DateSeparator := Char(Integer(AArgs[0]));
end;
...
begin
  ...
  if IsGet then
    Result := Ord(System.SysUtils.TimeSeparator)
  else
    System.SysUtils.TimeSeparator := Char(Integer(AArgs[0]));
end;
...
begin
  ...
  if IsGet then
    Result := Ord(System.SysUtils.ListSeparator)
  else
    System.SysUtils.ListSeparator := Char(Integer(AArgs[0]));
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.ShortDateFormat
  else
    System.SysUtils.ShortDateFormat := string(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.LongDateFormat
  else
    System.SysUtils.LongDateFormat := string(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.TimeAMString
  else
    System.SysUtils.TimeAMString := string(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.TimePMString
  else
    System.SysUtils.TimePMString := string(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.ShortTimeFormat
  else
    System.SysUtils.ShortTimeFormat := string(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.LongTimeFormat
  else
    System.SysUtils.LongTimeFormat := string(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := Ord(System.SysUtils.ThousandSeparator)
  else
    System.SysUtils.ThousandSeparator := Char(Integer(AArgs[0]));
end;
...
begin
  ...
  if IsGet then
    Result := Ord(System.SysUtils.DecimalSeparator)
  else
    System.SysUtils.DecimalSeparator := Char(Integer(AArgs[0]));
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.TwoDigitYearCenturyWindow
  else
    System.SysUtils.TwoDigitYearCenturyWindow := Word(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := System.SysUtils.NegCurrFormat
  else
    System.SysUtils.NegCurrFormat := Byte(AArgs[0]);
end;
...
begin
  ...
  Result := System.SysUtils.LoadStr(Integer(AArgs[0]));
end;
...
begin
  ...
  Result := System.SysUtils.FileSetDate(string(AArgs[0]), Integer(AArgs[1]));
end;
...
begin
  ...
  Result := TDateTime_sw.ToVar(System.SysUtils.FileDateToDateTime(Integer(
    AArgs[0])));
end;
...
begin
  ...
  AData.AddConstant('MaxEraCount', SysUtils_MaxEraCount_si, nil, VarType(System.SysUtils.MaxEraCount));
