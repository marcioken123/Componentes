...
begin
  ...
  if IsGet then
    Result := Uint16_sw.ToVar(TExtended80Rec_sw(AObj).FValue._Exp)
  else
    TExtended80Rec_sw(AObj).FValue._Exp := Uint16_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Frac', TExtended80Rec_Frac_si, UInt64_sw);
  AData.AddField('_Exp', TExtended80Rec__Exp_si, Uint16_sw);
...
class procedure TRuntimeError_sw.GetEnumerators(out AEnums: PLMDEnumerator;
  out ACount: Integer);
const
  ENUMS: array[0..27] of TLMDEnumerator = (
...
function System__StrLong_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _StrLong(val: Longint; width: Longint): ShortStr...

  Result := System._StrLong(Longint(AArgs[0]), Longint(AArgs[1]));
end;
...
begin
  ...
  Result := System._Str0Long(Longint(AArgs[0]));
end;
...
begin
  ...
  Result := System._Str2Ext(Extended(AArgs[0]), LongInt(AArgs[1]), LongInt(
    AArgs[2]));
end;
...
function System__Str1Ext_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _Str1Ext(val: Extended; width: LongInt): ShortSt...

  Result := System._Str1Ext(Extended(AArgs[0]), LongInt(AArgs[1]));
end;
...
begin
  ...
  Result := System._Str0Ext(Extended(AArgs[0]));
end;
...
var
  v_1: AnsiString;
begin
  // procedure _LStrAsg(var Dest: AnsiString; const Source: An...

  v_1 := AnsiString(AArgs[0]);
  System._LStrAsg(v_1, AnsiString(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;
...
var
  v_1: AnsiString;
begin
  // procedure _LStrLAsg(var Dest: AnsiString; const Source: A...

  v_1 := AnsiString(AArgs[0]);
  System._LStrLAsg(v_1, AnsiString(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;
...
function System__Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _Copy(const S: ShortString; Index: Integer; Coun...

  Result := System._Copy(ShortString(AArgs[0]), Integer(AArgs[1]), Integer(
    AArgs[2]));
end;
...
var
  v_1: AnsiString;
begin
  // procedure _LStrCat(var Dest: AnsiString; const Source: An...

  v_1 := AnsiString(AArgs[0]);
  System._LStrCat(v_1, AnsiString(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;
...
var
  v_1: AnsiString;
begin
  // procedure _LStrCat3(var Dest: AnsiString; const Source1: ...

  v_1 := AnsiString(AArgs[0]);
  System._LStrCat3(v_1, AnsiString(AArgs[1]), AnsiString(AArgs[2]));
  AssignRefParam(AArgs[0], v_1);
end;
...
function System__LStrCopy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _LStrCopy(const S: AnsiString; Index: Integer; C...

  Result := System._LStrCopy(AnsiString(AArgs[0]), Integer(AArgs[1]), Integer(
    AArgs[2]));
end;
...
var
  v_1: AnsiString;
begin
  // procedure _LStrDelete(var S: AnsiString; Index: Integer; ...
...
var
  v_1: AnsiString;
begin
  // procedure _LStrInsert(const Source: AnsiString; var S: An...

  v_1 := AnsiString(AArgs[1]);
  System._LStrInsert(AnsiString(AArgs[0]), v_1, Integer(AArgs[2]));
  AssignRefParam(AArgs[1], v_1);
end;
...
begin
  ...
  AData.AddFunction('_StrLong', System__StrLong_si, ShortString_sw, 2, False);
  AData.AddFunction('_Str0Long', System__Str0Long_si, ShortString_sw, 1, False);
  ...
  AData.AddFunction('_Str2Ext', System__Str2Ext_si, ShortString_sw, 3, False);
  AData.AddFunction('_Str1Ext', System__Str1Ext_si, ShortString_sw, 2, False);
  AData.AddFunction('_Str0Ext', System__Str0Ext_si, ShortString_sw, 1, False);
  ...
  AData.AddFunction('_Copy', System__Copy_si, ShortString_sw, 3, False);
  ...
  AData.AddFunction('_LStrCopy', System__LStrCopy_si, AnsiString_sw, 3, False);
