...
uses
  ...
  Winapi.Messages, Vcl.ImgList, System.Contnrs, Vcl.ActnList,
  System.Classes_LMDSW, Winapi.Messages_LMDSW, Vcl.ImgList_LMDSW,
  System.Contnrs_LMDSW;
...
begin
  ...
  AData.AddProperty('ActionList', TContainedAction_ActionList_si, TCustomActionList_sw, True, True, 0, False, False);
...
begin
  ...
  AData.AddProperty('OnChange', TCustomActionList_OnChange_si, TNotifyEvent_sw, True, True, 0, True, False);
  AData.AddProperty('OnExecute', TCustomActionList_OnExecute_si, TActionEvent_sw, True, True, 0, True, False);
  AData.AddProperty('OnUpdate', TCustomActionList_OnUpdate_si, TActionEvent_sw, True, True, 0, True, False);
  ...
  AData.AddProperty('Actions', TCustomActionList_Actions_si, TContainedAction_sw, True, True, 1, False, True);
  AData.AddProperty('ActionCount', TCustomActionList_ActionCount_si, Integer_sw, True, False, 0, False, False);
  AData.AddProperty('Images', TCustomActionList_Images_si, TCustomImageList_sw, True, True, 0, False, False);
  AData.AddProperty('State', TCustomActionList_State_si, TActionListState_sw, True, True, 0, False, False);
  AData.AddProperty('OnStateChange', TCustomActionList_OnStateChange_si, TNotifyEvent_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddProperty('ShortCuts', TShortCutList_ShortCuts_si, TShortCut_sw, True, False, 1, False, False);
end;
...
begin
  ...
  AData.AddProperty('SavedEnabledState', TCustomAction_SavedEnabledState_si, Boolean_sw, True, True, 0, True, False);
  AData.AddFunction('DoHint', TCustomAction_DoHint_si, Boolean_sw, 1, False);
  AData.AddProperty('AutoCheck', TCustomAction_AutoCheck_si, Boolean_sw, True, True, 0, False, False);
  AData.AddProperty('Caption', TCustomAction_Caption_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('Checked', TCustomAction_Checked_si, Boolean_sw, True, True, 0, False, False);
  AData.AddProperty('DisableIfNoHandler', TCustomAction_DisableIfNoHandler_si, Boolean_sw, True, True, 0, False, False);
  AData.AddProperty('Enabled', TCustomAction_Enabled_si, Boolean_sw, True, True, 0, False, False);
  AData.AddProperty('GroupIndex', TCustomAction_GroupIndex_si, Integer_sw, True, True, 0, False, False);
  AData.AddProperty('HelpContext', TCustomAction_HelpContext_si, THelpContext_sw, True, True, 0, False, False);
  AData.AddProperty('HelpKeyword', TCustomAction_HelpKeyword_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('HelpType', TCustomAction_HelpType_si, THelpType_sw, True, True, 0, False, False);
  AData.AddProperty('Hint', TCustomAction_Hint_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('ImageIndex', TCustomAction_ImageIndex_si, TImageIndex_sw, True, True, 0, False, False);
  AData.AddProperty('ShortCut', TCustomAction_ShortCut_si, TShortCut_sw, True, True, 0, False, False);
  AData.AddProperty('SecondaryShortCuts', TCustomAction_SecondaryShortCuts_si, TShortCutList_sw, True, True, 0, False, False);
  AData.AddProperty('Visible', TCustomAction_Visible_si, Boolean_sw, True, True, 0, False, False);
  AData.AddProperty('OnHint', TCustomAction_OnHint_si, THintEvent_sw, True, True, 0, False, False);
end;
...
begin
  ...
  Result := TBasicAction_sw.ToVar(Vcl.ActnList.CreateAction(TComponent_sw.
