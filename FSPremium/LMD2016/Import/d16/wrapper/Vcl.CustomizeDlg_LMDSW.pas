...
uses
  ...
  Vcl.Dialogs, Vcl.StdCtrls, Vcl.ActnList, Vcl.CheckLst, Vcl.ComCtrls,
  Vcl.Menus, Vcl.ExtCtrls, Vcl.ImgList, Vcl.Buttons, Vcl.ActnMan,
  ...
  System.Classes_LMDSW, Vcl.Graphics_LMDSW, Vcl.Controls_LMDSW,
  Vcl.Forms_LMDSW, Vcl.Dialogs_LMDSW, Vcl.StdCtrls_LMDSW, Vcl.ActnList_LMDSW,
  Vcl.CheckLst_LMDSW, Vcl.ComCtrls_LMDSW, Vcl.Menus_LMDSW, Vcl.ExtCtrls_LMDSW,
  Vcl.ImgList_LMDSW, Vcl.Buttons_LMDSW, Vcl.ActnMan_LMDSW, Vcl.ActnCtrls_LMDSW,
  Vcl.ActnMenus_LMDSW;
