...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.DBCGrids' unit.
  #
  # WARNING:
...
uses
  ...
  LMDSctWrappers, LMDSctSysWrappers, System.SysUtils, Winapi.Windows,
  Winapi.Messages, System.Classes, Vcl.Controls, Vcl.Forms, Vcl.Graphics,
  Vcl.Menus, Data.DB, Vcl.DBCGrids, System.SysUtils_LMDSW,
  Winapi.Windows_LMDSW, Winapi.Messages_LMDSW, System.Classes_LMDSW,
  Vcl.Controls_LMDSW, Vcl.Forms_LMDSW, Vcl.Graphics_LMDSW, Vcl.Menus_LMDSW,
  Data.DB_LMDSW;
