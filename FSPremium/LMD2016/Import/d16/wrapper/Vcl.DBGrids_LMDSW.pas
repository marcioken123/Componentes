...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.DBGrids' unit.
  #
  # WARNING:
...
uses
  ...
  Winapi.Messages, System.Classes, Vcl.Controls, Vcl.Forms, Vcl.StdCtrls,
  Vcl.Graphics, Vcl.Grids, Vcl.DBCtrls, Data.DB, Vcl.Menus, Vcl.ImgList,
  Vcl.DBGrids, System.Variants_LMDSW, Winapi.Windows_LMDSW,
  System.SysUtils_LMDSW, Winapi.Messages_LMDSW, System.Classes_LMDSW,
  Vcl.Controls_LMDSW, Vcl.Forms_LMDSW, Vcl.StdCtrls_LMDSW, Vcl.Graphics_LMDSW,
  Vcl.Grids_LMDSW, Vcl.DBCtrls_LMDSW, Data.DB_LMDSW, Vcl.Menus_LMDSW,
  Vcl.ImgList_LMDSW;
...
const
  ENUMS: array[0..14] of TLMDEnumerator = (
    ...
    (Name: 'dgTitleClick'; Value: Integer({$IFDEF LMDSCT_12}TDBGridOption.{$ENDIF}dgTitleClick)),
    (Name: 'dgTitleHotTrack'; Value: Integer({$IFDEF LMDSCT_12}TDBGridOption.{$ENDIF}dgTitleHotTrack))
  );
begin
  AEnums := @ENUMS;
  ACount := 15;
...
begin
  ...
  AData.AddConstant('cm_DeferLayout', DBGrids_cm_DeferLayout_si, nil, VarType(Vcl.DBGrids.cm_DeferLayout));
  ...
  AData.AddConstant('IndicatorWidth', DBGrids_IndicatorWidth_si, nil, VarType(Vcl.DBGrids.IndicatorWidth));
end;
