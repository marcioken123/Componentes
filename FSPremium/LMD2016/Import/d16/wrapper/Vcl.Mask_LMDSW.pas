...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.Mask' unit.
  #
  # WARNING:
...
uses
  ...
  System.SysUtils, System.Classes, System.MaskUtils, Vcl.Controls,
  Vcl.StdCtrls, Vcl.Forms, Vcl.Graphics, Vcl.Menus, Vcl.Mask,
  Winapi.Windows_LMDSW, Winapi.Messages_LMDSW, System.SysUtils_LMDSW,
  System.Classes_LMDSW, System.MaskUtils_LMDSW, Vcl.Controls_LMDSW,
  Vcl.StdCtrls_LMDSW, Vcl.Forms_LMDSW, Vcl.Graphics_LMDSW, Vcl.Menus_LMDSW;
