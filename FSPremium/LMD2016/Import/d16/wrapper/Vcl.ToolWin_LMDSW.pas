...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.ToolWin' unit.
  #
  # WARNING:
...
uses
  ...
  Winapi.Messages, System.Classes, Vcl.Controls, Vcl.Forms, Vcl.ToolWin,
  Winapi.Windows_LMDSW, Winapi.Messages_LMDSW, System.Classes_LMDSW,
  Vcl.Controls_LMDSW, Vcl.Forms_LMDSW;
