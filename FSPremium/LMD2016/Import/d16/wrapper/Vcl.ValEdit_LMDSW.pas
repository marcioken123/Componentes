...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.ValEdit' unit.
  #
  # WARNING:
...
uses
  ...
  System.Classes, System.Variants, Vcl.Controls, Vcl.Grids, Vcl.StdCtrls,
  Vcl.ValEdit, Winapi.Windows_LMDSW, Winapi.Messages_LMDSW,
  System.SysUtils_LMDSW, System.Classes_LMDSW, System.Variants_LMDSW,
  Vcl.Controls_LMDSW, Vcl.Grids_LMDSW, Vcl.StdCtrls_LMDSW;
