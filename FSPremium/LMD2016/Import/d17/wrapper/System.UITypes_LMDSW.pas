...
function UITypes_vlPeriod_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const vlPeriod = <value>;
...
function UITypes_vkBacksplash_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const vkBacksplash = <value>;
...
begin
  ...
  AData.AddConstant('vlPeriod', UITypes_vlPeriod_si, nil, VarType(System.UITypes.vlPeriod));
  ...
  AData.AddConstant('vkBacksplash', UITypes_vkBacksplash_si, nil, VarType(System.UITypes.vkBacksplash));
