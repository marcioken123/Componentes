...
uses
  System.Classes, LMDTypes, LMDSctScripter, LMDSctWrappers, LMDSctSysWrappers,
  Winapi.Windows, Winapi.Messages, System.Types, System.TypInfo,
  System.SysUtils, System.Variants, System.UITypes, Winapi.Windows_LMDSW,
  Winapi.Messages_LMDSW, System.Types_LMDSW, System.TypInfo_LMDSW,
  System.SysUtils_LMDSW, System.Variants_LMDSW, System.UITypes_LMDSW;
...
begin
  ...
  case AArgsSize of
    ...
    begin
      v_1 := Boolean(AArgs[0]);
      Result := TStream(AObj).ReadData(v_1, Longint(AArgs[1]));
      AssignRefParam(AArgs[0], v_1);
    end;
    1:
    begin
      v_2 := AnsiChar(Integer(AArgs[0]));
      Result := TStream(AObj).ReadData(v_2);
...
begin
  ...
  case AArgsSize of
    2:
    begin
      Result := TStream(AObj).WriteData(Boolean(AArgs[0]), Longint(AArgs[1]));
    end;
    1:
    begin
...
begin
  ...
  case AArgsSize of
    ...
    begin
      v_1 := Boolean(AArgs[0]);
      TStream(AObj).ReadBufferData(v_1, Longint(AArgs[1]));
      AssignRefParam(AArgs[0], v_1);
    end;
    1:
    begin
      v_2 := AnsiChar(Integer(AArgs[0]));
      TStream(AObj).ReadBufferData(v_2);
      AssignRefParam(AArgs[0], Ord(v_2));
    end;
  else
...
begin
  ...
  TWriter(AObj).WriteVar(Char(Integer(AArgs[0])), Longint(AArgs[1]));
end;
...
function TLinkObservers_EditLinkTrackUpdate_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function EditLinkTrackUpdate(AObservers: TObservers...
...
function TLinkObservers_ControlValueTrackUpdate_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function ControlValueTrackUpdate(AObservers: TObser...
...
function TLinkObservers_AllowControlChange_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function AllowControlChange(AControl: TComponent): ...
...
function TLinkObservers_ControlChanged_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class procedure ControlChanged(AControl: TComponent);
...
begin
  ...
  Result := DefaultAttribute_sw.ToVar(DefaultAttribute_sc(AObj).Create(Integer(
    AArgs[0])));
end;
...
function Classes_StoredAttribute_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
begin
  ...
  AData.AddType(StoredAttribute_sw, Classes_StoredAttribute_si);
