...
function TVector_Scale_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Scale(const AFactor: Single): TVector;

  Result := TVector_sw.ToVar(TVector_sw(AObj).FValue.Scale(Single(AArgs[0])));
end;
...
begin
  ...
  AData.AddFunction('Scale', TVector_Scale_si, TVector_sw, 1, False);
  ...
  AData.AddConstructor('Create', TVector_Create_si, 0, True);
end;
...
function TMatrix_Transform_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Transform(const AVector: TVector): TVector;

  Result := TVector_sw.ToVar(TMatrix_sw(AObj).FValue.Transform(TVector_sw.
    FromVar(AArgs[0])));
end;
...
begin
  ...
  AData.AddFunction('Transform', TMatrix_Transform_si, TVector_sw, 1, False);
...
begin
  ...
  case AArgsSize of
    ...
    begin
      // Implicit parameterless constructor.
      Result := TPoint3D_sw.Create as IDispatch;
    end;
  else
    WrongArgCountError('Create');
  end;
...
function TPoint3D_Scale_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Scale(const AFactor: Single): TPoint3D;

  Result := TPoint3D_sw.ToVar(TPoint3D_sw(AObj).FValue.Scale(Single(AArgs[0])));
end;
...
function TPoint3D_Negative_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Negative: TPoint3D;

  Result := TPoint3D_sw.ToVar(TPoint3D_sw(AObj).FValue.Negative());
end;
...
begin
  ...
  AData.AddFunction('Scale', TPoint3D_Scale_si, TPoint3D_sw, 1, False);
  ...
  AData.AddFunction('Negative', TPoint3D_Negative_si, TPoint3D_sw, 0, False);
  AData.AddFunction('Copy', TPoint3D_Copy_si, TPoint3D_sw, 0, False);

  { Class members }

  AData.AddConstructor('Create', TPoint3D_Create_si, 0, True);
end;
...
begin
  ...
  case AArgsSize of
    ...
    begin
      // Implicit parameterless constructor.
      Result := TVector3D_sw.Create as IDispatch;
    end;
  else
    WrongArgCountError('Create');
  end;
...
begin
  ...
  TVector3D_sw(AObj).FValue.Normalize();
end;

function TVector3D_GetNormalize_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function GetNormalize: TVector3D;

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.GetNormalize());
end;

function TVector3D_AddVector3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure AddVector3D(const AVector3D: TVector3D);

  TVector3D_sw(AObj).FValue.AddVector3D(TVector3D_sw.FromVar(AArgs[0]));
end;
...
function TVector3D_AddScale_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function AddScale(const AValue: Single): TVector3D;

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.AddScale(Single(
    AArgs[0])));
end;

function TVector3D_Scale_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Scale(factor: Single): TVector3D;

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.Scale(Single(
    AArgs[0])));
end;

function TVector3D_PointProject_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function PointProject(const AOrigin: TVector3D; const ADi...

  Result := TVector3D_sw(AObj).FValue.PointProject(TVector3D_sw.FromVar(
    AArgs[0]), TVector3D_sw.FromVar(AArgs[1]));
end;
...
function TVector3D_CrossProduct_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function CrossProduct(const AVector3D: TVector3D): TVecto...

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.CrossProduct(
    TVector3D_sw.FromVar(AArgs[0])));
end;

function TVector3D_CalcPlaneNormal_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function CalcPlaneNormal(const AVector3D1: TVector3D; con...

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.CalcPlaneNormal(
    TVector3D_sw.FromVar(AArgs[0]), TVector3D_sw.FromVar(AArgs[1])));
end;
...
begin
  ...
  AData.AddProcedure('Normalize', TVector3D_Normalize_si, 0, False);
  AData.AddFunction('GetNormalize', TVector3D_GetNormalize_si, TVector3D_sw, 0, False);
  AData.AddProcedure('AddVector3D', TVector3D_AddVector3D_si, 1, False);
  ...
  AData.AddFunction('AddScale', TVector3D_AddScale_si, TVector3D_sw, 1, False);
  AData.AddFunction('Scale', TVector3D_Scale_si, TVector3D_sw, 1, False);
  AData.AddFunction('PointProject', TVector3D_PointProject_si, Single_sw, 2, False);
  ...
  AData.AddFunction('CalcPlaneNormal', TVector3D_CalcPlaneNormal_si, TVector3D_sw, 2, False);
  ...
  AData.AddConstructor('Create', TVector3D_Create_si, 0, True);
end;
...
function TMatrix3D_Scale_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Scale(const factor: single): TMatrix3D;

  Result := TMatrix3D_sw.ToVar(TMatrix3D_sw(AObj).FValue.Scale(single(
    AArgs[0])));
end;

function TMatrix3D_TransposeMatrix3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function TransposeMatrix3D(const AMatrix: TMatrix3D...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.TransposeMatrix3D(TMatrix3D_sw.FromVar(
    AArgs[0])));
end;

function TMatrix3D_ScaleMatrix3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function ScaleMatrix3D(const AMatrix: TMatrix3D; co...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.ScaleMatrix3D(TMatrix3D_sw.FromVar(
    AArgs[0]), single(AArgs[1])));
end;
...
begin
  ...
  AData.AddFunction('Scale', TMatrix3D_Scale_si, TMatrix3D_sw, 1, False);
  ...
  AData.AddClassFunction('TransposeMatrix3D', TMatrix3D_TransposeMatrix3D_si, TMatrix3D_sw, 1, False);
  AData.AddClassFunction('ScaleMatrix3D', TMatrix3D_ScaleMatrix3D_si, TMatrix3D_sw, 2, False);
  AData.AddConstructor('Create', TMatrix3D_Create_si, 0, False);
end;
...
function TQuaternion3D_ImagPart_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var ImagPart: TVector3D;

  if IsGet then
    Result := TVector3D_sw.ToVar(TQuaternion3D_sw(AObj).FValue.ImagPart)
  else
    TQuaternion3D_sw(AObj).FValue.ImagPart := TVector3D_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('ImagPart', TQuaternion3D_ImagPart_si, TVector3D_sw);
  ...
  AData.AddConstructor('Create', TQuaternion3D_Create_si, 0, False);
end;
