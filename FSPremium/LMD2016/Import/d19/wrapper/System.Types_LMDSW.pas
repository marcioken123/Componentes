...
type
  ...
  TDirection_sw = class(TLMDEnumWrapper)
  protected
    class function  GetTypeName: WideString; override;
    class procedure GetEnumerators(out AEnums: PLMDEnumerator;
                                   out ACount: Integer); override;
  public
    class function ToVar(const AValue: TDirection): OleVariant;
    class function FromVar(const AValue: OleVariant): TDirection;
  end;
  ...
  tagVECTOR_sw = class(TLMDRecordWrapper)
  private
    FValue: tagVECTOR;
  protected
    class function  GetTypeName: WideString; override;
    ...
    class procedure DoInit(AData: TLMDRecordWrapperData); override;
  public
    class function ToVar(const AValue: tagVECTOR): OleVariant;
    class function FromVar(const AValue: OleVariant): tagVECTOR;
  end;
  ...
  TPoint3D_sw = class(TLMDRecordWrapper)
  private
    FValue: TPoint3D;
  protected
    class function  GetTypeName: WideString; override;
    ...
    class procedure DoInit(AData: TLMDRecordWrapperData); override;
  public
    class function ToVar(const AValue: TPoint3D): OleVariant;
    class function FromVar(const AValue: OleVariant): TPoint3D;
  end;

  tagVECTOR3D_sw = class(TLMDRecordWrapper)
  private
    FValue: tagVECTOR3D;
  protected
    class function  GetTypeName: WideString; override;
    ...
    class procedure DoInit(AData: TLMDRecordWrapperData); override;
  public
    class function ToVar(const AValue: tagVECTOR3D): OleVariant;
    class function FromVar(const AValue: OleVariant): tagVECTOR3D;
  end;

  TVector3D_sw = class(TLMDRecordWrapper)
  private
    FValue: TVector3D;
  protected
    class function  GetTypeName: WideString; override;
    ...
    class procedure DoInit(AData: TLMDRecordWrapperData); override;
  public
    class function ToVar(const AValue: TVector3D): OleVariant;
    class function FromVar(const AValue: OleVariant): TVector3D;
  end;

  TMatrix3D_sw = class(TLMDRecordWrapper)
  private
    FValue: TMatrix3D;
  protected
    class function  GetTypeName: WideString; override;
    ...
    class procedure DoInit(AData: TLMDRecordWrapperData); override;
  public
    class function ToVar(const AValue: TMatrix3D): OleVariant;
    class function FromVar(const AValue: OleVariant): TMatrix3D;
  end;

  TQuaternion3D_sw = class(TLMDRecordWrapper)
  private
    FValue: TQuaternion3D;
  protected
    class function  GetTypeName: WideString; override;
    function        CloneVal: TLMDRecordWrapper; override;
    class procedure DoInit(AData: TLMDRecordWrapperData); override;
  public
    class function ToVar(const AValue: TQuaternion3D): OleVariant;
    class function FromVar(const AValue: OleVariant): TQuaternion3D;
  end;
...
class procedure TDuplicates_sw.GetEnumerators(out AEnums: PLMDEnumerator;
  out ACount: Integer);
const
  ENUMS: array[0..2] of TLMDEnumerator = (
    (Name: 'dupIgnore'; Value: Integer({$IFDEF LMDSCT_12}TDuplicates.{$ENDIF}dupIgnore)),
    (Name: 'dupAccept'; Value: Integer({$IFDEF LMDSCT_12}TDuplicates.{$ENDIF}dupAccept)),
    (Name: 'dupError'; Value: Integer({$IFDEF LMDSCT_12}TDuplicates.{$ENDIF}dupError))
  );
begin
  AEnums := @ENUMS;
  ACount := 3;
...
class function TDirection_sw.GetTypeName: WideString;
begin
  Result := 'TDirection';
end;

class procedure TDirection_sw.GetEnumerators(out AEnums: PLMDEnumerator;
  out ACount: Integer);
const
  ENUMS: array[0..1] of TLMDEnumerator = (
    (Name: 'FromBeginning'; Value: Integer({$IFDEF LMDSCT_12}TDirection.{$ENDIF}FromBeginning)),
    (Name: 'FromEnd'; Value: Integer({$IFDEF LMDSCT_12}TDirection.{$ENDIF}FromEnd))
  );
begin
  AEnums := @ENUMS;
  ACount := 2;
...
class function TDirection_sw.ToVar(const AValue: TDirection): OleVariant;
begin
  Result := Integer(AValue);
end;

class function TDirection_sw.FromVar(const AValue: OleVariant): TDirection;
begin
  Result := TDirection(Integer(AValue));
end;
...
function TPointF_CrossProduct_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function CrossProduct(const APoint: TPointF): Single;

  Result := TPointF_sw(AObj).FValue.CrossProduct(TPointF_sw.FromVar(AArgs[0]));
end;

function TPointF_DotProduct_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function DotProduct(const APoint: TPointF): Single;

  Result := TPointF_sw(AObj).FValue.DotProduct(TPointF_sw.FromVar(AArgs[0]));
end;
...
function TPointF_Scale_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Scale(const AFactor: Single): TPointF;

  Result := TPointF_sw.ToVar(TPointF_sw(AObj).FValue.Scale(Single(AArgs[0])));
end;
...
function TPointF_Normalize_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Normalize: TPointF;

  Result := TPointF_sw.ToVar(TPointF_sw(AObj).FValue.Normalize());
end;

function TPointF_Length_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Length: Single;

  Result := TPointF_sw(AObj).FValue.Length();
end;

function TPointF_Rotate_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Rotate(const AAngle: Single): TPointF;

  Result := TPointF_sw.ToVar(TPointF_sw(AObj).FValue.Rotate(Single(AArgs[0])));
end;

function TPointF_Reflect_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Reflect(const APoint: TPointF): TPointF;

  Result := TPointF_sw.ToVar(TPointF_sw(AObj).FValue.Reflect(TPointF_sw.FromVar(
    AArgs[0])));
end;

function TPointF_MidPoint_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function MidPoint(const APoint: TPointF): TPointF;

  Result := TPointF_sw.ToVar(TPointF_sw(AObj).FValue.MidPoint(TPointF_sw.
    FromVar(AArgs[0])));
end;

function TPointF_AngleCosine_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function AngleCosine(const APoint: TPointF): Single;

  Result := TPointF_sw(AObj).FValue.AngleCosine(TPointF_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  AData.AddFunction('Distance', TPointF_Distance_si, Single_sw, 1, False);
  AData.AddFunction('CrossProduct', TPointF_CrossProduct_si, Single_sw, 1, False);
  AData.AddFunction('DotProduct', TPointF_DotProduct_si, Single_sw, 1, False);
  ...
  AData.AddFunction('Scale', TPointF_Scale_si, TPointF_sw, 1, False);
  ...
  AData.AddFunction('Normalize', TPointF_Normalize_si, TPointF_sw, 0, False);
  AData.AddFunction('Length', TPointF_Length_si, Single_sw, 0, False);
  AData.AddFunction('Rotate', TPointF_Rotate_si, TPointF_sw, 1, False);
  AData.AddFunction('Reflect', TPointF_Reflect_si, TPointF_sw, 1, False);
  AData.AddFunction('MidPoint', TPointF_MidPoint_si, TPointF_sw, 1, False);
  AData.AddFunction('AngleCosine', TPointF_AngleCosine_si, Single_sw, 1, False);
  ...
  AData.AddConstructor('Create', TPointF_Create_si, 0, False);
end;
...
function TRectF_Fit_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // function Fit(BoundsRect: TRectF): Single;

  Result := TRectF_sw(AObj).FValue.Fit(TRectF_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  AData.AddFunction('Fit', TRectF_Fit_si, Single_sw, 1, False);
...
function tagVECTOR_X_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var X: Single;

  if IsGet then
    Result := tagVECTOR_sw(AObj).FValue.X
  else
    tagVECTOR_sw(AObj).FValue.X := Single(AArgs[0]);
end;

function tagVECTOR_Y_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var Y: Single;

  if IsGet then
    Result := tagVECTOR_sw(AObj).FValue.Y
  else
    tagVECTOR_sw(AObj).FValue.Y := Single(AArgs[0]);
end;

function tagVECTOR_W_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var W: Single;

  if IsGet then
    Result := tagVECTOR_sw(AObj).FValue.W
  else
    tagVECTOR_sw(AObj).FValue.W := Single(AArgs[0]);
end;

function tagVECTOR_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create;

  // Implicit parameterless constructor.
  Result := tagVECTOR_sw.Create as IDispatch;
end;

function tagVECTOR_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: tagVECTOR;

  // Implicit record copy method.
  Result := tagVECTOR_sw.ToVar(tagVECTOR(AObj));
end;

class function tagVECTOR_sw.GetTypeName: WideString;
begin
  Result := 'tagVECTOR';
end;

function tagVECTOR_sw.CloneVal: TLMDRecordWrapper;
begin
  Result := tagVECTOR_sw.Create;
  tagVECTOR_sw(Result).FValue := FValue;
end;

class procedure tagVECTOR_sw.DoInit(AData: TLMDRecordWrapperData);
begin
  { Instance members }

  AData.AddField('X', tagVECTOR_X_si, Single_sw);
  AData.AddField('Y', tagVECTOR_Y_si, Single_sw);
  AData.AddField('W', tagVECTOR_W_si, Single_sw);
  AData.AddFunction('Copy', tagVECTOR_Copy_si, tagVECTOR_sw, 0, False);

  { Class members }

  AData.AddConstructor('Create', tagVECTOR_Create_si, 0, False);
end;

class function tagVECTOR_sw.ToVar(const AValue: tagVECTOR): OleVariant;
var
  wrpr: tagVECTOR_sw;
begin
  wrpr        := tagVECTOR_sw.Create;
  wrpr.FValue := AValue;
  
  Result := ConvToVar(wrpr);
end;

class function tagVECTOR_sw.FromVar(const AValue: OleVariant): tagVECTOR;
begin
  Result := tagVECTOR_sw(ConvFromVar(AValue)).FValue;
end;
...
begin
  ...
  case AArgsSize of
    3:
    begin
      Result := TVector_sw.ToVar(TVector.Create(Single(AArgs[0]), Single(
        AArgs[1]), Single(AArgs[2])));
    end;
    1:
    begin
      Result := TVector_sw.ToVar(TVector.Create(TPointF_sw.FromVar(AArgs[0])));
    end;
  else
    WrongArgCountError('Create');
  end;
...
function TVector_Offset_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Offset(...); overload;
  ...
  case AArgsSize of
    1:
    begin
      TVector_sw(AObj).FValue.Offset(TPointF_sw.FromVar(AArgs[0]));
    end;
    2:
    begin
      TVector_sw(AObj).FValue.Offset(Single(AArgs[0]), Single(AArgs[1]));
    end;
  else
    WrongArgCountError('Offset');
  end;
...
function TVector_CrossProduct_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function CrossProduct(const AVector: TVector): Single;

  Result := TVector_sw(AObj).FValue.CrossProduct(TVector_sw.FromVar(AArgs[0]));
end;

function TVector_DotProduct_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function DotProduct(const AVector: TVector): Single;

  Result := TVector_sw(AObj).FValue.DotProduct(TVector_sw.FromVar(AArgs[0]));
end;

function TVector_Length_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Length: Single;

  Result := TVector_sw(AObj).FValue.Length();
end;

function TVector_Normalize_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Normalize: TVector;

  Result := TVector_sw.ToVar(TVector_sw(AObj).FValue.Normalize());
end;

function TVector_Rotate_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Rotate(const AAngle: Single): TVector;

  Result := TVector_sw.ToVar(TVector_sw(AObj).FValue.Rotate(Single(AArgs[0])));
end;

function TVector_Reflect_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Reflect(const AVector: TVector): TVector;

  Result := TVector_sw.ToVar(TVector_sw(AObj).FValue.Reflect(TVector_sw.FromVar(
    AArgs[0])));
end;

function TVector_MidVector_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function MidVector(const AVector: TVector): TVector;

  Result := TVector_sw.ToVar(TVector_sw(AObj).FValue.MidVector(TVector_sw.
    FromVar(AArgs[0])));
end;

function TVector_AngleCosine_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function AngleCosine(const AVector: TVector): Single;

  Result := TVector_sw(AObj).FValue.AngleCosine(TVector_sw.FromVar(AArgs[0]));
end;

function TVector_ToPointF_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function ToPointF: TPointF;

  Result := TPointF_sw.ToVar(TVector_sw(AObj).FValue.ToPointF());
end;
...
begin
  ...
  AData.AddProcedure('Offset', TVector_Offset_si, 1, True);
  AData.AddFunction('CrossProduct', TVector_CrossProduct_si, Single_sw, 1, False);
  AData.AddFunction('DotProduct', TVector_DotProduct_si, Single_sw, 1, False);
  AData.AddFunction('Length', TVector_Length_si, Single_sw, 0, False);
  AData.AddFunction('Normalize', TVector_Normalize_si, TVector_sw, 0, False);
  AData.AddFunction('Rotate', TVector_Rotate_si, TVector_sw, 1, False);
  AData.AddFunction('Reflect', TVector_Reflect_si, TVector_sw, 1, False);
  AData.AddFunction('MidVector', TVector_MidVector_si, TVector_sw, 1, False);
  AData.AddFunction('AngleCosine', TVector_AngleCosine_si, Single_sw, 1, False);
  AData.AddFunction('ToPointF', TVector_ToPointF_si, TPointF_sw, 0, False);
  ...
  AData.AddClassFunction('Create', TVector_Create_si, nil, 1, True);
end;
...
function TMatrix_CreateRotation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateRotation(const AAngle: Single): TMat...

  Result := TMatrix_sw.ToVar(TMatrix.CreateRotation(Single(AArgs[0])));
end;

function TMatrix_CreateScaling_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateScaling(const AScaleX: Single; const...

  Result := TMatrix_sw.ToVar(TMatrix.CreateScaling(Single(AArgs[0]), Single(
    AArgs[1])));
end;

function TMatrix_CreateTranslation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateTranslation(const ADeltaX: Single; c...

  Result := TMatrix_sw.ToVar(TMatrix.CreateTranslation(Single(AArgs[0]), Single(
    AArgs[1])));
end;

function TMatrix_Determinant_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Determinant: Single;

  Result := TMatrix_sw(AObj).FValue.Determinant();
end;

function TMatrix_Adjoint_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Adjoint: TMatrix;

  Result := TMatrix_sw.ToVar(TMatrix_sw(AObj).FValue.Adjoint());
end;

function TMatrix_Inverse_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Inverse: TMatrix;

  Result := TMatrix_sw.ToVar(TMatrix_sw(AObj).FValue.Inverse());
end;
...
begin
  ...
  AData.AddFunction('Determinant', TMatrix_Determinant_si, Single_sw, 0, False);
  AData.AddFunction('Adjoint', TMatrix_Adjoint_si, TMatrix_sw, 0, False);
  AData.AddFunction('Inverse', TMatrix_Inverse_si, TMatrix_sw, 0, False);
  ...
  AData.AddClassFunction('CreateRotation', TMatrix_CreateRotation_si, TMatrix_sw, 1, False);
  AData.AddClassFunction('CreateScaling', TMatrix_CreateScaling_si, TMatrix_sw, 2, False);
  AData.AddClassFunction('CreateTranslation', TMatrix_CreateTranslation_si, TMatrix_sw, 2, False);
...
function TPoint3D_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Create(...); overload;
  ...
  case AArgsSize of
    3:
    begin
      Result := TPoint3D_sw.ToVar(TPoint3D.Create(Single(AArgs[0]), Single(
        AArgs[1]), Single(AArgs[2])));
    end;
    1:
    begin
      Result := TPoint3D_sw.ToVar(TPoint3D.Create(TPointF_sw.FromVar(
        AArgs[0])));
    end;
    2:
    begin
      Result := TPoint3D_sw.ToVar(TPoint3D.Create(TPointF_sw.FromVar(AArgs[0]), 
        Single(AArgs[1])));
    end;
  else
    WrongArgCountError('Create');
...
function TPoint3D_Offset_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Offset(...); overload;
  ...
  case AArgsSize of
    1:
    begin
      TPoint3D_sw(AObj).FValue.Offset(TPoint3D_sw.FromVar(AArgs[0]));
    end;
    3:
    begin
      TPoint3D_sw(AObj).FValue.Offset(Single(AArgs[0]), Single(AArgs[1]), 
        Single(AArgs[2]));
    end;
  else
    WrongArgCountError('Offset');
...
function TPoint3D_CrossProduct_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function CrossProduct(const APoint: TPoint3D): TPoint3D;

  Result := TPoint3D_sw.ToVar(TPoint3D_sw(AObj).FValue.CrossProduct(TPoint3D_sw.
    FromVar(AArgs[0])));
end;

function TPoint3D_DotProduct_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function DotProduct(const APoint: TPoint3D): Single;

  Result := TPoint3D_sw(AObj).FValue.DotProduct(TPoint3D_sw.FromVar(AArgs[0]));
end;

function TPoint3D_Length_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Length: Single;

  Result := TPoint3D_sw(AObj).FValue.Length();
end;

function TPoint3D_Normalize_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Normalize: TPoint3D;

  Result := TPoint3D_sw.ToVar(TPoint3D_sw(AObj).FValue.Normalize());
end;

function TPoint3D_Distance_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Distance(const APoint: TPoint3D): Single;

  Result := TPoint3D_sw(AObj).FValue.Distance(TPoint3D_sw.FromVar(AArgs[0]));
end;

function TPoint3D_Rotate_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Rotate(const AAxis: TPoint3D; const AAngle: Sing...

  Result := TPoint3D_sw.ToVar(TPoint3D_sw(AObj).FValue.Rotate(TPoint3D_sw.
    FromVar(AArgs[0]), Single(AArgs[1])));
end;

function TPoint3D_Reflect_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Reflect(const APoint: TPoint3D): TPoint3D;

  Result := TPoint3D_sw.ToVar(TPoint3D_sw(AObj).FValue.Reflect(TPoint3D_sw.
    FromVar(AArgs[0])));
end;

function TPoint3D_MidPoint_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function MidPoint(const APoint: TPoint3D): TPoint3D;

  Result := TPoint3D_sw.ToVar(TPoint3D_sw(AObj).FValue.MidPoint(TPoint3D_sw.
    FromVar(AArgs[0])));
end;

function TPoint3D_AngleCosine_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function AngleCosine(const APoint: TPoint3D): Single;

  Result := TPoint3D_sw(AObj).FValue.AngleCosine(TPoint3D_sw.FromVar(AArgs[0]));
end;

function TPoint3D_X_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var X: Single;

  if IsGet then
    Result := TPoint3D_sw(AObj).FValue.X
  else
    TPoint3D_sw(AObj).FValue.X := Single(AArgs[0]);
end;

function TPoint3D_Y_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var Y: Single;

  if IsGet then
    Result := TPoint3D_sw(AObj).FValue.Y
  else
    TPoint3D_sw(AObj).FValue.Y := Single(AArgs[0]);
end;

function TPoint3D_Z_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var Z: Single;

  if IsGet then
    Result := TPoint3D_sw(AObj).FValue.Z
  else
    TPoint3D_sw(AObj).FValue.Z := Single(AArgs[0]);
end;

function TPoint3D_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: TPoint3D;

  // Implicit record copy method.
  Result := TPoint3D_sw.ToVar(TPoint3D(AObj));
end;

class function TPoint3D_sw.GetTypeName: WideString;
begin
  Result := 'TPoint3D';
end;

function TPoint3D_sw.CloneVal: TLMDRecordWrapper;
begin
  Result := TPoint3D_sw.Create;
  TPoint3D_sw(Result).FValue := FValue;
end;

class procedure TPoint3D_sw.DoInit(AData: TLMDRecordWrapperData);
begin
  { Instance members }

  AData.AddProcedure('Offset', TPoint3D_Offset_si, 1, True);
  AData.AddFunction('CrossProduct', TPoint3D_CrossProduct_si, TPoint3D_sw, 1, False);
  AData.AddFunction('DotProduct', TPoint3D_DotProduct_si, Single_sw, 1, False);
  AData.AddFunction('Length', TPoint3D_Length_si, Single_sw, 0, False);
  AData.AddFunction('Normalize', TPoint3D_Normalize_si, TPoint3D_sw, 0, False);
  AData.AddFunction('Distance', TPoint3D_Distance_si, Single_sw, 1, False);
  AData.AddFunction('Rotate', TPoint3D_Rotate_si, TPoint3D_sw, 2, False);
  AData.AddFunction('Reflect', TPoint3D_Reflect_si, TPoint3D_sw, 1, False);
  AData.AddFunction('MidPoint', TPoint3D_MidPoint_si, TPoint3D_sw, 1, False);
  AData.AddFunction('AngleCosine', TPoint3D_AngleCosine_si, Single_sw, 1, False);
  AData.AddField('X', TPoint3D_X_si, Single_sw);
  AData.AddField('Y', TPoint3D_Y_si, Single_sw);
  AData.AddField('Z', TPoint3D_Z_si, Single_sw);
  AData.AddFunction('Copy', TPoint3D_Copy_si, TPoint3D_sw, 0, False);

  { Class members }

  AData.AddClassFunction('Create', TPoint3D_Create_si, nil, 1, True);
end;

class function TPoint3D_sw.ToVar(const AValue: TPoint3D): OleVariant;
var
  wrpr: TPoint3D_sw;
begin
  wrpr        := TPoint3D_sw.Create;
  wrpr.FValue := AValue;
  
  Result := ConvToVar(wrpr);
end;

class function TPoint3D_sw.FromVar(const AValue: OleVariant): TPoint3D;
begin
  Result := TPoint3D_sw(ConvFromVar(AValue)).FValue;
end;

{ tagVECTOR3D_sw }

function tagVECTOR3D_X_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var X: Single;

  if IsGet then
    Result := tagVECTOR3D_sw(AObj).FValue.X
  else
    tagVECTOR3D_sw(AObj).FValue.X := Single(AArgs[0]);
end;

function tagVECTOR3D_Y_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var Y: Single;

  if IsGet then
    Result := tagVECTOR3D_sw(AObj).FValue.Y
  else
    tagVECTOR3D_sw(AObj).FValue.Y := Single(AArgs[0]);
end;

function tagVECTOR3D_Z_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var Z: Single;

  if IsGet then
    Result := tagVECTOR3D_sw(AObj).FValue.Z
  else
    tagVECTOR3D_sw(AObj).FValue.Z := Single(AArgs[0]);
end;

function tagVECTOR3D_W_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var W: Single;

  if IsGet then
    Result := tagVECTOR3D_sw(AObj).FValue.W
  else
    tagVECTOR3D_sw(AObj).FValue.W := Single(AArgs[0]);
end;

function tagVECTOR3D_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create;

  // Implicit parameterless constructor.
  Result := tagVECTOR3D_sw.Create as IDispatch;
end;

function tagVECTOR3D_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: tagVECTOR3D;

  // Implicit record copy method.
  Result := tagVECTOR3D_sw.ToVar(tagVECTOR3D(AObj));
end;

class function tagVECTOR3D_sw.GetTypeName: WideString;
begin
  Result := 'tagVECTOR3D';
end;

function tagVECTOR3D_sw.CloneVal: TLMDRecordWrapper;
begin
  Result := tagVECTOR3D_sw.Create;
  tagVECTOR3D_sw(Result).FValue := FValue;
end;

class procedure tagVECTOR3D_sw.DoInit(AData: TLMDRecordWrapperData);
begin
  { Instance members }

  AData.AddField('X', tagVECTOR3D_X_si, Single_sw);
  AData.AddField('Y', tagVECTOR3D_Y_si, Single_sw);
  AData.AddField('Z', tagVECTOR3D_Z_si, Single_sw);
  AData.AddField('W', tagVECTOR3D_W_si, Single_sw);
  AData.AddFunction('Copy', tagVECTOR3D_Copy_si, tagVECTOR3D_sw, 0, False);

  { Class members }

  AData.AddConstructor('Create', tagVECTOR3D_Create_si, 0, False);
end;

class function tagVECTOR3D_sw.ToVar(const AValue: tagVECTOR3D): OleVariant;
var
  wrpr: tagVECTOR3D_sw;
begin
  wrpr        := tagVECTOR3D_sw.Create;
  wrpr.FValue := AValue;
  
  Result := ConvToVar(wrpr);
end;

class function tagVECTOR3D_sw.FromVar(const AValue: OleVariant): tagVECTOR3D;
begin
  Result := tagVECTOR3D_sw(ConvFromVar(AValue)).FValue;
end;

{ TVector3D_sw }

function TVector3D_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Create(...); overload;
  ...
  case AArgsSize of
    3:
    begin
      Result := TVector3D_sw.ToVar(TVector3D.Create(Single(AArgs[0]), Single(
        AArgs[1]), Single(AArgs[2])));
    end;
    4:
    begin
    ...
    1:
    begin
      Result := TVector3D_sw.ToVar(TVector3D.Create(TPoint3D_sw.FromVar(
        AArgs[0])));
    end;
    2:
    begin
      Result := TVector3D_sw.ToVar(TVector3D.Create(TPoint3D_sw.FromVar(
        AArgs[0]), Single(AArgs[1])));
    end;
  else
    WrongArgCountError('Create');
  end;
...
function TVector3D_Offset_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Offset(...); overload;
  ...
  case AArgsSize of
    1:
    begin
      TVector3D_sw(AObj).FValue.Offset(TPoint3D_sw.FromVar(AArgs[0]));
    end;
    3:
    begin
      TVector3D_sw(AObj).FValue.Offset(Single(AArgs[0]), Single(AArgs[1]), 
        Single(AArgs[2]));
    end;
  else
    WrongArgCountError('Offset');
...
function TVector3D_CrossProduct_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function CrossProduct(const AVector: TVector3D): TVector3D;

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.CrossProduct(
    TVector3D_sw.FromVar(AArgs[0])));
end;

function TVector3D_DotProduct_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function DotProduct(const AVector: TVector3D): Single;

  Result := TVector3D_sw(AObj).FValue.DotProduct(TVector3D_sw.FromVar(
    AArgs[0]));
end;

function TVector3D_Length_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Length: Single;

  Result := TVector3D_sw(AObj).FValue.Length();
end;

function TVector3D_Normalize_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Normalize: TVector3D;

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.Normalize());
end;

function TVector3D_Distance_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Distance(const AVector: TVector3D): Single;

  Result := TVector3D_sw(AObj).FValue.Distance(TVector3D_sw.FromVar(AArgs[0]));
end;

function TVector3D_Rotate_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Rotate(const AAxis: TPoint3D; const AAngle: Sing...

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.Rotate(TPoint3D_sw.
    FromVar(AArgs[0]), Single(AArgs[1])));
end;

function TVector3D_Reflect_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Reflect(const AVector: TVector3D): TVector3D;

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.Reflect(TVector3D_sw.
    FromVar(AArgs[0])));
end;

function TVector3D_MidVector_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function MidVector(const AVector: TVector3D): TVector3D;

  Result := TVector3D_sw.ToVar(TVector3D_sw(AObj).FValue.MidVector(TVector3D_sw.
    FromVar(AArgs[0])));
end;

function TVector3D_AngleCosine_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function AngleCosine(const AVector: TVector3D): Single;

  Result := TVector3D_sw(AObj).FValue.AngleCosine(TVector3D_sw.FromVar(
    AArgs[0]));
end;

function TVector3D_ToPoint3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function ToPoint3D(const ATransform: Boolean): TPoint3D;

  case AArgsSize of
    0:
    begin
      Result := TPoint3D_sw.ToVar(TVector3D_sw(AObj).FValue.ToPoint3D());
    end;
    1:
    begin
      Result := TPoint3D_sw.ToVar(TVector3D_sw(AObj).FValue.ToPoint3D(Boolean(
        AArgs[0])));
    end;
  else
    WrongArgCountError('ToPoint3D');
  end;
end;

function TVector3D_X_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var X: Single;

  if IsGet then
    Result := TVector3D_sw(AObj).FValue.X
  else
    TVector3D_sw(AObj).FValue.X := Single(AArgs[0]);
end;

function TVector3D_Y_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var Y: Single;

  if IsGet then
    Result := TVector3D_sw(AObj).FValue.Y
  else
    TVector3D_sw(AObj).FValue.Y := Single(AArgs[0]);
end;

function TVector3D_Z_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var Z: Single;

  if IsGet then
    Result := TVector3D_sw(AObj).FValue.Z
  else
    TVector3D_sw(AObj).FValue.Z := Single(AArgs[0]);
end;

function TVector3D_W_si(var AObj; const AArgs: TLMDDispArgs; AArgsSize: Integer;
  IsGet: Boolean): OleVariant;
begin
  // var W: Single;

  if IsGet then
    Result := TVector3D_sw(AObj).FValue.W
  else
    TVector3D_sw(AObj).FValue.W := Single(AArgs[0]);
end;

function TVector3D_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: TVector3D;

  // Implicit record copy method.
  Result := TVector3D_sw.ToVar(TVector3D(AObj));
end;

class function TVector3D_sw.GetTypeName: WideString;
begin
  Result := 'TVector3D';
end;

function TVector3D_sw.CloneVal: TLMDRecordWrapper;
begin
  Result := TVector3D_sw.Create;
  TVector3D_sw(Result).FValue := FValue;
end;

class procedure TVector3D_sw.DoInit(AData: TLMDRecordWrapperData);
begin
  { Instance members }

  AData.AddProcedure('Offset', TVector3D_Offset_si, 1, True);
  AData.AddFunction('CrossProduct', TVector3D_CrossProduct_si, TVector3D_sw, 1, False);
  AData.AddFunction('DotProduct', TVector3D_DotProduct_si, Single_sw, 1, False);
  AData.AddFunction('Length', TVector3D_Length_si, Single_sw, 0, False);
  AData.AddFunction('Normalize', TVector3D_Normalize_si, TVector3D_sw, 0, False);
  AData.AddFunction('Distance', TVector3D_Distance_si, Single_sw, 1, False);
  AData.AddFunction('Rotate', TVector3D_Rotate_si, TVector3D_sw, 2, False);
  AData.AddFunction('Reflect', TVector3D_Reflect_si, TVector3D_sw, 1, False);
  AData.AddFunction('MidVector', TVector3D_MidVector_si, TVector3D_sw, 1, False);
  AData.AddFunction('AngleCosine', TVector3D_AngleCosine_si, Single_sw, 1, False);
  AData.AddFunction('ToPoint3D', TVector3D_ToPoint3D_si, TPoint3D_sw, 0, True);
  AData.AddField('X', TVector3D_X_si, Single_sw);
  AData.AddField('Y', TVector3D_Y_si, Single_sw);
  AData.AddField('Z', TVector3D_Z_si, Single_sw);
  AData.AddField('W', TVector3D_W_si, Single_sw);
  AData.AddFunction('Copy', TVector3D_Copy_si, TVector3D_sw, 0, False);

  { Class members }

  AData.AddClassFunction('Create', TVector3D_Create_si, nil, 1, True);
end;

class function TVector3D_sw.ToVar(const AValue: TVector3D): OleVariant;
var
  wrpr: TVector3D_sw;
begin
  wrpr        := TVector3D_sw.Create;
  wrpr.FValue := AValue;
  
  Result := ConvToVar(wrpr);
end;

class function TVector3D_sw.FromVar(const AValue: OleVariant): TVector3D;
begin
  Result := TVector3D_sw(ConvFromVar(AValue)).FValue;
end;

{ TMatrix3D_sw }

function TMatrix3D_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Create(...); overload;
  ...
  case AArgsSize of
    16:
    begin
      Result := TMatrix3D_sw.ToVar(TMatrix3D.Create(Single(AArgs[0]), Single(
        AArgs[1]), Single(AArgs[2]), Single(AArgs[3]), Single(AArgs[4]), Single(
        AArgs[5]), Single(AArgs[6]), Single(AArgs[7]), Single(AArgs[8]), Single(
        AArgs[9]), Single(AArgs[10]), Single(AArgs[11]), Single(AArgs[12]),
        Single(AArgs[13]), Single(AArgs[14]), Single(AArgs[15])));
    end;
    0:
    begin
      // Implicit parameterless constructor.
      Result := TMatrix3D_sw.Create as IDispatch;
    end;
  else
    WrongArgCountError('Create');
  end;
...
function TMatrix3D_CreateScaling_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateScaling(const AScale: TPoint3D): TMa...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateScaling(TPoint3D_sw.FromVar(
    AArgs[0])));
end;

function TMatrix3D_CreateTranslation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateTranslation(const ATranslation: TPoi...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateTranslation(TPoint3D_sw.FromVar(
    AArgs[0])));
end;

function TMatrix3D_CreateRotationX_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateRotationX(const AAngle: Single): TMa...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateRotationX(Single(AArgs[0])));
end;

function TMatrix3D_CreateRotationY_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateRotationY(const AAngle: Single): TMa...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateRotationY(Single(AArgs[0])));
end;

function TMatrix3D_CreateRotationZ_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateRotationZ(const AAngle: Single): TMa...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateRotationZ(Single(AArgs[0])));
end;

function TMatrix3D_CreateRotation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateRotation(const AAxis: TPoint3D; cons...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateRotation(TPoint3D_sw.FromVar(
    AArgs[0]), Single(AArgs[1])));
end;

function TMatrix3D_CreateRotationYawPitchRoll_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateRotationYawPitchRoll(const AYaw: Sin...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateRotationYawPitchRoll(Single(
    AArgs[0]), Single(AArgs[1]), Single(AArgs[2])));
end;

function TMatrix3D_CreateRotationHeadingPitchBank_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateRotationHeadingPitchBank(const AHead...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateRotationHeadingPitchBank(Single(
    AArgs[0]), Single(AArgs[1]), Single(AArgs[2])));
end;

function TMatrix3D_CreateLookAtRH_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateLookAtRH(const ASource: TPoint3D; co...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateLookAtRH(TPoint3D_sw.FromVar(
    AArgs[0]), TPoint3D_sw.FromVar(AArgs[1]), TPoint3D_sw.FromVar(AArgs[2])));
end;

function TMatrix3D_CreateLookAtLH_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateLookAtLH(const ASource: TPoint3D; co...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateLookAtLH(TPoint3D_sw.FromVar(
    AArgs[0]), TPoint3D_sw.FromVar(AArgs[1]), TPoint3D_sw.FromVar(AArgs[2])));
end;

function TMatrix3D_CreateLookAtDirRH_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateLookAtDirRH(const ASource: TPoint3D;...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateLookAtDirRH(TPoint3D_sw.FromVar(
    AArgs[0]), TPoint3D_sw.FromVar(AArgs[1]), TPoint3D_sw.FromVar(AArgs[2])));
end;

function TMatrix3D_CreateLookAtDirLH_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateLookAtDirLH(const ASource: TPoint3D;...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateLookAtDirLH(TPoint3D_sw.FromVar(
    AArgs[0]), TPoint3D_sw.FromVar(AArgs[1]), TPoint3D_sw.FromVar(AArgs[2])));
end;

function TMatrix3D_CreateOrthoLH_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateOrthoLH(const AWidth: Single; const ...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateOrthoLH(Single(AArgs[0]), Single(
    AArgs[1]), Single(AArgs[2]), Single(AArgs[3])));
end;

function TMatrix3D_CreateOrthoRH_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateOrthoRH(const AWidth: Single; const ...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateOrthoRH(Single(AArgs[0]), Single(
    AArgs[1]), Single(AArgs[2]), Single(AArgs[3])));
end;

function TMatrix3D_CreateOrthoOffCenterLH_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateOrthoOffCenterLH(const ALeft: Single...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateOrthoOffCenterLH(Single(
    AArgs[0]), Single(AArgs[1]), Single(AArgs[2]), Single(AArgs[3]), Single(
    AArgs[4]), Single(AArgs[5])));
end;

function TMatrix3D_CreateOrthoOffCenterRH_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreateOrthoOffCenterRH(const ALeft: Single...

  Result := TMatrix3D_sw.ToVar(TMatrix3D.CreateOrthoOffCenterRH(Single(
    AArgs[0]), Single(AArgs[1]), Single(AArgs[2]), Single(AArgs[3]), Single(
    AArgs[4]), Single(AArgs[5])));
end;

function TMatrix3D_CreatePerspectiveFovLH_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreatePerspectiveFovLH(const AFOV: Single;...

  case AArgsSize of
    4:
    begin
      Result := TMatrix3D_sw.ToVar(TMatrix3D.CreatePerspectiveFovLH(Single(
        AArgs[0]), Single(AArgs[1]), Single(AArgs[2]), Single(AArgs[3])));
    end;
    5:
    begin
      Result := TMatrix3D_sw.ToVar(TMatrix3D.CreatePerspectiveFovLH(Single(
        AArgs[0]), Single(AArgs[1]), Single(AArgs[2]), Single(AArgs[3]), Boolean(
        AArgs[4])));
    end;
  else
    WrongArgCountError('CreatePerspectiveFovLH');
  end;
end;

function TMatrix3D_CreatePerspectiveFovRH_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // class function CreatePerspectiveFovRH(const AFOV: Single;...

  case AArgsSize of
    4:
    begin
      Result := TMatrix3D_sw.ToVar(TMatrix3D.CreatePerspectiveFovRH(Single(
        AArgs[0]), Single(AArgs[1]), Single(AArgs[2]), Single(AArgs[3])));
    end;
    5:
    begin
    ...
    WrongArgCountError('CreatePerspectiveFovRH');
  end;
end;

function TMatrix3D_Transpose_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Transpose: TMatrix3D;

  Result := TMatrix3D_sw.ToVar(TMatrix3D_sw(AObj).FValue.Transpose());
end;

function TMatrix3D_Determinant_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Determinant: Single;

  Result := TMatrix3D_sw(AObj).FValue.Determinant();
end;

function TMatrix3D_Adjoint_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Adjoint: TMatrix3D;

  Result := TMatrix3D_sw.ToVar(TMatrix3D_sw(AObj).FValue.Adjoint());
end;

function TMatrix3D_Inverse_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Inverse: TMatrix3D;

  Result := TMatrix3D_sw.ToVar(TMatrix3D_sw(AObj).FValue.Inverse());
end;

function TMatrix3D_EyePosition_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function EyePosition: TPoint3D;

  Result := TPoint3D_sw.ToVar(TMatrix3D_sw(AObj).FValue.EyePosition());
end;

function TMatrix3D_m11_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m11: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m11
  else
    TMatrix3D_sw(AObj).FValue.m11 := Single(AArgs[0]);
end;

function TMatrix3D_m12_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m12: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m12
  else
    TMatrix3D_sw(AObj).FValue.m12 := Single(AArgs[0]);
end;

function TMatrix3D_m13_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m13: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m13
  else
    TMatrix3D_sw(AObj).FValue.m13 := Single(AArgs[0]);
end;

function TMatrix3D_m14_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m14: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m14
  else
    TMatrix3D_sw(AObj).FValue.m14 := Single(AArgs[0]);
end;

function TMatrix3D_m21_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m21: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m21
  else
    TMatrix3D_sw(AObj).FValue.m21 := Single(AArgs[0]);
end;

function TMatrix3D_m22_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m22: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m22
  else
    TMatrix3D_sw(AObj).FValue.m22 := Single(AArgs[0]);
end;

function TMatrix3D_m23_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m23: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m23
  else
    TMatrix3D_sw(AObj).FValue.m23 := Single(AArgs[0]);
end;

function TMatrix3D_m24_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m24: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m24
  else
    TMatrix3D_sw(AObj).FValue.m24 := Single(AArgs[0]);
end;

function TMatrix3D_m31_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m31: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m31
  else
    TMatrix3D_sw(AObj).FValue.m31 := Single(AArgs[0]);
end;

function TMatrix3D_m32_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m32: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m32
  else
    TMatrix3D_sw(AObj).FValue.m32 := Single(AArgs[0]);
end;

function TMatrix3D_m33_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m33: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m33
  else
    TMatrix3D_sw(AObj).FValue.m33 := Single(AArgs[0]);
end;

function TMatrix3D_m34_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m34: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m34
  else
    TMatrix3D_sw(AObj).FValue.m34 := Single(AArgs[0]);
end;

function TMatrix3D_m41_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m41: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m41
  else
    TMatrix3D_sw(AObj).FValue.m41 := Single(AArgs[0]);
end;

function TMatrix3D_m42_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m42: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m42
  else
    TMatrix3D_sw(AObj).FValue.m42 := Single(AArgs[0]);
end;

function TMatrix3D_m43_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m43: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m43
  else
    TMatrix3D_sw(AObj).FValue.m43 := Single(AArgs[0]);
end;

function TMatrix3D_m44_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var m44: Single;

  if IsGet then
    Result := TMatrix3D_sw(AObj).FValue.m44
  else
    TMatrix3D_sw(AObj).FValue.m44 := Single(AArgs[0]);
end;

function TMatrix3D_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: TMatrix3D;

  // Implicit record copy method.
  Result := TMatrix3D_sw.ToVar(TMatrix3D(AObj));
end;

class function TMatrix3D_sw.GetTypeName: WideString;
begin
  Result := 'TMatrix3D';
end;

function TMatrix3D_sw.CloneVal: TLMDRecordWrapper;
begin
  Result := TMatrix3D_sw.Create;
  TMatrix3D_sw(Result).FValue := FValue;
end;

class procedure TMatrix3D_sw.DoInit(AData: TLMDRecordWrapperData);
begin
  { Instance members }

  AData.AddFunction('Transpose', TMatrix3D_Transpose_si, TMatrix3D_sw, 0, False);
  AData.AddFunction('Determinant', TMatrix3D_Determinant_si, Single_sw, 0, False);
  AData.AddFunction('Adjoint', TMatrix3D_Adjoint_si, TMatrix3D_sw, 0, False);
  AData.AddFunction('Inverse', TMatrix3D_Inverse_si, TMatrix3D_sw, 0, False);
  AData.AddFunction('EyePosition', TMatrix3D_EyePosition_si, TPoint3D_sw, 0, False);
  AData.AddField('m11', TMatrix3D_m11_si, Single_sw);
  AData.AddField('m12', TMatrix3D_m12_si, Single_sw);
  AData.AddField('m13', TMatrix3D_m13_si, Single_sw);
  AData.AddField('m14', TMatrix3D_m14_si, Single_sw);
  AData.AddField('m21', TMatrix3D_m21_si, Single_sw);
  AData.AddField('m22', TMatrix3D_m22_si, Single_sw);
  AData.AddField('m23', TMatrix3D_m23_si, Single_sw);
  AData.AddField('m24', TMatrix3D_m24_si, Single_sw);
  AData.AddField('m31', TMatrix3D_m31_si, Single_sw);
  AData.AddField('m32', TMatrix3D_m32_si, Single_sw);
  AData.AddField('m33', TMatrix3D_m33_si, Single_sw);
  AData.AddField('m34', TMatrix3D_m34_si, Single_sw);
  AData.AddField('m41', TMatrix3D_m41_si, Single_sw);
  AData.AddField('m42', TMatrix3D_m42_si, Single_sw);
  AData.AddField('m43', TMatrix3D_m43_si, Single_sw);
  AData.AddField('m44', TMatrix3D_m44_si, Single_sw);
  AData.AddFunction('Copy', TMatrix3D_Copy_si, TMatrix3D_sw, 0, False);

  { Class members }

  AData.AddConstructor('Create', TMatrix3D_Create_si, 0, True);
  AData.AddClassFunction('CreateScaling', TMatrix3D_CreateScaling_si, TMatrix3D_sw, 1, False);
  AData.AddClassFunction('CreateTranslation', TMatrix3D_CreateTranslation_si, TMatrix3D_sw, 1, False);
  AData.AddClassFunction('CreateRotationX', TMatrix3D_CreateRotationX_si, TMatrix3D_sw, 1, False);
  AData.AddClassFunction('CreateRotationY', TMatrix3D_CreateRotationY_si, TMatrix3D_sw, 1, False);
  AData.AddClassFunction('CreateRotationZ', TMatrix3D_CreateRotationZ_si, TMatrix3D_sw, 1, False);
  AData.AddClassFunction('CreateRotation', TMatrix3D_CreateRotation_si, TMatrix3D_sw, 2, False);
  AData.AddClassFunction('CreateRotationYawPitchRoll', TMatrix3D_CreateRotationYawPitchRoll_si, TMatrix3D_sw, 3, False);
  AData.AddClassFunction('CreateRotationHeadingPitchBank', TMatrix3D_CreateRotationHeadingPitchBank_si, TMatrix3D_sw, 3, False);
  AData.AddClassFunction('CreateLookAtRH', TMatrix3D_CreateLookAtRH_si, TMatrix3D_sw, 3, False);
  AData.AddClassFunction('CreateLookAtLH', TMatrix3D_CreateLookAtLH_si, TMatrix3D_sw, 3, False);
  AData.AddClassFunction('CreateLookAtDirRH', TMatrix3D_CreateLookAtDirRH_si, TMatrix3D_sw, 3, False);
  AData.AddClassFunction('CreateLookAtDirLH', TMatrix3D_CreateLookAtDirLH_si, TMatrix3D_sw, 3, False);
  AData.AddClassFunction('CreateOrthoLH', TMatrix3D_CreateOrthoLH_si, TMatrix3D_sw, 4, False);
  AData.AddClassFunction('CreateOrthoRH', TMatrix3D_CreateOrthoRH_si, TMatrix3D_sw, 4, False);
  AData.AddClassFunction('CreateOrthoOffCenterLH', TMatrix3D_CreateOrthoOffCenterLH_si, TMatrix3D_sw, 6, False);
  AData.AddClassFunction('CreateOrthoOffCenterRH', TMatrix3D_CreateOrthoOffCenterRH_si, TMatrix3D_sw, 6, False);
  AData.AddClassFunction('CreatePerspectiveFovLH', TMatrix3D_CreatePerspectiveFovLH_si, TMatrix3D_sw, 4, True);
  AData.AddClassFunction('CreatePerspectiveFovRH', TMatrix3D_CreatePerspectiveFovRH_si, TMatrix3D_sw, 4, True);
end;

class function TMatrix3D_sw.ToVar(const AValue: TMatrix3D): OleVariant;
var
  wrpr: TMatrix3D_sw;
begin
  wrpr        := TMatrix3D_sw.Create;
  wrpr.FValue := AValue;
  
  Result := ConvToVar(wrpr);
end;

class function TMatrix3D_sw.FromVar(const AValue: OleVariant): TMatrix3D;
begin
  Result := TMatrix3D_sw(ConvFromVar(AValue)).FValue;
end;

{ TQuaternion3D_sw }

function TQuaternion3D_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Create(...); overload;
  ...
  case AArgsSize of
    2:
    begin
      Result := TQuaternion3D_sw.ToVar(TQuaternion3D.Create(TPoint3D_sw.FromVar(
        AArgs[0]), Single(AArgs[1])));
    end;
    3:
    begin
      Result := TQuaternion3D_sw.ToVar(TQuaternion3D.Create(Single(AArgs[0]), 
        Single(AArgs[1]), Single(AArgs[2])));
    end;
    1:
    begin
      Result := TQuaternion3D_sw.ToVar(TQuaternion3D.Create(TMatrix3D_sw.
        FromVar(AArgs[0])));
    end;
    0:
    begin
      // Implicit parameterless constructor.
      Result := TQuaternion3D_sw.Create as IDispatch;
    end;
  else
    WrongArgCountError('Create');
  end;
...
function TQuaternion3D_Length_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Length: Single;

  Result := TQuaternion3D_sw(AObj).FValue.Length();
end;

function TQuaternion3D_Normalize_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Normalize: TQuaternion3D;

  Result := TQuaternion3D_sw.ToVar(TQuaternion3D_sw(AObj).FValue.Normalize());
end;

function TQuaternion3D_ImagPart_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var ImagPart: TPoint3D;

  if IsGet then
    Result := TPoint3D_sw.ToVar(TQuaternion3D_sw(AObj).FValue.ImagPart)
  else
    TQuaternion3D_sw(AObj).FValue.ImagPart := TPoint3D_sw.FromVar(AArgs[0]);
end;

function TQuaternion3D_RealPart_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var RealPart: Single;

  if IsGet then
    Result := TQuaternion3D_sw(AObj).FValue.RealPart
  else
    TQuaternion3D_sw(AObj).FValue.RealPart := Single(AArgs[0]);
end;

function TQuaternion3D_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: TQuaternion3D;

  // Implicit record copy method.
  Result := TQuaternion3D_sw.ToVar(TQuaternion3D(AObj));
end;

class function TQuaternion3D_sw.GetTypeName: WideString;
begin
  Result := 'TQuaternion3D';
end;

function TQuaternion3D_sw.CloneVal: TLMDRecordWrapper;
begin
  Result := TQuaternion3D_sw.Create;
  TQuaternion3D_sw(Result).FValue := FValue;
end;

class procedure TQuaternion3D_sw.DoInit(AData: TLMDRecordWrapperData);
begin
  { Instance members }

  AData.AddFunction('Length', TQuaternion3D_Length_si, Single_sw, 0, False);
  AData.AddFunction('Normalize', TQuaternion3D_Normalize_si, TQuaternion3D_sw, 0, False);
  AData.AddField('ImagPart', TQuaternion3D_ImagPart_si, TPoint3D_sw);
  AData.AddField('RealPart', TQuaternion3D_RealPart_si, Single_sw);
  AData.AddFunction('Copy', TQuaternion3D_Copy_si, TQuaternion3D_sw, 0, False);

  { Class members }

  AData.AddConstructor('Create', TQuaternion3D_Create_si, 0, True);
end;

class function TQuaternion3D_sw.ToVar(const AValue: TQuaternion3D): OleVariant;
var
  wrpr: TQuaternion3D_sw;
begin
  wrpr        := TQuaternion3D_sw.Create;
  wrpr.FValue := AValue;
  
  Result := ConvToVar(wrpr);
end;

class function TQuaternion3D_sw.FromVar(
  const AValue: OleVariant): TQuaternion3D;
begin
  Result := TQuaternion3D_sw(ConvFromVar(AValue)).FValue;
end;
...
function Types_OleStr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type OleStr = WideString;

  Result := TLMDUnitWrapper.TypeToVar(OleStr_sw);
end;

function Types_TDuplicates_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
function Types_TDirection_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDirection = (FromBeginning, FromEnd);

  Result := TLMDUnitWrapper.TypeToVar(TDirection_sw);
end;
...
function Types_tagVECTOR_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type tagVECTOR = record;

  Result := TLMDUnitWrapper.TypeToVar(tagVECTOR_sw);
end;
...
function Types_TPoint3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPoint3D = record;

  Result := TLMDUnitWrapper.TypeToVar(TPoint3D_sw);
end;

function Types_tagVECTOR3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type tagVECTOR3D = record;

  Result := TLMDUnitWrapper.TypeToVar(tagVECTOR3D_sw);
end;

function Types_TVector3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TVector3D = record;

  Result := TLMDUnitWrapper.TypeToVar(TVector3D_sw);
end;

function Types_TMatrix3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMatrix3D = record;

  Result := TLMDUnitWrapper.TypeToVar(TMatrix3D_sw);
end;

function Types_TQuaternion3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TQuaternion3D = record;

  Result := TLMDUnitWrapper.TypeToVar(TQuaternion3D_sw);
end;
...
function Types_Vector_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Vector(...); overload;

  case AArgsSize of
    2:
    begin
      Result := TVector_sw.ToVar(System.Types.Vector(Single(AArgs[0]), Single(
        AArgs[1])));
    end;
    3:
    begin
    ...
    WrongArgCountError('Vector');
  end;
end;

function Types_Vector3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Vector3D(...); overload;

  case AArgsSize of
    3:
    begin
      Result := TVector3D_sw.ToVar(System.Types.Vector3D(Single(AArgs[0]), 
        Single(AArgs[1]), Single(AArgs[2])));
    end;
    4:
    begin
      Result := TVector3D_sw.ToVar(System.Types.Vector3D(Single(AArgs[0]), 
        Single(AArgs[1]), Single(AArgs[2]), Single(AArgs[3])));
    end;
    1:
    begin
      Result := TVector3D_sw.ToVar(System.Types.Vector3D(TPoint3D_sw.FromVar(
        AArgs[0])));
    end;
    2:
    begin
    ...
    WrongArgCountError('Vector3D');
  end;
end;

function Types_Point3D_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Point3D(...); overload;

  case AArgsSize of
    3:
    begin
      Result := TPoint3D_sw.ToVar(System.Types.Point3D(Single(AArgs[0]), Single(
        AArgs[1]), Single(AArgs[2])));
    end;
    1:
    begin
      Result := TPoint3D_sw.ToVar(System.Types.Point3D(TVector3D_sw.FromVar(
        AArgs[0])));
    end;
    2:
    begin
...
begin
  AData.AddType(OleStr_sw, Types_OleStr_si);
  AData.AddType(TDuplicates_sw, Types_TDuplicates_si);
  AData.AddType(TDirection_sw, Types_TDirection_si);
  ...
  AData.AddType(tagVECTOR_sw, Types_tagVECTOR_si);
  AData.AddType(TVector_sw, Types_TVector_si);
  AData.AddType(TMatrix_sw, Types_TMatrix_si);
  AData.AddType(TPoint3D_sw, Types_TPoint3D_si);
  AData.AddType(tagVECTOR3D_sw, Types_tagVECTOR3D_si);
  AData.AddType(TVector3D_sw, Types_TVector3D_si);
  AData.AddType(TMatrix3D_sw, Types_TMatrix3D_si);
  AData.AddType(TQuaternion3D_sw, Types_TQuaternion3D_si);
  ...
  AData.AddFunction('Vector', Types_Vector_si, nil, 2, True);
  AData.AddFunction('Vector3D', Types_Vector3D_si, nil, 1, True);
  AData.AddFunction('Point3D', Types_Point3D_si, nil, 1, True);
