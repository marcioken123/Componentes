...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.ListActns' unit.
  #
  # WARNING:
...
uses
  ...
  Vcl.Controls, Vcl.ActnList, Vcl.ImgList, Vcl.ListActns, System.Classes_LMDSW,
  Vcl.Controls_LMDSW, Vcl.ActnList_LMDSW, Vcl.ImgList_LMDSW;
