...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.ActnMenus' unit.
  #
  # WARNING:
...
uses
  ...
  Winapi.Messages, System.Classes, System.Contnrs, System.Actions, Vcl.Buttons,
  Vcl.Graphics, Vcl.Forms, Vcl.Controls, Vcl.ActnList, Vcl.ToolWin,
  Vcl.ExtCtrls, Vcl.StdCtrls, Vcl.Menus, Vcl.StdActns, Vcl.ActnMan,
  Vcl.ActnCtrls, Vcl.ShadowWnd, Vcl.ActnMenus, Winapi.Windows_LMDSW,
  Winapi.Messages_LMDSW, System.Classes_LMDSW, System.Contnrs_LMDSW,
  System.Actions_LMDSW, Vcl.Buttons_LMDSW, Vcl.Graphics_LMDSW, Vcl.Forms_LMDSW,
  Vcl.Controls_LMDSW, Vcl.ActnList_LMDSW, Vcl.ToolWin_LMDSW,
  Vcl.ExtCtrls_LMDSW, Vcl.StdCtrls_LMDSW, Vcl.Menus_LMDSW, Vcl.StdActns_LMDSW,
  Vcl.ActnMan_LMDSW, Vcl.ActnCtrls_LMDSW, Vcl.ShadowWnd_LMDSW;
...
begin
  ...
  if IsGet then
    Result := TMenuItemControlClass_sw.ToVar(Vcl.ActnMenus.MenuItemControlClass)
  else
    Vcl.ActnMenus.MenuItemControlClass := TMenuItemControlClass_sw.FromVar(
      AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TAddRemoveItemClass_sw.ToVar(Vcl.ActnMenus.MenuAddRemoveItemClass)
  else
    Vcl.ActnMenus.MenuAddRemoveItemClass := TAddRemoveItemClass_sw.FromVar(
      AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TMenuButtonControlClass_sw.ToVar(Vcl.ActnMenus.
      MenuButtonControlClass)
  else
    Vcl.ActnMenus.MenuButtonControlClass := TMenuButtonControlClass_sw.FromVar(
      AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TCustomPopupClass_sw.ToVar(Vcl.ActnMenus.MenuPopupClass)
  else
    Vcl.ActnMenus.MenuPopupClass := TCustomPopupClass_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TCustomizeActionToolBarClass_sw.ToVar(Vcl.ActnMenus.
      MenuCustomizePopupClass)
  else
    Vcl.ActnMenus.MenuCustomizePopupClass := TCustomizeActionToolBarClass_sw.
      FromVar(AArgs[0]);
end;
...
begin
  ...
  Vcl.ActnMenus.RegisterActnBarStyle(TActionBarStyleEx_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Vcl.ActnMenus.UnRegisterActnBarStyle(TActionBarStyleEx_sw.FromVar(AArgs[0]));
end;
