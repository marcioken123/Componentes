...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.CheckLst' unit.
  #
  # WARNING:
...
uses
  ...
  Vcl.CheckLst, Winapi.Windows_LMDSW, Winapi.Messages_LMDSW,
  System.SysUtils_LMDSW, System.Classes_LMDSW, Vcl.Graphics_LMDSW,
  Vcl.Controls_LMDSW, Vcl.StdCtrls_LMDSW;
...
function TCheckListBox_CheckAll_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure CheckAll(AState: TCheckBoxState; AllowGrayed: B...

  case AArgsSize of
    1:
    begin
      TCheckListBox(AObj).CheckAll(TCheckBoxState_sw.FromVar(AArgs[0]));
    end;
    2:
    begin
      TCheckListBox(AObj).CheckAll(TCheckBoxState_sw.FromVar(AArgs[0]), Boolean(
        AArgs[1]));
    end;
    3:
    begin
...
begin
  ...
  AData.AddProcedure('CheckAll', TCheckListBox_CheckAll_si, 1, True);
