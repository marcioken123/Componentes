...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.DBCtrls' unit.
  #
  # WARNING:
...
uses
  ...
  Winapi.Messages, Vcl.Controls, Vcl.Forms, System.Classes, Vcl.Graphics,
  Vcl.Menus, Vcl.StdCtrls, Vcl.ExtCtrls, Vcl.Mask, Vcl.Buttons, Vcl.ComCtrls,
  Data.DB, Winapi.RichEdit, Vcl.DBCtrls, System.Variants_LMDSW,
  Winapi.Windows_LMDSW, System.SysUtils_LMDSW, Winapi.Messages_LMDSW,
  Vcl.Controls_LMDSW, Vcl.Forms_LMDSW, System.Classes_LMDSW,
  Vcl.Graphics_LMDSW, Vcl.Menus_LMDSW, Vcl.StdCtrls_LMDSW, Vcl.ExtCtrls_LMDSW,
  Vcl.Mask_LMDSW, Vcl.Buttons_LMDSW, Vcl.ComCtrls_LMDSW, Data.DB_LMDSW,
  Winapi.RichEdit_LMDSW;
...
type
  ...
  TCustomDBLookupComboBox_sw = class;
  ...
  TDBNavigatorKind_sw = class(TLMDEnumWrapper)
  protected
    class function  GetTypeName: WideString; override;
    class procedure GetEnumerators(out AEnums: PLMDEnumerator;
                                   out ACount: Integer); override;
  public
    class function ToVar(const AValue: TDBNavigatorKind): OleVariant;
    class function FromVar(const AValue: OleVariant): TDBNavigatorKind;
  end;
  ...
  TCustomDBLookupComboBox_sc = class of TCustomDBLookupComboBox;
  TCustomDBLookupComboBox_sw = class(TDBLookupControl_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TCustomDBLookupComboBox): OleVariant;
    class function FromVar(const AValue: OleVariant): TCustomDBLookupComboBox;
    class function ClassToVar(AClass: TCustomDBLookupComboBox_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TCustomDBLookupComboBox_sc;
  end;

  TDBLookupComboBox_sc = class of TDBLookupComboBox;
  TDBLookupComboBox_sw = class(TCustomDBLookupComboBox_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
...
begin
  ...
  if IsGet then
    ...
    TFieldDataLink(AObj).FieldName := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('FieldName', TFieldDataLink_FieldName_si, string_sw, True, True, 0, False, False);
...
function TDBEdit_DataField_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DataField: string read <getter> write <setter>;

  if IsGet then
    Result := TDBEdit(AObj).DataField
  else
    TDBEdit(AObj).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('DataField', TDBEdit_DataField_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    ...
    TDBText(AObj).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Color', False);
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddProperty('DataField', TDBText_DataField_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    ...
    TDBCheckBox(AObj).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddPropertyRedecl('Ctl3D', False);
  AData.AddProperty('DataField', TDBCheckBox_DataField_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    ...
    TDBComboBox(AObj).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddPropertyRedecl('Ctl3D', False);
  AData.AddProperty('DataField', TDBComboBox_DataField_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    ...
    TDBListBox(AObj).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddPropertyRedecl('Ctl3D', False);
  AData.AddProperty('DataField', TDBListBox_DataField_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    ...
    TDBRadioGroup(AObj).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddPropertyRedecl('Ctl3D', False);
  AData.AddProperty('DataField', TDBRadioGroup_DataField_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    ...
    TDBMemo(AObj).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddPropertyRedecl('Ctl3D', False);
  AData.AddProperty('DataField', TDBMemo_DataField_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    ...
    TDBImage(AObj).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddPropertyRedecl('Ctl3D', False);
  AData.AddProperty('DataField', TDBImage_DataField_si, string_sw, True, True, 0, False, False);
...
const
  ENUMS: array[0..11] of TLMDEnumerator = (
    ...
    (Name: 'nbApplyUpdates'; Value: Integer({$IFDEF LMDSCT_12}TNavigateBtn.{$ENDIF}nbApplyUpdates)),
    (Name: 'nbCancelUpdates'; Value: Integer({$IFDEF LMDSCT_12}TNavigateBtn.{$ENDIF}nbCancelUpdates))
  );
begin
  AEnums := @ENUMS;
  ACount := 12;
...
class function TDBNavigatorKind_sw.GetTypeName: WideString;
begin
  Result := 'TDBNavigatorKind';
end;

class procedure TDBNavigatorKind_sw.GetEnumerators(out AEnums: PLMDEnumerator;
  out ACount: Integer);
const
  ENUMS: array[0..1] of TLMDEnumerator = (
    (Name: 'dbnHorizontal'; Value: Integer({$IFDEF LMDSCT_12}TDBNavigatorKind.{$ENDIF}dbnHorizontal)),
    (Name: 'dbnVertical'; Value: Integer({$IFDEF LMDSCT_12}TDBNavigatorKind.{$ENDIF}dbnVertical))
  );
begin
  AEnums := @ENUMS;
  ACount := 2;
...
class function TDBNavigatorKind_sw.ToVar(
  const AValue: TDBNavigatorKind): OleVariant;
begin
  Result := Integer(AValue);
end;

class function TDBNavigatorKind_sw.FromVar(
  const AValue: OleVariant): TDBNavigatorKind;
begin
  Result := TDBNavigatorKind(Integer(AValue));
end;
...
function TDBNavigator_MaxErrors_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property MaxErrors: Integer read <getter> write <setter>;

  if IsGet then
    Result := TDBNavigator(AObj).MaxErrors
  else
    TDBNavigator(AObj).MaxErrors := Integer(AArgs[0]);
end;
...
function TDBNavigator_Kind_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Kind: TDBNavigatorKind read <getter> write <sett...

  if IsGet then
    Result := TDBNavigatorKind_sw.ToVar(TDBNavigator(AObj).Kind)
  else
    TDBNavigator(AObj).Kind := TDBNavigatorKind_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('MaxErrors', TDBNavigator_MaxErrors_si, Integer_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('Align', False);
  AData.AddPropertyRedecl('Anchors', False);
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddPropertyRedecl('DragCursor', False);
  ...
  AData.AddProperty('Kind', TDBNavigator_Kind_si, TDBNavigatorKind_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('ParentCtl3D', False);
  AData.AddPropertyRedecl('ParentShowHint', False);
  AData.AddPropertyRedecl('PopupMenu', False);
...
function TDBLookupControl_DataField_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property DataField: string read <getter> write ...

  if IsGet then
    Result := TDBLookupControl_sacc(TDBLookupControl(AObj)).DataField
  else
    TDBLookupControl_sacc(TDBLookupControl(AObj)).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('DataField', TDBLookupControl_DataField_si, string_sw, True, True, 0, True, False);
...
{ TCustomDBLookupComboBox_sw }

function TCustomDBLookupComboBox_CloseUp_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure CloseUp(Accept: Boolean);

  TCustomDBLookupComboBox(AObj).CloseUp(Boolean(AArgs[0]));
end;

function TCustomDBLookupComboBox_DropDown_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure DropDown;

  TCustomDBLookupComboBox(AObj).DropDown();
end;

function TCustomDBLookupComboBox_DropDownAlign_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DropDownAlign: TDropDownAlign read <getter> writ...

  if IsGet then
    Result := TDropDownAlign_sw.ToVar(TCustomDBLookupComboBox(AObj).
      DropDownAlign)
  else
    TCustomDBLookupComboBox(AObj).DropDownAlign := TDropDownAlign_sw.FromVar(
      AArgs[0]);
end;

function TCustomDBLookupComboBox_DropDownRows_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DropDownRows: Integer read <getter> write <setter>;

  if IsGet then
    Result := TCustomDBLookupComboBox(AObj).DropDownRows
  else
    TCustomDBLookupComboBox(AObj).DropDownRows := Integer(AArgs[0]);
end;

function TCustomDBLookupComboBox_DropDownWidth_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DropDownWidth: Integer read <getter> write <sett...

  if IsGet then
    Result := TCustomDBLookupComboBox(AObj).DropDownWidth
  else
    TCustomDBLookupComboBox(AObj).DropDownWidth := Integer(AArgs[0]);
end;

function TCustomDBLookupComboBox_ListVisible_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property ListVisible: Boolean read <getter>;

  Result := TCustomDBLookupComboBox(AObj).ListVisible;
end;

function TCustomDBLookupComboBox_OnCloseUp_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property OnCloseUp: TNotifyEvent read <getter> write <set...

  if IsGet then
    Result := TNotifyEvent_sw.ToVar(TCustomDBLookupComboBox(AObj).OnCloseUp)
  else
    TCustomDBLookupComboBox(AObj).OnCloseUp := TNotifyEvent_sw.FromVar(
      AArgs[0]);
end;

function TCustomDBLookupComboBox_OnDropDown_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property OnDropDown: TNotifyEvent read <getter> write <se...

  if IsGet then
    Result := TNotifyEvent_sw.ToVar(TCustomDBLookupComboBox(AObj).OnDropDown)
  else
    TCustomDBLookupComboBox(AObj).OnDropDown := TNotifyEvent_sw.FromVar(
      AArgs[0]);
end;

function TCustomDBLookupComboBox_Text_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Text: string read <getter>;

  Result := TCustomDBLookupComboBox(AObj).Text;
end;

class function TCustomDBLookupComboBox_sw.GetTypeName: WideString;
begin
  Result := 'TCustomDBLookupComboBox';
end;

class function TCustomDBLookupComboBox_sw.GetWrappedClass: TClass;
begin
  Result := TCustomDBLookupComboBox;
end;

class procedure TCustomDBLookupComboBox_sw.DoInit(AData: TLMDClassWrapperData);
begin
  { Instance members }

  AData.AddProcedure('CloseUp', TCustomDBLookupComboBox_CloseUp_si, 1, False);
  AData.AddProcedure('DropDown', TCustomDBLookupComboBox_DropDown_si, 0, False);
  AData.AddProperty('DropDownAlign', TCustomDBLookupComboBox_DropDownAlign_si, TDropDownAlign_sw, True, True, 0, False, False);
  AData.AddProperty('DropDownRows', TCustomDBLookupComboBox_DropDownRows_si, Integer_sw, True, True, 0, False, False);
  AData.AddProperty('DropDownWidth', TCustomDBLookupComboBox_DropDownWidth_si, Integer_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('KeyValue', False);
  AData.AddProperty('ListVisible', TCustomDBLookupComboBox_ListVisible_si, Boolean_sw, True, False, 0, False, False);
  AData.AddProperty('OnCloseUp', TCustomDBLookupComboBox_OnCloseUp_si, TNotifyEvent_sw, True, True, 0, False, False);
  AData.AddProperty('OnDropDown', TCustomDBLookupComboBox_OnDropDown_si, TNotifyEvent_sw, True, True, 0, False, False);
  AData.AddProperty('Text', TCustomDBLookupComboBox_Text_si, string_sw, True, False, 0, False, False);
end;

class function TCustomDBLookupComboBox_sw.ToVar(
  const AValue: TCustomDBLookupComboBox): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TCustomDBLookupComboBox_sw.FromVar(
  const AValue: OleVariant): TCustomDBLookupComboBox;
begin
  Result := TCustomDBLookupComboBox(ConvFromVar(AValue, 
    TCustomDBLookupComboBox));
end;

class function TCustomDBLookupComboBox_sw.ClassToVar(
  AClass: TCustomDBLookupComboBox_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TCustomDBLookupComboBox_sw.ClassFromVar(
  const AClass: OleVariant): TCustomDBLookupComboBox_sc;
begin
  Result := TCustomDBLookupComboBox_sc(ConvClsFromVar(AClass, 
    TCustomDBLookupComboBox));
end;
...
begin
  ...
  AData.AddPropertyRedecl('DragKind', False);
  AData.AddPropertyRedecl('DragMode', False);
  AData.AddPropertyRedecl('DropDownAlign', False);
  AData.AddPropertyRedecl('DropDownRows', False);
  AData.AddPropertyRedecl('DropDownWidth', False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('Font', False);
  AData.AddPropertyRedecl('ImeMode', False);
  AData.AddPropertyRedecl('ImeName', False);
...
begin
  ...
  if IsGet then
    ...
    TDBRichEdit(AObj).DataField := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddPropertyRedecl('Ctl3D', False);
  AData.AddProperty('DataField', TDBRichEdit_DataField_si, string_sw, True, True, 0, False, False);
  ...
  AData.AddPropertyRedecl('WantTabs', False);
  AData.AddPropertyRedecl('WordWrap', False);
  AData.AddPropertyRedecl('Zoom', False);
  AData.AddPropertyRedecl('OnChange', False);
  AData.AddPropertyRedecl('OnClick', False);
  AData.AddPropertyRedecl('OnContextPopup', False);
  AData.AddPropertyRedecl('OnDblClick', False);
...
function DBCtrls_TDBNavigatorKind_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDBNavigatorKind = (dbnHorizontal, dbnVertical);

  Result := TLMDUnitWrapper.TypeToVar(TDBNavigatorKind_sw);
end;
...
function DBCtrls_TCustomDBLookupComboBox_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCustomDBLookupComboBox = class(TDBLookupControl);

  Result := TLMDUnitWrapper.TypeToVar(TCustomDBLookupComboBox_sw);
end;

function DBCtrls_TDBLookupComboBox_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDBLookupComboBox = class(TCustomDBLookupComboBox);
...
begin
  ...
  Result := Vcl.DBCtrls.OkToChangeFieldAlignment(TField_sw.FromVar(AArgs[0]), 
...
begin
  ...
  Result := Vcl.DBCtrls.DBUseRightToLeftAlignment(TControl_sw.FromVar(AArgs[0]),
...
begin
  ...
  AData.AddConstant('InitRepeatPause', DBCtrls_InitRepeatPause_si, nil, VarType(Vcl.DBCtrls.InitRepeatPause));
  AData.AddConstant('RepeatPause', DBCtrls_RepeatPause_si, nil, VarType(Vcl.DBCtrls.RepeatPause));
  AData.AddConstant('SpaceSize', DBCtrls_SpaceSize_si, nil, VarType(Vcl.DBCtrls.SpaceSize));
  ...
  AData.AddType(TDBNavigatorKind_sw, DBCtrls_TDBNavigatorKind_si);
  ...
  AData.AddType(TCustomDBLookupComboBox_sw, DBCtrls_TCustomDBLookupComboBox_si);
...
initialization
  ...
  RegisterClassWrapper(TCustomDBLookupComboBox_sw);
