...
begin
  ...
  case AArgsSize of
    1:
    begin
      v_1 := UInt8_sw.FromVar(AArgs[0]);
      Result := TStream(AObj).ReadData(v_1);
      AssignRefParam(AArgs[0], UInt8_sw.ToVar(v_1));
    end;
    2:
    begin
      v_2 := UInt8_sw.FromVar(AArgs[0]);
      Result := TStream(AObj).ReadData(v_2, Longint(AArgs[1]));
      AssignRefParam(AArgs[0], UInt8_sw.ToVar(v_2));
    end;
  else
...
begin
  ...
  case AArgsSize of
    1:
    begin
      Result := TStream(AObj).WriteData(UInt8_sw.FromVar(AArgs[0]));
    end;
    2:
    begin
      Result := TStream(AObj).WriteData(UInt8_sw.FromVar(AArgs[0]), Longint(
        AArgs[1]));
    end;
  else
...
begin
  ...
  TWriter(AObj).WriteVar(UInt8_sw.FromVar(AArgs[0]), Longint(AArgs[1]));
end;
