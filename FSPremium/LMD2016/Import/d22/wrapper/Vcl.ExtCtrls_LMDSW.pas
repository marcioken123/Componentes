...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.ExtCtrls' unit.
  #
  # WARNING:
...
uses
  ...
  LMDSctSysWrappers, Winapi.Messages, Winapi.Windows, System.SysUtils,
  System.Classes, System.Contnrs, System.Types, System.UITypes, Vcl.Controls,
  Vcl.Forms, Vcl.Menus, Vcl.Graphics, Vcl.StdCtrls, Vcl.GraphUtil, Vcl.ImgList,
  Vcl.ExtCtrls, Winapi.Messages_LMDSW, Winapi.Windows_LMDSW,
  System.SysUtils_LMDSW, System.Classes_LMDSW, System.Contnrs_LMDSW,
  System.Types_LMDSW, System.UITypes_LMDSW, Vcl.Controls_LMDSW,
  Vcl.Forms_LMDSW, Vcl.Menus_LMDSW, Vcl.Graphics_LMDSW, Vcl.StdCtrls_LMDSW,
  Vcl.GraphUtil_LMDSW, Vcl.ImgList_LMDSW;
...
function TCustomGridPanel_UpdateControlsColumn_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure UpdateControlsColumn(AColumn: Integer);

  TCustomGridPanel(AObj).UpdateControlsColumn(Integer(AArgs[0]));
end;

function TCustomGridPanel_UpdateControlsRow_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure UpdateControlsRow(ARow: Integer);

  TCustomGridPanel(AObj).UpdateControlsRow(Integer(AArgs[0]));
end;
...
begin
  ...
  AData.AddProcedure('UpdateControlsColumn', TCustomGridPanel_UpdateControlsColumn_si, 1, False);
  AData.AddProcedure('UpdateControlsRow', TCustomGridPanel_UpdateControlsRow_si, 1, False);
...
begin
  ...
  Result := TCustomImageList_sw.ToVar(TEditButton_sacc(TEditButton(AObj)).
    Images);
end;

function TEditButton_CustomHint_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property CustomHint: TCustomHint read <getter> write <set...

  if IsGet then
    Result := TCustomHint_sw.ToVar(TEditButton(AObj).CustomHint)
  else
    TEditButton(AObj).CustomHint := TCustomHint_sw.FromVar(AArgs[0]);
end;
...
function TEditButton_Hint_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Hint: string read <getter> write <setter>;

  if IsGet then
    Result := TEditButton(AObj).Hint
  else
    TEditButton(AObj).Hint := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Images', TEditButton_Images_si, TCustomImageList_sw, True, False, 0, True, False);
  AData.AddProperty('CustomHint', TEditButton_CustomHint_si, TCustomHint_sw, True, True, 0, False, False);
  ...
  AData.AddProperty('Hint', TEditButton_Hint_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    Result := TCustomImageList_sw.ToVar(TCustomButtonedEdit(AObj).Images)
  else
    TCustomButtonedEdit(AObj).Images := TCustomImageList_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Images', TCustomButtonedEdit_Images_si, TCustomImageList_sw, True, True, 0, False, False);
...
function TCustomTrayIcon_Icons_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Icons: TCustomImageList read <getter> write <set...

  if IsGet then
    Result := TCustomImageList_sw.ToVar(TCustomTrayIcon(AObj).Icons)
  else
    TCustomTrayIcon(AObj).Icons := TCustomImageList_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Icons', TCustomTrayIcon_Icons_si, TCustomImageList_sw, True, True, 0, False, False);
...
begin
  ...
  if IsGet then
    Result := TCustomImageList_sw.ToVar(TCustomCategoryPanelGroup(AObj).Images)
  else
    TCustomCategoryPanelGroup(AObj).Images := TCustomImageList_sw.FromVar(
      AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Images', TCustomCategoryPanelGroup_Images_si, TCustomImageList_sw, True, True, 0, False, False);
...
begin
  ...
  Vcl.ExtCtrls.Frame3D(TCanvas_sw.FromVar(AArgs[0]), v_1, TColor_sw.FromVar(
...
begin
  ...
  Vcl.ExtCtrls.NotebookHandlesNeeded(TNotebook_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  AData.AddConstant('WM_SYSTEM_TRAY_MESSAGE', ExtCtrls_WM_SYSTEM_TRAY_MESSAGE_si, nil, VarType(Vcl.ExtCtrls.WM_SYSTEM_TRAY_MESSAGE));
  ...
  AData.AddConstant('DefaultCategoryPanelHeight', ExtCtrls_DefaultCategoryPanelHeight_si, nil, VarType(Vcl.ExtCtrls.DefaultCategoryPanelHeight));
