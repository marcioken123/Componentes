...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.ShadowWnd' unit.
  #
  # WARNING:
...
uses
  ...
  Vcl.ShadowWnd, Winapi.Windows_LMDSW, Winapi.Messages_LMDSW,
  System.Classes_LMDSW, Vcl.Controls_LMDSW, Vcl.Forms_LMDSW,
  Vcl.Graphics_LMDSW;
