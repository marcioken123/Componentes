...
uses
  ...
  System.Types, System.SysUtils, System.Classes, System.Variants,
  System.MaskUtils, Data.DBCommonTypes, Data.DB, System.Types_LMDSW,
  System.SysUtils_LMDSW, System.Classes_LMDSW, System.Variants_LMDSW,
  System.MaskUtils_LMDSW, Data.DBCommonTypes_LMDSW;
...
type
  ...
  TPlatformValueBuffer_sw = class;
  TDBBitConverter_sw = class;
  TField_sw = class;
  ...
  TFieldTypes_sw = class(TLMDSetWrapper)
  protected
    class function GetTypeName: WideString; override;
    class function GetSetSizeOf: Integer; override;
  public
    class function ToVar(const AValue: TFieldTypes): OleVariant;
    class function FromVar(const AValue: OleVariant): TFieldTypes;
  end;
  ...
  TFieldsAutoCreationMode_sw = class(TLMDEnumWrapper)
  protected
    class function  GetTypeName: WideString; override;
    class procedure GetEnumerators(out AEnums: PLMDEnumerator;
                                   out ACount: Integer); override;
  public
    class function ToVar(const AValue: TFieldsAutoCreationMode): OleVariant;
    class function FromVar(const AValue: OleVariant): TFieldsAutoCreationMode;
  end;

  TFieldsPositionMode_sw = class(TLMDEnumWrapper)
  protected
    class function  GetTypeName: WideString; override;
    class procedure GetEnumerators(out AEnums: PLMDEnumerator;
                                   out ACount: Integer); override;
  public
    class function ToVar(const AValue: TFieldsPositionMode): OleVariant;
    class function FromVar(const AValue: OleVariant): TFieldsPositionMode;
  end;

  TFieldLifeCycle_sw = class(TLMDEnumWrapper)
  protected
    class function  GetTypeName: WideString; override;
    class procedure GetEnumerators(out AEnums: PLMDEnumerator;
                                   out ACount: Integer); override;
  public
    class function ToVar(const AValue: TFieldLifeCycle): OleVariant;
    class function FromVar(const AValue: OleVariant): TFieldLifeCycle;
  end;

  TFieldLifeCycles_sw = class(TLMDSetWrapper)
  protected
    class function GetTypeName: WideString; override;
    class function GetSetSizeOf: Integer; override;
  public
    class function ToVar(const AValue: TFieldLifeCycles): OleVariant;
    class function FromVar(const AValue: OleVariant): TFieldLifeCycles;
  end;
  ...
  TPlatformValueBuffer_sc = class of TPlatformValueBuffer;
  TPlatformValueBuffer_sw = class(TObject_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TPlatformValueBuffer): OleVariant;
    class function FromVar(const AValue: OleVariant): TPlatformValueBuffer;
    class function ClassToVar(AClass: TPlatformValueBuffer_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TPlatformValueBuffer_sc;
  end;

  TDBBitConverter_sc = class of TDBBitConverter;
  TDBBitConverter_sw = class(TBitConverter_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TDBBitConverter): OleVariant;
    class function FromVar(const AValue: OleVariant): TDBBitConverter;
    class function ClassToVar(AClass: TDBBitConverter_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TDBBitConverter_sc;
  end;
  ...
  TFieldOptions_sc = class of TFieldOptions;
  TFieldOptions_sw = class(TPersistent_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TFieldOptions): OleVariant;
    class function FromVar(const AValue: OleVariant): TFieldOptions;
    class function ClassToVar(AClass: TFieldOptions_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TFieldOptions_sc;
  end;
...
class function TFieldTypes_sw.GetTypeName: WideString;
begin
  Result := 'TFieldTypes';
end;

class function TFieldTypes_sw.GetSetSizeOf: Integer;
begin
  Result := SizeOf(TFieldTypes);
end;

class function TFieldTypes_sw.ToVar(const AValue: TFieldTypes): OleVariant;
begin
  Result := ConvToVar(@AValue);
end;

class function TFieldTypes_sw.FromVar(const AValue: OleVariant): TFieldTypes;
begin
...
{ TFieldsAutoCreationMode_sw }

class function TFieldsAutoCreationMode_sw.GetTypeName: WideString;
begin
  Result := 'TFieldsAutoCreationMode';
end;

class procedure TFieldsAutoCreationMode_sw.GetEnumerators(
  out AEnums: PLMDEnumerator; out ACount: Integer);
const
  ENUMS: array[0..2] of TLMDEnumerator = (
    (Name: 'acExclusive'; Value: Integer({$IFDEF LMDSCT_12}TFieldsAutoCreationMode.{$ENDIF}acExclusive)),
    (Name: 'acCombineComputed'; Value: Integer({$IFDEF LMDSCT_12}TFieldsAutoCreationMode.{$ENDIF}acCombineComputed)),
    (Name: 'acCombineAlways'; Value: Integer({$IFDEF LMDSCT_12}TFieldsAutoCreationMode.{$ENDIF}acCombineAlways))
  );
begin
  AEnums := @ENUMS;
  ACount := 3;
...
class function TFieldsAutoCreationMode_sw.ToVar(
  const AValue: TFieldsAutoCreationMode): OleVariant;
begin
  Result := Integer(AValue);
end;

class function TFieldsAutoCreationMode_sw.FromVar(
  const AValue: OleVariant): TFieldsAutoCreationMode;
begin
  Result := TFieldsAutoCreationMode(Integer(AValue));
end;

{ TFieldsPositionMode_sw }

class function TFieldsPositionMode_sw.GetTypeName: WideString;
begin
  Result := 'TFieldsPositionMode';
end;

class procedure TFieldsPositionMode_sw.GetEnumerators(
  out AEnums: PLMDEnumerator; out ACount: Integer);
const
  ENUMS: array[0..2] of TLMDEnumerator = (
    (Name: 'poLast'; Value: Integer({$IFDEF LMDSCT_12}TFieldsPositionMode.{$ENDIF}poLast)),
    (Name: 'poFirst'; Value: Integer({$IFDEF LMDSCT_12}TFieldsPositionMode.{$ENDIF}poFirst)),
    (Name: 'poFieldNo'; Value: Integer({$IFDEF LMDSCT_12}TFieldsPositionMode.{$ENDIF}poFieldNo))
  );
begin
  AEnums := @ENUMS;
  ACount := 3;
...
class function TFieldsPositionMode_sw.ToVar(
  const AValue: TFieldsPositionMode): OleVariant;
begin
  Result := Integer(AValue);
end;

class function TFieldsPositionMode_sw.FromVar(
  const AValue: OleVariant): TFieldsPositionMode;
begin
  Result := TFieldsPositionMode(Integer(AValue));
end;

{ TFieldLifeCycle_sw }

class function TFieldLifeCycle_sw.GetTypeName: WideString;
begin
  Result := 'TFieldLifeCycle';
end;

class procedure TFieldLifeCycle_sw.GetEnumerators(out AEnums: PLMDEnumerator;
  out ACount: Integer);
const
  ENUMS: array[0..1] of TLMDEnumerator = (
    (Name: 'lcAutomatic'; Value: Integer({$IFDEF LMDSCT_12}TFieldLifeCycle.{$ENDIF}lcAutomatic)),
    (Name: 'lcPersistent'; Value: Integer({$IFDEF LMDSCT_12}TFieldLifeCycle.{$ENDIF}lcPersistent))
  );
begin
  AEnums := @ENUMS;
  ACount := 2;
...
class function TFieldLifeCycle_sw.ToVar(
  const AValue: TFieldLifeCycle): OleVariant;
begin
  Result := Integer(AValue);
end;

class function TFieldLifeCycle_sw.FromVar(
  const AValue: OleVariant): TFieldLifeCycle;
begin
  Result := TFieldLifeCycle(Integer(AValue));
end;

{ TFieldLifeCycles_sw }

class function TFieldLifeCycles_sw.GetTypeName: WideString;
begin
  Result := 'TFieldLifeCycles';
end;

class function TFieldLifeCycles_sw.GetSetSizeOf: Integer;
begin
  Result := SizeOf(TFieldLifeCycles);
end;

class function TFieldLifeCycles_sw.ToVar(
  const AValue: TFieldLifeCycles): OleVariant;
begin
  Result := ConvToVar(@AValue);
end;

class function TFieldLifeCycles_sw.FromVar(
  const AValue: OleVariant): TFieldLifeCycles;
begin
  ConvFromVar(AValue, @Result);
end;
...
function TFieldDef_DataSet_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DataSet: TDataSet read <getter>;

  Result := TDataSet_sw.ToVar(TFieldDef(AObj).DataSet);
end;
...
begin
  ...
  AData.AddProperty('DataSet', TFieldDef_DataSet_si, TDataSet_sw, True, False, 0, False, False);
...
function TFields_ClearAutomatic_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure ClearAutomatic;

  TFields(AObj).ClearAutomatic();
end;
...
function TFields_LifeCycles_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property LifeCycles: TFieldLifeCycles read <getter> write...

  if IsGet then
    Result := TFieldLifeCycles_sw.ToVar(TFields(AObj).LifeCycles)
  else
    TFields(AObj).LifeCycles := TFieldLifeCycles_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProcedure('ClearAutomatic', TFields_ClearAutomatic_si, 0, False);
  ...
  AData.AddProperty('LifeCycles', TFields_LifeCycles_si, TFieldLifeCycles_sw, True, True, 0, False, False);
...
{ TPlatformValueBuffer_sw }

class function TPlatformValueBuffer_sw.GetTypeName: WideString;
begin
  Result := 'TPlatformValueBuffer';
end;

class function TPlatformValueBuffer_sw.GetWrappedClass: TClass;
begin
  Result := TPlatformValueBuffer;
end;

class procedure TPlatformValueBuffer_sw.DoInit(AData: TLMDClassWrapperData);
begin
  // Do not call inherited.
end;

class function TPlatformValueBuffer_sw.ToVar(
  const AValue: TPlatformValueBuffer): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TPlatformValueBuffer_sw.FromVar(
  const AValue: OleVariant): TPlatformValueBuffer;
begin
  Result := TPlatformValueBuffer(ConvFromVar(AValue, TPlatformValueBuffer));
end;

class function TPlatformValueBuffer_sw.ClassToVar(
  AClass: TPlatformValueBuffer_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TPlatformValueBuffer_sw.ClassFromVar(
  const AClass: OleVariant): TPlatformValueBuffer_sc;
begin
  Result := TPlatformValueBuffer_sc(ConvClsFromVar(AClass, 
    TPlatformValueBuffer));
end;

{ TDBBitConverter_sw }

class function TDBBitConverter_sw.GetTypeName: WideString;
begin
  Result := 'TDBBitConverter';
end;

class function TDBBitConverter_sw.GetWrappedClass: TClass;
begin
  Result := TDBBitConverter;
end;

class procedure TDBBitConverter_sw.DoInit(AData: TLMDClassWrapperData);
begin
  // Do not call inherited.
end;

class function TDBBitConverter_sw.ToVar(
  const AValue: TDBBitConverter): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TDBBitConverter_sw.FromVar(
  const AValue: OleVariant): TDBBitConverter;
begin
  Result := TDBBitConverter(ConvFromVar(AValue, TDBBitConverter));
end;

class function TDBBitConverter_sw.ClassToVar(
  AClass: TDBBitConverter_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TDBBitConverter_sw.ClassFromVar(
  const AClass: OleVariant): TDBBitConverter_sc;
begin
  Result := TDBBitConverter_sc(ConvClsFromVar(AClass, TDBBitConverter));
end;
...
function TField_SetFieldProps_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure SetFieldProps(FieldDef: TFieldDef);

  TField(AObj).SetFieldProps(TFieldDef_sw.FromVar(AArgs[0]));
end;

function TField_SetFieldDefProps_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure SetFieldDefProps(FieldDef: TFieldDef);

  TField(AObj).SetFieldDefProps(TFieldDef_sw.FromVar(AArgs[0]));
end;
...
function TField_LifeCycle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property LifeCycle: TFieldLifeCycle read <getter> write <...

  if IsGet then
    Result := TFieldLifeCycle_sw.ToVar(TField(AObj).LifeCycle)
  else
    TField(AObj).LifeCycle := TFieldLifeCycle_sw.FromVar(AArgs[0]);
end;
...
function TField_Validating_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Validating: Boolean read <getter>;

  Result := TField(AObj).Validating;
end;
...
begin
  ...
  AData.AddProcedure('SetFieldProps', TField_SetFieldProps_si, 1, False);
  AData.AddProcedure('SetFieldDefProps', TField_SetFieldDefProps_si, 1, False);
  ...
  AData.AddProperty('LifeCycle', TField_LifeCycle_si, TFieldLifeCycle_sw, True, True, 0, False, False);
  ...
  AData.AddProperty('Validating', TField_Validating_si, Boolean_sw, True, False, 0, False, False);
...
function TFieldOptions_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create(DataSet: TDataSet);

  Result := TFieldOptions_sw.ToVar(TFieldOptions_sc(AObj).Create(TDataSet_sw.
    FromVar(AArgs[0])));
end;

function TFieldOptions_AutoCreateMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property AutoCreateMode: TFieldsAutoCreationMode read <ge...

  if IsGet then
    Result := TFieldsAutoCreationMode_sw.ToVar(TFieldOptions(AObj).
      AutoCreateMode)
  else
    TFieldOptions(AObj).AutoCreateMode := TFieldsAutoCreationMode_sw.FromVar(
      AArgs[0]);
end;

function TFieldOptions_PositionMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property PositionMode: TFieldsPositionMode read <getter> ...

  if IsGet then
    Result := TFieldsPositionMode_sw.ToVar(TFieldOptions(AObj).PositionMode)
  else
    TFieldOptions(AObj).PositionMode := TFieldsPositionMode_sw.FromVar(
      AArgs[0]);
end;

function TFieldOptions_UpdatePersistent_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property UpdatePersistent: Boolean read <getter> write <s...

  if IsGet then
    Result := TFieldOptions(AObj).UpdatePersistent
  else
    TFieldOptions(AObj).UpdatePersistent := Boolean(AArgs[0]);
end;

class function TFieldOptions_sw.GetTypeName: WideString;
begin
  Result := 'TFieldOptions';
end;

class function TFieldOptions_sw.GetWrappedClass: TClass;
begin
  Result := TFieldOptions;
end;

class procedure TFieldOptions_sw.DoInit(AData: TLMDClassWrapperData);
begin
  { Instance members }

  AData.AddProperty('AutoCreateMode', TFieldOptions_AutoCreateMode_si, TFieldsAutoCreationMode_sw, True, True, 0, False, False);
  AData.AddProperty('PositionMode', TFieldOptions_PositionMode_si, TFieldsPositionMode_sw, True, True, 0, False, False);
  AData.AddProperty('UpdatePersistent', TFieldOptions_UpdatePersistent_si, Boolean_sw, True, True, 0, False, False);

  { Class members }

  AData.AddConstructor('Create', TFieldOptions_Create_si, 1, False);
end;

class function TFieldOptions_sw.ToVar(const AValue: TFieldOptions): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TFieldOptions_sw.FromVar(
  const AValue: OleVariant): TFieldOptions;
begin
  Result := TFieldOptions(ConvFromVar(AValue, TFieldOptions));
end;

class function TFieldOptions_sw.ClassToVar(
  AClass: TFieldOptions_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TFieldOptions_sw.ClassFromVar(
  const AClass: OleVariant): TFieldOptions_sc;
begin
  Result := TFieldOptions_sc(ConvClsFromVar(AClass, TFieldOptions));
end;
...
function TDataSet_FieldOptions_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property FieldOptions: TFieldOptions read <gett...

  if IsGet then
    Result := TFieldOptions_sw.ToVar(TDataSet_sacc(TDataSet(AObj)).FieldOptions)
  else
    TDataSet_sacc(TDataSet(AObj)).FieldOptions := TFieldOptions_sw.FromVar(
      AArgs[0]);
end;
...
function TDataSet_CanRefresh_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property CanRefresh: Boolean read <getter>;

  Result := TDataSet(AObj).CanRefresh;
end;
...
begin
  ...
  AData.AddProperty('FieldOptions', TDataSet_FieldOptions_si, TFieldOptions_sw, True, True, 0, True, False);
  ...
  AData.AddProperty('CanRefresh', TDataSet_CanRefresh_si, Boolean_sw, True, False, 0, False, False);
  ...
  AData.AddFunction('DefaultFields', TDataSet_DefaultFields_si, Boolean_sw, 0, False);
...
begin
  ...
  if IsGet then
    ...
    TDateTimeRec_sw(AObj).FValue.Date := Integer(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    ...
    TDateTimeRec_sw(AObj).FValue.Time := Integer(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Date', TDateTimeRec_Date_si, Integer_sw);
  AData.AddField('Time', TDateTimeRec_Time_si, Integer_sw);
...
function DB_TFieldTypes_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFieldTypes = set of TFieldType;

  Result := TLMDUnitWrapper.TypeToVar(TFieldTypes_sw);
end;
...
function DB_TFieldsAutoCreationMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFieldsAutoCreationMode = (acExclusive, acCombineCom...

  Result := TLMDUnitWrapper.TypeToVar(TFieldsAutoCreationMode_sw);
end;

function DB_TFieldsPositionMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFieldsPositionMode = (poLast, poFirst, poFieldNo);

  Result := TLMDUnitWrapper.TypeToVar(TFieldsPositionMode_sw);
end;

function DB_TFieldLifeCycle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFieldLifeCycle = (lcAutomatic, lcPersistent);

  Result := TLMDUnitWrapper.TypeToVar(TFieldLifeCycle_sw);
end;

function DB_TFieldLifeCycles_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFieldLifeCycles = set of TFieldLifeCycle;

  Result := TLMDUnitWrapper.TypeToVar(TFieldLifeCycles_sw);
end;
...
function DB_TPlatformValueBuffer_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPlatformValueBuffer = class(TObject);

  Result := TLMDUnitWrapper.TypeToVar(TPlatformValueBuffer_sw);
end;

function DB_TDBBitConverter_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDBBitConverter = class(TBitConverter);

  Result := TLMDUnitWrapper.TypeToVar(TDBBitConverter_sw);
end;
...
function DB_TFieldOptions_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFieldOptions = class(TPersistent);

  Result := TLMDUnitWrapper.TypeToVar(TFieldOptions_sw);
end;
...
function DB_ftCalcFieldTypes_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const ftCalcFieldTypes = <value>;

  Result := LMDSetToVar(SizeOf(ftCalcFieldTypes), ftCalcFieldTypes);
end;
...
begin
  ...
  AData.AddType(TFieldTypes_sw, DB_TFieldTypes_si);
  AData.AddType(TDataSetState_sw, DB_TDataSetState_si);
  AData.AddType(TDataEvent_sw, DB_TDataEvent_si);
  AData.AddType(TFieldsAutoCreationMode_sw, DB_TFieldsAutoCreationMode_si);
  AData.AddType(TFieldsPositionMode_sw, DB_TFieldsPositionMode_si);
  AData.AddType(TFieldLifeCycle_sw, DB_TFieldLifeCycle_si);
  AData.AddType(TFieldLifeCycles_sw, DB_TFieldLifeCycles_si);
  ...
  AData.AddType(TPlatformValueBuffer_sw, DB_TPlatformValueBuffer_si);
  AData.AddType(TDBBitConverter_sw, DB_TDBBitConverter_si);
  ...
  AData.AddType(TFieldOptions_sw, DB_TFieldOptions_si);
  ...
  AData.AddConstant('ftCalcFieldTypes', DB_ftCalcFieldTypes_si, nil, varInteger);
...
initialization
  ...
  RegisterClassWrapper(TPlatformValueBuffer_sw);
  RegisterClassWrapper(TDBBitConverter_sw);
  ...
  RegisterClassWrapper(TFieldOptions_sw);
