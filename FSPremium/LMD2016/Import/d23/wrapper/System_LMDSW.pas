...
type
  ...
  HPPGENAttribute_sw = class;
  HFAAttribute_sw = class;
  AlignAttribute_sw = class;
  ...
  FixedInt_sw = LongInt_sw;

  FixedUInt_sw = LongWord_sw;
  ...
  HPPGENAttribute_sc = class of HPPGENAttribute;
  HPPGENAttribute_sw = class(TCustomAttribute_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: HPPGENAttribute): OleVariant;
    class function FromVar(const AValue: OleVariant): HPPGENAttribute;
    class function ClassToVar(AClass: HPPGENAttribute_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): HPPGENAttribute_sc;
  end;

  HFAAttribute_sc = class of HFAAttribute;
  HFAAttribute_sw = class(TCustomAttribute_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: HFAAttribute): OleVariant;
    class function FromVar(const AValue: OleVariant): HFAAttribute;
    class function ClassToVar(AClass: HFAAttribute_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): HFAAttribute_sc;
  end;

  AlignAttribute_sc = class of AlignAttribute;
  AlignAttribute_sw = class(TCustomAttribute_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: AlignAttribute): OleVariant;
    class function FromVar(const AValue: OleVariant): AlignAttribute;
    class function ClassToVar(AClass: AlignAttribute_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): AlignAttribute_sc;
  end;
  ...
  TExtended80RecW_sw = class(TLMDRecordWrapper)
  private
    FValue: TExtended80RecW;
  protected
    class function  GetTypeName: WideString; override;
    function        CloneVal: TLMDRecordWrapper; override;
    class procedure DoInit(AData: TLMDRecordWrapperData); override;
  public
    class function ToVar(const AValue: TExtended80RecW): OleVariant;
    class function FromVar(const AValue: OleVariant): TExtended80RecW;
  end;
...
begin
  ...
  if IsGet then
    ...
    TGUID_sw(AObj).FValue.D1 := Cardinal(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('D1', TGUID_D1_si, Cardinal_sw);
...
begin
  ...
  AData.AddClassFunction('InstanceSize', TObject_InstanceSize_si, Integer_sw, 0, False);
...
function HPPGENAttribute_mkNoDefine_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const mkNoDefine = <value>;

  Result := HPPGENAttribute_sc(AObj).mkNoDefine;
end;

function HPPGENAttribute_mkAccessible_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const mkAccessible = <value>;

  Result := HPPGENAttribute_sc(AObj).mkAccessible;
end;

function HPPGENAttribute_mkFriend_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const mkFriend = <value>;

  Result := HPPGENAttribute_sc(AObj).mkFriend;
end;

function HPPGENAttribute_mkNonPackage_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const mkNonPackage = <value>;

  Result := HPPGENAttribute_sc(AObj).mkNonPackage;
end;

function HPPGENAttribute_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure/function Create(...); overload;
  ...
  case AArgsSize of
    1:
    begin
      Result := HPPGENAttribute_sw.ToVar(HPPGENAttribute_sc(AObj).Create(
        Integer(AArgs[0])));
    end;
    2:
    begin
      Result := HPPGENAttribute_sw.ToVar(HPPGENAttribute_sc(AObj).Create(
        Integer(AArgs[0]), string(AArgs[1])));
    end;
  else
    WrongArgCountError('Create');
  end;
...
class function HPPGENAttribute_sw.GetTypeName: WideString;
begin
  Result := 'HPPGENAttribute';
end;

class function HPPGENAttribute_sw.GetWrappedClass: TClass;
begin
  Result := HPPGENAttribute;
end;

class procedure HPPGENAttribute_sw.DoInit(AData: TLMDClassWrapperData);
begin

  { Class members }

  AData.AddConstant('mkNoDefine', HPPGENAttribute_mkNoDefine_si, nil, VarType(HPPGENAttribute.mkNoDefine));
  AData.AddConstant('mkAccessible', HPPGENAttribute_mkAccessible_si, nil, VarType(HPPGENAttribute.mkAccessible));
  AData.AddConstant('mkFriend', HPPGENAttribute_mkFriend_si, nil, VarType(HPPGENAttribute.mkFriend));
  AData.AddConstant('mkNonPackage', HPPGENAttribute_mkNonPackage_si, nil, VarType(HPPGENAttribute.mkNonPackage));
  AData.AddConstructor('Create', HPPGENAttribute_Create_si, 1, True);
end;

class function HPPGENAttribute_sw.ToVar(
  const AValue: HPPGENAttribute): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function HPPGENAttribute_sw.FromVar(
  const AValue: OleVariant): HPPGENAttribute;
begin
  Result := HPPGENAttribute(ConvFromVar(AValue, HPPGENAttribute));
end;

class function HPPGENAttribute_sw.ClassToVar(
  AClass: HPPGENAttribute_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function HPPGENAttribute_sw.ClassFromVar(
  const AClass: OleVariant): HPPGENAttribute_sc;
begin
  Result := HPPGENAttribute_sc(ConvClsFromVar(AClass, HPPGENAttribute));
end;

{ HFAAttribute_sw }

function HFAAttribute_ElementCount_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property ElementCount: Integer read <getter>;

  Result := HFAAttribute(AObj).ElementCount;
end;

class function HFAAttribute_sw.GetTypeName: WideString;
begin
  Result := 'HFAAttribute';
end;

class function HFAAttribute_sw.GetWrappedClass: TClass;
begin
  Result := HFAAttribute;
end;

class procedure HFAAttribute_sw.DoInit(AData: TLMDClassWrapperData);
begin
  { Instance members }

  AData.AddProperty('ElementCount', HFAAttribute_ElementCount_si, Integer_sw, True, False, 0, False, False);
end;

class function HFAAttribute_sw.ToVar(const AValue: HFAAttribute): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function HFAAttribute_sw.FromVar(const AValue: OleVariant): HFAAttribute;
begin
  Result := HFAAttribute(ConvFromVar(AValue, HFAAttribute));
end;

class function HFAAttribute_sw.ClassToVar(AClass: HFAAttribute_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function HFAAttribute_sw.ClassFromVar(
  const AClass: OleVariant): HFAAttribute_sc;
begin
  Result := HFAAttribute_sc(ConvClsFromVar(AClass, HFAAttribute));
end;

{ AlignAttribute_sw }

function AlignAttribute_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create(Align: Integer);

  Result := AlignAttribute_sw.ToVar(AlignAttribute_sc(AObj).Create(Integer(
    AArgs[0])));
end;

function AlignAttribute_Align_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Align: Integer read <getter>;

  Result := AlignAttribute(AObj).Align;
end;

class function AlignAttribute_sw.GetTypeName: WideString;
begin
  Result := 'AlignAttribute';
end;

class function AlignAttribute_sw.GetWrappedClass: TClass;
begin
  Result := AlignAttribute;
end;

class procedure AlignAttribute_sw.DoInit(AData: TLMDClassWrapperData);
begin
  { Instance members }

  AData.AddProperty('Align', AlignAttribute_Align_si, Integer_sw, True, False, 0, False, False);

  { Class members }

  AData.AddConstructor('Create', AlignAttribute_Create_si, 1, False);
end;

class function AlignAttribute_sw.ToVar(
  const AValue: AlignAttribute): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function AlignAttribute_sw.FromVar(
  const AValue: OleVariant): AlignAttribute;
begin
  Result := AlignAttribute(ConvFromVar(AValue, AlignAttribute));
end;

class function AlignAttribute_sw.ClassToVar(
  AClass: AlignAttribute_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function AlignAttribute_sw.ClassFromVar(
  const AClass: OleVariant): AlignAttribute_sc;
begin
  Result := AlignAttribute_sc(ConvClsFromVar(AClass, AlignAttribute));
end;
...
begin
  Result := UCS4Char(Cardinal_sw.FromVar(AValue));
end;
...
function TVarData_VLongWord_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var VLongWord: Cardinal;

  if IsGet then
    Result := TVarData_sw(AObj).FValue.VLongWord
  else
    TVarData_sw(AObj).FValue.VLongWord := Cardinal(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('VLongWord', TVarData_VLongWord_si, Cardinal_sw);
...
begin
  ...
  if IsGet then
    ...
    TDynArrayTypeInfo_sw(AObj).FValue.elSize := Integer(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('elSize', TDynArrayTypeInfo_elSize_si, Integer_sw);
...
function TExtended80RecW_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create;

  // Implicit parameterless constructor.
  Result := TExtended80RecW_sw.Create as IDispatch;
end;

function TExtended80RecW_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: TExtended80RecW;

  // Implicit record copy method.
  Result := TExtended80RecW_sw.ToVar(TExtended80RecW(AObj));
end;

class function TExtended80RecW_sw.GetTypeName: WideString;
begin
  Result := 'TExtended80RecW';
end;

function TExtended80RecW_sw.CloneVal: TLMDRecordWrapper;
begin
  Result := TExtended80RecW_sw.Create;
  TExtended80RecW_sw(Result).FValue := FValue;
end;

class procedure TExtended80RecW_sw.DoInit(AData: TLMDRecordWrapperData);
begin
  { Instance members }

  AData.AddFunction('Copy', TExtended80RecW_Copy_si, TExtended80RecW_sw, 0, False);

  { Class members }

  AData.AddConstructor('Create', TExtended80RecW_Create_si, 0, False);
end;

class function TExtended80RecW_sw.ToVar(
  const AValue: TExtended80RecW): OleVariant;
var
  wrpr: TExtended80RecW_sw;
begin
  wrpr        := TExtended80RecW_sw.Create;
  wrpr.FValue := AValue;
  
  Result := ConvToVar(wrpr);
end;

class function TExtended80RecW_sw.FromVar(
  const AValue: OleVariant): TExtended80RecW;
begin
  Result := TExtended80RecW_sw(ConvFromVar(AValue)).FValue;
end;
...
function System_HPPGENAttribute_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type HPPGENAttribute = class(TCustomAttribute);

  Result := TLMDUnitWrapper.TypeToVar(HPPGENAttribute_sw);
end;

function System_HFAAttribute_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type HFAAttribute = class(TCustomAttribute);

  Result := TLMDUnitWrapper.TypeToVar(HFAAttribute_sw);
end;

function System_AlignAttribute_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type AlignAttribute = class(TCustomAttribute);

  Result := TLMDUnitWrapper.TypeToVar(AlignAttribute_sw);
end;
...
function System_tkAnsiChar_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const tkAnsiChar = <value>;

  Result := TTypeKind_sw.ToVar(tkAnsiChar);
end;

function System_tkWideChar_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const tkWideChar = <value>;

  Result := TTypeKind_sw.ToVar(tkWideChar);
end;

function System_tkUnicodeString_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const tkUnicodeString = <value>;

  Result := TTypeKind_sw.ToVar(tkUnicodeString);
end;

function System_tkAnsiString_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const tkAnsiString = <value>;

  Result := TTypeKind_sw.ToVar(tkAnsiString);
end;

function System_tkWideString_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const tkWideString = <value>;

  Result := TTypeKind_sw.ToVar(tkWideString);
end;

function System_tkShortString_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const tkShortString = <value>;

  Result := TTypeKind_sw.ToVar(tkShortString);
end;
...
begin
  ...
  if IsGet then
    ...
    System.RandSeed := Integer(AArgs[0]);
end;
...
function System_TExtended80RecW_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TExtended80RecW = record;

  Result := TLMDUnitWrapper.TypeToVar(TExtended80RecW_sw);
end;
...
var
  v_1: TFileRec;
begin
  // function _ResetFile(var f: TFileRec; recSize: Integer): I...

  v_1 := TFileRec_sw.FromVar(AArgs[0]);
  Result := System._ResetFile(v_1, Integer(AArgs[1]));
  AssignRefParam(AArgs[0], TFileRec_sw.ToVar(v_1));
end;
...
var
  v_1: TFileRec;
begin
  // function _RewritFile(var f: TFileRec; recSize: Integer): ...

  v_1 := TFileRec_sw.FromVar(AArgs[0]);
  Result := System._RewritFile(v_1, Integer(AArgs[1]));
  AssignRefParam(AArgs[0], TFileRec_sw.ToVar(v_1));
end;
...
function System__StrLong_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _StrLong(val: Integer; width: Integer): _ShortStr;

  Result := _ShortStr_sw.ToVar(System._StrLong(Integer(AArgs[0]), Integer(
    AArgs[1])));
end;
...
begin
  ...
  Result := _ShortStr_sw.ToVar(System._Str0Long(Integer(AArgs[0])));
end;
...
var
  v_1: Integer;
begin
  // function _ValLong(const S: string; var Code: Integer): In...
...
function System__Str2Ext_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _Str2Ext(val: Extended; Width: Integer; Precisio...

  Result := _ShortStr_sw.ToVar(System._Str2Ext(Extended(AArgs[0]), Integer(
    AArgs[1]), Integer(AArgs[2])));
end;
...
begin
  ...
  Result := _ShortStr_sw.ToVar(System._Str1Ext(Extended(AArgs[0]), Integer(
    AArgs[1])));
end;
...
function System__WStrLen_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _WStrLen(const S: _WideStr): Integer;
...
function System__LStrLen_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _LStrLen(const S: _AnsiStr): Integer;
...
begin
  ...
  AData.AddType(FixedUInt_sw, System_FixedUInt_si);
  ...
  AData.AddType(HPPGENAttribute_sw, System_HPPGENAttribute_si);
  AData.AddType(HFAAttribute_sw, System_HFAAttribute_si);
  AData.AddType(AlignAttribute_sw, System_AlignAttribute_si);
  ...
  AData.AddConstant('tkAnsiChar', System_tkAnsiChar_si, TTypeKind_sw);
  AData.AddConstant('tkWideChar', System_tkWideChar_si, TTypeKind_sw);
  AData.AddConstant('tkUnicodeString', System_tkUnicodeString_si, TTypeKind_sw);
  AData.AddConstant('tkAnsiString', System_tkAnsiString_si, TTypeKind_sw);
  AData.AddConstant('tkWideString', System_tkWideString_si, TTypeKind_sw);
  AData.AddConstant('tkShortString', System_tkShortString_si, TTypeKind_sw);
  ...
  AData.AddType(TExtended80RecW_sw, System_TExtended80RecW_si);
  ...
  AData.AddFunction('_FilePos', System__FilePos_si, Integer_sw, 1, False);
  AData.AddFunction('_FileSize', System__FileSize_si, Integer_sw, 1, False);
  ...
  AData.AddFunction('_ReadLong', System__ReadLong_si, Integer_sw, 1, False);
  ...
  AData.AddFunction('_ValLong', System__ValLong_si, Integer_sw, 2, False);
  ...
  AData.AddFunction('_LStrLen', System__LStrLen_si, Integer_sw, 1, False);
...
initialization
  ...
  RegisterClassWrapper(HPPGENAttribute_sw);
  RegisterClassWrapper(HFAAttribute_sw);
  RegisterClassWrapper(AlignAttribute_sw);
