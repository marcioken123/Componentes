...
function TCustomTreeView_Encoding_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Encoding: TEncoding read <getter>;

  Result := TEncoding_sw.ToVar(TCustomTreeView_sacc(TCustomTreeView(AObj)).
    Encoding);
end;
...
begin
  ...
  AData.AddProperty('Encoding', TCustomTreeView_Encoding_si, TEncoding_sw, True, False, 0, True, False);
...
function TCustomRichEdit_Zoom_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Zoom: Integer read <getter> write <setter>;

  if IsGet then
    Result := TCustomRichEdit(AObj).Zoom
  else
    TCustomRichEdit(AObj).Zoom := Integer(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Zoom', TCustomRichEdit_Zoom_si, Integer_sw, True, True, 0, False, False);
