...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.StdActns' unit.
  #
  # WARNING:
...
uses
  ...
  LMDSctWrappers, LMDSctSysWrappers, Winapi.Windows, Winapi.ShlObj,
  System.SysUtils, System.Classes, Vcl.ActnList, Vcl.StdCtrls, Vcl.Forms,
  Vcl.Dialogs, Vcl.StdActns, Winapi.Windows_LMDSW, Winapi.ShlObj_LMDSW,
  System.SysUtils_LMDSW, System.Classes_LMDSW, Vcl.ActnList_LMDSW,
  Vcl.StdCtrls_LMDSW, Vcl.Forms_LMDSW, Vcl.Dialogs_LMDSW;
...
type
  ...
  TBrowseForFolderOptionEx_sw = class(TLMDEnumWrapper)
  protected
    class function  GetTypeName: WideString; override;
    class procedure GetEnumerators(out AEnums: PLMDEnumerator;
                                   out ACount: Integer); override;
  public
    class function ToVar(const AValue: TBrowseForFolderOptionEx): OleVariant;
    class function FromVar(const AValue: OleVariant): TBrowseForFolderOptionEx;
  end;

  TBrowseOptionsEx_sw = class(TLMDSetWrapper)
  protected
    class function GetTypeName: WideString; override;
    class function GetSetSizeOf: Integer; override;
  public
    class function ToVar(const AValue: TBrowseOptionsEx): OleVariant;
    class function FromVar(const AValue: OleVariant): TBrowseOptionsEx;
  end;
...
begin
  ...
  AData.AddProperty('Control', TEditAction_Control_si, TCustomEdit_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddProperty('Form', TWindowAction_Form_si, TCustomForm_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddProperty('ExecuteResult', TCommonDialogAction_ExecuteResult_si, Boolean_sw, True, False, 0, False, False);
  AData.AddProperty('BeforeExecute', TCommonDialogAction_BeforeExecute_si, TNotifyEvent_sw, True, True, 0, False, False);
  AData.AddProperty('OnAccept', TCommonDialogAction_OnAccept_si, TNotifyEvent_sw, True, True, 0, False, False);
  AData.AddProperty('OnCancel', TCommonDialogAction_OnCancel_si, TNotifyEvent_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddProperty('FileName', TFileAction_FileName_si, TFileName_sw, True, True, 0, True, False);
end;
...
begin
  ...
  AData.AddProperty('Dialog', TFileOpen_Dialog_si, TOpenDialog_sw, True, False, 0, False, False);
  ...
  AData.AddProperty('UseDefaultApp', TFileOpen_UseDefaultApp_si, Boolean_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('Visible', False);
  AData.AddPropertyRedecl('BeforeExecute', False);
  AData.AddPropertyRedecl('OnAccept', False);
  AData.AddPropertyRedecl('OnCancel', False);
...
begin
  ...
  AData.AddProperty('FileName', TFileOpenWith_FileName_si, TFileName_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('HelpKeyword', False);
  AData.AddPropertyRedecl('HelpType', False);
  AData.AddPropertyRedecl('BeforeExecute', False);
  AData.AddProperty('AfterOpen', TFileOpenWith_AfterOpen_si, TNotifyEvent_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('OnUpdate', False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('Caption', False);
  AData.AddProperty('Dialog', TFileSaveAs_Dialog_si, TSaveDialog_sw, True, False, 0, False, False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('Hint', False);
  AData.AddPropertyRedecl('ImageIndex', False);
...
begin
  ...
  AData.AddPropertyRedecl('Caption', False);
  AData.AddProperty('Dialog', TFilePrintSetup_Dialog_si, TPrinterSetupDialog_sw, True, False, 0, False, False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('HelpKeyword', False);
  AData.AddPropertyRedecl('HelpType', False);
...
begin
  ...
  AData.AddPropertyRedecl('Caption', False);
  AData.AddProperty('Dialog', TFilePageSetup_Dialog_si, TPageSetupDialog_sw, True, False, 0, False, False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('HelpKeyword', False);
  AData.AddPropertyRedecl('HelpType', False);
...
begin
  ...
  AData.AddPropertyRedecl('Caption', False);
  AData.AddProperty('Dialog', TSearchFind_Dialog_si, TFindDialog_sw, True, False, 0, False, False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('HelpKeyword', False);
  AData.AddPropertyRedecl('HelpType', False);
...
begin
  ...
  AData.AddPropertyRedecl('Caption', False);
  AData.AddProperty('Dialog', TSearchReplace_Dialog_si, TReplaceDialog_sw, True, False, 0, False, False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('HelpKeyword', False);
  AData.AddPropertyRedecl('HelpType', False);
...
begin
  ...
  AData.AddPropertyRedecl('Hint', False);
  AData.AddPropertyRedecl('ImageIndex', False);
  AData.AddProperty('SearchFind', TSearchFindNext_SearchFind_si, TSearchFind_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('ShortCut', False);
  AData.AddPropertyRedecl('SecondaryShortCuts', False);
  AData.AddPropertyRedecl('Visible', False);
  AData.AddPropertyRedecl('OnHint', False);
...
begin
  ...
  AData.AddPropertyRedecl('Caption', False);
  AData.AddProperty('Dialog', TFontEdit_Dialog_si, TFontDialog_sw, True, False, 0, False, False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('HelpKeyword', False);
  AData.AddPropertyRedecl('HelpType', False);
...
begin
  ...
  AData.AddPropertyRedecl('Caption', False);
  AData.AddProperty('Dialog', TColorSelect_Dialog_si, TColorDialog_sw, True, False, 0, False, False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('HelpKeyword', False);
  AData.AddPropertyRedecl('HelpType', False);
...
begin
  ...
  AData.AddPropertyRedecl('Caption', False);
  AData.AddProperty('Dialog', TPrintDlg_Dialog_si, TPrintDialog_sw, True, False, 0, False, False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('HelpKeyword', False);
  AData.AddPropertyRedecl('HelpType', False);
...
class procedure TBrowseForFolderOption_sw.GetEnumerators(
  out AEnums: PLMDEnumerator; out ACount: Integer);
const
  ENUMS: array[0..15] of TLMDEnumerator = (
    (Name: 'bifBrowseForComputer'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifBrowseForComputer)),
    (Name: 'bifBrowseForPrinter'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifBrowseForPrinter)),
    (Name: 'bifBrowseIncludeFiles'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifBrowseIncludeFiles)),
    (Name: 'bifBrowseIncludeURLS'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifBrowseIncludeURLS)),
    (Name: 'bifDontGoBelowDomain'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifDontGoBelowDomain)),
    (Name: 'bifEditBox'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifEditBox)),
    (Name: 'bifNewDialogStyle'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifNewDialogStyle)),
    (Name: 'bifNoNewFolderButton'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifNoNewFolderButton)),
    (Name: 'bifNoTranslateTargets'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifNoTranslateTargets)),
    (Name: 'bifReturnFSAncestors'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifReturnFSAncestors)),
    (Name: 'bifReturnOnlyFSDirs'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifReturnOnlyFSDirs)),
    (Name: 'bifShareable'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifShareable)),
    (Name: 'bifStatusText'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifStatusText)),
    (Name: 'bifUAHint'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifUAHint)),
    (Name: 'bifUseNewUI'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifUseNewUI)),
    (Name: 'bifValidate'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOption.{$ENDIF}bifValidate))
  );
begin
  AEnums := @ENUMS;
  ACount := 16;
...
{ TBrowseForFolderOptionEx_sw }

class function TBrowseForFolderOptionEx_sw.GetTypeName: WideString;
begin
  Result := 'TBrowseForFolderOptionEx';
end;

class procedure TBrowseForFolderOptionEx_sw.GetEnumerators(
  out AEnums: PLMDEnumerator; out ACount: Integer);
const
  ENUMS: array[0..3] of TLMDEnumerator = (
    (Name: 'bifeHidePinnedPlaces'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOptionEx.{$ENDIF}bifeHidePinnedPlaces)),
    (Name: 'bifeNoDereferenceLinks'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOptionEx.{$ENDIF}bifeNoDereferenceLinks)),
    (Name: 'bifeForceShowHidden'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOptionEx.{$ENDIF}bifeForceShowHidden)),
    (Name: 'bifeAllowMultiselect'; Value: Integer({$IFDEF LMDSCT_12}TBrowseForFolderOptionEx.{$ENDIF}bifeAllowMultiselect))
  );
begin
  AEnums := @ENUMS;
  ACount := 4;
...
class function TBrowseForFolderOptionEx_sw.ToVar(
  const AValue: TBrowseForFolderOptionEx): OleVariant;
begin
  Result := Integer(AValue);
end;

class function TBrowseForFolderOptionEx_sw.FromVar(
  const AValue: OleVariant): TBrowseForFolderOptionEx;
begin
  Result := TBrowseForFolderOptionEx(Integer(AValue));
end;

{ TBrowseOptionsEx_sw }

class function TBrowseOptionsEx_sw.GetTypeName: WideString;
begin
  Result := 'TBrowseOptionsEx';
end;

class function TBrowseOptionsEx_sw.GetSetSizeOf: Integer;
begin
  Result := SizeOf(TBrowseOptionsEx);
end;

class function TBrowseOptionsEx_sw.ToVar(
  const AValue: TBrowseOptionsEx): OleVariant;
begin
  Result := ConvToVar(@AValue);
end;

class function TBrowseOptionsEx_sw.FromVar(
  const AValue: OleVariant): TBrowseOptionsEx;
begin
  ConvFromVar(AValue, @Result);
end;
...
function TBrowseForFolder_Folders_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Folders[Index: Integer]: string read <getter>;

  Result := TBrowseForFolder(AObj).Folders[Integer(AArgs[0])];
end;

function TBrowseForFolder_SelectionCount_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property SelectionCount: Integer read <getter>;

  Result := TBrowseForFolder(AObj).SelectionCount;
end;
...
function TBrowseForFolder_BrowseOptionsEx_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property BrowseOptionsEx: TBrowseOptionsEx read <getter> ...

  if IsGet then
    Result := TBrowseOptionsEx_sw.ToVar(TBrowseForFolder(AObj).BrowseOptionsEx)
  else
    TBrowseForFolder(AObj).BrowseOptionsEx := TBrowseOptionsEx_sw.FromVar(
      AArgs[0]);
end;
...
function TBrowseForFolder_UseFileDialog_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property UseFileDialog: Boolean read <getter> write <sett...

  if IsGet then
    Result := TBrowseForFolder(AObj).UseFileDialog
  else
    TBrowseForFolder(AObj).UseFileDialog := Boolean(AArgs[0]);
end;

function TBrowseForFolder_FolderNameLabel_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property FolderNameLabel: string read <getter> write <set...

  if IsGet then
    Result := TBrowseForFolder(AObj).FolderNameLabel
  else
    TBrowseForFolder(AObj).FolderNameLabel := string(AArgs[0]);
end;

function TBrowseForFolder_OkButtonLabel_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property OkButtonLabel: string read <getter> write <setter>;

  if IsGet then
    Result := TBrowseForFolder(AObj).OkButtonLabel
  else
    TBrowseForFolder(AObj).OkButtonLabel := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Folder', TBrowseForFolder_Folder_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('Folders', TBrowseForFolder_Folders_si, string_sw, True, False, 1, False, False);
  AData.AddProperty('SelectionCount', TBrowseForFolder_SelectionCount_si, Integer_sw, True, False, 0, False, False);
  AData.AddPropertyRedecl('Caption', False);
  AData.AddProperty('DialogCaption', TBrowseForFolder_DialogCaption_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('BrowseOptions', TBrowseForFolder_BrowseOptions_si, TBrowseOptions_sw, True, True, 0, False, False);
  AData.AddProperty('BrowseOptionsEx', TBrowseForFolder_BrowseOptionsEx_si, TBrowseOptionsEx_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('HelpContext', False);
  AData.AddPropertyRedecl('HelpKeyword', False);
  AData.AddPropertyRedecl('HelpType', False);
  AData.AddPropertyRedecl('Hint', False);
  AData.AddPropertyRedecl('ImageIndex', False);
  AData.AddProperty('RootDir', TBrowseForFolder_RootDir_si, string_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('ShortCut', False);
  AData.AddPropertyRedecl('SecondaryShortCuts', False);
  AData.AddPropertyRedecl('Visible', False);
  AData.AddPropertyRedecl('BeforeExecute', False);
  AData.AddProperty('UseFileDialog', TBrowseForFolder_UseFileDialog_si, Boolean_sw, True, True, 0, False, False);
  AData.AddProperty('FolderNameLabel', TBrowseForFolder_FolderNameLabel_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('OkButtonLabel', TBrowseForFolder_OkButtonLabel_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('OnCallback', TBrowseForFolder_OnCallback_si, TBrowseForFolderCallbackEvent_sw, True, True, 0, False, False);
  AData.AddProperty('OnValidate', TBrowseForFolder_OnValidate_si, TBrowseForFolderCallbackEvent_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('OnAccept', False);
  AData.AddPropertyRedecl('OnCancel', False);
  AData.AddPropertyRedecl('OnHint', False);
end;
...
function StdActns_TBrowseForFolderOption_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBrowseForFolderOption = (bifBrowseForComputer, bifB...
...
function StdActns_TBrowseForFolderOptionEx_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBrowseForFolderOptionEx = (bifeHidePinnedPlaces, bi...

  Result := TLMDUnitWrapper.TypeToVar(TBrowseForFolderOptionEx_sw);
end;

function StdActns_TBrowseOptionsEx_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBrowseOptionsEx = set of TBrowseForFolderOptionEx;

  Result := TLMDUnitWrapper.TypeToVar(TBrowseOptionsEx_sw);
end;
...
begin
  ...
  AData.AddType(TBrowseForFolderOptionEx_sw, StdActns_TBrowseForFolderOptionEx_si);
  AData.AddType(TBrowseOptionsEx_sw, StdActns_TBrowseOptionsEx_si);
