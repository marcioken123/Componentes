...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.StdCtrls' unit.
  #
  # WARNING:
...
uses
  ...
  System.SysUtils, System.Classes, Vcl.Controls, Vcl.Forms, Vcl.Menus,
  Vcl.Graphics, Winapi.CommCtrl, Vcl.ImgList, System.UITypes, Vcl.StdCtrls,
  Winapi.Messages_LMDSW, Winapi.Windows_LMDSW, System.SysUtils_LMDSW,
  System.Classes_LMDSW, Vcl.Controls_LMDSW, Vcl.Forms_LMDSW, Vcl.Menus_LMDSW,
  Vcl.Graphics_LMDSW, Winapi.CommCtrl_LMDSW, Vcl.ImgList_LMDSW,
...
type
  ...
  TImageMargins_sw = class;
  TPushButtonActionLink_sw = class;
  TPushButtonActionLinkClass_sw = class;
  TCustomButton_sw = class;
  TButton_sw = class;
  ...
  TEllipsisPosition_sw = class(TLMDEnumWrapper)
  protected
    class function  GetTypeName: WideString; override;
    class procedure GetEnumerators(out AEnums: PLMDEnumerator;
                                   out ACount: Integer); override;
  public
    class function ToVar(const AValue: TEllipsisPosition): OleVariant;
    class function FromVar(const AValue: OleVariant): TEllipsisPosition;
  end;

  TFNDrawText_sh = class(TLMDScriptEventHandler)
  public
    function  GetHandler: TMethod; override;
    procedure Handler(DC: HDC; const Text: UnicodeString; var TextRect: TRect;
      TextFlags: Cardinal);
  end;

  TFNDrawText_sw = class(TLMDEventWrapper)
  protected
    class function GetTypeName: WideString; override;
  public
    class function ToVar(const AValue: TFNDrawText): OleVariant;
    class function FromVar(const AValue: OleVariant): TFNDrawText;
    class function GetScriptHandlerClass: TClass; override;
    class function GetHandler(AScriptControl: TLMDScriptControl;
                              const AProcName: string): TFNDrawText;
  end;
  ...
  TEditCharCase_sw = System.UITypes_LMDSW.TEditCharCase_sw;
  ...
  TScrollStyle_sw = System.UITypes_LMDSW.TScrollStyle_sw;
  ...
  TImageAlignment_sw = class(TLMDEnumWrapper)
  protected
    class function  GetTypeName: WideString; override;
    class procedure GetEnumerators(out AEnums: PLMDEnumerator;
                                   out ACount: Integer); override;
  public
    class function ToVar(const AValue: TImageAlignment): OleVariant;
    class function FromVar(const AValue: OleVariant): TImageAlignment;
  end;

  TImageMargins_sc = class of TImageMargins;
  TImageMargins_sw = class(TPersistent_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TImageMargins): OleVariant;
    class function FromVar(const AValue: OleVariant): TImageMargins;
    class function ClassToVar(AClass: TImageMargins_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TImageMargins_sc;
  end;

  TPushButtonActionLink_sc = class of TPushButtonActionLink;
  TPushButtonActionLink_sw = class(TButtonActionLink_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TPushButtonActionLink): OleVariant;
    class function FromVar(const AValue: OleVariant): TPushButtonActionLink;
    class function ClassToVar(AClass: TPushButtonActionLink_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TPushButtonActionLink_sc;
  end;

  TPushButtonActionLinkClass_sw = class(TLMDMetaclassWrapper)
  protected
    class function GetTypeName: WideString; override;
    class function GetWrappedBaseClass: TClass; override;
  public
    class function ToVar(const AValue: TPushButtonActionLinkClass): OleVariant;
    class function FromVar(const AValue: OleVariant): TPushButtonActionLinkClass;
  end;

  TCustomButton_sc = class of TCustomButton;
  TCustomButton_sw = class(TButtonControl_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TCustomButton): OleVariant;
    class function FromVar(const AValue: OleVariant): TCustomButton;
    class function ClassToVar(AClass: TCustomButton_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TCustomButton_sc;
  end;

  TButton_sc = class of TButton;
  TButton_sw = class(TCustomButton_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  ...
  TListBoxItemData_sw = Winapi.Windows_LMDSW.LPARAM_sw;
  ...
  TScrollCode_sw = System.UITypes_LMDSW.TScrollCode_sw;
  ...
  TSelection_sw = class(TLMDRecordWrapper)
  private
    FValue: TSelection;
  protected
    class function  GetTypeName: WideString; override;
  ...
  public
    class function ToVar(const AValue: TSelection): OleVariant;
    class function FromVar(const AValue: OleVariant): TSelection;
  end;
...
{ TEllipsisPosition_sw }

class function TEllipsisPosition_sw.GetTypeName: WideString;
begin
  Result := 'TEllipsisPosition';
end;

class procedure TEllipsisPosition_sw.GetEnumerators(out AEnums: PLMDEnumerator;
  out ACount: Integer);
const
  ENUMS: array[0..3] of TLMDEnumerator = (
    (Name: 'epNone'; Value: Integer({$IFDEF LMDSCT_12}TEllipsisPosition.{$ENDIF}epNone)),
    (Name: 'epPathEllipsis'; Value: Integer({$IFDEF LMDSCT_12}TEllipsisPosition.{$ENDIF}epPathEllipsis)),
    (Name: 'epEndEllipsis'; Value: Integer({$IFDEF LMDSCT_12}TEllipsisPosition.{$ENDIF}epEndEllipsis)),
    (Name: 'epWordEllipsis'; Value: Integer({$IFDEF LMDSCT_12}TEllipsisPosition.{$ENDIF}epWordEllipsis))
  );
begin
  AEnums := @ENUMS;
  ACount := 4;
...
class function TEllipsisPosition_sw.ToVar(
  const AValue: TEllipsisPosition): OleVariant;
begin
  Result := Integer(AValue);
end;

class function TEllipsisPosition_sw.FromVar(
  const AValue: OleVariant): TEllipsisPosition;
begin
  Result := TEllipsisPosition(Integer(AValue));
end;

{ TFNDrawText_sh }

function TFNDrawText_sh.GetHandler: TMethod;
var
  hdr: TFNDrawText;
begin
  hdr    := Handler;
...
procedure TFNDrawText_sh.Handler(DC: HDC; const Text: UnicodeString;
  var TextRect: TRect; TextFlags: Cardinal);
var
  args: array[0..3] of OleVariant;
  v_1: OleVariant;
begin
  // procedure (DC: HDC; const Text: UnicodeString; var TextRe...

  v_1 := TRect_sw.ToVar(TextRect);
  args[0] := HDC_sw.ToVar(DC);
  args[1] := Text;
  args[2] := MakeVarRef(v_1);
  args[3] := TextFlags;
  Self.Owner.RunProc(Self.ProcName, args);
  TextRect := TRect_sw.FromVar(v_1);
end;

{ TFNDrawText_sw }

class function TFNDrawText_sw.GetTypeName: WideString;
begin
  Result := 'TFNDrawText';
end;

class function TFNDrawText_sw.GetScriptHandlerClass: TClass;
begin
  Result := TFNDrawText_sh;
end;

class function TFNDrawText_sw.ToVar(const AValue: TFNDrawText): OleVariant;
begin
  Result := ConvToVar(TMethod(AValue));
end;

class function TFNDrawText_sw.FromVar(const AValue: OleVariant): TFNDrawText;
begin
  Result := TFNDrawText(ConvFromVar(AValue));
end;

class function TFNDrawText_sw.GetHandler(AScriptControl: TLMDScriptControl;
  const AProcName: string): TFNDrawText;
var
  hdlr: TFNDrawText_sh;
begin
  hdlr   := TFNDrawText_sh(AScriptControl.GetEventHandler(AProcName, 
    TFNDrawText_sw));
  Result := hdlr.Handler;
end;
...
function TCustomLabel_EllipsisPosition_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property EllipsisPosition: TEllipsisPosition re...

  if IsGet then
    Result := TEllipsisPosition_sw.ToVar(TCustomLabel_sacc(TCustomLabel(AObj)).
      EllipsisPosition)
  else
    TCustomLabel_sacc(TCustomLabel(AObj)).EllipsisPosition := 
      TEllipsisPosition_sw.FromVar(AArgs[0]);
end;
...
function TCustomLabel_GlowSize_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property GlowSize: Integer read <getter> write <setter>;

  if IsGet then
    Result := TCustomLabel(AObj).GlowSize
  else
    TCustomLabel(AObj).GlowSize := Integer(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('EllipsisPosition', TCustomLabel_EllipsisPosition_si, TEllipsisPosition_sw, True, True, 0, True, False);
  ...
  AData.AddProperty('GlowSize', TCustomLabel_GlowSize_si, Integer_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('DragKind', False);
  AData.AddPropertyRedecl('DragMode', False);
  AData.AddPropertyRedecl('EllipsisPosition', False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('FocusControl', False);
  AData.AddPropertyRedecl('Font', False);
  AData.AddPropertyRedecl('GlowSize', False);
  AData.AddPropertyRedecl('ParentBiDiMode', False);
  AData.AddPropertyRedecl('ParentColor', False);
  AData.AddPropertyRedecl('ParentFont', False);
  AData.AddPropertyRedecl('ParentShowHint', False);
...
function TCustomEdit_NumbersOnly_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property NumbersOnly: Boolean read <getter> wri...

  if IsGet then
    Result := TCustomEdit_sacc(TCustomEdit(AObj)).NumbersOnly
  else
    TCustomEdit_sacc(TCustomEdit(AObj)).NumbersOnly := Boolean(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := Ord(TCustomEdit_sacc(TCustomEdit(AObj)).PasswordChar)
  else
...
function TCustomEdit_SetSelText_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure SetSelText(const Value: string);

  TCustomEdit(AObj).SetSelText(string(AArgs[0]));
end;
...
function TCustomEdit_Alignment_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Alignment: TAlignment read <getter> write <setter>;

  if IsGet then
    Result := TAlignment_sw.ToVar(TCustomEdit(AObj).Alignment)
  else
    TCustomEdit(AObj).Alignment := TAlignment_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TCustomEdit(AObj).ReadOnly
  else
    TCustomEdit(AObj).ReadOnly := Boolean(AArgs[0]);
end;
...
function TCustomEdit_TextHint_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property TextHint: string read <getter> write <setter>;

  if IsGet then
    Result := TCustomEdit(AObj).TextHint
  else
    TCustomEdit(AObj).TextHint := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('NumbersOnly', TCustomEdit_NumbersOnly_si, Boolean_sw, True, True, 0, True, False);
  ...
  AData.AddProcedure('SetSelText', TCustomEdit_SetSelText_si, 1, False);
  AData.AddProcedure('SelectAll', TCustomEdit_SelectAll_si, 0, False);
  AData.AddProperty('Alignment', TCustomEdit_Alignment_si, TAlignment_sw, True, True, 0, False, False);
  ...
  AData.AddProperty('ReadOnly', TCustomEdit_ReadOnly_si, Boolean_sw, True, True, 0, False, False);
  ...
  AData.AddProperty('TextHint', TCustomEdit_TextHint_si, string_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('TabStop', False);
end;
...
function TCustomMemo_ScrollBars_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property ScrollBars: System.UITypes.TScrollStyl...

  if IsGet then
    Result := System.UITypes_LMDSW.TScrollStyle_sw.ToVar(TCustomMemo_sacc(
      TCustomMemo(AObj)).ScrollBars)
  else
    TCustomMemo_sacc(TCustomMemo(AObj)).ScrollBars := System.UITypes_LMDSW.
      TScrollStyle_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('ScrollBars', TCustomMemo_ScrollBars_si, System.UITypes_LMDSW.TScrollStyle_sw, True, True, 0, True, False);
...
function TCustomComboBoxStrings_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create;

  Result := TCustomComboBoxStrings_sw.ToVar(TCustomComboBoxStrings_sc(AObj).
    Create());
end;
...
begin
  ...
  AData.AddConstructor('Create', TCustomComboBoxStrings_Create_si, 0, False);
end;
...
function TCustomComboBox_AutoCompleteDelay_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property AutoCompleteDelay: Cardinal read <getter> write ...

  if IsGet then
    Result := TCustomComboBox(AObj).AutoCompleteDelay
  else
    TCustomComboBox(AObj).AutoCompleteDelay := Cardinal(AArgs[0]);
end;
...
function TCustomComboBox_TextHint_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property TextHint: string read <getter> write <setter>;

  if IsGet then
    Result := TCustomComboBox(AObj).TextHint
  else
    TCustomComboBox(AObj).TextHint := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('AutoCompleteDelay', TCustomComboBox_AutoCompleteDelay_si, Cardinal_sw, True, True, 0, False, False);
  ...
  AData.AddProperty('TextHint', TCustomComboBox_TextHint_si, string_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('AutoCompleteDelay', False);
...
class function TImageAlignment_sw.GetTypeName: WideString;
begin
  Result := 'TImageAlignment';
end;

class procedure TImageAlignment_sw.GetEnumerators(out AEnums: PLMDEnumerator;
  out ACount: Integer);
const
  ENUMS: array[0..4] of TLMDEnumerator = (
    (Name: 'iaLeft'; Value: Integer({$IFDEF LMDSCT_12}TImageAlignment.{$ENDIF}iaLeft)),
    (Name: 'iaRight'; Value: Integer({$IFDEF LMDSCT_12}TImageAlignment.{$ENDIF}iaRight)),
    (Name: 'iaTop'; Value: Integer({$IFDEF LMDSCT_12}TImageAlignment.{$ENDIF}iaTop)),
    (Name: 'iaBottom'; Value: Integer({$IFDEF LMDSCT_12}TImageAlignment.{$ENDIF}iaBottom)),
    (Name: 'iaCenter'; Value: Integer({$IFDEF LMDSCT_12}TImageAlignment.{$ENDIF}iaCenter))
  );
begin
  AEnums := @ENUMS;
  ACount := 5;
...
class function TImageAlignment_sw.ToVar(
  const AValue: TImageAlignment): OleVariant;
begin
  Result := Integer(AValue);
end;

class function TImageAlignment_sw.FromVar(
  const AValue: OleVariant): TImageAlignment;
begin
  Result := TImageAlignment(Integer(AValue));
end;

{ TImageMargins_sw }

function TImageMargins_OnChange_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property OnChange: TNotifyEvent read <getter> write <sett...

  if IsGet then
    Result := TNotifyEvent_sw.ToVar(TImageMargins(AObj).OnChange)
  else
    TImageMargins(AObj).OnChange := TNotifyEvent_sw.FromVar(AArgs[0]);
end;

function TImageMargins_Left_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Left: Integer read <getter> write <setter>;

  if IsGet then
    Result := TImageMargins(AObj).Left
  else
    TImageMargins(AObj).Left := Integer(AArgs[0]);
end;

function TImageMargins_Top_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Top: Integer read <getter> write <setter>;

  if IsGet then
    Result := TImageMargins(AObj).Top
  else
    TImageMargins(AObj).Top := Integer(AArgs[0]);
end;

function TImageMargins_Right_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Right: Integer read <getter> write <setter>;

  if IsGet then
    Result := TImageMargins(AObj).Right
  else
    TImageMargins(AObj).Right := Integer(AArgs[0]);
end;

function TImageMargins_Bottom_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Bottom: Integer read <getter> write <setter>;

  if IsGet then
    Result := TImageMargins(AObj).Bottom
  else
    TImageMargins(AObj).Bottom := Integer(AArgs[0]);
end;

class function TImageMargins_sw.GetTypeName: WideString;
begin
  Result := 'TImageMargins';
end;

class function TImageMargins_sw.GetWrappedClass: TClass;
begin
  Result := TImageMargins;
end;

class procedure TImageMargins_sw.DoInit(AData: TLMDClassWrapperData);
begin
  { Instance members }

  AData.AddProperty('OnChange', TImageMargins_OnChange_si, TNotifyEvent_sw, True, True, 0, False, False);
  AData.AddProperty('Left', TImageMargins_Left_si, Integer_sw, True, True, 0, False, False);
  AData.AddProperty('Top', TImageMargins_Top_si, Integer_sw, True, True, 0, False, False);
  AData.AddProperty('Right', TImageMargins_Right_si, Integer_sw, True, True, 0, False, False);
  AData.AddProperty('Bottom', TImageMargins_Bottom_si, Integer_sw, True, True, 0, False, False);
end;

class function TImageMargins_sw.ToVar(const AValue: TImageMargins): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TImageMargins_sw.FromVar(
  const AValue: OleVariant): TImageMargins;
begin
  Result := TImageMargins(ConvFromVar(AValue, TImageMargins));
end;

class function TImageMargins_sw.ClassToVar(
  AClass: TImageMargins_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TImageMargins_sw.ClassFromVar(
  const AClass: OleVariant): TImageMargins_sc;
begin
  Result := TImageMargins_sc(ConvClsFromVar(AClass, TImageMargins));
end;

{ TPushButtonActionLink_sw }

class function TPushButtonActionLink_sw.GetTypeName: WideString;
begin
  Result := 'TPushButtonActionLink';
end;

class function TPushButtonActionLink_sw.GetWrappedClass: TClass;
begin
  Result := TPushButtonActionLink;
end;

class procedure TPushButtonActionLink_sw.DoInit(AData: TLMDClassWrapperData);
begin
  // Do not call inherited.
end;

class function TPushButtonActionLink_sw.ToVar(
  const AValue: TPushButtonActionLink): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TPushButtonActionLink_sw.FromVar(
  const AValue: OleVariant): TPushButtonActionLink;
begin
  Result := TPushButtonActionLink(ConvFromVar(AValue, TPushButtonActionLink));
end;

class function TPushButtonActionLink_sw.ClassToVar(
  AClass: TPushButtonActionLink_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TPushButtonActionLink_sw.ClassFromVar(
  const AClass: OleVariant): TPushButtonActionLink_sc;
begin
  Result := TPushButtonActionLink_sc(ConvClsFromVar(AClass, 
    TPushButtonActionLink));
end;

{ TPushButtonActionLinkClass_sw }

class function TPushButtonActionLinkClass_sw.GetTypeName: WideString;
begin
  Result := 'TPushButtonActionLinkClass';
end;

class function TPushButtonActionLinkClass_sw.GetWrappedBaseClass: TClass;
begin
  Result := TPushButtonActionLink;
end;

class function TPushButtonActionLinkClass_sw.ToVar(
  const AValue: TPushButtonActionLinkClass): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TPushButtonActionLinkClass_sw.FromVar(
  const AValue: OleVariant): TPushButtonActionLinkClass;
begin
  Result := TPushButtonActionLinkClass(ConvFromVar(AValue, 
    TPushButtonActionLink));
end;

{ TCustomButton_sw }

function TCustomButton_Cancel_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Cancel: Boolean read <getter> write <setter>;

  if IsGet then
    Result := TCustomButton(AObj).Cancel
  else
    TCustomButton(AObj).Cancel := Boolean(AArgs[0]);
end;

function TCustomButton_CommandLinkHint_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property CommandLinkHint: string read <getter> write <set...

  if IsGet then
    Result := TCustomButton(AObj).CommandLinkHint
  else
    TCustomButton(AObj).CommandLinkHint := string(AArgs[0]);
end;

function TCustomButton_Default_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Default: Boolean read <getter> write <setter>;

  if IsGet then
    Result := TCustomButton(AObj).Default
  else
    TCustomButton(AObj).Default := Boolean(AArgs[0]);
end;

function TCustomButton_DisabledImageIndex_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DisabledImageIndex: TImageIndex read <getter> wr...

  if IsGet then
    Result := TImageIndex_sw.ToVar(TCustomButton(AObj).DisabledImageIndex)
  else
    TCustomButton(AObj).DisabledImageIndex := TImageIndex_sw.FromVar(AArgs[0]);
end;

function TCustomButton_DropDownMenu_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property DropDownMenu: TPopupMenu read <getter> write <se...

  if IsGet then
    Result := TPopupMenu_sw.ToVar(TCustomButton(AObj).DropDownMenu)
  else
    TCustomButton(AObj).DropDownMenu := TPopupMenu_sw.FromVar(AArgs[0]);
end;

function TCustomButton_ElevationRequired_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property ElevationRequired: Boolean read <getter> write <...

  if IsGet then
    Result := TCustomButton(AObj).ElevationRequired
  else
    TCustomButton(AObj).ElevationRequired := Boolean(AArgs[0]);
end;

function TCustomButton_HotImageIndex_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property HotImageIndex: TImageIndex read <getter> write <...

  if IsGet then
    Result := TImageIndex_sw.ToVar(TCustomButton(AObj).HotImageIndex)
  else
    TCustomButton(AObj).HotImageIndex := TImageIndex_sw.FromVar(AArgs[0]);
end;

function TCustomButton_Images_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Images: TCustomImageList read <getter> write <se...

  if IsGet then
    Result := TCustomImageList_sw.ToVar(TCustomButton(AObj).Images)
  else
    TCustomButton(AObj).Images := TCustomImageList_sw.FromVar(AArgs[0]);
end;

function TCustomButton_ImageAlignment_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property ImageAlignment: TImageAlignment read <getter> wr...

  if IsGet then
    Result := TImageAlignment_sw.ToVar(TCustomButton(AObj).ImageAlignment)
  else
    TCustomButton(AObj).ImageAlignment := TImageAlignment_sw.FromVar(AArgs[0]);
end;

function TCustomButton_ImageIndex_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property ImageIndex: TImageIndex read <getter> write <set...

  if IsGet then
    Result := TImageIndex_sw.ToVar(TCustomButton(AObj).ImageIndex)
  else
    TCustomButton(AObj).ImageIndex := TImageIndex_sw.FromVar(AArgs[0]);
end;

function TCustomButton_ImageMargins_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property ImageMargins: TImageMargins read <getter> write ...

  if IsGet then
    Result := TImageMargins_sw.ToVar(TCustomButton(AObj).ImageMargins)
  else
    TCustomButton(AObj).ImageMargins := TImageMargins_sw.FromVar(AArgs[0]);
end;

function TCustomButton_ModalResult_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property ModalResult: TModalResult read <getter> write <s...

  if IsGet then
    Result := TModalResult_sw.ToVar(TCustomButton(AObj).ModalResult)
  else
    TCustomButton(AObj).ModalResult := TModalResult_sw.FromVar(AArgs[0]);
end;

function TCustomButton_PressedImageIndex_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property PressedImageIndex: TImageIndex read <getter> wri...

  if IsGet then
    Result := TImageIndex_sw.ToVar(TCustomButton(AObj).PressedImageIndex)
  else
    TCustomButton(AObj).PressedImageIndex := TImageIndex_sw.FromVar(AArgs[0]);
end;

function TCustomButton_SelectedImageIndex_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property SelectedImageIndex: TImageIndex read <getter> wr...

  if IsGet then
    Result := TImageIndex_sw.ToVar(TCustomButton(AObj).SelectedImageIndex)
  else
    TCustomButton(AObj).SelectedImageIndex := TImageIndex_sw.FromVar(AArgs[0]);
end;

function TCustomButton_StylusHotImageIndex_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property StylusHotImageIndex: TImageIndex read <getter> w...

  if IsGet then
    Result := TImageIndex_sw.ToVar(TCustomButton(AObj).StylusHotImageIndex)
  else
    TCustomButton(AObj).StylusHotImageIndex := TImageIndex_sw.FromVar(AArgs[0]);
end;

function TCustomButton_OnDropDownClick_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property OnDropDownClick: TNotifyEvent read <getter> writ...

  if IsGet then
    Result := TNotifyEvent_sw.ToVar(TCustomButton(AObj).OnDropDownClick)
  else
    TCustomButton(AObj).OnDropDownClick := TNotifyEvent_sw.FromVar(AArgs[0]);
end;

class function TCustomButton_sw.GetTypeName: WideString;
begin
  Result := 'TCustomButton';
end;

class function TCustomButton_sw.GetWrappedClass: TClass;
begin
  Result := TCustomButton;
end;

class procedure TCustomButton_sw.DoInit(AData: TLMDClassWrapperData);
begin
  { Instance members }

  AData.AddProperty('Cancel', TCustomButton_Cancel_si, Boolean_sw, True, True, 0, False, False);
  AData.AddProperty('CommandLinkHint', TCustomButton_CommandLinkHint_si, string_sw, True, True, 0, False, False);
  AData.AddProperty('Default', TCustomButton_Default_si, Boolean_sw, True, True, 0, False, False);
  AData.AddProperty('DisabledImageIndex', TCustomButton_DisabledImageIndex_si, TImageIndex_sw, True, True, 0, False, False);
  AData.AddProperty('DropDownMenu', TCustomButton_DropDownMenu_si, TPopupMenu_sw, True, True, 0, False, False);
  AData.AddProperty('ElevationRequired', TCustomButton_ElevationRequired_si, Boolean_sw, True, True, 0, False, False);
  AData.AddProperty('HotImageIndex', TCustomButton_HotImageIndex_si, TImageIndex_sw, True, True, 0, False, False);
  AData.AddProperty('Images', TCustomButton_Images_si, TCustomImageList_sw, True, True, 0, False, False);
  AData.AddProperty('ImageAlignment', TCustomButton_ImageAlignment_si, TImageAlignment_sw, True, True, 0, False, False);
  AData.AddProperty('ImageIndex', TCustomButton_ImageIndex_si, TImageIndex_sw, True, True, 0, False, False);
  AData.AddProperty('ImageMargins', TCustomButton_ImageMargins_si, TImageMargins_sw, True, True, 0, False, False);
  AData.AddProperty('ModalResult', TCustomButton_ModalResult_si, TModalResult_sw, True, True, 0, False, False);
  AData.AddProperty('PressedImageIndex', TCustomButton_PressedImageIndex_si, TImageIndex_sw, True, True, 0, False, False);
  AData.AddProperty('SelectedImageIndex', TCustomButton_SelectedImageIndex_si, TImageIndex_sw, True, True, 0, False, False);
  AData.AddProperty('StylusHotImageIndex', TCustomButton_StylusHotImageIndex_si, TImageIndex_sw, True, True, 0, False, False);
  AData.AddPropertyRedecl('TabStop', False);
  AData.AddProperty('OnDropDownClick', TCustomButton_OnDropDownClick_si, TNotifyEvent_sw, True, True, 0, False, False);
end;

class function TCustomButton_sw.ToVar(const AValue: TCustomButton): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TCustomButton_sw.FromVar(
  const AValue: OleVariant): TCustomButton;
begin
  Result := TCustomButton(ConvFromVar(AValue, TCustomButton));
end;

class function TCustomButton_sw.ClassToVar(
  AClass: TCustomButton_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TCustomButton_sw.ClassFromVar(
  const AClass: OleVariant): TCustomButton_sc;
begin
  Result := TCustomButton_sc(ConvClsFromVar(AClass, TCustomButton));
end;
...
begin
  ...
  AData.AddPropertyRedecl('Caption', False);
  AData.AddPropertyRedecl('CommandLinkHint', False);
  AData.AddPropertyRedecl('Constraints', False);
  AData.AddPropertyRedecl('Default', False);
  AData.AddPropertyRedecl('DisabledImageIndex', False);
  AData.AddPropertyRedecl('DoubleBuffered', False);
  AData.AddPropertyRedecl('DragCursor', False);
  AData.AddPropertyRedecl('DragKind', False);
  AData.AddPropertyRedecl('DragMode', False);
  AData.AddPropertyRedecl('DropDownMenu', False);
  AData.AddPropertyRedecl('ElevationRequired', False);
  AData.AddPropertyRedecl('Enabled', False);
  AData.AddPropertyRedecl('Font', False);
  AData.AddPropertyRedecl('HotImageIndex', False);
  AData.AddPropertyRedecl('ImageAlignment', False);
  AData.AddPropertyRedecl('ImageIndex', False);
  AData.AddPropertyRedecl('ImageMargins', False);
  ...
  AData.AddPropertyRedecl('ParentShowHint', False);
  AData.AddPropertyRedecl('PopupMenu', False);
  AData.AddPropertyRedecl('PressedImageIndex', False);
  AData.AddPropertyRedecl('SelectedImageIndex', False);
  AData.AddPropertyRedecl('ShowHint', False);
  AData.AddPropertyRedecl('Style', False);
  AData.AddPropertyRedecl('StylusHotImageIndex', False);
  AData.AddPropertyRedecl('TabOrder', False);
  AData.AddPropertyRedecl('TabStop', False);
  AData.AddPropertyRedecl('Visible', False);
  AData.AddPropertyRedecl('WordWrap', False);
  ...
  AData.AddPropertyRedecl('OnDragDrop', False);
  AData.AddPropertyRedecl('OnDragOver', False);
  AData.AddPropertyRedecl('OnDropDownClick', False);
  AData.AddPropertyRedecl('OnEndDock', False);
  AData.AddPropertyRedecl('OnEndDrag', False);
  AData.AddPropertyRedecl('OnEnter', False);
  AData.AddPropertyRedecl('OnExit', False);
...
function TCustomListBox_AutoCompleteDelay_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property AutoCompleteDelay: Cardinal read <getter> write ...

  if IsGet then
    Result := TCustomListBox(AObj).AutoCompleteDelay
  else
    TCustomListBox(AObj).AutoCompleteDelay := Cardinal(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('AutoCompleteDelay', TCustomListBox_AutoCompleteDelay_si, Cardinal_sw, True, True, 0, False, False);
...
function TSelection_StartPos_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var StartPos: Integer;

  if IsGet then
    Result := TSelection_sw(AObj).FValue.StartPos
  else
    TSelection_sw(AObj).FValue.StartPos := Integer(AArgs[0]);
end;

function TSelection_EndPos_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var EndPos: Integer;

  if IsGet then
    Result := TSelection_sw(AObj).FValue.EndPos
  else
    TSelection_sw(AObj).FValue.EndPos := Integer(AArgs[0]);
end;

function TSelection_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create;

  // Implicit parameterless constructor.
  Result := TSelection_sw.Create as IDispatch;
end;

function TSelection_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: TSelection;

  // Implicit record copy method.
  Result := TSelection_sw.ToVar(TSelection(AObj));
end;

class function TSelection_sw.GetTypeName: WideString;
begin
  Result := 'TSelection';
end;

function TSelection_sw.CloneVal: TLMDRecordWrapper;
begin
  Result := TSelection_sw.Create;
  TSelection_sw(Result).FValue := FValue;
end;

class procedure TSelection_sw.DoInit(AData: TLMDRecordWrapperData);
begin
  { Instance members }

  AData.AddField('StartPos', TSelection_StartPos_si, Integer_sw);
  AData.AddField('EndPos', TSelection_EndPos_si, Integer_sw);
  AData.AddFunction('Copy', TSelection_Copy_si, TSelection_sw, 0, False);

  { Class members }

  AData.AddConstructor('Create', TSelection_Create_si, 0, False);
end;

class function TSelection_sw.ToVar(const AValue: TSelection): OleVariant;
var
  wrpr: TSelection_sw;
begin
  wrpr        := TSelection_sw.Create;
  wrpr.FValue := AValue;
  
  Result := ConvToVar(wrpr);
end;

class function TSelection_sw.FromVar(const AValue: OleVariant): TSelection;
begin
  Result := TSelection_sw(ConvFromVar(AValue)).FValue;
end;
...
function StdCtrls_TEllipsisPosition_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TEllipsisPosition = (epNone, epPathEllipsis, epEndEl...

  Result := TLMDUnitWrapper.TypeToVar(TEllipsisPosition_sw);
end;

function StdCtrls_TFNDrawText_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFNDrawText = procedure (DC: HDC; const Text: Unicod...

  Result := TLMDUnitWrapper.TypeToVar(TFNDrawText_sw);
end;
...
function StdCtrls_ecNormal_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const ecNormal = <value>;

  Result := TEditCharCase_sw.ToVar(ecNormal);
end;

function StdCtrls_ecUpperCase_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const ecUpperCase = <value>;

  Result := TEditCharCase_sw.ToVar(ecUpperCase);
end;

function StdCtrls_ecLowerCase_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const ecLowerCase = <value>;

  Result := TEditCharCase_sw.ToVar(ecLowerCase);
end;

function StdCtrls_TEditCharCase_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TEditCharCase = System.UITypes.TEditCharCase;
...
function StdCtrls_ssNone_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const ssNone = <value>;

  Result := TScrollStyle_sw.ToVar(ssNone);
end;

function StdCtrls_ssHorizontal_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const ssHorizontal = <value>;

  Result := TScrollStyle_sw.ToVar(ssHorizontal);
end;

function StdCtrls_ssVertical_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const ssVertical = <value>;

  Result := TScrollStyle_sw.ToVar(ssVertical);
end;

function StdCtrls_ssBoth_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const ssBoth = <value>;

  Result := TScrollStyle_sw.ToVar(ssBoth);
end;

function StdCtrls_TScrollStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TScrollStyle = System.UITypes.TScrollStyle;
...
function StdCtrls_TImageAlignment_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TImageAlignment = (iaLeft, iaRight, iaTop, iaBottom,...

  Result := TLMDUnitWrapper.TypeToVar(TImageAlignment_sw);
end;

function StdCtrls_TImageMargins_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TImageMargins = class(TPersistent);

  Result := TLMDUnitWrapper.TypeToVar(TImageMargins_sw);
end;

function StdCtrls_TPushButtonActionLink_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPushButtonActionLink = class(TButtonActionLink);

  Result := TLMDUnitWrapper.TypeToVar(TPushButtonActionLink_sw);
end;

function StdCtrls_TPushButtonActionLinkClass_si(var AObj;
  const AArgs: TLMDDispArgs; AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TPushButtonActionLinkClass = class of TPushButtonAct...

  Result := TLMDUnitWrapper.TypeToVar(TPushButtonActionLinkClass_sw);
end;

function StdCtrls_TCustomButton_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TCustomButton = class(TButtonControl);

  Result := TLMDUnitWrapper.TypeToVar(TCustomButton_sw);
end;
...
function StdCtrls_TListBoxItemData_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TListBoxItemData = Winapi.Windows.LPARAM;

  Result := TLMDUnitWrapper.TypeToVar(TListBoxItemData_sw);
end;
...
function StdCtrls_scLineUp_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const scLineUp = <value>;

  Result := TScrollCode_sw.ToVar(scLineUp);
end;

function StdCtrls_scLineDown_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const scLineDown = <value>;

  Result := TScrollCode_sw.ToVar(scLineDown);
end;

function StdCtrls_scPageUp_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const scPageUp = <value>;

  Result := TScrollCode_sw.ToVar(scPageUp);
end;

function StdCtrls_scPageDown_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const scPageDown = <value>;

  Result := TScrollCode_sw.ToVar(scPageDown);
end;

function StdCtrls_scPosition_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const scPosition = <value>;

  Result := TScrollCode_sw.ToVar(scPosition);
end;

function StdCtrls_scTrack_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const scTrack = <value>;

  Result := TScrollCode_sw.ToVar(scTrack);
end;

function StdCtrls_scTop_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const scTop = <value>;

  Result := TScrollCode_sw.ToVar(scTop);
end;

function StdCtrls_scBottom_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const scBottom = <value>;

  Result := TScrollCode_sw.ToVar(scBottom);
end;

function StdCtrls_scEndScroll_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const scEndScroll = <value>;

  Result := TScrollCode_sw.ToVar(scEndScroll);
end;

function StdCtrls_TScrollCode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TScrollCode = System.UITypes.TScrollCode;
...
function StdCtrls_TSelection_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TSelection = record;

  Result := TLMDUnitWrapper.TypeToVar(TSelection_sw);
end;
...
begin
  ...
  AData.AddType(TEllipsisPosition_sw, StdCtrls_TEllipsisPosition_si);
  AData.AddType(TFNDrawText_sw, StdCtrls_TFNDrawText_si);
  AData.AddType(TCustomLabel_sw, StdCtrls_TCustomLabel_si);
  AData.AddType(TLabel_sw, StdCtrls_TLabel_si);
  AData.AddConstant('ecNormal', StdCtrls_ecNormal_si, TEditCharCase_sw);
  AData.AddConstant('ecUpperCase', StdCtrls_ecUpperCase_si, TEditCharCase_sw);
  AData.AddConstant('ecLowerCase', StdCtrls_ecLowerCase_si, TEditCharCase_sw);
  ...
  AData.AddConstant('ssNone', StdCtrls_ssNone_si, TScrollStyle_sw);
  AData.AddConstant('ssHorizontal', StdCtrls_ssHorizontal_si, TScrollStyle_sw);
  AData.AddConstant('ssVertical', StdCtrls_ssVertical_si, TScrollStyle_sw);
  AData.AddConstant('ssBoth', StdCtrls_ssBoth_si, TScrollStyle_sw);
  ...
  AData.AddType(TImageAlignment_sw, StdCtrls_TImageAlignment_si);
  AData.AddType(TImageMargins_sw, StdCtrls_TImageMargins_si);
  AData.AddType(TPushButtonActionLink_sw, StdCtrls_TPushButtonActionLink_si);
  AData.AddType(TPushButtonActionLinkClass_sw, StdCtrls_TPushButtonActionLinkClass_si);
  AData.AddType(TCustomButton_sw, StdCtrls_TCustomButton_si);
  ...
  AData.AddType(TListBoxItemData_sw, StdCtrls_TListBoxItemData_si);
  AData.AddType(TCustomListBox_sw, StdCtrls_TCustomListBox_si);
  AData.AddType(TListBox_sw, StdCtrls_TListBox_si);
  AData.AddConstant('scLineUp', StdCtrls_scLineUp_si, TScrollCode_sw);
  AData.AddConstant('scLineDown', StdCtrls_scLineDown_si, TScrollCode_sw);
  AData.AddConstant('scPageUp', StdCtrls_scPageUp_si, TScrollCode_sw);
  AData.AddConstant('scPageDown', StdCtrls_scPageDown_si, TScrollCode_sw);
  AData.AddConstant('scPosition', StdCtrls_scPosition_si, TScrollCode_sw);
  AData.AddConstant('scTrack', StdCtrls_scTrack_si, TScrollCode_sw);
  AData.AddConstant('scTop', StdCtrls_scTop_si, TScrollCode_sw);
  AData.AddConstant('scBottom', StdCtrls_scBottom_si, TScrollCode_sw);
  AData.AddConstant('scEndScroll', StdCtrls_scEndScroll_si, TScrollCode_sw);
  ...
  AData.AddType(TSelection_sw, StdCtrls_TSelection_si);
end;
...
initialization
  ...
  RegisterClassWrapper(TImageMargins_sw);
  RegisterClassWrapper(TPushButtonActionLink_sw);
  RegisterClassWrapper(TCustomButton_sw);
  ...
  RegisterEventWrapper(TypeInfo(TFNDrawText), TFNDrawText_sw);
