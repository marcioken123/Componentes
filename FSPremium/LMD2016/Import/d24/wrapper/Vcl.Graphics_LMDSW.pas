...

{
  ##############################################################################
  #
  # LMD Script Pack wrappers for 'Vcl.Graphics' unit.
  #
  # WARNING:
...
uses
  ...
  System.SysUtils, System.Classes, Vcl.Graphics, Winapi.Windows_LMDSW,
  System.UITypes_LMDSW, System.SysUtils_LMDSW, System.Classes_LMDSW;
...
type
  ...
  TIcon_sw = class;
  TWICImage_sw = class;
  TGDIHandleRecall_sw = class;

  TColor_sw = System.UITypes_LMDSW.TColor_sw;
  ...
  TFontStyle_sw = System.UITypes_LMDSW.TFontStyle_sw;

  TFontStyles_sw = System.UITypes_LMDSW.TFontStyles_sw;

  TFontName_sw = System.UITypes_LMDSW.TFontName_sw;

  TFontCharset_sw = System.UITypes_LMDSW.TFontCharset_sw;

  TFontPitch_sw = System.UITypes_LMDSW.TFontPitch_sw;

  TFontQuality_sw = System.UITypes_LMDSW.TFontQuality_sw;
  ...
  TDrawTextFlags_sw = Cardinal_sw;

  TTextFormatFlags_sw = class(TLMDRecordWrapper)
  private
    FValue: TTextFormatFlags;
  protected
    class function  GetTypeName: WideString; override;
    function        CloneVal: TLMDRecordWrapper; override;
    class procedure DoInit(AData: TLMDRecordWrapperData); override;
  public
    class function ToVar(const AValue: TTextFormatFlags): OleVariant;
    class function FromVar(const AValue: OleVariant): TTextFormatFlags;
  end;
  ...
  TGDIHandleRecall_sc = class of TGDIHandleRecall;
  TGDIHandleRecall_sw = class(TObject_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  public
    class function ToVar(const AValue: TGDIHandleRecall): OleVariant;
    class function FromVar(const AValue: OleVariant): TGDIHandleRecall;
    class function ClassToVar(AClass: TGDIHandleRecall_sc): OleVariant;
    class function ClassFromVar(const AClass: OleVariant): TGDIHandleRecall_sc;
  end;
...
function TFontData_Quality_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var Quality: TFontQuality;

  if IsGet then
    Result := TFontQuality_sw.ToVar(TFontData_sw(AObj).FValue.Quality)
  else
    TFontData_sw(AObj).FValue.Quality := TFontQuality_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Quality', TFontData_Quality_si, TFontQuality_sw);
...
function TResource_Owner_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var Owner: TThreadID;

  if IsGet then
    Result := TThreadID_sw.ToVar(TResource_sw(AObj).FValue.Owner)
  else
    TResource_sw(AObj).FValue.Owner := TThreadID_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Owner', TResource_Owner_si, TThreadID_sw);
...
function TFont_Quality_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Quality: TFontQuality read <getter> write <setter>;

  if IsGet then
    Result := TFontQuality_sw.ToVar(TFont(AObj).Quality)
  else
    TFont(AObj).Quality := TFontQuality_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('Quality', TFont_Quality_si, TFontQuality_sw, True, True, 0, False, False);
...
class procedure TTextFormats_sw.GetEnumerators(out AEnums: PLMDEnumerator;
  out ACount: Integer);
const
  ENUMS: array[0..23] of TLMDEnumerator = (
    ...
    (Name: 'tfHidePrefix'; Value: Integer({$IFDEF LMDSCT_12}TTextFormats.{$ENDIF}tfHidePrefix)),
    (Name: 'tfNoFullWidthCharBreak'; Value: Integer({$IFDEF LMDSCT_12}TTextFormats.{$ENDIF}tfNoFullWidthCharBreak)),
    (Name: 'tfPrefixOnly'; Value: Integer({$IFDEF LMDSCT_12}TTextFormats.{$ENDIF}tfPrefixOnly)),
    (Name: 'tfTabStop'; Value: Integer({$IFDEF LMDSCT_12}TTextFormats.{$ENDIF}tfTabStop)),
    (Name: 'tfWordEllipsis'; Value: Integer({$IFDEF LMDSCT_12}TTextFormats.{$ENDIF}tfWordEllipsis)),
    (Name: 'tfComposited'; Value: Integer({$IFDEF LMDSCT_12}TTextFormats.{$ENDIF}tfComposited))
  );
begin
  AEnums := @ENUMS;
  ACount := 24;
...
function TTextFormatFlags_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create;

  // Implicit parameterless constructor.
  Result := TTextFormatFlags_sw.Create as IDispatch;
end;

function TTextFormatFlags_Copy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function Copy: TTextFormatFlags;

  // Implicit record copy method.
  Result := TTextFormatFlags_sw.ToVar(TTextFormatFlags(AObj));
end;

class function TTextFormatFlags_sw.GetTypeName: WideString;
begin
  Result := 'TTextFormatFlags';
end;

function TTextFormatFlags_sw.CloneVal: TLMDRecordWrapper;
begin
  Result := TTextFormatFlags_sw.Create;
  TTextFormatFlags_sw(Result).FValue := FValue;
end;

class procedure TTextFormatFlags_sw.DoInit(AData: TLMDRecordWrapperData);
begin
  { Instance members }

  AData.AddFunction('Copy', TTextFormatFlags_Copy_si, TTextFormatFlags_sw, 0, False);

  { Class members }

  AData.AddConstructor('Create', TTextFormatFlags_Create_si, 0, False);
end;

class function TTextFormatFlags_sw.ToVar(
  const AValue: TTextFormatFlags): OleVariant;
var
  wrpr: TTextFormatFlags_sw;
begin
  wrpr        := TTextFormatFlags_sw.Create;
  wrpr.FValue := AValue;
  
  Result := ConvToVar(wrpr);
end;

class function TTextFormatFlags_sw.FromVar(
  const AValue: OleVariant): TTextFormatFlags;
begin
  Result := TTextFormatFlags_sw(ConvFromVar(AValue)).FValue;
end;
...
function TCustomCanvas_ArcTo_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure ArcTo(X1: Integer; Y1: Integer; X2: Integer; Y2...

  TCustomCanvas(AObj).ArcTo(Integer(AArgs[0]), Integer(AArgs[1]), Integer(
    AArgs[2]), Integer(AArgs[3]), Integer(AArgs[4]), Integer(AArgs[5]), Integer(
    AArgs[6]), Integer(AArgs[7]));
end;

function TCustomCanvas_AngleArc_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure AngleArc(X: Integer; Y: Integer; Radius: Cardin...

  TCustomCanvas(AObj).AngleArc(Integer(AArgs[0]), Integer(AArgs[1]), Cardinal(
    AArgs[2]), Single(AArgs[3]), Single(AArgs[4]));
end;
...
begin
  ...
  AData.AddProcedure('ArcTo', TCustomCanvas_ArcTo_si, 8, False);
  AData.AddProcedure('AngleArc', TCustomCanvas_AngleArc_si, 5, False);
...
function TGDIHandleRecall_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create(DC: HDC; GDIObject: Cardinal);

  Result := TGDIHandleRecall_sw.ToVar(TGDIHandleRecall_sc(AObj).Create(HDC_sw.
    FromVar(AArgs[0]), Cardinal(AArgs[1])));
end;

function TGDIHandleRecall_Canvas_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // property Canvas: TCanvas read <getter>;

  Result := TCanvas_sw.ToVar(TGDIHandleRecall(AObj).Canvas);
end;

class function TGDIHandleRecall_sw.GetTypeName: WideString;
begin
  Result := 'TGDIHandleRecall';
end;

class function TGDIHandleRecall_sw.GetWrappedClass: TClass;
begin
  Result := TGDIHandleRecall;
end;

class procedure TGDIHandleRecall_sw.DoInit(AData: TLMDClassWrapperData);
begin
  { Instance members }

  AData.AddProperty('Canvas', TGDIHandleRecall_Canvas_si, TCanvas_sw, True, False, 0, False, False);

  { Class members }

  AData.AddConstructor('Create', TGDIHandleRecall_Create_si, 2, False);
end;

class function TGDIHandleRecall_sw.ToVar(
  const AValue: TGDIHandleRecall): OleVariant;
begin
  Result := ConvToVar(AValue);
end;

class function TGDIHandleRecall_sw.FromVar(
  const AValue: OleVariant): TGDIHandleRecall;
begin
  Result := TGDIHandleRecall(ConvFromVar(AValue, TGDIHandleRecall));
end;

class function TGDIHandleRecall_sw.ClassToVar(
  AClass: TGDIHandleRecall_sc): OleVariant;
begin
  Result := ConvClsToVar(AClass);
end;

class function TGDIHandleRecall_sw.ClassFromVar(
  const AClass: OleVariant): TGDIHandleRecall_sc;
begin
  Result := TGDIHandleRecall_sc(ConvClsFromVar(AClass, TGDIHandleRecall));
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clSystemColor);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSnow);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebFloralWhite);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLavenderBlush);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebOldLace);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebIvory);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebCornSilk);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebBeige);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebAntiqueWhite);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebWheat);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebAliceBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebGhostWhite);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLavender);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSeashell);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightYellow);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPapayaWhip);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebNavajoWhite);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMoccasin);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebBurlywood);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebAzure);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMintcream);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebHoneydew);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLinen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLemonChiffon);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebBlanchedAlmond);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebBisque);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPeachPuff);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebTan);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebYellow);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkOrange);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebRed);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkRed);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMaroon);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebIndianRed);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSalmon);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebCoral);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebGold);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebTomato);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebCrimson);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebBrown);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebChocolate);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSandyBrown);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightSalmon);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightCoral);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebOrange);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebOrangeRed);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebFirebrick);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSaddleBrown);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSienna);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPeru);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkSalmon);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebRosyBrown);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPaleGoldenrod);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightGoldenrodYellow);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebOlive);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebForestGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebGreenYellow);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebChartreuse);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebAquamarine);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSeaGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebGoldenRod);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebKhaki);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebOliveDrab);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebYellowGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLawnGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPaleGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMediumAquamarine);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMediumSeaGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkGoldenRod);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkKhaki);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkOliveGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkgreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLimeGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLime);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSpringGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMediumSpringGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkSeaGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightSeaGreen);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPaleTurquoise);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightCyan);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightSkyBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebCornFlowerBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebIndigo);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMediumTurquoise);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebTurquoise);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebCyan);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebAqua);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPowderBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSkyBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebRoyalBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMediumBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMidnightBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkTurquoise);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebCadetBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkCyan);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebTeal);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDeepskyBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDodgerBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebNavy);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkViolet);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkOrchid);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMagenta);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebFuchsia);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkMagenta);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMediumVioletRed);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPaleVioletRed);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebBlueViolet);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMediumOrchid);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMediumPurple);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPurple);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDeepPink);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightPink);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebViolet);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebOrchid);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPlum);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebThistle);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebHotPink);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebPink);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightSteelBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMediumSlateBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightSlateGray);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebWhite);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebLightgrey);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebGray);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSteelBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSlateBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSlateGray);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebWhiteSmoke);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebSilver);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDimGray);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebMistyRose);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkSlateBlue);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkSlategray);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebGainsboro);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebDarkGray);
end;
...
begin
  ...
  Result := TColor_sw.ToVar(clWebBlack);
end;
...
function Graphics_fsBold_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fsBold = <value>;

  Result := TFontStyle_sw.ToVar(fsBold);
end;

function Graphics_fsItalic_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fsItalic = <value>;

  Result := TFontStyle_sw.ToVar(fsItalic);
end;

function Graphics_fsUnderline_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fsUnderline = <value>;

  Result := TFontStyle_sw.ToVar(fsUnderline);
end;

function Graphics_fsStrikeOut_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fsStrikeOut = <value>;

  Result := TFontStyle_sw.ToVar(fsStrikeOut);
end;

function Graphics_fpDefault_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fpDefault = <value>;

  Result := TFontPitch_sw.ToVar(fpDefault);
end;

function Graphics_fpVariable_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fpVariable = <value>;

  Result := TFontPitch_sw.ToVar(fpVariable);
end;

function Graphics_fpFixed_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fpFixed = <value>;

  Result := TFontPitch_sw.ToVar(fpFixed);
end;

function Graphics_fqDefault_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fqDefault = <value>;

  Result := TFontQuality_sw.ToVar(fqDefault);
end;

function Graphics_fqDraft_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fqDraft = <value>;

  Result := TFontQuality_sw.ToVar(fqDraft);
end;

function Graphics_fqProof_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fqProof = <value>;

  Result := TFontQuality_sw.ToVar(fqProof);
end;

function Graphics_fqNonAntialiased_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fqNonAntialiased = <value>;

  Result := TFontQuality_sw.ToVar(fqNonAntialiased);
end;

function Graphics_fqAntialiased_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fqAntialiased = <value>;

  Result := TFontQuality_sw.ToVar(fqAntialiased);
end;

function Graphics_fqClearType_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fqClearType = <value>;

  Result := TFontQuality_sw.ToVar(fqClearType);
end;

function Graphics_fqClearTypeNatural_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const fqClearTypeNatural = <value>;

  Result := TFontQuality_sw.ToVar(fqClearTypeNatural);
end;

function Graphics_MASK_TF_COMPOSITED_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // const MASK_TF_COMPOSITED = <value>;

  Result := MASK_TF_COMPOSITED;
end;
...
function Graphics_TFontStyle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFontStyle = System.UITypes.TFontStyle;
...
function Graphics_TFontStyles_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFontStyles = System.UITypes.TFontStyles;
...
function Graphics_TFontName_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFontName = System.UITypes.TFontName;
...
function Graphics_TFontCharset_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFontCharset = System.UITypes.TFontCharset;
...
function Graphics_TFontPitch_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFontPitch = System.UITypes.TFontPitch;

  Result := TLMDUnitWrapper.TypeToVar(TFontPitch_sw);
end;

function Graphics_TFontQuality_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TFontQuality = System.UITypes.TFontQuality;
...
function Graphics_TDrawTextFlags_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDrawTextFlags = Cardinal;

  Result := TLMDUnitWrapper.TypeToVar(TDrawTextFlags_sw);
end;

function Graphics_TTextFormatFlags_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TTextFormatFlags = record;

  Result := TLMDUnitWrapper.TypeToVar(TTextFormatFlags_sw);
end;
...
function Graphics_TGDIHandleRecall_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TGDIHandleRecall = class(TObject);

  Result := TLMDUnitWrapper.TypeToVar(TGDIHandleRecall_sw);
end;
...
begin
  ...
  if IsGet then
    Result := TFontData_sw.ToVar(Vcl.Graphics.DefFontData)
  else
    Vcl.Graphics.DefFontData := TFontData_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := HPalette_sw.ToVar(Vcl.Graphics.SystemPalette16)
  else
    Vcl.Graphics.SystemPalette16 := HPalette_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := Vcl.Graphics.DDBsOnly
  else
    Vcl.Graphics.DDBsOnly := Boolean(AArgs[0]);
end;
...
begin
  ...
  Result := Vcl.Graphics.GraphicFilter(TGraphicClass_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Result := Vcl.Graphics.GraphicExtension(TGraphicClass_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Result := Vcl.Graphics.GraphicFileMask(TGraphicClass_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Result := Vcl.Graphics.ColorToRGB(TColor_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Result := Vcl.Graphics.ColorToString(TColor_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Result := TColor_sw.ToVar(Vcl.Graphics.StringToColor(string(AArgs[0])));
end;
...
begin
  ...
  Vcl.Graphics.GetColorValues(TGetStrProc_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  v_1 := string(AArgs[1]);
  Result := Vcl.Graphics.ColorToIdent(Longint(AArgs[0]), v_1);
...
begin
  ...
  v_1 := Longint(AArgs[1]);
  Result := Vcl.Graphics.IdentToColor(string(AArgs[0]), v_1);
  AssignRefParam(AArgs[1], v_1);
end;
...
begin
  ...
  Vcl.Graphics.GetCharsetValues(TGetStrProc_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  v_1 := string(AArgs[1]);
  Result := Vcl.Graphics.CharsetToIdent(Longint(AArgs[0]), v_1);
  AssignRefParam(AArgs[1], v_1);
end;
...
begin
  ...
  v_1 := Longint(AArgs[1]);
  Result := Vcl.Graphics.IdentToCharset(string(AArgs[0]), v_1);
  AssignRefParam(AArgs[1], v_1);
end;
...
begin
  ...
  Vcl.Graphics.GetDIBSizes(HBITMAP_sw.FromVar(AArgs[0]), v_1, v_2);
...
begin
  ...
  Result := HPALETTE_sw.ToVar(Vcl.Graphics.CopyPalette(HPALETTE_sw.FromVar(
    AArgs[0])));
end;
...
begin
  ...
  Result := TFontCharSet_sw.ToVar(Vcl.Graphics.GetDefFontCharSet());
end;
...
begin
  ...
  Result := Vcl.Graphics.TransparentStretchBlt(HDC_sw.FromVar(AArgs[0]), 
    Integer(AArgs[1]), Integer(AArgs[2]), Integer(AArgs[3]), Integer(AArgs[4]),
    HDC_sw.FromVar(AArgs[5]), Integer(AArgs[6]), Integer(AArgs[7]), Integer(
    AArgs[8]), Integer(AArgs[9]), HDC_sw.FromVar(AArgs[10]), Integer(AArgs[11]),
    Integer(AArgs[12]));
end;
...
begin
  ...
  Result := HBITMAP_sw.ToVar(Vcl.Graphics.CreateGrayMappedBmp(HBITMAP_sw.
    FromVar(AArgs[0])));
end;
...
begin
  ...
  Result := TBitmap_sw.ToVar(Vcl.Graphics.AllocPatternBitmap(TColor_sw.FromVar(
...
begin
  ...
  Result := Vcl.Graphics.BytesPerScanline(Longint(AArgs[0]), Longint(AArgs[1]), 
    Longint(AArgs[2]));
end;
...
begin
  ...
  AData.AddConstant('clSystemColor', Graphics_clSystemColor_si, TColor_sw);
  ...
  AData.AddConstant('StandardColorsCount', Graphics_StandardColorsCount_si, nil, VarType(Vcl.Graphics.StandardColorsCount));
  ...
  AData.AddConstant('ExtendedColorsCount', Graphics_ExtendedColorsCount_si, nil, VarType(Vcl.Graphics.ExtendedColorsCount));
  AData.AddConstant('clNone', Graphics_clNone_si, TColor_sw);
  AData.AddConstant('clDefault', Graphics_clDefault_si, TColor_sw);
  AData.AddConstant('clWebSnow', Graphics_clWebSnow_si, TColor_sw);
  AData.AddConstant('clWebFloralWhite', Graphics_clWebFloralWhite_si, TColor_sw);
  AData.AddConstant('clWebLavenderBlush', Graphics_clWebLavenderBlush_si, TColor_sw);
  AData.AddConstant('clWebOldLace', Graphics_clWebOldLace_si, TColor_sw);
  AData.AddConstant('clWebIvory', Graphics_clWebIvory_si, TColor_sw);
  AData.AddConstant('clWebCornSilk', Graphics_clWebCornSilk_si, TColor_sw);
  AData.AddConstant('clWebBeige', Graphics_clWebBeige_si, TColor_sw);
  AData.AddConstant('clWebAntiqueWhite', Graphics_clWebAntiqueWhite_si, TColor_sw);
  AData.AddConstant('clWebWheat', Graphics_clWebWheat_si, TColor_sw);
  AData.AddConstant('clWebAliceBlue', Graphics_clWebAliceBlue_si, TColor_sw);
  AData.AddConstant('clWebGhostWhite', Graphics_clWebGhostWhite_si, TColor_sw);
  AData.AddConstant('clWebLavender', Graphics_clWebLavender_si, TColor_sw);
  AData.AddConstant('clWebSeashell', Graphics_clWebSeashell_si, TColor_sw);
  AData.AddConstant('clWebLightYellow', Graphics_clWebLightYellow_si, TColor_sw);
  AData.AddConstant('clWebPapayaWhip', Graphics_clWebPapayaWhip_si, TColor_sw);
  AData.AddConstant('clWebNavajoWhite', Graphics_clWebNavajoWhite_si, TColor_sw);
  AData.AddConstant('clWebMoccasin', Graphics_clWebMoccasin_si, TColor_sw);
  AData.AddConstant('clWebBurlywood', Graphics_clWebBurlywood_si, TColor_sw);
  AData.AddConstant('clWebAzure', Graphics_clWebAzure_si, TColor_sw);
  AData.AddConstant('clWebMintcream', Graphics_clWebMintcream_si, TColor_sw);
  AData.AddConstant('clWebHoneydew', Graphics_clWebHoneydew_si, TColor_sw);
  AData.AddConstant('clWebLinen', Graphics_clWebLinen_si, TColor_sw);
  AData.AddConstant('clWebLemonChiffon', Graphics_clWebLemonChiffon_si, TColor_sw);
  AData.AddConstant('clWebBlanchedAlmond', Graphics_clWebBlanchedAlmond_si, TColor_sw);
  AData.AddConstant('clWebBisque', Graphics_clWebBisque_si, TColor_sw);
  AData.AddConstant('clWebPeachPuff', Graphics_clWebPeachPuff_si, TColor_sw);
  AData.AddConstant('clWebTan', Graphics_clWebTan_si, TColor_sw);
  AData.AddConstant('clWebYellow', Graphics_clWebYellow_si, TColor_sw);
  AData.AddConstant('clWebDarkOrange', Graphics_clWebDarkOrange_si, TColor_sw);
  AData.AddConstant('clWebRed', Graphics_clWebRed_si, TColor_sw);
  AData.AddConstant('clWebDarkRed', Graphics_clWebDarkRed_si, TColor_sw);
  AData.AddConstant('clWebMaroon', Graphics_clWebMaroon_si, TColor_sw);
  AData.AddConstant('clWebIndianRed', Graphics_clWebIndianRed_si, TColor_sw);
  AData.AddConstant('clWebSalmon', Graphics_clWebSalmon_si, TColor_sw);
  AData.AddConstant('clWebCoral', Graphics_clWebCoral_si, TColor_sw);
  AData.AddConstant('clWebGold', Graphics_clWebGold_si, TColor_sw);
  AData.AddConstant('clWebTomato', Graphics_clWebTomato_si, TColor_sw);
  AData.AddConstant('clWebCrimson', Graphics_clWebCrimson_si, TColor_sw);
  AData.AddConstant('clWebBrown', Graphics_clWebBrown_si, TColor_sw);
  AData.AddConstant('clWebChocolate', Graphics_clWebChocolate_si, TColor_sw);
  AData.AddConstant('clWebSandyBrown', Graphics_clWebSandyBrown_si, TColor_sw);
  AData.AddConstant('clWebLightSalmon', Graphics_clWebLightSalmon_si, TColor_sw);
  AData.AddConstant('clWebLightCoral', Graphics_clWebLightCoral_si, TColor_sw);
  AData.AddConstant('clWebOrange', Graphics_clWebOrange_si, TColor_sw);
  AData.AddConstant('clWebOrangeRed', Graphics_clWebOrangeRed_si, TColor_sw);
  AData.AddConstant('clWebFirebrick', Graphics_clWebFirebrick_si, TColor_sw);
  AData.AddConstant('clWebSaddleBrown', Graphics_clWebSaddleBrown_si, TColor_sw);
  AData.AddConstant('clWebSienna', Graphics_clWebSienna_si, TColor_sw);
  AData.AddConstant('clWebPeru', Graphics_clWebPeru_si, TColor_sw);
  AData.AddConstant('clWebDarkSalmon', Graphics_clWebDarkSalmon_si, TColor_sw);
  AData.AddConstant('clWebRosyBrown', Graphics_clWebRosyBrown_si, TColor_sw);
  AData.AddConstant('clWebPaleGoldenrod', Graphics_clWebPaleGoldenrod_si, TColor_sw);
  AData.AddConstant('clWebLightGoldenrodYellow', Graphics_clWebLightGoldenrodYellow_si, TColor_sw);
  AData.AddConstant('clWebOlive', Graphics_clWebOlive_si, TColor_sw);
  AData.AddConstant('clWebForestGreen', Graphics_clWebForestGreen_si, TColor_sw);
  AData.AddConstant('clWebGreenYellow', Graphics_clWebGreenYellow_si, TColor_sw);
  AData.AddConstant('clWebChartreuse', Graphics_clWebChartreuse_si, TColor_sw);
  AData.AddConstant('clWebLightGreen', Graphics_clWebLightGreen_si, TColor_sw);
  AData.AddConstant('clWebAquamarine', Graphics_clWebAquamarine_si, TColor_sw);
  AData.AddConstant('clWebSeaGreen', Graphics_clWebSeaGreen_si, TColor_sw);
  AData.AddConstant('clWebGoldenRod', Graphics_clWebGoldenRod_si, TColor_sw);
  AData.AddConstant('clWebKhaki', Graphics_clWebKhaki_si, TColor_sw);
  AData.AddConstant('clWebOliveDrab', Graphics_clWebOliveDrab_si, TColor_sw);
  AData.AddConstant('clWebGreen', Graphics_clWebGreen_si, TColor_sw);
  AData.AddConstant('clWebYellowGreen', Graphics_clWebYellowGreen_si, TColor_sw);
  AData.AddConstant('clWebLawnGreen', Graphics_clWebLawnGreen_si, TColor_sw);
  AData.AddConstant('clWebPaleGreen', Graphics_clWebPaleGreen_si, TColor_sw);
  AData.AddConstant('clWebMediumAquamarine', Graphics_clWebMediumAquamarine_si, TColor_sw);
  AData.AddConstant('clWebMediumSeaGreen', Graphics_clWebMediumSeaGreen_si, TColor_sw);
  AData.AddConstant('clWebDarkGoldenRod', Graphics_clWebDarkGoldenRod_si, TColor_sw);
  AData.AddConstant('clWebDarkKhaki', Graphics_clWebDarkKhaki_si, TColor_sw);
  AData.AddConstant('clWebDarkOliveGreen', Graphics_clWebDarkOliveGreen_si, TColor_sw);
  AData.AddConstant('clWebDarkgreen', Graphics_clWebDarkgreen_si, TColor_sw);
  AData.AddConstant('clWebLimeGreen', Graphics_clWebLimeGreen_si, TColor_sw);
  AData.AddConstant('clWebLime', Graphics_clWebLime_si, TColor_sw);
  AData.AddConstant('clWebSpringGreen', Graphics_clWebSpringGreen_si, TColor_sw);
  AData.AddConstant('clWebMediumSpringGreen', Graphics_clWebMediumSpringGreen_si, TColor_sw);
  AData.AddConstant('clWebDarkSeaGreen', Graphics_clWebDarkSeaGreen_si, TColor_sw);
  AData.AddConstant('clWebLightSeaGreen', Graphics_clWebLightSeaGreen_si, TColor_sw);
  AData.AddConstant('clWebPaleTurquoise', Graphics_clWebPaleTurquoise_si, TColor_sw);
  AData.AddConstant('clWebLightCyan', Graphics_clWebLightCyan_si, TColor_sw);
  AData.AddConstant('clWebLightBlue', Graphics_clWebLightBlue_si, TColor_sw);
  AData.AddConstant('clWebLightSkyBlue', Graphics_clWebLightSkyBlue_si, TColor_sw);
  AData.AddConstant('clWebCornFlowerBlue', Graphics_clWebCornFlowerBlue_si, TColor_sw);
  AData.AddConstant('clWebDarkBlue', Graphics_clWebDarkBlue_si, TColor_sw);
  AData.AddConstant('clWebIndigo', Graphics_clWebIndigo_si, TColor_sw);
  AData.AddConstant('clWebMediumTurquoise', Graphics_clWebMediumTurquoise_si, TColor_sw);
  AData.AddConstant('clWebTurquoise', Graphics_clWebTurquoise_si, TColor_sw);
  AData.AddConstant('clWebCyan', Graphics_clWebCyan_si, TColor_sw);
  AData.AddConstant('clWebAqua', Graphics_clWebAqua_si, TColor_sw);
  AData.AddConstant('clWebPowderBlue', Graphics_clWebPowderBlue_si, TColor_sw);
  AData.AddConstant('clWebSkyBlue', Graphics_clWebSkyBlue_si, TColor_sw);
  AData.AddConstant('clWebRoyalBlue', Graphics_clWebRoyalBlue_si, TColor_sw);
  AData.AddConstant('clWebMediumBlue', Graphics_clWebMediumBlue_si, TColor_sw);
  AData.AddConstant('clWebMidnightBlue', Graphics_clWebMidnightBlue_si, TColor_sw);
  AData.AddConstant('clWebDarkTurquoise', Graphics_clWebDarkTurquoise_si, TColor_sw);
  AData.AddConstant('clWebCadetBlue', Graphics_clWebCadetBlue_si, TColor_sw);
  AData.AddConstant('clWebDarkCyan', Graphics_clWebDarkCyan_si, TColor_sw);
  AData.AddConstant('clWebTeal', Graphics_clWebTeal_si, TColor_sw);
  AData.AddConstant('clWebDeepskyBlue', Graphics_clWebDeepskyBlue_si, TColor_sw);
  AData.AddConstant('clWebDodgerBlue', Graphics_clWebDodgerBlue_si, TColor_sw);
  AData.AddConstant('clWebBlue', Graphics_clWebBlue_si, TColor_sw);
  AData.AddConstant('clWebNavy', Graphics_clWebNavy_si, TColor_sw);
  AData.AddConstant('clWebDarkViolet', Graphics_clWebDarkViolet_si, TColor_sw);
  AData.AddConstant('clWebDarkOrchid', Graphics_clWebDarkOrchid_si, TColor_sw);
  AData.AddConstant('clWebMagenta', Graphics_clWebMagenta_si, TColor_sw);
  AData.AddConstant('clWebFuchsia', Graphics_clWebFuchsia_si, TColor_sw);
  AData.AddConstant('clWebDarkMagenta', Graphics_clWebDarkMagenta_si, TColor_sw);
  AData.AddConstant('clWebMediumVioletRed', Graphics_clWebMediumVioletRed_si, TColor_sw);
  AData.AddConstant('clWebPaleVioletRed', Graphics_clWebPaleVioletRed_si, TColor_sw);
  AData.AddConstant('clWebBlueViolet', Graphics_clWebBlueViolet_si, TColor_sw);
  AData.AddConstant('clWebMediumOrchid', Graphics_clWebMediumOrchid_si, TColor_sw);
  AData.AddConstant('clWebMediumPurple', Graphics_clWebMediumPurple_si, TColor_sw);
  AData.AddConstant('clWebPurple', Graphics_clWebPurple_si, TColor_sw);
  AData.AddConstant('clWebDeepPink', Graphics_clWebDeepPink_si, TColor_sw);
  AData.AddConstant('clWebLightPink', Graphics_clWebLightPink_si, TColor_sw);
  AData.AddConstant('clWebViolet', Graphics_clWebViolet_si, TColor_sw);
  AData.AddConstant('clWebOrchid', Graphics_clWebOrchid_si, TColor_sw);
  AData.AddConstant('clWebPlum', Graphics_clWebPlum_si, TColor_sw);
  AData.AddConstant('clWebThistle', Graphics_clWebThistle_si, TColor_sw);
  AData.AddConstant('clWebHotPink', Graphics_clWebHotPink_si, TColor_sw);
  AData.AddConstant('clWebPink', Graphics_clWebPink_si, TColor_sw);
  AData.AddConstant('clWebLightSteelBlue', Graphics_clWebLightSteelBlue_si, TColor_sw);
  AData.AddConstant('clWebMediumSlateBlue', Graphics_clWebMediumSlateBlue_si, TColor_sw);
  AData.AddConstant('clWebLightSlateGray', Graphics_clWebLightSlateGray_si, TColor_sw);
  AData.AddConstant('clWebWhite', Graphics_clWebWhite_si, TColor_sw);
  AData.AddConstant('clWebLightgrey', Graphics_clWebLightgrey_si, TColor_sw);
  AData.AddConstant('clWebGray', Graphics_clWebGray_si, TColor_sw);
  AData.AddConstant('clWebSteelBlue', Graphics_clWebSteelBlue_si, TColor_sw);
  AData.AddConstant('clWebSlateBlue', Graphics_clWebSlateBlue_si, TColor_sw);
  AData.AddConstant('clWebSlateGray', Graphics_clWebSlateGray_si, TColor_sw);
  AData.AddConstant('clWebWhiteSmoke', Graphics_clWebWhiteSmoke_si, TColor_sw);
  AData.AddConstant('clWebSilver', Graphics_clWebSilver_si, TColor_sw);
  AData.AddConstant('clWebDimGray', Graphics_clWebDimGray_si, TColor_sw);
  AData.AddConstant('clWebMistyRose', Graphics_clWebMistyRose_si, TColor_sw);
  AData.AddConstant('clWebDarkSlateBlue', Graphics_clWebDarkSlateBlue_si, TColor_sw);
  AData.AddConstant('clWebDarkSlategray', Graphics_clWebDarkSlategray_si, TColor_sw);
  AData.AddConstant('clWebGainsboro', Graphics_clWebGainsboro_si, TColor_sw);
  AData.AddConstant('clWebDarkGray', Graphics_clWebDarkGray_si, TColor_sw);
  AData.AddConstant('clWebBlack', Graphics_clWebBlack_si, TColor_sw);
  AData.AddConstant('WebColorsCount', Graphics_WebColorsCount_si, nil, VarType(Vcl.Graphics.WebColorsCount));
  ...
  AData.AddConstant('rc3_StockIcon', Graphics_rc3_StockIcon_si, nil, VarType(Vcl.Graphics.rc3_StockIcon));
  AData.AddConstant('rc3_Icon', Graphics_rc3_Icon_si, nil, VarType(Vcl.Graphics.rc3_Icon));
  AData.AddConstant('rc3_Cursor', Graphics_rc3_Cursor_si, nil, VarType(Vcl.Graphics.rc3_Cursor));
  AData.AddConstant('fsBold', Graphics_fsBold_si, TFontStyle_sw);
  AData.AddConstant('fsItalic', Graphics_fsItalic_si, TFontStyle_sw);
  AData.AddConstant('fsUnderline', Graphics_fsUnderline_si, TFontStyle_sw);
  AData.AddConstant('fsStrikeOut', Graphics_fsStrikeOut_si, TFontStyle_sw);
  AData.AddConstant('fpDefault', Graphics_fpDefault_si, TFontPitch_sw);
  AData.AddConstant('fpVariable', Graphics_fpVariable_si, TFontPitch_sw);
  AData.AddConstant('fpFixed', Graphics_fpFixed_si, TFontPitch_sw);
  AData.AddConstant('fqDefault', Graphics_fqDefault_si, TFontQuality_sw);
  AData.AddConstant('fqDraft', Graphics_fqDraft_si, TFontQuality_sw);
  AData.AddConstant('fqProof', Graphics_fqProof_si, TFontQuality_sw);
  AData.AddConstant('fqNonAntialiased', Graphics_fqNonAntialiased_si, TFontQuality_sw);
  AData.AddConstant('fqAntialiased', Graphics_fqAntialiased_si, TFontQuality_sw);
  AData.AddConstant('fqClearType', Graphics_fqClearType_si, TFontQuality_sw);
  AData.AddConstant('fqClearTypeNatural', Graphics_fqClearTypeNatural_si, TFontQuality_sw);
  AData.AddConstant('MASK_TF_COMPOSITED', Graphics_MASK_TF_COMPOSITED_si, nil, VarType(Vcl.Graphics.MASK_TF_COMPOSITED));
  ...
  AData.AddType(TFontQuality_sw, Graphics_TFontQuality_si);
  ...
  AData.AddType(TDrawTextFlags_sw, Graphics_TDrawTextFlags_si);
  AData.AddType(TTextFormatFlags_sw, Graphics_TTextFormatFlags_si);
  ...
  AData.AddType(TGDIHandleRecall_sw, Graphics_TGDIHandleRecall_si);
...
initialization
  ...
  RegisterClassWrapper(TGDIHandleRecall_sw);
