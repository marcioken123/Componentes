...
uses
  ...
  Graphics, ToolWin, ActnMan, Buttons, StdCtrls, ComCtrls, Contnrs, GraphUtil,
  ExtCtrls, ActnCtrls, Windows_LMDSW, Messages_LMDSW, Classes_LMDSW,
  Controls_LMDSW, Graphics_LMDSW, ToolWin_LMDSW, ActnMan_LMDSW, Buttons_LMDSW,
  StdCtrls_LMDSW, ComCtrls_LMDSW, Contnrs_LMDSW, GraphUtil_LMDSW,
  ExtCtrls_LMDSW;
