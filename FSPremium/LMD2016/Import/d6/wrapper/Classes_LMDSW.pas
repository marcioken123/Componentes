...
uses
  Classes, LMDTypes, LMDSctClass, LMDSctScripter, LMDSctWrappers,
  LMDSctSysWrappers, Windows, Messages, SysUtils, Variants, TypInfo,
  Windows_LMDSW, Messages_LMDSW, SysUtils_LMDSW, Variants_LMDSW, TypInfo_LMDSW;
...
type
  ...
  EFCreateError_sw = class(EStreamError_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
  ...
  EFOpenError_sw = class(EStreamError_sw)
  protected
    class function  GetTypeName: WideString; override;
    class function  GetWrappedClass: TClass; override;
    class procedure DoInit(AData: TLMDClassWrapperData); override;
...
begin
  ...
  AData.AddProperty('Handle', THandleStream_Handle_si, Integer_sw, True, False, 0, False, False);
...
begin
  ...
  AData.AddConstructor('Create', TParser_Create_si, 1, False);
end;
...
function Classes_GlobalNameSpace_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var GlobalNameSpace: TMultiReadExclusiveWriteSynchronizer;

  if IsGet then
    Result := TMultiReadExclusiveWriteSynchronizer_sw.ToVar(Classes.
      GlobalNameSpace)
  else
    Classes.GlobalNameSpace := TMultiReadExclusiveWriteSynchronizer_sw.FromVar(
      AArgs[0]);
end;
...
begin
  ...
  AData.AddVariable('GlobalNameSpace', Classes_GlobalNameSpace_si, TMultiReadExclusiveWriteSynchronizer_sw);
  ...
  AData.AddFunction('CheckSynchronize', Classes_CheckSynchronize_si, Boolean_sw, 0, False);
