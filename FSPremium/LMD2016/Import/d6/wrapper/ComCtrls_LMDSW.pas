...
uses
  ...
  LMDSctSysWrappers, Messages, Windows, SysUtils, CommCtrl, Controls, Forms,
  Classes, Menus, Graphics, StdCtrls, RichEdit, ToolWin, ImgList, ExtCtrls,
  ListActns, ComCtrls, Messages_LMDSW, Windows_LMDSW, SysUtils_LMDSW,
  CommCtrl_LMDSW, Controls_LMDSW, Forms_LMDSW, Classes_LMDSW, Menus_LMDSW,
