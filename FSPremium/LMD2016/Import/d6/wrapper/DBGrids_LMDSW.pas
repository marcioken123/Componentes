...
uses
  ...
  LMDSctSysWrappers, Variants, Windows, SysUtils, Messages, Classes, Controls,
  Forms, StdCtrls, Graphics, Grids, DBCtrls, Db, Menus, ImgList, DBGrids,
  Variants_LMDSW, Windows_LMDSW, SysUtils_LMDSW, Messages_LMDSW, Classes_LMDSW,
  Controls_LMDSW, Forms_LMDSW, StdCtrls_LMDSW, Graphics_LMDSW, Grids_LMDSW,
  DBCtrls_LMDSW, Db_LMDSW, Menus_LMDSW, ImgList_LMDSW;
...
begin
  ...
  if IsGet then
    ...
    TColumn(AObj).FieldName := string(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('FieldName', TColumn_FieldName_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  AData.AddProperty('Items', TBookmarkList_Items_si, TBookmarkStr_sw, True, False, 1, False, True);
