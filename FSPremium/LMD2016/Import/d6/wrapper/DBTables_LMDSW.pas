...
uses
  TypInfo, LMDTypes, LMDSctClass, LMDSctScripter, LMDSctWrappers,
  LMDSctSysWrappers, Variants, Windows, SysUtils, Classes, DB, DBCommon,
  DBTables, Variants_LMDSW, Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW,
  DB_LMDSW, DBCommon_LMDSW;
...
function TRecInfo_UpdateStatus_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var UpdateStatus: TUpdateStatus;

  if IsGet then
    Result := TUpdateStatus_sw.ToVar(TRecInfo_sw(AObj).FValue.UpdateStatus)
  else
    TRecInfo_sw(AObj).FValue.UpdateStatus := TUpdateStatus_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('UpdateStatus', TRecInfo_UpdateStatus_si, TUpdateStatus_sw);
...
begin
  ...
  AData.AddProcedure('SetParams', TUpdateSQL_SetParams_si, 1, False);
...
function DBTables_TKeyIndex_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
function DBTables_TKeyBuffer_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
function DBTables_TRecInfo_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
begin
  AData.AddConstant('smTraceBufSize', DBTables_smTraceBufSize_si, nil, VarType(DBTables.smTraceBufSize));
  AData.AddConstant('dbfOpened', DBTables_dbfOpened_si, nil, VarType(DBTables.dbfOpened));
  AData.AddConstant('dbfPrepared', DBTables_dbfPrepared_si, nil, VarType(DBTables.dbfPrepared));
  AData.AddConstant('dbfExecSQL', DBTables_dbfExecSQL_si, nil, VarType(DBTables.dbfExecSQL));
  AData.AddConstant('dbfTable', DBTables_dbfTable_si, nil, VarType(DBTables.dbfTable));
  AData.AddConstant('dbfFieldList', DBTables_dbfFieldList_si, nil, VarType(DBTables.dbfFieldList));
  AData.AddConstant('dbfIndexList', DBTables_dbfIndexList_si, nil, VarType(DBTables.dbfIndexList));
  AData.AddConstant('dbfStoredProc', DBTables_dbfStoredProc_si, nil, VarType(DBTables.dbfStoredProc));
  AData.AddConstant('dbfExecProc', DBTables_dbfExecProc_si, nil, VarType(DBTables.dbfExecProc));
  AData.AddConstant('dbfProcDesc', DBTables_dbfProcDesc_si, nil, VarType(DBTables.dbfProcDesc));
  AData.AddConstant('dbfDatabase', DBTables_dbfDatabase_si, nil, VarType(DBTables.dbfDatabase));
  AData.AddConstant('dbfProvider', DBTables_dbfProvider_si, nil, VarType(DBTables.dbfProvider));
  ...
  AData.AddType(TKeyIndex_sw, DBTables_TKeyIndex_si);
  AData.AddType(TKeyBuffer_sw, DBTables_TKeyBuffer_si);
  AData.AddType(TRecInfo_sw, DBTables_TRecInfo_si);
