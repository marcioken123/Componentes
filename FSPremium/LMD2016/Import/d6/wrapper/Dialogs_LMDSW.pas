...
uses
  ...
  LMDSctSysWrappers, Windows, Messages, SysUtils, CommDlg, Classes, Graphics,
  Controls, Forms, StdCtrls, Printers, Dialogs, Windows_LMDSW, Messages_LMDSW,
  SysUtils_LMDSW, CommDlg_LMDSW, Classes_LMDSW, Graphics_LMDSW, Controls_LMDSW,
  Forms_LMDSW, StdCtrls_LMDSW, Printers_LMDSW;
