...
begin
  ...
  if IsGet then
    Result := TMessage_sw(AObj).FValue.WParam
  else
    TMessage_sw(AObj).FValue.WParam := Longint(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TMessage_sw(AObj).FValue.LParam
  else
    TMessage_sw(AObj).FValue.LParam := Longint(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TMessage_sw(AObj).FValue.Result
  else
    TMessage_sw(AObj).FValue.Result := Longint(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('WParam', TMessage_WParam_si, Longint_sw);
  AData.AddField('LParam', TMessage_LParam_si, Longint_sw);
  AData.AddField('Result', TMessage_Result_si, Longint_sw);
...
begin
  ...
  if IsGet then
    Result := TWMNoParams_sw(AObj).FValue.Result
  else
    TWMNoParams_sw(AObj).FValue.Result := Longint(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Result', TWMNoParams_Result_si, Longint_sw);
...
begin
  ...
  if IsGet then
    Result := TWMKey_sw(AObj).FValue.Result
  else
    TWMKey_sw(AObj).FValue.Result := Longint(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Result', TWMKey_Result_si, Longint_sw);
...
function TWMMouse_Pos_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var Pos: TSmallPoint;

  if IsGet then
    Result := TSmallPoint_sw.ToVar(TWMMouse_sw(AObj).FValue.Pos)
  else
    TWMMouse_sw(AObj).FValue.Pos := TSmallPoint_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TWMMouse_sw(AObj).FValue.Result
  else
    TWMMouse_sw(AObj).FValue.Result := Longint(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Pos', TWMMouse_Pos_si, TSmallPoint_sw);
  AData.AddField('Result', TWMMouse_Result_si, Longint_sw);
...
begin
  ...
  if IsGet then
    Result := TWMMenuChar_sw(AObj).FValue.User
  else
    TWMMenuChar_sw(AObj).FValue.User := Char(Integer(AArgs[0]));
end;

function TWMMenuChar_Unused_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var Unused: Byte;

  if IsGet then
    Result := TWMMenuChar_sw(AObj).FValue.Unused
  else
    TWMMenuChar_sw(AObj).FValue.Unused := Byte(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TWMMenuChar_sw(AObj).FValue.Result
  else
    TWMMenuChar_sw(AObj).FValue.Result := Longint(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Unused', TWMMenuChar_Unused_si, Byte_sw);
  AData.AddField('MenuFlag', TWMMenuChar_MenuFlag_si, Word_sw);
  AData.AddField('Menu', TWMMenuChar_Menu_si, HMENU_sw);
  AData.AddField('Result', TWMMenuChar_Result_si, Longint_sw);
...
begin
  ...
  if IsGet then
    Result := TWMNCHitTest_sw(AObj).FValue.Unused
  else
    TWMNCHitTest_sw(AObj).FValue.Unused := Longint(AArgs[0]);
end;
...
function TWMNCHitTest_Pos_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // var Pos: TSmallPoint;

  if IsGet then
    Result := TSmallPoint_sw.ToVar(TWMNCHitTest_sw(AObj).FValue.Pos)
  else
    TWMNCHitTest_sw(AObj).FValue.Pos := TSmallPoint_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  if IsGet then
    Result := TWMNCHitTest_sw(AObj).FValue.Result
  else
    TWMNCHitTest_sw(AObj).FValue.Result := Longint(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Unused', TWMNCHitTest_Unused_si, Longint_sw);
  AData.AddField('XPos', TWMNCHitTest_XPos_si, Smallint_sw);
  AData.AddField('YPos', TWMNCHitTest_YPos_si, Smallint_sw);
  AData.AddField('Pos', TWMNCHitTest_Pos_si, TSmallPoint_sw);
  AData.AddField('Result', TWMNCHitTest_Result_si, Longint_sw);
