...
uses
  ...
  LMDSctSysWrappers, Windows, SysUtils, Variants, Classes, DBClient, DB,
  Provider, Windows_LMDSW, SysUtils_LMDSW, Variants_LMDSW, Classes_LMDSW,
  DBClient_LMDSW, DB_LMDSW;
...
type
  TDataPacketWriter_sacc = class(TDataPacketWriter);
  ...
  TCustomResolver_sacc = class(TCustomResolver);
...
function TDataPacketWriter_OnGetParams_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property OnGetParams: TGetParamsEvent read <get...

  if IsGet then
    Result := TGetParamsEvent_sw.ToVar(TDataPacketWriter_sacc(TDataPacketWriter(
      AObj)).OnGetParams)
  else
    TDataPacketWriter_sacc(TDataPacketWriter(AObj)).OnGetParams := 
      TGetParamsEvent_sw.FromVar(AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('OnGetParams', TDataPacketWriter_OnGetParams_si, TGetParamsEvent_sw, True, True, 0, True, False);
...
function TDataSetProvider_Params_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Params: TParams read <getter>;

  Result := TParams_sw.ToVar(TDataSetProvider_sacc(TDataSetProvider(AObj)).
    Params);
end;
...
begin
  ...
  AData.AddProperty('Params', TDataSetProvider_Params_si, TParams_sw, True, False, 0, True, False);
...
function TUpdateTree_Delta_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Delta: TPacketDataSet read <getter>;

  Result := TPacketDataSet_sw.ToVar(TUpdateTree_sacc(TUpdateTree(AObj)).Delta);
end;

function TUpdateTree_DetailCount_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property DetailCount: Integer read <getter>;

  Result := TUpdateTree_sacc(TUpdateTree(AObj)).DetailCount;
end;

function TUpdateTree_Details_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Details[Index: Integer]: TUpdateTree r...

  Result := TUpdateTree_sw.ToVar(TUpdateTree_sacc(TUpdateTree(AObj)).
    Details[Integer(AArgs[0])]);
end;

function TUpdateTree_ErrorDS_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property ErrorDS: TPacketDataSet read <getter>;

  Result := TPacketDataSet_sw.ToVar(TUpdateTree_sacc(TUpdateTree(AObj)).
    ErrorDS);
end;
...
function TUpdateTree_HasErrors_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property HasErrors: Boolean read <getter>;

  Result := TUpdateTree_sacc(TUpdateTree(AObj)).HasErrors;
end;

function TUpdateTree_Name_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Name: string read <getter> write <sett...

  if IsGet then
    Result := TUpdateTree_sacc(TUpdateTree(AObj)).Name
  else
    TUpdateTree_sacc(TUpdateTree(AObj)).Name := string(AArgs[0]);
end;

function TUpdateTree_Parent_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Parent: TUpdateTree read <getter>;

  Result := TUpdateTree_sw.ToVar(TUpdateTree_sacc(TUpdateTree(AObj)).Parent);
end;

function TUpdateTree_Source_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Source: TDataSet read <getter>;

  Result := TDataSet_sw.ToVar(TUpdateTree_sacc(TUpdateTree(AObj)).Source);
end;

function TUpdateTree_IsNested_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property IsNested: Boolean read <getter>;

  Result := TUpdateTree_sacc(TUpdateTree(AObj)).IsNested;
end;
...
begin
  ...
  AData.AddProperty('Delta', TUpdateTree_Delta_si, TPacketDataSet_sw, True, False, 0, True, False);
  AData.AddProperty('DetailCount', TUpdateTree_DetailCount_si, Integer_sw, True, False, 0, True, False);
  AData.AddProperty('Details', TUpdateTree_Details_si, TUpdateTree_sw, True, False, 1, True, False);
  AData.AddProperty('ErrorDS', TUpdateTree_ErrorDS_si, TPacketDataSet_sw, True, False, 0, True, False);
  AData.AddProperty('HasErrors', TUpdateTree_HasErrors_si, Boolean_sw, True, False, 0, True, False);
  AData.AddProperty('Name', TUpdateTree_Name_si, string_sw, True, True, 0, True, False);
  AData.AddProperty('Parent', TUpdateTree_Parent_si, TUpdateTree_sw, True, False, 0, True, False);
  AData.AddProperty('Source', TUpdateTree_Source_si, TDataSet_sw, True, False, 0, True, False);
  AData.AddProperty('IsNested', TUpdateTree_IsNested_si, Boolean_sw, True, False, 0, True, False);
...
function TCustomResolver_Provider_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property Provider: TBaseProvider read <getter>;

  Result := TBaseProvider_sw.ToVar(TCustomResolver_sacc(TCustomResolver(AObj)).
    Provider);
end;
...
begin
  ...
  AData.AddProperty('Provider', TCustomResolver_Provider_si, TBaseProvider_sw, True, False, 0, True, False);
