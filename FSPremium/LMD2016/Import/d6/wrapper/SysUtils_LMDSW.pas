...
function TThreadLocalCounter_Create_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // constructor Create;

  Result := TThreadLocalCounter_sw.ToVar(TThreadLocalCounter_sc(AObj).Create());
end;
...
begin
  ...
  AData.AddConstructor('Create', TThreadLocalCounter_Create_si, 0, False);
end;
...
function SysUtils_FloatToStrF_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function FloatToStrF(Value: Extended; Format: TFloatForma...

  Result := SysUtils.FloatToStrF(Extended(AArgs[0]), TFloatFormat_sw.FromVar(
...
begin
  ...
  AData.AddFunction('FloatToStrF', SysUtils_FloatToStrF_si, string_sw, 4, False);
  AData.AddFunction('CurrToStrF', SysUtils_CurrToStrF_si, string_sw, 3, False);
  ...
  AData.AddFunction('TryStrToFloat', SysUtils_TryStrToFloat_si, nil, 2, False);
