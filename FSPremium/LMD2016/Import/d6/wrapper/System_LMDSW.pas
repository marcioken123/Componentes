...
begin
  ...
  if IsGet then
    Result := TVarData_sw(AObj).FValue.VError
  else
    TVarData_sw(AObj).FValue.VError := LongWord(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('VError', TVarData_VError_si, LongWord_sw);
...
function System__VarClear_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  System._VarClear(v_1);
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarCopy_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  // procedure _VarCopy(var Dest: Variant; const Source: Varia...

  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarCopy(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarCopyNoInd_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure _VarCopyNoInd;

  System._VarCopyNoInd();
end;

function System__VarCast_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  // procedure _VarCast(var Dest: Variant; const Source: Varia...

  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarCast(v_1, Variant(FindVarData(AArgs[1])^), Integer(AArgs[2]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarCastOle_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  // procedure _VarCastOle(var Dest: Variant; const Source: Va...

  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarCastOle(v_1, Variant(FindVarData(AArgs[1])^), Integer(AArgs[2]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarClr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
...
function System__VarToInt_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _VarToInt(const V: Variant): Integer;

  Result := System._VarToInt(Variant(FindVarData(AArgs[0])^));
end;

function System__VarToInt64_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _VarToInt64(const V: Variant): Int64;

  Result := Int64_sw.ToVar(System._VarToInt64(Variant(FindVarData(AArgs[0])^)));
end;

function System__VarToBool_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _VarToBool(const V: Variant): Boolean;

  Result := System._VarToBool(Variant(FindVarData(AArgs[0])^));
end;

function System__VarToReal_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _VarToReal(const V: Variant): Extended;

  Result := System._VarToReal(Variant(FindVarData(AArgs[0])^));
end;

function System__VarToCurr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function _VarToCurr(const V: Variant): Currency;

  Result := System._VarToCurr(Variant(FindVarData(AArgs[0])^));
end;

function System__VarToLStr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: string;
begin
  ...
  v_1 := string(AArgs[0]);
  System._VarToLStr(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarToWStr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: WideString;
begin
  ...
  System._VarToWStr(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarFromInt_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  // procedure _VarFromInt(var V: Variant; const Value: Intege...

  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarFromInt(v_1, Integer(AArgs[1]), Integer(AArgs[2]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarFromInt64_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarFromInt64(v_1, Int64_sw.FromVar(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarFromBool_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  // procedure _VarFromBool(var V: Variant; const Value: Boole...

  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarFromBool(v_1, Boolean(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarFromReal_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
function System__VarFromTDateTime_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure _VarFromTDateTime;

  System._VarFromTDateTime();
end;

function System__VarFromCurr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
function System__VarFromPStr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  // procedure _VarFromPStr(var V: Variant; const Value: Short...

  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarFromPStr(v_1, ShortString(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarFromLStr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarFromLStr(v_1, string(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarFromWStr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  // procedure _VarFromWStr(var V: Variant; const Value: WideS...

  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarFromWStr(v_1, WideString(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__OleVarFromPStr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: OleVariant;
begin
  // procedure _OleVarFromPStr(var V: OleVariant; const Value:...

  v_1 := OleVariant(FindVarData(AArgs[0])^);
  System._OleVarFromPStr(v_1, ShortString(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__OleVarFromLStr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: OleVariant;
begin
  // procedure _OleVarFromLStr(var V: OleVariant; const Value:...

  v_1 := OleVariant(FindVarData(AArgs[0])^);
  System._OleVarFromLStr(v_1, string(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__OleVarFromVar_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: OleVariant;
begin
  // procedure _OleVarFromVar(var V: OleVariant; const Value: ...

  v_1 := OleVariant(FindVarData(AArgs[0])^);
  System._OleVarFromVar(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__OleVarFromInt_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: OleVariant;
begin
  // procedure _OleVarFromInt(var V: OleVariant; const Value: ...

  v_1 := OleVariant(FindVarData(AArgs[0])^);
  System._OleVarFromInt(v_1, Integer(AArgs[1]), Integer(AArgs[2]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarAdd_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarAdd(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarSub_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarSub(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarMul_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarMul(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarDiv_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarDiv(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarMod_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarMod(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarAnd_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarAnd(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarOr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarOr(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarXor_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarXor(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarShl_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarShl(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarShr_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarShr(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarRDiv_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarRDiv(v_1, Variant(FindVarData(AArgs[1])^));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarCmpEQ_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure _VarCmpEQ(const Left: Variant; const Right: Var...

  System._VarCmpEQ(Variant(FindVarData(AArgs[0])^), Variant(FindVarData(
    AArgs[1])^));
end;

function System__VarCmpNE_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure _VarCmpNE(const Left: Variant; const Right: Var...

  System._VarCmpNE(Variant(FindVarData(AArgs[0])^), Variant(FindVarData(
    AArgs[1])^));
end;

function System__VarCmpLT_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure _VarCmpLT(const Left: Variant; const Right: Var...

  System._VarCmpLT(Variant(FindVarData(AArgs[0])^), Variant(FindVarData(
    AArgs[1])^));
end;

function System__VarCmpLE_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure _VarCmpLE(const Left: Variant; const Right: Var...

  System._VarCmpLE(Variant(FindVarData(AArgs[0])^), Variant(FindVarData(
    AArgs[1])^));
end;

function System__VarCmpGT_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure _VarCmpGT(const Left: Variant; const Right: Var...

  System._VarCmpGT(Variant(FindVarData(AArgs[0])^), Variant(FindVarData(
    AArgs[1])^));
end;

function System__VarCmpGE_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // procedure _VarCmpGE(const Left: Variant; const Right: Var...

  System._VarCmpGE(Variant(FindVarData(AArgs[0])^), Variant(FindVarData(
    AArgs[1])^));
end;

function System__VarNeg_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
...
function System__VarNot_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
...
function System__DispInvoke_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
function System__VarAddRef_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarAddRef(v_1);
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarArrayRedim_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  // procedure _VarArrayRedim(var A: Variant; HighBound: Integ...

  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarArrayRedim(v_1, Integer(AArgs[1]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarArrayGet_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  ...
  v_1 := Variant(FindVarData(AArgs[0])^);
  Result := System._VarArrayGet(v_1, Integer(AArgs[1]), Integer(AArgs[2]));
  AssignRefParam(AArgs[0], v_1);
end;

function System__VarArrayPut_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
var
  v_1: Variant;
begin
  // procedure _VarArrayPut(var A: Variant; const Value: Varia...

  v_1 := Variant(FindVarData(AArgs[0])^);
  System._VarArrayPut(v_1, Variant(FindVarData(AArgs[1])^), Integer(AArgs[2]), 
    Integer(AArgs[3]));
  AssignRefParam(AArgs[0], v_1);
end;
...
begin
  ...
  AData.AddProcedure('_VarClear', System__VarClear_si, 1, False);
  AData.AddProcedure('_VarCopy', System__VarCopy_si, 2, False);
  AData.AddProcedure('_VarCopyNoInd', System__VarCopyNoInd_si, 0, False);
  AData.AddProcedure('_VarCast', System__VarCast_si, 3, False);
  AData.AddProcedure('_VarCastOle', System__VarCastOle_si, 3, False);
  AData.AddProcedure('_VarClr', System__VarClr_si, 1, False);
  AData.AddFunction('_VarToInt', System__VarToInt_si, Integer_sw, 1, False);
  AData.AddFunction('_VarToInt64', System__VarToInt64_si, Int64_sw, 1, False);
  AData.AddFunction('_VarToBool', System__VarToBool_si, Boolean_sw, 1, False);
  AData.AddFunction('_VarToReal', System__VarToReal_si, Extended_sw, 1, False);
  AData.AddFunction('_VarToCurr', System__VarToCurr_si, Currency_sw, 1, False);
  AData.AddProcedure('_VarToLStr', System__VarToLStr_si, 2, False);
  AData.AddProcedure('_VarToWStr', System__VarToWStr_si, 2, False);
  AData.AddProcedure('_VarFromInt', System__VarFromInt_si, 3, False);
  AData.AddProcedure('_VarFromInt64', System__VarFromInt64_si, 2, False);
  AData.AddProcedure('_VarFromBool', System__VarFromBool_si, 2, False);
  AData.AddProcedure('_VarFromReal', System__VarFromReal_si, 0, False);
  AData.AddProcedure('_VarFromTDateTime', System__VarFromTDateTime_si, 0, False);
  AData.AddProcedure('_VarFromCurr', System__VarFromCurr_si, 0, False);
  AData.AddProcedure('_VarFromPStr', System__VarFromPStr_si, 2, False);
  AData.AddProcedure('_VarFromLStr', System__VarFromLStr_si, 2, False);
  AData.AddProcedure('_VarFromWStr', System__VarFromWStr_si, 2, False);
  AData.AddProcedure('_OleVarFromPStr', System__OleVarFromPStr_si, 2, False);
  AData.AddProcedure('_OleVarFromLStr', System__OleVarFromLStr_si, 2, False);
  AData.AddProcedure('_OleVarFromVar', System__OleVarFromVar_si, 2, False);
  AData.AddProcedure('_OleVarFromInt', System__OleVarFromInt_si, 3, False);
  AData.AddProcedure('_VarAdd', System__VarAdd_si, 2, False);
  AData.AddProcedure('_VarSub', System__VarSub_si, 2, False);
  AData.AddProcedure('_VarMul', System__VarMul_si, 2, False);
  AData.AddProcedure('_VarDiv', System__VarDiv_si, 2, False);
  AData.AddProcedure('_VarMod', System__VarMod_si, 2, False);
  AData.AddProcedure('_VarAnd', System__VarAnd_si, 2, False);
  AData.AddProcedure('_VarOr', System__VarOr_si, 2, False);
  AData.AddProcedure('_VarXor', System__VarXor_si, 2, False);
  AData.AddProcedure('_VarShl', System__VarShl_si, 2, False);
  AData.AddProcedure('_VarShr', System__VarShr_si, 2, False);
  AData.AddProcedure('_VarRDiv', System__VarRDiv_si, 2, False);
  AData.AddProcedure('_VarCmpEQ', System__VarCmpEQ_si, 2, False);
  AData.AddProcedure('_VarCmpNE', System__VarCmpNE_si, 2, False);
  AData.AddProcedure('_VarCmpLT', System__VarCmpLT_si, 2, False);
  AData.AddProcedure('_VarCmpLE', System__VarCmpLE_si, 2, False);
  AData.AddProcedure('_VarCmpGT', System__VarCmpGT_si, 2, False);
  AData.AddProcedure('_VarCmpGE', System__VarCmpGE_si, 2, False);
  AData.AddProcedure('_VarNeg', System__VarNeg_si, 1, False);
  AData.AddProcedure('_VarNot', System__VarNot_si, 1, False);
  AData.AddProcedure('_DispInvoke', System__DispInvoke_si, 0, False);
  ...
  AData.AddProcedure('_VarAddRef', System__VarAddRef_si, 1, False);
  AData.AddProcedure('_VarArrayRedim', System__VarArrayRedim_si, 2, False);
  AData.AddFunction('_VarArrayGet', System__VarArrayGet_si, Variant_sw, 3, False);
  AData.AddProcedure('_VarArrayPut', System__VarArrayPut_si, 4, False);
