...
uses
  ...
  LMDSctSysWrappers, Windows, Messages, Classes, Controls, Graphics, ToolWin,
  ActnMan, Buttons, StdCtrls, ComCtrls, Contnrs, GraphUtil, ExtCtrls,
...
function ActnCtrls_TCustomActionBarClass_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
begin
  ...
  AData.AddType(TCustomActionBarClass_sw, ActnCtrls_TCustomActionBarClass_si);
