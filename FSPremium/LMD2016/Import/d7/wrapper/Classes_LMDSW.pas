...
uses
  Classes, LMDTypes, LMDSctScripter, LMDSctWrappers, LMDSctSysWrappers, Windows,
  Messages, SysUtils, Variants, TypInfo, Windows_LMDSW, Messages_LMDSW,
  SysUtils_LMDSW, Variants_LMDSW, TypInfo_LMDSW;
