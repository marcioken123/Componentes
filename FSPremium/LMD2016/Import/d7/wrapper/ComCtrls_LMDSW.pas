...
begin
  ...
  AData.AddProperty('Items', TCustomListView_Items_si, TListItems_sw, True, True, 0, True, False);
...
begin
  ...
  AData.AddProperty('CalExceptionClass', TCommonCalendar_CalExceptionClass_si, ExceptClass_sw, True, True, 0, True, False);
