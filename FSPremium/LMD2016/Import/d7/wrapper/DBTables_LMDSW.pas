...
uses
  TypInfo, LMDTypes, LMDSctScripter, LMDSctWrappers, LMDSctSysWrappers,
  Variants, Windows, SysUtils, Classes, DB, DBCommon, DBTables, Variants_LMDSW,
  Windows_LMDSW, SysUtils_LMDSW, Classes_LMDSW, DB_LMDSW, DBCommon_LMDSW;
