...
uses
  ...
  SysUtils, Classes, Variants, MaskUtils, DB, Windows_LMDSW, SysUtils_LMDSW,
  Classes_LMDSW, Variants_LMDSW, MaskUtils_LMDSW;
...
begin
  ...
  AData.AddProperty('Value', TStringField_Value_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  AData.AddProperty('Value', TWideStringField_Value_si, WideString_sw, True, True, 0, False, False);
end;
...
begin
  ...
  AData.AddProperty('Value', TBlobField_Value_si, string_sw, True, True, 0, False, False);
...
begin
  ...
  AData.AddProperty('AsBlob', TParam_AsBlob_si, TBlobData_sw, True, True, 0, False, False);
...
function TDataSet_NestedDataSetClass_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // protected property NestedDataSetClass: TClass read <gette...

  if IsGet then
    Result := TClass_sw.ToVar(TDataSet_sacc(TDataSet(AObj)).NestedDataSetClass)
  else
    TDataSet_sacc(TDataSet(AObj)).NestedDataSetClass := TClass_sw.FromVar(
      AArgs[0]);
end;
...
begin
  ...
  AData.AddProperty('NestedDataSetClass', TDataSet_NestedDataSetClass_si, TClass_sw, True, True, 0, True, False);
  ...
  AData.AddProperty('Bookmark', TDataSet_Bookmark_si, TBookmarkStr_sw, True, True, 0, False, False);
...
function DB_TLoginEvent_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
var
  v_1: Integer;
begin
  // function ExtractFieldName(const Fields: string; var Pos: ...
...
begin
  ...
  AData.AddType(TLoginEvent_sw, DB_TLoginEvent_si);
  ...
  AData.AddFunction('ExtractFieldName', DB_ExtractFieldName_si, string_sw, 2, False);
