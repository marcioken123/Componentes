...
begin
  ...
  if IsGet then
    Result := TCMHintShowPause_sw(AObj).FValue.Result
  else
    TCMHintShowPause_sw(AObj).FValue.Result := Integer(AArgs[0]);
end;
...
begin
  ...
  AData.AddField('Result', TCMHintShowPause_Result_si, Integer_sw);
...
function Forms_TCMHintShow_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
...
begin
  ...
  Result := TCustomForm_sw.ToVar(Forms.GetParentForm(TControl_sw.FromVar(
    AArgs[0])));
end;
...
begin
  ...
  Result := TCustomForm_sw.ToVar(Forms.ValidParentForm(TControl_sw.FromVar(
    AArgs[0])));
end;
...
begin
  ...
  Result := Forms.IsAccel(Word(AArgs[0]), string(AArgs[1]));
end;
...
begin
  ...
  Result := Forms.Subclass3DWnd(HWnd_sw.FromVar(AArgs[0]));
end;
...
begin
  ...
  Forms.Subclass3DDlg(HWnd_sw.FromVar(AArgs[0]), Word(AArgs[1]));
end;
...
begin
  ...
  Forms.SetAutoSubClass(Boolean(AArgs[0]));
end;

function Forms_AllocateHWnd_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // function AllocateHWnd(Method: TWndMethod): HWND;

  Result := HWND_sw.ToVar(Forms.AllocateHWnd(TWndMethod_sw.FromVar(AArgs[0])));
end;
...
begin
  ...
  AData.AddType(TCMHintShow_sw, Forms_TCMHintShow_si);
  ...
  AData.AddFunction('GetParentForm', Forms_GetParentForm_si, TCustomForm_sw, 1, False);
  AData.AddFunction('ValidParentForm', Forms_ValidParentForm_si, TCustomForm_sw, 1, False);
  ...
  AData.AddFunction('AllocateHWnd', Forms_AllocateHWnd_si, HWND_sw, 1, False);
