...
uses
  ...
  LMDSctSysWrappers, Windows, SysUtils, Classes, StdCtrls, Controls, Messages,
  Forms, Graphics, Menus, MaskUtils, Mask, Windows_LMDSW, SysUtils_LMDSW,
  Classes_LMDSW, StdCtrls_LMDSW, Controls_LMDSW, Messages_LMDSW, Forms_LMDSW,
  Graphics_LMDSW, Menus_LMDSW, MaskUtils_LMDSW;
