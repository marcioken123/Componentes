...
uses
  ...
  LMDSctSysWrappers, SysUtils, Classes, ActnList, StdCtrls, Forms, Dialogs,
  StdActns, SysUtils_LMDSW, Classes_LMDSW, ActnList_LMDSW, StdCtrls_LMDSW,
  Forms_LMDSW, Dialogs_LMDSW;
