...
uses
  ...
  LMDSctSysWrappers, Windows, Messages, Classes, Forms, Controls, Contnrs,
  Graphics, ActnList, ToolWin, ExtCtrls, ActnMan, ActnCtrls, Menus, StdCtrls,
  ShadowWnd, Buttons, StdActns, ActnMenus, Windows_LMDSW, Messages_LMDSW,
  Classes_LMDSW, Forms_LMDSW, Controls_LMDSW, Contnrs_LMDSW, Graphics_LMDSW,
  ActnList_LMDSW, ToolWin_LMDSW, ExtCtrls_LMDSW, ActnMan_LMDSW,
...
begin
  ...
  AData.AddProperty('PopupStack', TCustomActionMenuBar_PopupStack_si, TMenuStack_sw, True, False, 0, True, False);
