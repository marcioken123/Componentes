...
uses
  ...
  StdCtrls, ExtCtrls, CommCtrl, Buttons, Windows_LMDSW, Messages_LMDSW,
  Classes_LMDSW, Controls_LMDSW, Forms_LMDSW, Graphics_LMDSW, StdCtrls_LMDSW,
  ExtCtrls_LMDSW, CommCtrl_LMDSW;
