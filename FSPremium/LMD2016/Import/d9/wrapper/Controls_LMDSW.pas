...
uses
  ...
  LMDSctSysWrappers, Messages, Types, Windows, MultiMon, Classes, SysUtils,
  Graphics, Menus, CommCtrl, Imm, ImgList, ActnList, Controls, Messages_LMDSW,
  Types_LMDSW, Windows_LMDSW, MultiMon_LMDSW, Classes_LMDSW, SysUtils_LMDSW,
  Graphics_LMDSW, Menus_LMDSW, CommCtrl_LMDSW, Imm_LMDSW, ImgList_LMDSW,
  ActnList_LMDSW;
...
class function TDragMessage_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDragMessage);
end;
...
begin
  ...
  AData.AddFunction('Copy', TPopupFormInfo_Copy_si, TPopupFormInfo_sw, 0);
  ...
  AData.AddConstructor('Create', TPopupFormInfo_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TCMPopupHWndDestroy_Copy_si, TCMPopupHWndDestroy_sw, 0);
  ...
  AData.AddConstructor('Create', TCMPopupHWndDestroy_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TCMCreatePopup_Copy_si, TCMCreatePopup_sw, 0);
  ...
  AData.AddConstructor('Create', TCMCreatePopup_Create_si, 0);
end;
...
class function TAlign_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TAlign);
end;
...
begin
  ...
  AData.AddProperty('AlwaysShowDragImages', TDragObject_AlwaysShowDragImages_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Cancelling', TDragObject_Cancelling_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DragHandle', TDragObject_DragHandle_si, HWND_sw, True, True, 0, False);
  AData.AddProperty('DragPos', TDragObject_DragPos_si, TPoint_sw, True, True, 0, False);
  AData.AddProperty('DragTargetPos', TDragObject_DragTargetPos_si, TPoint_sw, True, True, 0, False);
  AData.AddProperty('Dropped', TDragObject_Dropped_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('MouseDeltaX', TDragObject_MouseDeltaX_si, Double_sw, True, False, 0, False);
  AData.AddProperty('MouseDeltaY', TDragObject_MouseDeltaY_si, Double_sw, True, False, 0, False);
  AData.AddProperty('RightClickCancels', TDragObject_RightClickCancels_si, Boolean_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Control', TBaseDragControlObject_Control_si, TControl_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Brush', TDragDockObject_Brush_si, TBrush_sw, True, True, 0, False);
  AData.AddProperty('DockRect', TDragDockObject_DockRect_si, TRect_sw, True, True, 0, False);
  AData.AddProperty('DropAlign', TDragDockObject_DropAlign_si, TAlign_sw, True, False, 0, False);
  AData.AddProperty('DropOnControl', TDragDockObject_DropOnControl_si, TControl_sw, True, False, 0, False);
  AData.AddProperty('Floating', TDragDockObject_Floating_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('FrameWidth', TDragDockObject_FrameWidth_si, Integer_sw, True, False, 0, False);
end;
...
begin
  ...
  AData.AddProperty('Control', TControlCanvas_Control_si, TControl_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('DropdownMenu', TCustomControlAction_DropdownMenu_si, TPopupMenu_sw, True, True, 0, False);
  AData.AddProperty('EnableDropdown', TCustomControlAction_EnableDropdown_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('PopupMenu', TCustomControlAction_PopupMenu_si, TPopupMenu_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('DropdownMenu');
  AData.AddPropertyRedecl('Enabled');
  AData.AddPropertyRedecl('EnableDropdown');
...
class function TMouseButton_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TMouseButton);
end;
...
class function TMouseActivate_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TMouseActivate);
end;
...
class function TDragMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDragMode);
end;
...
class function TDragState_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDragState);
end;
...
class function TDragKind_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDragKind);
end;
...
begin
  ...
  AData.AddFunction('Copy', TMouseActivateRec_Copy_si, TMouseActivateRec_sw, 0);
  ...
  AData.AddConstructor('Create', TMouseActivateRec_Create_si, 0);
end;
...
begin
  ...
  AData.AddFunction('Copy', TCMMouseActivate_Copy_si, TCMMouseActivate_sw, 0);
  ...
  AData.AddConstructor('Create', TCMMouseActivate_Create_si, 0);
end;
...
class function TAnchorKind_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TAnchorKind);
end;
...
begin
  ...
  AData.AddProperty('Control', TSizeConstraints_Control_si, TControl_sw, True, False, 0, True);
  AData.AddProperty('OnChange', TSizeConstraints_OnChange_si, TNotifyEvent_sw, True, True, 0, False);
  AData.AddProperty('MaxHeight', TSizeConstraints_MaxHeight_si, TConstraintSize_sw, True, True, 0, False);
  AData.AddProperty('MaxWidth', TSizeConstraints_MaxWidth_si, TConstraintSize_sw, True, True, 0, False);
  AData.AddProperty('MinHeight', TSizeConstraints_MinHeight_si, TConstraintSize_sw, True, True, 0, False);
  AData.AddProperty('MinWidth', TSizeConstraints_MinWidth_si, TConstraintSize_sw, True, True, 0, False);
...
class function TDockOrientation_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TDockOrientation);
end;
...
begin
  ...
  AData.AddProperty('ActionLink', TControl_ActionLink_si, TControlActionLink_sw, True, True, 0, True);
  AData.AddProperty('AutoSize', TControl_AutoSize_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('Caption', TControl_Caption_si, TCaption_sw, True, True, 0, True);
  AData.AddProperty('Color', TControl_Color_si, TColor_sw, True, True, 0, True);
  AData.AddProperty('DesktopFont', TControl_DesktopFont_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('DragKind', TControl_DragKind_si, TDragKind_sw, True, True, 0, True);
  AData.AddProperty('DragCursor', TControl_DragCursor_si, TCursor_sw, True, True, 0, True);
  AData.AddProperty('DragMode', TControl_DragMode_si, TDragMode_sw, True, True, 0, True);
  AData.AddProperty('Font', TControl_Font_si, TFont_sw, True, True, 0, True);
  AData.AddProperty('IsControl', TControl_IsControl_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('MouseCapture', TControl_MouseCapture_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ParentBiDiMode', TControl_ParentBiDiMode_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ParentColor', TControl_ParentColor_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ParentFont', TControl_ParentFont_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ParentShowHint', TControl_ParentShowHint_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('PopupMenu', TControl_PopupMenu_si, TPopupMenu_sw, True, True, 0, True);
  AData.AddProperty('Text', TControl_Text_si, TCaption_sw, True, True, 0, True);
  AData.AddProperty('WheelAccumulator', TControl_WheelAccumulator_si, Integer_sw, True, True, 0, True);
  AData.AddProperty('OnCanResize', TControl_OnCanResize_si, TCanResizeEvent_sw, True, True, 0, True);
  AData.AddProperty('OnClick', TControl_OnClick_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnConstrainedResize', TControl_OnConstrainedResize_si, TConstrainedResizeEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDblClick', TControl_OnDblClick_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDragDrop', TControl_OnDragDrop_si, TDragDropEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDragOver', TControl_OnDragOver_si, TDragOverEvent_sw, True, True, 0, True);
  AData.AddProperty('OnEndDock', TControl_OnEndDock_si, TEndDragEvent_sw, True, True, 0, True);
  AData.AddProperty('OnEndDrag', TControl_OnEndDrag_si, TEndDragEvent_sw, True, True, 0, True);
  AData.AddProperty('OnResize', TControl_OnResize_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnStartDock', TControl_OnStartDock_si, TStartDockEvent_sw, True, True, 0, True);
  AData.AddProperty('OnStartDrag', TControl_OnStartDrag_si, TStartDragEvent_sw, True, True, 0, True);
  AData.AddProcedure('BeginDrag', TControl_BeginDrag_si, 2, False);
  ...
  AData.AddFunction('ClientToParent', TControl_ClientToParent_si, TPoint_sw, 2, False);
  ...
  AData.AddProperty('Enabled', TControl_Enabled_si, Boolean_sw, True, True, 0, False);
  ...
  AData.AddFunction('ManualDock', TControl_ManualDock_si, Boolean_sw, 3, False);
  ...
  AData.AddFunction('ParentToClient', TControl_ParentToClient_si, TPoint_sw, 2, False);
  ...
  AData.AddProperty('Action', TControl_Action_si, TBasicAction_sw, True, True, 0, False);
  AData.AddProperty('Align', TControl_Align_si, TAlign_sw, True, True, 0, False);
  AData.AddProperty('Anchors', TControl_Anchors_si, TAnchors_sw, True, True, 0, False);
  AData.AddProperty('BiDiMode', TControl_BiDiMode_si, TBiDiMode_sw, True, True, 0, False);
  AData.AddProperty('BoundsRect', TControl_BoundsRect_si, TRect_sw, True, True, 0, False);
  AData.AddProperty('ClientHeight', TControl_ClientHeight_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('ClientOrigin', TControl_ClientOrigin_si, TPoint_sw, True, False, 0, False);
  AData.AddProperty('ClientRect', TControl_ClientRect_si, TRect_sw, True, False, 0, False);
  AData.AddProperty('ClientWidth', TControl_ClientWidth_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Constraints', TControl_Constraints_si, TSizeConstraints_sw, True, True, 0, False);
  AData.AddProperty('DockOrientation', TControl_DockOrientation_si, TDockOrientation_sw, True, True, 0, False);
  AData.AddProperty('Floating', TControl_Floating_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('FloatingDockSiteClass', TControl_FloatingDockSiteClass_si, TWinControlClass_sw, True, True, 0, False);
  AData.AddProperty('HostDockSite', TControl_HostDockSite_si, TWinControl_sw, True, True, 0, False);
  AData.AddProperty('LRDockWidth', TControl_LRDockWidth_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Parent', TControl_Parent_si, TWinControl_sw, True, True, 0, False);
  AData.AddProperty('ShowHint', TControl_ShowHint_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('TBDockHeight', TControl_TBDockHeight_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('UndockHeight', TControl_UndockHeight_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('UndockWidth', TControl_UndockWidth_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Visible', TControl_Visible_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('Left', TControl_Left_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Top', TControl_Top_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Width', TControl_Width_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Height', TControl_Height_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('Cursor', TControl_Cursor_si, TCursor_sw, True, True, 0, False);
  AData.AddProperty('Hint', TControl_Hint_si, string_sw, True, True, 0, False);
  AData.AddProperty('HelpType', TControl_HelpType_si, THelpType_sw, True, True, 0, False);
  AData.AddProperty('HelpKeyword', TControl_HelpKeyword_si, string_sw, True, True, 0, False);
  AData.AddProperty('HelpContext', TControl_HelpContext_si, THelpContext_sw, True, True, 0, False);
end;
...
class function TImeMode_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TImeMode);
end;
...
begin
  ...
  AData.AddFunction('Copy', TAlignInfo_Copy_si, TAlignInfo_sw, 0);
  ...
  AData.AddConstructor('Create', TAlignInfo_Create_si, 0);
end;
...
class function TBevelCut_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBevelCut);
end;
...
class function TBevelEdge_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBevelEdge);
end;
...
class function TBevelKind_sw.GetEnumTypeInfo: TLMDTypeInfo;
begin
  Result := TypeInfo(TBevelKind);
end;
...
begin
  ...
  Result := TControl_sw.ToVar(TWinControl(AObj).ControlAtPos(TPoint_sw.FromVar(
    AArgs[0]), Boolean(AArgs[1]), Boolean(AArgs[2]), Boolean(AArgs[3])));
end;
...
begin
  ...
  AData.AddProperty('BevelEdges', TWinControl_BevelEdges_si, TBevelEdges_sw, True, True, 0, True);
  AData.AddProperty('BevelInner', TWinControl_BevelInner_si, TBevelCut_sw, True, True, 0, True);
  AData.AddProperty('BevelOuter', TWinControl_BevelOuter_si, TBevelCut_sw, True, True, 0, True);
  AData.AddProperty('BevelKind', TWinControl_BevelKind_si, TBevelKind_sw, True, True, 0, True);
  AData.AddProperty('BevelWidth', TWinControl_BevelWidth_si, TBevelWidth_sw, True, True, 0, True);
  AData.AddProperty('BorderWidth', TWinControl_BorderWidth_si, TBorderWidth_sw, True, True, 0, True);
  AData.AddProperty('Ctl3D', TWinControl_Ctl3D_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ImeMode', TWinControl_ImeMode_si, TImeMode_sw, True, True, 0, True);
  AData.AddProperty('ImeName', TWinControl_ImeName_si, TImeName_sw, True, True, 0, True);
  AData.AddProperty('ParentBackground', TWinControl_ParentBackground_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('ParentCtl3D', TWinControl_ParentCtl3D_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('WindowHandle', TWinControl_WindowHandle_si, HWnd_sw, True, True, 0, True);
  AData.AddProperty('OnAlignInsertBefore', TWinControl_OnAlignInsertBefore_si, TAlignInsertBeforeEvent_sw, True, True, 0, True);
  AData.AddProperty('OnAlignPosition', TWinControl_OnAlignPosition_si, TAlignPositionEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDockDrop', TWinControl_OnDockDrop_si, TDockDropEvent_sw, True, True, 0, True);
  AData.AddProperty('OnDockOver', TWinControl_OnDockOver_si, TDockOverEvent_sw, True, True, 0, True);
  AData.AddProperty('OnEnter', TWinControl_OnEnter_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnExit', TWinControl_OnExit_si, TNotifyEvent_sw, True, True, 0, True);
  AData.AddProperty('OnKeyPress', TWinControl_OnKeyPress_si, TKeyPressEvent_sw, True, True, 0, True);
  AData.AddProperty('OnUnDock', TWinControl_OnUnDock_si, TUnDockEvent_sw, True, True, 0, True);
  ...
  AData.AddFunction('ControlAtPos', TWinControl_ControlAtPos_si, TControl_sw, 4, False);
  AData.AddProcedure('DisableAlign', TWinControl_DisableAlign_si, 0, False);
  AData.AddProperty('DockClientCount', TWinControl_DockClientCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('DockClients', TWinControl_DockClients_si, TControl_sw, True, False, 1, False);
  AData.AddProcedure('DockDrop', TWinControl_DockDrop_si, 3, False);
  AData.AddProperty('DockSite', TWinControl_DockSite_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DoubleBuffered', TWinControl_DoubleBuffered_si, Boolean_sw, True, True, 0, False);
  ...
  AData.AddProperty('AlignDisabled', TWinControl_AlignDisabled_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('VisibleDockClientCount', TWinControl_VisibleDockClientCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Brush', TWinControl_Brush_si, TBrush_sw, True, False, 0, False);
  AData.AddProperty('Controls', TWinControl_Controls_si, TControl_sw, True, False, 1, False);
  AData.AddProperty('ControlCount', TWinControl_ControlCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Handle', TWinControl_Handle_si, HWnd_sw, True, False, 0, False);
  AData.AddProperty('ParentWindow', TWinControl_ParentWindow_si, HWnd_sw, True, True, 0, False);
  AData.AddProperty('Showing', TWinControl_Showing_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('TabOrder', TWinControl_TabOrder_si, TTabOrder_sw, True, True, 0, False);
  AData.AddProperty('TabStop', TWinControl_TabStop_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('UseDockManager', TWinControl_UseDockManager_si, Boolean_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('Canvas', TGraphicControl_Canvas_si, TCanvas_sw, True, False, 0, True);
end;
...
begin
  ...
  AData.AddProperty('Canvas', TCustomControl_Canvas_si, TCanvas_sw, True, False, 0, True);
end;
...
begin
  ...
  AData.AddProperty('DragCursor', TDragImageList_DragCursor_si, TCursor_sw, True, True, 0, False);
  AData.AddProperty('DragHotspot', TDragImageList_DragHotspot_si, TPoint_sw, True, True, 0, False);
  AData.AddProperty('Dragging', TDragImageList_Dragging_si, Boolean_sw, True, False, 0, False);
end;
...
begin
  ...
  AData.AddPropertyRedecl('BlendColor');
  AData.AddPropertyRedecl('BkColor');
  AData.AddPropertyRedecl('AllocBy');
  AData.AddPropertyRedecl('DrawingStyle');
  AData.AddPropertyRedecl('Height');
  AData.AddPropertyRedecl('ImageType');
  AData.AddPropertyRedecl('Masked');
  AData.AddPropertyRedecl('OnChange');
  AData.AddPropertyRedecl('ShareImages');
...
begin
  ...
  AData.AddProperty('ChildCount', TDockZone_ChildCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('ChildControl', TDockZone_ChildControl_si, TControl_sw, True, False, 0, False);
  AData.AddProperty('Height', TDockZone_Height_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Left', TDockZone_Left_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('LimitBegin', TDockZone_LimitBegin_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('LimitSize', TDockZone_LimitSize_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Top', TDockZone_Top_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Visible', TDockZone_Visible_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('VisibleChildCount', TDockZone_VisibleChildCount_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('Width', TDockZone_Width_si, Integer_sw, True, False, 0, False);
  AData.AddProperty('ZoneLimit', TDockZone_ZoneLimit_si, Integer_sw, True, True, 0, False);
...
begin
  ...
  AData.AddProperty('DockSite', TDockTree_DockSite_si, TWinControl_sw, True, True, 0, True);
  AData.AddProperty('RelativeSizes', TDockTree_RelativeSizes_si, Boolean_sw, True, True, 0, True);
  AData.AddProperty('TopZone', TDockTree_TopZone_si, TDockZone_sw, True, False, 0, True);
...
begin
  ...
  AData.AddProperty('Capture', TMouse_Capture_si, HWND_sw, True, True, 0, False);
  AData.AddProperty('CursorPos', TMouse_CursorPos_si, TPoint_sw, True, True, 0, False);
  AData.AddProperty('DragImmediate', TMouse_DragImmediate_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('DragThreshold', TMouse_DragThreshold_si, Integer_sw, True, True, 0, False);
  AData.AddProperty('MousePresent', TMouse_MousePresent_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('IsDragging', TMouse_IsDragging_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('RegWheelMessage', TMouse_RegWheelMessage_si, UINT_sw, True, False, 0, False);
  AData.AddProperty('WheelPresent', TMouse_WheelPresent_si, Boolean_sw, True, False, 0, False);
  AData.AddProperty('WheelScrollLines', TMouse_WheelScrollLines_si, Integer_sw, True, False, 0, False);
...
begin
  ...
  AData.AddProperty('ItemIndex', TCustomListControl_ItemIndex_si, Integer_sw, True, True, 0, False);
end;
...
begin
  ...
  AData.AddProperty('MultiSelect', TCustomMultiSelectListControl_MultiSelect_si, Boolean_sw, True, True, 0, False);
  AData.AddProperty('SelCount', TCustomMultiSelectListControl_SelCount_si, Integer_sw, True, False, 0, False);
end;
...
function Controls_TDragMessage_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDragMessage = (dmDragLeave, dmDragMove, dmDragDrop,...
...
function Controls_TAlign_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TAlign = (alTop, alBottom, alLeft, alRight, alClient...
...
function Controls_TMouseButton_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMouseButton = (mbRight, mbMiddle);
...
function Controls_TMouseActivate_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TMouseActivate = (maActivate, maActivateAndEat, maNo...
...
function Controls_TDragState_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDragState = (dsDragLeave, dsDragMove);
...
function Controls_TAnchorKind_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TAnchorKind = (akTop, akRight, akBottom);
...
function Controls_TDockOrientation_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDockOrientation = (doHorizontal, doVertical);
...
function Controls_TImeMode_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TImeMode = (imClose, imOpen, imDontCare, imSAlpha, i...
...
function Controls_TBevelCut_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBevelCut = (bvLowered, bvRaised, bvSpace);
...
function Controls_TBevelEdge_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBevelEdge = (beTop, beRight, beBottom);
...
function Controls_TBevelKind_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TBevelKind = (bkTile, bkSoft, bkFlat);
...
function Controls_TDockTree_si(var AObj; const AArgs: TLMDDispArgs;
  AArgsSize: Integer; IsGet: Boolean): OleVariant;
begin
  // type TDockTree = class(TInterfacedObject, IDockManager);
