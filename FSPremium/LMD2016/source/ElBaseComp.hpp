...
// (DO NOT EDIT: machine generated header) 'ElBaseComp.pas' rev: 31.00 (Windows)
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EBaseEnabledFailed(void) { }
	
};

#pragma pack(pop)

class PASCALIMPLEMENTATION TElBaseComponent : public Elcomponent::TElComponent
{
