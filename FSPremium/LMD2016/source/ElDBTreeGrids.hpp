...
// (DO NOT EDIT: machine generated header) 'ElDBTreeGrids.pas' rev: 31.00 (Windows)

#ifndef EldbtreegridsHPP
#define EldbtreegridsHPP
...
namespace Eldbtreegrids
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS THackElStylesDefsItem;
class DELPHICLASS TElDBTreeGridColumns;
class DELPHICLASS TCustomElDBTreeGrid;
class DELPHICLASS TElDBTreeTrickyInplaceEdit;
class DELPHICLASS TElDBTreeStringGrid;
class DELPHICLASS TElDBTreeGridView;
class DELPHICLASS EElDBTreeGridError;
//-- type declarations -------------------------------------------------------
#pragma pack(push,4)
class PASCALIMPLEMENTATION THackElStylesDefsItem : public Eldbtree::TElStylesDefsItem
{
	typedef Eldbtree::TElStylesDefsItem inherited;
	
public:
	/* TElStylesDefsItem.Create */ inline __fastcall virtual THackElStylesDefsItem(System::Classes::TCollection* Collection) : Eldbtree::TElStylesDefsItem(Collection) { }
	/* TElStylesDefsItem.Destroy */ inline __fastcall virtual ~THackElStylesDefsItem(void) { }
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TElDBTreeGridColumns : public System::Classes::TPersistent
{
	typedef System::Classes::TPersistent inherited;
	
private:
	TCustomElDBTreeGrid* Tree;
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TElDBTreeGridColumns(void) { }
	
public:
	/* TObject.Create */ inline __fastcall TElDBTreeGridColumns(void) : System::Classes::TPersistent() { }
	
};

#pragma pack(pop)

class PASCALIMPLEMENTATION TCustomElDBTreeGrid : public Eldbtree::TCustomElDBTree
{
	typedef Eldbtree::TCustomElDBTree inherited;
...
protected:
	...
	bool FgoDeletion;
	virtual void __fastcall SetSource(Eldbtree::TElRelDataSource* Source);
...
public:
	...
	__fastcall virtual TCustomElDBTreeGrid(System::Classes::TComponent* Owner);
	__fastcall virtual ~TCustomElDBTreeGrid(void);
...
__published:
	__property TElDBTreeGridColumns* Columns = {read=FColumns};
	__property VerticalLines = {default=1};
	__property HorizontalLines = {default=1};
public:
	/* TCustomElTree.CreateClass */ inline __fastcall TCustomElDBTreeGrid(System::Classes::TComponent* AOwner, Eltree::TElTreeItemClass ItemClass) : Eldbtree::TCustomElDBTree(AOwner, ItemClass) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TCustomElDBTreeGrid(HWND ParentWindow) : Eldbtree::TCustomElDBTree(ParentWindow) { }
	
};


class PASCALIMPLEMENTATION TElDBTreeTrickyInplaceEdit : public Eldbtreeeditors::TElDBTreeWideStringEdit
{
	typedef Eldbtreeeditors::TElDBTreeWideStringEdit inherited;
	
private:
	System::UnicodeString FDummyStr;
	TElDBTreeStringGrid* FOwner;
...
public:
	/* TElDBTreeWideStringEdit.Create */ inline __fastcall virtual TElDBTreeTrickyInplaceEdit(System::Classes::TComponent* AOwner) : Eldbtreeeditors::TElDBTreeWideStringEdit(AOwner) { }
	/* TElDBTreeWideStringEdit.Destroy */ inline __fastcall virtual ~TElDBTreeTrickyInplaceEdit(void) { }
	
};


class PASCALIMPLEMENTATION TElDBTreeStringGrid : public TCustomElDBTreeGrid
{
	typedef TCustomElDBTreeGrid inherited;
...
public:
	__fastcall virtual TElDBTreeStringGrid(System::Classes::TComponent* Owner);
	__fastcall virtual ~TElDBTreeStringGrid(void);
...
public:
	/* TCustomElTree.CreateClass */ inline __fastcall TElDBTreeStringGrid(System::Classes::TComponent* AOwner, Eltree::TElTreeItemClass ItemClass) : TCustomElDBTreeGrid(AOwner, ItemClass) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TElDBTreeStringGrid(HWND ParentWindow) : TCustomElDBTreeGrid(ParentWindow) { }
	
};


class PASCALIMPLEMENTATION TElDBTreeGridView : public Eldbtree::TElDBTreeView
{
	typedef Eldbtree::TElDBTreeView inherited;
...
public:
	virtual Eltree::TElTreeItem* __fastcall FindNewFocused(System::Word Key, System::PInteger PVal1, bool &Sel)/* overload */;
public:
	/* TElTreeView.Create */ inline __fastcall virtual TElDBTreeGridView(System::Classes::TComponent* Owner) : Eldbtree::TElDBTreeView(Owner) { }
	/* TElTreeView.Destroy */ inline __fastcall virtual ~TElDBTreeGridView(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TElDBTreeGridView(HWND ParentWindow) : Eldbtree::TElDBTreeView(ParentWindow) { }
	
	/* Hoisted overloads: */
	
protected:
	inline Eltree::TElTreeItem* __fastcall  FindNewFocused(System::Word Key, bool &Sel){ return Eltree::TElTreeView::FindNewFocused(Key, Sel); }
	
};


#pragma pack(push,4)
class PASCALIMPLEMENTATION EElDBTreeGridError : public Eltreeinplaceeditors::EElTreeError
{
	typedef Eltreeinplaceeditors::EElTreeError inherited;
	
public:
	/* Exception.Create */ inline __fastcall EElDBTreeGridError(const System::UnicodeString Msg) : Eltreeinplaceeditors::EElTreeError(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EElDBTreeGridError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : Eltreeinplaceeditors::EElTreeError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EElDBTreeGridError(NativeUInt Ident)/* overload */ : Eltreeinplaceeditors::EElTreeError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EElDBTreeGridError(System::PResStringRec ResStringRec)/* overload */ : Eltreeinplaceeditors::EElTreeError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EElDBTreeGridError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : Eltreeinplaceeditors::EElTreeError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EElDBTreeGridError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : Eltreeinplaceeditors::EElTreeError(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EElDBTreeGridError(const System::UnicodeString Msg, int AHelpContext) : Eltreeinplaceeditors::EElTreeError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EElDBTreeGridError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : Eltreeinplaceeditors::EElTreeError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EElDBTreeGridError(NativeUInt Ident, int AHelpContext)/* overload */ : Eltreeinplaceeditors::EElTreeError(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EElDBTreeGridError(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : Eltreeinplaceeditors::EElTreeError(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EElDBTreeGridError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Eltreeinplaceeditors::EElTreeError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EElDBTreeGridError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Eltreeinplaceeditors::EElTreeError(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EElDBTreeGridError(void) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ELDBTREEGRIDS)
using namespace Eldbtreegrids;
#endif
#pragma pack(pop)
#pragma option pop
