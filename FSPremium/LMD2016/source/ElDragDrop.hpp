...
// (DO NOT EDIT: machine generated header) 'ElDragDrop.pas' rev: 31.00 (Windows)
...
private:
	...
	System::Classes::TStringList* FWideList;
	System::UnicodeString FWideString;
	
protected:
	System::Classes::TStringList* __fastcall GetWideFileList(void);
	System::WideString __fastcall GetWideString(void);
	System::Classes::TStringList* __fastcall GetFileList(void);
...
public:
	...
	_di_IDataObject __fastcall DataObject(void);
	...
	__property System::Classes::TStringList* WideFileList = {read=GetWideFileList};
	__property System::WideString WideStringData = {read=GetWideString};
...
class PASCALIMPLEMENTATION TElDropTarget : public Elcomponent::TElComponent
{
...
__published:
	...
	__property TDragTypes DragTypes = {read=FDragTypes, write=FDragTypes, default=5};
	...
	__property bool IsDropSource = {read=FIsDropSource, write=FIsDropSource, default=0};
	__property bool IsDropTarget = {read=FIsDropTarget, write=SetIsDropTarget, default=0};
