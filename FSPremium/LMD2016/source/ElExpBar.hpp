...
// (DO NOT EDIT: machine generated header) 'ElExpBar.pas' rev: 31.00 (Windows)
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EExplorerBarError(void) { }
...
protected:
	...
	bool FIsSpecial;
	void __fastcall SetIsSpecial(const bool Value);
...
__published:
	__property bool IsSpecial = {read=FIsSpecial, write=SetIsSpecial, default=0};
...
protected:
	...
	bool FUseCaptionsFont;
	void __fastcall SetUseCaptionsFont(bool Value);
...
public:
	...
	__property bool UseCaptionsFont = {read=FUseCaptionsFont, write=SetUseCaptionsFont, nodefault};
...
__published:
	...
	__property TransparentXPThemes = {default=0};
public:
...
public:
	__fastcall virtual TElExplorerBarGroupCaption(System::Classes::TComponent* AOwner);
public:
	/* TElAdvCaptionPanel.Destroy */ inline __fastcall virtual ~TElExplorerBarGroupCaption(void) { }
