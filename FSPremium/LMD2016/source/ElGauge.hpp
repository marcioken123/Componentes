...
// (DO NOT EDIT: machine generated header) 'ElGauge.pas' rev: 31.00 (Windows)
...
__published:
	...
	__property int CriticalValue = {read=FCriticalValue, write=SetCriticalValue, default=0};
	__property System::Uitypes::TColor CriticalColor = {read=FCriticalColor, write=SetCriticalColor, default=-16777198};
	...
	__property TElGaugeKind GaugeKind = {read=FGaugeKind, write=SetGaugeKind, default=0};
	__property OnClick;
