...
// (DO NOT EDIT: machine generated header) 'ElHook.pas' rev: 31.00 (Windows)
...
class PASCALIMPLEMENTATION TElHook : public Elcomponent::TElComponent
{
...
public:
	/* TComponent.Create */ inline __fastcall virtual TElHook(System::Classes::TComponent* AOwner) : Elcomponent::TElComponent(AOwner) { }
