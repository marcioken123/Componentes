...
// (DO NOT EDIT: machine generated header) 'ElPrinterPreview.pas' rev: 31.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (*TElBeforeSavePageEvent)(System::TObject* Sender, System::UnicodeString AFileName, bool &CanSave);
...
private:
	...
	int FCurrentPage;
	int FTotalPages;
	Lmdobjectlist::TLMDObjectList* Panels;
	int PagePanels;
	int HorzPages;
	int VertPages;
	...
	int FScaleIdx;
	int FRealIdx;
	TElBeforeSavePageEvent FOnBeforeSavePage;
...
public:
	...
	__property TElBeforeSavePageEvent OnBeforeSavePage = {read=FOnBeforeSavePage, write=FOnBeforeSavePage};
