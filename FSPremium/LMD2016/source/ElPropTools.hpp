...
// (DO NOT EDIT: machine generated header) 'ElPropTools.pas' rev: 31.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall LoadWideStringProperty(System::TObject* Comp, System::Typinfo::PPropInfo Prop, Elini::TElIniFile* Storage);
extern DELPHI_PACKAGE void __fastcall LoadWideStringList(System::Classes::TStrings* Strings, System::UnicodeString Name, Elini::TElIniFile* Storage);
...
extern DELPHI_PACKAGE void __fastcall StoreWideStringProperty(System::TObject* Comp, System::Typinfo::PPropInfo Prop, Elini::TElIniFile* Storage);
extern DELPHI_PACKAGE void __fastcall StoreWideStringList(System::Classes::TStrings* Strings, System::UnicodeString Name, Elini::TElIniFile* Storage);
