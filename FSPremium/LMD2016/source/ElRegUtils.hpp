...
// (DO NOT EDIT: machine generated header) 'ElRegUtils.pas' rev: 31.00 (Windows)
...
extern DELPHI_PACKAGE bool __fastcall IsValidKeyName(System::AnsiString Name);
...
extern DELPHI_PACKAGE bool __fastcall KeyGetValueInfo(const System::UnicodeString ComputerName, TRegRootType RT, const System::UnicodeString KeyName, const System::UnicodeString ValueName, unsigned &ValueType, System::UnicodeString &ValueString);
