...
// (DO NOT EDIT: machine generated header) 'ElSideBar.pas' rev: 31.00 (Windows)
...
__published:
	...
	__property Align = {stored=false};
	__property BevelOuter = {stored=false, default=2};
	__property MouseCapture = {stored=false, default=0};
	__property Visible = {stored=false, default=1};
	__property DockOrientation = {stored=false};
	__property DoubleBuffered = {stored=false, default=0};
public:
...
private:
	...
	int __fastcall VisItemCount(void);
...
__published:
	__property bool Inactive = {read=FInactive, write=FInactive, default=0};
	__property TElSideBarItems* Items = {read=FItems, write=SetItems};
	__property bool ContainsControls = {read=FContainsControls, write=SetContainsControls, default=0};
};
...
private:
	...
	Vcl::Imglist::TCustomImageList* FSectionImages;
	Vcl::Imglist::TCustomImageList* FSectionHotImages;
	Vcl::Imglist::TCustomImageList* FSectionDisabledImages;
	Vcl::Imglist::TCustomImageList* FItemDisabledImages;
	Vcl::Imglist::TCustomImageList* FItemImages;
	Vcl::Imglist::TCustomImageList* FItemHotImages;
	Vcl::Imglist::TCustomImageList* FAlphaSectionImages;
	Vcl::Imglist::TCustomImageList* FAlphaSectionHotImages;
	Vcl::Imglist::TCustomImageList* FAlphaSectionDisabledImages;
	Vcl::Imglist::TCustomImageList* FAlphaItemDisabledImages;
	Vcl::Imglist::TCustomImageList* FAlphaItemImages;
	Vcl::Imglist::TCustomImageList* FAlphaItemHotImages;
	...
	Vcl::Imglist::TChangeLink* FASImagesLink;
	Vcl::Imglist::TChangeLink* FAIImagesLink;
	Vcl::Imglist::TChangeLink* FASDImagesLink;
	Vcl::Imglist::TChangeLink* FAIDImagesLink;
	Vcl::Imglist::TChangeLink* FASHImagesLink;
	Vcl::Imglist::TChangeLink* FAIHImagesLink;
	...
	System::Uitypes::TColor FScrollButtonColor;
	...
	void __fastcall SetSectionImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetSectionHotImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetSectionDisabledImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetItemDisabledImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetItemImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetItemHotImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetAlphaSectionImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetAlphaSectionHotImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetAlphaSectionDisabledImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetAlphaItemDisabledImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetAlphaItemImages(Vcl::Imglist::TCustomImageList* newValue);
	void __fastcall SetAlphaItemHotImages(Vcl::Imglist::TCustomImageList* newValue);
	...
	Vcl::Graphics::TFont* __fastcall GetSectionsFont(void);
...
protected:
	...
	System::Types::TRect __fastcall GetItemsRect(void);
	System::Types::TRect __fastcall GetTopSectionsRect(void);
	System::Types::TRect __fastcall GetBottomSectionsRect(void);
	...
	void __fastcall SetScrollButtonColor(System::Uitypes::TColor Value);
	void __fastcall SetTransparentItems(bool Value);
	HIDESBASE void __fastcall SetBorderColorDkShadow(System::Uitypes::TColor Value);
	HIDESBASE void __fastcall SetBorderColorFace(System::Uitypes::TColor Value);
	HIDESBASE void __fastcall SetBorderColorHighlight(System::Uitypes::TColor Value);
	HIDESBASE void __fastcall SetBorderColorShadow(System::Uitypes::TColor Value);
	HIDESBASE void __fastcall SetBorderColorWindow(System::Uitypes::TColor Value);
...
__published:
	...
	__property int SectionIndex = {read=GetSectionIndex, write=SetSectionIndex, default=-1};
	...
	__property Vcl::Imglist::TCustomImageList* SectionImages = {read=FSectionImages, write=SetSectionImages};
	__property Vcl::Imglist::TCustomImageList* SectionHotImages = {read=FSectionHotImages, write=SetSectionHotImages};
	__property Vcl::Imglist::TCustomImageList* SectionDisabledImages = {read=FSectionDisabledImages, write=SetSectionDisabledImages};
	__property Vcl::Imglist::TCustomImageList* ItemDisabledImages = {read=FItemDisabledImages, write=SetItemDisabledImages};
	__property Vcl::Imglist::TCustomImageList* ItemImages = {read=FItemImages, write=SetItemImages};
	__property Vcl::Imglist::TCustomImageList* ItemHotImages = {read=FItemHotImages, write=SetItemHotImages};
	__property Vcl::Imglist::TCustomImageList* AlphaForSectionImages = {read=FAlphaSectionImages, write=SetAlphaSectionImages};
	__property Vcl::Imglist::TCustomImageList* AlphaForSectionHotImages = {read=FAlphaSectionHotImages, write=SetAlphaSectionHotImages};
	__property Vcl::Imglist::TCustomImageList* AlphaForSectionDisabledImages = {read=FAlphaSectionDisabledImages, write=SetAlphaSectionDisabledImages};
	__property Vcl::Imglist::TCustomImageList* AlphaForItemDisabledImages = {read=FAlphaItemDisabledImages, write=SetAlphaItemDisabledImages};
	__property Vcl::Imglist::TCustomImageList* AlphaForItemImages = {read=FAlphaItemImages, write=SetAlphaItemImages};
	__property Vcl::Imglist::TCustomImageList* AlphaForItemHotImages = {read=FAlphaItemHotImages, write=SetAlphaItemHotImages};
	...
	__property bool FlatActiveItem = {read=FFlatActiveItem, write=SetFlatActiveItem, default=0};
	__property int ItemSize = {read=FItemSize, write=SetItemSize, default=36};
	__property bool RightAlignedBar = {read=FRightAlignedBar, write=SetRightAlignedBar, default=0};
	__property int SectionHeight = {read=FSectionHeight, write=SetSectionHeight, default=0};
	...
	__property System::Uitypes::TFontStyles ActiveSectionStyle = {read=FActiveSectionStyle, write=SetActiveSectionStyle, default=1};
	__property System::Uitypes::TFontStyles ActiveItemStyle = {read=FActiveItemStyle, write=SetActiveItemStyle, default=1};
	...
	__property System::Uitypes::TColor ScrollButtonColor = {read=FScrollButtonColor, write=SetScrollButtonColor, default=-16777201};
	__property bool TransparentItems = {read=FTransparentItems, write=SetTransparentItems, default=0};
