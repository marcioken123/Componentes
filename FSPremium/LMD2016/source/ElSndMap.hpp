...
// (DO NOT EDIT: machine generated header) 'ElSndMap.pas' rev: 31.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef System::UnicodeString TElSoundName;

class PASCALIMPLEMENTATION TElSoundMap : public Elcomponent::TElComponent
{
...
private:
	...
	System::Classes::TStringList* __fastcall GetSchemes(void);
	System::Classes::TStringList* __fastcall GetEventKeys(void);
