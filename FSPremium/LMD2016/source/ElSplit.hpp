...
// (DO NOT EDIT: machine generated header) 'ElSplit.pas' rev: 31.00 (Windows)
...
//-- type declarations -------------------------------------------------------
enum DECLSPEC_DENUM TElResizeStyle : unsigned char { ersLine, ersPattern };
...
private:
	...
	int FCurPos;
	int FSizeBeforeSnap;
	int FLSizeBeforeSnap;
	int FRSizeBeforeSnap;
	...
	Vcl::Controls::TControl* __fastcall GetControlTopLeft(void);
	Vcl::Controls::TControl* __fastcall GetControlBottomRight(void);
	...
	System::Types::TRect __fastcall GetLeftSnapButtonRect(void);
	...
	System::Types::TRect __fastcall GetRightSnapButtonRect(void);
	HIDESBASE MESSAGE void __fastcall WMSize(Winapi::Messages::TWMSize &Msg);
	
protected:
	bool FSnappedLeft;
	bool FSnappedRight;
	TElResizeStyle FResizeStyle;
...
public:
	...
	__property int SizeBeforeSnap = {read=FSizeBeforeSnap, write=FSizeBeforeSnap, nodefault};
...
__published:
	...
	__property TElResizeStyle ResizeStyle = {read=FResizeStyle, write=FResizeStyle, default=0};
	__property bool InvertSnapButtons = {read=FInvertSnapButtons, write=SetInvertSnapButtons, default=0};
	__property bool SnapOnly = {read=FSnapOnly, write=FSnapOnly, default=0};
