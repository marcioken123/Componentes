...
// (DO NOT EDIT: machine generated header) 'ElTools.pas' rev: 31.00 (Windows)
...
public:
	/* TObject.Create */ inline __fastcall TDirectMemoryStream(void) : System::Classes::TMemoryStream() { }
...
struct DECLSPEC_DRECORD Eltools__4
{
public:
	void __fastcall (*GetMem)(void *P, int Size);
	void __fastcall (*ReallocMem)(void *P, int Size);
	void __fastcall (*FreeMem)(void * P);
};
...
extern DELPHI_PACKAGE Eltools__4 ElMemoryManager;
extern DELPHI_PACKAGE bool SimpleAppFinallize;
extern DELPHI_PACKAGE void __fastcall PlaySound(System::WideChar * Name, unsigned ModuleFlags, unsigned SoundFlags);
...
extern DELPHI_PACKAGE Lmdtypes::TLMDString __fastcall GetUserLocalAppDataFolder(void);
extern DELPHI_PACKAGE System::UnicodeString __fastcall GetSpecialFolder(const int CSIDL);
extern DELPHI_PACKAGE System::UnicodeString __fastcall IncludeTrailingBackslash2(System::UnicodeString Path);
...
extern DELPHI_PACKAGE bool __fastcall TimeInMask(const System::UnicodeString CronMask, const TReducedDateTime &T);
extern DELPHI_PACKAGE System::UnicodeString __fastcall GetSystemDir(void);
extern DELPHI_PACKAGE System::UnicodeString __fastcall GetShortPath(const System::UnicodeString Path);
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall GetFormattedTimeString(System::TDateTime ADate, const System::UnicodeString Format);
...
extern DELPHI_PACKAGE System::Types::TRect __fastcall ScaleRectToRect(const System::Types::TRect &RectSrc, const System::Types::TRect &RectDest);
...
extern DELPHI_PACKAGE void __fastcall AnsiWriteTextToStream(System::Classes::TStream* S, System::UnicodeString AData);
extern DELPHI_PACKAGE void __fastcall WriteTextToStream(System::Classes::TStream* S, System::UnicodeString AData);
extern DELPHI_PACKAGE System::UnicodeString __fastcall encode_line(const void *buf, int size);
extern DELPHI_PACKAGE bool __fastcall FileNameValid(const System::UnicodeString FileName);
extern DELPHI_PACKAGE __int64 __fastcall GetFileSize(const Lmdtypes::TLMDString FileName);
extern DELPHI_PACKAGE System::TDateTime __fastcall FileDateTime(const System::UnicodeString FileName);
extern DELPHI_PACKAGE bool __fastcall CreateFile(const Lmdtypes::TLMDString FileName);
extern DELPHI_PACKAGE bool __fastcall EnsureDirExists(System::UnicodeString RootName, const System::UnicodeString DirName);
extern DELPHI_PACKAGE System::UnicodeString __fastcall EnsureValidFileName(const System::UnicodeString PathName, const System::UnicodeString FileName);
extern DELPHI_PACKAGE bool __fastcall DirExists(System::UnicodeString DirName);
extern DELPHI_PACKAGE System::UnicodeString __fastcall ReplaceExt(const System::UnicodeString FileName, const System::UnicodeString NewExt);
extern DELPHI_PACKAGE bool __fastcall PurgeDir(System::UnicodeString DirName, bool RemoveFiles = true);
extern DELPHI_PACKAGE NativeUInt __fastcall RunProgram(System::UnicodeString StartName, const System::UnicodeString Params, const System::UnicodeString StartDir);
...
extern DELPHI_PACKAGE bool __fastcall SetPrivilege(const System::UnicodeString sPrivilegeName, bool bEnabled);
extern DELPHI_PACKAGE HWND __fastcall WindowExists(const System::UnicodeString ClassName, const System::UnicodeString Caption, bool ExactMatch);
extern DELPHI_PACKAGE HWND __fastcall TopWindowExists(const System::UnicodeString ClassName, const System::UnicodeString Caption, bool ExactMatch);
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall GetSystemErrorMessage(int ErrorCode);
...
extern DELPHI_PACKAGE bool __fastcall DrivePresent(const System::UnicodeString DrivePath);
}	/* namespace Eltools */
