...
// (DO NOT EDIT: machine generated header) 'ElTreePrinter.pas' rev: 31.00 (Windows)
...
public:
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EElTreePrinterError(void) { }
...
__published:
	...
	__property bool showHeaderExpandMarks = {read=FshowHeaderExpandMarks, write=SetshowHeaderExpandMarks, default=0};
	__property bool ShowHeaderImages = {read=FShowHeaderImages, write=SetShowHeaderImages, default=1};
	__property bool ShowHeaderSortMarks = {read=FShowHeaderSortMarks, write=SetShowHeaderSortMarks, default=0};
	__property bool ShowHiddenItems = {read=FShowHiddenItems, write=SetShowHiddenItems, default=1};
	__property bool ShowHiddenSections = {read=FShowHiddenSections, write=SetShowHiddenSections, default=1};
	...
	__property bool ShowInvisibleSections = {read=FShowInvisibleSections, write=SetShowInvisibleSections, default=0};
	...
	__property bool HeaderOnEveryPage = {read=FHeaderOnEveryPage, write=SetHeaderOnEveryPage, default=0};
