...
// (DO NOT EDIT: machine generated header) 'LMDCSVWriter.pas' rev: 31.00 (Windows)

#ifndef LmdcsvwriterHPP
#define LmdcsvwriterHPP
...
namespace Lmdcsvwriter
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TLMDCSVWriter;
//-- type declarations -------------------------------------------------------
#pragma pack(push,4)
class PASCALIMPLEMENTATION TLMDCSVWriter : public Lmdwriter::TLMDWriter
{
...
public:
	__fastcall virtual TLMDCSVWriter(System::Classes::TStream* aStream)/* overload */;
	__fastcall virtual ~TLMDCSVWriter(void);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDCSVWRITER)
using namespace Lmdcsvwriter;
#endif
#pragma pack(pop)
#pragma option pop
