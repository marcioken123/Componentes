...
// (DO NOT EDIT: machine generated header) 'LMDChartCTAreaLine3D.pas' rev: 31.00 (Windows)

#ifndef Lmdchartctarealine3dHPP
#define Lmdchartctarealine3dHPP
...
namespace Lmdchartctarealine3d
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TLMDChartCTAreaLine3D;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TLMDChartCTAreaLine3D : public Lmdcharttypes::TLMDChartCTAbstract
{
...
protected:
	...
	void __fastcall DrawAreaLinesNegative(Vcl::Graphics::TCanvas* ATarget, Lmdchartdata::TLMDChartData* AValues, int AStartX, int AEndX, int AStartY, int AEndY, Lmdchartaxis::TLMDChartYAxis* AYAxis, bool AShowMarkers);
...
public:
	...
	__fastcall virtual ~TLMDChartCTAreaLine3D(void);
	...
	__fastcall virtual TLMDChartCTAreaLine3D(System::Classes::TComponent* AMainOwner);
...
__published:
	...
	__property int Indent3D = {read=FIndent3D, write=SetIndent3D, default=5};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDCHARTCTAREALINE3D)
using namespace Lmdchartctarealine3d;
#endif
#pragma pack(pop)
#pragma option pop
