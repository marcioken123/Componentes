...
// (DO NOT EDIT: machine generated header) 'LMDChartCTAreaSpline.pas' rev: 31.00 (Windows)

#ifndef LmdchartctareasplineHPP
#define LmdchartctareasplineHPP
...
namespace Lmdchartctareaspline
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TLMDChartCTAreaSpline;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TLMDChartCTAreaSpline : public Lmdcharttypes::TLMDChartCTAbstract
{
...
public:
	...
	__fastcall virtual ~TLMDChartCTAreaSpline(void);
	...
	__fastcall virtual TLMDChartCTAreaSpline(System::Classes::TComponent* AMainOwner);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDCHARTCTAREASPLINE)
using namespace Lmdchartctareaspline;
#endif
#pragma pack(pop)
#pragma option pop
