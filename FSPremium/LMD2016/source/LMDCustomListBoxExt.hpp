...
// (DO NOT EDIT: machine generated header) 'LMDCustomListBoxExt.pas' rev: 31.00 (Windows)

#ifndef LmdcustomlistboxextHPP
#define LmdcustomlistboxextHPP
...
namespace Lmdcustomlistboxext
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TLMDCustomListBoxExt;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TLMDCustomListBoxExt : public Lmdcustomscrollboxext::TLMDCustomScrollBoxExt
{
...
private:
	...
	Vcl::Graphics::TFont* __fastcall GetFonts(int Index);
	...
	void __fastcall SetGridLines(Lmdlistbox::TLMDLBGridLines aValue);
	void __fastcall SetDelimiter(System::WideChar aValue);
	void __fastcall SetDragMod(System::Uitypes::TDragMode aValue);
	void __fastcall SetFonts(int Index, Vcl::Graphics::TFont* aValue);
	HIDESBASE void __fastcall SetHint(System::UnicodeString aValue);
...
protected:
	Lmdhtmlheadercontrol::TLMDHTMLHeaderControl* FHeader;
	System::WideChar FDelimiter;
	bool FDesc;
	bool FHScroll;
	Lmdlistbox::TLMDLBGridLines FGridLines;
	Lmdhtmlextlistbox::TLMDHTMLExtListBox* FListBox;
	...
	Lmdlistbox::TLMDLBCompareItemEvent FOnCompare;
	int FVirtualWidth;
	...
	Lmdlistbox::TLMDLBGetLineSettingsEvent FOnGetLineSettings;
	...
	void __fastcall UpdateListBoxSize(void);
	...
	HIDESBASE System::Uitypes::TColor __fastcall GetThemedBkColor(void);
	System::Uitypes::TColor __fastcall GetThemedTextColor(void);
	
public:
	__fastcall virtual TLMDCustomListBoxExt(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TLMDCustomListBoxExt(void);
	...
	__property Lmdhtmlheadercontrol::TLMDHTMLHeaderControl* Header = {read=FHeader};
	__property int ItemIndex = {read=GetInteger, write=SetInteger, index=1, nodefault};
	__property Lmdhtmlextlistbox::TLMDHTMLExtListBox* LB = {read=FListBox};
...
__published:
	...
	__property Vcl::Graphics::TFont* Font = {read=GetFonts, write=SetFonts, index=1};
	__property System::Uitypes::TColor GridHorzColor = {read=FGridHorzColor, write=SetColor, index=2, default=12632256};
	__property Lmdlistbox::TLMDLBGridLines GridLines = {read=FGridLines, write=SetGridLines, default=0};
	__property System::Uitypes::TColor GridVertColor = {read=FGridVertColor, write=SetColor, index=3, default=12632256};
	__property Vcl::Graphics::TFont* HeaderFont = {read=GetFonts, write=SetFonts, index=0};
	...
	__property Lmdlistbox::TLMDLBGetLineSettingsEvent OnGetLineSettings = {read=FOnGetLineSettings, write=FOnGetLineSettings};
	...
	__property Lmdlistbox::TLMDLBCompareItemEvent OnSSCompareItem = {read=FOnCompare, write=FOnCompare};
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TLMDCustomListBoxExt(HWND ParentWindow) : Lmdcustomscrollboxext::TLMDCustomScrollBoxExt(ParentWindow) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDCUSTOMLISTBOXEXT)
using namespace Lmdcustomlistboxext;
#endif
#pragma pack(pop)
#pragma option pop
