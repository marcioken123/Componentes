...
// (DO NOT EDIT: machine generated header) 'LMDDBCalculatorComboBox.pas' rev: 31.00 (Windows)

#ifndef LmddbcalculatorcomboboxHPP
#define LmddbcalculatorcomboboxHPP
...
#include <LMDCalculatorComboBox.hpp>
...
namespace Lmddbcalculatorcombobox
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TLMDDBCalculatorComboBox;
class DELPHICLASS TLMDDBLabeledCalculatorComboBox;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TLMDDBCalculatorComboBox : public Lmdcalculatorcombobox::TLMDCalculatorComboBox
{
	typedef Lmdcalculatorcombobox::TLMDCalculatorComboBox inherited;
...
public:
	__fastcall virtual TLMDDBCalculatorComboBox(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TLMDDBCalculatorComboBox(void);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TLMDDBCalculatorComboBox(HWND ParentWindow) : Lmdcalculatorcombobox::TLMDCalculatorComboBox(ParentWindow) { }
...
class PASCALIMPLEMENTATION TLMDDBLabeledCalculatorComboBox : public TLMDDBCalculatorComboBox
{
	typedef TLMDDBCalculatorComboBox inherited;
	
public:
	__fastcall virtual TLMDDBLabeledCalculatorComboBox(System::Classes::TComponent* AOwner);
...
public:
	/* TLMDDBCalculatorComboBox.Destroy */ inline __fastcall virtual ~TLMDDBLabeledCalculatorComboBox(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TLMDDBLabeledCalculatorComboBox(HWND ParentWindow) : TLMDDBCalculatorComboBox(ParentWindow) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDDBCALCULATORCOMBOBOX)
using namespace Lmddbcalculatorcombobox;
#endif
#pragma pack(pop)
#pragma option pop
...
//-- end unit ----------------------------------------------------------------
#endif	// LmddbcalculatorcomboboxHPP
