...
// (DO NOT EDIT: machine generated header) 'LMDDBCalendarComboBox.pas' rev: 31.00 (Windows)

#ifndef LmddbcalendarcomboboxHPP
#define LmddbcalendarcomboboxHPP
...
namespace Lmddbcalendarcombobox
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TLMDDBCalendarComboBox;
class DELPHICLASS TLMDDBLabeledCalendarComboBox;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TLMDDBCalendarComboBox : public Lmdcalendarcombobox::TLMDCalendarComboBox
{
	typedef Lmdcalendarcombobox::TLMDCalendarComboBox inherited;
...
public:
	__fastcall virtual TLMDDBCalendarComboBox(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TLMDDBCalendarComboBox(void);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TLMDDBCalendarComboBox(HWND ParentWindow) : Lmdcalendarcombobox::TLMDCalendarComboBox(ParentWindow) { }
...
class PASCALIMPLEMENTATION TLMDDBLabeledCalendarComboBox : public TLMDDBCalendarComboBox
{
	typedef TLMDDBCalendarComboBox inherited;
	
public:
	__fastcall virtual TLMDDBLabeledCalendarComboBox(System::Classes::TComponent* AOwner);
...
public:
	/* TLMDDBCalendarComboBox.Destroy */ inline __fastcall virtual ~TLMDDBLabeledCalendarComboBox(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TLMDDBLabeledCalendarComboBox(HWND ParentWindow) : TLMDDBCalendarComboBox(ParentWindow) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDDBCALENDARCOMBOBOX)
using namespace Lmddbcalendarcombobox;
#endif
#pragma pack(pop)
#pragma option pop
...
//-- end unit ----------------------------------------------------------------
#endif	// LmddbcalendarcomboboxHPP
