...
// (DO NOT EDIT: machine generated header) 'LMDDBLabel.pas' rev: 31.00 (Windows)

#ifndef LmddblabelHPP
#define LmddblabelHPP
...
namespace Lmddblabel
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TLMDDBLabel;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TLMDDBLabel : public Lmdcustomlabel::TLMDCustomLabel
{
...
public:
	__fastcall virtual TLMDDBLabel(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TLMDDBLabel(void);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDDBLABEL)
using namespace Lmddblabel;
#endif
#pragma pack(pop)
#pragma option pop
