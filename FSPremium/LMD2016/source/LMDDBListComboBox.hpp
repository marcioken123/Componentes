...
// (DO NOT EDIT: machine generated header) 'LMDDBListComboBox.pas' rev: 31.00 (Windows)

#ifndef LmddblistcomboboxHPP
#define LmddblistcomboboxHPP
...
namespace Lmddblistcombobox
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TLMDDBListComboBox;
class DELPHICLASS TLMDDBLabeledListComboBox;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TLMDDBListComboBox : public Lmdlistcombobox::TLMDListComboBox
{
	typedef Lmdlistcombobox::TLMDListComboBox inherited;
...
public:
	__fastcall virtual TLMDDBListComboBox(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TLMDDBListComboBox(void);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TLMDDBListComboBox(HWND ParentWindow) : Lmdlistcombobox::TLMDListComboBox(ParentWindow) { }
...
class PASCALIMPLEMENTATION TLMDDBLabeledListComboBox : public TLMDDBListComboBox
{
	typedef TLMDDBListComboBox inherited;
	
public:
	__fastcall virtual TLMDDBLabeledListComboBox(System::Classes::TComponent* AOwner);
...
public:
	/* TLMDDBListComboBox.Destroy */ inline __fastcall virtual ~TLMDDBLabeledListComboBox(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TLMDDBLabeledListComboBox(HWND ParentWindow) : TLMDDBListComboBox(ParentWindow) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDDBLISTCOMBOBOX)
using namespace Lmddblistcombobox;
#endif
#pragma pack(pop)
#pragma option pop
