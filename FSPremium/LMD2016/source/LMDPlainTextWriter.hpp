...
// (DO NOT EDIT: machine generated header) 'LMDPlainTextWriter.pas' rev: 31.00 (Windows)

#ifndef LmdplaintextwriterHPP
#define LmdplaintextwriterHPP
...
namespace Lmdplaintextwriter
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TLMDPlainTextWriter;
//-- type declarations -------------------------------------------------------
#pragma pack(push,4)
class PASCALIMPLEMENTATION TLMDPlainTextWriter : public Lmdwriter::TLMDWriter
{
...
public:
	/* TLMDWriter.Create */ inline __fastcall virtual TLMDPlainTextWriter(System::Classes::TStream* aStream)/* overload */ : Lmdwriter::TLMDWriter(aStream) { }
	
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TLMDPlainTextWriter(void) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDPLAINTEXTWRITER)
using namespace Lmdplaintextwriter;
#endif
#pragma pack(pop)
#pragma option pop
