...
// (DO NOT EDIT: machine generated header) 'LMDStorINIVault.pas' rev: 31.00 (Windows)

#ifndef LmdstorinivaultHPP
#define LmdstorinivaultHPP
...
namespace Lmdstorinivault
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TIniCrackWriter;
class DELPHICLASS TLMDStorCustomINIVault;
class DELPHICLASS TLMDStorINIVault;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TIniCrackWriter : public System::Classes::TWriter
{
	typedef System::Classes::TWriter inherited;
	
public:
	/* TWriter.Destroy */ inline __fastcall virtual ~TIniCrackWriter(void) { }
	
public:
	/* TFiler.Create */ inline __fastcall TIniCrackWriter(System::Classes::TStream* Stream, int BufSize) : System::Classes::TWriter(Stream, BufSize) { }
	
};


class PASCALIMPLEMENTATION TLMDStorCustomINIVault : public Lmdstorbase::TLMDAbstractStorageVault
{
	typedef Lmdstorbase::TLMDAbstractStorageVault inherited;
	
private:
	System::Inifiles::TMemIniFile* INI;
	System::UnicodeString __fastcall CurrentActiveSection(void);
	void __fastcall LoadComponent(System::UnicodeString Name, System::UnicodeString szObject, TIniCrackWriter* Writer);
	...
	void __fastcall WriteEssence(const System::UnicodeString Section, const System::UnicodeString Ident, const System::UnicodeString szObj, const System::UnicodeString szType, System::Classes::TPersistent* Instance);
	System::Classes::TPersistent* __fastcall ReadEssence(const System::UnicodeString Section, const System::UnicodeString Ident, const System::UnicodeString szObj, System::Classes::TPersistent* Instance);
	void __fastcall SaveObject(System::Classes::TStream* Stream, System::UnicodeString Section, System::UnicodeString szObj, System::UnicodeString szType);
	
protected:
	DYNAMIC System::UnicodeString __fastcall Extension(void);
	
public:
	__fastcall virtual TLMDStorCustomINIVault(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TLMDStorCustomINIVault(void);
	...
	void __fastcall DeleteKeyEx(const System::UnicodeString Section, const System::UnicodeString Ident, const System::UnicodeString szObj, const System::UnicodeString szType);
...
class PASCALIMPLEMENTATION TLMDStorINIVault : public TLMDStorCustomINIVault
{
	typedef TLMDStorCustomINIVault inherited;
	
__published:
	__property BinaryStream = {default=0};
	__property FileName = {default=0};
	__property FilePrefix = {default=3};
...
public:
	/* TLMDStorCustomINIVault.Create */ inline __fastcall virtual TLMDStorINIVault(System::Classes::TComponent* AOwner) : TLMDStorCustomINIVault(AOwner) { }
	/* TLMDStorCustomINIVault.Destroy */ inline __fastcall virtual ~TLMDStorINIVault(void) { }
	
};


//-- var, const, procedure ---------------------------------------------------
static const System::Word MaxINIStringLength = System::Word(0x384);
}	/* namespace Lmdstorinivault */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDSTORINIVAULT)
using namespace Lmdstorinivault;
#endif
#pragma pack(pop)
#pragma option pop
