...
// (DO NOT EDIT: machine generated header) 'dcllmdbar.dpk' rev: 31.00 (Windows)
...
#include <SysInit.hpp>
#include <LMD_RegBar.hpp>
#include <pLMDSectionBarEditorDlg.hpp>
#include <pLMDBarCE.hpp>
#include <pLMDBarSelectIMLDlg.hpp>
#include <pLMDBarPE.hpp>
...
#include <LMDSectionBar.hpp>	// (lmdrtbar)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDBAR)
using namespace Dcllmdbar;
#endif
#pragma pack(pop)
#pragma option pop
