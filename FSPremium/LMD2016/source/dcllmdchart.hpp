...
// (DO NOT EDIT: machine generated header) 'dcllmdchart.dpk' rev: 31.00 (Windows)

#ifndef DcllmdchartHPP
#define DcllmdchartHPP
...
#include <pLMDChartCE.hpp>
#include <pLMDChartSeriesEditor.hpp>
...
namespace Dcllmdchart
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdchart */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDCHART)
using namespace Dcllmdchart;
#endif
#pragma pack(pop)
#pragma option pop
