...
// (DO NOT EDIT: machine generated header) 'dcllmdchartdb.dpk' rev: 31.00 (Windows)

#ifndef DcllmdchartdbHPP
#define DcllmdchartdbHPP
...
namespace Dcllmdchartdb
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdchartdb */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDCHARTDB)
using namespace Dcllmdchartdb;
#endif
#pragma pack(pop)
#pragma option pop
