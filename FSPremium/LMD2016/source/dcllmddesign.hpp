...
// (DO NOT EDIT: machine generated header) 'dcllmddesign.dpk' rev: 31.00 (Windows)

#ifndef DcllmddesignHPP
#define DcllmddesignHPP
...
#include <SysInit.hpp>
#include <LMD_RegDesign.hpp>
#include <pLMDDsgPE.hpp>
...
namespace Dcllmddesign
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmddesign */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDDESIGN)
using namespace Dcllmddesign;
#endif
#pragma pack(pop)
#pragma option pop
