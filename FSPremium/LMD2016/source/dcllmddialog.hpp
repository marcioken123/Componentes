...
// (DO NOT EDIT: machine generated header) 'dcllmddialog.dpk' rev: 31.00 (Windows)

#ifndef DcllmddialogHPP
#define DcllmddialogHPP
...
#include <SysInit.hpp>
#include <JSEditDialogDesignReg.hpp>
#include <JSEditDialogReg.hpp>
#include <JSDialogDesignReg.hpp>
#include <JSDialogReg.hpp>
#include <CustomiseDialog.hpp>
#include <CustomiseEditDialog.hpp>
#include <CADAddIn.hpp>
#include <CADForm.hpp>
#include <JSTemplateEngineImpl.hpp>
...
#include <JSUnicode.hpp>	// (lmdrtdialog)
#include <JSDialogStrs.hpp>	// (lmdrtdialog)
#include <JSDialogs.hpp>	// (lmdrtdialog)
#include <JSGraphics.hpp>	// (lmdrtdialog)
#include <JSDialog.hpp>	// (lmdrtdialog)
...
#include <JSEditEvents.hpp>	// (lmdrtdialog)
#include <JSEditDialogs.hpp>	// (lmdrtdialog)

//-- user supplied -----------------------------------------------------------

namespace Dcllmddialog
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmddialog */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDDIALOG)
using namespace Dcllmddialog;
#endif
#pragma pack(pop)
#pragma option pop
