...
// (DO NOT EDIT: machine generated header) 'dcllmddocking.dpk' rev: 31.00 (Windows)

#ifndef DcllmddockingHPP
#define DcllmddockingHPP
...
#include <SysInit.hpp>
#include <LMD_RegDocking.hpp>
#include <pLMDDckPE.hpp>
...
#include <LMDDckStyles.hpp>	// (lmdrtdocking)
#include <LMDDckStyleElems.hpp>	// (lmdrtdocking)
#include <LMDDckSite.hpp>	// (lmdrtdocking)
#include <VCLEditors.hpp>	// (designide)

//-- user supplied -----------------------------------------------------------

namespace Dcllmddocking
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmddocking */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDDOCKING)
using namespace Dcllmddocking;
#endif
#pragma pack(pop)
#pragma option pop
