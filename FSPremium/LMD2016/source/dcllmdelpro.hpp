...
// (DO NOT EDIT: machine generated header) 'dcllmdelpro.dpk' rev: 31.00 (Windows)

#ifndef DcllmdelproHPP
#define DcllmdelproHPP
...
#include <ElShellCtl.hpp>	// (lmdrtelpro)
...
namespace Dcllmdelpro
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdelpro */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDELPRO)
using namespace Dcllmdelpro;
#endif
#pragma pack(pop)
#pragma option pop
