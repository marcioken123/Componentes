...
// (DO NOT EDIT: machine generated header) 'dcllmdfx.dpk' rev: 31.00 (Windows)
...
#include <SysInit.hpp>
#include <pLMDFxAniDesigner.hpp>
#include <pLMDFxAniListDesigner.hpp>
#include <LMD_RegFx.hpp>
...
#include <LMDFxBitmap.hpp>	// (lmdrtfx)
#include <LMDFxUtils.hpp>	// (lmdrtfx)
#include <LMDFxEffect.hpp>	// (lmdrtfx)
#include <LMDFxGrabClass.hpp>	// (lmdrtfx)
#include <LMDFxGrab.hpp>	// (lmdrtfx)
#include <LMDFxAnimation.hpp>	// (lmdrtfx)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDFX)
using namespace Dcllmdfx;
#endif
#pragma pack(pop)
#pragma option pop
