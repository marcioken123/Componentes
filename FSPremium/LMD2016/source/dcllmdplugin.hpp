...
// (DO NOT EDIT: machine generated header) 'dcllmdplugin.dpk' rev: 31.00 (Windows)

#ifndef DcllmdpluginHPP
#define DcllmdpluginHPP
...
#include <SysInit.hpp>
#include <LMD_RegPlugin.hpp>
#include <pLMDPluginWizard.hpp>
#include <pLMDPluginWizardInfo.hpp>
#include <LMDPluginModuleEditor.hpp>
...
#include <LMDPluginVarType.hpp>	// (lmdrtplugin)
#include <LMDXML.hpp>	// (lmdrtl)

//-- user supplied -----------------------------------------------------------

namespace Dcllmdplugin
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdplugin */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDPLUGIN)
using namespace Dcllmdplugin;
#endif
#pragma pack(pop)
#pragma option pop
