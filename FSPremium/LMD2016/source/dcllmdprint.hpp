...
// (DO NOT EDIT: machine generated header) 'dcllmdprint.dpk' rev: 31.00 (Windows)

#ifndef DcllmdprintHPP
#define DcllmdprintHPP
...
#include <SysInit.hpp>
#include <LMD_RegPrint.hpp>
#include <pLMDPrintPE.hpp>
...
namespace Dcllmdprint
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdprint */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDPRINT)
using namespace Dcllmdprint;
#endif
#pragma pack(pop)
#pragma option pop
