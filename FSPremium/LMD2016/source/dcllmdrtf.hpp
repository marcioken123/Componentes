...
// (DO NOT EDIT: machine generated header) 'dcllmdrtf.dpk' rev: 31.00 (Windows)
...
#include <SysInit.hpp>
#include <LMD_RegRTF.hpp>
#include <pLMDRTFPE.hpp>
#include <pLMDRTFCE.hpp>
#include <pLMDRTFGenerateToolbar.hpp>
#include <pLMDRTFEditor.hpp>
#include <pLMDRTFSyntaxDefEditor.hpp>
#include <pLMDRTFHyperTextEditor.hpp>
#include <pLMDRTFToolbarOptions.hpp>
#include <pLMDRTFRichEditor.hpp>
#include <pLMDRTFActDescr.hpp>
...
#include <LMDRTFFontDialog.hpp>	// (lmdrtrtf)
#include <LMDRTFRichEdit.hpp>	// (lmdrtrtf)
#include <LMDThemes.hpp>	// (lmdrtrtlx)
#include <LMDButtonBase.hpp>	// (lmdrtrtlx)
#include <LMDGraphUtils.hpp>	// (lmdrtrtlx)
#include <LMDRTFLabel.hpp>	// (lmdrtrtf)
#include <Vcl.XPStyleActnCtrls.hpp>	// (vclactnband)
#include <Vcl.StdStyleActnCtrls.hpp>	// (vclactnband)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDRTF)
using namespace Dcllmdrtf;
#endif
#pragma pack(pop)
#pragma option pop
