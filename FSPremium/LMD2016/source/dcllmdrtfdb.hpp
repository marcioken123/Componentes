...
// (DO NOT EDIT: machine generated header) 'dcllmdrtfdb.dpk' rev: 31.00 (Windows)

#ifndef DcllmdrtfdbHPP
#define DcllmdrtfdbHPP
...
#include <pLMDRTFActDescr.hpp>	// (dcllmdrtf)
#include <pLMDRTFRichEditor.hpp>	// (dcllmdrtf)

//-- user supplied -----------------------------------------------------------

namespace Dcllmdrtfdb
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdrtfdb */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDRTFDB)
using namespace Dcllmdrtfdb;
#endif
#pragma pack(pop)
#pragma option pop
