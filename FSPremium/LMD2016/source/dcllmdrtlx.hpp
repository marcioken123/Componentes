...
// (DO NOT EDIT: machine generated header) 'dcllmdrtlx.dpk' rev: 31.00 (Windows)

#ifndef DcllmdrtlxHPP
#define DcllmdrtlxHPP
...
#include <SysInit.hpp>
#include <LMD_RegRtlX.hpp>
#include <pLMDActionsData.hpp>
#include <pLMDActnList.hpp>
#include <pLMDActnListEditor.hpp>
#include <pLMDStdActnList.hpp>
#include <pLMDCEBase.hpp>
#include <pLMDCEX.hpp>
#include <pLMDPeX.hpp>
#include <pLMDPeCst.hpp>
#include <pLMDDsgnCPGetX.hpp>
#include <pLMDWizardsX.hpp>
#include <pLMDHTMLEditDlg.hpp>
#include <pLMDTaskDialogEditor.hpp>
#include <pLMDStdListEditorDlg.hpp>
#include <pLMDStdItemPropertiesEditorDlg.hpp>
#include <pLMDExtImageListEditorDlg.hpp>
#include <pLMDCustomImageListSelectDlg.hpp>
#include <pLMDPicturePropertyEditor.hpp>
...
#include <LMDTaskDialog.hpp>	// (lmdrtrtlx)
#include <LMDCont.hpp>	// (lmdrtrtlx)
#include <LMDCabSupport.hpp>	// (lmdrtrtlx)
#include <LMDFormVista.hpp>	// (lmdrtrtlx)
#include <LMDFormPersistent.hpp>	// (lmdrtrtlx)
#include <LMDActnList.hpp>	// (lmdrtrtlx)
#include <LMDStdActns.hpp>	// (lmdrtrtlx)
...
namespace Dcllmdrtlx
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdrtlx */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDRTLX)
using namespace Dcllmdrtlx;
#endif
#pragma pack(pop)
#pragma option pop
