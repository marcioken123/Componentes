...
// (DO NOT EDIT: machine generated header) 'dcllmdscript.dpk' rev: 31.00 (Windows)

#ifndef DcllmdscriptHPP
#define DcllmdscriptHPP
...
#include <LMDSctImporterParser.hpp>	// (lmdrtscriptimp)
#include <LMDSctImporterCompiler.hpp>	// (lmdrtscriptimp)
...
namespace Dcllmdscript
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdscript */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDSCRIPT)
using namespace Dcllmdscript;
#endif
#pragma pack(pop)
#pragma option pop
