...
// (DO NOT EDIT: machine generated header) 'dcllmdsearch.dpk' rev: 31.00 (Windows)

#ifndef DcllmdsearchHPP
#define DcllmdsearchHPP
...
#include <SysInit.hpp>
#include <LMD_RegSearch.hpp>
#include <pLMDSearchPE.hpp>
...
namespace Dcllmdsearch
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdsearch */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDSEARCH)
using namespace Dcllmdsearch;
#endif
#pragma pack(pop)
#pragma option pop
