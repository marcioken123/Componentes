...
// (DO NOT EDIT: machine generated header) 'dcllmdshell.dpk' rev: 31.00 (Windows)

#ifndef DcllmdshellHPP
#define DcllmdshellHPP
...
#include <SysInit.hpp>
#include <LMD_RegShell.hpp>
#include <pLMDShRootEdit.hpp>
...
#include <LMDShMisc.hpp>	// (lmdrtshell)
#include <LMDShPIDL.hpp>	// (lmdrtshell)
#include <LMDShDragDrop.hpp>	// (lmdrtshell)
#include <LMDShNtf.hpp>	// (lmdrtshell)
#include <LMDShController.hpp>	// (lmdrtshell)
...
#include <LMDShList.hpp>	// (lmdrtshell)
#include <LMDShTree.hpp>	// (lmdrtshell)
#include <LMDShDlg.hpp>	// (lmdrtshell)
...
namespace Dcllmdshell
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdshell */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDSHELL)
using namespace Dcllmdshell;
#endif
#pragma pack(pop)
#pragma option pop
