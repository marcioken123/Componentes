...
// (DO NOT EDIT: machine generated header) 'dcllmdstorage.dpk' rev: 31.00 (Windows)

#ifndef DcllmdstorageHPP
#define DcllmdstorageHPP
...
#include <SysInit.hpp>
#include <LMD_RegStorage.hpp>
#include <pLMDStorPE.hpp>
...
#include <LMDStorCommon.hpp>	// (lmdrtstorage)
#include <LMDStorPropertiesStorage.hpp>	// (lmdrtstorage)
...
namespace Dcllmdstorage
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdstorage */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDSTORAGE)
using namespace Dcllmdstorage;
#endif
#pragma pack(pop)
#pragma option pop
