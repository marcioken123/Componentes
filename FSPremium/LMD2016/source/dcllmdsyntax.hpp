...
// (DO NOT EDIT: machine generated header) 'dcllmdsyntax.dpk' rev: 31.00 (Windows)

#ifndef DcllmdsyntaxHPP
#define DcllmdsyntaxHPP
...
#include <SysInit.hpp>
#include <LMD_RegSyntax.hpp>
#include <pLMDSedPE.hpp>
...
#include <LMDUnicodeEncodings.hpp>	// (lmdrtl)
#include <LMDSedUtils.hpp>	// (lmdrtsyntax)
#include <LMDRegExpr.hpp>	// (lmdrtl)
#include <LMDXML.hpp>	// (lmdrtl)
#include <LMDSedParser.hpp>	// (lmdrtsyntax)
...
#include <LMDSedView.hpp>	// (lmdrtsyntax)
#include <LMDSedColorSchemeDialog.hpp>	// (lmdrtsyntax)
...
namespace Dcllmdsyntax
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dcllmdsyntax */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDSYNTAX)
using namespace Dcllmdsyntax;
#endif
#pragma pack(pop)
#pragma option pop
