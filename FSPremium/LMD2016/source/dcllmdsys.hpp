...
// (DO NOT EDIT: machine generated header) 'dcllmdsys.dpk' rev: 31.00 (Windows)
...
#include <SysInit.hpp>
#include <LMD_RegSys.hpp>
#include <pLMDSys_PE.hpp>
#include <pLMDSys_CE.hpp>
#include <pLMDSysCheckListDlg.hpp>
#include <pLMDSysViewDlg.hpp>
#include <pLMDSysNetEnumDlg.hpp>
...
#include <pLMDConfigDlg.hpp>	// (dcllmdrtl)
#include <pLMDComAboutDlg.hpp>	// (dcllmdrtl)
#include <LMDSysBase.hpp>	// (lmdrtsys)
#include <LMDSysPowerStatusObject.hpp>	// (lmdrtsys)
#include <LMDSysLocaleObject.hpp>	// (lmdrtsys)
#include <LMDSysTimeZoneObject.hpp>	// (lmdrtsys)
#include <LMDSysMemoryObject.hpp>	// (lmdrtsys)
#include <LMDSysMouseObject.hpp>	// (lmdrtsys)
#include <LMDSysKeyboardObject.hpp>	// (lmdrtsys)
#include <LMDSysInfoProcs.hpp>	// (lmdrtsys)
#include <LMDSysWindowsObject.hpp>	// (lmdrtsys)
#include <LMDSysScreenSaverObject.hpp>	// (lmdrtsys)
#include <LMDSysProcessorObject.hpp>	// (lmdrtsys)
#include <LMDSysPrinterInfo.hpp>	// (lmdrtsys)
#include <LMDSysInternetObject.hpp>	// (lmdrtsys)
#include <LMDSysModemInfo.hpp>	// (lmdrtsys)
#include <LMDButtonBase.hpp>	// (lmdrtrtlx)
#include <LMDGraphUtils.hpp>	// (lmdrtrtlx)
#include <LMDThemes.hpp>	// (lmdrtrtlx)
#include <LMDSysEventLog.hpp>	// (lmdrtsys)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDSYS)
using namespace Dcllmdsys;
#endif
#pragma pack(pop)
#pragma option pop
