...
// (DO NOT EDIT: machine generated header) 'dcllmdtxt.dpk' rev: 31.00 (Windows)
...
#include <SysInit.hpp>
#include <LMD_RegText.hpp>
#include <LMD_RegTextDB.hpp>
#include <pLMDText_PE.hpp>
#include <pLMDHTMLEditorDlg.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLLMDTXT)
using namespace Dcllmdtxt;
#endif
#pragma pack(pop)
#pragma option pop
