...
uses
  Windows, Messages, Controls, Forms, SysUtils, StdCtrls, Classes, Types,
  ElTreeInplaceEditors, ElStrArray, ElXTree, ElHeader, ElStrUtils,
  ElVCLUtils, {$ifdef LMD_UNICODE} LMDUnicodeStrings, {$endif}
  ElTreeBtnEdit;
