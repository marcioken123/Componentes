...
// (DO NOT EDIT: machine generated header) 'frmTbrStp.pas' rev: 31.00 (Windows)
...
public:
	void __fastcall LoadToolbarControls(Eltoolbar::TCustomElToolBar* Toolbar);
	void __fastcall SaveToolbarControls(Eltoolbar::TCustomElToolBar* Toolbar);
public:
