...
// (DO NOT EDIT: machine generated header) 'lmdrtbar.dpk' rev: 31.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDRTBAR)
using namespace Lmdrtbar;
#endif
#pragma pack(pop)
#pragma option pop
