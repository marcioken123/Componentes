...
// (DO NOT EDIT: machine generated header) 'lmdrtchartdb.dpk' rev: 31.00 (Windows)

#ifndef LmdrtchartdbHPP
#define LmdrtchartdbHPP
...
namespace Lmdrtchartdb
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Lmdrtchartdb */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDRTCHARTDB)
using namespace Lmdrtchartdb;
#endif
#pragma pack(pop)
#pragma option pop
