...
// (DO NOT EDIT: machine generated header) 'lmdrtfx.dpk' rev: 31.00 (Windows)
...
#include <SysInit.hpp>
#include <LMDFxAniDesignerForm.hpp>
#include <LMDFxAnimation.hpp>
#include <LMDFxBase.hpp>
#include <LMDFxBitmap.hpp>
#include <LMDFxConsts.hpp>
#include <LMDFxEffect.hpp>
#include <LMDFxForm.hpp>
#include <LMDFxGrab.hpp>
#include <LMDFxGrabClass.hpp>
#include <LMDFxImage.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDRTFX)
using namespace Lmdrtfx;
#endif
#pragma pack(pop)
#pragma option pop
