...
// (DO NOT EDIT: machine generated header) 'lmdrtrtfdb.dpk' rev: 31.00 (Windows)

#ifndef LmdrtrtfdbHPP
#define LmdrtrtfdbHPP
...
#include <SysInit.hpp>
#include <LMDRTFDBSyntaxEdit.hpp>
#include <LMDRTFDBRichEdit.hpp>
#include <LMDRTFDBLabel.hpp>
...
namespace Lmdrtrtfdb
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Lmdrtrtfdb */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDRTRTFDB)
using namespace Lmdrtrtfdb;
#endif
#pragma pack(pop)
#pragma option pop
