...
// (DO NOT EDIT: machine generated header) 'lmdrtscriptimp.dpk' rev: 31.00 (Windows)

#ifndef LmdrtscriptimpHPP
#define LmdrtscriptimpHPP
...
#include <LMDSctImporterCompiler.hpp>
...
namespace Lmdrtscriptimp
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Lmdrtscriptimp */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDRTSCRIPTIMP)
using namespace Lmdrtscriptimp;
#endif
#pragma pack(pop)
#pragma option pop
