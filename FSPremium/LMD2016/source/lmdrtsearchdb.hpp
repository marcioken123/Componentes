...
// (DO NOT EDIT: machine generated header) 'lmdrtsearchdb.dpk' rev: 31.00 (Windows)

#ifndef LmdrtsearchdbHPP
#define LmdrtsearchdbHPP
...
namespace Lmdrtsearchdb
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Lmdrtsearchdb */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LMDRTSEARCHDB)
using namespace Lmdrtsearchdb;
#endif
#pragma pack(pop)
#pragma option pop
