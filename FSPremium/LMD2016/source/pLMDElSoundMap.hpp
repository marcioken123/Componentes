...
// (DO NOT EDIT: machine generated header) 'pLMDElSoundMap.pas' rev: 31.00 (Windows)

#ifndef PlmdelsoundmapHPP
#define PlmdelsoundmapHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_PLMDELSOUNDMAP)
using namespace Plmdelsoundmap;
#endif
#pragma pack(pop)
#pragma option pop
