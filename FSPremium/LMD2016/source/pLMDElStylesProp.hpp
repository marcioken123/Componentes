...
// (DO NOT EDIT: machine generated header) 'pLMDElStylesProp.pas' rev: 31.00 (Windows)

#ifndef PlmdelstylespropHPP
#define PlmdelstylespropHPP
...
class PASCALIMPLEMENTATION TStylesPropDlg : public Vcl::Forms::TForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TStylesPropDlg(System::Classes::TComponent* AOwner) : Vcl::Forms::TForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TStylesPropDlg(System::Classes::TComponent* AOwner, int Dummy) : Vcl::Forms::TForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TStylesPropDlg(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TStylesPropDlg(HWND ParentWindow) : Vcl::Forms::TForm(ParentWindow) { }
	
};


//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE TStylesPropDlg* StylesPropDlg;
}	/* namespace Plmdelstylesprop */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_PLMDELSTYLESPROP)
using namespace Plmdelstylesprop;
#endif
#pragma pack(pop)
#pragma option pop
