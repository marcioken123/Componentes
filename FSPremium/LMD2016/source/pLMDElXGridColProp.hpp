...
// (DO NOT EDIT: machine generated header) 'pLMDElXGridColProp.pas' rev: 31.00 (Windows)

#ifndef PlmdelxgridcolpropHPP
#define PlmdelxgridcolpropHPP
...
namespace Plmdelxgridcolprop
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TElXColumnsDefsProperty;
class DELPHICLASS TXColumnDefs;
//-- type declarations -------------------------------------------------------
#pragma pack(push,4)
class PASCALIMPLEMENTATION TElXColumnsDefsProperty : public Designeditors::TClassProperty
{
...
public:
	/* TPropertyEditor.Create */ inline __fastcall virtual TElXColumnsDefsProperty(const Designintf::_di_IDesigner ADesigner, int APropCount) : Designeditors::TClassProperty(ADesigner, APropCount) { }
	/* TPropertyEditor.Destroy */ inline __fastcall virtual ~TElXColumnsDefsProperty(void) { }
	
};

#pragma pack(pop)

class PASCALIMPLEMENTATION TXColumnDefs : public Vcl::Forms::TForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TXColumnDefs(System::Classes::TComponent* AOwner) : Vcl::Forms::TForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TXColumnDefs(System::Classes::TComponent* AOwner, int Dummy) : Vcl::Forms::TForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TXColumnDefs(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TXColumnDefs(HWND ParentWindow) : Vcl::Forms::TForm(ParentWindow) { }
	
};


//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE TXColumnDefs* ColumnDefs;
}	/* namespace Plmdelxgridcolprop */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_PLMDELXGRIDCOLPROP)
using namespace Plmdelxgridcolprop;
#endif
#pragma pack(pop)
#pragma option pop
