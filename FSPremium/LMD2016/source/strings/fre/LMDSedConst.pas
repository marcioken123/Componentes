...
resourcestring
  //Utils
  SLMDBadSegment = 'mauvais segment passé à la fonction';
  
  //Parser
  SLMDSedIntAttirbuteRequired = 'Attribut Int %s requis';
  SLMDSedIntAttrRangeRequired = 'Attribut Int %s doit être dans la plage (%d given instead): [%d, %d]';
  SLMDSedBadIntAttribute = 'Malformed int attribute %s';
  SLMDSedBoolAttributeRequired = 'Attribut Booléen %s requis';
  ...
  SLMDSedStartGroupUsedBadIndex = 'startGroupUsed doit être >=0  et < (regex groups count: %d)';

  SLMDSedEndGroupUsedBadIndex = 'endGroupUsed doit être >=0  et < (regex groups count: %d)';
  ...
  SLMDSedErrorLoadingSyntaxScheme = 'Erreur %s au chargement de la définitions de syntaxes. Message original: %s';
  SLMDSedDocumentShouldHaveSchemeList = 'Le document doit avoir un élément SchemeList!';
  SLMDSedSchemeListShouldNameRoot = 'L''élément SchemeList du document doit avoir un attribut ''root'' non vide!';
  ...
  SLMDSedDocDisposedMarkersUsed = 'La collection de marqueurs a été supprimé pour ce document. Impossible à utiliser.';
  SLMDSedDocCantRemoveInvalidMarker = 'Impossible de supprimer le marqueur avec Valid=false';
  SLMDSedDocInvalidCharIndex = 'Index de caractère non valide: %d. Plage valide: [%d, %d].';
  SLMDSedDocInvalidCharInsIndex = 'Index de caractère non valide pour insertion: %d. Plage valide: [%d, %d].';
  SLMDSedDocInvalidSegment = 'Segment non valide passé à la méthode';
  SLMDSedDocSyntaxSchemeNotFound = 'Définition de syntaxes introuvable avec le nom: ';
  SLMDSedDocColorSchemeNotFound = 'Définition de couleurs introuvable avec le nom: ';
  SLMDSedInvalidSchemeName = 'Scheme collection item name should be nonempty and unique';
  SLMDSedInvalidRangeOrder = 'Le début de la plage doit être inférieur ou égal à la fin: plage: [%d, %d]';
  SLMDSedDocMethodInUpdatingState = 'This method is prohibited while document in compound edit';
  SLMDSedDocChangesLocked = 'Le document est verrouillé pour les changements';
  SLMDSedDocMarkersLocked = 'Les marqueurs du document sont verrouillés pour les changements';
  ...
  SLMDSedDocInvalidOffsetToSearch = 'Offset non valide donné pour recherche: %d. Plage valide: [%d, %d]';
  SLMDSedDocInvalidOffset = 'Offset non valide donné au docuement: %d. Plage valide: [%d, %d]';
  ...
  SLMDSedViewFixedFontRequired = 'Seules les polices à largeur fixe sont acceptées par Syntax Edit';
  SLMDSedViewDocNotSet = 'Le document doit être attaché à une vue pour cette opération';
  SLMDSedViewChangesLocked = 'La vue est verrouillée pour les changements';
  SLMDSedViewGutterBarInvalid = 'La gouttière est invisible ou n''appartient pas à cette vue';
  ...
  SLMDSedDlgContinueSearchFromStart = 'Fin du document. Continuer recherche/remplacement au début?';
  SLMDSedDlgContinueSearchFromEnd = 'Début du document. Continuer recherche/remplacement à la fin?';

  SLMDSedLoadSyntaxSchemes = 'Charger Définitions de syntaxes depuis dossier...';
  SLMDSedLoadColorSchemes = 'Charger Définitions de couleurs depuis dossier...';
