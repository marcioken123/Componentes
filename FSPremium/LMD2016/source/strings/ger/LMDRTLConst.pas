...
resourcestring
  ...
  IDS_REGISTEREDOWNER='Registrierter Eigentìmer';
  IDS_REGISTEREDCOMPANY='Registrierte Firma';
  IDS_VERSION='Version';
  IDS_COLORDEPTH='Farbtiefe (in Bit)';
  IDS_SCREENSAVERDELAY='Screensaver Verzægerung';
  IDS_MEMORYSIZE='GræŸe des Hauptspeichers';
  ...
  IDS_MEMORYFREE='Verfìgbarer Hauptspeicher';
  IDS_MEMORYFREEPAGES='Freie Speicherseiten';
  IDS_MEMORYTOTALPAGES='Insg. verfìgbare Speicherseiten';
  IDS_MEMORYVIRTUALFREE='Freier virtueller Speicher';
  IDS_MEMORYVIRTUALTOTAL='Insg. verfìgbarer virtueller Speicher';
