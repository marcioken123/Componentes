...
resourcestring
  ...
  SLMDSedDlgReplaceConfirm = 'Replace this occurence of %s?';
  ...
  SLMDSedLoadSyntaxSchemes = 'Load syntax schemes from dir...';
  SLMDSedLoadColorSchemes = 'Load color schemes from dir...';
