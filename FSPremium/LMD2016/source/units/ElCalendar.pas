...
var
  ...
  // Если не вызвать Invalidate, то при перемещении нажатой мыши будет оставаться след.
  // Думаю это следствие того , чтот прорисовка определена не через переопреджеление
