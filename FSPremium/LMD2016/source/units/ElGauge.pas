...
uses
  SysUtils, Classes, Messages, Windows, Graphics, Controls, Forms,
  Types, LMDProcs,
  ElImgFrm, ElCGControl;
...
type
  ...
  published
    ...
    property CriticalValue : Integer read FCriticalValue write SetCriticalValue default 0;
    property CriticalColor : TColor read FCriticalColor write SetCriticalColor default clBtnText;
    ...
    property GaugeKind : TElGaugeKind read FGaugeKind write SetGaugeKind default egkNeedle;
...
begin
  ...
  begin
    ...
    begin
      ...
      Brush.Style := bsClear;
      TR := ClientRect;
      DrawText(Handle, PChar(Text), -1, TR, DT_VCENTER or DT_CENTER or DT_CALCRECT);
      LMDCenterRects((TR.Right - TR.Left), (R.Right - R.Left), (TR.Bottom - TR.Top), (R.Bottom - R.Top), R);
      DrawText(Handle, PChar(Text), -1, R, DT_CENTER);
      end;
  end; // with
...
begin
  ...
  FPoints := 11;
  FCriticalValue := 0;
  FCriticalColor := clBtnText;
  FGaugeKind := egkNeedle;
