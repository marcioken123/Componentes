...
uses
  Types, Windows, Messages, Graphics, Controls,
  Forms, ExtCtrls, Classes, SysUtils, LMDProcs,
  ElImgFrm,  ElVCLUtils, ElCGControl;
...
type
  ...
  TElHistogram = class (TElCustomGraphicControl)
  private
  ...
  published
    ...
    property DoubleMode: THistoDoubleMode read FDoubleMode write SetDoubleMode default hdmCumulative;
    ...
    property ShowZeroValues: Boolean read FShowZeroValues write
        SetShowZeroValues default False;
    property Smooth: Boolean read FSmooth write SetSmooth default false;
    property Transparent: Boolean read GetTransparent write SetTransparent default False;
    property UseBuffer2: Boolean read FUseBuffer2 write SetUseBuffer2 default False;
...
begin
  if (FBufSize <> newValue) and LMDInRange(newValue, 1, HISTOBUFFERSIZE) then
  begin
...
begin
  ...
  FDoubleMode := hdmCumulative;
  FShowZeroValues := False;
  Transparent := False;
  FUseBuffer2 := False;
