...
{$warnings on}
  ...
  private
    ...
    FSectionHotImages : TCustomImageList;
    FSectionDisabledImages : TCustomImageList;
    FItemDisabledImages : TCustomImageList;
    FItemImages: TCustomImageList;
    FItemHotImages : TCustomImageList;

    FAlphaSectionImages : TCustomImageList;
    FAlphaSectionHotImages : TCustomImageList;
    FAlphaSectionDisabledImages : TCustomImageList;
    FAlphaItemDisabledImages : TCustomImageList;
    FAlphaItemImages: TCustomImageList;
    FAlphaItemHotImages : TCustomImageList;
...
{    FScrollPos,
    ...
    procedure SetSectionImages(newValue : TCustomImageList);
    procedure SetSectionHotImages(newValue : TCustomImageList);
    procedure SetSectionDisabledImages(newValue : TCustomImageList);
    procedure SetItemDisabledImages(newValue : TCustomImageList);
    procedure SetItemImages(newValue : TCustomImageList);
    procedure SetItemHotImages(newValue : TCustomImageList);
    procedure SetAlphaSectionImages(newValue : TCustomImageList);
    procedure SetAlphaSectionHotImages(newValue : TCustomImageList);
    procedure SetAlphaSectionDisabledImages(newValue : TCustomImageList);
    procedure SetAlphaItemDisabledImages(newValue : TCustomImageList);
    procedure SetAlphaItemImages(newValue : TCustomImageList);
    procedure SetAlphaItemHotImages(newValue : TCustomImageList);
  ...
  published
    ...
    property SectionHotImages : TCustomImageList read FSectionHotImages write SetSectionHotImages;
    property SectionDisabledImages : TCustomImageList read FSectionDisabledImages write SetSectionDisabledImages;

    property ItemDisabledImages : TCustomImageList read FItemDisabledImages write SetItemDisabledImages;
    property ItemImages : TCustomImageList read FItemImages write SetItemImages;
    property ItemHotImages : TCustomImageList read FItemHotImages write SetItemHotImages;
    property AlphaForSectionImages : TCustomImageList read FAlphaSectionImages write SetAlphaSectionImages;
    property AlphaForSectionHotImages : TCustomImageList read FAlphaSectionHotImages write SetAlphaSectionHotImages;
    property AlphaForSectionDisabledImages : TCustomImageList read FAlphaSectionDisabledImages write SetAlphaSectionDisabledImages;
    property AlphaForItemDisabledImages : TCustomImageList read FAlphaItemDisabledImages write SetAlphaItemDisabledImages;
    property AlphaForItemImages : TCustomImageList read FAlphaItemImages write SetAlphaItemImages;
    property AlphaForItemHotImages : TCustomImageList read FAlphaItemHotImages write SetAlphaItemHotImages;
...
procedure TElSideBarContainerPanel.WMEraseBkGnd(var Msg: TWMEraseBkGnd);
begin
  Msg.Result := 1;
end;
...
procedure TElSideBarCItem.SetCaption(newValue: TLMDString);
...
begin
  if LMDInRange(newValue, 0, Sections.Count - 1) then
  begin
...
var i,
    ...
    var IL : TCustomImageList;
        ...
        : integer;
        sid: integer;
        AIL : TCustomImageList;
          amBMP, BMP: TBitmap;
        P2 : TPoint;
        LDetails: TThemedToolBar;
    ...
    begin
      ...
      begin
        LDetails2.Element := teToolBar;
        LDetails2.Part := 0;
        LDetails2.State := 0;
        LMDThemeServices.DrawElement(LUseThemeMode, TmpCanvas.Handle, LDetails2, Section.FBoundRect, nil);
        // DrawThemeBackground(Theme, TmpCanvas.Handle, 0, 0, Section.FBoundRect, nil);
        if not Section.Enabled then
          // sid := TS_DISABLED
          LDetails := ttbButtonDisabled
        else
        if FDownSection = Section then
          // sid := TS_PRESSED
          LDetails := ttbButtonPressed
        else
        if Section = FTrackSection then
          // sid := TS_HOT
          LDetails := ttbButtonHot
        else
        if FlatSections then
          // sid := TS_NORMAL
          LDetails := ttbButtonNormal
        else
          // sid := TS_HOT
          LDetails := ttbButtonHot;

        LMDThemeServices.DrawElement(LUseThemeMode, TmpCanvas.Handle, LDetails, Section.FBoundRect, nil);
        // DrawThemeBackground(Theme, TmpCanvas.Handle, TP_BUTTON, sid, Section.FBoundRect, nil);
        R := LMDThemeServices.ContentRect(LUseThemeMode, TmpCanvas.Handle, ThemeServices.GetElementDetails(LDetails), Section.FBoundRect);
      ...
      begin
        ...
        begin
          ...
          LDetails2.Element := teToolBar;
          LDetails2.Part := TP_BUTTON;
          LDetails2.State := sid;
          LMDThemeServices.GetThemeTextExtent(LUseThemeMode, TmpCanvas.Handle, LDetails2, Section.Caption, Length(Section.Caption), Flags, LMDRectToPtr(R), Section.FTextRect);
          ...
          LMDThemeServices.DrawThemeText(LUseThemeMode, TmpCanvas.Handle, LDetails2, Section.Caption, Length(Section.Caption),  Flags, Flags2, R);
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              Brush.Style := bsClear;
              LMDDrawText(Handle, Section.Caption, Length(Section.Caption), R, Flags);
              OffsetRect(R, -1, -1);
    ...
    begin
      ...
      begin
        ...
        LDetails.Part := TP_BUTTON;
        LDetails.State := sid;
        LMDThemeServices.GetThemeTextExtent(LUseThemeMode, TmpCanvas.Handle, LDetails, Item.Caption, Length(Item.Caption), Flags, LMDRectToPtr(Rtmp), Rect);
      ...
      begin
        ...
        if RightAlignedBar then
          Flags := Flags + DT_RTLREADING;
        SetRectEmpty(Rect);
        LMDDrawText(TmpCanvas.Handle, Item.Caption, -1, Rect, DT_CALCRECT or Flags);
        Result.cy := Rect.Bottom - Rect.Top;
        Result.cx := Rect.Right - Rect.Left;
      end;
    end;
    ...
    var BtnRect,
      ...
      begin
        ...
        LDetails.Part := 0;
        LDetails.State := 0;
        LMDThemeServices.DrawElement(LUseThemeMode, TmpCanvas.Handle, LDetails, Item.FBoundRect, nil);
        ...
        BtnRect := LMDThemeServices.ContentRect(LUseThemeMode, TmpCanvas.Handle, LDetails, Item.FBoundRect);
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              LMDCenterRects(IL.Width, BtnRect.Right - BtnRect.Left, IL.Height, BtnRect.Bottom - BtnRect.Top - i, ImRect)
            end
            else
            begin
            ...
            LMDCenterRects(IL.Width, BtnRect.Right - BtnRect.Left, IL.Height, BtnRect.Bottom - BtnRect.Top, ImRect);
          ...
          begin
            ...
            begin
              ...
              IL.Draw(TmpCanvas, ImRect.Left, ImRect.Top, Item.ImageIndex, b);
            end;
        end;
      end;
      if (FIconLocation = ilTop) then
      ...
      begin
        ...
        begin
          ...
          LDetails.Part := TP_BUTTON;
          LDetails.State := sid;
          LMDThemeServices.GetThemeTextExtent(LUseThemeMode, TmpCanvas.Handle, LDetails, Item.Caption, Length(Item.Caption), Flags, LMDRectToPtr(ImRect), R1);
          ...
          LMDThemeServices.DrawThemeText(LUseThemeMode, TmpCanvas.Handle, LDetails, Item.Caption, Length(Item.Caption), Flags, Flags2, ImRect);
        ...
        begin
          ...
          if RightAlignedBar then
            Flags := Flags + DT_RTLREADING;
          LMDDrawText(TmpCanvas.Handle, Item.Caption, -1, R1, DT_CALCRECT or Flags);
          if (FIconLocation = ilTop) then
          begin
            ImRect.Left :=  (ImRect.Right - (R1.Right - R1.Left)) div 2;
            ImRect.Right := ImRect.Left + (R1.Right - R1.Left);
          ...
          begin
            ...
            TmpCanvas.Brush.Style := bsClear;
            LMDDrawText(TmpCanvas.Handle, Item.Caption, Length(Item.Caption), ImRect, Flags);
            Item.FTextRect := ImRect;
          end
          else
          begin
    ...
    begin
      case BackgroundType of //
        ...
        bgtBottomRightGradient, bgtTopLeftDiagonalGradient, bgtTopRightDiagonalGradient:
          begin
            LMDGradientPaint(TmpCanvas, Rect1, GradientStartColor, GradientEndColor, GradientSteps, LMDBackgroundType2GradientStyle[BackgroundType], 0, 0);
            end;
        bgtStretchBitmap,
        bgtTileBitmap:
          begin
        ...
        bgtCenterBitmap :
          begin
            ...
            LMDCenterRects(FBackground.Width, Rect1.Right - Rect1.Left, FBackground.Height, Rect1.Bottom - Rect1.Top, R1);
        ...
        bgtTopLeftBitmap:
          begin
            ...
            begin
              ...
              R1 := GetItemsRect;
              OffsetRect(R1, -Rect1.Left, -Rect1.Top);
              LMDExtDrawBkgnd2(TmpCanvas.Handle, GetItemsRect, Rect1, R1.TopLeft, Color, Background, BackgroundType);
              end;
          end;
      end; // case
    end;
...
//              sid := TS_PRESSED
              LDetail := ttbButtonPressed
            else
              LDetail := ttbButtonHot;
//              sid := TS_HOT;

            LMDThemeServices.DrawElement(LUseThemeMode, TmpCanvas.Handle, LDetail, Rect1, nil);
          ...
          LMDDrawArrow(TmpCanvas, eadUp, Rect1, ArrowColor, true);
        end;
        if FVisDownBtn then
        begin
          if RightAlignedBar then
          ...
          LMDDrawArrow(TmpCanvas, eadDown, Rect1, BtnColor, true);
        end;
      end;
      end;
  ...
  begin
    ...
    begin
      ...
      begin
        if LUseThemeMode <> ttmNone then
        begin
          TmpCanvas.Brush.Color := LMDThemeServices.GetThemeSysColor(LUseThemeMode, teToolBar, TMT_BTNSHADOW);
          ...
          LDetails.Part := 0;
          LDetails.State := 0;
          LMDThemeServices.DrawElement(LUseThemeMode, TmpCanvas.Handle, LDetails, R1, LMDRectToPtr(R2));
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        LDetails.Part := 0;
        LDetails.State := 0;
        LMDThemeServices.DrawElement(LUseThemeMode, TmpCanvas.Handle, LDetails, R2, LMDRectToPtr(R1));
    ...
    if (LUseThemeMode = ttmNone) and (BackgroundType <> bgtColorFill) then
...
procedure TElSideBar.SetSectionImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetAlphaSectionImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetSectionHotImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetAlphaSectionHotImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetSectionDisabledImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetAlphaSectionDisabledImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetItemDisabledImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetAlphaItemDisabledImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetItemHotImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetAlphaItemHotImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetItemImages(newValue : TCustomImageList);
begin
...
procedure TElSideBar.SetAlphaItemImages(newValue : TCustomImageList);
begin
...
begin
  inherited;
  FMouseOver := true;
  if Flat and (not IsThemed) then UpdateFrame;
end;  { CMMouseEnter }
...
begin
  ...
  begin
    ...
    if Flat {and (not Focused)} and (not IsThemed) then UpdateFrame;
  end;
end;  { CMMouseLeave }
...
procedure TElSideBar.WMNCPaint(var Msg : TWMNCPaint);  { private }
begin
  if not (Flat or IsThemed) then
  begin
    inherited;
    exit;
  end;
...
begin
  ...
  if (FSection <> nil) and FSection.ContainsControls then
     UpdateChildControl;
  if HandleAllocated and (abs(Msg.Height - FOldHeight) > 20) then
    Paint;
  FOldHeight := Height;
  if Assigned(FSection) and Assigned(FTopItem) and (FTopItem.Index > 0) then
  begin
    while (FTopItem.Index > 0) and (((FSection.Items.Count - FTopItem.Index + 2) * (ItemSize + Spacing)) <= FSection.FPanel.Height) do
      FTopItem := FSection.Items[FTopItem.Index - 1];
  end;
  if Assigned(FSection) and Assigned(FTopItem) and (ItemIndex > -1) and not LMDInRange(ItemIndex, FTopItem.Index, FSection.VisItemCount - 1) then
  begin
    if ItemIndex < FTopItem.Index then
      FTopItem := FSection.Items[ItemIndex]
    else
      FTopItem := FSection.Items[max(0, ItemIndex - FSection.VisItemCount + FTopItem.Index + 1)];
  end;
  if Flat then
    UpdateFrame;
end;  { WMSize }
...
procedure TElSideBar.WMGetMinMaxInfo(var Msg : TWMGetMinMaxInfo);  { private }

begin
  inherited;

  Msg.MinMaxInfo.ptMinTrackSize.Y := GetMinHeight;
...
procedure TElSideBar.CMHintShow(var Msg: TCMHintShow);
...
begin
  if (((Key = VK_TAB) and (Shift = [ssCtrl])) or (Key = VK_NEXT)) and (FSections.Count > 1) then
    if SectionIndex = FSections.Count - 1 then
      SectionIndex := 0
    else
      SectionIndex := SectionIndex + 1
  else
  if (((Key = VK_TAB) and (Shift = [ssCtrl, ssShift])) or (Key = VK_PRIOR)) and (FSections.Count > 1) then
      ...
      if ItemIndex = 0 then
        ...
        if (FChangeDelay = 0) and (not (csLoading in ComponentState)) then
          ...
          begin
            ...
            begin
              if FSections[SectionIndex].Items.Count > 0 then
              begin
                if ItemIndex = -1 then
                  ItemIndex := 0;
                if (FSections[SectionIndex].Items[ItemIndex].Index < FTopItem.Index) then
                  ScrollUp
                else
                  if (ItemIndex = FSections[SectionIndex].Items.Count - 1) then
                  begin
                    if FSections[SectionIndex].VisItemCount <> FSections[SectionIndex].Items.Count then
                      FTopItem := FSections[SectionIndex].Items[FSections[SectionIndex].Items.Count - FSections[SectionIndex].VisItemCount];
                  end;
              end;
              if ItemIndex <> -1 then
      ...
      if ItemIndex = FSections[SectionIndex].Items.Count - 1 then
        ...
        begin
          ...
          begin
            if ItemIndex = -1 then
              ItemIndex := 0;
            if FSections[SectionIndex].Items[ItemIndex].FPartial then
              ScrollDown
            else
              if ItemIndex = 0 then
                FTopItem := FSections[SectionIndex].Items[ItemIndex];
            if ItemIndex <> -1 then
              StartDelayTimer(FSections[SectionIndex].Items[ItemIndex])
            else
              StartDelayTimer(nil);
...
begin
  if (FSection <> nil) then
  begin
    if LMDInRange(newValue, 0, FSection.Items.Count -1) and KeepSelection then
    begin
      Item := FSection.Items[newValue];
  ...
  case BarPart of
    ...
    sbpItemText:
      begin
        ...
        begin
          LKeepSelection := FKeepSelection;
          FKeepSelection := True;
          ItemIndex := Item.Index;
          FKeepSelection := LKeepSelection;
...
procedure TElSideBar.SetBorderSides(Value: TLMDBorderSides);
begin
...
procedure TElSideBar.WMEraseBkgnd(var Message: TWMEraseBkgnd);
begin
  Message.Result := 1;
end;

{
function TElSideBar.GetThemedClassName: TLMDThemedItem;
begin
  Result := tiToolBar;
end;
}
...
function TElSideBarSection.VisItemCount: integer;
var
  i: integer;
begin
  Result := FItems.Count;
  if FBar.FVisUpBtn or FBar.FVisDownBtn then
    for i := 0 to FItems.Count - 1 do
    begin
      if FItems[i].FPartial then
      begin
        Result := i;
        Break;
      end;
...
procedure TElSideBar.WMKeyDown(var Message: TWMKey);
begin
  with Message do
    if (CharCode = VK_RETURN) and (KeyDataToShiftState(KeyData) = []) then
    begin
