...
uses
  ...
  Forms, LMDTypes, LMDBase, LMDBaseLabel, LMDClass, LMDIniCtrl,
  LMDHTMLHeaderControl, LMDHTMLExtListBox, LMDListBox, LMDCustomScrollBoxExt,
  LMDSBar, LMDVldBase;

type
  {--------------------------- TLMDCustomListBoxExt ---------------------------}

  TLMDCustomListBoxExt = class(TLMDCustomScrollBoxExt, ILMDValidatingMsgControl)
  private
    ...
    procedure SetFonts(Index:Integer; aValue:TFont);
  ...
  protected
    ...
    procedure CalcScrollRange(var aMaxX: integer; var aMaxY: integer); override;
    procedure DoCheckCanScroll(aControl: TControl; aDeltaX, aDeltaY: integer;
                               var aCanScroll: boolean); override;
    ...
    procedure UpdateListBoxSize;
    function  NeedVertScrollBar: boolean; override;
    function  NeedHorzScrollBar: boolean; override;
  ...
  public
    ...
    property Header:TLMDHTMLHeaderControl read FHeader;
    property ItemIndex:Integer index 1 read GetInteger write SetInteger;
    property LB:TLMDHTMLExtListBox read FListBox;
  ...
  published
    ...
    property Font:TFont index 1 read GetFonts write SetFonts;
    ...
    property HeaderFont:TFont index 0 read GetFonts write SetFonts;
...
type
  ...
  begin
    ...
    try
      LMDAnsiParseToStrList(ItemText, TLMDCustomListBoxExt(Parent).Delimiter, tmpList);
  ...
  begin
    ...
    begin
      with TLMDHTMLHeaderControlH(TLMDCustomListBoxExt(Parent).Header) do
      begin
...
{********************* Class TLMDCustomListBoxExt **************************************}
{------------------ Private ---------------------------------------------------}
function TLMDCustomListBoxExt.AddLine(const X:array of String):Integer;
begin
  result:=Items.Add(LMDAnsiCodeString(X, FDelimiter));
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetIniString(w:String);
var
  temp:TStringList;
  i:Integer;
begin
...
{RM 3.5.12}
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetIniString:String;
var
  i:Integer;
begin
  result:='';
...
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.ItemPart(Index:Integer; Col:Integer):String;
begin
  result:={$IFDEF LMD_NATIVEUNICODE}LMDGetCodedString{$ELSE}LMDAnsiGetCodedString{$ENDIF}(Items[index], FDelimiter, Col);
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetItemPart(Index:Integer; Col:Integer; partStr:String);
var
  s: String;
begin
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.UpdateVirtualWidth;
var
  tmp:Integer;
begin
  if FVirtualAutoWidth then
    begin
      ...
      if tmp > width - 2*(BevelWidth - BorderWidth) then
        FVirtualWidth:=tmp
      else
        VirtualWidth:=0;
    end;
  //if FVirtualWidth <> 0 then
  //  FScrollRange.X := FVirtualWidth;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.Focused: Boolean;
begin
  result := inherited Focused or lb.Focused;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetPartString(const w:String;col:Integer):String;
begin
  result:={$IFDEF LMD_NATIVEUNICODE}LMDGetCodedString{$ELSE}LMDAnsiGetCodedString{$ENDIF}(w, FDelimiter, Col);
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetBool(index:Integer):Boolean;
begin
  case index of
...
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetCanvas:TCanvas;
begin
  result:=FListBox.Canvas;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetColor(Index:Integer):TColor;
begin
  case Index of
...
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetCursor(Index:Integer):TCursor;
begin
  case index of
...
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetDragMode:TDragMode;
begin
 result:=FListBox.DragMode;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetFonts(index:Integer):TFont;
begin
  case index of
...
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetHint:String;
begin
  result:=FListBox.Hint;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetImeName:TImeName;
begin
  result:=FListBox.ImeName;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetImeMode:TImeMode;
begin
  result:=FListBox.ImeMode;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetInteger(index:Integer):Integer;
begin
  case index of
...
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetSectionEvent:TSectionNotifyEvent;
begin
  result:=FHeader.OnSectionClick;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetDrawSectionEvent:TDrawSectionEvent;
begin
  result:=FHeader.OnDrawSection;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetSectionTrackEvent:TSectionTrackEvent;
begin
  result:=FHeader.OnSectionTrack;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetItems:TStrings;
begin
  result:=FListBox.Items;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetCount;
begin
  result:=FListBox.Count;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetOnData;
begin
  result:=FListBox.OnData;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetOnDataFind;
begin
  result:=FListBox.OnDataFind;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetOnDrawItem: TDrawItemEvent;
begin
  result := FOnDrawItem;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetMeasureItemEvent:TMeasureItemEvent;
begin
  result:=FListBox.OnMeasureItem;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetSelected(index:integer):Boolean;
begin
  result:=FListBox.Selected[index];
end;

function TLMDCustomListBoxExt.GetThemedBkColor: TColor;
begin
  {$IFDEF LMDCOMP16}
...
function TLMDCustomListBoxExt.GetThemedTextColor: TColor;
begin
  {$IFDEF LMDCOMP16}
  if (UseThemeMode = ttmPlatform) and StyleServices.Enabled and
     TStyleManager.IsCustomStyleActive then
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetBool(index:Integer;aValue:Boolean);
begin
  case index of
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetOnData(aValue:TLBGetDataEvent);
begin
  FListBox.OnData:=aValue;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetCount;
begin
  FListBox.Count:=aValue;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetOnDataFind(aValue:TLBFindDataEvent);
begin
  FListBox.OnDataFind:=aValue;
end;

procedure TLMDCustomListBoxExt.SetOnDrawItem(const Value: TDrawItemEvent);
begin
  FOnDrawItem := Value;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetColor(Index:Integer; aValue:TColor);
begin
  case Index of
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetCursor(Index:Integer; aValue:TCursor);
begin
  case index of
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetDelimiter(aValue:Char);
begin
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetDragMod(aValue:TDragMode);
begin
  FListBox.DragMode:=aValue;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetFonts(index:Integer;aValue:TFont);
begin
  case index of
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetGridLines(aValue:TLMDLBGridLines);
begin
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetHint(aValue:String);
begin
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetImeMode(aValue:TImeMode);
begin
  FListBox.ImeMode:=aValue;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetImeName(aValue:TImeName);
begin
  FListBox.ImeName:=aValue;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetInteger(index:Integer;aValue:Integer);
begin
  case index of
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetListBoxStyle(aValue:TListBoxStyle);
begin
  if aValue<>FListboxStyle then
    begin
      FListBoxStyle:=aValue;
      FListBox.MeasureItemEvent:=FListBoxStyle in [lbVirtualOwnerDraw, lbOwnerDrawVariable];
      FListBox.VirtualMode:=FListBoxStyle in [lbVirtualOwnerDraw, lbVirtual];
    end;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetItems(aValue:TStrings);
begin
  FListbox.Items.Assign(aValue);
end;
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetPenStyle(const Index: Integer; const Value: TPenStyle);
begin
  case index of
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetMeasureItemEvent(aValue:TMeasureItemEvent);
begin
  FListBox.OnMeasureItem:=aValue;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetDrawSectionEvent(aValue:TDrawSectionEvent);
begin
  FHeader.OnDrawSection:=aValue;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetSelectedFontStyle(const aValue:TFontStyles);
begin
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetSectionEvent(aValue:TSectionNotifyEvent);
begin
  FHeader.OnSectionClick:=aValue;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetSectionTrackEvent(aValue:TSectionTrackEvent);
begin
  FHeader.OnSectionTrack:=aValue;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetSelected(index:integer;flag:boolean);
begin
...
// 4.0
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetVirtualWidth(aValue:Integer);
begin
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetOptions (aValue : TLMDLabelOptions);
begin
...
{ ---------------------------------------------------------------------------- }
function TLMDCustomListBoxExt.GetOnSelect: TNotifyEvent;
begin
 result:=FListBox.OnSelect;
end;

{ ---------------------------------------------------------------------------- }
procedure TLMDCustomListBoxExt.SetOnSelect(const Value: TNotifyEvent);
begin
 FListBox.OnSelect:=Value;
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetOptionsFlag:Word;
const
...
{------------------------------------------------------------------------------}
{procedure TLMDCustomListBoxExt.SetHeaderStrings(aValue:TLMDHeaderStrings);
begin
  raise Exception.Create(IDS_PROPERTYNOTUSED);
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetHeaderSections(aValue:THeaderSections);
begin
  FHeader.Sections.Assign(aValue);
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.GetHeaderSections:THeaderSections;
begin
  result:=FHeader.Sections;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.HeaderSized(Sender:THeaderControl;Section: THeaderSection);
{$IFDEF LMDCOMP7}
var
  aRect:TRect;
{$ENDIF}
begin
  ...
  begin
    aRect:=Rect(0,0,HScroll.Position+ClientWidth, ClientHeight);
  end
  else
...
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.SaveKey:Boolean;
begin
  result:=(FKey<>'') and (FKey<>IDS_LISTBOXSAVE);
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.SaveSection:Boolean;
begin
  result:=(FSection<>'') and (FSection<>IDS_COMMON);
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetIniLink(aValue:TLMDIniCtrl);
begin
  FIniLink:=aValue;
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.DrawItem(Control:TWinControl;Index:Integer;
    ...
    begin
       ...
       try
         ...
         begin
           ...
           DrawText(FListBox.Canvas.Handle, int_Ref(tmpItem), Length(tmpItem),
                    tmpRect, flags);
         ...
         begin
           ...
           begin
             ...
             DrawText(FListBox.Canvas.Handle, int_Ref(tmpList[i]),
                      Length(tmpList[i]), tmpRect, flags);
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.PrepareDrawItem(Rect: TRect;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        tmpfc := GetThemedTextColor; // Self.Font.Color;
        tmpc  := GetThemedBkColor;   // Self.color;
      end;
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.CMTRANSPARENTCHANGED(var Message: TMessage);
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.WMEraseBkgnd(var Message: TWMEraseBkgnd);
{$IFDEF LMDCOMP7}
var
  aRect:TRect;
{$ENDIF}
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.UpdateListBoxSize;
var
  lR: TRect;
begin
  lR := ClientRect;
  if HeaderVisible then
    lR.Top := lR.Top + HeaderHeight;
  if VScroll.Visible then
    lR.Right := lR.Right - VScroll.Width;
  if HScroll.Visible then
    lR.Bottom := lR.Bottom - HScroll.Height;
  FListBox.SetBounds(lR.Left, lR.Top, lR.Right - lR.Left + 1, lR.Bottom - lR.Top + 1);
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.WMSize(var Message: TWMSIZE);
begin
  inherited;
  UpdateListBoxSize;
end;
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.WMMouseWheel(var Message: TWMMouseWheel);
begin
//TODO!
end;
...
{-------------------------- Protected -----------------------------------------}
procedure TLMDCustomListBoxExt.AlignControls(AControl: TControl;var Rect : TRect);
begin
  if [csLoading, csReading, csDestroying]*ComponentState<>[] then exit;
  ...
  if FVirtualWidth>0 then
    begin
      FScrollRange.X := FVirtualWidth;
      if FListBox.Align = alClient then
      begin
        FListBox.Align:=alNone;
        FHeader.Align := alNone;
      end;
...
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.CalcColumnsWidth: Integer;
var
  i:Integer;
begin
  result:=0;
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.CreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.DefineProperties(Filer:TFiler);
begin
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.DoReadData;
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.DoThemeChanged;
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.DoWriteData;
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.Loaded;
begin
  inherited Loaded;
...
{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.NeedVertScrollBar: boolean;
var
  lMax: integer;
begin
  lMax := ClientHeight;
  if HeaderVisible then
    lMax := lMax - HeaderHeight;
  if HScroll.Visible then
    lMax := lMax - HScroll.Height;
  result := (FScrollRange.Y > lMax);
end;

{------------------------------------------------------------------------------}
function TLMDCustomListBoxExt.NeedHorzScrollBar: boolean;
var
  lMax: integer;
begin
  lMax := ClientWidth;
  if VScroll.Visible then
    lMax := lMax - VScroll.Width;
  result := (FScrollRange.X > lMax);
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.Notification(aComponent:TComponent;Operation:TOperation);
begin
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.ReadState(Reader:TReader);
begin
  // 7.01 RM
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.Resize;
begin
  inherited Resize;
  if [csLoading, csReading, csDestroying]*ComponentState<>[] then exit;
  //ReAlign;
...
procedure TLMDCustomListBoxExt.SpecialSort(sortOrder : Array of Integer);
...
{ ---------------------------------------------------------------------------- }
procedure TLMDCustomListBoxExt.SpecialSort;
begin
  SpecialSort([]);
end;

{------------------------------------------------------------------------------}
constructor TLMDCustomListBoxExt.Create(AOwner :TComponent);
begin
  ...
  inherited VScroll.Visible:=False;
end;

{------------------------------------------------------------------------------}
destructor TLMDCustomListBoxExt.Destroy;
begin
...
{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.InternalMouseMove(Shift: TShiftState; X,
  Y: Integer);
begin
end;

function TLMDCustomListBoxExt.ItemAtPos(Pos:TPoint;Existing:Boolean):Integer;
begin
  result:=FListBox.ItemAtPos(Pos,Existing);
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.Clear;
begin
  FListBox.Clear;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.SetFocus;
begin
  FListBox.SetFocus;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.WriteData;
begin
  DoWriteData;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.ReadData;
begin
  DoReadData;
end;

{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.CalcScrollRange(var aMaxX, aMaxY: integer);
var
  lH: integer;
begin
  aMaxX := CalcColumnsWidth;
  if HeaderVisible then
    lH := HeaderHeight
  else
    lH := 0;
  aMaxY := TLMDHTMLExtListBoxH(FListBox).MeasureItemHeights(false, false) + lH;
end;


{------------------------------------------------------------------------------}
procedure TLMDCustomListBoxExt.DoCheckCanScroll(aControl: TControl; aDeltaX, aDeltaY: integer; 
  var aCanScroll: boolean);
begin
  if (aControl = FHeader) or (aControl = FListBox) then
    aCanScroll := (aDeltaY = 0)
  else
    inherited DoCheckCanScroll(aControl, aDeltaX, aDeltaY, aCanScroll);
end;
...
function TLMDCustomListBoxExt.GetLastErrorMessage: TLMDString;
begin
  if Self.Items.Count > 0 then
    Result := Self.Items[Self.Items.Count - 1];
end;

procedure TLMDCustomListBoxExt.SetErrorMessage(val: TLMDString; errorLevel: integer);
begin
  if val <> '' then
    Self.Items.Add(val);
end;

procedure TLMDCustomListBoxExt.ScrollY(Sender: TObject;
  ScrollCode: TScrollCode; var ScrollPos: Integer);
var
  wParam: DWORD;
begin
  case ScrollCode of
    scLineUp    : FListBox.Perform(WM_VSCROLL, SB_LINEUP, 0);
    scLineDown  : FListBox.Perform(WM_VSCROLL, SB_LINEDOWN, 0);
    scPageUp    : FListBox.Perform(WM_VSCROLL, SB_PAGEUP, 0);
    scPageDown  : FListBox.Perform(WM_VSCROLL, SB_PAGEDOWN, 0);
    scPosition  :
    begin
      wParam := SB_THUMBPOSITION + (ScrollPos shl 16);
      FListBox.Perform(WM_VSCROLL, wParam, 0);
    end;
  end;
end;
