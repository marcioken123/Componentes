...
interface
uses
  Classes, LMDText, LMDTable, LMDSimpleXMLLex, LMDParser, LMDLex, LMDTree;

type
  { **************************** TLMDSimpleXMLParser ******************************* }
  TLMDSimpleXMLParser = class(TLMDParser)
  private
...
{-----------------------------------------------------------------------------}
function  TLMDSimpleXMLParser.ProcessText(aRoot : TLMDParsedTextList; aText : string) : TLMDBaseText;
var
  lWord : string;
  J     : LongInt;
begin
...
{-----------------------------------------------------------------------------}
procedure TLMDSimpleXMLParser.ParseBranch(aRoot : TLMDTree; aStream : TStream; aOpenText : string);
var
  T             : TLMDToken;
  L             : TList;
  I             : LongInt;
...
{-----------------------------------------------------------------------------}
function TLMDSimpleXMLParser.GetLexClass: TLMDLexClass;
begin
 Result:= TLMDSimpleXMLLex;
end;

function TLMDSimpleXMLParser.Parse(aStream: TStream;
  aGraphicErrorEvent: TLMDGraphicErrorEvent;
  aGetVariable: TLMDGetVariableEvent;
  aEmbdControlCreated : TLMDEmbdControlEvent;
...
initialization
  RegisterParser(TLMDSimpleXMLParser, ['XML'], False);
end.
