...
function TLMDXMLLex.GetToken(aStream: TStream): TLMDToken;
var
  C: Char;
  S: string;
  avPos: LongInt;
  ...
  while (aStream.Position < aStream.Size) and (C in [#10, #13, ' ']) do
    C:= GetNextChar(aStream);
...
function TLMDXMLLex.GetDelimChars: TCharSet;
begin
