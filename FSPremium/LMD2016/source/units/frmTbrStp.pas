...
uses
  ...
  ElToolBar, ExtCtrls, StdCtrls, ElBtnCtl, ElPopBtn, LMDObjectList,
...
type
  ...
  public
    procedure LoadToolbarControls(Toolbar : TCustomElToolbar);
    procedure SaveToolbarControls(Toolbar : TCustomElToolbar);
  end;
...
type
   THackToolbar = class(TCustomElToolbar);

procedure TfrmToolbarSetup.LoadToolbarControls(Toolbar : TCustomElToolbar);
var
  I : integer;
  S : string;
  AControl : TControl;
...
begin
  ...
  if THackToolbar(Toolbar).ShowCaption then
    TextOptionsCombo.ItemIndex := 0
  else
    TextOptionsCombo.ItemIndex := 1;
  if THackToolbar(Toolbar).LargeSize then
...
procedure TfrmToolbarSetup.SaveToolbarControls(Toolbar : TCustomElToolbar);
var
  I, K : integer;
...
begin
 ...
 //     if K = -1 then
  ...
  Toolbar.EndUpdate;
  THackToolbar(Toolbar).ShowCaption := TextOptionsCombo.ItemIndex = 0;
  THackToolbar(Toolbar).LargeSize := IconOptionsCombo.ItemIndex = 1;
end;
