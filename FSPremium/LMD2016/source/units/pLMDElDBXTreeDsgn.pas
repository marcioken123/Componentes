...
type
  TELDBXTreeEditor = class(TComponentEditor)
...
procedure TELDBXTreeEditor.ExecuteVerb(Index : Integer);
...
function TELDBXTreeEditor.GetVerb(Index : Integer) : string;
begin
  if Index = 0 then
    Result := 'Styles...'
  else
...
function TELDBXTreeEditor.GetVerbCount : Integer;
begin
  Result := 1;
end;
