...
// (DO NOT EDIT: machine generated header) 'wwrcdvw.pas' rev: 6.00
...
protected:
	...
	void __fastcall SetNavigatorVisibleButtons(Dbctrls::TButtonSet Value);
...
__published:
	...
	__property Dbctrls::TButtonSet NavigatorVisibleButtons = {write=SetNavigatorVisibleButtons, stored=false, nodefault};
...
//-- var, const, procedure ---------------------------------------------------
#pragma error Unsupported symbol type (23, wwrcdvw)
