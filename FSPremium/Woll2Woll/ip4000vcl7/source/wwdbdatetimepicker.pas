...
begin
   ...
   ((FDatalink.Field<>nil) and
    {$ifdef wwdelphi6up}
      ((TDateTimeField(FDatalink.Field).DataType=ftDateTime) or (TDateTimeField(FDatalink.Field).DataType=ftTimeStamp)) and
    {$else}
...
begin
   result:=((FDatalink.Field<>Nil) and
    {$ifdef wwdelphi6up}
      ((TDateTimeField(FDatalink.Field).DataType=ftDateTime) or (TDateTimeField(FDatalink.Field).DataType=ftTimeStamp)))
    {$else}
      (TDateTimeField(FDatalink.Field).DataType=ftDateTime))
    {$endif}
