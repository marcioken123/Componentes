...
{$IFDEF BORLAND}
{$IFNDEF RTL360_UP} // From Delphi 12 and up, NativeInt = Int64 in x64 platforms
...
begin
  inherited Create;
  FName := Name;
  FHandle := IWJclWin32.CreateMutex(SecAttr, Ord(InitialOwner), PChar(Name));
  if FHandle = 0 then
