...
uses
  ...
  IWHTMLTag, IWApplication, IWDBCommon, IWBSCommon, IWBSCustomControl;
...
uses {$IFDEF  IW_14_3_0_UP}
  ...
  IWBSRegion, IWBSInputCommon, IWBSCustomEvents, IWBSInputForm, IWBSList;
...
procedure TIWBSFile.InternalRenderHTML(const AHTMLName: string; AContext: TIWCompContext; var AHTMLTag: TIWHTMLTag);
begin
  inherited;
