...
uses
  Classes, SysUtils, StrUtils, db, IWControl, IWRenderContext, IWHTMLTag,
  IWXMLTag, IWDBCommon, IWDBStdCtrls, IWTypes, IWApplication, IWBSCommon,
  IWBSCommonInterfaces, IWBSCustomEvents;
...
type
  ...
  protected
    ...
    procedure ExtraTagParamsChanged(ASender: TObject); override;
  protected
    {$hints on}
...
uses
  IWBaseHTMLInterfaces, IWBSScriptEvents, IWBSGlobal, IWBSUtils;
...
procedure TIWBSCustomControl.ExtraTagParamsChanged(ASender: TObject);
begin
  AsyncRefreshControl;
end;
