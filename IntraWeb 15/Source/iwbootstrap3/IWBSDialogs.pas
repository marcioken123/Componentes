...
uses
  Classes, SysUtils, Controls, IWControl, IWRenderContext, IWBaseRenderContext,
  IWHTMLTag, IWForm, IWBSCustomRegion, IWBSRegion, IWBSModal, IWBSButton,
  IWBSControls;
...
uses
  IWApplication, IWBSUtils, IWBSCommon;
...
begin
  ...
  if ACloseButton in [iwbsdcCaption, iwbsdcBoth] then
    with TIWBSButton.Create(Owner) do
    begin
      Parent := GetHeader;
      Top := 0;
      Left := 0;
