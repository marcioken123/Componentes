...
var
  ...
  gIWBSLibJQueryJs: string = '/<iwbspath>/jquery.min.js';   // current version is 3.6.4, same as IW

  // path for bootstrap library (required)
  gIWBSLibBootstrapCss: string = '/<iwbspath>/bootstrap-3.4.1/css/bootstrap.min.css';
  gIWBSLibBootstrapJs: string = '/<iwbspath>/bootstrap-3.4.1/js/bootstrap.min.js';
...
begin
  // public repositories
  gIWBSLibJQueryJS := 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.4/jquery.min.js';
