...
uses
  Classes, SysUtils, StrUtils, Graphics, Db, IWRenderContext, IWHTMLTag,
  IWBSCustomControl, IWApplication;
...
uses
  ...
  IWDbCommon, IWURL, IWFilePath, IWGlobal, InCoderMIME, IWBSCommon, IWBSUtils,
  IWBSImageUtils, IWBSInputCommon, IWBSInputForm;
{$region 'TIWBSImage'}
