...
uses
  ...
  IWBaseHTMLControl, IWApplication, IWBSCommon, IWBSCustomInput;
...
uses
  IW.Common.SysTools, IWBSInputCommon, IWBSInputForm, IWBSUtils;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (LControl <> Self) and (LControl is TIWBSRadioButton) and TIWBSRadioButton(LControl).Checked and SameText(TIWBSRadioButton(LControl).Group, Self.Group) then
        begin
          TIWBSRadioButton(LControl).Checked := False;
        end;
      end;
    end
    else
