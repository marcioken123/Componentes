...
uses
  Classes, SysUtils, SyncObjs, Controls, IWBSRegion, IWBSInputForm,
  IWBSButtonGroup, IWHTMLTag;
...
var
  LSpanDiv: TIWHTMLTag;
begin
  if (AParentForm <> nil) and not ((AParent is TIWBSRegion) and (TIWBSRegion(AParent).BSRegionType = bsrtFormGroup)) and not (AParent is TIWBSButtonGroup) then
  begin
