...
uses
  ...
  IWHTMLTag, IW.HTTP.Request, IW.HTTP.Reply, IWBaseInterfaces, IWBSCommon,
  IWBSRestServer, IWBSCustomregion;
...
begin
  Result := FInputsSize.GetClassString(FCaptionsSize.GridXSOffset + FCaptionsSize.GridXSSpan, FCaptionsSize.GridSMOffset + FCaptionsSize.GridSMSpan, FCaptionsSize.GridMDOffset + FCaptionsSize.GridMDSpan, FCaptionsSize.GridLGOffset + FCaptionsSize.GridLGSpan);
end;
