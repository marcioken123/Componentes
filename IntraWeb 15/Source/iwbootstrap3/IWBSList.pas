...
uses
  SysUtils, Classes, Controls, StrUtils, IWHTMLTag, IWBSCommon, IWBSCustomregion,
  IWBSCustomControl;

type
  TIWBSListType = (bsltNone, bsltDropDownMenu, bsltGroup, bsltInline, bsltNav,
    bsltPager, bsltPagination, bsltPaginationLg, bsltPaginationSm, bsltBreadcrumb);
