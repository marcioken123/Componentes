...
type
  TIWBS4CustomRegion = class(TIWCustomRegion, IIWBS4Component, IIWBS4Container)
  private
    FOldCss: string;
    FOldStyle: string;
    FOldVisible: Boolean;
    ...
    procedure SetGridOptions(const AValue: TIWBS4GridOptions);
...
uses IWBS4Utils, IWBS4ScriptEvents, IWBS4Global;

type
  TIWContainerHack = class(TIWContainer);

constructor TIWBS4CustomRegion.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TIWBS4CustomRegion.Destroy;
begin
...
{$IFNDEF IW_14_1_0_UP}
function TIWBS4CustomRegion.get_ScriptEvents: TIWScriptEvents;
begin
  Result := inherited get_ScriptEvents;
end;

procedure TIWBS4CustomRegion.set_ScriptEvents(const Value: TIWScriptEvents);
begin
  inherited set_ScriptEvents(Value);
end;

function TIWBS4CustomRegion.IsScriptEventsStored: Boolean;
begin
  Result := ScriptEvents.Count > 0;
end;
{$ENDIF}

function TIWBS4CustomRegion.get_Visible: Boolean;
begin
...
procedure TIWBS4CustomRegion.set_Visible(Value: Boolean);
begin
  inherited;
...
procedure TIWBS4CustomRegion.SetParent(AParent: TWinControl);
begin
  inherited;
...
procedure TIWBS4CustomRegion.SetRawText(const Value: Boolean);
begin
  FRawText := Value;
  AsyncRefreshControl;
end;

function TIWBS4CustomRegion.JQSelector: string;
begin
  Result := '$("#' + HTMLName + '")';
end;

procedure TIWBS4CustomRegion.AsyncRefreshControl;
begin
  FAsyncRefreshControl := True;
  Invalidate;
end;

procedure TIWBS4CustomRegion.ResetAsyncRefreshControl;
begin
  FAsyncRefreshControl := False;
end;

procedure TIWBS4CustomRegion.ApplyAsyncChanges;
begin
...
procedure TIWBS4CustomRegion.AsyncRemoveControl;
begin
...
procedure TIWBS4CustomRegion.Release;
var
...
procedure TIWBS4CustomRegion.SetFocus;
begin
  IWBS4ExecuteAsyncJScript(JQSelector + '.focus()');
end;

function TIWBS4CustomRegion.GetRoleString: string;
begin
  Result := '';
end;

procedure TIWBS4CustomRegion.SetGridOptions(const AValue: TIWBS4GridOptions);
begin
  FGridOptions.Assign(AValue);
  Invalidate;
end;

procedure TIWBS4CustomRegion.OnScriptChange(ASender: TObject);
begin
  AsyncRefreshControl;
end;

procedure TIWBS4CustomRegion.OnStyleChange(ASender: TObject);
begin
  Invalidate;
end;

function TIWBS4CustomRegion.GetAfterRender: TNotifyEvent;
begin
  Result := FOnAfterRender;
end;

function TIWBS4CustomRegion.GetCssString: string;
begin
  Result := RenderCSSClass(nil);
end;

function TIWBS4CustomRegion.GetCustomAsyncEvents: TIWBS4CustomAsyncEvents;
begin
...
function TIWBS4CustomRegion.GetCustomRestEvents: TIWBS4CustomRestEvents;
begin
...
procedure TIWBS4CustomRegion.SetAfterRender(const Value: TNotifyEvent);
begin
  FOnAfterRender := Value;
end;

procedure TIWBS4CustomRegion.SetCollapse(const Value: Boolean);
begin
  FCollapse := Value;
  Invalidate;
end;

procedure TIWBS4CustomRegion.SetCollapseVisible(const Value: Boolean);
begin
  FCollapseVisible := Value;
  Invalidate;
end;

procedure TIWBS4CustomRegion.SetCss(const Value: string);
begin
  FCss := Value;
  Invalidate;
end;

procedure TIWBS4CustomRegion.SetCustomAsyncEvents(const Value: TIWBS4CustomAsyncEvents);
begin
  FCustomAsyncEvents.Assign(Value);
end;

procedure TIWBS4CustomRegion.SetCustomRestEvents(const Value: TIWBS4CustomRestEvents);
begin
  FCustomRestEvents.Assign(Value);
end;

function TIWBS4CustomRegion.IsStoredCustomAsyncEvents: Boolean;
begin
  Result := (FCustomAsyncEvents <> nil) and (FCustomAsyncEvents.Count > 0);
end;

function TIWBS4CustomRegion.IsStoredCustomRestEvents: Boolean;
begin
  Result := (FCustomRestEvents <> nil) and (FCustomRestEvents.Count > 0);
end;

procedure TIWBS4CustomRegion.SetScript(const AValue: TStringList);
begin
  FScript.Assign(AValue);
end;

procedure TIWBS4CustomRegion.SetScriptInsideTag(const Value: Boolean);
begin
  FScriptInsideTag := Value;
end;

procedure TIWBS4CustomRegion.SetScriptParams(const AValue: TIWBS4ScriptParams);
begin
  FScriptParams.Assign(AValue);
end;

function TIWBS4CustomRegion.GetScript: TStringList;
begin
  Result := FScript;
end;

function TIWBS4CustomRegion.GetScriptInsideTag: Boolean;
begin
  Result := FScriptInsideTag;
end;

function TIWBS4CustomRegion.GetScriptParams: TIWBS4ScriptParams;
begin
  Result := FScriptParams;
end;

function TIWBS4CustomRegion.GetStyle: TStringList;
begin
  Result := FStyle;
end;

procedure TIWBS4CustomRegion.SetStyle(const AValue: TStringList);
begin
  FStyle.Assign(AValue);
end;

procedure TIWBS4CustomRegion.SetText(const Value: string);
begin
  FText := TrimRight(Value);
  AsyncRefreshControl;
end;

function TIWBS4CustomRegion.ContainerPrefix: string;
begin
...
function TIWBS4CustomRegion.HTMLControlImplementation: TIWHTMLControlImplementation;
begin
  Result := ControlImplementation;
end;

function TIWBS4CustomRegion.RegionDiv: TIWHTMLTag;
begin
  Result := FRegionDiv;
end;

function TIWBS4CustomRegion.InitContainerContext(AWebApplication: TIWApplication): TIWContainerContext;
begin
...
function TIWBS4CustomRegion.SupportsInput: Boolean;
begin
  Result := False;
end;

procedure TIWBS4CustomRegion.IWComponentsChanged(AComponent: TComponent);
...
procedure TIWBS4CustomRegion.InternalRenderCss(var ACss: string);
begin
  if FCollapseVisible then
  begin
    TIWBS4Common.AddCssClass(ACss, 'collapse');
    if FCollapse = false then
    begin
      TIWBS4Common.AddCssClass(ACss, 'show');
    end;
  end;
  ...
  // Flex Order
  if FFlexOrder <> 0 then
  begin
    TIWBS4Common.AddCssClass(ACss, 'order-' + IntToStr(FFlexOrder));
  end;
end;

procedure TIWBS4CustomRegion.InternalRenderScript(AContext: TIWCompContext; const AHTMLName: string; AScript: TStringList);
begin
  //
end;

procedure TIWBS4CustomRegion.InternalRenderStyle(AStyle: TStringList);
begin
  //
end;

function TIWBS4CustomRegion.RenderAsync(AContext: TIWCompContext): TIWXMLTag;
var
  xHTMLName: string;
...
procedure TIWBS4CustomRegion.RenderComponents(AContainerContext: TIWContainerContext; APageContext: TIWBasePageContext);
begin
  TIWBS4RegionCommon.RenderComponents(Self, AContainerContext, APageContext);
end;

function TIWBS4CustomRegion.RenderCSSClass(AComponentContext: TIWCompContext): string;
begin
...
function TIWBS4CustomRegion.RenderHTML(AContext: TIWCompContext): TIWHTMLTag;
var
  BadgeTag: TIWHTMLTag;
  SpanClass: string;
begin
  ...
  // Badge
  if FBadge.Enabled and not FBadge.BadgeOnRight then
  begin
    BadgeTag := FRegionDiv.Contents.AddTag('span');
    if FBadge.BadgePill
      then SpanClass := 'badge badge-pill badge-' + aIWBS4ContextualClass[FBadge.ContextualColor]
      else SpanClass := 'badge badge-' + aIWBS4ContextualClass[FBadge.ContextualColor];
  ...
  // Badge
  if FBadge.Enabled and FBadge.BadgeOnRight then
  begin
    BadgeTag := FRegionDiv.Contents.AddTag('span');
    if FBadge.BadgePill
      then SpanClass := 'badge badge-pill badge-' + aIWBS4ContextualClass[FBadge.ContextualColor]
...
procedure TIWBS4CustomRegion.RenderScripts(AComponentContext: TIWCompContext);
begin
  //
end;

function TIWBS4CustomRegion.RenderStyle(AContext: TIWCompContext): string;
begin
  Result := TIWBS4Common.RenderStyle(Self);
end;

function TIWBS4CustomRegion.RenderText: string;
var
  i: Integer;
  LLines: TStringList;
begin
...
function TIWBS4CustomRegion.get_HTMLName: string;
begin
  Result := ControlImplementation.HTMLName;
end;

function TIWBS4CustomRegion.get_Clip: Boolean;
begin
  Result := inherited ClipRegion;
end;

procedure TIWBS4CustomRegion.set_Clip(AValue: Boolean);
begin
  inherited ClipRegion := AValue;
end;

function TIWBS4CustomRegion.get_HasName: Boolean;
begin
  Result := inherited HasName;
end;

function TIWBS4CustomRegion.get_UseFrame: Boolean;
begin
  Result := inherited UseFrame;
end;

procedure TIWBS4CustomRegion.set_UseFrame(AValue: Boolean);
begin
  inherited UseFrame := AValue;
end;

function TIWBS4CustomRegion.get_HTMLWidth: Integer;
begin
  Result := inherited HTMLWidth;
end;

function TIWBS4CustomRegion.get_HTMLHeight: Integer;
begin
  Result := inherited HTMLHeight;
end;

function TIWBS4CustomRegion.get_HTMLLeft: Integer;
begin
  Result := ControlImplementation.GetHTMLLeft;
end;

function TIWBS4CustomRegion.get_HTMLTop: Integer;
begin
  Result := ControlImplementation.GetHTMLTop;
end;

function TIWBS4CustomRegion.get_ZIndex: Integer;
begin
  Result := ControlImplementation.GetZIndex;
end;

procedure TIWBS4CustomRegion.set_ZIndex(AValue: Integer);
begin
  ControlImplementation.SetZIndex(AValue);
end;

function TIWBS4CustomRegion.get_RenderSize: Boolean;
begin
  Result := ControlImplementation.GetRenderSize;
end;

procedure TIWBS4CustomRegion.set_RenderSize(AValue: Boolean);
begin
  // Constant
end;

function TIWBS4CustomRegion.get_StyleRenderOptions: TIWStyleRenderOptions;
begin
  Result := ControlImplementation.GetStyleRenderOptions;
end;

procedure TIWBS4CustomRegion.set_StyleRenderOptions(AValue: TIWStyleRenderOptions);
begin
...
procedure TIWBS4CustomRegion.set_ScriptEvents(AValue: TIWScriptEvents);
begin
  ControlImplementation.SetScriptEvents(AValue);
end;

function TIWBS4CustomRegion.get_Css: string;
begin
  Result := ControlImplementation.GetCss;
end;

procedure TIWBS4CustomRegion.set_Css(const AValue: string);
begin
  ControlImplementation.SetCss(AValue);
end;

function TIWBS4CustomRegion.get_SkinId: string;
begin
  Result := ControlImplementation.getSkinId;
end;

procedure TIWBS4CustomRegion.set_SkinId(const AValue: string);
begin
  ControlImplementation.setSkinId(AValue);
end;

function TIWBS4CustomRegion.get_WebCursor: TIWCursor;
begin
  Result := ControlImplementation.GetCursor;
end;

procedure TIWBS4CustomRegion.set_WebCursor(AValue: TIWCursor);
begin
  ControlImplementation.SetCursor(AValue);
end;

procedure TIWBS4CustomRegion.set_WebFont(AValue: TIWFont);
begin
  ControlImplementation.Font := AValue;
end;

function TIWBS4CustomRegion.get_WebFont: TIWFont;
begin
  Result := ControlImplementation.Font;
end;

function TIWBS4CustomRegion.get_ExtraTagParams: TStringList;
begin
  Result := ControlImplementation.get_ExtraTagParams;
end;

procedure TIWBS4CustomRegion.set_ExtraTagParams(const Value: TStringList);
begin
  ControlImplementation.set_ExtraTagParams(Value);
end;

function TIWBS4CustomRegion.get_OnHTMLTag: TIWOnHTMLTag;
begin
  Result := ControlImplementation.OnHTMLTag;
end;

procedure TIWBS4CustomRegion.set_OnHTMLTag(AValue: TIWOnHTMLTag);
begin
  ControlImplementation.setOnHTMLTag(AValue);
end;

// deprecated
function TIWBS4CustomRegion.get_SupportsPartial: Boolean;
begin
  Result := False;
end;

procedure TIWBS4CustomRegion.set_SupportsPartial(AValue: Boolean);
begin
  // deprecated property
end;
{$ENDREGION}
