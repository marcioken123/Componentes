...
function IWBS4GetFieldBlobStream(ADataSet: TDataSet; AField: TBlobField): TStream;
...
begin
  ...
  begin
    ...
    if (GraphicHeader.Count <> 1) or (GraphicHeader.HType <> $0100) or (GraphicHeader.Size <> Size - SizeOf(GraphicHeader)) then
      Result.Position := 0;
  end;
end;
{
