...
type
  ...
  TIWBS4Moab = class(TIWCustomRegion, IIWBS4Component, IIWBS4Container)
  private
    FOldCss: string;
    FOldStyle: string;
    FOldVisible: Boolean;
...
constructor TIWBS4Moab.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TIWBS4Moab.SetModalVisible(AValue: Boolean);
begin
...
procedure TIWBS4Moab.DoOnAsyncHide(AParams: TStringList);
begin
  FModalVisible := False;
...
procedure TIWBS4Moab.DoOnAsyncShow(AParams: TStringList);
begin
  FOnAsyncShow(Self, AParams);
end;

{$IFNDEF IW_14_1_0_UP}
function TIWBS4Moab.get_ScriptEvents: TIWScriptEvents;
begin
  Result := inherited get_ScriptEvents;
end;

procedure TIWBS4Moab.set_ScriptEvents(const Value: TIWScriptEvents);
begin
  inherited set_ScriptEvents(Value);
end;

function TIWBS4Moab.IsScriptEventsStored: Boolean;
begin
  Result := ScriptEvents.Count > 0;
end;
{$ENDIF}

function TIWBS4Moab.get_Visible: Boolean;
begin
...
procedure TIWBS4Moab.set_Visible(Value: Boolean);
begin
  inherited;
...
procedure TIWBS4Moab.SetParent(AParent: TWinControl);
begin
  inherited;
...
procedure TIWBS4Moab.SetRawText(const Value: Boolean);
begin
  FRawText := Value;
  AsyncRefreshControl;
end;

function TIWBS4Moab.JQSelector: string;
begin
  Result := '$("#' + HTMLName + '")';
end;

procedure TIWBS4Moab.AsyncRefreshControl;
begin
  FAsyncRefreshControl := True;
  Invalidate;
end;

procedure TIWBS4Moab.ResetAsyncRefreshControl;
begin
  FAsyncRefreshControl := False;
end;

procedure TIWBS4Moab.ApplyAsyncChanges;
begin
...
procedure TIWBS4Moab.AsyncRemoveControl;
begin
...
procedure TIWBS4Moab.SetFocus;
begin
  IWBS4ExecuteAsyncJScript(JQSelector + '.focus()');
end;

function TIWBS4Moab.GetRoleString: string;
begin
  Result := '';
end;

procedure TIWBS4Moab.OnScriptChange(ASender: TObject);
begin
  AsyncRefreshControl;
end;

procedure TIWBS4Moab.OnStyleChange(ASender: TObject);
begin
  Invalidate;
end;

function TIWBS4Moab.GetAfterRender: TNotifyEvent;
begin
  Result := FOnAfterRender;
end;

function TIWBS4Moab.GetCssString: string;
begin
  Result := RenderCSSClass(nil);
end;

function TIWBS4Moab.GetCustomAsyncEvents: TIWBS4CustomAsyncEvents;
begin
...
function TIWBS4Moab.GetCustomRestEvents: TIWBS4CustomRestEvents;
begin
...
function TIWBS4Moab.GetHideScript: string;
begin
  Result := '$("#' + HTMLName + '").modal("hide");';
end;

procedure TIWBS4Moab.SetAfterRender(const Value: TNotifyEvent);
begin
  FOnAfterRender := Value;
end;

procedure TIWBS4Moab.SetCss(const Value: string);
begin
  FCss := Value;
  Invalidate;
end;

procedure TIWBS4Moab.SetCustomAsyncEvents(const Value: TIWBS4CustomAsyncEvents);
begin
  FCustomAsyncEvents.Assign(Value);
end;

procedure TIWBS4Moab.SetCustomRestEvents(const Value: TIWBS4CustomRestEvents);
begin
  FCustomRestEvents.Assign(Value);
end;

function TIWBS4Moab.IsStoredCustomAsyncEvents: Boolean;
begin
  Result := (FCustomAsyncEvents <> nil) and (FCustomAsyncEvents.Count > 0);
end;

function TIWBS4Moab.IsStoredCustomRestEvents: Boolean;
begin
  Result := (FCustomRestEvents <> nil) and (FCustomRestEvents.Count > 0);
end;

procedure TIWBS4Moab.SetScript(const AValue: TStringList);
begin
  FScript.Assign(AValue);
end;

procedure TIWBS4Moab.SetScriptInsideTag(const Value: Boolean);
begin
  FScriptInsideTag := Value;
end;

procedure TIWBS4Moab.SetScriptParams(const AValue: TIWBS4ScriptParams);
begin
  FScriptParams.Assign(AValue);
end;

function TIWBS4Moab.GetScript: TStringList;
begin
  Result := FScript;
end;

function TIWBS4Moab.GetScriptInsideTag: Boolean;
begin
  Result := FScriptInsideTag;
end;

function TIWBS4Moab.GetScriptParams: TIWBS4ScriptParams;
begin
  Result := FScriptParams;
end;

function TIWBS4Moab.GetShowScript: string;
begin
  Result := '$("#' + HTMLName + '").modal({backdrop: "static", "keyboard": true});';
end;

function TIWBS4Moab.GetStyle: TStringList;
begin
  Result := FStyle;
end;

procedure TIWBS4Moab.SetStyle(const AValue: TStringList);
begin
  FStyle.Assign(AValue);
end;

procedure TIWBS4Moab.SetText(const Value: string);
begin
  FText := TrimRight(Value);
  AsyncRefreshControl;
end;

function TIWBS4Moab.ContainerPrefix: string;
begin
...
function TIWBS4Moab.HTMLControlImplementation: TIWHTMLControlImplementation;
begin
  Result := ControlImplementation;
end;

function TIWBS4Moab.RegionDiv: TIWHTMLTag;
begin
  Result := FRegionDiv;
end;

function TIWBS4Moab.InitContainerContext(AWebApplication: TIWApplication): TIWContainerContext;
begin
...
function TIWBS4Moab.SupportsInput: Boolean;
begin
  Result := False;
end;

procedure TIWBS4Moab.IWComponentsChanged(AComponent: TComponent);
...
procedure TIWBS4Moab.InternalRenderCss(var ACss: string);
begin
  if FFade then
  begin
    TIWBS4Common.AddCssClass(ACss, 'fade');
  end;
 {if FCollapse then
  begin
...
procedure TIWBS4Moab.InternalRenderScript(AContext: TIWCompContext; const AHTMLName: string; AScript: TStringList);
begin
...
procedure TIWBS4Moab.InternalRenderStyle(AStyle: TStringList);
begin
  //
end;

function TIWBS4Moab.RenderAsync(AContext: TIWCompContext): TIWXMLTag;
var
  xHTMLName: string;
...
procedure TIWBS4Moab.RenderComponents(AContainerContext: TIWContainerContext; APageContext: TIWBasePageContext);
begin
  TIWBS4RegionCommon.RenderComponents(Self, AContainerContext, APageContext);
end;

function TIWBS4Moab.RenderCSSClass(AComponentContext: TIWCompContext): string;
begin
  Result := 'modal'; //FGridOptions.GetClassString;
  if FCss <> '' then
  begin
    if Result <> '' then
    begin
...
function TIWBS4Moab.RenderHTML(AContext: TIWCompContext): TIWHTMLTag;
begin
...
procedure TIWBS4Moab.RenderScripts(AComponentContext: TIWCompContext);
begin
  //
end;

function TIWBS4Moab.RenderStyle(AContext: TIWCompContext): string;
begin
  Result := TIWBS4Common.RenderStyle(Self);
end;

function TIWBS4Moab.RenderText: string;
var
  i: Integer;
  LLines: TStringList;
begin
...
function TIWBS4Moab.get_HTMLName: string;
begin
  Result := ControlImplementation.HTMLName;
end;

function TIWBS4Moab.get_Clip: Boolean;
begin
  Result := inherited ClipRegion;
end;

procedure TIWBS4Moab.set_Clip(AValue: Boolean);
begin
  inherited ClipRegion := AValue;
end;

function TIWBS4Moab.get_HasName: Boolean;
begin
  Result := inherited HasName;
end;

function TIWBS4Moab.get_UseFrame: Boolean;
begin
  Result := inherited UseFrame;
end;

procedure TIWBS4Moab.set_UseFrame(AValue: Boolean);
begin
  inherited UseFrame := AValue;
end;

function TIWBS4Moab.get_HTMLWidth: Integer;
begin
  Result := inherited HTMLWidth;
end;

function TIWBS4Moab.get_HTMLHeight: Integer;
begin
  Result := inherited HTMLHeight;
end;

function TIWBS4Moab.get_HTMLLeft: Integer;
begin
  Result := ControlImplementation.GetHTMLLeft;
end;

function TIWBS4Moab.get_HTMLTop: Integer;
begin
  Result := ControlImplementation.GetHTMLTop;
end;

function TIWBS4Moab.get_ZIndex: Integer;
begin
  Result := ControlImplementation.GetZIndex;
end;

procedure TIWBS4Moab.set_ZIndex(AValue: Integer);
begin
  ControlImplementation.SetZIndex(AValue);
end;

function TIWBS4Moab.get_RenderSize: Boolean;
begin
  Result := ControlImplementation.GetRenderSize;
end;

procedure TIWBS4Moab.set_RenderSize(AValue: Boolean);
begin
  // Constant
end;

function TIWBS4Moab.get_StyleRenderOptions: TIWStyleRenderOptions;
begin
  Result := ControlImplementation.GetStyleRenderOptions;
end;

procedure TIWBS4Moab.set_StyleRenderOptions(AValue: TIWStyleRenderOptions);
begin
...
procedure TIWBS4Moab.set_ScriptEvents(AValue: TIWScriptEvents);
begin
  ControlImplementation.SetScriptEvents(AValue);
end;

function TIWBS4Moab.get_Css: string;
begin
  Result := ControlImplementation.GetCss;
end;

procedure TIWBS4Moab.set_Css(const AValue: string);
begin
  ControlImplementation.SetCss(AValue);
end;

function TIWBS4Moab.get_SkinId: string;
begin
  Result := ControlImplementation.getSkinId;
end;

procedure TIWBS4Moab.set_SkinId(const AValue: string);
begin
  ControlImplementation.setSkinId(AValue);
end;

function TIWBS4Moab.get_WebCursor: TIWCursor;
begin
  Result := ControlImplementation.GetCursor;
end;

procedure TIWBS4Moab.set_WebCursor(AValue: TIWCursor);
begin
  ControlImplementation.SetCursor(AValue);
end;

procedure TIWBS4Moab.set_WebFont(AValue: TIWFont);
begin
  ControlImplementation.Font := AValue;
end;

function TIWBS4Moab.get_WebFont: TIWFont;
begin
  Result := ControlImplementation.Font;
end;

function TIWBS4Moab.get_ExtraTagParams: TStringList;
begin
  Result := ControlImplementation.get_ExtraTagParams;
end;

procedure TIWBS4Moab.set_ExtraTagParams(const Value: TStringList);
begin
  ControlImplementation.set_ExtraTagParams(Value);
end;

function TIWBS4Moab.get_OnHTMLTag: TIWOnHTMLTag;
begin
  Result := ControlImplementation.OnHTMLTag;
end;

procedure TIWBS4Moab.set_OnHTMLTag(AValue: TIWOnHTMLTag);
begin
  ControlImplementation.setOnHTMLTag(AValue);
end;
// deprecated

function TIWBS4Moab.get_SupportsPartial: Boolean;
begin
  Result := False;
end;

procedure TIWBS4Moab.set_SupportsPartial(AValue: Boolean);
begin
  // deprecated property
end;
{$ENDREGION}
