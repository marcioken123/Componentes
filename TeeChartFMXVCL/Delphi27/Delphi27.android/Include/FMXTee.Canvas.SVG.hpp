...
// (DO NOT EDIT: machine generated header) 'FMXTee.Canvas.SVG.pas' rev: 34.00 (Android)

#ifndef Fmxtee_Canvas_SvgHPP
#define Fmxtee_Canvas_SvgHPP
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TSVGCanvas : public Fmxtee::Canvas::TTeeNeutralCanvas
{
...
private:
	...
	System::UnicodeString __fastcall SVGColor(System::Uitypes::TAlphaColor AColor);
	System::UnicodeString __fastcall SVGEllipse(const float X1, const float Y1, const float X2, const float Y2);
	void __fastcall SVGEndClip();
	System::UnicodeString __fastcall SVGOpacity(bool IsPen, const System::Uitypes::TAlphaColor AColor);
	System::UnicodeString __fastcall SVGPen();
	System::UnicodeString __fastcall SVGPoints(const System::Types::TPointF *Points, const int Points_High);
	System::UnicodeString __fastcall SVGRect(const System::Types::TRectF &Rect);
	System::UnicodeString __fastcall TotalBounds();
	void __fastcall TextOutWithRotate(const float X, const float Y, const System::UnicodeString Text, const double RotDegree);
...
public:
	/* TTeeNeutralCanvas.Create */ inline __fastcall virtual TSVGCanvas() : Fmxtee::Canvas::TTeeNeutralCanvas() { }
...
public:
	...
	inline void __fastcall  Donut(const System::Types::TRectF &R, const double StartAngle, const double EndAngle, const double HolePercent){ Fmxtee::Canvas::TTeeCanvas3D::Donut(R, StartAngle, EndAngle, HolePercent); }
...
private:
	void *__ICanvasToolTips;	// Fmxtee::Canvas::ICanvasToolTips 
	void *__ICanvasHyperlinks;	// Fmxtee::Canvas::ICanvasHyperlinks 
	
public:
	#if defined(MANAGED_INTERFACE_OPERATORS)
	// {03EBCB55-D01F-4CA8-8A2F-48EB3BEBC5E3}
	operator Fmxtee::Canvas::_di_ICanvasToolTips()
	{
		Fmxtee::Canvas::_di_ICanvasToolTips intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Fmxtee::Canvas::ICanvasToolTips*(void) { return (Fmxtee::Canvas::ICanvasToolTips*)&__ICanvasToolTips; }
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
	// {84DBB276-CBD2-4BBB-AC31-AACBF8B6F34C}
	operator Fmxtee::Canvas::_di_ICanvasHyperlinks()
	{
		Fmxtee::Canvas::_di_ICanvasHyperlinks intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Fmxtee::Canvas::ICanvasHyperlinks*(void) { return (Fmxtee::Canvas::ICanvasHyperlinks*)&__ICanvasHyperlinks; }
	#endif
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TSVGExportFormat : public Fmxtee::Editor::Export::TTeeExportFormat
{
...
public:
	/* TTeeExportFormat.Create */ inline __fastcall virtual TSVGExportFormat() : Fmxtee::Editor::Export::TTeeExportFormat() { }
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE void __fastcall TeeSaveToSVGFile(Fmxtee::Procs::TCustomTeePanel* const APanel, System::UnicodeString FileName, int AWidth = 0x0, int AHeight = 0x0);
}	/* namespace Svg */
}	/* namespace Canvas */
}	/* namespace Fmxtee */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXTEE_CANVAS_SVG)
using namespace Fmxtee::Canvas::Svg;
#endif
