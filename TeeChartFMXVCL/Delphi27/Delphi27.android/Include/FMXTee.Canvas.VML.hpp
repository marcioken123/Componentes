...
// (DO NOT EDIT: machine generated header) 'FMXTee.Canvas.VML.pas' rev: 34.00 (Android)

#ifndef Fmxtee_Canvas_VmlHPP
#define Fmxtee_Canvas_VmlHPP
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TVMLCanvas : public Fmxtee::Canvas::TTeeNeutralCanvas
{
...
public:
	/* TTeeNeutralCanvas.Create */ inline __fastcall virtual TVMLCanvas() : Fmxtee::Canvas::TTeeNeutralCanvas() { }
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TVMLExportFormat : public Fmxtee::Editor::Export::TTeeExportFormat
{
...
public:
	/* TTeeExportFormat.Create */ inline __fastcall virtual TVMLExportFormat() : Fmxtee::Editor::Export::TTeeExportFormat() { }
	
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TVMLExportFormat() { }
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE void __fastcall TeeSaveToVMLFile(Fmxtee::Procs::TCustomTeePanel* const APanel, const System::UnicodeString FileName, int AWidth = 0x0, int AHeight = 0x0);
}	/* namespace Vml */
}	/* namespace Canvas */
}	/* namespace Fmxtee */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXTEE_CANVAS_VML)
using namespace Fmxtee::Canvas::Vml;
#endif
