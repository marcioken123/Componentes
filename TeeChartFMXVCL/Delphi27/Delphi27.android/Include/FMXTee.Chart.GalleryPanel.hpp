...
// (DO NOT EDIT: machine generated header) 'FMXTee.Chart.GalleryPanel.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Int8 TeeGalleryNumRows = System::Int8(0x0);
static constexpr System::Int8 TeeGalleryNumCols = System::Int8(0x4);
static constexpr short TeeCursorDisabled = short(-18);
#define TeeMsg_GalleryRender u"GalleryRender"
