...
// (DO NOT EDIT: machine generated header) 'FMXTee.Chart.pas' rev: 34.00 (Android)
...
protected:
	...
	virtual void __fastcall DrawLegendShape(const System::Types::TRectF &Rect, Fmx::Graphics::TBitmap* const AGraphic = (Fmx::Graphics::TBitmap*)(0x0));
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TTeeToolTypes : public System::Generics::Collections::TList__1<Fmxtee::Engine::TTeeCustomToolClass>
{
	typedef System::Generics::Collections::TList__1<Fmxtee::Engine::TTeeCustomToolClass> inherited;
	
public:
	/* {System_Generics_Collections}TList<FMXTee_Engine_TTeeCustomToolClass>.Create */ inline __fastcall TTeeToolTypes()/* overload */ : System::Generics::Collections::TList__1<Fmxtee::Engine::TTeeCustomToolClass>() { }
	/* {System_Generics_Collections}TList<FMXTee_Engine_TTeeCustomToolClass>.Create */ inline __fastcall TTeeToolTypes(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<Fmxtee::Engine::TTeeCustomToolClass> > AComparer)/* overload */ : System::Generics::Collections::TList__1<Fmxtee::Engine::TTeeCustomToolClass>(AComparer) { }
	/* {System_Generics_Collections}TList<FMXTee_Engine_TTeeCustomToolClass>.Create */ inline __fastcall TTeeToolTypes(System::Generics::Collections::TEnumerable__1<Fmxtee::Engine::TTeeCustomToolClass>* const Collection)/* overload */ : System::Generics::Collections::TList__1<Fmxtee::Engine::TTeeCustomToolClass>(Collection) { }
	/* {System_Generics_Collections}TList<FMXTee_Engine_TTeeCustomToolClass>.Destroy */ inline __fastcall virtual ~TTeeToolTypes() { }
...
private:
	typedef System::DynamicArray<System::Uitypes::TAlphaColor> _TColorPalette__1;
...
private:
	...
	void __fastcall Add(const System::UnicodeString AName, const System::Uitypes::TAlphaColor *APalette, const int APalette_High);
	void __fastcall CopyPalette(const int Index, const System::Uitypes::TAlphaColor *APalette, const int APalette_High);
...
public:
	...
	__classmethod void __fastcall RegisterPalette(const System::UnicodeString AName, const System::Uitypes::TAlphaColor *APalette, const int APalette_High);
...
//-- var, const, procedure ---------------------------------------------------
#define TeeMsg_DefaultFunctionName u"TeeFunction"
#define TeeMsg_DefaultSeriesName u"Series"
#define TeeMsg_DefaultToolName u"ChartTool"
#define TeeMsg_DefaultAnimationName u"ChartAnimation"
#define ChartComponentPalette u"TeeChart"
static constexpr System::Int8 TeeMaxLegendColumns = System::Int8(0x3);
static constexpr System::Int8 TeeDefaultLegendSymbolHeight = System::Int8(0x64);
static constexpr System::Int8 TeeDefaultLegendSymbolWidth = System::Int8(0x14);
static constexpr System::Int8 TeeTitleFootDistance = System::Int8(0x5);
static constexpr System::Word TeeAllComponentPlatformIDs = System::Word(0x945f);
...
extern DELPHI_PACKAGE System::StaticArray<System::Uitypes::TAlphaColor, 10> ActivityPalette;
...
extern DELPHI_PACKAGE void __fastcall RegisterTeeTools(Fmxtee::Engine::TTeeCustomToolClass *ATools, const int ATools_High);
extern DELPHI_PACKAGE void __fastcall UnRegisterTeeTools(Fmxtee::Engine::TTeeCustomToolClass *ATools, const int ATools_High);
extern DELPHI_PACKAGE void __fastcall RegisterTeeAnimations(Fmxtee::Engine::TTeeCustomAnimationClass *AAnimations, const int AAnimations_High);
extern DELPHI_PACKAGE void __fastcall UnRegisterTeeAnimations(Fmxtee::Engine::TTeeCustomAnimationClass *AAnimations, const int AAnimations_High);
