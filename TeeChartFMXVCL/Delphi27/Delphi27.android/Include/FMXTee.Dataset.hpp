...
// (DO NOT EDIT: machine generated header) 'FMXTee.Dataset.pas' rev: 34.00 (Android)
...
protected:
	...
	bool __fastcall GetSeriesBuffer(int FieldIndex, TSeriesPoint &Active, System::TArray__1<System::Byte> &Buffer, Fmxtee::Engine::TChartSeries* const Series);
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Byte MaxLabelLen = System::Byte(0x80);
}	/* namespace Dataset */
}	/* namespace Fmxtee */
