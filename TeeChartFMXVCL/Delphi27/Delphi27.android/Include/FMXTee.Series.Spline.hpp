...
// (DO NOT EDIT: machine generated header) 'FMXTee.Series.Spline.pas' rev: 34.00 (Android)

#ifndef Fmxtee_Series_SplineHPP
#define Fmxtee_Series_SplineHPP
...
public:
	...
	__fastcall TBSpline(const System::Types::TPointF *P, const int P_High)/* overload */;
...
class PASCALIMPLEMENTATION TSmoothingFunction : public Fmxtee::Engine::TTeeFunction
{
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word MaxFragments = System::Word(0x258);
static constexpr System::Word MaxResults = System::Word(0x262);
static constexpr System::Byte MaxCalcSteps = System::Byte(0x96);
static constexpr System::Int8 MaxIterations = System::Int8(0x50);
static constexpr System::Int8 VerticesIncrement = System::Int8(0x5);
}	/* namespace Spline */
}	/* namespace Series */
}	/* namespace Fmxtee */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXTEE_SERIES_SPLINE)
using namespace Fmxtee::Series::Spline;
#endif
