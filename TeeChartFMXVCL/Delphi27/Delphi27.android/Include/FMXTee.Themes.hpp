...
// (DO NOT EDIT: machine generated header) 'FMXTee.Themes.pas' rev: 34.00 (Android)
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TThemesList : public System::Generics::Collections::TList__1<Fmxtee::Chart::TChartThemeClass>
{
	typedef System::Generics::Collections::TList__1<Fmxtee::Chart::TChartThemeClass> inherited;
...
public:
	/* {System_Generics_Collections}TList<FMXTee_Chart_TChartThemeClass>.Create */ inline __fastcall TThemesList()/* overload */ : System::Generics::Collections::TList__1<Fmxtee::Chart::TChartThemeClass>() { }
	/* {System_Generics_Collections}TList<FMXTee_Chart_TChartThemeClass>.Create */ inline __fastcall TThemesList(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<Fmxtee::Chart::TChartThemeClass> > AComparer)/* overload */ : System::Generics::Collections::TList__1<Fmxtee::Chart::TChartThemeClass>(AComparer) { }
	/* {System_Generics_Collections}TList<FMXTee_Chart_TChartThemeClass>.Create */ inline __fastcall TThemesList(System::Generics::Collections::TEnumerable__1<Fmxtee::Chart::TChartThemeClass>* const Collection)/* overload */ : System::Generics::Collections::TList__1<Fmxtee::Chart::TChartThemeClass>(Collection) { }
	/* {System_Generics_Collections}TList<FMXTee_Chart_TChartThemeClass>.Destroy */ inline __fastcall virtual ~TThemesList() { }
...
//-- var, const, procedure ---------------------------------------------------
#define TeeMsg_ThemesPath u"FMXThemesPath"
