...
// (DO NOT EDIT: machine generated header) 'FMXTee.Tools.pas' rev: 34.00 (Android)
...
_DECLARE_METACLASS(System::TMetaClass, TDrawLineClass);
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Int8 TeeClickTolerance = System::Int8(0x3);
static constexpr System::Uitypes::TAlphaColor clTeeScrollBar = System::Uitypes::TAlphaColor(0xf0f0f0);
static constexpr System::Int8 DefaultScrollBarSize = System::Int8(0x12);
