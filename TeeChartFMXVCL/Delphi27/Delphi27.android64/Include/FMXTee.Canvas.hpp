...
// (DO NOT EDIT: machine generated header) 'FMXTee.Canvas.pas' rev: 34.00 (Android)
...
_DECLARE_ARITH_TYPE_ALIAS(System::Int8, TTeeTransparency);
...
public:
	...
	static System::Uitypes::TAlphaColor __fastcall SystemColor(const System::Uitypes::TAlphaColor AColor);
...
public:
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	System::Types::TPointF __fastcall Point();
	__property System::Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Int8 TeeDefaultPerspective = System::Int8(0xf);
static constexpr System::Word TeeMinAngle = System::Word(0x10e);
static constexpr System::Int8 TeeCheckBoxSize = System::Int8(0xb);
...
#define TeeFontElektra u"Elektra"
#define TeeFontDigital u"DS-Digital"
...
static constexpr unsigned clDkGray = unsigned(0xffa9a9a9);
static constexpr unsigned clNone = unsigned(0x0);
static constexpr System::Uitypes::TAlphaColor clDefault = System::Uitypes::TAlphaColor(0xffffff);
static constexpr System::Int8 pf32Bit = System::Int8(0x0);
static constexpr System::WideChar TeeCharForHeight = (System::WideChar)(0x57);
...
static constexpr System::Int8 TeePixelFormat = System::Int8(0x0);
...
extern DELPHI_PACKAGE System::Generics::Collections::TList__1<TCanvas3DClass>* TeeRenderClasses;
