...
// (DO NOT EDIT: machine generated header) 'FMXTee.Procs.pas' rev: 34.00 (iOSSIM)
...
public:
	...
	__classmethod void __fastcall ParallelFor(int nMin, int nMax, int nThreads, TParallelProc aProc)/* overload */;
