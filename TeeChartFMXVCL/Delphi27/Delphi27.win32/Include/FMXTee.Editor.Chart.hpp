...
// (DO NOT EDIT: machine generated header) 'FMXTee.Editor.Chart.pas' rev: 34.00 (Windows)
...
__published:
	...
	void __fastcall LabelViewClick(System::TObject* Sender);
	void __fastcall PanBottomResize(System::TObject* Sender);
	
private:
	Fmx::Forms::TForm* FLastForm;
	Fmxtee::Chart::Grid::TChartGrid* FChartGrid;
	Fmx::Treeview::TTreeViewItem* AnimsNode;
	Fmx::Treeview::TTreeViewItem* ToolsNode;
	Fmx::Treeview::TTreeViewItem* ImportNode;
	Fmx::Treeview::TTreeViewItem* ThemesNode;
	void __fastcall AddSeries(Fmxtee::Engine::TChartSeries* const ASeries);
	Fmxtee::Engine::TSeriesGroup* __fastcall CurrentGroup();
	void __fastcall DestroyGrid();
	void __fastcall DestroyPreviousForm();
