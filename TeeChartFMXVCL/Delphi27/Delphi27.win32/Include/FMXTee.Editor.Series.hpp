...
// (DO NOT EDIT: machine generated header) 'FMXTee.Editor.Series.pas' rev: 34.00 (Windows)
...
__published:
	...
	Fmx::Tabcontrol::TTabItem* TabMarksStyle;
	...
	Fmx::Tabcontrol::TTabItem* TabTail;
	Fmx::Stdctrls::TCheckBox* CBTailVisible;
	Fmx::Stdctrls::TLabel* Label8;
	Fmx::Spinbox::TSpinBox* SBTailHeight;
	Fmx::Stdctrls::TLabel* Label9;
	Fmx::Spinbox::TSpinBox* SBTailWidth;
	Fmx::Stdctrls::TLabel* Label10;
	Fmx::Spinbox::TSpinBox* SBTailMargin;
	Fmx::Stdctrls::TGroupBox* GroupBox2;
	Fmx::Stdctrls::TCheckBox* CBTailAuto;
	Fmx::Stdctrls::TLabel* Label13;
	Fmx::Listbox::TComboBox* CBTailEdge;
	Fmx::Stdctrls::TLabel* Label14;
	Fmx::Listbox::TComboBox* CBTailAlign;
	...
	void __fastcall SBTailHeightChangeTracking(System::TObject* Sender);
	void __fastcall CBTailVisibleChange(System::TObject* Sender);
	void __fastcall SBTailWidthChangeTracking(System::TObject* Sender);
	void __fastcall SBTailMarginChangeTracking(System::TObject* Sender);
	void __fastcall CBTailEdgeChange(System::TObject* Sender);
	void __fastcall CBTailAutoChange(System::TObject* Sender);
	void __fastcall CBTailAlignChange(System::TObject* Sender);
	void __fastcall FormDestroy(System::TObject* Sender);
	
private:
	Fmxtee::Engine::TChartSeries* Series;
	bool ChangingSeries;
	TFormClass FunctionEditorClass;
	...
	int __fastcall IndexOfSource(const Fmxtee::Engine::TTeeSeriesSourceClass ASource);
	...
	void __fastcall RefreshTailAlign(Fmxtee::Engine::TMarksTail* const ATail);
	void __fastcall RemoveAllSources();
