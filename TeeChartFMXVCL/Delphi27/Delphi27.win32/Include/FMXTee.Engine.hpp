...
// (DO NOT EDIT: machine generated header) 'FMXTee.Engine.pas' rev: 34.00 (Windows)
...
private:
	...
	void __fastcall DoDrawText(Fmxtee::Procs::TCustomTeePanel* const Panel, const System::Types::TRectF &Rect, int Angle = 0x0, int AZ = 0x0);
...
protected:
	...
	virtual void __fastcall DoDraw(Fmxtee::Procs::TCustomTeePanel* const Panel, const System::Types::TRectF &Rect, int Angle = 0x0, int AZ = 0x0)/* overload */;
	virtual void __fastcall DoDraw(Fmxtee::Procs::TCustomTeePanel* const Panel, const Fmxtee::Canvas::TPointArray Points, const System::Types::TRectF &Rect, int Angle = 0x0, int AZ = 0x0)/* overload */;
...
public:
	...
	__property Fmxtee::Canvas::TTeePicture* Picture = {read=FPicture};
...
private:
	...
	TAxisItem* __fastcall InternalAdd(const double Value, const System::UnicodeString Text = System::UnicodeString(), Fmxtee::Canvas::TTeePicture* const APicture = (Fmxtee::Canvas::TTeePicture*)(0x0));
...
private:
	...
	bool __fastcall CalcIsDateTime(const Fmxtee::Procs::TDateTimeStep ADateTime);
	void __fastcall CalcRoundScales();
	int __fastcall DepthAxisAlign();
	int __fastcall DepthAxisPos();
	bool __fastcall GetAxisSeriesLabel(const TAxisLabelStyle AStyle, TChartSeries* const ASeries, int AIndex, /* out */ double &AValue, /* out */ System::UnicodeString &ALabel, /* out */ Fmxtee::Canvas::TTeePicture* &APicture);
	...
	bool __fastcall IncDec(bool Increment, double &Value, const double AnIncrement, const Fmxtee::Procs::TDateTimeStep ADateTime)/* overload */;
...
public:
	...
	void __fastcall DrawAxisLabel(int x, int y, int Angle, const System::UnicodeString St, TCustomTextShape* Format = (TCustomTextShape*)(0x0), int z = 0x0, Fmxtee::Canvas::TTeePicture* const APicture = (Fmxtee::Canvas::TTeePicture*)(0x0), int ItemIndex = 0xffffffff);
...
public:
	...
	HIDESBASE TTeeCustomTool* __fastcall Add(TTeeCustomToolClass Tool)/* overload */;
	HIDESBASE void __fastcall Clear();
...
public:
	...
	inline TTeeCustomTool* __fastcall  Add(TTeeCustomToolClass Tool){ return TChartTools::Add(Tool); }
...
protected:
	...
	virtual void __fastcall DrawLegendShape(const System::Types::TRectF &Rect, Fmx::Graphics::TBitmap* const AGraphic = (Fmx::Graphics::TBitmap*)(0x0)) = 0 ;
...
private:
	bool FAutoAlign;
	bool FCustomPoint;
	System::Types::TPointF FCustomPointPos;
	int FHeight;
	TTailAlign FAlign;
	int FMargin;
	bool FVisible;
	...
	Fmxtee::Canvas::TPointArray __fastcall GetPoints(const System::Types::TRectF &R, const System::Types::TPointF &AFrom, const System::Types::TPointF &ATo)/* overload */;
	Fmxtee::Canvas::TPointArray __fastcall GetPoints(const TTailAlign align, const System::Types::TRectF &R)/* overload */;
	void __fastcall SetAlign(const TTailAlign Value);
	void __fastcall SetCustomPoint(bool Value);
	void __fastcall SetCustomPointPos(const System::Types::TPointF &Value);
...
public:
	...
	__property System::Types::TPointF CustomPointPos = {read=FCustomPointPos, write=SetCustomPointPos};
...
private:
	...
	HIDESBASE void __fastcall InternalDraw(int Index, System::Uitypes::TAlphaColor AColor, const System::UnicodeString AText, TSeriesMarkPosition* APosition);
	void __fastcall ReadItems(System::Classes::TStream* Stream);
...
enum DECLSPEC_DENUM Fmxtee_Engine__94 : unsigned char { rOnDelete, rOnModify, rOnInsert, rOnClear };

typedef System::Set<Fmxtee_Engine__94, Fmxtee_Engine__94::rOnDelete, Fmxtee_Engine__94::rOnClear> TSeriesRecalcOptions;
...
enum DECLSPEC_DENUM Fmxtee_Engine__45 : unsigned char { tssIsTemplate, tssDenyChangeType, tssDenyDelete, tssDenyClone, tssIsPersistent, tssHideDataSource };

typedef System::Set<Fmxtee_Engine__45, Fmxtee_Engine__45::tssIsTemplate, Fmxtee_Engine__45::tssHideDataSource> TChartSeriesStyle;
...
private:
	typedef System::DynamicArray<Fmxtee::Canvas::TTeePicture*> _TTeePictureList__1;
	
	
public:
	Fmxtee::Canvas::TTeePicture* operator[](const int Index) { return this->Items[Index]; }
	
private:
	_TTeePictureList__1 List;
	TChartSeries* Series;
	void __fastcall Delete(const int ValueIndex);
	Fmxtee::Canvas::TTeePicture* __fastcall Get(const int ValueIndex);
	void __fastcall Put(const int ValueIndex, Fmxtee::Canvas::TTeePicture* const APicture);
	void __fastcall Insert(const int ValueIndex, Fmxtee::Canvas::TTeePicture* const APicture);
...
public:
	...
	static Fmxtee::Canvas::TTeePicture* __fastcall Copy(Fmxtee::Canvas::TTeePicture* const APicture);
	static Fmxtee::Canvas::TTeePicture* __fastcall FromGraphic(Fmx::Graphics::TBitmap* const AGraphic);
	int __fastcall IndexOf(Fmxtee::Canvas::TTeePicture* const APicture);
	__property Fmxtee::Canvas::TTeePicture* Items[const int Index] = {read=Get, write=Put/*, default*/};
public:
...
private:
	...
	Fmxtee::Procs::TBackImage* __fastcall GetImage();
	...
	void __fastcall SetImage(Fmxtee::Procs::TBackImage* const Value);
...
public:
	...
	__property Fmxtee::Procs::TBackImage* Image = {read=GetImage, write=SetImage};
...
//-- var, const, procedure ---------------------------------------------------
static const unsigned ChartMarkColor = unsigned(0xffffffe1);
...
static const System::Uitypes::TAlphaColor clTeeColor = System::Uitypes::TAlphaColor(0xffffff);
