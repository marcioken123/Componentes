...
// (DO NOT EDIT: machine generated header) 'VCLTee.Chart.pas' rev: 34.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall RegisterTeeTools(Vcltee::Teengine::TTeeCustomToolClass *ATools, const int ATools_High);
extern DELPHI_PACKAGE void __fastcall UnRegisterTeeTools(Vcltee::Teengine::TTeeCustomToolClass *ATools, const int ATools_High);
extern DELPHI_PACKAGE void __fastcall RegisterTeeAnimations(Vcltee::Teengine::TTeeCustomAnimationClass *AAnimations, const int AAnimations_High);
extern DELPHI_PACKAGE void __fastcall UnRegisterTeeAnimations(Vcltee::Teengine::TTeeCustomAnimationClass *AAnimations, const int AAnimations_High);
