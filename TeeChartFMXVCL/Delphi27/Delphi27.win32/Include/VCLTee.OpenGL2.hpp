...
extern DELPHI_PACKAGE void __stdcall (*glDeleteRenderbuffersEXT)(int n, const PGLuint renderbuffers);
extern DELPHI_PACKAGE void __stdcall (*glGenRenderbuffersEXT)(int n, PGLuint renderbuffers);
...
extern DELPHI_PACKAGE void __stdcall (*glDeleteFramebuffersEXT)(int n, const PGLuint framebuffers);
extern DELPHI_PACKAGE void __stdcall (*glGenFramebuffersEXT)(int n, PGLuint framebuffers);
...
extern DELPHI_PACKAGE void __stdcall (*glDeleteProgram)(unsigned p);
extern DELPHI_PACKAGE void __stdcall (*glLinkProgram)(unsigned p);
extern DELPHI_PACKAGE void __stdcall (*glUseProgram)(unsigned p);
extern DELPHI_PACKAGE unsigned __stdcall (*glCreateShader)(unsigned shaderType);
...
extern DELPHI_PACKAGE void __stdcall (*glAttachShader)(unsigned p, unsigned shader);
extern DELPHI_PACKAGE void __stdcall (*glShaderSource)(unsigned shader, int size, const PGLChars source, const PGLint length);
extern DELPHI_PACKAGE void __stdcall (*glGetShaderInfoLog)(unsigned shader, int size, int length, char * log);
extern DELPHI_PACKAGE void __stdcall (*glGetShaderiv)(unsigned shader, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramInfoLog)(unsigned shader, int size, int length, char * log);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramiv)(unsigned prog, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glActiveTexture)(unsigned target);
extern DELPHI_PACKAGE int __stdcall (*glGetUniformLocation)(unsigned prog, const char * name);
extern DELPHI_PACKAGE void __stdcall (*glUniform1i)(int location, int value);
