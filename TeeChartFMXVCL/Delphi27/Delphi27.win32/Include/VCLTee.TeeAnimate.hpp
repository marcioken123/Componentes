...
// (DO NOT EDIT: machine generated header) 'VCLTee.TeeAnimate.pas' rev: 34.00 (Windows)

#ifndef Vcltee_TeeanimateHPP
#define Vcltee_TeeanimateHPP
...
typedef System::TMetaClass* TTeeAnimationClass;
...
public:
	/* {System_Generics_Collections}TObjectList<VCLTee_TeeAnimate_TTeeAnimation>.Create */ inline __fastcall TAnimations()/* overload */ : System::Generics::Collections::TObjectList__1<TTeeAnimation*>() { }
	/* {System_Generics_Collections}TObjectList<VCLTee_TeeAnimate_TTeeAnimation>.Create */ inline __fastcall TAnimations(bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTeeAnimation*>(AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCLTee_TeeAnimate_TTeeAnimation>.Create */ inline __fastcall TAnimations(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTeeAnimation*> > AComparer, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTeeAnimation*>(AComparer, AOwnsObjects) { }
	/* {System_Generics_Collections}TObjectList<VCLTee_TeeAnimate_TTeeAnimation>.Create */ inline __fastcall TAnimations(System::Generics::Collections::TEnumerable__1<TTeeAnimation*>* const Collection, bool AOwnsObjects)/* overload */ : System::Generics::Collections::TObjectList__1<TTeeAnimation*>(Collection, AOwnsObjects) { }
	
public:
	/* {System_Generics_Collections}TList<VCLTee_TeeAnimate_TTeeAnimation>.Create */ inline __fastcall TAnimations(const System::DelphiInterface<System::Generics::Defaults::IComparer__1<TTeeAnimation*> > AComparer)/* overload */ : System::Generics::Collections::TObjectList__1<TTeeAnimation*>(AComparer) { }
	/* {System_Generics_Collections}TList<VCLTee_TeeAnimate_TTeeAnimation>.Create */ inline __fastcall TAnimations(System::Generics::Collections::TEnumerable__1<TTeeAnimation*>* const Collection)/* overload */ : System::Generics::Collections::TObjectList__1<TTeeAnimation*>(Collection) { }
...
private:
	typedef System::DynamicArray<PTimerEvent> _TMultiTimer__1;
...
private:
	bool FInverted;
	Vcltee::Tecanvas::TDoubleArray ICurve;
...
public:
	Vcltee::Tecanvas::TDoubleArray X;
	Vcltee::Tecanvas::TDoubleArray Y;
...
private:
	...
	System::Uitypes::TColor __fastcall GetEnd();
	System::Uitypes::TColor __fastcall GetStart();
	void __fastcall SetEnd(const System::Uitypes::TColor Value);
	void __fastcall SetStart(const System::Uitypes::TColor Value);
	
protected:
	virtual void __fastcall NextFrame(const float Fraction);
	
public:
	__property System::Uitypes::TColor EndColor = {read=GetEnd, write=SetEnd, nodefault};
	__property System::Uitypes::TColor StartColor = {read=GetStart, write=SetStart, nodefault};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLTEE_TEEANIMATE)
using namespace Vcltee::Teeanimate;
#endif
