...
__published:
	...
	Vcl::Comctrls::TTabSheet* TabTail;
	Vcl::Stdctrls::TCheckBox* CBTailVisible;
	Vcl::Stdctrls::TLabel* Label8;
	Vcl::Stdctrls::TLabel* Label9;
	Vcl::Stdctrls::TEdit* ETailHeight;
	Vcl::Comctrls::TUpDown* UDTailHeight;
	Vcl::Stdctrls::TEdit* ETailWidth;
	Vcl::Comctrls::TUpDown* UDTailWidth;
	Vcl::Stdctrls::TLabel* Label10;
	Vcl::Stdctrls::TEdit* ETailMargin;
	Vcl::Comctrls::TUpDown* UDTailMargin;
	Vcl::Stdctrls::TGroupBox* GroupBox2;
	Vcl::Stdctrls::TLabel* LHorizAlign;
	Vcl::Stdctrls::TComboBox* CBTailEdge;
	Vcl::Stdctrls::TCheckBox* CBAlign;
	Vcl::Stdctrls::TLabel* LVertAlign;
	Vcl::Stdctrls::TComboBox* CBTailAlign;
	...
	void __fastcall CBTailVisibleClick(System::TObject* Sender);
	void __fastcall ETailHeightChange(System::TObject* Sender);
	void __fastcall ETailWidthChange(System::TObject* Sender);
	void __fastcall ETailMarginChange(System::TObject* Sender);
...
private:
	...
	void __fastcall EnableTailAlign();
	...
	void __fastcall SetTailProperties(Vcltee::Teengine::TMarksTail* const ATail);
