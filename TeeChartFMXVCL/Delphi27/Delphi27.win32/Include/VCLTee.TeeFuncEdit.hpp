...
private:
	...
	__classmethod Vcl::Forms::TForm* __fastcall CreateFunctionEditor(System::Classes::TComponent* const AOwner, const System::UnicodeString EditorClass);
...
public:
	...
	__classmethod bool __fastcall EditFunction(System::Classes::TComponent* const AOwner, Vcltee::Teengine::TTeeFunction* const AFunction);
	Vcltee::Teengine::TTeeFunctionClass __fastcall FunctionClass();
	__classmethod void __fastcall SetValueListCombo(Vcltee::Teengine::TChartSeries* const Series, Vcltee::Tecanvas::TComboFlat* const Combo);
