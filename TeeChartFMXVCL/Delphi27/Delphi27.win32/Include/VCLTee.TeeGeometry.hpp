...
static const System::Extended EPSILON = 1.000000E-100;
static const System::Extended EPSILON2 = 1.000000E-50;
extern DELPHI_PACKAGE float __fastcall VectorLength(const float *V, const int V_High);
extern DELPHI_PACKAGE float __fastcall VectorAngle(const TAffineFltVector &V1, const TAffineFltVector &V2);
...
extern DELPHI_PACKAGE TQuaternion __fastcall QuaternionFromPoints(const TAffineFltVector &V1, const TAffineFltVector &V2);
extern DELPHI_PACKAGE TQuaternion __fastcall QuaternionMultiply(const TQuaternion &qL, const TQuaternion &qR);
extern DELPHI_PACKAGE void __fastcall QuaternionToPoints(const TQuaternion &Q, THomogeneousFltVector &ArcFrom, THomogeneousFltVector &ArcTo);
extern DELPHI_PACKAGE float __fastcall VectorNorm(const float *V, const int V_High);
extern DELPHI_PACKAGE float __fastcall VectorNormalize(const float *V, const int V_High);
extern DELPHI_PACKAGE void __fastcall VectorScale(const float *V, const int V_High, const float Factor);
extern DELPHI_PACKAGE void __fastcall VectorNegate(const float *V, const int V_High);
...
extern DELPHI_PACKAGE TQuaternion __fastcall QuaternionSlerp(const TQuaternion &QStart, const TQuaternion &QEnd, int Spin, float t);
extern DELPHI_PACKAGE bool __fastcall MatrixDecompose(const THomogeneousFltMatrix &M, TTransformations &Tran);
}	/* namespace Teegeometry */
}	/* namespace Vcltee */
