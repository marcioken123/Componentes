...
// (DO NOT EDIT: machine generated header) 'VCLTee.TeePDFCanvas.pas' rev: 34.00 (Windows)

#ifndef Vcltee_TeepdfcanvasHPP
#define Vcltee_TeepdfcanvasHPP
...
public:
	__fastcall TPDFImageListEntry(Vcl::Graphics::TGraphic* const AGraphic);
...
private:
	...
	bool __fastcall EqualImages(Vcl::Graphics::TGraphic* const i1, Vcl::Graphics::TGraphic* const i2);
...
public:
	...
	int __fastcall Select(Vcl::Graphics::TGraphic* const AGraphic);
};
...
private:
	...
	void __fastcall DefineFontData(Vcl::Graphics::TFont* const AFont);
	
public:
	__fastcall TPDFFontListEntry(Vcl::Graphics::TFont* const AFont);
...
public:
	...
	__property int Count = {read=GetCount, nodefault};
	int __fastcall Select(Vcl::Graphics::TFont* const AFont);
};
...
public:
	__fastcall TPDFPattern(Vcltee::Tecanvas::TTeeGradient* const AGradient, const System::Types::TRect &ARect);
...
public:
	...
	__property int Count = {read=GetCount, nodefault};
	int __fastcall Select(Vcltee::Tecanvas::TTeeGradient* const AGradient, const System::Types::TRect &ARect);
};
...
class PASCALIMPLEMENTATION TPDFCanvas : public Vcltee::Tecanvas::TTeeNeutralCanvas
{
...
private:
	...
	Vcl::Graphics::TBitmap* IControl;
	bool IOwnsReference;
	bool IOwnsDoc;
	int IClipStack;
	System::UnicodeString __fastcall BrushProperties(Vcltee::Tecanvas::TTeeBrush* const ABrush, const System::Types::TRect &R)/* overload */;
	System::UnicodeString __fastcall BrushProperties(const System::Types::TRect &R)/* overload */;
	void __fastcall CheckReferenceCanvas();
	void __fastcall EndPenBrush();
	System::UnicodeString __fastcall FontProperties(Vcltee::Tecanvas::TTeeFont* const Font, /* out */ int &FontIndex);
	...
	System::UnicodeString __fastcall PenProperties(Vcltee::Tecanvas::TTeePen* const APen)/* overload */;
	System::UnicodeString __fastcall PointToStr(const System::Types::TPoint &P)/* overload */;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TPDFExportFormat : public Vcltee::Teeexport::TTeeExportFormat
{
...
private:
	...
	void __fastcall DrawTo(TPDFDocument* const APage, const System::Types::TRect &ARect, TPDFCanvas* const ACanvas = (TPDFCanvas*)(0x0));
...
public:
	...
	__classmethod System::Types::TRect __fastcall CalcRectangle(Vcltee::Teeprocs::TCustomTeePanel* const APanel, TPDFDocument* const ADocument, const TPDFPosition APosition, const System::Types::TRect &ABounds);
	virtual System::UnicodeString __fastcall Description();
	__classmethod void __fastcall Draw(TPDFCanvas* const ACanvas, Vcltee::Teeprocs::TCustomTeePanel* const APanel, const System::Types::TRect &ARect);
	...
	void __fastcall AddPanel(Vcltee::Teeprocs::TCustomTeePanel* APanel, int AWidth = 0x0, int AHeight = 0x0);
...
public:
	/* TTeeExportFormat.Destroy */ inline __fastcall virtual ~TPDFExportFormat() { }
...
extern DELPHI_PACKAGE void __fastcall TeeSaveToPDFFile(Vcltee::Teeprocs::TCustomTeePanel* const APanel, const System::UnicodeString FileName, int AWidth = 0x0, int AHeight = 0x0);
}	/* namespace Teepdfcanvas */
}	/* namespace Vcltee */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLTEE_TEEPDFCANVAS)
using namespace Vcltee::Teepdfcanvas;
#endif
