...
// (DO NOT EDIT: machine generated header) 'VCLTee.TeePyramid.pas' rev: 34.00 (Windows)

#ifndef Vcltee_TeepyramidHPP
#define Vcltee_TeepyramidHPP
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TPyramidSeries : public Vcltee::Teengine::TChartSeries
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLTEE_TEEPYRAMID)
using namespace Vcltee::Teepyramid;
#endif
