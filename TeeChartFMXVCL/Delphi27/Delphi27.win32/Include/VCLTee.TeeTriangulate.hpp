...
// (DO NOT EDIT: machine generated header) 'VCLTee.TeeTriangulate.pas' rev: 34.00 (Windows)

#ifndef Vcltee_TeetriangulateHPP
#define Vcltee_TeetriangulateHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLTEE_TEETRIANGULATE)
using namespace Vcltee::Teetriangulate;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcltee_TeetriangulateHPP
