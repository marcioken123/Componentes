...
// (DO NOT EDIT: machine generated header) 'FMXTreeReg.pas' rev: 34.00 (Windows)

#ifndef FmxtreeregHPP
#define FmxtreeregHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXTREEREG)
using namespace Fmxtreereg;
#endif
#pragma pack(pop)
#pragma option pop
