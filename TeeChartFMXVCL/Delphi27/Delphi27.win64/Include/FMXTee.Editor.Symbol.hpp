...
// (DO NOT EDIT: machine generated header) 'FMXTee.Editor.Symbol.pas' rev: 34.00 (Windows)
...
__published:
	...
	Fmx::Stdctrls::TCheckBox* CBImages;
	...
	void __fastcall CBImagesChange(System::TObject* Sender);
