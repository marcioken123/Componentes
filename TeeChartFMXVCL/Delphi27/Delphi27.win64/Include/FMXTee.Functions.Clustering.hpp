...
// (DO NOT EDIT: machine generated header) 'FMXTee.Functions.Clustering.pas' rev: 34.00 (Windows)

#ifndef Fmxtee_Functions_ClusteringHPP
#define Fmxtee_Functions_ClusteringHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXTEE_FUNCTIONS_CLUSTERING)
using namespace Fmxtee::Functions::Clustering;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmxtee_Functions_ClusteringHPP
