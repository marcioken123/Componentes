...
// (DO NOT EDIT: machine generated header) 'FMXTee.Procs.pas' rev: 34.00 (Windows)
...
typedef System::Int8 TBevelWidth;
...
private:
	...
	Fmxtee::Canvas::TTeeFont* FGlobalFont;
	...
	Fmxtee::Canvas::TTeeFont* __fastcall GetDefaultFont();
	...
	void __fastcall SetDefaultFont(Fmxtee::Canvas::TTeeFont* const AFont);
...
protected:
	...
	System::Types::TRectF ICustomPrinterRect;
	...
	void __fastcall TryAssignFont(Fmxtee::Canvas::TTeeFont* const AFont);
...
public:
	...
	void __fastcall SaveToMetafileRect(const bool Enhanced, const System::UnicodeString FileName, const System::Types::TRectF &Rect);
	...
	TMetafile* __fastcall TeeCreateMetafile(const bool Enhanced, const System::Types::TRectF &Rect);
	...
	__property Fmxtee::Canvas::TTeeFont* DefaultFont = {read=GetDefaultFont, write=SetDefaultFont};
...
public:
	...
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	void __fastcall CorrectAspectRatio(const System::Types::TRectF &R, const float X, const float Y);
...
private:
	...
	void __fastcall DoDrawPoints(TCustomTeePanel* const Panel, const Fmxtee::Canvas::TPointArray P, const int AZ);
	void __fastcall InternalDraw(TCustomTeePanel* const Panel, const Fmxtee::Canvas::TPointArray Points, const System::Types::TRectF &Rect, bool UseRect, int Angle = 0x0, int AZ = 0x0);
...
protected:
	...
	Fmxtee::Canvas::TFourPoints FRotatedBounds;
	bool FDraw3D;
	...
	virtual void __fastcall DefineProperties(System::Classes::TFiler* Filer);
	virtual void __fastcall DoDraw(TCustomTeePanel* const Panel, const Fmxtee::Canvas::TPointArray Points, const System::Types::TRectF &Rect, int Angle = 0x0, int AZ = 0x0)/* overload */;
	virtual void __fastcall DoDraw(TCustomTeePanel* const Panel, const System::Types::TRectF &Rect, int Angle = 0x0, int AZ = 0x0)/* overload */;
...
public:
	...
	void __fastcall Draw(const System::Types::TRectF &Rect, const Fmxtee::Canvas::TPointArray Points, int Angle = 0x0, int AZ = 0x0)/* overload */;
	void __fastcall Draw(TCustomTeePanel* const Panel, const System::Types::TRectF &Rect, const Fmxtee::Canvas::TPointArray Points, int Angle = 0x0, int AZ = 0x0)/* overload */;
...
static const System::Int8 bsDialog = System::Int8(0x1);
static const System::Int8 bsSizeable = System::Int8(0x2);
...
static const System::Int8 TeeBorderStyle = System::Int8(0x2);
