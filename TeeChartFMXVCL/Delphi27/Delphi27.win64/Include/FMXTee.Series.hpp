...
// (DO NOT EDIT: machine generated header) 'FMXTee.Series.pas' rev: 34.00 (Windows)
...
#include <FMXTee.Series.Spline.hpp>
...
private:
	...
	bool FSmoothed;
	Fmxtee::Series::Spline::TSmoothingFunction* FSmoothFunction;
	...
	void __fastcall DrawVisual(const System::Types::TRectF &R, Fmxtee::Engine::TSeriesPointer* const AItem, Fmxtee::Canvas::TVisualBlock* const AVisual, const System::Uitypes::TAlphaColor AColor);
...
public:
	...
	__classmethod void __fastcall AdjustScreenRatio(Fmxtee::Canvas::TCanvas3D* const ACanvas, int AXRadius, int AYRadius, System::Types::TRectF &R, bool isPrint);
...
private:
	...
	Fmxtee::Engine::TTailEdge __fastcall GetMarkQuadrant(const double Angle, Fmxtee::Engine::TTailAlign &Align);
	Fmxtee::Canvas::TTeePen* __fastcall GetPiePen();
	Fmxtee::Engine::TChartValueList* __fastcall GetPieValues();
	System::Types::TPointF __fastcall GetTailEnd(const int x, const int y, const int margin, const int zPos, const Fmxtee::Engine::TTailAlign Align);
...
//-- var, const, procedure ---------------------------------------------------
static const System::Uitypes::TAlphaColor Tee_CircledShadowColor = System::Uitypes::TAlphaColor(0xa0a0a0);
static const System::Uitypes::TAlphaColor Tee_CircledEmbossColor = System::Uitypes::TAlphaColor(0xa0a0a0);
