...
// (DO NOT EDIT: machine generated header) 'Tee927.dpk' rev: 34.00 (Windows)
...
#include <VCLTee.TeeAbout.hpp>
#include <VCLTee.TeeSpline.hpp>
#include <VCLTee.TeeGDIPlus.hpp>
#include <VCLTee.TeeException.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_TEE927)
using namespace Tee927;
#endif
#pragma pack(pop)
#pragma option pop
