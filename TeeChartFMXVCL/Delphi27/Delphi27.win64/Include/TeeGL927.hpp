...
// (DO NOT EDIT: machine generated header) 'TeeGL927.dpk' rev: 34.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_TEEGL927)
using namespace Teegl927;
#endif
#pragma pack(pop)
#pragma option pop
