...
// (DO NOT EDIT: machine generated header) 'TeeImage927.dpk' rev: 34.00 (Windows)

#ifndef Teeimage927HPP
#define Teeimage927HPP
...
#include <VCLTee.TeePCX.hpp>
#include <VCLTee.TeeVMLCanvas.hpp>
#include <VCLTee.PCX.hpp>
#include <VCLTee.TeePDFCanvas.hpp>
#include <VCLTee.TeePDFOptions.hpp>
#include <VCLTee.TeeSVGCanvas.hpp>
#include <VCLTee.TeeSVGCanvasEditor.hpp>
#include <VCLTee.TeePSCanvas.hpp>
#include <VCLTee.TeeXAMLCanvas.hpp>
#include <VCLTee.TeeXAMLCanvasEditor.hpp>
#include <VCLTee.TeeFlexCanvas.hpp>
#include <VCLTee.TeeDosCommand.hpp>
#include <VCLTee.TeeVRML3D.hpp>
#include <VCLTee.TeeHTML5Canvas.hpp>
#include <VCLTee.TeeJavaScript.hpp>
#include <VCLTee.TeeJavascriptEditor.hpp>
...
namespace Teeimage927
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Teeimage927 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_TEEIMAGE927)
using namespace Teeimage927;
#endif
#pragma pack(pop)
#pragma option pop
