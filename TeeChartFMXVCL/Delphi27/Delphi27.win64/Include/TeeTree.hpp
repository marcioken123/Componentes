...
// (DO NOT EDIT: machine generated header) 'TeeTree.pas' rev: 34.00 (Windows)
...
private:
	...
	Vcltee::Teeprocs::TVertTextAlign FVertAlign;
	int FVertOffset;
	bool FVisible;
	...
	void __fastcall SetVertAlign(const Vcltee::Teeprocs::TVertTextAlign Value);
...
__published:
	...
	__property Vcltee::Teeprocs::TVertTextAlign VertAlign = {read=FVertAlign, write=SetVertAlign, default=0};
...
private:
	...
	Vcltee::Tecanvas::TTeeFont* __fastcall InternalFont();
	...
	void __fastcall SetVertTextAlign(Vcltee::Teeprocs::TVertTextAlign Value);
	...
	Vcltee::Teeprocs::TVertTextAlign __fastcall GetVertTextAlign();
...
protected:
	...
	void __fastcall SetColorProperty(System::Uitypes::TColor &Variable, const System::Uitypes::TColor Value);
...
public:
	...
	__property Vcltee::Tecanvas::TTeeFont* Font = {read=GetFont, write=SetFont, stored=IsFontStored};
	...
	__property Vcltee::Teeprocs::TVertTextAlign VertTextAlign = {read=GetVertTextAlign, write=SetVertTextAlign, nodefault};
public:
...
typedef System::StaticArray<System::Types::TPoint, 16> TRoundRectanglePoint;

typedef Vcltee::Tecanvas::TTeeGradient TShapeGradient;

typedef Vcltee::Tecanvas::TTeePen TTreePen;
...
_DECLARE_METACLASS(System::TMetaClass, TTreeConnectionClass);

typedef Vcltee::Tecanvas::TTeeBrush TTreeBrush;

class PASCALIMPLEMENTATION TTreeShapeBrush : public Vcltee::Tecanvas::TTeeBrush
{
...
typedef System::StaticArray<System::Types::TPoint, 100> TShapePoints;

_DECLARE_METACLASS(System::TMetaClass, TTreeNodeShapeClass);
...
private:
	...
	System::Types::TPoint FMagneticPos;
...
class PASCALIMPLEMENTATION TTreePicture : public Vcltee::Tecanvas::TTeePicture
{
...
public:
	/* TPicture.Create */ inline __fastcall TTreePicture() : Vcltee::Tecanvas::TTeePicture() { }
...
private:
	System::Types::TRect FAdjustedRect;
	bool FAutoSize;
	TTreeShapeAutoPosition* FAutoPosition;
	Vcltee::Tecanvas::TTeePen* FBorder;
	...
	void __fastcall GetTrianglePoints(const System::Types::TRect &R, const int MidX, const int MidY, TShapePoints &P);
	TTreeShapeBrush* __fastcall InternalBrush();
	bool __fastcall InternalClipText();
	virtual void __fastcall InternalDrawShadow(const System::Types::TRect &tmpR, Vcltee::Tecanvas::TCanvas3D* const ACanvas, const TTreeShapeStyle tmpStyle);
	void __fastcall InternalDrawShape(const System::Types::TRect &tmpR, Vcltee::Tecanvas::TCanvas3D* const ACanvas, TTreeShapeStyle tmpStyle);
	Vcltee::Tecanvas::TTeePen* __fastcall InternalPen();
	void __fastcall InternalSetImage(Vcl::Graphics::TPicture* const Value);
	...
	void __fastcall SetBorder(Vcltee::Tecanvas::TTeePen* const Value);
...
protected:
	...
	void __fastcall DrawGradient(const System::Types::TRect &Rect, Vcltee::Tecanvas::TCanvas3D* const ACanvas);
	void __fastcall DrawImage();
	void __fastcall DrawShape(const System::Types::TRect &R);
	...
	void __fastcall DrawText(Vcltee::Tecanvas::TCanvas3D* const ACanvas, System::Types::TRect &R);
	void __fastcall RecalcImageSize();
	TTreeShapeBrush* __fastcall GetBrush();
	DYNAMIC void __fastcall GetConnectionTo(const int pX0, const int pY0, const int pX1, const int pY1, int &AX, int &AY);
	DYNAMIC TTreeNodeShape* __fastcall GetEditedShape();
	DYNAMIC System::Uitypes::TCursor __fastcall GetHandleCursor(int x, int y);
	int __fastcall GetRoundRectanglePoints(const System::Types::TRect &R, TShapePoints &P);
	virtual int __fastcall GetShapePoints(const System::Types::TRect &R, TShapePoints &P);
	bool __fastcall HasCheckBox();
	void __fastcall PictureChanged(System::TObject* Sender);
	System::Types::TRect __fastcall RectTo3DCanvas(Vcltee::Tecanvas::TCanvas3D* const ACanvas, const System::Types::TRect &R);
	void __fastcall SetBounds(const System::Types::TRect &R);
	void __fastcall SetCanvasFont(Vcltee::Tecanvas::TCanvas3D* const ACanvas);
...
public:
	...
	__property System::Types::TRect AdjustedRectangle = {read=FAdjustedRect};
	...
	DYNAMIC void __fastcall DrawHandles();
	void __fastcall GetConnectionPos(TTreeNodeShape* const AShape, int &AX, int &AY);
	...
	int __fastcall XCenter();
	int __fastcall YCenter();
	...
	System::Types::TPoint __fastcall CalcXYCross(TTreeNodeShape* const AParent);
	...
	int __fastcall MaxHeightExpandedChilds();
	int __fastcall MinHeightExpandedChilds();
...
__published:
	...
	__property System::Uitypes::TColor BackColor = {read=GetBackColor, write=SetBackColor, default=536870911};
	__property Vcltee::Tecanvas::TTeePen* Border = {read=GetBorder, write=SetBorder, stored=IsBorderStored};
	...
	__property Vcltee::Tecanvas::TTeeGradient* Gradient = {read=GetGradient, write=SetGradient, stored=IsGradientStored};
	...
	__property Vcltee::Tecanvas::TTeeShadow* Shadow = {read=GetShadow, write=SetShadow, stored=IsShadowStored};
...
class PASCALIMPLEMENTATION TConnectionArrowBrush : public Vcltee::Tecanvas::TTeeBrush
{
	typedef Vcltee::Tecanvas::TTeeBrush inherited;
...
public:
	/* TTeeBrush.Create */ inline __fastcall virtual TConnectionArrowBrush(const System::Classes::TNotifyEvent OnChangeEvent) : Vcltee::Tecanvas::TTeeBrush(OnChangeEvent) { }
...
public:
	...
	int __fastcall Add(const System::Types::TPoint &P)/* overload */;
...
__published:
	__property System::Uitypes::TColor BackColor = {read=GetBackColor, write=SetBackColor, default=536870911};
	__property Vcltee::Tecanvas::TTeePen* Border = {read=GetBorder, write=SetBorder};
...
class PASCALIMPLEMENTATION TTreeConnectionPen : public Vcltee::Tecanvas::TTeePen
{
...
class PASCALIMPLEMENTATION TConnectionFormat : public Vcltee::Teeprocs::TTeeShape
{
...
public:
	/* TTeeCustomShape.Create */ inline __fastcall virtual TConnectionFormat(Vcltee::Teeprocs::TCustomTeePanel* const AOwner)/* overload */ : Vcltee::Teeprocs::TTeeShape(AOwner) { }
	/* TTeeCustomShape.Destroy */ inline __fastcall virtual ~TConnectionFormat() { }
	
};


typedef System::StaticArray<System::Types::TPoint, 100> TCurvePoints;
...
class PASCALIMPLEMENTATION TTreeSelectedPen : public Vcltee::Tecanvas::TTeePen
{
	typedef Vcltee::Tecanvas::TTeePen inherited;
...
class PASCALIMPLEMENTATION TTreeHiddenPen : public Vcltee::Tecanvas::TTeePen
{
	typedef Vcltee::Tecanvas::TTeePen inherited;
...
private:
	...
	System::Uitypes::TColor FColorUnFocused;
	bool FFullRedraw;
	...
	void __fastcall SetColorUnFocused(System::Uitypes::TColor Value);
	...
	void __fastcall SetHandleColor(const System::Uitypes::TColor Value);
...
__published:
	...
	__property System::Uitypes::TColor Color = {read=FColor, write=SetColor, default=8388608};
	__property System::Uitypes::TColor ColorUnFocused = {read=FColorUnFocused, write=SetColorUnFocused, default=8421504};
	__property bool FullRedraw = {read=FFullRedraw, write=SetFullRedraw, default=0};
	__property System::Uitypes::TColor HandleColor = {read=FHandleColor, write=SetHandleColor, default=0};
	...
	__property System::Uitypes::TColor TextColor = {read=FTextColor, write=SetTextColor, default=16777215};
};


class PASCALIMPLEMENTATION TTreeCrossBoxPen : public Vcltee::Tecanvas::TTeePen
{
	typedef Vcltee::Tecanvas::TTeePen inherited;
...
public:
	/* TTeePen.Create */ inline __fastcall TTreeCrossBoxPen(const System::Classes::TNotifyEvent OnChangeEvent) : Vcltee::Tecanvas::TTeePen(OnChangeEvent) { }
...
private:
	...
	int FClickTolerance;
	Vcltee::Tecanvas::TTeePen* FSignPen;
	...
	void __fastcall SetSignPen(Vcltee::Tecanvas::TTeePen* const Value);
...
public:
	...
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	void __fastcall Draw(const System::Types::TPoint &AtPoint, bool DrawExpanded);
...
__published:
	...
	__property Vcltee::Tecanvas::TTeePen* SignPen = {read=FSignPen, write=SetSignPen};
...
public:
	...
	Vcl::Controls::TMouseEvent FMouseDown;
	Vcl::Controls::TMouseEvent FMouseUp;
	Vcl::Controls::TMouseMoveEvent FMouseMove;
...
private:
	...
	TCustomTree* ITree;
	int ICode;
	int __fastcall CalcScrollOffset(int ScrollCode);
	bool __fastcall CanModifyBar();
...
typedef void __fastcall (__closure *TTreeZoomedAreaEvent)(const System::Types::TRect &R);
...
public:
	virtual System::Types::TPoint __fastcall CalcXYCross(TTreeNodeShape* const ANode, TTreeNodeShape* const AParent) = 0 ;
...
public:
	...
	virtual System::Types::TPoint __fastcall CalcXYCross(TTreeNodeShape* const ANode, TTreeNodeShape* const AParent);
...
class PASCALIMPLEMENTATION TTeeHotTrackFont : public Vcltee::Tecanvas::TTeeFont
{
	typedef Vcltee::Tecanvas::TTeeFont inherited;
	
__published:
	__property Style = {default=4};
public:
	/* TTeeFont.Create */ inline __fastcall TTeeHotTrackFont(System::Classes::TNotifyEvent ChangedEvent) : Vcltee::Tecanvas::TTeeFont(ChangedEvent) { }
...
__published:
	...
	__property Vcltee::Tecanvas::TTeePen* Border = {read=FBorder, write=SetBorder};
...
__published:
	...
	__property System::Uitypes::TColor Color = {read=FColor, write=SetColor, default=8421504};
...
class PASCALIMPLEMENTATION TTreePageBorder : public Vcltee::Tecanvas::TTeePen
{
	typedef Vcltee::Tecanvas::TTeePen inherited;
...
public:
	/* TTeePen.Create */ inline __fastcall TTreePageBorder(const System::Classes::TNotifyEvent OnChangeEvent) : Vcltee::Tecanvas::TTeePen(OnChangeEvent) { }
...
_DECLARE_METACLASS(System::TMetaClass, TPolygonShapeClass);
...
private:
	...
	int FResizingHandle;
	bool IsPolyLine;
	void __fastcall InternalDraw(Vcltee::Tecanvas::TCanvas3D* const ACanvas, const int OffsetX, const int OffsetY);
...
public:
	inline bool __fastcall  Clicked(const float x, const float y){ return TTreeNodeShape::Clicked(x, y); }
...
class PASCALIMPLEMENTATION TTreeAfterDrawEvent : public Vcltee::Teeprocs::TTeeEvent
{
	typedef Vcltee::Teeprocs::TTeeEvent inherited;
	
public:
	/* TObject.Create */ inline __fastcall TTreeAfterDrawEvent() : Vcltee::Teeprocs::TTeeEvent() { }
...
class PASCALIMPLEMENTATION TCustomTree : public Vcltee::Teeprocs::TCustomTeePanelExtended
{
...
private:
	...
	System::Types::TPoint IFromConnect;
	System::Types::TPoint IToConnect;
	...
	void __fastcall DrawConnecting(const int x, const int y, bool CheckPos);
	...
	System::Uitypes::TColor __fastcall GetGridColor();
	int __fastcall GetGridStep();
	Vcl::Stdctrls::TMemo* __fastcall GetMemo();
	TTreeNodeShape* __fastcall GetShape(int Index);
	...
	void __fastcall InternalSetFocus(bool Value);
	...
	System::Types::TRect __fastcall Rectangle2DPosition(const System::Types::TRect &R);
...
protected:
	...
	void __fastcall DrawDiamond(const System::Types::TRect &R);
	void __fastcall DrawGrid();
	void __fastcall DrawHandle(TCustomTreeElement* const Node, const TTreeShapeHandle Handle, int x, int y);
	...
	System::Types::TRect __fastcall PrepareGrid(int &tmpH, int &tmpV);
...
public:
	...
	void __fastcall Sort(bool Ascending = true, bool IgnoreCase = true);
	...
	void __fastcall ZoomRectangle(const System::Types::TRect &R);
	...
	__property System::Uitypes::TColor GridColor = {read=GetGridColor, write=SetGridColor, default=536870911};
	...
	__property Vcl::Stdctrls::TMemo* InternalMemo = {read=GetMemo};
	...
	__property System::Types::TRect TotalBounds = {read=IBounds};
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TCustomTree(HWND ParentWindow) : Vcltee::Teeprocs::TCustomTeePanelExtended(ParentWindow) { }
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTree(HWND ParentWindow) : TCustomTree(ParentWindow) { }
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TTreeClipboard(HWND ParentWindow) : TCustomTree(ParentWindow) { }
...
protected:
	int __fastcall GetPolygonPoints(int Sides, const System::Types::TRect &R, TShapePoints &P);
...
class PASCALIMPLEMENTATION TImageLevels : public Vcl::Controls::TImageList
{
	typedef Vcl::Controls::TImageList inherited;
	
private:
	TCustomTree* FTree;
	System::StaticArray<Vcl::Graphics::TPicture*, 101> IPictures;
	Vcl::Graphics::TPicture* __fastcall NewPicture(const int Level);
	void __fastcall SetTree(TCustomTree* const Value);
	
protected:
	void __fastcall ClearPictures();
	Vcl::Graphics::TPicture* __fastcall GetPicture(int Level);
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
...
public:
	/* TCustomImageList.Create */ inline __fastcall virtual TImageLevels(System::Classes::TComponent* AOwner) : Vcl::Controls::TImageList(AOwner) { }
	/* TCustomImageList.CreateSize */ inline __fastcall TImageLevels(int AWidth, int AHeight) : Vcl::Controls::TImageList(AWidth, AHeight) { }
...
class PASCALIMPLEMENTATION TCustomPanelTreeLink : public Vcl::Extctrls::TCustomPanel
{
	typedef Vcl::Extctrls::TCustomPanel inherited;
	
private:
	TCustomTree* FTree;
	virtual void __fastcall TeeEvent(Vcltee::Teeprocs::TTeeEvent* Event);
...
public:
	...
	__property TCustomTree* Tree = {read=FTree, write=SetTree};
public:
	/* TCustomPanel.Create */ inline __fastcall virtual TCustomPanelTreeLink(System::Classes::TComponent* AOwner) : Vcl::Extctrls::TCustomPanel(AOwner) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TCustomPanelTreeLink(HWND ParentWindow) : Vcl::Extctrls::TCustomPanel(ParentWindow) { }
...
private:
	Vcltee::Tecanvas::TTeePen* FMarker;
	...
	void __fastcall SetMarker(Vcltee::Tecanvas::TTeePen* const Value);
...
__published:
	__property Font;
	__property Vcltee::Tecanvas::TTeePen* Marker = {read=FMarker, write=SetMarker};
	...
	__property OnUnDock;
public:
	/* TWinControl.CreateParented */ inline __fastcall TTreeRuler(HWND ParentWindow) : TCustomPanelTreeLink(ParentWindow) { }
...
private:
	typedef System::DynamicArray<Vcl::Graphics::TPicture*> _TTreeImagePool__1;
	
	
public:
	Vcl::Graphics::TPicture* operator[](int Index) { return this->Image[Index]; }
	
private:
	_TTreeImagePool__1 FImages;
	Vcl::Graphics::TPicture* __fastcall GetImage(int Index);
	
public:
	__fastcall TTreeImagePool();
	__fastcall virtual ~TTreeImagePool();
	TTreeNodeImageIndex __fastcall Add(Vcl::Graphics::TPicture* const Picture)/* overload */;
	TTreeNodeImageIndex __fastcall Add(const System::UnicodeString FileName)/* overload */;
	int __fastcall Count();
	__property Vcl::Graphics::TPicture* Image[int Index] = {read=GetImage/*, default*/};
};
...
//-- var, const, procedure ---------------------------------------------------
static const System::Int8 TeeDefaultBoxSize = System::Int8(0x4);
...
static const System::Uitypes::TCursor crArrowRight = System::Uitypes::TCursor(2021);
static const System::Uitypes::TCursor crArrowDown = System::Uitypes::TCursor(2022);
...
static const int TeeHighLight = int(8388608);
static const int TeeHighLightUnfocused = int(8421504);
static const int TeeHighLightText = int(16777215);
...
extern DELPHI_PACKAGE bool __fastcall Intersect(const System::Types::TRect &R1, const System::Types::TRect &R2);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_TEETREE)
using namespace Teetree;
#endif
#pragma pack(pop)
#pragma option pop
