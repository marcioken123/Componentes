...
// (DO NOT EDIT: machine generated header) 'VCLTee.TeeAnimations.pas' rev: 34.00 (Windows)

#ifndef Vcltee_TeeanimationsHPP
#define Vcltee_TeeanimationsHPP
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TTeeAnimationTool : public Vcltee::Teengine::TTeeCustomAnimation
{
	typedef Vcltee::Teengine::TTeeCustomAnimation inherited;
...
public:
	...
	__property Vcltee::Teeanimate::TAnimations* Animations = {read=GetAnimations};
	
__published:
	__property Vcltee::Teeanimate::TTeeAnimate* Animate = {read=GetAnimate, write=SetAnimate};
...
public:
	/* TCustomChartElement.Create */ inline __fastcall virtual TTeeAnimationTool(System::Classes::TComponent* AOwner) : Vcltee::Teengine::TTeeCustomAnimation(AOwner) { }
...
class PASCALIMPLEMENTATION TCustomExpandAnimation : public Vcltee::Teeanimate::TTeeAnimation
{
...
private:
	...
	int FSizeBy;
	Vcltee::Teengine::TChartClickedPartStyle FTarget;
...
__published:
	...
	__property Vcltee::Teengine::TChartClickedPartStyle Target = {read=FTarget, write=FTarget, default=8};
...
class PASCALIMPLEMENTATION TCustomAnimationChart : public Vcltee::Teeanimate::TTeeAnimation
{
	typedef Vcltee::Teeanimate::TTeeAnimation inherited;
	
private:
	Vcltee::Teengine::TCustomAxisPanel* FChart;
	Vcltee::Teengine::TChartSeries* FSeries;
	void __fastcall SetChart(Vcltee::Teengine::TCustomAxisPanel* const Value);
...
__published:
	__property Vcltee::Teengine::TCustomAxisPanel* Chart = {read=FChart, write=SetChart};
	__property Vcltee::Teengine::TChartSeries* Series = {read=FSeries, write=SetSeries};
public:
	/* TTeeAnimation.Create */ inline __fastcall virtual TCustomAnimationChart(System::Classes::TComponent* AOwner) : Vcltee::Teeanimate::TTeeAnimation(AOwner) { }
...
typedef Vcltee::Teengine::TChartClickedPartStyle TTransformAnimationTarget;
...
private:
	...
	bool IOldClipFlag;
	int IOldTransp;
	Vcltee::Tecanvas::TTeeTransform* ILastTransform;
	Vcltee::Teengine::TCustomAxisPanel* __fastcall CalcChart();
	void __fastcall ReadAxis(System::Classes::TReader* Reader);
	void __fastcall WriteAxis(System::Classes::TWriter* Writer);
	
protected:
	void __fastcall ChangeTransform(const float Fraction, Vcltee::Tecanvas::TTeeTransform* const Transform, const System::Types::TRect &R);
...
__published:
	__property Vcltee::Teengine::TChartAxis* Axis = {read=FAxis, write=FAxis, stored=false};
	...
	__property Vcltee::Teengine::TChartClickedPartStyle Target = {read=FTarget, write=FTarget, default=3};
...
private:
	...
	Vcltee::Teengine::TCustomAxisPanel* IPrepared;
	bool OldCustom;
	void __fastcall RemoveAllSeries(Vcltee::Teengine::TChartSeriesList* const AList);
	
protected:
	Vcltee::Teengine::TChartSeriesList* IBackup;
	virtual bool __fastcall AnimateSeries(const float Fraction, Vcltee::Teengine::TChartSeries* const ASeries, int AIndex);
	virtual bool __fastcall EndAnimation();
	virtual void __fastcall NextFrame(const float Fraction);
	virtual void __fastcall SetInitialValues(Vcltee::Teengine::TChartSeries* const ASeries);
	virtual void __fastcall StoreSeries(Vcltee::Teengine::TChartSeries* const ASeries);
...
private:
	Vcltee::Teeanimate::TTeeAnimation* IAnimation;
	
protected:
	virtual void __fastcall DoCreateAnimation() = 0 ;
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
	virtual void __fastcall ReadState(System::Classes::TReader* Reader);
	virtual void __fastcall SetAnimation(Vcltee::Teeanimate::TTeeAnimation* const Value);
...
__published:
	...
	__property Vcltee::Teengine::TChartSeries* Series = {read=GetSeries, write=SetSeries, stored=false};
...
private:
	...
	Vcltee::Teengine::TChartClickedPartStyle __fastcall GetTarget();
	TAnimationTrigger __fastcall GetTrigger();
	void __fastcall SetSizeBy(const int Value);
	void __fastcall SetTarget(const Vcltee::Teengine::TChartClickedPartStyle Value);
...
__published:
	...
	__property Vcltee::Teengine::TChartClickedPartStyle Target = {read=GetTarget, write=SetTarget, stored=false, nodefault};
...
private:
	Vcltee::Tecanvas::TView3DOptions* IBackup;
	bool IBackupView3D;
...
private:
	Vcltee::Teengine::TChartSeriesList* IRandom;
...
typedef System::DynamicArray<System::Types::TRect> Vcltee_Teeanimations__21;

typedef System::DynamicArray<System::DynamicArray<System::Types::TRect> > TSeriesTransitionData;
...
private:
	...
	float IFraction;
	void __fastcall GetBar(Vcltee::Series::TCustomBarSeries* Sender, int ValueIndex, System::Types::TRect &Rect);
	void __fastcall Remember(TSeriesTransitionData &AData);
	void __fastcall SetEvent(const Vcltee::Series::TGetBarBoundsEvent AEvent);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLTEE_TEEANIMATIONS)
using namespace Vcltee::Teeanimations;
#endif
