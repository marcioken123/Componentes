...
// (DO NOT EDIT: machine generated header) 'VCLTee.TeeAxisBreaks.pas' rev: 34.00 (Windows)

#ifndef Vcltee_TeeaxisbreaksHPP
#define Vcltee_TeeaxisbreaksHPP
...
class PASCALIMPLEMENTATION TAxisBreaksTool : public Vcltee::Teengine::TTeeCustomToolAxis
{
...
private:
	...
	Vcltee::Tecanvas::TPointArray tmpPoints;
	Vcltee::Teengine::TAxisCalcPos OldCalcX;
	Vcltee::Teengine::TAxisCalcPos OldCalcY;
	Vcltee::Teengine::TAxisCalcPosPoint OldCalcPosPoint;
	Vcltee::Teengine::TAxisOnGetLabel IOldLabel;
	Vcltee::Chart::TChartAllowScrollEvent IOldAxisAllowScroll;
	...
	void __fastcall DrawValue(Vcltee::Teengine::TChartSeries* Series, int Index);
	void __fastcall GetMarkText(Vcltee::Teengine::TChartSeries* Sender, int ValueIndex, System::UnicodeString &MarkText);
	...
	void __fastcall CheckNextLabelValue(Vcltee::Teengine::TChartAxis* Sender, double &tmpValue);
...
protected:
	...
	void __fastcall AxisBreakDoAllowScroll(Vcltee::Teengine::TChartAxis* Sender, double &AMin, double &AMax, bool &AllowScroll);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLTEE_TEEAXISBREAKS)
using namespace Vcltee::Teeaxisbreaks;
#endif
