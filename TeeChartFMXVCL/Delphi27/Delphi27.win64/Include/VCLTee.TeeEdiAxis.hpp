...
__published:
	...
	Vcl::Stdctrls::TCheckBox* CBImages;
	...
	void __fastcall CBImagesClick(System::TObject* Sender);
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE void __fastcall TeeAddAxes(Vcltee::Teengine::TCustomAxisPanel* const AChart, System::Classes::TStrings* const AList, bool AddDepth)/* overload */;
extern DELPHI_PACKAGE void __fastcall TeeAddAxes(Vcltee::Teengine::TCustomAxisPanel* const AChart, System::Classes::TStrings* const AList, bool AddDepth, bool AddAll)/* overload */;
}	/* namespace Teeediaxis */
}	/* namespace Vcltee */
