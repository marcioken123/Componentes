...
private:
	...
	void __fastcall CheckStyle(Vcl::Stdctrls::TCheckBox* const Check, const System::Uitypes::TFontStyle Value);
	void __fastcall RefreshBasicProps();
	
public:
	void __fastcall RefreshControls(Vcltee::Tecanvas::TTeeFont* const AFont);
public:
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE TTeeFontEditor* __fastcall InsertTeeFontEditor(Vcl::Controls::TWinControl* const AParent);
extern DELPHI_PACKAGE bool __fastcall EditTeeFontEx(System::Classes::TComponent* const AOwner, Vcltee::Tecanvas::TTeeFont* const AFont);
}	/* namespace Teeedifont */
}	/* namespace Vcltee */
