...
__published:
	...
	Vcl::Stdctrls::TEdit* EItemText3;
	Vcl::Stdctrls::TLabel* Label12;
	Vcl::Comctrls::TTabSheet* TabColumns;
	Vcl::Stdctrls::TGroupBox* GBColumnWidths;
	Vcl::Stdctrls::TLabel* LColumn;
	Vcl::Stdctrls::TLabel* LItem0;
	Vcl::Stdctrls::TLabel* LItem1;
	Vcl::Stdctrls::TLabel* LItem2;
	Vcl::Stdctrls::TEdit* EColumn;
	Vcl::Comctrls::TUpDown* UDColumn;
	Vcl::Stdctrls::TEdit* EItem0;
	Vcl::Comctrls::TUpDown* UDItem0;
	Vcl::Stdctrls::TCheckBox* CBCusWid;
	Vcl::Stdctrls::TEdit* EItem1;
	Vcl::Comctrls::TUpDown* UDItem1;
	Vcl::Stdctrls::TEdit* EItem2;
	Vcl::Comctrls::TUpDown* UDItem2;
	...
	void __fastcall CBCusWidClick(System::TObject* Sender);
	void __fastcall EColumnChange(System::TObject* Sender);
	void __fastcall EItem0Change(System::TObject* Sender);
	void __fastcall EItem1Change(System::TObject* Sender);
	void __fastcall EItem2Change(System::TObject* Sender);
	void __fastcall EItemText3Change(System::TObject* Sender);
...
private:
	...
	void __fastcall EnableColumnWidths();
