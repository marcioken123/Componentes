...
#include <VCLTee.TeeEditAnimations.hpp>
...
private:
	...
	int FGalleryHeight;
	int FGalleryWidth;
	void __fastcall DeleteToolNode(Vcl::Comctrls::TTreeNode* const ANode, System::TObject* const Sender);
	void __fastcall AddedTool(System::TObject* Sender);
	void __fastcall DeletedTool(System::TObject* Sender);
	void __fastcall CreateToolsForm();
	void __fastcall AddedAnimation(System::TObject* Sender);
	void __fastcall CreateAnimationsForm();
	...
	bool __fastcall CanSetPosition();
	...
	void __fastcall SelectLastAnimation(Vcltee::Teengine::TTeeCustomAnimation* &Anim, Vcltee::Teeeditanimations::TFormTeeAnimations* const AForm);
	void __fastcall SelectLastTool(Vcltee::Teengine::TTeeCustomTool* &ATool, Vcltee::Teeedittools::TFormTeeTools* const AForm);
