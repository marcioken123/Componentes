...
// (DO NOT EDIT: machine generated header) 'VCLTee.TeeLinearGauge.pas' rev: 34.00 (Windows)

#ifndef Vcltee_TeelineargaugeHPP
#define Vcltee_TeelineargaugeHPP
...
class PASCALIMPLEMENTATION TGaugeSeriesPointer : public Vcltee::Teengine::TSeriesPointer
{
...
public:
	...
	HIDESBASE void __fastcall Draw(const System::Types::TPoint &Inner, const System::Types::TPoint &InnerPlus, const System::Types::TPoint &InnerMinus, const System::Types::TPoint &Outer, const System::Types::TPoint &OuterPlus, const System::Types::TPoint &OuterMinus)/* overload */;
	
__published:
	__property TGaugePointerStyles GaugeStyle = {read=FGaugeStyle, write=SetGaugeStyle, nodefault};
public:
	/* TSeriesPointer.Create */ inline __fastcall TGaugeSeriesPointer(Vcltee::Teengine::TChartSeries* const AOwner) : Vcltee::Teengine::TSeriesPointer(AOwner) { }
	/* TSeriesPointer.Destroy */ inline __fastcall virtual ~TGaugeSeriesPointer() { }
	
	/* Hoisted overloads: */
	
public:
	inline void __fastcall  Draw(const System::Types::TPoint &P){ Vcltee::Teengine::TSeriesPointer::Draw(P); }
	inline void __fastcall  Draw(int X, int Y){ Vcltee::Teengine::TSeriesPointer::Draw(X, Y); }
	inline void __fastcall  Draw(int px, int py, System::Uitypes::TColor ColorValue, Vcltee::Teengine::TSeriesPointerStyle AStyle){ Vcltee::Teengine::TSeriesPointer::Draw(px, py, ColorValue, AStyle); }
...
public:
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	HIDESBASE void __fastcall Draw(const double StartAngle, const double EndAngle, const System::Types::TRect &Rectangle);
...
public:
	/* TSeriesPointer.Create */ inline __fastcall TGaugePointerRange(Vcltee::Teengine::TChartSeries* const AOwner) : TGaugeSeriesPointer(AOwner) { }
...
public:
	HIDESBASE TGaugeRange* __fastcall Add(const double StartValue, const double EndValue, const System::Uitypes::TColor Color = (System::Uitypes::TColor)(0x0));
...
class PASCALIMPLEMENTATION TCustomGaugeMinMax : public Vcltee::Teenumericgauge::TCustomGauge
{
	typedef Vcltee::Teenumericgauge::TCustomGauge inherited;
...
public:
	...
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	virtual Vcltee::Teengine::TChartAxis* __fastcall Axis() = 0 ;
...
private:
	...
	Vcltee::Teeprocs::TTeeShape* FValueArea;
	double IMaxValue;
	void __fastcall SetMaxIndicator(TGaugeSeriesPointer* const Value);
	void __fastcall SetUseValuePalette(const bool Value);
	void __fastcall SetValueArea(Vcltee::Teeprocs::TTeeShape* const Value);
	
protected:
	System::Types::TRect IAxisRect;
...
__published:
	...
	__property Vcltee::Teeprocs::TTeeShape* ValueArea = {read=FValueArea, write=SetValueArea};
};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCLTEE_TEELINEARGAUGE)
using namespace Vcltee::Teelineargauge;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Vcltee_TeelineargaugeHPP
