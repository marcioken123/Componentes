...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TAddComponentDataSource)(System::Classes::TComponent* const AComponent, System::Classes::TStrings* const AItems, bool AddCurrent);

typedef void __fastcall (*TOnGetDesignerNamesEvent)(const TAddComponentDataSource AProc, Vcltee::Teengine::TChartSeries* const ASeries, System::Classes::TStrings* const AItems, bool AddCurrent);
...
protected:
	...
	void __fastcall AddComponentDataSource(System::Classes::TComponent* const AComponent, System::Classes::TStrings* const AItems, bool AddCurrent);
