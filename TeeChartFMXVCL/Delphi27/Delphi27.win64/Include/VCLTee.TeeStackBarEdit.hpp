...
__published:
	...
	Vcl::Stdctrls::TEdit* ESelfStackPos;
	Vcl::Stdctrls::TCheckBox* CBSelfStackPos;
	...
	void __fastcall ESelfStackPosChange(System::TObject* Sender);
	void __fastcall CBSelfStackPosClick(System::TObject* Sender);
...
private:
	...
	void __fastcall EnableSelfStack();
